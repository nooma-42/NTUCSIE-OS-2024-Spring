...
main(int argc, char *argv[])
{
  ...
  be:	330080e7          	jalr	816(ra) # 3ea <open>
  c2:	84aa                	mv	s1,a0
  ...
  d6:	300080e7          	jalr	768(ra) # 3d2 <close>
  for(i = 1; i < argc; i++){
  ...
  e6:	2c8080e7          	jalr	712(ra) # 3aa <exit>
    cat(0);
  ea:	4501                	li	a0,0
  ...
  fa:	2b4080e7          	jalr	692(ra) # 3aa <exit>
      fprintf(2, "cat: cannot open %s\n", argv[i]);
 ...
 11a:	294080e7          	jalr	660(ra) # 3aa <exit>
...
gets(char *buf, int max)
{
 ...
 210:	1b6080e7          	jalr	438(ra) # 3c2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 262:	18c080e7          	jalr	396(ra) # 3ea <open>
  if(fd < 0)
 ...
 272:	194080e7          	jalr	404(ra) # 402 <fstat>
 276:	892a                	mv	s2,a0
  close(fd);
 278:	8526                	mv	a0,s1
 27a:	00000097          	auipc	ra,0x0
 27e:	158080e7          	jalr	344(ra) # 3d2 <close>
  return r;
}
 282:	854a                	mv	a0,s2
...
000000000000046c <pgprint>:
.global pgprint
pgprint:
 li a7, SYS_pgprint
 46c:	02100893          	li	a7,33
 ecall
 470:	00000073          	ecall
 ret
 474:	8082                	ret
...
putc(int fd, char c)
{
 ...
 48c:	f42080e7          	jalr	-190(ra) # 3ca <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4d0:	0007c783          	lbu	a5,0(a5) # 4000000 <__global_pointer$+0x3ffeeaf>
...
malloc(uint nbytes)
{
 ...
 834:	1287b783          	ld	a5,296(a5) # 958 <freep>
 838:	c795                	beqz	a5,864 <malloc+0x58>
 ...
 842:	8a4e                	mv	s4,s3
 844:	0009879b          	sext.w	a5,s3
 848:	6705                	lui	a4,0x1
 84a:	00e7f363          	bgeu	a5,a4,850 <malloc+0x44>
 84e:	6a05                	lui	s4,0x1
 ...
 868:	2fc50513          	addi	a0,a0,764 # b60 <base>
 86c:	00000797          	auipc	a5,0x0
 870:	0ea7b623          	sd	a0,236(a5) # 958 <freep>
 874:	e108                	sd	a0,0(a0)
    base.s.size = 0;
 876:	00052423          	sw	zero,8(a0)
    if(p->s.size >= nunits){
 87a:	b7e1                	j	842 <malloc+0x36>
      if(p->s.size == nunits)
 87c:	02e48963          	beq	s1,a4,8ae <malloc+0xa2>
        p->s.size -= nunits;
 ...
 88c:	953a                	add	a0,a0,a4
        p->s.size = nunits;
 88e:	01352423          	sw	s3,8(a0)
      freep = prevp;
 892:	00000717          	auipc	a4,0x0
 896:	0cf73323          	sd	a5,198(a4) # 958 <freep>
 ...
 8be:	eca080e7          	jalr	-310(ra) # 784 <free>
  return freep;
 8c2:	00093783          	ld	a5,0(s2)
      if((p = morecore(nunits)) == 0)
 8c6:	c39d                	beqz	a5,8ec <malloc+0xe0>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8c8:	6388                	ld	a0,0(a5)
    if(p->s.size >= nunits){
 8ca:	4518                	lw	a4,8(a0)
 ...
 8d4:	87aa                	mv	a5,a0
 8d6:	fea719e3          	bne	a4,a0,8c8 <malloc+0xbc>
  p = sbrk(nu * sizeof(Header));
 8da:	8552                	mv	a0,s4
 8dc:	00000097          	auipc	ra,0x0
 8e0:	b56080e7          	jalr	-1194(ra) # 432 <sbrk>
  if(p == (char*)-1)
 8e4:	fd5518e3          	bne	a0,s5,8b4 <malloc+0xa8>
        return 0;
 8e8:	4501                	li	a0,0
 8ea:	bf45                	j	89a <malloc+0x8e>
 8ec:	853e                	mv	a0,a5
 8ee:	b775                	j	89a <malloc+0x8e>

...
print(const char *s)
{
  ...
  20:	3ae080e7          	jalr	942(ra) # 3ca <write>
}
  24:	60e2                	ld	ra,24(sp)
  26:	6442                	ld	s0,16(sp)
  28:	64a2                	ld	s1,8(sp)
...
forktest(void)
{
  ...
  3e:	43e50513          	addi	a0,a0,1086 # 478 <pgprint+0xc>
  ...
  54:	352080e7          	jalr	850(ra) # 3a2 <fork>
    if(pid < 0)
  ...
  68:	42450513          	addi	a0,a0,1060 # 488 <pgprint+0x1c>
  ...
  82:	32c080e7          	jalr	812(ra) # 3aa <exit>
  if(n == N){
  ...
  98:	31e080e7          	jalr	798(ra) # 3b2 <wait>
  ...
  aa:	30c080e7          	jalr	780(ra) # 3b2 <wait>
  ae:	57fd                	li	a5,-1
  ...
  b8:	42450513          	addi	a0,a0,1060 # 4d8 <pgprint+0x6c>
  ...
  d4:	3d850513          	addi	a0,a0,984 # 4a8 <pgprint+0x3c>
  ...
  ee:	3d650513          	addi	a0,a0,982 # 4c0 <pgprint+0x54>
  f2:	00000097          	auipc	ra,0x0
  f6:	f0e080e7          	jalr	-242(ra) # 0 <print>
    exit(1);
  fa:	4505                	li	a0,1
  fc:	00000097          	auipc	ra,0x0
 100:	2ae080e7          	jalr	686(ra) # 3aa <exit>

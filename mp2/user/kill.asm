...
main(int argc, char **argv)
{
  ...
  34:	2f0080e7          	jalr	752(ra) # 320 <kill>
  for(i=1; i<argc; i++)
  ...
  60:	294080e7          	jalr	660(ra) # 2f0 <exit>
...
gets(char *buf, int max)
{
 ...
 156:	1b6080e7          	jalr	438(ra) # 308 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1a8:	18c080e7          	jalr	396(ra) # 330 <open>
  if(fd < 0)
 ...
 1b8:	194080e7          	jalr	404(ra) # 348 <fstat>
 1bc:	892a                	mv	s2,a0
  close(fd);
 1be:	8526                	mv	a0,s1
 1c0:	00000097          	auipc	ra,0x0
 1c4:	158080e7          	jalr	344(ra) # 318 <close>
  return r;
}
 1c8:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 2dc:	17f5                	addi	a5,a5,-3
 2de:	07b2                	slli	a5,a5,0xc
 2e0:	4388                	lw	a0,0(a5)
 2e2:	6422                	ld	s0,8(sp)
...
00000000000003a8 <madvise>:
.global madvise
madvise:
 li a7, SYS_madvise
 3a8:	02000893          	li	a7,32
 ecall
 3ac:	00000073          	ecall
 ret
 3b0:	8082                	ret

00000000000003b2 <pgprint>:
.global pgprint
pgprint:
 li a7, SYS_pgprint
 3b2:	02100893          	li	a7,33
 ecall
 3b6:	00000073          	ecall
 ret
 3ba:	8082                	ret
...
putc(int fd, char c)
{
 ...
 3d2:	f42080e7          	jalr	-190(ra) # 310 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 416:	0007c783          	lbu	a5,0(a5) # 4000000 <__global_pointer$+0x3ffef97>
...
malloc(uint nbytes)
{
 ...
 77a:	0fa7b783          	ld	a5,250(a5) # 870 <freep>
 77e:	c795                	beqz	a5,7aa <malloc+0x58>
 ...
 788:	8a4e                	mv	s4,s3
 78a:	0009879b          	sext.w	a5,s3
 78e:	6705                	lui	a4,0x1
 790:	00e7f363          	bgeu	a5,a4,796 <malloc+0x44>
 794:	6a05                	lui	s4,0x1
 ...
 7ae:	0ce50513          	addi	a0,a0,206 # 878 <base>
 7b2:	00000797          	auipc	a5,0x0
 7b6:	0aa7bf23          	sd	a0,190(a5) # 870 <freep>
 7ba:	e108                	sd	a0,0(a0)
    base.s.size = 0;
 7bc:	00052423          	sw	zero,8(a0)
    if(p->s.size >= nunits){
 7c0:	b7e1                	j	788 <malloc+0x36>
      if(p->s.size == nunits)
 7c2:	02e48963          	beq	s1,a4,7f4 <malloc+0xa2>
        p->s.size -= nunits;
 ...
 7d2:	953a                	add	a0,a0,a4
        p->s.size = nunits;
 7d4:	01352423          	sw	s3,8(a0)
      freep = prevp;
 7d8:	00000717          	auipc	a4,0x0
 7dc:	08f73c23          	sd	a5,152(a4) # 870 <freep>
 ...
 804:	eca080e7          	jalr	-310(ra) # 6ca <free>
  return freep;
 808:	00093783          	ld	a5,0(s2)
      if((p = morecore(nunits)) == 0)
 80c:	c39d                	beqz	a5,832 <malloc+0xe0>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 80e:	6388                	ld	a0,0(a5)
    if(p->s.size >= nunits){
 810:	4518                	lw	a4,8(a0)
 ...
 81a:	87aa                	mv	a5,a0
 81c:	fea719e3          	bne	a4,a0,80e <malloc+0xbc>
  p = sbrk(nu * sizeof(Header));
 820:	8552                	mv	a0,s4
 822:	00000097          	auipc	ra,0x0
 826:	b56080e7          	jalr	-1194(ra) # 378 <sbrk>
  if(p == (char*)-1)
 82a:	fd5518e3          	bne	a0,s5,7fa <malloc+0xa8>
        return 0;
 82e:	4501                	li	a0,0
 830:	bf45                	j	7e0 <malloc+0x8e>
 832:	853e                	mv	a0,a5
 834:	b775                	j	7e0 <malloc+0x8e>

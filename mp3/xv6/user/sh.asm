...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      32:	77a78793          	addi	a5,a5,1914 # 27a8 <schedule_dm+0x1ae>
      36:	97ba                	add	a5,a5,a4
      38:	439c                	lw	a5,0(a5)
      3a:	0007871b          	sext.w	a4,a5
      3e:	00002797          	auipc	a5,0x2
      42:	76a78793          	addi	a5,a5,1898 # 27a8 <schedule_dm+0x1ae>
      46:	97ba                	add	a5,a5,a4
      48:	8782                	jr	a5
  default:
    panic("runcmd");
      4a:	00002517          	auipc	a0,0x2
      4e:	72e50513          	addi	a0,a0,1838 # 2778 <schedule_dm+0x17e>
  ...
  case EXEC:
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      98:	6ec58593          	addi	a1,a1,1772 # 2780 <schedule_dm+0x186>
      9c:	4509                	li	a0,2
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ea:	6aa58593          	addi	a1,a1,1706 # 2790 <schedule_dm+0x196>
      ee:	4509                	li	a0,2
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     174:	63050513          	addi	a0,a0,1584 # 27a0 <schedule_dm+0x1a6>
...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
     ...
     298:	52c58593          	addi	a1,a1,1324 # 27c0 <schedule_dm+0x1c6>
     29c:	4509                	li	a0,2
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     314:	4b850513          	addi	a0,a0,1208 # 27c8 <schedule_dm+0x1ce>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     378:	57450513          	addi	a0,a0,1396 # 28e8 <buf.1144>
     ...
     390:	55c70713          	addi	a4,a4,1372 # 28e8 <buf.1144>
     ...
     3a2:	54d78793          	addi	a5,a5,1357 # 28eb <buf.1144+0x3>
     3a6:	853e                	mv	a0,a5
     ...
     3ba:	53578793          	addi	a5,a5,1333 # 28eb <buf.1144+0x3>
     3be:	863e                	mv	a2,a5
     3c0:	00002597          	auipc	a1,0x2
     3c4:	41058593          	addi	a1,a1,1040 # 27d0 <schedule_dm+0x1d6>
     3c8:	4509                	li	a0,2
    ...
    if(fork1() == 0)
     ...
     3e4:	50850513          	addi	a0,a0,1288 # 28e8 <buf.1144>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     40e:	4de50513          	addi	a0,a0,1246 # 28e8 <buf.1144>
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
     ...
     43e:	3a658593          	addi	a1,a1,934 # 27e0 <schedule_dm+0x1e6>
     442:	4509                	li	a0,2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     47e:	36e50513          	addi	a0,a0,878 # 27e8 <schedule_dm+0x1ee>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a4:	23850513          	addi	a0,a0,568 # 28d8 <whitespace>
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     7a0:	13c50513          	addi	a0,a0,316 # 28d8 <whitespace>
     ...
     7be:	12650513          	addi	a0,a0,294 # 28e0 <symbols>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     810:	0cc50513          	addi	a0,a0,204 # 28d8 <whitespace>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     87c:	06050513          	addi	a0,a0,96 # 28d8 <whitespace>
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     916:	ede60613          	addi	a2,a2,-290 # 27f0 <schedule_dm+0x1f6>
  ...
  if(s != es){
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     93e:	ebe58593          	addi	a1,a1,-322 # 27f8 <schedule_dm+0x1fe>
     942:	4509                	li	a0,2
     944:	00001097          	auipc	ra,0x1
     948:	f96080e7          	jalr	-106(ra) # 18da <fprintf>
    panic("syntax");
     94c:	00002517          	auipc	a0,0x2
     950:	ebc50513          	addi	a0,a0,-324 # 2808 <schedule_dm+0x20e>
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     9c6:	e4e60613          	addi	a2,a2,-434 # 2810 <schedule_dm+0x216>
  ...
  if(peek(ps, es, ";")){
     ...
     9e2:	e3a60613          	addi	a2,a2,-454 # 2818 <schedule_dm+0x21e>
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     a68:	dbc60613          	addi	a2,a2,-580 # 2820 <schedule_dm+0x226>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     b22:	d0a50513          	addi	a0,a0,-758 # 2828 <schedule_dm+0x22e>
  ...
  while(peek(ps, es, "<>")){
     ...
     bd6:	c7660613          	addi	a2,a2,-906 # 2848 <schedule_dm+0x24e>
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     c12:	c4260613          	addi	a2,a2,-958 # 2850 <schedule_dm+0x256>
    ...
    panic("parseblock");
     ...
     c2e:	c2e50513          	addi	a0,a0,-978 # 2858 <schedule_dm+0x25e>
  ...
  if(!peek(ps, es, ")"))
     ...
     c66:	c0660613          	addi	a2,a2,-1018 # 2868 <schedule_dm+0x26e>
    ...
    panic("syntax - missing )");
     ...
     c82:	bf250513          	addi	a0,a0,-1038 # 2870 <schedule_dm+0x276>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     cdc:	b7860613          	addi	a2,a2,-1160 # 2850 <schedule_dm+0x256>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     d78:	a9450513          	addi	a0,a0,-1388 # 2808 <schedule_dm+0x20e>
    ...
    if(argc >= MAXARGS)
     ...
     dc6:	ac650513          	addi	a0,a0,-1338 # 2888 <schedule_dm+0x28e>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     dee:	aae60613          	addi	a2,a2,-1362 # 2898 <schedule_dm+0x29e>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     e66:	a3e78793          	addi	a5,a5,-1474 # 28a0 <schedule_dm+0x2a6>
     e6a:	97ba                	add	a5,a5,a4
     e6c:	439c                	lw	a5,0(a5)
     e6e:	0007871b          	sext.w	a4,a5
     e72:	00002797          	auipc	a5,0x2
     e76:	a2e78793          	addi	a5,a5,-1490 # 28a0 <schedule_dm+0x2a6>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1554:	37068693          	addi	a3,a3,880 # 28c0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    162e:	29670713          	addi	a4,a4,662 # 28c0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    17ee:	0ce78793          	addi	a5,a5,206 # 28b8 <schedule_dm+0x2be>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    199a:	fca78793          	addi	a5,a5,-54 # 2960 <freep>
  ...
  freep = p;
    ...
    1a92:	ed278793          	addi	a5,a5,-302 # 2960 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1b14:	e5078793          	addi	a5,a5,-432 # 2960 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1b46:	e1e78793          	addi	a5,a5,-482 # 2960 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1c04:	d6078793          	addi	a5,a5,-672 # 2960 <freep>
    ...
    1c1a:	d4a78793          	addi	a5,a5,-694 # 2960 <freep>
...
{
    1d9c:	711d                	addi	sp,sp,-96
    1d9e:	eca2                	sd	s0,88(sp)
    1da0:	e8a6                	sd	s1,80(sp)
    ...
    1da6:	fe043423          	sd	zero,-24(s0)
    struct thread *candidate = NULL;
    1daa:	fe043023          	sd	zero,-32(s0)
    ...
    1dae:	00001797          	auipc	a5,0x1
    1db2:	bba78793          	addi	a5,a5,-1094 # 2968 <last_thread.1226>
    1db6:	639c                	ld	a5,0(a5)
    1db8:	cb89                	beqz	a5,1dca <schedule_wrr+0x2e>
    1dba:	00001797          	auipc	a5,0x1
    1dbe:	bae78793          	addi	a5,a5,-1106 # 2968 <last_thread.1226>
    1dc2:	639c                	ld	a5,0(a5)
    1dc4:	4fbc                	lw	a5,88(a5)
    1dc6:	00f04863          	bgtz	a5,1dd6 <schedule_wrr+0x3a>
        last_thread = NULL;
    1dca:	00001797          	auipc	a5,0x1
    1dce:	b9e78793          	addi	a5,a5,-1122 # 2968 <last_thread.1226>
    1dd2:	0007b023          	sd	zero,0(a5)
    }
    ...
    1dda:	fcf43823          	sd	a5,-48(s0)
    1dde:	fd043783          	ld	a5,-48(s0)
    1de2:	fd878793          	addi	a5,a5,-40
    1de6:	fef43023          	sd	a5,-32(s0)
    1dea:	a0a9                	j	1e34 <schedule_wrr+0x98>
        if (!last_thread && candidate->remaining_time > 0)
    1dec:	00001797          	auipc	a5,0x1
    1df0:	b7c78793          	addi	a5,a5,-1156 # 2968 <last_thread.1226>
    1df4:	639c                	ld	a5,0(a5)
    1df6:	eb91                	bnez	a5,1e0a <schedule_wrr+0x6e>
    1df8:	fe043783          	ld	a5,-32(s0)
    1dfc:	4fbc                	lw	a5,88(a5)
    1dfe:	00f05663          	blez	a5,1e0a <schedule_wrr+0x6e>
            selected_thread = candidate;
    1e02:	fe043783          	ld	a5,-32(s0)
    1e06:	fef43423          	sd	a5,-24(s0)
        if (candidate->remaining_time > 0) {
    1e0a:	fe043783          	ld	a5,-32(s0)
    1e0e:	4fbc                	lw	a5,88(a5)
    1e10:	00f05763          	blez	a5,1e1e <schedule_wrr+0x82>
            selected_thread = candidate;
    1e14:	fe043783          	ld	a5,-32(s0)
    1e18:	fef43423          	sd	a5,-24(s0)
            break;
    1e1c:	a01d                	j	1e42 <schedule_wrr+0xa6>
    list_for_each_entry(candidate, args.run_queue, thread_list) {
    1e1e:	fe043783          	ld	a5,-32(s0)
    1e22:	779c                	ld	a5,40(a5)
    1e24:	fcf43423          	sd	a5,-56(s0)
    1e28:	fc843783          	ld	a5,-56(s0)
    1e2c:	fd878793          	addi	a5,a5,-40
    1e30:	fef43023          	sd	a5,-32(s0)
    1e34:	fe043783          	ld	a5,-32(s0)
    1e38:	02878713          	addi	a4,a5,40
    1e3c:	649c                	ld	a5,8(s1)
    1e3e:	faf717e3          	bne	a4,a5,1dec <schedule_wrr+0x50>
        }
    }
    ...
    1e42:	fe843783          	ld	a5,-24(s0)
    1e46:	e795                	bnez	a5,1e72 <schedule_wrr+0xd6>
    1e48:	00001797          	auipc	a5,0x1
    1e4c:	b2078793          	addi	a5,a5,-1248 # 2968 <last_thread.1226>
    1e50:	639c                	ld	a5,0(a5)
    1e52:	c385                	beqz	a5,1e72 <schedule_wrr+0xd6>
    1e54:	00001797          	auipc	a5,0x1
    1e58:	b1478793          	addi	a5,a5,-1260 # 2968 <last_thread.1226>
    1e5c:	639c                	ld	a5,0(a5)
    1e5e:	4fbc                	lw	a5,88(a5)
    1e60:	00f05963          	blez	a5,1e72 <schedule_wrr+0xd6>
        selected_thread = last_thread;
    1e64:	00001797          	auipc	a5,0x1
    1e68:	b0478793          	addi	a5,a5,-1276 # 2968 <last_thread.1226>
    ...
    1e76:	c7b9                	beqz	a5,1ec4 <schedule_wrr+0x128>
        int time_slice = selected_thread->weight * TIME_QUANTUM;
    1e78:	fe843783          	ld	a5,-24(s0)
    1e7c:	47bc                	lw	a5,72(a5)
    1e7e:	0017979b          	slliw	a5,a5,0x1
    1e82:	fcf42e23          	sw	a5,-36(s0)
        if (time_slice > selected_thread->remaining_time) {
    1e86:	fe843783          	ld	a5,-24(s0)
    1e8a:	4fb8                	lw	a4,88(a5)
    1e8c:	fdc42783          	lw	a5,-36(s0)
    1e90:	2781                	sext.w	a5,a5
    1e92:	00f75763          	bge	a4,a5,1ea0 <schedule_wrr+0x104>
            time_slice = selected_thread->remaining_time;
    1e96:	fe843783          	ld	a5,-24(s0)
    1e9a:	4fbc                	lw	a5,88(a5)
    1e9c:	fcf42e23          	sw	a5,-36(s0)
        }
        r.scheduled_thread_list_member = &selected_thread->thread_list;
    1ea0:	fe843783          	ld	a5,-24(s0)
    1ea4:	02878793          	addi	a5,a5,40
    1ea8:	faf43423          	sd	a5,-88(s0)
        r.allocated_time = time_slice;
    1eac:	fdc42783          	lw	a5,-36(s0)
    1eb0:	faf42823          	sw	a5,-80(s0)
        last_thread = selected_thread;  // Update the last run thread
    1eb4:	00001797          	auipc	a5,0x1
    1eb8:	ab478793          	addi	a5,a5,-1356 # 2968 <last_thread.1226>
    1ebc:	fe843703          	ld	a4,-24(s0)
    1ec0:	e398                	sd	a4,0(a5)
    1ec2:	a039                	j	1ed0 <schedule_wrr+0x134>
    } else {
        // Idle if no suitable thread is found
        r.scheduled_thread_list_member = args.run_queue;
    1ec4:	649c                	ld	a5,8(s1)
    1ec6:	faf43423          	sd	a5,-88(s0)
        r.allocated_time = 1;
    1eca:	4785                	li	a5,1
    1ecc:	faf42823          	sw	a5,-80(s0)
    }

    return r;
    1ed0:	fa843783          	ld	a5,-88(s0)
    1ed4:	faf43c23          	sd	a5,-72(s0)
    1ed8:	fb043783          	ld	a5,-80(s0)
    1edc:	fcf43023          	sd	a5,-64(s0)
    1ee0:	4701                	li	a4,0
    1ee2:	fb843703          	ld	a4,-72(s0)
    1ee6:	4781                	li	a5,0
    1ee8:	fc043783          	ld	a5,-64(s0)
    1eec:	863a                	mv	a2,a4
    1eee:	86be                	mv	a3,a5
    1ef0:	8732                	mv	a4,a2
    1ef2:	87b6                	mv	a5,a3
    ...
    1ef4:	853a                	mv	a0,a4
    1ef6:	85be                	mv	a1,a5
    1ef8:	6466                	ld	s0,88(sp)
    1efa:	64c6                	ld	s1,80(sp)
    1efc:	6125                	addi	sp,sp,96
    1efe:	8082                	ret

0000000000001f00 <find_next_release_time>:

int find_next_release_time(struct list_head *release_queue, int current_time) {
    1f00:	7139                	addi	sp,sp,-64
    1f02:	fc22                	sd	s0,56(sp)
    1f04:	0080                	addi	s0,sp,64
    1f06:	fca43423          	sd	a0,-56(s0)
    1f0a:	87ae                	mv	a5,a1
    1f0c:	fcf42223          	sw	a5,-60(s0)
    struct release_queue_entry *next_release = NULL;
    1f10:	fe043423          	sd	zero,-24(s0)
    int next_release_time = INT_MAX;
    1f14:	800007b7          	lui	a5,0x80000
    1f18:	fff7c793          	not	a5,a5
    ...
    1f26:	fcf43c23          	sd	a5,-40(s0)
    1f2a:	fd843783          	ld	a5,-40(s0)
    1f2e:	17e1                	addi	a5,a5,-8
    1f30:	fef43423          	sd	a5,-24(s0)
    1f34:	a081                	j	1f74 <find_next_release_time+0x74>
        if (next_release->release_time > current_time && next_release->release_time < next_release_time) {
    1f36:	fe843783          	ld	a5,-24(s0)
    1f3a:	4f98                	lw	a4,24(a5)
    1f3c:	fc442783          	lw	a5,-60(s0)
    1f40:	2781                	sext.w	a5,a5
    1f42:	00e7df63          	bge	a5,a4,1f60 <find_next_release_time+0x60>
    1f46:	fe843783          	ld	a5,-24(s0)
    1f4a:	4f98                	lw	a4,24(a5)
    1f4c:	fe442783          	lw	a5,-28(s0)
    1f50:	2781                	sext.w	a5,a5
    1f52:	00f75763          	bge	a4,a5,1f60 <find_next_release_time+0x60>
            next_release_time = next_release->release_time;
    1f56:	fe843783          	ld	a5,-24(s0)
    1f5a:	4f9c                	lw	a5,24(a5)
    1f5c:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(next_release, release_queue, thread_list) {
    1f60:	fe843783          	ld	a5,-24(s0)
    1f64:	679c                	ld	a5,8(a5)
    1f66:	fcf43823          	sd	a5,-48(s0)
    1f6a:	fd043783          	ld	a5,-48(s0)
    1f6e:	17e1                	addi	a5,a5,-8
    1f70:	fef43423          	sd	a5,-24(s0)
    1f74:	fe843783          	ld	a5,-24(s0)
    1f78:	07a1                	addi	a5,a5,8
    1f7a:	fc843703          	ld	a4,-56(s0)
    1f7e:	faf71ce3          	bne	a4,a5,1f36 <find_next_release_time+0x36>
        }
    }

    if (next_release_time == INT_MAX)
    1f82:	fe442783          	lw	a5,-28(s0)
    1f86:	0007871b          	sext.w	a4,a5
    1f8a:	800007b7          	lui	a5,0x80000
    1f8e:	fff7c793          	not	a5,a5
    1f92:	00f71463          	bne	a4,a5,1f9a <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    1f96:	57fd                	li	a5,-1
    1f98:	a801                	j	1fa8 <find_next_release_time+0xa8>

    return next_release_time - current_time;
    1f9a:	fe442703          	lw	a4,-28(s0)
    1f9e:	fc442783          	lw	a5,-60(s0)
    1fa2:	40f707bb          	subw	a5,a4,a5
    1fa6:	2781                	sext.w	a5,a5
}
    1fa8:	853e                	mv	a0,a5
    1faa:	7462                	ld	s0,56(sp)
    1fac:	6121                	addi	sp,sp,64
    1fae:	8082                	ret

0000000000001fb0 <find_earliest_impactful_release_time>:



int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    1fb0:	7159                	addi	sp,sp,-112
    1fb2:	f4a2                	sd	s0,104(sp)
    1fb4:	1880                	addi	s0,sp,112
    1fb6:	faa43423          	sd	a0,-88(s0)
    1fba:	fab43023          	sd	a1,-96(s0)
    1fbe:	87b2                	mv	a5,a2
    1fc0:	f8f42e23          	sw	a5,-100(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_time = INT_MAX;
    1fc4:	800007b7          	lui	a5,0x80000
    1fc8:	fff7c793          	not	a5,a5
    1fcc:	fef42223          	sw	a5,-28(s0)
    int shortest_current_time = INT_MAX;
    1fd0:	800007b7          	lui	a5,0x80000
    1fd4:	fff7c793          	not	a5,a5
    1fd8:	fef42023          	sw	a5,-32(s0)
    ...
    1fe2:	fcf43823          	sd	a5,-48(s0)
    1fe6:	fd043783          	ld	a5,-48(s0)
    1fea:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffcf18>
    1fee:	fcf43c23          	sd	a5,-40(s0)
    1ff2:	a80d                	j	2024 <find_earliest_impactful_release_time+0x74>
        if (t->remaining_time < shortest_current_time) {
    1ff4:	fd843783          	ld	a5,-40(s0)
    1ff8:	4fb8                	lw	a4,88(a5)
    1ffa:	fe042783          	lw	a5,-32(s0)
    1ffe:	2781                	sext.w	a5,a5
    2000:	00f75763          	bge	a4,a5,200e <find_earliest_impactful_release_time+0x5e>
            shortest_current_time = t->remaining_time;
    2004:	fd843783          	ld	a5,-40(s0)
    2008:	4fbc                	lw	a5,88(a5)
    200a:	fef42023          	sw	a5,-32(s0)
    list_for_each_entry(t, run_queue, thread_list) {
    200e:	fd843783          	ld	a5,-40(s0)
    2012:	779c                	ld	a5,40(a5)
    2014:	faf43c23          	sd	a5,-72(s0)
    2018:	fb843783          	ld	a5,-72(s0)
    201c:	fd878793          	addi	a5,a5,-40
    2020:	fcf43c23          	sd	a5,-40(s0)
    2024:	fd843783          	ld	a5,-40(s0)
    2028:	02878793          	addi	a5,a5,40
    202c:	fa043703          	ld	a4,-96(s0)
    2030:	fcf712e3          	bne	a4,a5,1ff4 <find_earliest_impactful_release_time+0x44>
        }
    }
    ...
    2034:	fa843783          	ld	a5,-88(s0)
    2038:	639c                	ld	a5,0(a5)
    203a:	fcf43423          	sd	a5,-56(s0)
    203e:	fc843783          	ld	a5,-56(s0)
    2042:	17e1                	addi	a5,a5,-8
    2044:	fef43423          	sd	a5,-24(s0)
    2048:	a889                	j	209a <find_earliest_impactful_release_time+0xea>
        if (entry->release_time > current_time && entry->release_time < earliest_impactful_time) {
    204a:	fe843783          	ld	a5,-24(s0)
    204e:	4f98                	lw	a4,24(a5)
    2050:	f9c42783          	lw	a5,-100(s0)
    2054:	2781                	sext.w	a5,a5
    2056:	02e7d863          	bge	a5,a4,2086 <find_earliest_impactful_release_time+0xd6>
    205a:	fe843783          	ld	a5,-24(s0)
    205e:	4f98                	lw	a4,24(a5)
    2060:	fe442783          	lw	a5,-28(s0)
    2064:	2781                	sext.w	a5,a5
    2066:	02f75063          	bge	a4,a5,2086 <find_earliest_impactful_release_time+0xd6>
            if (entry->thrd->remaining_time < shortest_current_time) {
    206a:	fe843783          	ld	a5,-24(s0)
    206e:	639c                	ld	a5,0(a5)
    2070:	4fb8                	lw	a4,88(a5)
    2072:	fe042783          	lw	a5,-32(s0)
    2076:	2781                	sext.w	a5,a5
    2078:	00f75763          	bge	a4,a5,2086 <find_earliest_impactful_release_time+0xd6>
                earliest_impactful_time = entry->release_time;
    207c:	fe843783          	ld	a5,-24(s0)
    2080:	4f9c                	lw	a5,24(a5)
    2082:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    2086:	fe843783          	ld	a5,-24(s0)
    208a:	679c                	ld	a5,8(a5)
    208c:	fcf43023          	sd	a5,-64(s0)
    2090:	fc043783          	ld	a5,-64(s0)
    2094:	17e1                	addi	a5,a5,-8
    2096:	fef43423          	sd	a5,-24(s0)
    209a:	fe843783          	ld	a5,-24(s0)
    209e:	07a1                	addi	a5,a5,8
    20a0:	fa843703          	ld	a4,-88(s0)
    20a4:	faf713e3          	bne	a4,a5,204a <find_earliest_impactful_release_time+0x9a>
            }
        }
    }
    ...
    20ac:	0007871b          	sext.w	a4,a5
    20b0:	800007b7          	lui	a5,0x80000
    20b4:	fff7c793          	not	a5,a5
    20b8:	00f70a63          	beq	a4,a5,20cc <find_earliest_impactful_release_time+0x11c>
    20bc:	fe442703          	lw	a4,-28(s0)
    20c0:	f9c42783          	lw	a5,-100(s0)
    20c4:	40f707bb          	subw	a5,a4,a5
    20c8:	2781                	sext.w	a5,a5
    20ca:	a011                	j	20ce <find_earliest_impactful_release_time+0x11e>
    20cc:	57fd                	li	a5,-1
}
    20ce:	853e                	mv	a0,a5
    20d0:	7426                	ld	s0,104(sp)
    20d2:	6165                	addi	sp,sp,112
    20d4:	8082                	ret

00000000000020d6 <schedule_sjf>:


struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    20d6:	7119                	addi	sp,sp,-128
    20d8:	fc86                	sd	ra,120(sp)
    20da:	f8a2                	sd	s0,112(sp)
    20dc:	f4a6                	sd	s1,104(sp)
    20de:	f0ca                	sd	s2,96(sp)
    20e0:	ecce                	sd	s3,88(sp)
    20e2:	0100                	addi	s0,sp,128
    20e4:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *shortest_job = NULL;
    20e6:	fc043423          	sd	zero,-56(s0)
    struct thread *current;
    int shortest_time = INT_MAX;
    20ea:	800007b7          	lui	a5,0x80000
    20ee:	fff7c793          	not	a5,a5
    20f2:	faf42e23          	sw	a5,-68(s0)
    ...
    20f8:	6498                	ld	a4,8(s1)
    20fa:	4094                	lw	a3,0(s1)
    20fc:	8636                	mv	a2,a3
    20fe:	85ba                	mv	a1,a4
    2100:	853e                	mv	a0,a5
    2102:	00000097          	auipc	ra,0x0
    2106:	eae080e7          	jalr	-338(ra) # 1fb0 <find_earliest_impactful_release_time>
    210a:	87aa                	mv	a5,a0
    210c:	faf42a23          	sw	a5,-76(s0)

    // Determine the shortest job from the run queue
    list_for_each_entry(current, args.run_queue, thread_list) {
    2110:	649c                	ld	a5,8(s1)
    2112:	639c                	ld	a5,0(a5)
    2114:	faf43423          	sd	a5,-88(s0)
    2118:	fa843783          	ld	a5,-88(s0)
    211c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffcf18>
    2120:	fcf43023          	sd	a5,-64(s0)
    2124:	a82d                	j	215e <schedule_sjf+0x88>
        if (current->remaining_time < shortest_time) {
    2126:	fc043783          	ld	a5,-64(s0)
    212a:	4fb8                	lw	a4,88(a5)
    212c:	fbc42783          	lw	a5,-68(s0)
    2130:	2781                	sext.w	a5,a5
    2132:	00f75b63          	bge	a4,a5,2148 <schedule_sjf+0x72>
            shortest_time = current->remaining_time;
    2136:	fc043783          	ld	a5,-64(s0)
    213a:	4fbc                	lw	a5,88(a5)
    213c:	faf42e23          	sw	a5,-68(s0)
            shortest_job = current;
    2140:	fc043783          	ld	a5,-64(s0)
    2144:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(current, args.run_queue, thread_list) {
    2148:	fc043783          	ld	a5,-64(s0)
    214c:	779c                	ld	a5,40(a5)
    214e:	faf43023          	sd	a5,-96(s0)
    2152:	fa043783          	ld	a5,-96(s0)
    2156:	fd878793          	addi	a5,a5,-40
    215a:	fcf43023          	sd	a5,-64(s0)
    215e:	fc043783          	ld	a5,-64(s0)
    2162:	02878713          	addi	a4,a5,40
    2166:	649c                	ld	a5,8(s1)
    2168:	faf71fe3          	bne	a4,a5,2126 <schedule_sjf+0x50>
        }
    }

    if (shortest_job) {
    216c:	fc843783          	ld	a5,-56(s0)
    2170:	c7a1                	beqz	a5,21b8 <schedule_sjf+0xe2>
        int time_to_allocate = shortest_job->remaining_time;
    2172:	fc843783          	ld	a5,-56(s0)
    2176:	4fbc                	lw	a5,88(a5)
    2178:	faf42c23          	sw	a5,-72(s0)
    ...
    217c:	fb442783          	lw	a5,-76(s0)
    2180:	0007871b          	sext.w	a4,a5
    2184:	57fd                	li	a5,-1
    2186:	00f70e63          	beq	a4,a5,21a2 <schedule_sjf+0xcc>
    218a:	fb442703          	lw	a4,-76(s0)
    218e:	fb842783          	lw	a5,-72(s0)
    2192:	2701                	sext.w	a4,a4
    2194:	2781                	sext.w	a5,a5
    2196:	00f75663          	bge	a4,a5,21a2 <schedule_sjf+0xcc>
            time_to_allocate = earliest_impactful_time;
    219a:	fb442783          	lw	a5,-76(s0)
    219e:	faf42c23          	sw	a5,-72(s0)
        }

        r.scheduled_thread_list_member = &shortest_job->thread_list;
    21a2:	fc843783          	ld	a5,-56(s0)
    21a6:	02878793          	addi	a5,a5,40
    21aa:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = time_to_allocate;
    21ae:	fb842783          	lw	a5,-72(s0)
    21b2:	f8f42423          	sw	a5,-120(s0)
    21b6:	a80d                	j	21e8 <schedule_sjf+0x112>
    } else {
    ...
    21be:	fb442783          	lw	a5,-76(s0)
    21c2:	0007871b          	sext.w	a4,a5
    21c6:	57fd                	li	a5,-1
    21c8:	00f71c63          	bne	a4,a5,21e0 <schedule_sjf+0x10a>
    21cc:	689c                	ld	a5,16(s1)
    21ce:	4098                	lw	a4,0(s1)
    21d0:	85ba                	mv	a1,a4
    21d2:	853e                	mv	a0,a5
    21d4:	00000097          	auipc	ra,0x0
    21d8:	d2c080e7          	jalr	-724(ra) # 1f00 <find_next_release_time>
    21dc:	87aa                	mv	a5,a0
    21de:	a019                	j	21e4 <schedule_sjf+0x10e>
    21e0:	fb442783          	lw	a5,-76(s0)
    21e4:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    21e8:	f8043783          	ld	a5,-128(s0)
    21ec:	f8f43823          	sd	a5,-112(s0)
    21f0:	f8843783          	ld	a5,-120(s0)
    21f4:	f8f43c23          	sd	a5,-104(s0)
    21f8:	4701                	li	a4,0
    21fa:	f9043703          	ld	a4,-112(s0)
    21fe:	4781                	li	a5,0
    2200:	f9843783          	ld	a5,-104(s0)
    2204:	893a                	mv	s2,a4
    2206:	89be                	mv	s3,a5
    2208:	874a                	mv	a4,s2
    220a:	87ce                	mv	a5,s3
    ...
    220c:	853a                	mv	a0,a4
    220e:	85be                	mv	a1,a5
    2210:	70e6                	ld	ra,120(sp)
    2212:	7446                	ld	s0,112(sp)
    2214:	74a6                	ld	s1,104(sp)
    2216:	7906                	ld	s2,96(sp)
    2218:	69e6                	ld	s3,88(sp)
    221a:	6109                	addi	sp,sp,128
    221c:	8082                	ret

000000000000221e <min>:

int min(int a, int b) {
    221e:	1101                	addi	sp,sp,-32
    2220:	ec22                	sd	s0,24(sp)
    2222:	1000                	addi	s0,sp,32
    2224:	87aa                	mv	a5,a0
    2226:	872e                	mv	a4,a1
    2228:	fef42623          	sw	a5,-20(s0)
    222c:	87ba                	mv	a5,a4
    222e:	fef42423          	sw	a5,-24(s0)
    return (a < b) ? a : b;
    2232:	fec42603          	lw	a2,-20(s0)
    2236:	fe842783          	lw	a5,-24(s0)
    223a:	0007869b          	sext.w	a3,a5
    223e:	0006071b          	sext.w	a4,a2
    2242:	00d75363          	bge	a4,a3,2248 <min+0x2a>
    2246:	87b2                	mv	a5,a2
    2248:	2781                	sext.w	a5,a5
}
    224a:	853e                	mv	a0,a5
    224c:	6462                	ld	s0,24(sp)
    224e:	6105                	addi	sp,sp,32
    2250:	8082                	ret

0000000000002252 <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    2252:	7131                	addi	sp,sp,-192
    2254:	fd06                	sd	ra,184(sp)
    2256:	f922                	sd	s0,176(sp)
    2258:	f526                	sd	s1,168(sp)
    225a:	f14a                	sd	s2,160(sp)
    225c:	ed4e                	sd	s3,152(sp)
    225e:	0180                	addi	s0,sp,192
    2260:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *min_slack_thread = NULL;
    2262:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    2266:	800007b7          	lui	a5,0x80000
    226a:	fff7c793          	not	a5,a5
    226e:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    // int ddl;
    // Determine the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    2272:	649c                	ld	a5,8(s1)
    2274:	639c                	ld	a5,0(a5)
    2276:	faf43023          	sd	a5,-96(s0)
    227a:	fa043783          	ld	a5,-96(s0)
    227e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffcf18>
    2282:	faf43c23          	sd	a5,-72(s0)
    2286:	a069                	j	2310 <schedule_lst+0xbe>
        int slack_time = t->current_deadline - args.current_time - t->remaining_time;
    2288:	fb843783          	ld	a5,-72(s0)
    228c:	4ff8                	lw	a4,92(a5)
    228e:	409c                	lw	a5,0(s1)
    2290:	40f707bb          	subw	a5,a4,a5
    2294:	0007871b          	sext.w	a4,a5
    2298:	fb843783          	ld	a5,-72(s0)
    229c:	4fbc                	lw	a5,88(a5)
    229e:	40f707bb          	subw	a5,a4,a5
    22a2:	f6f42a23          	sw	a5,-140(s0)
        if (slack_time < min_slack_time || (slack_time == min_slack_time && t->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))) {
    22a6:	f7442703          	lw	a4,-140(s0)
    22aa:	fc442783          	lw	a5,-60(s0)
    22ae:	2701                	sext.w	a4,a4
    22b0:	2781                	sext.w	a5,a5
    22b2:	02f74c63          	blt	a4,a5,22ea <schedule_lst+0x98>
    22b6:	f7442703          	lw	a4,-140(s0)
    22ba:	fc442783          	lw	a5,-60(s0)
    22be:	2701                	sext.w	a4,a4
    22c0:	2781                	sext.w	a5,a5
    22c2:	02f71c63          	bne	a4,a5,22fa <schedule_lst+0xa8>
    22c6:	fb843783          	ld	a5,-72(s0)
    22ca:	5fd4                	lw	a3,60(a5)
    22cc:	fc843783          	ld	a5,-56(s0)
    22d0:	c789                	beqz	a5,22da <schedule_lst+0x88>
    22d2:	fc843783          	ld	a5,-56(s0)
    22d6:	5fdc                	lw	a5,60(a5)
    22d8:	a029                	j	22e2 <schedule_lst+0x90>
    22da:	800007b7          	lui	a5,0x80000
    22de:	fff7c793          	not	a5,a5
    22e2:	873e                	mv	a4,a5
    22e4:	87b6                	mv	a5,a3
    22e6:	00e7da63          	bge	a5,a4,22fa <schedule_lst+0xa8>
            min_slack_thread = t;
    22ea:	fb843783          	ld	a5,-72(s0)
    22ee:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    22f2:	f7442783          	lw	a5,-140(s0)
    22f6:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    22fa:	fb843783          	ld	a5,-72(s0)
    22fe:	779c                	ld	a5,40(a5)
    2300:	f6f43423          	sd	a5,-152(s0)
    2304:	f6843783          	ld	a5,-152(s0)
    2308:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffcf18>
    230c:	faf43c23          	sd	a5,-72(s0)
    2310:	fb843783          	ld	a5,-72(s0)
    2314:	02878713          	addi	a4,a5,40
    2318:	649c                	ld	a5,8(s1)
    231a:	f6f717e3          	bne	a4,a5,2288 <schedule_lst+0x36>
    ...
    231e:	800007b7          	lui	a5,0x80000
    2322:	fff7c793          	not	a5,a5
    ...
    232e:	f8f43c23          	sd	a5,-104(s0)
    2332:	f9843783          	ld	a5,-104(s0)
    2336:	17e1                	addi	a5,a5,-8
    2338:	faf43423          	sd	a5,-88(s0)
    233c:	a0f1                	j	2408 <schedule_lst+0x1b6>
        if (entry->release_time > args.current_time) {
    233e:	fa843783          	ld	a5,-88(s0)
    2342:	4f98                	lw	a4,24(a5)
    2344:	409c                	lw	a5,0(s1)
    2346:	0ae7d763          	bge	a5,a4,23f4 <schedule_lst+0x1a2>
            struct thread *upcoming_thread = entry->thrd;
    234a:	fa843783          	ld	a5,-88(s0)
    234e:	639c                	ld	a5,0(a5)
    2350:	f8f43423          	sd	a5,-120(s0)
            int upcoming_slack_time = upcoming_thread->current_deadline - entry->release_time - upcoming_thread->remaining_time;
    2354:	f8843783          	ld	a5,-120(s0)
    2358:	4ff8                	lw	a4,92(a5)
    235a:	fa843783          	ld	a5,-88(s0)
    235e:	4f9c                	lw	a5,24(a5)
    2360:	40f707bb          	subw	a5,a4,a5
    2364:	0007871b          	sext.w	a4,a5
    2368:	f8843783          	ld	a5,-120(s0)
    236c:	4fbc                	lw	a5,88(a5)
    236e:	40f707bb          	subw	a5,a4,a5
    2372:	f8f42223          	sw	a5,-124(s0)
    ...
    2376:	f8442703          	lw	a4,-124(s0)
    237a:	fc442783          	lw	a5,-60(s0)
    237e:	2701                	sext.w	a4,a4
    2380:	2781                	sext.w	a5,a5
    2382:	02f75163          	bge	a4,a5,23a4 <schedule_lst+0x152>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    2386:	fa843783          	ld	a5,-88(s0)
    238a:	4f98                	lw	a4,24(a5)
    238c:	fb442783          	lw	a5,-76(s0)
    2390:	85ba                	mv	a1,a4
    2392:	853e                	mv	a0,a5
    2394:	00000097          	auipc	ra,0x0
    2398:	e8a080e7          	jalr	-374(ra) # 221e <min>
    239c:	87aa                	mv	a5,a0
    239e:	faf42a23          	sw	a5,-76(s0)
    23a2:	a889                	j	23f4 <schedule_lst+0x1a2>
            } else if (upcoming_slack_time == min_slack_time && upcoming_thread->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))
    23a4:	f8442703          	lw	a4,-124(s0)
    23a8:	fc442783          	lw	a5,-60(s0)
    23ac:	2701                	sext.w	a4,a4
    23ae:	2781                	sext.w	a5,a5
    23b0:	04f71263          	bne	a4,a5,23f4 <schedule_lst+0x1a2>
    23b4:	f8843783          	ld	a5,-120(s0)
    23b8:	5fd4                	lw	a3,60(a5)
    23ba:	fc843783          	ld	a5,-56(s0)
    23be:	c789                	beqz	a5,23c8 <schedule_lst+0x176>
    23c0:	fc843783          	ld	a5,-56(s0)
    23c4:	5fdc                	lw	a5,60(a5)
    23c6:	a029                	j	23d0 <schedule_lst+0x17e>
    23c8:	800007b7          	lui	a5,0x80000
    23cc:	fff7c793          	not	a5,a5
    23d0:	873e                	mv	a4,a5
    23d2:	87b6                	mv	a5,a3
    23d4:	02e7d063          	bge	a5,a4,23f4 <schedule_lst+0x1a2>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    23d8:	fa843783          	ld	a5,-88(s0)
    23dc:	4f98                	lw	a4,24(a5)
    23de:	fb442783          	lw	a5,-76(s0)
    23e2:	85ba                	mv	a1,a4
    23e4:	853e                	mv	a0,a5
    23e6:	00000097          	auipc	ra,0x0
    23ea:	e38080e7          	jalr	-456(ra) # 221e <min>
    23ee:	87aa                	mv	a5,a0
    23f0:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(entry, args.release_queue, thread_list) {
    23f4:	fa843783          	ld	a5,-88(s0)
    23f8:	679c                	ld	a5,8(a5)
    23fa:	f6f43c23          	sd	a5,-136(s0)
    23fe:	f7843783          	ld	a5,-136(s0)
    2402:	17e1                	addi	a5,a5,-8
    2404:	faf43423          	sd	a5,-88(s0)
    2408:	fa843783          	ld	a5,-88(s0)
    240c:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffcf48>
    2410:	689c                	ld	a5,16(s1)
    2412:	f2f716e3          	bne	a4,a5,233e <schedule_lst+0xec>
        }
    }

    // Decide the allocated time based on current minimum slack or upcoming preemption needs
    if (min_slack_thread) {
    2416:	fc843783          	ld	a5,-56(s0)
    241a:	c3b1                	beqz	a5,245e <schedule_lst+0x20c>
    ...
    241c:	fb442783          	lw	a5,-76(s0)
    2420:	0007871b          	sext.w	a4,a5
    2424:	800007b7          	lui	a5,0x80000
    2428:	fff7c793          	not	a5,a5
    242c:	00f71663          	bne	a4,a5,2438 <schedule_lst+0x1e6>
    2430:	fc843783          	ld	a5,-56(s0)
    2434:	4fbc                	lw	a5,88(a5)
    2436:	a039                	j	2444 <schedule_lst+0x1f2>
    2438:	409c                	lw	a5,0(s1)
    243a:	fb442703          	lw	a4,-76(s0)
    243e:	40f707bb          	subw	a5,a4,a5
    2442:	2781                	sext.w	a5,a5
    2444:	f8f42a23          	sw	a5,-108(s0)
        r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    2448:	fc843783          	ld	a5,-56(s0)
    244c:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffcf68>
    2450:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = allocated_time;
    2454:	f9442783          	lw	a5,-108(s0)
    2458:	f4f42823          	sw	a5,-176(s0)
    245c:	a081                	j	249c <schedule_lst+0x24a>
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    245e:	649c                	ld	a5,8(s1)
    2460:	f4f43423          	sd	a5,-184(s0)
    ...
    2464:	fb442783          	lw	a5,-76(s0)
    2468:	0007871b          	sext.w	a4,a5
    246c:	800007b7          	lui	a5,0x80000
    2470:	fff7c793          	not	a5,a5
    2474:	00f70963          	beq	a4,a5,2486 <schedule_lst+0x234>
    2478:	409c                	lw	a5,0(s1)
    247a:	fb442703          	lw	a4,-76(s0)
    247e:	40f707bb          	subw	a5,a4,a5
    2482:	2781                	sext.w	a5,a5
    2484:	a811                	j	2498 <schedule_lst+0x246>
    2486:	689c                	ld	a5,16(s1)
    2488:	4098                	lw	a4,0(s1)
    248a:	85ba                	mv	a1,a4
    248c:	853e                	mv	a0,a5
    248e:	00000097          	auipc	ra,0x0
    2492:	a72080e7          	jalr	-1422(ra) # 1f00 <find_next_release_time>
    2496:	87aa                	mv	a5,a0
    2498:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    249c:	f4843783          	ld	a5,-184(s0)
    24a0:	f4f43c23          	sd	a5,-168(s0)
    24a4:	f5043783          	ld	a5,-176(s0)
    24a8:	f6f43023          	sd	a5,-160(s0)
    24ac:	4701                	li	a4,0
    24ae:	f5843703          	ld	a4,-168(s0)
    24b2:	4781                	li	a5,0
    24b4:	f6043783          	ld	a5,-160(s0)
    24b8:	893a                	mv	s2,a4
    24ba:	89be                	mv	s3,a5
    24bc:	874a                	mv	a4,s2
    24be:	87ce                	mv	a5,s3
    ...
    24c0:	853a                	mv	a0,a4
    24c2:	85be                	mv	a1,a5
    24c4:	70ea                	ld	ra,184(sp)
    24c6:	744a                	ld	s0,176(sp)
    24c8:	74aa                	ld	s1,168(sp)
    24ca:	790a                	ld	s2,160(sp)
    24cc:	69ea                	ld	s3,152(sp)
    24ce:	6129                	addi	sp,sp,192
    24d0:	8082                	ret

00000000000024d2 <find_earliest_impactful_release_time_dm>:

int find_earliest_impactful_release_time_dm(struct list_head *release_queue, int current_time, int current_deadline) {
    24d2:	715d                	addi	sp,sp,-80
    24d4:	e4a2                	sd	s0,72(sp)
    24d6:	0880                	addi	s0,sp,80
    24d8:	faa43c23          	sd	a0,-72(s0)
    24dc:	87ae                	mv	a5,a1
    24de:	8732                	mv	a4,a2
    24e0:	faf42a23          	sw	a5,-76(s0)
    24e4:	87ba                	mv	a5,a4
    24e6:	faf42823          	sw	a5,-80(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_event = INT_MAX;
    24ea:	800007b7          	lui	a5,0x80000
    24ee:	fff7c793          	not	a5,a5
    24f2:	fef42223          	sw	a5,-28(s0)
    struct thread *earliest_deadline_thread = NULL;
    24f6:	fc043c23          	sd	zero,-40(s0)
    earliest_deadline_thread->ID = INT_MAX;
    24fa:	fd843783          	ld	a5,-40(s0)
    24fe:	80000737          	lui	a4,0x80000
    2502:	fff74713          	not	a4,a4
    2506:	dfd8                	sw	a4,60(a5)

    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    2508:	fb843783          	ld	a5,-72(s0)
    250c:	639c                	ld	a5,0(a5)
    250e:	fcf43823          	sd	a5,-48(s0)
    2512:	fd043783          	ld	a5,-48(s0)
    2516:	17e1                	addi	a5,a5,-8
    2518:	fef43423          	sd	a5,-24(s0)
    251c:	a075                	j	25c8 <find_earliest_impactful_release_time_dm+0xf6>
        if (entry->release_time > current_time && entry->thrd->period < current_deadline) {
    251e:	fe843783          	ld	a5,-24(s0)
    2522:	4f98                	lw	a4,24(a5)
    2524:	fb442783          	lw	a5,-76(s0)
    2528:	2781                	sext.w	a5,a5
    252a:	02e7d963          	bge	a5,a4,255c <find_earliest_impactful_release_time_dm+0x8a>
    252e:	fe843783          	ld	a5,-24(s0)
    2532:	639c                	ld	a5,0(a5)
    2534:	4bb8                	lw	a4,80(a5)
    2536:	fb042783          	lw	a5,-80(s0)
    253a:	2781                	sext.w	a5,a5
    253c:	02f75063          	bge	a4,a5,255c <find_earliest_impactful_release_time_dm+0x8a>
            if (entry->release_time < earliest_impactful_event) {
    2540:	fe843783          	ld	a5,-24(s0)
    2544:	4f98                	lw	a4,24(a5)
    2546:	fe442783          	lw	a5,-28(s0)
    254a:	2781                	sext.w	a5,a5
    254c:	06f75463          	bge	a4,a5,25b4 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    2550:	fe843783          	ld	a5,-24(s0)
    2554:	4f9c                	lw	a5,24(a5)
    2556:	fef42223          	sw	a5,-28(s0)
            if (entry->release_time < earliest_impactful_event) {
    255a:	a8a9                	j	25b4 <find_earliest_impactful_release_time_dm+0xe2>
            }
        } 
    ...
    255c:	fe843783          	ld	a5,-24(s0)
    2560:	4f98                	lw	a4,24(a5)
    2562:	fb442783          	lw	a5,-76(s0)
    2566:	2781                	sext.w	a5,a5
    2568:	04e7d663          	bge	a5,a4,25b4 <find_earliest_impactful_release_time_dm+0xe2>
    256c:	fe843783          	ld	a5,-24(s0)
    2570:	639c                	ld	a5,0(a5)
    2572:	4bb8                	lw	a4,80(a5)
    2574:	fb042783          	lw	a5,-80(s0)
    2578:	2781                	sext.w	a5,a5
    257a:	02e79d63          	bne	a5,a4,25b4 <find_earliest_impactful_release_time_dm+0xe2>
            if (entry->release_time < earliest_impactful_event && entry->thrd->ID < earliest_deadline_thread->ID) {
    257e:	fe843783          	ld	a5,-24(s0)
    2582:	4f98                	lw	a4,24(a5)
    2584:	fe442783          	lw	a5,-28(s0)
    2588:	2781                	sext.w	a5,a5
    258a:	02f75563          	bge	a4,a5,25b4 <find_earliest_impactful_release_time_dm+0xe2>
    258e:	fe843783          	ld	a5,-24(s0)
    2592:	639c                	ld	a5,0(a5)
    2594:	5fd8                	lw	a4,60(a5)
    2596:	fd843783          	ld	a5,-40(s0)
    259a:	5fdc                	lw	a5,60(a5)
    259c:	00f75c63          	bge	a4,a5,25b4 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    25a0:	fe843783          	ld	a5,-24(s0)
    25a4:	4f9c                	lw	a5,24(a5)
    25a6:	fef42223          	sw	a5,-28(s0)
                earliest_deadline_thread = entry->thrd;
    25aa:	fe843783          	ld	a5,-24(s0)
    25ae:	639c                	ld	a5,0(a5)
    25b0:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    25b4:	fe843783          	ld	a5,-24(s0)
    25b8:	679c                	ld	a5,8(a5)
    25ba:	fcf43423          	sd	a5,-56(s0)
    25be:	fc843783          	ld	a5,-56(s0)
    25c2:	17e1                	addi	a5,a5,-8
    25c4:	fef43423          	sd	a5,-24(s0)
    25c8:	fe843783          	ld	a5,-24(s0)
    25cc:	07a1                	addi	a5,a5,8
    25ce:	fb843703          	ld	a4,-72(s0)
    25d2:	f4f716e3          	bne	a4,a5,251e <find_earliest_impactful_release_time_dm+0x4c>
            }
        }
    }
    ...
    25de:	800007b7          	lui	a5,0x80000
    25e2:	fff7c793          	not	a5,a5
    25e6:	00f70563          	beq	a4,a5,25f0 <find_earliest_impactful_release_time_dm+0x11e>
    25ea:	fe442783          	lw	a5,-28(s0)
    25ee:	a011                	j	25f2 <find_earliest_impactful_release_time_dm+0x120>
    25f0:	57fd                	li	a5,-1
}
    25f2:	853e                	mv	a0,a5
    25f4:	6426                	ld	s0,72(sp)
    25f6:	6161                	addi	sp,sp,80
    25f8:	8082                	ret

00000000000025fa <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    25fa:	7175                	addi	sp,sp,-144
    25fc:	e506                	sd	ra,136(sp)
    25fe:	e122                	sd	s0,128(sp)
    2600:	fca6                	sd	s1,120(sp)
    2602:	f8ca                	sd	s2,112(sp)
    2604:	f4ce                	sd	s3,104(sp)
    2606:	0900                	addi	s0,sp,144
    2608:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    260a:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    260e:	800007b7          	lui	a5,0x80000
    2612:	fff7c793          	not	a5,a5
    2616:	faf42e23          	sw	a5,-68(s0)

    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    261a:	649c                	ld	a5,8(s1)
    261c:	639c                	ld	a5,0(a5)
    261e:	faf43823          	sd	a5,-80(s0)
    2622:	fb043783          	ld	a5,-80(s0)
    2626:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffcf18>
    262a:	fcf43023          	sd	a5,-64(s0)
    262e:	a089                	j	2670 <schedule_dm+0x76>
        if (t->is_real_time && t->period < earliest_deadline) {
    2630:	fc043783          	ld	a5,-64(s0)
    2634:	43bc                	lw	a5,64(a5)
    2636:	c395                	beqz	a5,265a <schedule_dm+0x60>
    2638:	fc043783          	ld	a5,-64(s0)
    263c:	4bb8                	lw	a4,80(a5)
    263e:	fbc42783          	lw	a5,-68(s0)
    2642:	2781                	sext.w	a5,a5
    2644:	00f75b63          	bge	a4,a5,265a <schedule_dm+0x60>
            earliest_deadline_thread = t;
    2648:	fc043783          	ld	a5,-64(s0)
    264c:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    2650:	fc043783          	ld	a5,-64(s0)
    2654:	4bbc                	lw	a5,80(a5)
    2656:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    265a:	fc043783          	ld	a5,-64(s0)
    265e:	779c                	ld	a5,40(a5)
    2660:	f8f43c23          	sd	a5,-104(s0)
    2664:	f9843783          	ld	a5,-104(s0)
    2668:	fd878793          	addi	a5,a5,-40
    266c:	fcf43023          	sd	a5,-64(s0)
    2670:	fc043783          	ld	a5,-64(s0)
    2674:	02878713          	addi	a4,a5,40
    2678:	649c                	ld	a5,8(s1)
    267a:	faf71be3          	bne	a4,a5,2630 <schedule_dm+0x36>
        }
    }
    ...
    267e:	689c                	ld	a5,16(s1)
    2680:	4098                	lw	a4,0(s1)
    2682:	fbc42683          	lw	a3,-68(s0)
    2686:	8636                	mv	a2,a3
    2688:	85ba                	mv	a1,a4
    268a:	853e                	mv	a0,a5
    268c:	00000097          	auipc	ra,0x0
    2690:	e46080e7          	jalr	-442(ra) # 24d2 <find_earliest_impactful_release_time_dm>
    2694:	87aa                	mv	a5,a0
    2696:	faf42623          	sw	a5,-84(s0)

    if (earliest_deadline_thread) {
    269a:	fc843783          	ld	a5,-56(s0)
    269e:	c3c9                	beqz	a5,2720 <schedule_dm+0x126>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    26a0:	fc843783          	ld	a5,-56(s0)
    26a4:	4ff8                	lw	a4,92(a5)
    26a6:	409c                	lw	a5,0(s1)
    26a8:	40f707bb          	subw	a5,a4,a5
    26ac:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline < 0) {
    26b0:	fa842783          	lw	a5,-88(s0)
    26b4:	2781                	sext.w	a5,a5
    26b6:	0007db63          	bgez	a5,26cc <schedule_dm+0xd2>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    26ba:	fc843783          	ld	a5,-56(s0)
    26be:	02878793          	addi	a5,a5,40
    26c2:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    26c6:	f8042023          	sw	zero,-128(s0)
    26ca:	a88d                	j	273c <schedule_dm+0x142>
        } else {
    ...
    26cc:	fac42783          	lw	a5,-84(s0)
    26d0:	0007871b          	sext.w	a4,a5
    26d4:	57fd                	li	a5,-1
    26d6:	02f70563          	beq	a4,a5,2700 <schedule_dm+0x106>
    26da:	409c                	lw	a5,0(s1)
    26dc:	fac42703          	lw	a4,-84(s0)
    26e0:	40f707bb          	subw	a5,a4,a5
    26e4:	0007871b          	sext.w	a4,a5
    26e8:	fc843783          	ld	a5,-56(s0)
    26ec:	4fbc                	lw	a5,88(a5)
    26ee:	00f75963          	bge	a4,a5,2700 <schedule_dm+0x106>
    26f2:	409c                	lw	a5,0(s1)
    26f4:	fac42703          	lw	a4,-84(s0)
    26f8:	40f707bb          	subw	a5,a4,a5
    26fc:	2781                	sext.w	a5,a5
    26fe:	a021                	j	2706 <schedule_dm+0x10c>
    2700:	fc843783          	ld	a5,-56(s0)
    2704:	4fbc                	lw	a5,88(a5)
    2706:	faf42223          	sw	a5,-92(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    270a:	fc843783          	ld	a5,-56(s0)
    270e:	02878793          	addi	a5,a5,40
    2712:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    2716:	fa442783          	lw	a5,-92(s0)
    271a:	f8f42023          	sw	a5,-128(s0)
    271e:	a839                	j	273c <schedule_dm+0x142>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    2720:	649c                	ld	a5,8(s1)
    2722:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    2726:	689c                	ld	a5,16(s1)
    2728:	4098                	lw	a4,0(s1)
    272a:	85ba                	mv	a1,a4
    272c:	853e                	mv	a0,a5
    272e:	fffff097          	auipc	ra,0xfffff
    2732:	7d2080e7          	jalr	2002(ra) # 1f00 <find_next_release_time>
    2736:	87aa                	mv	a5,a0
    2738:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    273c:	f7843783          	ld	a5,-136(s0)
    2740:	f8f43423          	sd	a5,-120(s0)
    2744:	f8043783          	ld	a5,-128(s0)
    2748:	f8f43823          	sd	a5,-112(s0)
    274c:	4701                	li	a4,0
    274e:	f8843703          	ld	a4,-120(s0)
    2752:	4781                	li	a5,0
    2754:	f9043783          	ld	a5,-112(s0)
    2758:	893a                	mv	s2,a4
    275a:	89be                	mv	s3,a5
    275c:	874a                	mv	a4,s2
    275e:	87ce                	mv	a5,s3
    ...
    2760:	853a                	mv	a0,a4
    2762:	85be                	mv	a1,a5
    2764:	60aa                	ld	ra,136(sp)
    2766:	640a                	ld	s0,128(sp)
    2768:	74e6                	ld	s1,120(sp)
    276a:	7946                	ld	s2,112(sp)
    276c:	79a6                	ld	s3,104(sp)
    276e:	6149                	addi	sp,sp,144
    2770:	8082                	ret

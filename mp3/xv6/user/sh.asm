...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      32:	54a78793          	addi	a5,a5,1354 # 2578 <schedule_dm+0x23c>
      36:	97ba                	add	a5,a5,a4
      38:	439c                	lw	a5,0(a5)
      3a:	0007871b          	sext.w	a4,a5
      3e:	00002797          	auipc	a5,0x2
      42:	53a78793          	addi	a5,a5,1338 # 2578 <schedule_dm+0x23c>
      46:	97ba                	add	a5,a5,a4
      48:	8782                	jr	a5
  default:
    panic("runcmd");
      4a:	00002517          	auipc	a0,0x2
      4e:	4fe50513          	addi	a0,a0,1278 # 2548 <schedule_dm+0x20c>
  ...
  case EXEC:
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      98:	4bc58593          	addi	a1,a1,1212 # 2550 <schedule_dm+0x214>
      9c:	4509                	li	a0,2
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ea:	47a58593          	addi	a1,a1,1146 # 2560 <schedule_dm+0x224>
      ee:	4509                	li	a0,2
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     174:	40050513          	addi	a0,a0,1024 # 2570 <schedule_dm+0x234>
...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
     ...
     298:	2fc58593          	addi	a1,a1,764 # 2590 <schedule_dm+0x254>
     29c:	4509                	li	a0,2
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     314:	28850513          	addi	a0,a0,648 # 2598 <schedule_dm+0x25c>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     378:	34450513          	addi	a0,a0,836 # 26b8 <buf.1144>
     ...
     390:	32c70713          	addi	a4,a4,812 # 26b8 <buf.1144>
     ...
     3a2:	31d78793          	addi	a5,a5,797 # 26bb <buf.1144+0x3>
     3a6:	853e                	mv	a0,a5
     ...
     3ba:	30578793          	addi	a5,a5,773 # 26bb <buf.1144+0x3>
     3be:	863e                	mv	a2,a5
     3c0:	00002597          	auipc	a1,0x2
     3c4:	1e058593          	addi	a1,a1,480 # 25a0 <schedule_dm+0x264>
     3c8:	4509                	li	a0,2
    ...
    if(fork1() == 0)
     ...
     3e4:	2d850513          	addi	a0,a0,728 # 26b8 <buf.1144>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     40e:	2ae50513          	addi	a0,a0,686 # 26b8 <buf.1144>
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
     ...
     43e:	17658593          	addi	a1,a1,374 # 25b0 <schedule_dm+0x274>
     442:	4509                	li	a0,2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     47e:	13e50513          	addi	a0,a0,318 # 25b8 <schedule_dm+0x27c>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a4:	00850513          	addi	a0,a0,8 # 26a8 <whitespace>
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     7a0:	f0c50513          	addi	a0,a0,-244 # 26a8 <whitespace>
     ...
     7be:	ef650513          	addi	a0,a0,-266 # 26b0 <symbols>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     810:	e9c50513          	addi	a0,a0,-356 # 26a8 <whitespace>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     87c:	e3050513          	addi	a0,a0,-464 # 26a8 <whitespace>
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     916:	cae60613          	addi	a2,a2,-850 # 25c0 <schedule_dm+0x284>
  ...
  if(s != es){
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     93e:	c8e58593          	addi	a1,a1,-882 # 25c8 <schedule_dm+0x28c>
     942:	4509                	li	a0,2
     944:	00001097          	auipc	ra,0x1
     948:	f96080e7          	jalr	-106(ra) # 18da <fprintf>
    panic("syntax");
     94c:	00002517          	auipc	a0,0x2
     950:	c8c50513          	addi	a0,a0,-884 # 25d8 <schedule_dm+0x29c>
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     9c6:	c1e60613          	addi	a2,a2,-994 # 25e0 <schedule_dm+0x2a4>
  ...
  if(peek(ps, es, ";")){
     ...
     9e2:	c0a60613          	addi	a2,a2,-1014 # 25e8 <schedule_dm+0x2ac>
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     a68:	b8c60613          	addi	a2,a2,-1140 # 25f0 <schedule_dm+0x2b4>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     b22:	ada50513          	addi	a0,a0,-1318 # 25f8 <schedule_dm+0x2bc>
  ...
  while(peek(ps, es, "<>")){
     ...
     bd6:	a4660613          	addi	a2,a2,-1466 # 2618 <schedule_dm+0x2dc>
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     c12:	a1260613          	addi	a2,a2,-1518 # 2620 <schedule_dm+0x2e4>
    ...
    panic("parseblock");
     ...
     c2e:	9fe50513          	addi	a0,a0,-1538 # 2628 <schedule_dm+0x2ec>
  ...
  if(!peek(ps, es, ")"))
     ...
     c66:	9d660613          	addi	a2,a2,-1578 # 2638 <schedule_dm+0x2fc>
    ...
    panic("syntax - missing )");
     ...
     c82:	9c250513          	addi	a0,a0,-1598 # 2640 <schedule_dm+0x304>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     cdc:	94860613          	addi	a2,a2,-1720 # 2620 <schedule_dm+0x2e4>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     d78:	86450513          	addi	a0,a0,-1948 # 25d8 <schedule_dm+0x29c>
    ...
    if(argc >= MAXARGS)
     ...
     dc6:	89650513          	addi	a0,a0,-1898 # 2658 <schedule_dm+0x31c>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     dee:	87e60613          	addi	a2,a2,-1922 # 2668 <schedule_dm+0x32c>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     e66:	80e78793          	addi	a5,a5,-2034 # 2670 <schedule_dm+0x334>
     e6a:	97ba                	add	a5,a5,a4
     e6c:	439c                	lw	a5,0(a5)
     e6e:	0007871b          	sext.w	a4,a5
     e72:	00001797          	auipc	a5,0x1
     e76:	7fe78793          	addi	a5,a5,2046 # 2670 <schedule_dm+0x334>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1554:	14068693          	addi	a3,a3,320 # 2690 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    162e:	06670713          	addi	a4,a4,102 # 2690 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    17ee:	e9e78793          	addi	a5,a5,-354 # 2688 <schedule_dm+0x34c>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    199a:	d9a78793          	addi	a5,a5,-614 # 2730 <freep>
  ...
  freep = p;
    ...
    1a92:	ca278793          	addi	a5,a5,-862 # 2730 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1b14:	c2078793          	addi	a5,a5,-992 # 2730 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1b46:	bee78793          	addi	a5,a5,-1042 # 2730 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1c04:	b3078793          	addi	a5,a5,-1232 # 2730 <freep>
    ...
    1c1a:	b1a78793          	addi	a5,a5,-1254 # 2730 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    1df0:	94c78793          	addi	a5,a5,-1716 # 2738 <last_thread.1226>
    ...
    1e4c:	8f078793          	addi	a5,a5,-1808 # 2738 <last_thread.1226>
    1e50:	639c                	ld	a5,0(a5)
    1e52:	c385                	beqz	a5,1e72 <schedule_wrr+0xd6>
    1e54:	00001797          	auipc	a5,0x1
    1e58:	8e478793          	addi	a5,a5,-1820 # 2738 <last_thread.1226>
    ...
    1e68:	8d478793          	addi	a5,a5,-1836 # 2738 <last_thread.1226>
    ...
    1eb8:	88478793          	addi	a5,a5,-1916 # 2738 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    1fea:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd148>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    211c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd148>
    ...
    21b6:	a00d                	j	21d8 <schedule_sjf+0x102>
    } else {
    ...
    21c6:	57fd                	li	a5,-1
    21c8:	00f70563          	beq	a4,a5,21d2 <schedule_sjf+0xfc>
    21cc:	fb442783          	lw	a5,-76(s0)
    21d0:	a011                	j	21d4 <schedule_sjf+0xfe>
    21d2:	4785                	li	a5,1
    21d4:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    21d8:	f8043783          	ld	a5,-128(s0)
    21dc:	f8f43823          	sd	a5,-112(s0)
    21e0:	f8843783          	ld	a5,-120(s0)
    21e4:	f8f43c23          	sd	a5,-104(s0)
    21e8:	4701                	li	a4,0
    21ea:	f9043703          	ld	a4,-112(s0)
    21ee:	4781                	li	a5,0
    21f0:	f9843783          	ld	a5,-104(s0)
    21f4:	893a                	mv	s2,a4
    21f6:	89be                	mv	s3,a5
    21f8:	874a                	mv	a4,s2
    21fa:	87ce                	mv	a5,s3
    ...
    21fc:	853a                	mv	a0,a4
    21fe:	85be                	mv	a1,a5
    2200:	70e6                	ld	ra,120(sp)
    2202:	7446                	ld	s0,112(sp)
    2204:	74a6                	ld	s1,104(sp)
    2206:	7906                	ld	s2,96(sp)
    2208:	69e6                	ld	s3,88(sp)
    220a:	6109                	addi	sp,sp,128
    220c:	8082                	ret

000000000000220e <schedule_lst>:
...
{
    220e:	7119                	addi	sp,sp,-128
    2210:	fc86                	sd	ra,120(sp)
    2212:	f8a2                	sd	s0,112(sp)
    2214:	f4a6                	sd	s1,104(sp)
    2216:	f0ca                	sd	s2,96(sp)
    2218:	ecce                	sd	s3,88(sp)
    221a:	0100                	addi	s0,sp,128
    221c:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the least-slack-time scheduling algorithm
    struct thread *min_slack = NULL;
    221e:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    2222:	800007b7          	lui	a5,0x80000
    2226:	fff7c793          	not	a5,a5
    222a:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;

    // Find the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    222e:	649c                	ld	a5,8(s1)
    2230:	639c                	ld	a5,0(a5)
    2232:	faf43823          	sd	a5,-80(s0)
    2236:	fb043783          	ld	a5,-80(s0)
    223a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd148>
    223e:	faf43c23          	sd	a5,-72(s0)
    2242:	a8b5                	j	22be <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    2244:	fb843783          	ld	a5,-72(s0)
    2248:	47f8                	lw	a4,76(a5)
    224a:	409c                	lw	a5,0(s1)
    224c:	40f707bb          	subw	a5,a4,a5
    2250:	0007871b          	sext.w	a4,a5
    2254:	fb843783          	ld	a5,-72(s0)
    2258:	4fbc                	lw	a5,88(a5)
    225a:	40f707bb          	subw	a5,a4,a5
    225e:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    2262:	fc843783          	ld	a5,-56(s0)
    2266:	cb8d                	beqz	a5,2298 <schedule_lst+0x8a>
    2268:	fac42703          	lw	a4,-84(s0)
    226c:	fc442783          	lw	a5,-60(s0)
    2270:	2701                	sext.w	a4,a4
    2272:	2781                	sext.w	a5,a5
    2274:	02f74263          	blt	a4,a5,2298 <schedule_lst+0x8a>
    2278:	fac42703          	lw	a4,-84(s0)
    227c:	fc442783          	lw	a5,-60(s0)
    2280:	2701                	sext.w	a4,a4
    2282:	2781                	sext.w	a5,a5
    2284:	02f71263          	bne	a4,a5,22a8 <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    2288:	fb843783          	ld	a5,-72(s0)
    228c:	5fd8                	lw	a4,60(a5)
    228e:	fc843783          	ld	a5,-56(s0)
    2292:	5fdc                	lw	a5,60(a5)
    2294:	00f75a63          	bge	a4,a5,22a8 <schedule_lst+0x9a>
            min_slack = t;
    2298:	fb843783          	ld	a5,-72(s0)
    229c:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    22a0:	fac42783          	lw	a5,-84(s0)
    22a4:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    22a8:	fb843783          	ld	a5,-72(s0)
    22ac:	779c                	ld	a5,40(a5)
    22ae:	faf43023          	sd	a5,-96(s0)
    22b2:	fa043783          	ld	a5,-96(s0)
    22b6:	fd878793          	addi	a5,a5,-40
    22ba:	faf43c23          	sd	a5,-72(s0)
    22be:	fb843783          	ld	a5,-72(s0)
    22c2:	02878713          	addi	a4,a5,40
    22c6:	649c                	ld	a5,8(s1)
    22c8:	f6f71ee3          	bne	a4,a5,2244 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    22cc:	fc843783          	ld	a5,-56(s0)
    22d0:	cf89                	beqz	a5,22ea <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    22d2:	fc843783          	ld	a5,-56(s0)
    22d6:	02878793          	addi	a5,a5,40
    22da:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    22de:	fc843783          	ld	a5,-56(s0)
    22e2:	4fbc                	lw	a5,88(a5)
    22e4:	f8f42423          	sw	a5,-120(s0)
    22e8:	a839                	j	2306 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    22ea:	649c                	ld	a5,8(s1)
    22ec:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    22f0:	689c                	ld	a5,16(s1)
    22f2:	4098                	lw	a4,0(s1)
    22f4:	85ba                	mv	a1,a4
    22f6:	853e                	mv	a0,a5
    22f8:	00000097          	auipc	ra,0x0
    22fc:	c08080e7          	jalr	-1016(ra) # 1f00 <find_next_release_time>
    2300:	87aa                	mv	a5,a0
    2302:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    2306:	f8043783          	ld	a5,-128(s0)
    230a:	f8f43823          	sd	a5,-112(s0)
    230e:	f8843783          	ld	a5,-120(s0)
    2312:	f8f43c23          	sd	a5,-104(s0)
    2316:	4701                	li	a4,0
    2318:	f9043703          	ld	a4,-112(s0)
    231c:	4781                	li	a5,0
    231e:	f9843783          	ld	a5,-104(s0)
    2322:	893a                	mv	s2,a4
    2324:	89be                	mv	s3,a5
    2326:	874a                	mv	a4,s2
    2328:	87ce                	mv	a5,s3
    ...
    232a:	853a                	mv	a0,a4
    232c:	85be                	mv	a1,a5
    232e:	70e6                	ld	ra,120(sp)
    2330:	7446                	ld	s0,112(sp)
    2332:	74a6                	ld	s1,104(sp)
    2334:	7906                	ld	s2,96(sp)
    2336:	69e6                	ld	s3,88(sp)
    2338:	6109                	addi	sp,sp,128
    233a:	8082                	ret

000000000000233c <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    233c:	7135                	addi	sp,sp,-160
    233e:	ed06                	sd	ra,152(sp)
    2340:	e922                	sd	s0,144(sp)
    2342:	e526                	sd	s1,136(sp)
    2344:	e14a                	sd	s2,128(sp)
    2346:	fcce                	sd	s3,120(sp)
    2348:	1100                	addi	s0,sp,160
    234a:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    234c:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    2350:	800007b7          	lui	a5,0x80000
    2354:	fff7c793          	not	a5,a5
    2358:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    235c:	649c                	ld	a5,8(s1)
    235e:	639c                	ld	a5,0(a5)
    2360:	faf43423          	sd	a5,-88(s0)
    2364:	fa843783          	ld	a5,-88(s0)
    2368:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd148>
    236c:	fcf43023          	sd	a5,-64(s0)
    2370:	a841                	j	2400 <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    2372:	fc043783          	ld	a5,-64(s0)
    2376:	43bc                	lw	a5,64(a5)
    2378:	cb95                	beqz	a5,23ac <schedule_dm+0x70>
    237a:	fc043783          	ld	a5,-64(s0)
    237e:	4bbc                	lw	a5,80(a5)
    2380:	873e                	mv	a4,a5
    2382:	57fd                	li	a5,-1
    2384:	02f70463          	beq	a4,a5,23ac <schedule_dm+0x70>
    2388:	fc043783          	ld	a5,-64(s0)
    238c:	4ff8                	lw	a4,92(a5)
    238e:	fbc42783          	lw	a5,-68(s0)
    2392:	2781                	sext.w	a5,a5
    2394:	00f75c63          	bge	a4,a5,23ac <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    2398:	fc043783          	ld	a5,-64(s0)
    239c:	4ffc                	lw	a5,92(a5)
    239e:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    23a2:	fc043783          	ld	a5,-64(s0)
    23a6:	fcf43423          	sd	a5,-56(s0)
    23aa:	a081                	j	23ea <schedule_dm+0xae>
        } else if (t->is_real_time && t->period != -1 && t->current_deadline == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    23ac:	fc043783          	ld	a5,-64(s0)
    23b0:	43bc                	lw	a5,64(a5)
    23b2:	cf85                	beqz	a5,23ea <schedule_dm+0xae>
    23b4:	fc043783          	ld	a5,-64(s0)
    23b8:	4bbc                	lw	a5,80(a5)
    23ba:	873e                	mv	a4,a5
    23bc:	57fd                	li	a5,-1
    23be:	02f70663          	beq	a4,a5,23ea <schedule_dm+0xae>
    23c2:	fc043783          	ld	a5,-64(s0)
    23c6:	4ff8                	lw	a4,92(a5)
    23c8:	fbc42783          	lw	a5,-68(s0)
    23cc:	2781                	sext.w	a5,a5
    23ce:	00e79e63          	bne	a5,a4,23ea <schedule_dm+0xae>
    23d2:	fc043783          	ld	a5,-64(s0)
    23d6:	5fd8                	lw	a4,60(a5)
    23d8:	fc843783          	ld	a5,-56(s0)
    23dc:	5fdc                	lw	a5,60(a5)
    23de:	00f75663          	bge	a4,a5,23ea <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    23e2:	fc043783          	ld	a5,-64(s0)
    23e6:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    23ea:	fc043783          	ld	a5,-64(s0)
    23ee:	779c                	ld	a5,40(a5)
    23f0:	f8f43423          	sd	a5,-120(s0)
    23f4:	f8843783          	ld	a5,-120(s0)
    23f8:	fd878793          	addi	a5,a5,-40
    23fc:	fcf43023          	sd	a5,-64(s0)
    2400:	fc043783          	ld	a5,-64(s0)
    2404:	02878713          	addi	a4,a5,40
    2408:	649c                	ld	a5,8(s1)
    240a:	f6f714e3          	bne	a4,a5,2372 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    240e:	fc843783          	ld	a5,-56(s0)
    2412:	c7a5                	beqz	a5,247a <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    2414:	fc843783          	ld	a5,-56(s0)
    2418:	4ff8                	lw	a4,92(a5)
    241a:	409c                	lw	a5,0(s1)
    241c:	40f707bb          	subw	a5,a4,a5
    2420:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    2424:	fc843783          	ld	a5,-56(s0)
    2428:	4fb8                	lw	a4,88(a5)
    242a:	f9442783          	lw	a5,-108(s0)
    242e:	2781                	sext.w	a5,a5
    2430:	00e7db63          	bge	a5,a4,2446 <schedule_dm+0x10a>
    ...
    2434:	fc843783          	ld	a5,-56(s0)
    2438:	02878793          	addi	a5,a5,40
    243c:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    2440:	f6042823          	sw	zero,-144(s0)
    2444:	a0f1                	j	2510 <schedule_dm+0x1d4>
        } else {
    ...
    244c:	863e                	mv	a2,a5
    244e:	f9442783          	lw	a5,-108(s0)
    2452:	0007869b          	sext.w	a3,a5
    2456:	0006071b          	sext.w	a4,a2
    245a:	00d75363          	bge	a4,a3,2460 <schedule_dm+0x124>
    245e:	87b2                	mv	a5,a2
    2460:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    2464:	fc843783          	ld	a5,-56(s0)
    2468:	02878793          	addi	a5,a5,40
    246c:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    2470:	f9042783          	lw	a5,-112(s0)
    2474:	f6f42823          	sw	a5,-144(s0)
    2478:	a861                	j	2510 <schedule_dm+0x1d4>
        }
    } else {
    ...
    247a:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    247e:	649c                	ld	a5,8(s1)
    2480:	639c                	ld	a5,0(a5)
    2482:	faf43023          	sd	a5,-96(s0)
    2486:	fa043783          	ld	a5,-96(s0)
    248a:	fd878793          	addi	a5,a5,-40
    248e:	fcf43023          	sd	a5,-64(s0)
    2492:	a81d                	j	24c8 <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    2494:	fb043783          	ld	a5,-80(s0)
    2498:	cb89                	beqz	a5,24aa <schedule_dm+0x16e>
    249a:	fc043783          	ld	a5,-64(s0)
    249e:	5fd8                	lw	a4,60(a5)
    24a0:	fb043783          	ld	a5,-80(s0)
    24a4:	5fdc                	lw	a5,60(a5)
    24a6:	00f75663          	bge	a4,a5,24b2 <schedule_dm+0x176>
                smallest_id_thread = t;
    24aa:	fc043783          	ld	a5,-64(s0)
    24ae:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    24b2:	fc043783          	ld	a5,-64(s0)
    24b6:	779c                	ld	a5,40(a5)
    24b8:	f8f43c23          	sd	a5,-104(s0)
    24bc:	f9843783          	ld	a5,-104(s0)
    24c0:	fd878793          	addi	a5,a5,-40
    24c4:	fcf43023          	sd	a5,-64(s0)
    24c8:	fc043783          	ld	a5,-64(s0)
    24cc:	02878713          	addi	a4,a5,40
    24d0:	649c                	ld	a5,8(s1)
    24d2:	fcf711e3          	bne	a4,a5,2494 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    24d6:	fb043783          	ld	a5,-80(s0)
    24da:	cf89                	beqz	a5,24f4 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    24dc:	fb043783          	ld	a5,-80(s0)
    24e0:	02878793          	addi	a5,a5,40
    24e4:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    24e8:	fb043783          	ld	a5,-80(s0)
    24ec:	4fbc                	lw	a5,88(a5)
    24ee:	f6f42823          	sw	a5,-144(s0)
    24f2:	a839                	j	2510 <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    24f4:	649c                	ld	a5,8(s1)
    24f6:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    24fa:	689c                	ld	a5,16(s1)
    24fc:	4098                	lw	a4,0(s1)
    24fe:	85ba                	mv	a1,a4
    2500:	853e                	mv	a0,a5
    2502:	00000097          	auipc	ra,0x0
    2506:	9fe080e7          	jalr	-1538(ra) # 1f00 <find_next_release_time>
    250a:	87aa                	mv	a5,a0
    250c:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    2510:	f6843783          	ld	a5,-152(s0)
    2514:	f6f43c23          	sd	a5,-136(s0)
    2518:	f7043783          	ld	a5,-144(s0)
    251c:	f8f43023          	sd	a5,-128(s0)
    2520:	4701                	li	a4,0
    2522:	f7843703          	ld	a4,-136(s0)
    2526:	4781                	li	a5,0
    2528:	f8043783          	ld	a5,-128(s0)
    252c:	893a                	mv	s2,a4
    252e:	89be                	mv	s3,a5
    2530:	874a                	mv	a4,s2
    2532:	87ce                	mv	a5,s3
    ...
    2534:	853a                	mv	a0,a4
    2536:	85be                	mv	a1,a5
    2538:	60ea                	ld	ra,152(sp)
    253a:	644a                	ld	s0,144(sp)
    253c:	64aa                	ld	s1,136(sp)
    253e:	690a                	ld	s2,128(sp)
    2540:	79e6                	ld	s3,120(sp)
    2542:	610d                	addi	sp,sp,160
    2544:	8082                	ret

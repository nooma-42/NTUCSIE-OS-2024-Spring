...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      32:	3ea78793          	addi	a5,a5,1002 # 2418 <schedule_dm+0x23e>
      36:	97ba                	add	a5,a5,a4
      38:	439c                	lw	a5,0(a5)
      3a:	0007871b          	sext.w	a4,a5
      3e:	00002797          	auipc	a5,0x2
      42:	3da78793          	addi	a5,a5,986 # 2418 <schedule_dm+0x23e>
      46:	97ba                	add	a5,a5,a4
      48:	8782                	jr	a5
  default:
    panic("runcmd");
      4a:	00002517          	auipc	a0,0x2
      4e:	39e50513          	addi	a0,a0,926 # 23e8 <schedule_dm+0x20e>
  ...
  case EXEC:
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      98:	35c58593          	addi	a1,a1,860 # 23f0 <schedule_dm+0x216>
      9c:	4509                	li	a0,2
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ea:	31a58593          	addi	a1,a1,794 # 2400 <schedule_dm+0x226>
      ee:	4509                	li	a0,2
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     174:	2a050513          	addi	a0,a0,672 # 2410 <schedule_dm+0x236>
...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
     ...
     298:	19c58593          	addi	a1,a1,412 # 2430 <schedule_dm+0x256>
     29c:	4509                	li	a0,2
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     314:	12850513          	addi	a0,a0,296 # 2438 <schedule_dm+0x25e>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     378:	20c50513          	addi	a0,a0,524 # 2580 <buf.1144>
     ...
     390:	1f470713          	addi	a4,a4,500 # 2580 <buf.1144>
     ...
     3a2:	1e578793          	addi	a5,a5,485 # 2583 <buf.1144+0x3>
     3a6:	853e                	mv	a0,a5
     ...
     3ba:	1cd78793          	addi	a5,a5,461 # 2583 <buf.1144+0x3>
     3be:	863e                	mv	a2,a5
     3c0:	00002597          	auipc	a1,0x2
     3c4:	08058593          	addi	a1,a1,128 # 2440 <schedule_dm+0x266>
     3c8:	4509                	li	a0,2
    ...
    if(fork1() == 0)
     ...
     3e4:	1a050513          	addi	a0,a0,416 # 2580 <buf.1144>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     40e:	17650513          	addi	a0,a0,374 # 2580 <buf.1144>
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
     ...
     43e:	01658593          	addi	a1,a1,22 # 2450 <schedule_dm+0x276>
     442:	4509                	li	a0,2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     47e:	fde50513          	addi	a0,a0,-34 # 2458 <schedule_dm+0x27e>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a4:	ed050513          	addi	a0,a0,-304 # 2570 <whitespace>
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     7a0:	dd450513          	addi	a0,a0,-556 # 2570 <whitespace>
     ...
     7be:	dbe50513          	addi	a0,a0,-578 # 2578 <symbols>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     810:	d6450513          	addi	a0,a0,-668 # 2570 <whitespace>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     87c:	cf850513          	addi	a0,a0,-776 # 2570 <whitespace>
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     916:	b4e60613          	addi	a2,a2,-1202 # 2460 <schedule_dm+0x286>
  ...
  if(s != es){
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     93e:	b2e58593          	addi	a1,a1,-1234 # 2468 <schedule_dm+0x28e>
     942:	4509                	li	a0,2
     944:	00001097          	auipc	ra,0x1
     948:	f96080e7          	jalr	-106(ra) # 18da <fprintf>
    panic("syntax");
     94c:	00002517          	auipc	a0,0x2
     950:	b2c50513          	addi	a0,a0,-1236 # 2478 <schedule_dm+0x29e>
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     9c6:	abe60613          	addi	a2,a2,-1346 # 2480 <schedule_dm+0x2a6>
  ...
  if(peek(ps, es, ";")){
     ...
     9e2:	aaa60613          	addi	a2,a2,-1366 # 2488 <schedule_dm+0x2ae>
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     a68:	a2c60613          	addi	a2,a2,-1492 # 2490 <schedule_dm+0x2b6>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     b22:	97a50513          	addi	a0,a0,-1670 # 2498 <schedule_dm+0x2be>
  ...
  while(peek(ps, es, "<>")){
     ...
     bd6:	8e660613          	addi	a2,a2,-1818 # 24b8 <schedule_dm+0x2de>
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     c12:	8b260613          	addi	a2,a2,-1870 # 24c0 <schedule_dm+0x2e6>
    ...
    panic("parseblock");
     ...
     c2e:	89e50513          	addi	a0,a0,-1890 # 24c8 <schedule_dm+0x2ee>
  ...
  if(!peek(ps, es, ")"))
     ...
     c66:	87660613          	addi	a2,a2,-1930 # 24d8 <schedule_dm+0x2fe>
    ...
    panic("syntax - missing )");
     ...
     c82:	86250513          	addi	a0,a0,-1950 # 24e0 <schedule_dm+0x306>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     cdc:	7e860613          	addi	a2,a2,2024 # 24c0 <schedule_dm+0x2e6>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     d78:	70450513          	addi	a0,a0,1796 # 2478 <schedule_dm+0x29e>
    ...
    if(argc >= MAXARGS)
     ...
     dc6:	73650513          	addi	a0,a0,1846 # 24f8 <schedule_dm+0x31e>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     dee:	71e60613          	addi	a2,a2,1822 # 2508 <schedule_dm+0x32e>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     e66:	6ae78793          	addi	a5,a5,1710 # 2510 <schedule_dm+0x336>
     e6a:	97ba                	add	a5,a5,a4
     e6c:	439c                	lw	a5,0(a5)
     e6e:	0007871b          	sext.w	a4,a5
     e72:	00001797          	auipc	a5,0x1
     e76:	69e78793          	addi	a5,a5,1694 # 2510 <schedule_dm+0x336>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1554:	00868693          	addi	a3,a3,8 # 2558 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    162e:	f2e70713          	addi	a4,a4,-210 # 2558 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    17ee:	d3e78793          	addi	a5,a5,-706 # 2528 <schedule_dm+0x34e>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    199a:	c6278793          	addi	a5,a5,-926 # 25f8 <freep>
  ...
  freep = p;
    ...
    1a92:	b6a78793          	addi	a5,a5,-1174 # 25f8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1b14:	ae878793          	addi	a5,a5,-1304 # 25f8 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1b46:	ab678793          	addi	a5,a5,-1354 # 25f8 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1c04:	9f878793          	addi	a5,a5,-1544 # 25f8 <freep>
    ...
    1c1a:	9e278793          	addi	a5,a5,-1566 # 25f8 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    1df0:	81478793          	addi	a5,a5,-2028 # 2600 <last_thread.1226>
    ...
    1e4c:	7b878793          	addi	a5,a5,1976 # 2600 <last_thread.1226>
    1e50:	639c                	ld	a5,0(a5)
    1e52:	c385                	beqz	a5,1e72 <schedule_wrr+0xd6>
    1e54:	00000797          	auipc	a5,0x0
    1e58:	7ac78793          	addi	a5,a5,1964 # 2600 <last_thread.1226>
    1e5c:	639c                	ld	a5,0(a5)
    1e5e:	4fbc                	lw	a5,88(a5)
    1e60:	00f05963          	blez	a5,1e72 <schedule_wrr+0xd6>
        selected_thread = last_thread;
    1e64:	00000797          	auipc	a5,0x0
    1e68:	79c78793          	addi	a5,a5,1948 # 2600 <last_thread.1226>
    ...
    1eb4:	00000797          	auipc	a5,0x0
    1eb8:	74c78793          	addi	a5,a5,1868 # 2600 <last_thread.1226>
...
0000000000001f00 <schedule_sjf>:

struct threads_sched_result schedule_sjf(struct threads_sched_args args)
{
    1f00:	7119                	addi	sp,sp,-128
    1f02:	fc86                	sd	ra,120(sp)
    1f04:	f8a2                	sd	s0,112(sp)
    1f06:	f4a6                	sd	s1,104(sp)
    1f08:	f0ca                	sd	s2,96(sp)
    1f0a:	ecce                	sd	s3,88(sp)
    1f0c:	0100                	addi	s0,sp,128
    1f0e:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the shortest-job-first scheduling algorithm
    struct thread *shortest_job = NULL;
    1f10:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int shortest_time = INT_MAX;
    1f14:	800007b7          	lui	a5,0x80000
    1f18:	fff7c793          	not	a5,a5
    1f1c:	faf42e23          	sw	a5,-68(s0)

    // Find the thread with the shortest remaining time that is ready to run
    list_for_each_entry(t, args.run_queue, thread_list) {
    1f20:	649c                	ld	a5,8(s1)
    1f22:	639c                	ld	a5,0(a5)
    1f24:	faf43823          	sd	a5,-80(s0)
    1f28:	fb043783          	ld	a5,-80(s0)
    1f2c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd280>
    1f30:	fcf43023          	sd	a5,-64(s0)
    1f34:	a8a9                	j	1f8e <schedule_sjf+0x8e>
        printf("Thread ID: %d, Remaining Time: %d\n", t->ID, t->remaining_time);
    1f36:	fc043783          	ld	a5,-64(s0)
    1f3a:	5fd8                	lw	a4,60(a5)
    1f3c:	fc043783          	ld	a5,-64(s0)
    1f40:	4fbc                	lw	a5,88(a5)
    1f42:	863e                	mv	a2,a5
    1f44:	85ba                	mv	a1,a4
    1f46:	00000517          	auipc	a0,0x0
    1f4a:	5ea50513          	addi	a0,a0,1514 # 2530 <schedule_dm+0x356>
    1f4e:	00000097          	auipc	ra,0x0
    1f52:	9e4080e7          	jalr	-1564(ra) # 1932 <printf>
        if (t->remaining_time < shortest_time) {
    1f56:	fc043783          	ld	a5,-64(s0)
    1f5a:	4fb8                	lw	a4,88(a5)
    1f5c:	fbc42783          	lw	a5,-68(s0)
    1f60:	2781                	sext.w	a5,a5
    1f62:	00f75b63          	bge	a4,a5,1f78 <schedule_sjf+0x78>
            shortest_time = t->remaining_time;
    1f66:	fc043783          	ld	a5,-64(s0)
    1f6a:	4fbc                	lw	a5,88(a5)
    1f6c:	faf42e23          	sw	a5,-68(s0)
            shortest_job = t;
    1f70:	fc043783          	ld	a5,-64(s0)
    1f74:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1f78:	fc043783          	ld	a5,-64(s0)
    1f7c:	779c                	ld	a5,40(a5)
    1f7e:	faf43423          	sd	a5,-88(s0)
    1f82:	fa843783          	ld	a5,-88(s0)
    1f86:	fd878793          	addi	a5,a5,-40
    1f8a:	fcf43023          	sd	a5,-64(s0)
    1f8e:	fc043783          	ld	a5,-64(s0)
    1f92:	02878713          	addi	a4,a5,40
    1f96:	649c                	ld	a5,8(s1)
    1f98:	f8f71fe3          	bne	a4,a5,1f36 <schedule_sjf+0x36>
        }
    }

    if (shortest_job) {
    1f9c:	fc843783          	ld	a5,-56(s0)
    1fa0:	cf89                	beqz	a5,1fba <schedule_sjf+0xba>
        r.scheduled_thread_list_member = &shortest_job->thread_list;
    1fa2:	fc843783          	ld	a5,-56(s0)
    1fa6:	02878793          	addi	a5,a5,40
    1faa:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = shortest_job->remaining_time;  // Allow the thread to run to completion
    1fae:	fc843783          	ld	a5,-56(s0)
    1fb2:	4fbc                	lw	a5,88(a5)
    1fb4:	f8f42823          	sw	a5,-112(s0)
    1fb8:	a039                	j	1fc6 <schedule_sjf+0xc6>
    } else {
        // If no threads are ready, find the next release time or idle
        r.scheduled_thread_list_member = args.run_queue;
    1fba:	649c                	ld	a5,8(s1)
    1fbc:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;  // Default minimal quantum if unsure
    1fc0:	4785                	li	a5,1
    1fc2:	f8f42823          	sw	a5,-112(s0)
    }
    return r;
    1fc6:	f8843783          	ld	a5,-120(s0)
    1fca:	f8f43c23          	sd	a5,-104(s0)
    1fce:	f9043783          	ld	a5,-112(s0)
    1fd2:	faf43023          	sd	a5,-96(s0)
    1fd6:	4701                	li	a4,0
    1fd8:	f9843703          	ld	a4,-104(s0)
    1fdc:	4781                	li	a5,0
    1fde:	fa043783          	ld	a5,-96(s0)
    1fe2:	893a                	mv	s2,a4
    1fe4:	89be                	mv	s3,a5
    1fe6:	874a                	mv	a4,s2
    1fe8:	87ce                	mv	a5,s3
    ...
    1fea:	853a                	mv	a0,a4
    1fec:	85be                	mv	a1,a5
    1fee:	70e6                	ld	ra,120(sp)
    1ff0:	7446                	ld	s0,112(sp)
    1ff2:	74a6                	ld	s1,104(sp)
    1ff4:	7906                	ld	s2,96(sp)
    1ff6:	69e6                	ld	s3,88(sp)
    1ff8:	6109                	addi	sp,sp,128
    1ffa:	8082                	ret

0000000000001ffc <find_next_release_time>:

int find_next_release_time(struct list_head *release_queue, int current_time) {
    1ffc:	7139                	addi	sp,sp,-64
    1ffe:	fc22                	sd	s0,56(sp)
    2000:	0080                	addi	s0,sp,64
    2002:	fca43423          	sd	a0,-56(s0)
    2006:	87ae                	mv	a5,a1
    2008:	fcf42223          	sw	a5,-60(s0)
    struct release_queue_entry *next_release = NULL;
    200c:	fe043423          	sd	zero,-24(s0)
    int next_release_time = INT_MAX;
    2010:	800007b7          	lui	a5,0x80000
    2014:	fff7c793          	not	a5,a5
    2018:	fef42223          	sw	a5,-28(s0)

    list_for_each_entry(next_release, release_queue, thread_list) {
    201c:	fc843783          	ld	a5,-56(s0)
    2020:	639c                	ld	a5,0(a5)
    2022:	fcf43c23          	sd	a5,-40(s0)
    2026:	fd843783          	ld	a5,-40(s0)
    202a:	17e1                	addi	a5,a5,-8
    202c:	fef43423          	sd	a5,-24(s0)
    2030:	a081                	j	2070 <find_next_release_time+0x74>
        if (next_release->release_time > current_time &&
    2032:	fe843783          	ld	a5,-24(s0)
    2036:	4f98                	lw	a4,24(a5)
    2038:	fc442783          	lw	a5,-60(s0)
    203c:	2781                	sext.w	a5,a5
    203e:	00e7df63          	bge	a5,a4,205c <find_next_release_time+0x60>
    ...
    204e:	00f75763          	bge	a4,a5,205c <find_next_release_time+0x60>
            next_release_time = next_release->release_time;
    2052:	fe843783          	ld	a5,-24(s0)
    2056:	4f9c                	lw	a5,24(a5)
    2058:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(next_release, release_queue, thread_list) {
    205c:	fe843783          	ld	a5,-24(s0)
    2060:	679c                	ld	a5,8(a5)
    2062:	fcf43823          	sd	a5,-48(s0)
    2066:	fd043783          	ld	a5,-48(s0)
    206a:	17e1                	addi	a5,a5,-8
    206c:	fef43423          	sd	a5,-24(s0)
    2070:	fe843783          	ld	a5,-24(s0)
    2074:	07a1                	addi	a5,a5,8
    2076:	fc843703          	ld	a4,-56(s0)
    207a:	faf71ce3          	bne	a4,a5,2032 <find_next_release_time+0x36>
        }
    }

    if (next_release_time == INT_MAX)
    207e:	fe442783          	lw	a5,-28(s0)
    2082:	0007871b          	sext.w	a4,a5
    2086:	800007b7          	lui	a5,0x80000
    208a:	fff7c793          	not	a5,a5
    208e:	00f71463          	bne	a4,a5,2096 <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    2092:	57fd                	li	a5,-1
    2094:	a801                	j	20a4 <find_next_release_time+0xa8>

    return next_release_time - current_time;
    2096:	fe442703          	lw	a4,-28(s0)
    209a:	fc442783          	lw	a5,-60(s0)
    209e:	40f707bb          	subw	a5,a4,a5
    20a2:	2781                	sext.w	a5,a5
}
    20a4:	853e                	mv	a0,a5
    20a6:	7462                	ld	s0,56(sp)
    20a8:	6121                	addi	sp,sp,64
    20aa:	8082                	ret

00000000000020ac <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args)
{
    20ac:	7119                	addi	sp,sp,-128
    20ae:	fc86                	sd	ra,120(sp)
    20b0:	f8a2                	sd	s0,112(sp)
    20b2:	f4a6                	sd	s1,104(sp)
    20b4:	f0ca                	sd	s2,96(sp)
    20b6:	ecce                	sd	s3,88(sp)
    20b8:	0100                	addi	s0,sp,128
    20ba:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the least-slack-time scheduling algorithm
    struct thread *min_slack = NULL;
    20bc:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    20c0:	800007b7          	lui	a5,0x80000
    20c4:	fff7c793          	not	a5,a5
    20c8:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;

    // Find the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    20cc:	649c                	ld	a5,8(s1)
    20ce:	639c                	ld	a5,0(a5)
    20d0:	faf43823          	sd	a5,-80(s0)
    20d4:	fb043783          	ld	a5,-80(s0)
    20d8:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd280>
    20dc:	faf43c23          	sd	a5,-72(s0)
    20e0:	a8b5                	j	215c <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    20e2:	fb843783          	ld	a5,-72(s0)
    20e6:	47f8                	lw	a4,76(a5)
    20e8:	409c                	lw	a5,0(s1)
    20ea:	40f707bb          	subw	a5,a4,a5
    20ee:	0007871b          	sext.w	a4,a5
    20f2:	fb843783          	ld	a5,-72(s0)
    20f6:	4fbc                	lw	a5,88(a5)
    20f8:	40f707bb          	subw	a5,a4,a5
    20fc:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    2100:	fc843783          	ld	a5,-56(s0)
    2104:	cb8d                	beqz	a5,2136 <schedule_lst+0x8a>
    2106:	fac42703          	lw	a4,-84(s0)
    210a:	fc442783          	lw	a5,-60(s0)
    210e:	2701                	sext.w	a4,a4
    2110:	2781                	sext.w	a5,a5
    2112:	02f74263          	blt	a4,a5,2136 <schedule_lst+0x8a>
    2116:	fac42703          	lw	a4,-84(s0)
    211a:	fc442783          	lw	a5,-60(s0)
    211e:	2701                	sext.w	a4,a4
    2120:	2781                	sext.w	a5,a5
    2122:	02f71263          	bne	a4,a5,2146 <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    2126:	fb843783          	ld	a5,-72(s0)
    212a:	5fd8                	lw	a4,60(a5)
    212c:	fc843783          	ld	a5,-56(s0)
    2130:	5fdc                	lw	a5,60(a5)
    2132:	00f75a63          	bge	a4,a5,2146 <schedule_lst+0x9a>
            min_slack = t;
    2136:	fb843783          	ld	a5,-72(s0)
    213a:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    213e:	fac42783          	lw	a5,-84(s0)
    2142:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    2146:	fb843783          	ld	a5,-72(s0)
    214a:	779c                	ld	a5,40(a5)
    214c:	faf43023          	sd	a5,-96(s0)
    2150:	fa043783          	ld	a5,-96(s0)
    2154:	fd878793          	addi	a5,a5,-40
    2158:	faf43c23          	sd	a5,-72(s0)
    215c:	fb843783          	ld	a5,-72(s0)
    2160:	02878713          	addi	a4,a5,40
    2164:	649c                	ld	a5,8(s1)
    2166:	f6f71ee3          	bne	a4,a5,20e2 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    216a:	fc843783          	ld	a5,-56(s0)
    216e:	cf89                	beqz	a5,2188 <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    2170:	fc843783          	ld	a5,-56(s0)
    2174:	02878793          	addi	a5,a5,40
    2178:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    217c:	fc843783          	ld	a5,-56(s0)
    2180:	4fbc                	lw	a5,88(a5)
    2182:	f8f42423          	sw	a5,-120(s0)
    2186:	a839                	j	21a4 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    2188:	649c                	ld	a5,8(s1)
    218a:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    218e:	689c                	ld	a5,16(s1)
    2190:	4098                	lw	a4,0(s1)
    2192:	85ba                	mv	a1,a4
    2194:	853e                	mv	a0,a5
    2196:	00000097          	auipc	ra,0x0
    219a:	e66080e7          	jalr	-410(ra) # 1ffc <find_next_release_time>
    219e:	87aa                	mv	a5,a0
    21a0:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    21a4:	f8043783          	ld	a5,-128(s0)
    21a8:	f8f43823          	sd	a5,-112(s0)
    21ac:	f8843783          	ld	a5,-120(s0)
    21b0:	f8f43c23          	sd	a5,-104(s0)
    21b4:	4701                	li	a4,0
    21b6:	f9043703          	ld	a4,-112(s0)
    21ba:	4781                	li	a5,0
    21bc:	f9843783          	ld	a5,-104(s0)
    21c0:	893a                	mv	s2,a4
    21c2:	89be                	mv	s3,a5
    21c4:	874a                	mv	a4,s2
    21c6:	87ce                	mv	a5,s3
    ...
    21c8:	853a                	mv	a0,a4
    21ca:	85be                	mv	a1,a5
    21cc:	70e6                	ld	ra,120(sp)
    21ce:	7446                	ld	s0,112(sp)
    21d0:	74a6                	ld	s1,104(sp)
    21d2:	7906                	ld	s2,96(sp)
    21d4:	69e6                	ld	s3,88(sp)
    21d6:	6109                	addi	sp,sp,128
    21d8:	8082                	ret

00000000000021da <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    21da:	7135                	addi	sp,sp,-160
    21dc:	ed06                	sd	ra,152(sp)
    21de:	e922                	sd	s0,144(sp)
    21e0:	e526                	sd	s1,136(sp)
    21e2:	e14a                	sd	s2,128(sp)
    21e4:	fcce                	sd	s3,120(sp)
    21e6:	1100                	addi	s0,sp,160
    21e8:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    21ea:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    21ee:	800007b7          	lui	a5,0x80000
    21f2:	fff7c793          	not	a5,a5
    21f6:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    21fa:	649c                	ld	a5,8(s1)
    21fc:	639c                	ld	a5,0(a5)
    21fe:	faf43423          	sd	a5,-88(s0)
    2202:	fa843783          	ld	a5,-88(s0)
    2206:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd280>
    220a:	fcf43023          	sd	a5,-64(s0)
    220e:	a841                	j	229e <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    2210:	fc043783          	ld	a5,-64(s0)
    2214:	43bc                	lw	a5,64(a5)
    2216:	cb95                	beqz	a5,224a <schedule_dm+0x70>
    2218:	fc043783          	ld	a5,-64(s0)
    221c:	4bbc                	lw	a5,80(a5)
    221e:	873e                	mv	a4,a5
    2220:	57fd                	li	a5,-1
    2222:	02f70463          	beq	a4,a5,224a <schedule_dm+0x70>
    2226:	fc043783          	ld	a5,-64(s0)
    222a:	4ff8                	lw	a4,92(a5)
    222c:	fbc42783          	lw	a5,-68(s0)
    2230:	2781                	sext.w	a5,a5
    2232:	00f75c63          	bge	a4,a5,224a <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    2236:	fc043783          	ld	a5,-64(s0)
    223a:	4ffc                	lw	a5,92(a5)
    223c:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    2240:	fc043783          	ld	a5,-64(s0)
    2244:	fcf43423          	sd	a5,-56(s0)
    2248:	a081                	j	2288 <schedule_dm+0xae>
    ...
    224e:	43bc                	lw	a5,64(a5)
    2250:	cf85                	beqz	a5,2288 <schedule_dm+0xae>
    2252:	fc043783          	ld	a5,-64(s0)
    2256:	4bbc                	lw	a5,80(a5)
    2258:	873e                	mv	a4,a5
    225a:	57fd                	li	a5,-1
    225c:	02f70663          	beq	a4,a5,2288 <schedule_dm+0xae>
    2260:	fc043783          	ld	a5,-64(s0)
    2264:	4ff8                	lw	a4,92(a5)
    2266:	fbc42783          	lw	a5,-68(s0)
    226a:	2781                	sext.w	a5,a5
    226c:	00e79e63          	bne	a5,a4,2288 <schedule_dm+0xae>
    2270:	fc043783          	ld	a5,-64(s0)
    2274:	5fd8                	lw	a4,60(a5)
    2276:	fc843783          	ld	a5,-56(s0)
    227a:	5fdc                	lw	a5,60(a5)
    227c:	00f75663          	bge	a4,a5,2288 <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    2280:	fc043783          	ld	a5,-64(s0)
    2284:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    2288:	fc043783          	ld	a5,-64(s0)
    228c:	779c                	ld	a5,40(a5)
    228e:	f8f43423          	sd	a5,-120(s0)
    2292:	f8843783          	ld	a5,-120(s0)
    2296:	fd878793          	addi	a5,a5,-40
    229a:	fcf43023          	sd	a5,-64(s0)
    229e:	fc043783          	ld	a5,-64(s0)
    22a2:	02878713          	addi	a4,a5,40
    22a6:	649c                	ld	a5,8(s1)
    22a8:	f6f714e3          	bne	a4,a5,2210 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    22ac:	fc843783          	ld	a5,-56(s0)
    22b0:	c7a5                	beqz	a5,2318 <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    22b2:	fc843783          	ld	a5,-56(s0)
    22b6:	4ff8                	lw	a4,92(a5)
    22b8:	409c                	lw	a5,0(s1)
    22ba:	40f707bb          	subw	a5,a4,a5
    22be:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    22c2:	fc843783          	ld	a5,-56(s0)
    22c6:	4fb8                	lw	a4,88(a5)
    22c8:	f9442783          	lw	a5,-108(s0)
    22cc:	2781                	sext.w	a5,a5
    22ce:	00e7db63          	bge	a5,a4,22e4 <schedule_dm+0x10a>
    ...
    22da:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    22de:	f6042823          	sw	zero,-144(s0)
    22e2:	a0f1                	j	23ae <schedule_dm+0x1d4>
        } else {
    ...
    22e4:	fc843783          	ld	a5,-56(s0)
    22e8:	4fbc                	lw	a5,88(a5)
    22ea:	863e                	mv	a2,a5
    22ec:	f9442783          	lw	a5,-108(s0)
    22f0:	0007869b          	sext.w	a3,a5
    22f4:	0006071b          	sext.w	a4,a2
    22f8:	00d75363          	bge	a4,a3,22fe <schedule_dm+0x124>
    22fc:	87b2                	mv	a5,a2
    22fe:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    2302:	fc843783          	ld	a5,-56(s0)
    2306:	02878793          	addi	a5,a5,40
    230a:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    230e:	f9042783          	lw	a5,-112(s0)
    2312:	f6f42823          	sw	a5,-144(s0)
    2316:	a861                	j	23ae <schedule_dm+0x1d4>
        }
    } else {
    ...
    2318:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    231c:	649c                	ld	a5,8(s1)
    231e:	639c                	ld	a5,0(a5)
    2320:	faf43023          	sd	a5,-96(s0)
    2324:	fa043783          	ld	a5,-96(s0)
    2328:	fd878793          	addi	a5,a5,-40
    232c:	fcf43023          	sd	a5,-64(s0)
    2330:	a81d                	j	2366 <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    2332:	fb043783          	ld	a5,-80(s0)
    2336:	cb89                	beqz	a5,2348 <schedule_dm+0x16e>
    2338:	fc043783          	ld	a5,-64(s0)
    233c:	5fd8                	lw	a4,60(a5)
    233e:	fb043783          	ld	a5,-80(s0)
    2342:	5fdc                	lw	a5,60(a5)
    2344:	00f75663          	bge	a4,a5,2350 <schedule_dm+0x176>
                smallest_id_thread = t;
    2348:	fc043783          	ld	a5,-64(s0)
    234c:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    2350:	fc043783          	ld	a5,-64(s0)
    2354:	779c                	ld	a5,40(a5)
    2356:	f8f43c23          	sd	a5,-104(s0)
    235a:	f9843783          	ld	a5,-104(s0)
    235e:	fd878793          	addi	a5,a5,-40
    2362:	fcf43023          	sd	a5,-64(s0)
    2366:	fc043783          	ld	a5,-64(s0)
    236a:	02878713          	addi	a4,a5,40
    236e:	649c                	ld	a5,8(s1)
    2370:	fcf711e3          	bne	a4,a5,2332 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    2374:	fb043783          	ld	a5,-80(s0)
    2378:	cf89                	beqz	a5,2392 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    237a:	fb043783          	ld	a5,-80(s0)
    237e:	02878793          	addi	a5,a5,40
    2382:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    2386:	fb043783          	ld	a5,-80(s0)
    238a:	4fbc                	lw	a5,88(a5)
    238c:	f6f42823          	sw	a5,-144(s0)
    2390:	a839                	j	23ae <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    2392:	649c                	ld	a5,8(s1)
    2394:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    2398:	689c                	ld	a5,16(s1)
    239a:	4098                	lw	a4,0(s1)
    239c:	85ba                	mv	a1,a4
    239e:	853e                	mv	a0,a5
    23a0:	00000097          	auipc	ra,0x0
    23a4:	c5c080e7          	jalr	-932(ra) # 1ffc <find_next_release_time>
    23a8:	87aa                	mv	a5,a0
    23aa:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    23ae:	f6843783          	ld	a5,-152(s0)
    23b2:	f6f43c23          	sd	a5,-136(s0)
    23b6:	f7043783          	ld	a5,-144(s0)
    23ba:	f8f43023          	sd	a5,-128(s0)
    23be:	4701                	li	a4,0
    23c0:	f7843703          	ld	a4,-136(s0)
    23c4:	4781                	li	a5,0
    23c6:	f8043783          	ld	a5,-128(s0)
    23ca:	893a                	mv	s2,a4
    23cc:	89be                	mv	s3,a5
    23ce:	874a                	mv	a4,s2
    23d0:	87ce                	mv	a5,s3
    ...
    23d2:	853a                	mv	a0,a4
    23d4:	85be                	mv	a1,a5
    23d6:	60ea                	ld	ra,152(sp)
    23d8:	644a                	ld	s0,144(sp)
    23da:	64aa                	ld	s1,136(sp)
    23dc:	690a                	ld	s2,128(sp)
    23de:	79e6                	ld	s3,120(sp)

...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
    ...
    fprintf(2, "Usage: ln old new\n");
      ...
      24:	88858593          	addi	a1,a1,-1912 # 18a8 <schedule_dm+0x17c>
      28:	4509                	li	a0,2
  ...
  if(link(argv[1], argv[2]) < 0)
    ...
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
      ...
      76:	84e58593          	addi	a1,a1,-1970 # 18c0 <schedule_dm+0x194>
      7a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     686:	25e68693          	addi	a3,a3,606 # 18e0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     760:	18470713          	addi	a4,a4,388 # 18e0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     920:	fbc78793          	addi	a5,a5,-68 # 18d8 <schedule_dm+0x1ac>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     acc:	e4078793          	addi	a5,a5,-448 # 1908 <freep>
     ad0:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bc4:	d4878793          	addi	a5,a5,-696 # 1908 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c46:	cc678793          	addi	a5,a5,-826 # 1908 <freep>
     c4a:	639c                	ld	a5,0(a5)
}
     c4c:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c78:	c9478793          	addi	a5,a5,-876 # 1908 <freep>
     c7c:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     c8c:	c7078793          	addi	a5,a5,-912 # 18f8 <base>
     c90:	fef43023          	sd	a5,-32(s0)
     c94:	00001797          	auipc	a5,0x1
     c98:	c7478793          	addi	a5,a5,-908 # 1908 <freep>
     c9c:	fe043703          	ld	a4,-32(s0)
     ca0:	e398                	sd	a4,0(a5)
     ca2:	00001797          	auipc	a5,0x1
     ca6:	c6678793          	addi	a5,a5,-922 # 1908 <freep>
     caa:	6398                	ld	a4,0(a5)
     cac:	00001797          	auipc	a5,0x1
     cb0:	c4c78793          	addi	a5,a5,-948 # 18f8 <base>
     cb4:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     cb6:	00001797          	auipc	a5,0x1
     cba:	c4278793          	addi	a5,a5,-958 # 18f8 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d36:	bd678793          	addi	a5,a5,-1066 # 1908 <freep>
    ...
    if(p == freep)
     ...
     d4c:	bc078793          	addi	a5,a5,-1088 # 1908 <freep>
     d50:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     ee4:	a3078793          	addi	a5,a5,-1488 # 1910 <last_thread.1226>
     ee8:	639c                	ld	a5,0(a5)
     eea:	cb89                	beqz	a5,efc <schedule_wrr+0x2e>
     eec:	00001797          	auipc	a5,0x1
     ef0:	a2478793          	addi	a5,a5,-1500 # 1910 <last_thread.1226>
     ef4:	639c                	ld	a5,0(a5)
     ef6:	4fbc                	lw	a5,88(a5)
     ef8:	00f04863          	bgtz	a5,f08 <schedule_wrr+0x3a>
        last_thread = NULL;
     efc:	00001797          	auipc	a5,0x1
     f00:	a1478793          	addi	a5,a5,-1516 # 1910 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     f22:	9f278793          	addi	a5,a5,-1550 # 1910 <last_thread.1226>
     f26:	639c                	ld	a5,0(a5)
    ...
    if (selected_thread) {
     ...
     fea:	92a78793          	addi	a5,a5,-1750 # 1910 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    111c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdef8>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    124e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdef8>
    ...
    12e8:	a80d                	j	131a <schedule_sjf+0x112>
    } else {
    ...
    12f8:	57fd                	li	a5,-1
    12fa:	00f71c63          	bne	a4,a5,1312 <schedule_sjf+0x10a>
    12fe:	689c                	ld	a5,16(s1)
    1300:	4098                	lw	a4,0(s1)
    1302:	85ba                	mv	a1,a4
    1304:	853e                	mv	a0,a5
    1306:	00000097          	auipc	ra,0x0
    130a:	d2c080e7          	jalr	-724(ra) # 1032 <find_next_release_time>
    130e:	87aa                	mv	a5,a0
    1310:	a019                	j	1316 <schedule_sjf+0x10e>
    1312:	fb442783          	lw	a5,-76(s0)
    1316:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    131a:	f8043783          	ld	a5,-128(s0)
    131e:	f8f43823          	sd	a5,-112(s0)
    1322:	f8843783          	ld	a5,-120(s0)
    1326:	f8f43c23          	sd	a5,-104(s0)
    132a:	4701                	li	a4,0
    132c:	f9043703          	ld	a4,-112(s0)
    1330:	4781                	li	a5,0
    1332:	f9843783          	ld	a5,-104(s0)
    1336:	893a                	mv	s2,a4
    1338:	89be                	mv	s3,a5
    133a:	874a                	mv	a4,s2
    133c:	87ce                	mv	a5,s3
    ...
    133e:	853a                	mv	a0,a4
    1340:	85be                	mv	a1,a5
    1342:	70e6                	ld	ra,120(sp)
    1344:	7446                	ld	s0,112(sp)
    1346:	74a6                	ld	s1,104(sp)
    1348:	7906                	ld	s2,96(sp)
    134a:	69e6                	ld	s3,88(sp)
    134c:	6109                	addi	sp,sp,128
    134e:	8082                	ret

0000000000001350 <min>:

int min(int a, int b) {
    1350:	1101                	addi	sp,sp,-32
    1352:	ec22                	sd	s0,24(sp)
    1354:	1000                	addi	s0,sp,32
    1356:	87aa                	mv	a5,a0
    1358:	872e                	mv	a4,a1
    135a:	fef42623          	sw	a5,-20(s0)
    135e:	87ba                	mv	a5,a4
    1360:	fef42423          	sw	a5,-24(s0)
    return (a < b) ? a : b;
    1364:	fec42603          	lw	a2,-20(s0)
    1368:	fe842783          	lw	a5,-24(s0)
    136c:	0007869b          	sext.w	a3,a5
    1370:	0006071b          	sext.w	a4,a2
    1374:	00d75363          	bge	a4,a3,137a <min+0x2a>
    1378:	87b2                	mv	a5,a2
    137a:	2781                	sext.w	a5,a5
}
    137c:	853e                	mv	a0,a5
    137e:	6462                	ld	s0,24(sp)
    1380:	6105                	addi	sp,sp,32
    1382:	8082                	ret

0000000000001384 <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    1384:	7131                	addi	sp,sp,-192
    1386:	fd06                	sd	ra,184(sp)
    1388:	f922                	sd	s0,176(sp)
    138a:	f526                	sd	s1,168(sp)
    138c:	f14a                	sd	s2,160(sp)
    138e:	ed4e                	sd	s3,152(sp)
    1390:	0180                	addi	s0,sp,192
    1392:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    ...
    13a8:	faf43023          	sd	a5,-96(s0)
    13ac:	fa043783          	ld	a5,-96(s0)
    13b0:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdef8>
    13b4:	faf43c23          	sd	a5,-72(s0)
    13b8:	a069                	j	1442 <schedule_lst+0xbe>
        int slack_time = t->current_deadline - args.current_time - t->remaining_time;
    13ba:	fb843783          	ld	a5,-72(s0)
    13be:	4ff8                	lw	a4,92(a5)
    13c0:	409c                	lw	a5,0(s1)
    ...
    13d4:	f6f42a23          	sw	a5,-140(s0)
        if (slack_time < min_slack_time || (slack_time == min_slack_time && t->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))) {
    13d8:	f7442703          	lw	a4,-140(s0)
    13dc:	fc442783          	lw	a5,-60(s0)
    13e0:	2701                	sext.w	a4,a4
    13e2:	2781                	sext.w	a5,a5
    13e4:	02f74c63          	blt	a4,a5,141c <schedule_lst+0x98>
    13e8:	f7442703          	lw	a4,-140(s0)
    13ec:	fc442783          	lw	a5,-60(s0)
    13f0:	2701                	sext.w	a4,a4
    13f2:	2781                	sext.w	a5,a5
    13f4:	02f71c63          	bne	a4,a5,142c <schedule_lst+0xa8>
    13f8:	fb843783          	ld	a5,-72(s0)
    13fc:	5fd4                	lw	a3,60(a5)
    13fe:	fc843783          	ld	a5,-56(s0)
    1402:	c789                	beqz	a5,140c <schedule_lst+0x88>
    1404:	fc843783          	ld	a5,-56(s0)
    1408:	5fdc                	lw	a5,60(a5)
    140a:	a029                	j	1414 <schedule_lst+0x90>
    140c:	800007b7          	lui	a5,0x80000
    1410:	fff7c793          	not	a5,a5
    1414:	873e                	mv	a4,a5
    1416:	87b6                	mv	a5,a3
    1418:	00e7da63          	bge	a5,a4,142c <schedule_lst+0xa8>
            min_slack_thread = t;
    141c:	fb843783          	ld	a5,-72(s0)
    1420:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    1424:	f7442783          	lw	a5,-140(s0)
    1428:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    142c:	fb843783          	ld	a5,-72(s0)
    1430:	779c                	ld	a5,40(a5)
    1432:	f6f43423          	sd	a5,-152(s0)
    1436:	f6843783          	ld	a5,-152(s0)
    143a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdef8>
    143e:	faf43c23          	sd	a5,-72(s0)
    1442:	fb843783          	ld	a5,-72(s0)
    1446:	02878713          	addi	a4,a5,40
    144a:	649c                	ld	a5,8(s1)
    144c:	f6f717e3          	bne	a4,a5,13ba <schedule_lst+0x36>
    ...
    1450:	800007b7          	lui	a5,0x80000
    1454:	fff7c793          	not	a5,a5
    1458:	faf42a23          	sw	a5,-76(s0)
    ...
    145e:	639c                	ld	a5,0(a5)
    1460:	f8f43c23          	sd	a5,-104(s0)
    1464:	f9843783          	ld	a5,-104(s0)
    1468:	17e1                	addi	a5,a5,-8
    146a:	faf43423          	sd	a5,-88(s0)
    146e:	a0f1                	j	153a <schedule_lst+0x1b6>
        if (entry->release_time > args.current_time) {
    1470:	fa843783          	ld	a5,-88(s0)
    1474:	4f98                	lw	a4,24(a5)
    1476:	409c                	lw	a5,0(s1)
    1478:	0ae7d763          	bge	a5,a4,1526 <schedule_lst+0x1a2>
            struct thread *upcoming_thread = entry->thrd;
    147c:	fa843783          	ld	a5,-88(s0)
    1480:	639c                	ld	a5,0(a5)
    1482:	f8f43423          	sd	a5,-120(s0)
            int upcoming_slack_time = upcoming_thread->current_deadline - entry->release_time - upcoming_thread->remaining_time;
    1486:	f8843783          	ld	a5,-120(s0)
    148a:	4ff8                	lw	a4,92(a5)
    148c:	fa843783          	ld	a5,-88(s0)
    1490:	4f9c                	lw	a5,24(a5)
    1492:	40f707bb          	subw	a5,a4,a5
    1496:	0007871b          	sext.w	a4,a5
    149a:	f8843783          	ld	a5,-120(s0)
    149e:	4fbc                	lw	a5,88(a5)
    14a0:	40f707bb          	subw	a5,a4,a5
    14a4:	f8f42223          	sw	a5,-124(s0)
    ...
    14a8:	f8442703          	lw	a4,-124(s0)
    14ac:	fc442783          	lw	a5,-60(s0)
    14b0:	2701                	sext.w	a4,a4
    14b2:	2781                	sext.w	a5,a5
    14b4:	02f75163          	bge	a4,a5,14d6 <schedule_lst+0x152>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    14b8:	fa843783          	ld	a5,-88(s0)
    14bc:	4f98                	lw	a4,24(a5)
    14be:	fb442783          	lw	a5,-76(s0)
    14c2:	85ba                	mv	a1,a4
    14c4:	853e                	mv	a0,a5
    14c6:	00000097          	auipc	ra,0x0
    14ca:	e8a080e7          	jalr	-374(ra) # 1350 <min>
    14ce:	87aa                	mv	a5,a0
    14d0:	faf42a23          	sw	a5,-76(s0)
    14d4:	a889                	j	1526 <schedule_lst+0x1a2>
            } else if (upcoming_slack_time == min_slack_time && upcoming_thread->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))
    14d6:	f8442703          	lw	a4,-124(s0)
    14da:	fc442783          	lw	a5,-60(s0)
    14de:	2701                	sext.w	a4,a4
    14e0:	2781                	sext.w	a5,a5
    14e2:	04f71263          	bne	a4,a5,1526 <schedule_lst+0x1a2>
    14e6:	f8843783          	ld	a5,-120(s0)
    14ea:	5fd4                	lw	a3,60(a5)
    14ec:	fc843783          	ld	a5,-56(s0)
    14f0:	c789                	beqz	a5,14fa <schedule_lst+0x176>
    14f2:	fc843783          	ld	a5,-56(s0)
    14f6:	5fdc                	lw	a5,60(a5)
    14f8:	a029                	j	1502 <schedule_lst+0x17e>
    14fa:	800007b7          	lui	a5,0x80000
    14fe:	fff7c793          	not	a5,a5
    1502:	873e                	mv	a4,a5
    1504:	87b6                	mv	a5,a3
    1506:	02e7d063          	bge	a5,a4,1526 <schedule_lst+0x1a2>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    150a:	fa843783          	ld	a5,-88(s0)
    150e:	4f98                	lw	a4,24(a5)
    1510:	fb442783          	lw	a5,-76(s0)
    1514:	85ba                	mv	a1,a4
    1516:	853e                	mv	a0,a5
    1518:	00000097          	auipc	ra,0x0
    151c:	e38080e7          	jalr	-456(ra) # 1350 <min>
    1520:	87aa                	mv	a5,a0
    1522:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(entry, args.release_queue, thread_list) {
    1526:	fa843783          	ld	a5,-88(s0)
    152a:	679c                	ld	a5,8(a5)
    152c:	f6f43c23          	sd	a5,-136(s0)
    1530:	f7843783          	ld	a5,-136(s0)
    1534:	17e1                	addi	a5,a5,-8
    1536:	faf43423          	sd	a5,-88(s0)
    153a:	fa843783          	ld	a5,-88(s0)
    153e:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffdf28>
    1542:	689c                	ld	a5,16(s1)
    1544:	f2f716e3          	bne	a4,a5,1470 <schedule_lst+0xec>
        }
    }
    ...
    154c:	c3b1                	beqz	a5,1590 <schedule_lst+0x20c>
    ...
    1556:	800007b7          	lui	a5,0x80000
    155a:	fff7c793          	not	a5,a5
    155e:	00f71663          	bne	a4,a5,156a <schedule_lst+0x1e6>
    1562:	fc843783          	ld	a5,-56(s0)
    1566:	4fbc                	lw	a5,88(a5)
    1568:	a039                	j	1576 <schedule_lst+0x1f2>
    156a:	409c                	lw	a5,0(s1)
    156c:	fb442703          	lw	a4,-76(s0)
    1570:	40f707bb          	subw	a5,a4,a5
    1574:	2781                	sext.w	a5,a5
    1576:	f8f42a23          	sw	a5,-108(s0)
        r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    157a:	fc843783          	ld	a5,-56(s0)
    157e:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffdf48>
    1582:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = allocated_time;
    1586:	f9442783          	lw	a5,-108(s0)
    158a:	f4f42823          	sw	a5,-176(s0)
    158e:	a081                	j	15ce <schedule_lst+0x24a>
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    1590:	649c                	ld	a5,8(s1)
    1592:	f4f43423          	sd	a5,-184(s0)
    ...
    1596:	fb442783          	lw	a5,-76(s0)
    159a:	0007871b          	sext.w	a4,a5
    159e:	800007b7          	lui	a5,0x80000
    15a2:	fff7c793          	not	a5,a5
    15a6:	00f70963          	beq	a4,a5,15b8 <schedule_lst+0x234>
    15aa:	409c                	lw	a5,0(s1)
    15ac:	fb442703          	lw	a4,-76(s0)
    15b0:	40f707bb          	subw	a5,a4,a5
    15b4:	2781                	sext.w	a5,a5
    15b6:	a811                	j	15ca <schedule_lst+0x246>
    15b8:	689c                	ld	a5,16(s1)
    15ba:	4098                	lw	a4,0(s1)
    15bc:	85ba                	mv	a1,a4
    15be:	853e                	mv	a0,a5
    15c0:	00000097          	auipc	ra,0x0
    15c4:	a72080e7          	jalr	-1422(ra) # 1032 <find_next_release_time>
    15c8:	87aa                	mv	a5,a0
    15ca:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    15ce:	f4843783          	ld	a5,-184(s0)
    15d2:	f4f43c23          	sd	a5,-168(s0)
    15d6:	f5043783          	ld	a5,-176(s0)
    15da:	f6f43023          	sd	a5,-160(s0)
    15de:	4701                	li	a4,0
    15e0:	f5843703          	ld	a4,-168(s0)
    15e4:	4781                	li	a5,0
    15e6:	f6043783          	ld	a5,-160(s0)
    15ea:	893a                	mv	s2,a4
    15ec:	89be                	mv	s3,a5
    15ee:	874a                	mv	a4,s2
    15f0:	87ce                	mv	a5,s3
    ...
    15f2:	853a                	mv	a0,a4
    15f4:	85be                	mv	a1,a5
    15f6:	70ea                	ld	ra,184(sp)
    15f8:	744a                	ld	s0,176(sp)
    15fa:	74aa                	ld	s1,168(sp)
    15fc:	790a                	ld	s2,160(sp)
    15fe:	69ea                	ld	s3,152(sp)
    1600:	6129                	addi	sp,sp,192
    1602:	8082                	ret

0000000000001604 <find_earliest_impactful_release_time_dm>:

int find_earliest_impactful_release_time_dm(struct list_head *release_queue, int current_time, int current_deadline) {
    1604:	715d                	addi	sp,sp,-80
    1606:	e4a2                	sd	s0,72(sp)
    1608:	0880                	addi	s0,sp,80
    160a:	faa43c23          	sd	a0,-72(s0)
    160e:	87ae                	mv	a5,a1
    1610:	8732                	mv	a4,a2
    1612:	faf42a23          	sw	a5,-76(s0)
    1616:	87ba                	mv	a5,a4
    1618:	faf42823          	sw	a5,-80(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_event = INT_MAX;
    161c:	800007b7          	lui	a5,0x80000
    1620:	fff7c793          	not	a5,a5
    1624:	fef42223          	sw	a5,-28(s0)
    struct thread *earliest_deadline_thread = NULL;
    1628:	fc043c23          	sd	zero,-40(s0)
    earliest_deadline_thread->ID = INT_MAX;
    162c:	fd843783          	ld	a5,-40(s0)
    1630:	80000737          	lui	a4,0x80000
    1634:	fff74713          	not	a4,a4
    1638:	dfd8                	sw	a4,60(a5)

    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    163a:	fb843783          	ld	a5,-72(s0)
    163e:	639c                	ld	a5,0(a5)
    1640:	fcf43823          	sd	a5,-48(s0)
    1644:	fd043783          	ld	a5,-48(s0)
    1648:	17e1                	addi	a5,a5,-8
    164a:	fef43423          	sd	a5,-24(s0)
    164e:	a075                	j	16fa <find_earliest_impactful_release_time_dm+0xf6>
        if (entry->release_time > current_time && entry->thrd->period < current_deadline) {
    1650:	fe843783          	ld	a5,-24(s0)
    1654:	4f98                	lw	a4,24(a5)
    1656:	fb442783          	lw	a5,-76(s0)
    165a:	2781                	sext.w	a5,a5
    165c:	02e7d963          	bge	a5,a4,168e <find_earliest_impactful_release_time_dm+0x8a>
    1660:	fe843783          	ld	a5,-24(s0)
    1664:	639c                	ld	a5,0(a5)
    1666:	4bb8                	lw	a4,80(a5)
    1668:	fb042783          	lw	a5,-80(s0)
    166c:	2781                	sext.w	a5,a5
    166e:	02f75063          	bge	a4,a5,168e <find_earliest_impactful_release_time_dm+0x8a>
            if (entry->release_time < earliest_impactful_event) {
    1672:	fe843783          	ld	a5,-24(s0)
    1676:	4f98                	lw	a4,24(a5)
    1678:	fe442783          	lw	a5,-28(s0)
    167c:	2781                	sext.w	a5,a5
    167e:	06f75463          	bge	a4,a5,16e6 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    1682:	fe843783          	ld	a5,-24(s0)
    1686:	4f9c                	lw	a5,24(a5)
    1688:	fef42223          	sw	a5,-28(s0)
            if (entry->release_time < earliest_impactful_event) {
    168c:	a8a9                	j	16e6 <find_earliest_impactful_release_time_dm+0xe2>
            }
        } 
    ...
    1694:	fb442783          	lw	a5,-76(s0)
    1698:	2781                	sext.w	a5,a5
    169a:	04e7d663          	bge	a5,a4,16e6 <find_earliest_impactful_release_time_dm+0xe2>
    169e:	fe843783          	ld	a5,-24(s0)
    16a2:	639c                	ld	a5,0(a5)
    16a4:	4bb8                	lw	a4,80(a5)
    16a6:	fb042783          	lw	a5,-80(s0)
    16aa:	2781                	sext.w	a5,a5
    16ac:	02e79d63          	bne	a5,a4,16e6 <find_earliest_impactful_release_time_dm+0xe2>
            if (entry->release_time < earliest_impactful_event && entry->thrd->ID < earliest_deadline_thread->ID) {
    16b0:	fe843783          	ld	a5,-24(s0)
    16b4:	4f98                	lw	a4,24(a5)
    16b6:	fe442783          	lw	a5,-28(s0)
    16ba:	2781                	sext.w	a5,a5
    16bc:	02f75563          	bge	a4,a5,16e6 <find_earliest_impactful_release_time_dm+0xe2>
    16c0:	fe843783          	ld	a5,-24(s0)
    16c4:	639c                	ld	a5,0(a5)
    16c6:	5fd8                	lw	a4,60(a5)
    16c8:	fd843783          	ld	a5,-40(s0)
    16cc:	5fdc                	lw	a5,60(a5)
    16ce:	00f75c63          	bge	a4,a5,16e6 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    16d2:	fe843783          	ld	a5,-24(s0)
    16d6:	4f9c                	lw	a5,24(a5)
    16d8:	fef42223          	sw	a5,-28(s0)
                earliest_deadline_thread = entry->thrd;
    16dc:	fe843783          	ld	a5,-24(s0)
    16e0:	639c                	ld	a5,0(a5)
    16e2:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    16e6:	fe843783          	ld	a5,-24(s0)
    16ea:	679c                	ld	a5,8(a5)
    16ec:	fcf43423          	sd	a5,-56(s0)
    16f0:	fc843783          	ld	a5,-56(s0)
    16f4:	17e1                	addi	a5,a5,-8
    16f6:	fef43423          	sd	a5,-24(s0)
    16fa:	fe843783          	ld	a5,-24(s0)
    16fe:	07a1                	addi	a5,a5,8
    1700:	fb843703          	ld	a4,-72(s0)
    1704:	f4f716e3          	bne	a4,a5,1650 <find_earliest_impactful_release_time_dm+0x4c>
            }
        }
    }
    ...
    1710:	800007b7          	lui	a5,0x80000
    1714:	fff7c793          	not	a5,a5
    1718:	00f70563          	beq	a4,a5,1722 <find_earliest_impactful_release_time_dm+0x11e>
    171c:	fe442783          	lw	a5,-28(s0)
    1720:	a011                	j	1724 <find_earliest_impactful_release_time_dm+0x120>
    1722:	57fd                	li	a5,-1
}
    1724:	853e                	mv	a0,a5
    1726:	6426                	ld	s0,72(sp)
    1728:	6161                	addi	sp,sp,80
    172a:	8082                	ret

000000000000172c <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    172c:	7175                	addi	sp,sp,-144
    172e:	e506                	sd	ra,136(sp)
    1730:	e122                	sd	s0,128(sp)
    1732:	fca6                	sd	s1,120(sp)
    1734:	f8ca                	sd	s2,112(sp)
    1736:	f4ce                	sd	s3,104(sp)
    1738:	0900                	addi	s0,sp,144
    173a:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    173c:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    1740:	800007b7          	lui	a5,0x80000
    1744:	fff7c793          	not	a5,a5
    ...
    1750:	faf43823          	sd	a5,-80(s0)
    1754:	fb043783          	ld	a5,-80(s0)
    1758:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdef8>
    175c:	fcf43023          	sd	a5,-64(s0)
    1760:	a089                	j	17a2 <schedule_dm+0x76>
        if (t->is_real_time && t->period < earliest_deadline) {
    1762:	fc043783          	ld	a5,-64(s0)
    1766:	43bc                	lw	a5,64(a5)
    1768:	c395                	beqz	a5,178c <schedule_dm+0x60>
    176a:	fc043783          	ld	a5,-64(s0)
    176e:	4bb8                	lw	a4,80(a5)
    1770:	fbc42783          	lw	a5,-68(s0)
    1774:	2781                	sext.w	a5,a5
    1776:	00f75b63          	bge	a4,a5,178c <schedule_dm+0x60>
            earliest_deadline_thread = t;
    177a:	fc043783          	ld	a5,-64(s0)
    177e:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    1782:	fc043783          	ld	a5,-64(s0)
    1786:	4bbc                	lw	a5,80(a5)
    1788:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    178c:	fc043783          	ld	a5,-64(s0)
    1790:	779c                	ld	a5,40(a5)
    1792:	f8f43c23          	sd	a5,-104(s0)
    1796:	f9843783          	ld	a5,-104(s0)
    179a:	fd878793          	addi	a5,a5,-40
    179e:	fcf43023          	sd	a5,-64(s0)
    17a2:	fc043783          	ld	a5,-64(s0)
    17a6:	02878713          	addi	a4,a5,40
    17aa:	649c                	ld	a5,8(s1)
    17ac:	faf71be3          	bne	a4,a5,1762 <schedule_dm+0x36>
        }
    }
    ...
    17fe:	fac42783          	lw	a5,-84(s0)
    1802:	0007871b          	sext.w	a4,a5
    1806:	57fd                	li	a5,-1
    1808:	02f70563          	beq	a4,a5,1832 <schedule_dm+0x106>
    180c:	409c                	lw	a5,0(s1)
    180e:	fac42703          	lw	a4,-84(s0)
    1812:	40f707bb          	subw	a5,a4,a5
    1816:	0007871b          	sext.w	a4,a5
    181a:	fc843783          	ld	a5,-56(s0)
    181e:	4fbc                	lw	a5,88(a5)
    1820:	00f75963          	bge	a4,a5,1832 <schedule_dm+0x106>
    1824:	409c                	lw	a5,0(s1)
    1826:	fac42703          	lw	a4,-84(s0)
    182a:	40f707bb          	subw	a5,a4,a5
    182e:	2781                	sext.w	a5,a5
    1830:	a021                	j	1838 <schedule_dm+0x10c>
    1832:	fc843783          	ld	a5,-56(s0)
    1836:	4fbc                	lw	a5,88(a5)
    1838:	faf42223          	sw	a5,-92(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    183c:	fc843783          	ld	a5,-56(s0)
    1840:	02878793          	addi	a5,a5,40
    1844:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    1848:	fa442783          	lw	a5,-92(s0)
    184c:	f8f42023          	sw	a5,-128(s0)
    1850:	a839                	j	186e <schedule_dm+0x142>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    1852:	649c                	ld	a5,8(s1)
    1854:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1858:	689c                	ld	a5,16(s1)
    185a:	4098                	lw	a4,0(s1)
    185c:	85ba                	mv	a1,a4
    185e:	853e                	mv	a0,a5
    1860:	fffff097          	auipc	ra,0xfffff
    1864:	7d2080e7          	jalr	2002(ra) # 1032 <find_next_release_time>
    1868:	87aa                	mv	a5,a0
    186a:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    186e:	f7843783          	ld	a5,-136(s0)
    1872:	f8f43423          	sd	a5,-120(s0)
    1876:	f8043783          	ld	a5,-128(s0)
    187a:	f8f43823          	sd	a5,-112(s0)
    187e:	4701                	li	a4,0
    1880:	f8843703          	ld	a4,-120(s0)
    1884:	4781                	li	a5,0
    1886:	f9043783          	ld	a5,-112(s0)
    188a:	893a                	mv	s2,a4
    188c:	89be                	mv	s3,a5
    188e:	874a                	mv	a4,s2
    1890:	87ce                	mv	a5,s3
    ...
    1892:	853a                	mv	a0,a4
    1894:	85be                	mv	a1,a5
    1896:	60aa                	ld	ra,136(sp)
    1898:	640a                	ld	s0,128(sp)
    189a:	74e6                	ld	s1,120(sp)
    189c:	7946                	ld	s2,112(sp)
    189e:	79a6                	ld	s3,104(sp)
    18a0:	6149                	addi	sp,sp,144
    18a2:	8082                	ret

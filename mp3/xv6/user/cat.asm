...
cat(int fd)
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0) {
    ...
    if (write(1, buf, n) != n) {
      ...
      1a:	7ba58593          	addi	a1,a1,1978 # 17d0 <buf>
      1e:	4505                	li	a0,1
      ...
      3a:	73258593          	addi	a1,a1,1842 # 1768 <schedule_dm+0x20a>
      3e:	4509                	li	a0,2
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0) {
      ...
      5e:	77658593          	addi	a1,a1,1910 # 17d0 <buf>
      62:	853e                	mv	a0,a5
  ...
  if(n < 0){
    ...
    fprintf(2, "cat: read error\n");
      ...
      8a:	6fa58593          	addi	a1,a1,1786 # 1780 <schedule_dm+0x222>
      8e:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     126:	67658593          	addi	a1,a1,1654 # 1798 <schedule_dm+0x23a>
     12a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     776:	04668693          	addi	a3,a3,70 # 17b8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     850:	f6c70713          	addi	a4,a4,-148 # 17b8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     a10:	da478793          	addi	a5,a5,-604 # 17b0 <schedule_dm+0x252>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     bbc:	e2878793          	addi	a5,a5,-472 # 19e0 <freep>
     bc0:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     cb4:	d3078793          	addi	a5,a5,-720 # 19e0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     d36:	cae78793          	addi	a5,a5,-850 # 19e0 <freep>
     d3a:	639c                	ld	a5,0(a5)
}
     d3c:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d68:	c7c78793          	addi	a5,a5,-900 # 19e0 <freep>
     d6c:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d7c:	c5878793          	addi	a5,a5,-936 # 19d0 <base>
     d80:	fef43023          	sd	a5,-32(s0)
     d84:	00001797          	auipc	a5,0x1
     d88:	c5c78793          	addi	a5,a5,-932 # 19e0 <freep>
     d8c:	fe043703          	ld	a4,-32(s0)
     d90:	e398                	sd	a4,0(a5)
     d92:	00001797          	auipc	a5,0x1
     d96:	c4e78793          	addi	a5,a5,-946 # 19e0 <freep>
     d9a:	6398                	ld	a4,0(a5)
     d9c:	00001797          	auipc	a5,0x1
     da0:	c3478793          	addi	a5,a5,-972 # 19d0 <base>
     da4:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     da6:	00001797          	auipc	a5,0x1
     daa:	c2a78793          	addi	a5,a5,-982 # 19d0 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     e26:	bbe78793          	addi	a5,a5,-1090 # 19e0 <freep>
    ...
    if(p == freep)
     ...
     e3c:	ba878793          	addi	a5,a5,-1112 # 19e0 <freep>
     e40:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     fd4:	a1878793          	addi	a5,a5,-1512 # 19e8 <last_thread.1226>
     fd8:	639c                	ld	a5,0(a5)
     fda:	cb89                	beqz	a5,fec <schedule_wrr+0x2e>
     fdc:	00001797          	auipc	a5,0x1
     fe0:	a0c78793          	addi	a5,a5,-1524 # 19e8 <last_thread.1226>
     fe4:	639c                	ld	a5,0(a5)
     fe6:	4fbc                	lw	a5,88(a5)
     fe8:	00f04863          	bgtz	a5,ff8 <schedule_wrr+0x3a>
        last_thread = NULL;
     fec:	00001797          	auipc	a5,0x1
     ff0:	9fc78793          	addi	a5,a5,-1540 # 19e8 <last_thread.1226>
    ...
    1012:	9da78793          	addi	a5,a5,-1574 # 19e8 <last_thread.1226>
    ...
    106e:	97e78793          	addi	a5,a5,-1666 # 19e8 <last_thread.1226>
    1072:	639c                	ld	a5,0(a5)
    1074:	c385                	beqz	a5,1094 <schedule_wrr+0xd6>
    1076:	00001797          	auipc	a5,0x1
    107a:	97278793          	addi	a5,a5,-1678 # 19e8 <last_thread.1226>
    ...
    108a:	96278793          	addi	a5,a5,-1694 # 19e8 <last_thread.1226>
    ...
    10da:	91278793          	addi	a5,a5,-1774 # 19e8 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    120c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe020>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    133e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe020>
    ...
    13d8:	a00d                	j	13fa <schedule_sjf+0x102>
    } else {
    ...
    13e8:	57fd                	li	a5,-1
    13ea:	00f70563          	beq	a4,a5,13f4 <schedule_sjf+0xfc>
    13ee:	fb442783          	lw	a5,-76(s0)
    13f2:	a011                	j	13f6 <schedule_sjf+0xfe>
    13f4:	4785                	li	a5,1
    13f6:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    13fa:	f8043783          	ld	a5,-128(s0)
    13fe:	f8f43823          	sd	a5,-112(s0)
    1402:	f8843783          	ld	a5,-120(s0)
    1406:	f8f43c23          	sd	a5,-104(s0)
    140a:	4701                	li	a4,0
    140c:	f9043703          	ld	a4,-112(s0)
    1410:	4781                	li	a5,0
    1412:	f9843783          	ld	a5,-104(s0)
    1416:	893a                	mv	s2,a4
    1418:	89be                	mv	s3,a5
    141a:	874a                	mv	a4,s2
    141c:	87ce                	mv	a5,s3
...
{
    1430:	7119                	addi	sp,sp,-128
    1432:	fc86                	sd	ra,120(sp)
    1434:	f8a2                	sd	s0,112(sp)
    1436:	f4a6                	sd	s1,104(sp)
    1438:	f0ca                	sd	s2,96(sp)
    143a:	ecce                	sd	s3,88(sp)
    ...
    1454:	faf43823          	sd	a5,-80(s0)
    1458:	fb043783          	ld	a5,-80(s0)
    145c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe020>
    1460:	faf43c23          	sd	a5,-72(s0)
    1464:	a8b5                	j	14e0 <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    1466:	fb843783          	ld	a5,-72(s0)
    146a:	47f8                	lw	a4,76(a5)
    ...
    1480:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    1484:	fc843783          	ld	a5,-56(s0)
    1488:	cb8d                	beqz	a5,14ba <schedule_lst+0x8a>
    148a:	fac42703          	lw	a4,-84(s0)
    148e:	fc442783          	lw	a5,-60(s0)
    1492:	2701                	sext.w	a4,a4
    1494:	2781                	sext.w	a5,a5
    1496:	02f74263          	blt	a4,a5,14ba <schedule_lst+0x8a>
    149a:	fac42703          	lw	a4,-84(s0)
    149e:	fc442783          	lw	a5,-60(s0)
    14a2:	2701                	sext.w	a4,a4
    14a4:	2781                	sext.w	a5,a5
    14a6:	02f71263          	bne	a4,a5,14ca <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    14aa:	fb843783          	ld	a5,-72(s0)
    14ae:	5fd8                	lw	a4,60(a5)
    14b0:	fc843783          	ld	a5,-56(s0)
    14b4:	5fdc                	lw	a5,60(a5)
    14b6:	00f75a63          	bge	a4,a5,14ca <schedule_lst+0x9a>
            min_slack = t;
    14ba:	fb843783          	ld	a5,-72(s0)
    14be:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    14c2:	fac42783          	lw	a5,-84(s0)
    14c6:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    14ca:	fb843783          	ld	a5,-72(s0)
    14ce:	779c                	ld	a5,40(a5)
    14d0:	faf43023          	sd	a5,-96(s0)
    14d4:	fa043783          	ld	a5,-96(s0)
    14d8:	fd878793          	addi	a5,a5,-40
    14dc:	faf43c23          	sd	a5,-72(s0)
    14e0:	fb843783          	ld	a5,-72(s0)
    14e4:	02878713          	addi	a4,a5,40
    14e8:	649c                	ld	a5,8(s1)
    14ea:	f6f71ee3          	bne	a4,a5,1466 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    14ee:	fc843783          	ld	a5,-56(s0)
    14f2:	cf89                	beqz	a5,150c <schedule_lst+0xdc>
    ...
    1506:	f8f42423          	sw	a5,-120(s0)
    150a:	a839                	j	1528 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    150c:	649c                	ld	a5,8(s1)
    150e:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1512:	689c                	ld	a5,16(s1)
    1514:	4098                	lw	a4,0(s1)
    1516:	85ba                	mv	a1,a4
    1518:	853e                	mv	a0,a5
    151a:	00000097          	auipc	ra,0x0
    151e:	c08080e7          	jalr	-1016(ra) # 1122 <find_next_release_time>
    1522:	87aa                	mv	a5,a0
    1524:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    1528:	f8043783          	ld	a5,-128(s0)
    152c:	f8f43823          	sd	a5,-112(s0)
    1530:	f8843783          	ld	a5,-120(s0)
    1534:	f8f43c23          	sd	a5,-104(s0)
    1538:	4701                	li	a4,0
    153a:	f9043703          	ld	a4,-112(s0)
    153e:	4781                	li	a5,0
    1540:	f9843783          	ld	a5,-104(s0)
    1544:	893a                	mv	s2,a4
    1546:	89be                	mv	s3,a5
    1548:	874a                	mv	a4,s2
    154a:	87ce                	mv	a5,s3
    ...
    155a:	6109                	addi	sp,sp,128
    155c:	8082                	ret

000000000000155e <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    155e:	7135                	addi	sp,sp,-160
    1560:	ed06                	sd	ra,152(sp)
    1562:	e922                	sd	s0,144(sp)
    1564:	e526                	sd	s1,136(sp)
    1566:	e14a                	sd	s2,128(sp)
    1568:	fcce                	sd	s3,120(sp)
    156a:	1100                	addi	s0,sp,160
    156c:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    156e:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    1572:	800007b7          	lui	a5,0x80000
    1576:	fff7c793          	not	a5,a5
    157a:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    157e:	649c                	ld	a5,8(s1)
    1580:	639c                	ld	a5,0(a5)
    1582:	faf43423          	sd	a5,-88(s0)
    1586:	fa843783          	ld	a5,-88(s0)
    158a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe020>
    158e:	fcf43023          	sd	a5,-64(s0)
    1592:	a841                	j	1622 <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    1594:	fc043783          	ld	a5,-64(s0)
    1598:	43bc                	lw	a5,64(a5)
    159a:	cb95                	beqz	a5,15ce <schedule_dm+0x70>
    159c:	fc043783          	ld	a5,-64(s0)
    15a0:	4bbc                	lw	a5,80(a5)
    15a2:	873e                	mv	a4,a5
    15a4:	57fd                	li	a5,-1
    15a6:	02f70463          	beq	a4,a5,15ce <schedule_dm+0x70>
    15aa:	fc043783          	ld	a5,-64(s0)
    15ae:	4ff8                	lw	a4,92(a5)
    15b0:	fbc42783          	lw	a5,-68(s0)
    15b4:	2781                	sext.w	a5,a5
    15b6:	00f75c63          	bge	a4,a5,15ce <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    15ba:	fc043783          	ld	a5,-64(s0)
    15be:	4ffc                	lw	a5,92(a5)
    15c0:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    15c4:	fc043783          	ld	a5,-64(s0)
    15c8:	fcf43423          	sd	a5,-56(s0)
    15cc:	a081                	j	160c <schedule_dm+0xae>
        } else if (t->is_real_time && t->period != -1 && t->current_deadline == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    15ce:	fc043783          	ld	a5,-64(s0)
    15d2:	43bc                	lw	a5,64(a5)
    15d4:	cf85                	beqz	a5,160c <schedule_dm+0xae>
    15d6:	fc043783          	ld	a5,-64(s0)
    15da:	4bbc                	lw	a5,80(a5)
    15dc:	873e                	mv	a4,a5
    15de:	57fd                	li	a5,-1
    15e0:	02f70663          	beq	a4,a5,160c <schedule_dm+0xae>
    15e4:	fc043783          	ld	a5,-64(s0)
    15e8:	4ff8                	lw	a4,92(a5)
    15ea:	fbc42783          	lw	a5,-68(s0)
    15ee:	2781                	sext.w	a5,a5
    15f0:	00e79e63          	bne	a5,a4,160c <schedule_dm+0xae>
    15f4:	fc043783          	ld	a5,-64(s0)
    15f8:	5fd8                	lw	a4,60(a5)
    15fa:	fc843783          	ld	a5,-56(s0)
    15fe:	5fdc                	lw	a5,60(a5)
    1600:	00f75663          	bge	a4,a5,160c <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    1604:	fc043783          	ld	a5,-64(s0)
    1608:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    160c:	fc043783          	ld	a5,-64(s0)
    1610:	779c                	ld	a5,40(a5)
    1612:	f8f43423          	sd	a5,-120(s0)
    1616:	f8843783          	ld	a5,-120(s0)
    161a:	fd878793          	addi	a5,a5,-40
    161e:	fcf43023          	sd	a5,-64(s0)
    1622:	fc043783          	ld	a5,-64(s0)
    1626:	02878713          	addi	a4,a5,40
    162a:	649c                	ld	a5,8(s1)
    162c:	f6f714e3          	bne	a4,a5,1594 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    1630:	fc843783          	ld	a5,-56(s0)
    1634:	c7a5                	beqz	a5,169c <schedule_dm+0x13e>
    ...
    163c:	409c                	lw	a5,0(s1)
    163e:	40f707bb          	subw	a5,a4,a5
    1642:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    1646:	fc843783          	ld	a5,-56(s0)
    164a:	4fb8                	lw	a4,88(a5)
    164c:	f9442783          	lw	a5,-108(s0)
    1650:	2781                	sext.w	a5,a5
    1652:	00e7db63          	bge	a5,a4,1668 <schedule_dm+0x10a>
    ...
    1656:	fc843783          	ld	a5,-56(s0)
    165a:	02878793          	addi	a5,a5,40
    165e:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    1662:	f6042823          	sw	zero,-144(s0)
    1666:	a0f1                	j	1732 <schedule_dm+0x1d4>
        } else {
    ...
    166e:	863e                	mv	a2,a5
    1670:	f9442783          	lw	a5,-108(s0)
    1674:	0007869b          	sext.w	a3,a5
    1678:	0006071b          	sext.w	a4,a2
    167c:	00d75363          	bge	a4,a3,1682 <schedule_dm+0x124>
    1680:	87b2                	mv	a5,a2
    1682:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1686:	fc843783          	ld	a5,-56(s0)
    168a:	02878793          	addi	a5,a5,40
    168e:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    1692:	f9042783          	lw	a5,-112(s0)
    1696:	f6f42823          	sw	a5,-144(s0)
    169a:	a861                	j	1732 <schedule_dm+0x1d4>
        }
    } else {
    ...
    169c:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    16a0:	649c                	ld	a5,8(s1)
    16a2:	639c                	ld	a5,0(a5)
    16a4:	faf43023          	sd	a5,-96(s0)
    16a8:	fa043783          	ld	a5,-96(s0)
    16ac:	fd878793          	addi	a5,a5,-40
    16b0:	fcf43023          	sd	a5,-64(s0)
    16b4:	a81d                	j	16ea <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    16b6:	fb043783          	ld	a5,-80(s0)
    16ba:	cb89                	beqz	a5,16cc <schedule_dm+0x16e>
    16bc:	fc043783          	ld	a5,-64(s0)
    16c0:	5fd8                	lw	a4,60(a5)
    16c2:	fb043783          	ld	a5,-80(s0)
    16c6:	5fdc                	lw	a5,60(a5)
    16c8:	00f75663          	bge	a4,a5,16d4 <schedule_dm+0x176>
                smallest_id_thread = t;
    16cc:	fc043783          	ld	a5,-64(s0)
    16d0:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    16d4:	fc043783          	ld	a5,-64(s0)
    16d8:	779c                	ld	a5,40(a5)
    16da:	f8f43c23          	sd	a5,-104(s0)
    16de:	f9843783          	ld	a5,-104(s0)
    16e2:	fd878793          	addi	a5,a5,-40
    16e6:	fcf43023          	sd	a5,-64(s0)
    16ea:	fc043783          	ld	a5,-64(s0)
    16ee:	02878713          	addi	a4,a5,40
    16f2:	649c                	ld	a5,8(s1)
    16f4:	fcf711e3          	bne	a4,a5,16b6 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    16f8:	fb043783          	ld	a5,-80(s0)
    16fc:	cf89                	beqz	a5,1716 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    16fe:	fb043783          	ld	a5,-80(s0)
    1702:	02878793          	addi	a5,a5,40
    1706:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    170a:	fb043783          	ld	a5,-80(s0)
    170e:	4fbc                	lw	a5,88(a5)
    1710:	f6f42823          	sw	a5,-144(s0)
    1714:	a839                	j	1732 <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    1716:	649c                	ld	a5,8(s1)
    1718:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    171c:	689c                	ld	a5,16(s1)
    171e:	4098                	lw	a4,0(s1)
    1720:	85ba                	mv	a1,a4
    1722:	853e                	mv	a0,a5
    1724:	00000097          	auipc	ra,0x0
    1728:	9fe080e7          	jalr	-1538(ra) # 1122 <find_next_release_time>
    172c:	87aa                	mv	a5,a0
    ...
    return r;
    1732:	f6843783          	ld	a5,-152(s0)
    1736:	f6f43c23          	sd	a5,-136(s0)
    173a:	f7043783          	ld	a5,-144(s0)
    173e:	f8f43023          	sd	a5,-128(s0)
    1742:	4701                	li	a4,0
    1744:	f7843703          	ld	a4,-136(s0)
    1748:	4781                	li	a5,0
    174a:	f8043783          	ld	a5,-128(s0)
    174e:	893a                	mv	s2,a4
    1750:	89be                	mv	s3,a5
    1752:	874a                	mv	a4,s2
    1754:	87ce                	mv	a5,s3
    ...
    1756:	853a                	mv	a0,a4
    1758:	85be                	mv	a1,a5
    175a:	60ea                	ld	ra,152(sp)
    175c:	644a                	ld	s0,144(sp)
    175e:	64aa                	ld	s1,136(sp)
    1760:	690a                	ld	s2,128(sp)
    1762:	79e6                	ld	s3,120(sp)
    1764:	610d                	addi	sp,sp,160
    1766:	8082                	ret

...
fmtname(char *path)
{
  ...
  memmove(buf, p, strlen(p));
      ...
      9a:	97a50513          	addi	a0,a0,-1670 # 1a10 <buf.1118>
  ...
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
      ...
      c0:	95478793          	addi	a5,a5,-1708 # 1a10 <buf.1118>
  ...
  return buf;
      ...
      f4:	92078793          	addi	a5,a5,-1760 # 1a10 <buf.1118>
}
      f8:	853e                	mv	a0,a5
      fa:	70e2                	ld	ra,56(sp)
      fc:	7442                	ld	s0,48(sp)
...
ls(char *path)
{
  ...
  if((fd = open(path, 0)) < 0){
    ...
    fprintf(2, "ls: cannot open %s\n", path);
     ...
     13c:	84858593          	addi	a1,a1,-1976 # 1980 <schedule_dm+0x210>
     140:	4509                	li	a0,2
  ...
  if(fstat(fd, &st) < 0){
    ...
    fprintf(2, "ls: cannot stat %s\n", path);
     ...
     16e:	82e58593          	addi	a1,a1,-2002 # 1998 <schedule_dm+0x228>
     172:	4509                	li	a0,2
  ...
  case T_FILE:
    printf("%s %d %d %l\n", fmtname(path), st.type, st.ino, st.size);
     ...
     1c4:	7f050513          	addi	a0,a0,2032 # 19b0 <schedule_dm+0x240>
  ...
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
     ...
     1f4:	7d050513          	addi	a0,a0,2000 # 19c0 <schedule_dm+0x250>
    ...
    *p++ = '/';
    ...
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
     ...
     296:	70650513          	addi	a0,a0,1798 # 1998 <schedule_dm+0x228>
     ...
     2c8:	71450513          	addi	a0,a0,1812 # 19d8 <schedule_dm+0x268>
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    ls(".");
     ...
     336:	6b650513          	addi	a0,a0,1718 # 19e8 <schedule_dm+0x278>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     988:	07468693          	addi	a3,a3,116 # 19f8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     a62:	f9a70713          	addi	a4,a4,-102 # 19f8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     c22:	dd278793          	addi	a5,a5,-558 # 19f0 <schedule_dm+0x280>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     dce:	c6678793          	addi	a5,a5,-922 # 1a30 <freep>
     dd2:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     ec6:	b6e78793          	addi	a5,a5,-1170 # 1a30 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     f48:	aec78793          	addi	a5,a5,-1300 # 1a30 <freep>
     f4c:	639c                	ld	a5,0(a5)
}
     f4e:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     f7a:	aba78793          	addi	a5,a5,-1350 # 1a30 <freep>
     f7e:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     f8e:	a9678793          	addi	a5,a5,-1386 # 1a20 <base>
     f92:	fef43023          	sd	a5,-32(s0)
     f96:	00001797          	auipc	a5,0x1
     f9a:	a9a78793          	addi	a5,a5,-1382 # 1a30 <freep>
     f9e:	fe043703          	ld	a4,-32(s0)
     fa2:	e398                	sd	a4,0(a5)
     fa4:	00001797          	auipc	a5,0x1
     fa8:	a8c78793          	addi	a5,a5,-1396 # 1a30 <freep>
     fac:	6398                	ld	a4,0(a5)
     fae:	00001797          	auipc	a5,0x1
     fb2:	a7278793          	addi	a5,a5,-1422 # 1a20 <base>
     fb6:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     fb8:	00001797          	auipc	a5,0x1
     fbc:	a6878793          	addi	a5,a5,-1432 # 1a20 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1038:	9fc78793          	addi	a5,a5,-1540 # 1a30 <freep>
    ...
    104e:	9e678793          	addi	a5,a5,-1562 # 1a30 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    1224:	81878793          	addi	a5,a5,-2024 # 1a38 <last_thread.1226>
    ...
    1280:	7bc78793          	addi	a5,a5,1980 # 1a38 <last_thread.1226>
    1284:	639c                	ld	a5,0(a5)
    1286:	c385                	beqz	a5,12a6 <schedule_wrr+0xd6>
    1288:	00000797          	auipc	a5,0x0
    128c:	7b078793          	addi	a5,a5,1968 # 1a38 <last_thread.1226>
    ...
    129c:	7a078793          	addi	a5,a5,1952 # 1a38 <last_thread.1226>
    ...
    12ec:	75078793          	addi	a5,a5,1872 # 1a38 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    141e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdde0>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    1550:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdde0>
    ...
    15ea:	a00d                	j	160c <schedule_sjf+0x102>
    } else {
    ...
    15fa:	57fd                	li	a5,-1
    15fc:	00f70563          	beq	a4,a5,1606 <schedule_sjf+0xfc>
    1600:	fb442783          	lw	a5,-76(s0)
    1604:	a011                	j	1608 <schedule_sjf+0xfe>
    1606:	4785                	li	a5,1
    1608:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    160c:	f8043783          	ld	a5,-128(s0)
    1610:	f8f43823          	sd	a5,-112(s0)
    1614:	f8843783          	ld	a5,-120(s0)
    1618:	f8f43c23          	sd	a5,-104(s0)
    161c:	4701                	li	a4,0
    161e:	f9043703          	ld	a4,-112(s0)
    1622:	4781                	li	a5,0
    1624:	f9843783          	ld	a5,-104(s0)
    1628:	893a                	mv	s2,a4
    162a:	89be                	mv	s3,a5
    162c:	874a                	mv	a4,s2
    162e:	87ce                	mv	a5,s3
    ...
    163e:	6109                	addi	sp,sp,128
    1640:	8082                	ret

0000000000001642 <schedule_lst>:
...
{
    1642:	7119                	addi	sp,sp,-128
    1644:	fc86                	sd	ra,120(sp)
    1646:	f8a2                	sd	s0,112(sp)
    1648:	f4a6                	sd	s1,104(sp)
    164a:	f0ca                	sd	s2,96(sp)
    164c:	ecce                	sd	s3,88(sp)
    164e:	0100                	addi	s0,sp,128
    1650:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the least-slack-time scheduling algorithm
    struct thread *min_slack = NULL;
    1652:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    1656:	800007b7          	lui	a5,0x80000
    165a:	fff7c793          	not	a5,a5
    165e:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    ...
    1666:	faf43823          	sd	a5,-80(s0)
    166a:	fb043783          	ld	a5,-80(s0)
    166e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdde0>
    1672:	faf43c23          	sd	a5,-72(s0)
    1676:	a8b5                	j	16f2 <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    1678:	fb843783          	ld	a5,-72(s0)
    167c:	47f8                	lw	a4,76(a5)
    167e:	409c                	lw	a5,0(s1)
    1680:	40f707bb          	subw	a5,a4,a5
    1684:	0007871b          	sext.w	a4,a5
    1688:	fb843783          	ld	a5,-72(s0)
    168c:	4fbc                	lw	a5,88(a5)
    168e:	40f707bb          	subw	a5,a4,a5
    1692:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    1696:	fc843783          	ld	a5,-56(s0)
    169a:	cb8d                	beqz	a5,16cc <schedule_lst+0x8a>
    169c:	fac42703          	lw	a4,-84(s0)
    16a0:	fc442783          	lw	a5,-60(s0)
    16a4:	2701                	sext.w	a4,a4
    16a6:	2781                	sext.w	a5,a5
    16a8:	02f74263          	blt	a4,a5,16cc <schedule_lst+0x8a>
    16ac:	fac42703          	lw	a4,-84(s0)
    16b0:	fc442783          	lw	a5,-60(s0)
    16b4:	2701                	sext.w	a4,a4
    16b6:	2781                	sext.w	a5,a5
    16b8:	02f71263          	bne	a4,a5,16dc <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    16bc:	fb843783          	ld	a5,-72(s0)
    16c0:	5fd8                	lw	a4,60(a5)
    16c2:	fc843783          	ld	a5,-56(s0)
    16c6:	5fdc                	lw	a5,60(a5)
    16c8:	00f75a63          	bge	a4,a5,16dc <schedule_lst+0x9a>
            min_slack = t;
    16cc:	fb843783          	ld	a5,-72(s0)
    16d0:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    16d4:	fac42783          	lw	a5,-84(s0)
    16d8:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    16dc:	fb843783          	ld	a5,-72(s0)
    16e0:	779c                	ld	a5,40(a5)
    16e2:	faf43023          	sd	a5,-96(s0)
    16e6:	fa043783          	ld	a5,-96(s0)
    16ea:	fd878793          	addi	a5,a5,-40
    16ee:	faf43c23          	sd	a5,-72(s0)
    16f2:	fb843783          	ld	a5,-72(s0)
    16f6:	02878713          	addi	a4,a5,40
    16fa:	649c                	ld	a5,8(s1)
    16fc:	f6f71ee3          	bne	a4,a5,1678 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    1700:	fc843783          	ld	a5,-56(s0)
    1704:	cf89                	beqz	a5,171e <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    1706:	fc843783          	ld	a5,-56(s0)
    170a:	02878793          	addi	a5,a5,40
    170e:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    1712:	fc843783          	ld	a5,-56(s0)
    1716:	4fbc                	lw	a5,88(a5)
    1718:	f8f42423          	sw	a5,-120(s0)
    171c:	a839                	j	173a <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    171e:	649c                	ld	a5,8(s1)
    1720:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1724:	689c                	ld	a5,16(s1)
    1726:	4098                	lw	a4,0(s1)
    1728:	85ba                	mv	a1,a4
    172a:	853e                	mv	a0,a5
    172c:	00000097          	auipc	ra,0x0
    1730:	c08080e7          	jalr	-1016(ra) # 1334 <find_next_release_time>
    1734:	87aa                	mv	a5,a0
    1736:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    173a:	f8043783          	ld	a5,-128(s0)
    173e:	f8f43823          	sd	a5,-112(s0)
    1742:	f8843783          	ld	a5,-120(s0)
    1746:	f8f43c23          	sd	a5,-104(s0)
    174a:	4701                	li	a4,0
    174c:	f9043703          	ld	a4,-112(s0)
    1750:	4781                	li	a5,0
    1752:	f9843783          	ld	a5,-104(s0)
    1756:	893a                	mv	s2,a4
    1758:	89be                	mv	s3,a5
    175a:	874a                	mv	a4,s2
    175c:	87ce                	mv	a5,s3
    ...
    175e:	853a                	mv	a0,a4
    1760:	85be                	mv	a1,a5
    1762:	70e6                	ld	ra,120(sp)
    1764:	7446                	ld	s0,112(sp)
    1766:	74a6                	ld	s1,104(sp)
    1768:	7906                	ld	s2,96(sp)
    176a:	69e6                	ld	s3,88(sp)
    176c:	6109                	addi	sp,sp,128
    176e:	8082                	ret

0000000000001770 <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    1770:	7135                	addi	sp,sp,-160
    1772:	ed06                	sd	ra,152(sp)
    1774:	e922                	sd	s0,144(sp)
    1776:	e526                	sd	s1,136(sp)
    1778:	e14a                	sd	s2,128(sp)
    177a:	fcce                	sd	s3,120(sp)
    177c:	1100                	addi	s0,sp,160
    177e:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    1780:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    1784:	800007b7          	lui	a5,0x80000
    1788:	fff7c793          	not	a5,a5
    178c:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    1790:	649c                	ld	a5,8(s1)
    1792:	639c                	ld	a5,0(a5)
    1794:	faf43423          	sd	a5,-88(s0)
    1798:	fa843783          	ld	a5,-88(s0)
    179c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdde0>
    17a0:	fcf43023          	sd	a5,-64(s0)
    17a4:	a841                	j	1834 <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    17a6:	fc043783          	ld	a5,-64(s0)
    17aa:	43bc                	lw	a5,64(a5)
    17ac:	cb95                	beqz	a5,17e0 <schedule_dm+0x70>
    17ae:	fc043783          	ld	a5,-64(s0)
    17b2:	4bbc                	lw	a5,80(a5)
    17b4:	873e                	mv	a4,a5
    17b6:	57fd                	li	a5,-1
    17b8:	02f70463          	beq	a4,a5,17e0 <schedule_dm+0x70>
    17bc:	fc043783          	ld	a5,-64(s0)
    17c0:	4ff8                	lw	a4,92(a5)
    17c2:	fbc42783          	lw	a5,-68(s0)
    17c6:	2781                	sext.w	a5,a5
    17c8:	00f75c63          	bge	a4,a5,17e0 <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    17cc:	fc043783          	ld	a5,-64(s0)
    17d0:	4ffc                	lw	a5,92(a5)
    17d2:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    17d6:	fc043783          	ld	a5,-64(s0)
    17da:	fcf43423          	sd	a5,-56(s0)
    17de:	a081                	j	181e <schedule_dm+0xae>
        } else if (t->is_real_time && t->period != -1 && t->current_deadline == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    17e0:	fc043783          	ld	a5,-64(s0)
    17e4:	43bc                	lw	a5,64(a5)
    17e6:	cf85                	beqz	a5,181e <schedule_dm+0xae>
    17e8:	fc043783          	ld	a5,-64(s0)
    17ec:	4bbc                	lw	a5,80(a5)
    17ee:	873e                	mv	a4,a5
    17f0:	57fd                	li	a5,-1
    17f2:	02f70663          	beq	a4,a5,181e <schedule_dm+0xae>
    17f6:	fc043783          	ld	a5,-64(s0)
    17fa:	4ff8                	lw	a4,92(a5)
    17fc:	fbc42783          	lw	a5,-68(s0)
    1800:	2781                	sext.w	a5,a5
    1802:	00e79e63          	bne	a5,a4,181e <schedule_dm+0xae>
    1806:	fc043783          	ld	a5,-64(s0)
    180a:	5fd8                	lw	a4,60(a5)
    180c:	fc843783          	ld	a5,-56(s0)
    1810:	5fdc                	lw	a5,60(a5)
    1812:	00f75663          	bge	a4,a5,181e <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    1816:	fc043783          	ld	a5,-64(s0)
    181a:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    181e:	fc043783          	ld	a5,-64(s0)
    1822:	779c                	ld	a5,40(a5)
    1824:	f8f43423          	sd	a5,-120(s0)
    1828:	f8843783          	ld	a5,-120(s0)
    182c:	fd878793          	addi	a5,a5,-40
    1830:	fcf43023          	sd	a5,-64(s0)
    1834:	fc043783          	ld	a5,-64(s0)
    1838:	02878713          	addi	a4,a5,40
    183c:	649c                	ld	a5,8(s1)
    183e:	f6f714e3          	bne	a4,a5,17a6 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    1842:	fc843783          	ld	a5,-56(s0)
    1846:	c7a5                	beqz	a5,18ae <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    1848:	fc843783          	ld	a5,-56(s0)
    184c:	4ff8                	lw	a4,92(a5)
    184e:	409c                	lw	a5,0(s1)
    1850:	40f707bb          	subw	a5,a4,a5
    1854:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    1858:	fc843783          	ld	a5,-56(s0)
    185c:	4fb8                	lw	a4,88(a5)
    185e:	f9442783          	lw	a5,-108(s0)
    1862:	2781                	sext.w	a5,a5
    1864:	00e7db63          	bge	a5,a4,187a <schedule_dm+0x10a>
    ...
    1868:	fc843783          	ld	a5,-56(s0)
    186c:	02878793          	addi	a5,a5,40
    1870:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    1874:	f6042823          	sw	zero,-144(s0)
    1878:	a0f1                	j	1944 <schedule_dm+0x1d4>
        } else {
    ...
    187e:	4fbc                	lw	a5,88(a5)
    1880:	863e                	mv	a2,a5
    1882:	f9442783          	lw	a5,-108(s0)
    1886:	0007869b          	sext.w	a3,a5
    188a:	0006071b          	sext.w	a4,a2
    188e:	00d75363          	bge	a4,a3,1894 <schedule_dm+0x124>
    1892:	87b2                	mv	a5,a2
    1894:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1898:	fc843783          	ld	a5,-56(s0)
    189c:	02878793          	addi	a5,a5,40
    18a0:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    18a4:	f9042783          	lw	a5,-112(s0)
    18a8:	f6f42823          	sw	a5,-144(s0)
    18ac:	a861                	j	1944 <schedule_dm+0x1d4>
        }
    } else {
    ...
    18ae:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    18b2:	649c                	ld	a5,8(s1)
    18b4:	639c                	ld	a5,0(a5)
    18b6:	faf43023          	sd	a5,-96(s0)
    18ba:	fa043783          	ld	a5,-96(s0)
    18be:	fd878793          	addi	a5,a5,-40
    18c2:	fcf43023          	sd	a5,-64(s0)
    18c6:	a81d                	j	18fc <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    18c8:	fb043783          	ld	a5,-80(s0)
    18cc:	cb89                	beqz	a5,18de <schedule_dm+0x16e>
    18ce:	fc043783          	ld	a5,-64(s0)
    18d2:	5fd8                	lw	a4,60(a5)
    18d4:	fb043783          	ld	a5,-80(s0)
    18d8:	5fdc                	lw	a5,60(a5)
    18da:	00f75663          	bge	a4,a5,18e6 <schedule_dm+0x176>
                smallest_id_thread = t;
    18de:	fc043783          	ld	a5,-64(s0)
    18e2:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    18e6:	fc043783          	ld	a5,-64(s0)
    18ea:	779c                	ld	a5,40(a5)
    18ec:	f8f43c23          	sd	a5,-104(s0)
    18f0:	f9843783          	ld	a5,-104(s0)
    18f4:	fd878793          	addi	a5,a5,-40
    18f8:	fcf43023          	sd	a5,-64(s0)
    18fc:	fc043783          	ld	a5,-64(s0)
    1900:	02878713          	addi	a4,a5,40
    1904:	649c                	ld	a5,8(s1)
    1906:	fcf711e3          	bne	a4,a5,18c8 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    190a:	fb043783          	ld	a5,-80(s0)
    190e:	cf89                	beqz	a5,1928 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    1910:	fb043783          	ld	a5,-80(s0)
    1914:	02878793          	addi	a5,a5,40
    1918:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    191c:	fb043783          	ld	a5,-80(s0)
    1920:	4fbc                	lw	a5,88(a5)
    1922:	f6f42823          	sw	a5,-144(s0)
    1926:	a839                	j	1944 <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    1928:	649c                	ld	a5,8(s1)
    192a:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    192e:	689c                	ld	a5,16(s1)
    1930:	4098                	lw	a4,0(s1)
    1932:	85ba                	mv	a1,a4
    1934:	853e                	mv	a0,a5
    1936:	00000097          	auipc	ra,0x0
    193a:	9fe080e7          	jalr	-1538(ra) # 1334 <find_next_release_time>
    193e:	87aa                	mv	a5,a0
    1940:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    1944:	f6843783          	ld	a5,-152(s0)
    1948:	f6f43c23          	sd	a5,-136(s0)
    194c:	f7043783          	ld	a5,-144(s0)
    1950:	f8f43023          	sd	a5,-128(s0)
    1954:	4701                	li	a4,0
    1956:	f7843703          	ld	a4,-136(s0)
    195a:	4781                	li	a5,0
    195c:	f8043783          	ld	a5,-128(s0)
    1960:	893a                	mv	s2,a4
    1962:	89be                	mv	s3,a5
    1964:	874a                	mv	a4,s2
    1966:	87ce                	mv	a5,s3
    ...
    1968:	853a                	mv	a0,a4
    196a:	85be                	mv	a1,a5
    196c:	60ea                	ld	ra,152(sp)
    196e:	644a                	ld	s0,144(sp)
    1970:	64aa                	ld	s1,136(sp)
    1972:	690a                	ld	s2,128(sp)
    1974:	79e6                	ld	s3,120(sp)
    1976:	610d                	addi	sp,sp,160
    1978:	8082                	ret

...
fmtname(char *path)
{
  ...
  memmove(buf, p, strlen(p));
      ...
      9a:	ba250513          	addi	a0,a0,-1118 # 1c38 <buf.1118>
  ...
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
      ...
      c0:	b7c78793          	addi	a5,a5,-1156 # 1c38 <buf.1118>
  ...
  return buf;
      ...
      f4:	b4878793          	addi	a5,a5,-1208 # 1c38 <buf.1118>
}
      f8:	853e                	mv	a0,a5
      fa:	70e2                	ld	ra,56(sp)
      fc:	7442                	ld	s0,48(sp)
...
ls(char *path)
{
  ...
  if((fd = open(path, 0)) < 0){
    ...
    fprintf(2, "ls: cannot open %s\n", path);
     ...
     13c:	a7058593          	addi	a1,a1,-1424 # 1ba8 <schedule_dm+0x17a>
     140:	4509                	li	a0,2
  ...
  if(fstat(fd, &st) < 0){
    ...
    fprintf(2, "ls: cannot stat %s\n", path);
     ...
     16e:	a5658593          	addi	a1,a1,-1450 # 1bc0 <schedule_dm+0x192>
     172:	4509                	li	a0,2
  ...
  case T_FILE:
    printf("%s %d %d %l\n", fmtname(path), st.type, st.ino, st.size);
     ...
     1c4:	a1850513          	addi	a0,a0,-1512 # 1bd8 <schedule_dm+0x1aa>
  ...
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
     ...
     1f4:	9f850513          	addi	a0,a0,-1544 # 1be8 <schedule_dm+0x1ba>
    ...
    *p++ = '/';
    ...
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
     ...
     296:	92e50513          	addi	a0,a0,-1746 # 1bc0 <schedule_dm+0x192>
     ...
     2c8:	93c50513          	addi	a0,a0,-1732 # 1c00 <schedule_dm+0x1d2>
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    ls(".");
     ...
     336:	8de50513          	addi	a0,a0,-1826 # 1c10 <schedule_dm+0x1e2>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     988:	29c68693          	addi	a3,a3,668 # 1c20 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     a62:	1c270713          	addi	a4,a4,450 # 1c20 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     c22:	ffa78793          	addi	a5,a5,-6 # 1c18 <schedule_dm+0x1ea>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     dce:	e8e78793          	addi	a5,a5,-370 # 1c58 <freep>
     dd2:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     ec6:	d9678793          	addi	a5,a5,-618 # 1c58 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     f48:	d1478793          	addi	a5,a5,-748 # 1c58 <freep>
     f4c:	639c                	ld	a5,0(a5)
}
     f4e:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     f7a:	ce278793          	addi	a5,a5,-798 # 1c58 <freep>
     f7e:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     f8e:	cbe78793          	addi	a5,a5,-834 # 1c48 <base>
     f92:	fef43023          	sd	a5,-32(s0)
     f96:	00001797          	auipc	a5,0x1
     f9a:	cc278793          	addi	a5,a5,-830 # 1c58 <freep>
     f9e:	fe043703          	ld	a4,-32(s0)
     fa2:	e398                	sd	a4,0(a5)
     fa4:	00001797          	auipc	a5,0x1
     fa8:	cb478793          	addi	a5,a5,-844 # 1c58 <freep>
     fac:	6398                	ld	a4,0(a5)
     fae:	00001797          	auipc	a5,0x1
     fb2:	c9a78793          	addi	a5,a5,-870 # 1c48 <base>
     fb6:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     fb8:	00001797          	auipc	a5,0x1
     fbc:	c9078793          	addi	a5,a5,-880 # 1c48 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1038:	c2478793          	addi	a5,a5,-988 # 1c58 <freep>
    ...
    104e:	c0e78793          	addi	a5,a5,-1010 # 1c58 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    1224:	a4078793          	addi	a5,a5,-1472 # 1c60 <last_thread.1226>
    ...
    1280:	9e478793          	addi	a5,a5,-1564 # 1c60 <last_thread.1226>
    1284:	639c                	ld	a5,0(a5)
    1286:	c385                	beqz	a5,12a6 <schedule_wrr+0xd6>
    1288:	00001797          	auipc	a5,0x1
    128c:	9d878793          	addi	a5,a5,-1576 # 1c60 <last_thread.1226>
    ...
    129c:	9c878793          	addi	a5,a5,-1592 # 1c60 <last_thread.1226>
    ...
    12ec:	97878793          	addi	a5,a5,-1672 # 1c60 <last_thread.1226>
...
int find_next_release_time(struct list_head *release_queue, int current_time) {
    ...
    13ae:	fc843703          	ld	a4,-56(s0)
    13b2:	faf71ce3          	bne	a4,a5,136a <find_next_release_time+0x36>
        }
    }

    if (next_release_time == INT_MAX)
    13b6:	fe442783          	lw	a5,-28(s0)
    13ba:	0007871b          	sext.w	a4,a5
    13be:	800007b7          	lui	a5,0x80000
    13c2:	fff7c793          	not	a5,a5
    13c6:	00f71463          	bne	a4,a5,13ce <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    13ca:	57fd                	li	a5,-1
    13cc:	a801                	j	13dc <find_next_release_time+0xa8>

    return next_release_time - current_time;
    13ce:	fe442703          	lw	a4,-28(s0)
    13d2:	fc442783          	lw	a5,-60(s0)
    13d6:	40f707bb          	subw	a5,a4,a5
    13da:	2781                	sext.w	a5,a5
}
    13dc:	853e                	mv	a0,a5
    13de:	7462                	ld	s0,56(sp)
    13e0:	6121                	addi	sp,sp,64
    13e2:	8082                	ret

00000000000013e4 <find_earliest_impactful_release_time>:



int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    13e4:	7159                	addi	sp,sp,-112
    13e6:	f4a2                	sd	s0,104(sp)
    13e8:	1880                	addi	s0,sp,112
    13ea:	faa43423          	sd	a0,-88(s0)
    13ee:	fab43023          	sd	a1,-96(s0)
    13f2:	87b2                	mv	a5,a2
    13f4:	f8f42e23          	sw	a5,-100(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_time = INT_MAX;
    13f8:	800007b7          	lui	a5,0x80000
    13fc:	fff7c793          	not	a5,a5
    1400:	fef42223          	sw	a5,-28(s0)
    int shortest_current_time = INT_MAX;
    1404:	800007b7          	lui	a5,0x80000
    1408:	fff7c793          	not	a5,a5
    140c:	fef42023          	sw	a5,-32(s0)

    // Find the shortest remaining time among currently running tasks
    struct thread *t;
    list_for_each_entry(t, run_queue, thread_list) {
    1410:	fa043783          	ld	a5,-96(s0)
    1414:	639c                	ld	a5,0(a5)
    1416:	fcf43823          	sd	a5,-48(s0)
    141a:	fd043783          	ld	a5,-48(s0)
    141e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdbb8>
    1422:	fcf43c23          	sd	a5,-40(s0)
    1426:	a80d                	j	1458 <find_earliest_impactful_release_time+0x74>
        if (t->remaining_time < shortest_current_time) {
    1428:	fd843783          	ld	a5,-40(s0)
    142c:	4fb8                	lw	a4,88(a5)
    142e:	fe042783          	lw	a5,-32(s0)
    1432:	2781                	sext.w	a5,a5
    1434:	00f75763          	bge	a4,a5,1442 <find_earliest_impactful_release_time+0x5e>
            shortest_current_time = t->remaining_time;
    1438:	fd843783          	ld	a5,-40(s0)
    143c:	4fbc                	lw	a5,88(a5)
    143e:	fef42023          	sw	a5,-32(s0)
    list_for_each_entry(t, run_queue, thread_list) {
    1442:	fd843783          	ld	a5,-40(s0)
    1446:	779c                	ld	a5,40(a5)
    1448:	faf43c23          	sd	a5,-72(s0)
    144c:	fb843783          	ld	a5,-72(s0)
    1450:	fd878793          	addi	a5,a5,-40
    1454:	fcf43c23          	sd	a5,-40(s0)
    1458:	fd843783          	ld	a5,-40(s0)
    145c:	02878793          	addi	a5,a5,40
    1460:	fa043703          	ld	a4,-96(s0)
    1464:	fcf712e3          	bne	a4,a5,1428 <find_earliest_impactful_release_time+0x44>
        }
    }
    ...
    1468:	fa843783          	ld	a5,-88(s0)
    146c:	639c                	ld	a5,0(a5)
    146e:	fcf43423          	sd	a5,-56(s0)
    1472:	fc843783          	ld	a5,-56(s0)
    1476:	17e1                	addi	a5,a5,-8
    1478:	fef43423          	sd	a5,-24(s0)
    147c:	a889                	j	14ce <find_earliest_impactful_release_time+0xea>
        if (entry->release_time > current_time && entry->release_time < earliest_impactful_time) {
    147e:	fe843783          	ld	a5,-24(s0)
    1482:	4f98                	lw	a4,24(a5)
    1484:	f9c42783          	lw	a5,-100(s0)
    1488:	2781                	sext.w	a5,a5
    148a:	02e7d863          	bge	a5,a4,14ba <find_earliest_impactful_release_time+0xd6>
    148e:	fe843783          	ld	a5,-24(s0)
    1492:	4f98                	lw	a4,24(a5)
    1494:	fe442783          	lw	a5,-28(s0)
    1498:	2781                	sext.w	a5,a5
    149a:	02f75063          	bge	a4,a5,14ba <find_earliest_impactful_release_time+0xd6>
            if (entry->thrd->remaining_time < shortest_current_time) {
    149e:	fe843783          	ld	a5,-24(s0)
    14a2:	639c                	ld	a5,0(a5)
    14a4:	4fb8                	lw	a4,88(a5)
    14a6:	fe042783          	lw	a5,-32(s0)
    14aa:	2781                	sext.w	a5,a5
    14ac:	00f75763          	bge	a4,a5,14ba <find_earliest_impactful_release_time+0xd6>
                earliest_impactful_time = entry->release_time;
    14b0:	fe843783          	ld	a5,-24(s0)
    14b4:	4f9c                	lw	a5,24(a5)
    14b6:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    14ba:	fe843783          	ld	a5,-24(s0)
    14be:	679c                	ld	a5,8(a5)
    14c0:	fcf43023          	sd	a5,-64(s0)
    14c4:	fc043783          	ld	a5,-64(s0)
    14c8:	17e1                	addi	a5,a5,-8
    14ca:	fef43423          	sd	a5,-24(s0)
    14ce:	fe843783          	ld	a5,-24(s0)
    14d2:	07a1                	addi	a5,a5,8
    14d4:	fa843703          	ld	a4,-88(s0)
    14d8:	faf713e3          	bne	a4,a5,147e <find_earliest_impactful_release_time+0x9a>
            }
        }
    }
    ...
    14e0:	0007871b          	sext.w	a4,a5
    14e4:	800007b7          	lui	a5,0x80000
    14e8:	fff7c793          	not	a5,a5
    14ec:	00f70a63          	beq	a4,a5,1500 <find_earliest_impactful_release_time+0x11c>
    14f0:	fe442703          	lw	a4,-28(s0)
    14f4:	f9c42783          	lw	a5,-100(s0)
    14f8:	40f707bb          	subw	a5,a4,a5
    14fc:	2781                	sext.w	a5,a5
    14fe:	a011                	j	1502 <find_earliest_impactful_release_time+0x11e>
    1500:	57fd                	li	a5,-1
}
    1502:	853e                	mv	a0,a5
    1504:	7426                	ld	s0,104(sp)
    1506:	6165                	addi	sp,sp,112
    1508:	8082                	ret

000000000000150a <schedule_sjf>:


struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    150a:	7119                	addi	sp,sp,-128
    150c:	fc86                	sd	ra,120(sp)
    150e:	f8a2                	sd	s0,112(sp)
    1510:	f4a6                	sd	s1,104(sp)
    1512:	f0ca                	sd	s2,96(sp)
    1514:	ecce                	sd	s3,88(sp)
    1516:	0100                	addi	s0,sp,128
    1518:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *shortest_job = NULL;
    151a:	fc043423          	sd	zero,-56(s0)
    struct thread *current;
    int shortest_time = INT_MAX;
    151e:	800007b7          	lui	a5,0x80000
    1522:	fff7c793          	not	a5,a5
    1526:	faf42e23          	sw	a5,-68(s0)
    ...
    152c:	6498                	ld	a4,8(s1)
    152e:	4094                	lw	a3,0(s1)
    1530:	8636                	mv	a2,a3
    1532:	85ba                	mv	a1,a4
    1534:	853e                	mv	a0,a5
    1536:	00000097          	auipc	ra,0x0
    153a:	eae080e7          	jalr	-338(ra) # 13e4 <find_earliest_impactful_release_time>
    153e:	87aa                	mv	a5,a0
    1540:	faf42a23          	sw	a5,-76(s0)

    // Determine the shortest job from the run queue
    list_for_each_entry(current, args.run_queue, thread_list) {
    1544:	649c                	ld	a5,8(s1)
    1546:	639c                	ld	a5,0(a5)
    1548:	faf43423          	sd	a5,-88(s0)
    154c:	fa843783          	ld	a5,-88(s0)
    1550:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdbb8>
    1554:	fcf43023          	sd	a5,-64(s0)
    1558:	a82d                	j	1592 <schedule_sjf+0x88>
        if (current->remaining_time < shortest_time) {
    155a:	fc043783          	ld	a5,-64(s0)
    155e:	4fb8                	lw	a4,88(a5)
    1560:	fbc42783          	lw	a5,-68(s0)
    1564:	2781                	sext.w	a5,a5
    1566:	00f75b63          	bge	a4,a5,157c <schedule_sjf+0x72>
            shortest_time = current->remaining_time;
    156a:	fc043783          	ld	a5,-64(s0)
    156e:	4fbc                	lw	a5,88(a5)
    1570:	faf42e23          	sw	a5,-68(s0)
            shortest_job = current;
    1574:	fc043783          	ld	a5,-64(s0)
    1578:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(current, args.run_queue, thread_list) {
    157c:	fc043783          	ld	a5,-64(s0)
    1580:	779c                	ld	a5,40(a5)
    1582:	faf43023          	sd	a5,-96(s0)
    1586:	fa043783          	ld	a5,-96(s0)
    158a:	fd878793          	addi	a5,a5,-40
    158e:	fcf43023          	sd	a5,-64(s0)
    1592:	fc043783          	ld	a5,-64(s0)
    1596:	02878713          	addi	a4,a5,40
    159a:	649c                	ld	a5,8(s1)
    159c:	faf71fe3          	bne	a4,a5,155a <schedule_sjf+0x50>
        }
    }

    if (shortest_job) {
    15a0:	fc843783          	ld	a5,-56(s0)
    15a4:	c7a1                	beqz	a5,15ec <schedule_sjf+0xe2>
        int time_to_allocate = shortest_job->remaining_time;
    15a6:	fc843783          	ld	a5,-56(s0)
    15aa:	4fbc                	lw	a5,88(a5)
    15ac:	faf42c23          	sw	a5,-72(s0)
    ...
    15b0:	fb442783          	lw	a5,-76(s0)
    15b4:	0007871b          	sext.w	a4,a5
    15b8:	57fd                	li	a5,-1
    15ba:	00f70e63          	beq	a4,a5,15d6 <schedule_sjf+0xcc>
    15be:	fb442703          	lw	a4,-76(s0)
    15c2:	fb842783          	lw	a5,-72(s0)
    15c6:	2701                	sext.w	a4,a4
    15c8:	2781                	sext.w	a5,a5
    15ca:	00f75663          	bge	a4,a5,15d6 <schedule_sjf+0xcc>
            time_to_allocate = earliest_impactful_time;
    15ce:	fb442783          	lw	a5,-76(s0)
    15d2:	faf42c23          	sw	a5,-72(s0)
        }

        r.scheduled_thread_list_member = &shortest_job->thread_list;
    15d6:	fc843783          	ld	a5,-56(s0)
    15da:	02878793          	addi	a5,a5,40
    15de:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = time_to_allocate;
    15e2:	fb842783          	lw	a5,-72(s0)
    15e6:	f8f42423          	sw	a5,-120(s0)
    15ea:	a80d                	j	161c <schedule_sjf+0x112>
    } else {
        // If no current tasks are ready, wait for the next impactful task
        r.scheduled_thread_list_member = args.run_queue;
    15ec:	649c                	ld	a5,8(s1)
    15ee:	f8f43023          	sd	a5,-128(s0)
    ...
    15fa:	57fd                	li	a5,-1
    15fc:	00f71c63          	bne	a4,a5,1614 <schedule_sjf+0x10a>
    1600:	689c                	ld	a5,16(s1)
    1602:	4098                	lw	a4,0(s1)
    1604:	85ba                	mv	a1,a4
    1606:	853e                	mv	a0,a5
    1608:	00000097          	auipc	ra,0x0
    160c:	d2c080e7          	jalr	-724(ra) # 1334 <find_next_release_time>
    1610:	87aa                	mv	a5,a0
    1612:	a019                	j	1618 <schedule_sjf+0x10e>
    1614:	fb442783          	lw	a5,-76(s0)
    1618:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    161c:	f8043783          	ld	a5,-128(s0)
    1620:	f8f43823          	sd	a5,-112(s0)
    1624:	f8843783          	ld	a5,-120(s0)
    1628:	f8f43c23          	sd	a5,-104(s0)
    162c:	4701                	li	a4,0
    162e:	f9043703          	ld	a4,-112(s0)
    1632:	4781                	li	a5,0
    1634:	f9843783          	ld	a5,-104(s0)
    1638:	893a                	mv	s2,a4
    163a:	89be                	mv	s3,a5
    163c:	874a                	mv	a4,s2
    163e:	87ce                	mv	a5,s3
...
0000000000001652 <min>:

int min(int a, int b) {
    1652:	1101                	addi	sp,sp,-32
    1654:	ec22                	sd	s0,24(sp)
    1656:	1000                	addi	s0,sp,32
    1658:	87aa                	mv	a5,a0
    165a:	872e                	mv	a4,a1
    165c:	fef42623          	sw	a5,-20(s0)
    1660:	87ba                	mv	a5,a4
    1662:	fef42423          	sw	a5,-24(s0)
    return (a < b) ? a : b;
    1666:	fec42603          	lw	a2,-20(s0)
    166a:	fe842783          	lw	a5,-24(s0)
    166e:	0007869b          	sext.w	a3,a5
    1672:	0006071b          	sext.w	a4,a2
    1676:	00d75363          	bge	a4,a3,167c <min+0x2a>
    167a:	87b2                	mv	a5,a2
    167c:	2781                	sext.w	a5,a5
}
    167e:	853e                	mv	a0,a5
    1680:	6462                	ld	s0,24(sp)
    1682:	6105                	addi	sp,sp,32
    1684:	8082                	ret

0000000000001686 <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    1686:	7131                	addi	sp,sp,-192
    1688:	fd06                	sd	ra,184(sp)
    168a:	f922                	sd	s0,176(sp)
    168c:	f526                	sd	s1,168(sp)
    168e:	f14a                	sd	s2,160(sp)
    1690:	ed4e                	sd	s3,152(sp)
    1692:	0180                	addi	s0,sp,192
    1694:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *min_slack_thread = NULL;
    1696:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    169a:	800007b7          	lui	a5,0x80000
    169e:	fff7c793          	not	a5,a5
    16a2:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    // int ddl;
    // Determine the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    16a6:	649c                	ld	a5,8(s1)
    16a8:	639c                	ld	a5,0(a5)
    16aa:	faf43023          	sd	a5,-96(s0)
    16ae:	fa043783          	ld	a5,-96(s0)
    16b2:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdbb8>
    16b6:	faf43c23          	sd	a5,-72(s0)
    16ba:	a069                	j	1744 <schedule_lst+0xbe>
        int slack_time = t->current_deadline - args.current_time - t->remaining_time;
    16bc:	fb843783          	ld	a5,-72(s0)
    16c0:	4ff8                	lw	a4,92(a5)
    16c2:	409c                	lw	a5,0(s1)
    16c4:	40f707bb          	subw	a5,a4,a5
    16c8:	0007871b          	sext.w	a4,a5
    16cc:	fb843783          	ld	a5,-72(s0)
    16d0:	4fbc                	lw	a5,88(a5)
    16d2:	40f707bb          	subw	a5,a4,a5
    16d6:	f6f42a23          	sw	a5,-140(s0)
        if (slack_time < min_slack_time || (slack_time == min_slack_time && t->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))) {
    16da:	f7442703          	lw	a4,-140(s0)
    16de:	fc442783          	lw	a5,-60(s0)
    16e2:	2701                	sext.w	a4,a4
    16e4:	2781                	sext.w	a5,a5
    16e6:	02f74c63          	blt	a4,a5,171e <schedule_lst+0x98>
    16ea:	f7442703          	lw	a4,-140(s0)
    16ee:	fc442783          	lw	a5,-60(s0)
    16f2:	2701                	sext.w	a4,a4
    16f4:	2781                	sext.w	a5,a5
    16f6:	02f71c63          	bne	a4,a5,172e <schedule_lst+0xa8>
    16fa:	fb843783          	ld	a5,-72(s0)
    16fe:	5fd4                	lw	a3,60(a5)
    1700:	fc843783          	ld	a5,-56(s0)
    1704:	c789                	beqz	a5,170e <schedule_lst+0x88>
    1706:	fc843783          	ld	a5,-56(s0)
    170a:	5fdc                	lw	a5,60(a5)
    170c:	a029                	j	1716 <schedule_lst+0x90>
    170e:	800007b7          	lui	a5,0x80000
    1712:	fff7c793          	not	a5,a5
    1716:	873e                	mv	a4,a5
    1718:	87b6                	mv	a5,a3
    171a:	00e7da63          	bge	a5,a4,172e <schedule_lst+0xa8>
            min_slack_thread = t;
    171e:	fb843783          	ld	a5,-72(s0)
    1722:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    1726:	f7442783          	lw	a5,-140(s0)
    172a:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    172e:	fb843783          	ld	a5,-72(s0)
    1732:	779c                	ld	a5,40(a5)
    1734:	f6f43423          	sd	a5,-152(s0)
    1738:	f6843783          	ld	a5,-152(s0)
    173c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdbb8>
    1740:	faf43c23          	sd	a5,-72(s0)
    1744:	fb843783          	ld	a5,-72(s0)
    1748:	02878713          	addi	a4,a5,40
    174c:	649c                	ld	a5,8(s1)
    174e:	f6f717e3          	bne	a4,a5,16bc <schedule_lst+0x36>
    ...
    1752:	800007b7          	lui	a5,0x80000
    1756:	fff7c793          	not	a5,a5
    175a:	faf42a23          	sw	a5,-76(s0)
    ...
    175e:	689c                	ld	a5,16(s1)
    1760:	639c                	ld	a5,0(a5)
    1762:	f8f43c23          	sd	a5,-104(s0)
    1766:	f9843783          	ld	a5,-104(s0)
    176a:	17e1                	addi	a5,a5,-8
    176c:	faf43423          	sd	a5,-88(s0)
    1770:	a0f1                	j	183c <schedule_lst+0x1b6>
        if (entry->release_time > args.current_time) {
    1772:	fa843783          	ld	a5,-88(s0)
    1776:	4f98                	lw	a4,24(a5)
    1778:	409c                	lw	a5,0(s1)
    177a:	0ae7d763          	bge	a5,a4,1828 <schedule_lst+0x1a2>
            struct thread *upcoming_thread = entry->thrd;
    177e:	fa843783          	ld	a5,-88(s0)
    1782:	639c                	ld	a5,0(a5)
    1784:	f8f43423          	sd	a5,-120(s0)
            int upcoming_slack_time = upcoming_thread->current_deadline - entry->release_time - upcoming_thread->remaining_time;
    1788:	f8843783          	ld	a5,-120(s0)
    178c:	4ff8                	lw	a4,92(a5)
    178e:	fa843783          	ld	a5,-88(s0)
    1792:	4f9c                	lw	a5,24(a5)
    1794:	40f707bb          	subw	a5,a4,a5
    1798:	0007871b          	sext.w	a4,a5
    179c:	f8843783          	ld	a5,-120(s0)
    17a0:	4fbc                	lw	a5,88(a5)
    17a2:	40f707bb          	subw	a5,a4,a5
    17a6:	f8f42223          	sw	a5,-124(s0)
    ...
    17aa:	f8442703          	lw	a4,-124(s0)
    17ae:	fc442783          	lw	a5,-60(s0)
    17b2:	2701                	sext.w	a4,a4
    17b4:	2781                	sext.w	a5,a5
    17b6:	02f75163          	bge	a4,a5,17d8 <schedule_lst+0x152>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    17ba:	fa843783          	ld	a5,-88(s0)
    17be:	4f98                	lw	a4,24(a5)
    17c0:	fb442783          	lw	a5,-76(s0)
    17c4:	85ba                	mv	a1,a4
    17c6:	853e                	mv	a0,a5
    17c8:	00000097          	auipc	ra,0x0
    17cc:	e8a080e7          	jalr	-374(ra) # 1652 <min>
    17d0:	87aa                	mv	a5,a0
    17d2:	faf42a23          	sw	a5,-76(s0)
    17d6:	a889                	j	1828 <schedule_lst+0x1a2>
            } else if (upcoming_slack_time == min_slack_time && upcoming_thread->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))
    17d8:	f8442703          	lw	a4,-124(s0)
    17dc:	fc442783          	lw	a5,-60(s0)
    17e0:	2701                	sext.w	a4,a4
    17e2:	2781                	sext.w	a5,a5
    17e4:	04f71263          	bne	a4,a5,1828 <schedule_lst+0x1a2>
    17e8:	f8843783          	ld	a5,-120(s0)
    17ec:	5fd4                	lw	a3,60(a5)
    17ee:	fc843783          	ld	a5,-56(s0)
    17f2:	c789                	beqz	a5,17fc <schedule_lst+0x176>
    17f4:	fc843783          	ld	a5,-56(s0)
    17f8:	5fdc                	lw	a5,60(a5)
    17fa:	a029                	j	1804 <schedule_lst+0x17e>
    17fc:	800007b7          	lui	a5,0x80000
    1800:	fff7c793          	not	a5,a5
    1804:	873e                	mv	a4,a5
    1806:	87b6                	mv	a5,a3
    1808:	02e7d063          	bge	a5,a4,1828 <schedule_lst+0x1a2>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    180c:	fa843783          	ld	a5,-88(s0)
    1810:	4f98                	lw	a4,24(a5)
    1812:	fb442783          	lw	a5,-76(s0)
    1816:	85ba                	mv	a1,a4
    1818:	853e                	mv	a0,a5
    181a:	00000097          	auipc	ra,0x0
    181e:	e38080e7          	jalr	-456(ra) # 1652 <min>
    1822:	87aa                	mv	a5,a0
    1824:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(entry, args.release_queue, thread_list) {
    1828:	fa843783          	ld	a5,-88(s0)
    182c:	679c                	ld	a5,8(a5)
    182e:	f6f43c23          	sd	a5,-136(s0)
    1832:	f7843783          	ld	a5,-136(s0)
    1836:	17e1                	addi	a5,a5,-8
    1838:	faf43423          	sd	a5,-88(s0)
    183c:	fa843783          	ld	a5,-88(s0)
    1840:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffdbe8>
    1844:	689c                	ld	a5,16(s1)
    1846:	f2f716e3          	bne	a4,a5,1772 <schedule_lst+0xec>
        }
    }
    ...
    184e:	c3b1                	beqz	a5,1892 <schedule_lst+0x20c>
    ...
    1854:	0007871b          	sext.w	a4,a5
    1858:	800007b7          	lui	a5,0x80000
    185c:	fff7c793          	not	a5,a5
    1860:	00f71663          	bne	a4,a5,186c <schedule_lst+0x1e6>
    1864:	fc843783          	ld	a5,-56(s0)
    1868:	4fbc                	lw	a5,88(a5)
    186a:	a039                	j	1878 <schedule_lst+0x1f2>
    186c:	409c                	lw	a5,0(s1)
    186e:	fb442703          	lw	a4,-76(s0)
    1872:	40f707bb          	subw	a5,a4,a5
    1876:	2781                	sext.w	a5,a5
    1878:	f8f42a23          	sw	a5,-108(s0)
        r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    187c:	fc843783          	ld	a5,-56(s0)
    1880:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffdc08>
    1884:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = allocated_time;
    1888:	f9442783          	lw	a5,-108(s0)
    188c:	f4f42823          	sw	a5,-176(s0)
    1890:	a081                	j	18d0 <schedule_lst+0x24a>
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    1892:	649c                	ld	a5,8(s1)
    1894:	f4f43423          	sd	a5,-184(s0)
    ...
    1898:	fb442783          	lw	a5,-76(s0)
    189c:	0007871b          	sext.w	a4,a5
    18a0:	800007b7          	lui	a5,0x80000
    18a4:	fff7c793          	not	a5,a5
    18a8:	00f70963          	beq	a4,a5,18ba <schedule_lst+0x234>
    18ac:	409c                	lw	a5,0(s1)
    18ae:	fb442703          	lw	a4,-76(s0)
    18b2:	40f707bb          	subw	a5,a4,a5
    18b6:	2781                	sext.w	a5,a5
    18b8:	a811                	j	18cc <schedule_lst+0x246>
    18ba:	689c                	ld	a5,16(s1)
    18bc:	4098                	lw	a4,0(s1)
    18be:	85ba                	mv	a1,a4
    18c0:	853e                	mv	a0,a5
    18c2:	00000097          	auipc	ra,0x0
    18c6:	a72080e7          	jalr	-1422(ra) # 1334 <find_next_release_time>
    18ca:	87aa                	mv	a5,a0
    18cc:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    18d0:	f4843783          	ld	a5,-184(s0)
    18d4:	f4f43c23          	sd	a5,-168(s0)
    18d8:	f5043783          	ld	a5,-176(s0)
    18dc:	f6f43023          	sd	a5,-160(s0)
    18e0:	4701                	li	a4,0
    18e2:	f5843703          	ld	a4,-168(s0)
    18e6:	4781                	li	a5,0
    18e8:	f6043783          	ld	a5,-160(s0)
    18ec:	893a                	mv	s2,a4
    18ee:	89be                	mv	s3,a5
    18f0:	874a                	mv	a4,s2
    18f2:	87ce                	mv	a5,s3
    ...
    18f4:	853a                	mv	a0,a4
    18f6:	85be                	mv	a1,a5
    18f8:	70ea                	ld	ra,184(sp)
    18fa:	744a                	ld	s0,176(sp)
    18fc:	74aa                	ld	s1,168(sp)
    18fe:	790a                	ld	s2,160(sp)
    1900:	69ea                	ld	s3,152(sp)
    1902:	6129                	addi	sp,sp,192
    1904:	8082                	ret

0000000000001906 <find_earliest_impactful_release_time_dm>:
...
int find_earliest_impactful_release_time_dm(struct list_head *release_queue, int current_time, int current_deadline) {
    ...
    1908:	e4a2                	sd	s0,72(sp)
    190a:	0880                	addi	s0,sp,80
    190c:	faa43c23          	sd	a0,-72(s0)
    1910:	87ae                	mv	a5,a1
    1912:	8732                	mv	a4,a2
    1914:	faf42a23          	sw	a5,-76(s0)
    1918:	87ba                	mv	a5,a4
    191a:	faf42823          	sw	a5,-80(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_event = INT_MAX;
    191e:	800007b7          	lui	a5,0x80000
    1922:	fff7c793          	not	a5,a5
    1926:	fef42223          	sw	a5,-28(s0)
    struct thread *earliest_deadline_thread = NULL;
    192a:	fc043c23          	sd	zero,-40(s0)
    earliest_deadline_thread->ID = INT_MAX;
    192e:	fd843783          	ld	a5,-40(s0)
    1932:	80000737          	lui	a4,0x80000
    1936:	fff74713          	not	a4,a4
    193a:	dfd8                	sw	a4,60(a5)
    ...
    1942:	fcf43823          	sd	a5,-48(s0)
    1946:	fd043783          	ld	a5,-48(s0)
    194a:	17e1                	addi	a5,a5,-8
    194c:	fef43423          	sd	a5,-24(s0)
    1950:	a075                	j	19fc <find_earliest_impactful_release_time_dm+0xf6>
        if (entry->release_time > current_time && entry->thrd->period < current_deadline) {
    1952:	fe843783          	ld	a5,-24(s0)
    1956:	4f98                	lw	a4,24(a5)
    1958:	fb442783          	lw	a5,-76(s0)
    195c:	2781                	sext.w	a5,a5
    195e:	02e7d963          	bge	a5,a4,1990 <find_earliest_impactful_release_time_dm+0x8a>
    1962:	fe843783          	ld	a5,-24(s0)
    1966:	639c                	ld	a5,0(a5)
    1968:	4bb8                	lw	a4,80(a5)
    196a:	fb042783          	lw	a5,-80(s0)
    196e:	2781                	sext.w	a5,a5
    1970:	02f75063          	bge	a4,a5,1990 <find_earliest_impactful_release_time_dm+0x8a>
            if (entry->release_time < earliest_impactful_event) {
    1974:	fe843783          	ld	a5,-24(s0)
    1978:	4f98                	lw	a4,24(a5)
    197a:	fe442783          	lw	a5,-28(s0)
    197e:	2781                	sext.w	a5,a5
    1980:	06f75463          	bge	a4,a5,19e8 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    1984:	fe843783          	ld	a5,-24(s0)
    1988:	4f9c                	lw	a5,24(a5)
    198a:	fef42223          	sw	a5,-28(s0)
            if (entry->release_time < earliest_impactful_event) {
    198e:	a8a9                	j	19e8 <find_earliest_impactful_release_time_dm+0xe2>
            }
        } 
    ...
    1994:	4f98                	lw	a4,24(a5)
    1996:	fb442783          	lw	a5,-76(s0)
    199a:	2781                	sext.w	a5,a5
    199c:	04e7d663          	bge	a5,a4,19e8 <find_earliest_impactful_release_time_dm+0xe2>
    19a0:	fe843783          	ld	a5,-24(s0)
    19a4:	639c                	ld	a5,0(a5)
    19a6:	4bb8                	lw	a4,80(a5)
    19a8:	fb042783          	lw	a5,-80(s0)
    19ac:	2781                	sext.w	a5,a5
    19ae:	02e79d63          	bne	a5,a4,19e8 <find_earliest_impactful_release_time_dm+0xe2>
            if (entry->release_time < earliest_impactful_event && entry->thrd->ID < earliest_deadline_thread->ID) {
    19b2:	fe843783          	ld	a5,-24(s0)
    19b6:	4f98                	lw	a4,24(a5)
    19b8:	fe442783          	lw	a5,-28(s0)
    19bc:	2781                	sext.w	a5,a5
    19be:	02f75563          	bge	a4,a5,19e8 <find_earliest_impactful_release_time_dm+0xe2>
    19c2:	fe843783          	ld	a5,-24(s0)
    19c6:	639c                	ld	a5,0(a5)
    19c8:	5fd8                	lw	a4,60(a5)
    19ca:	fd843783          	ld	a5,-40(s0)
    19ce:	5fdc                	lw	a5,60(a5)
    19d0:	00f75c63          	bge	a4,a5,19e8 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    19d4:	fe843783          	ld	a5,-24(s0)
    19d8:	4f9c                	lw	a5,24(a5)
    19da:	fef42223          	sw	a5,-28(s0)
    ...
    19ec:	679c                	ld	a5,8(a5)
    19ee:	fcf43423          	sd	a5,-56(s0)
    19f2:	fc843783          	ld	a5,-56(s0)
    19f6:	17e1                	addi	a5,a5,-8
    19f8:	fef43423          	sd	a5,-24(s0)
    19fc:	fe843783          	ld	a5,-24(s0)
    1a00:	07a1                	addi	a5,a5,8
    1a02:	fb843703          	ld	a4,-72(s0)
    1a06:	f4f716e3          	bne	a4,a5,1952 <find_earliest_impactful_release_time_dm+0x4c>
            }
        }
    }
    ...
    1a0a:	fe442783          	lw	a5,-28(s0)
    1a0e:	0007871b          	sext.w	a4,a5
    1a12:	800007b7          	lui	a5,0x80000
    1a16:	fff7c793          	not	a5,a5
    1a1a:	00f70563          	beq	a4,a5,1a24 <find_earliest_impactful_release_time_dm+0x11e>
    1a1e:	fe442783          	lw	a5,-28(s0)
    1a22:	a011                	j	1a26 <find_earliest_impactful_release_time_dm+0x120>
    1a24:	57fd                	li	a5,-1
}
    1a26:	853e                	mv	a0,a5
    1a28:	6426                	ld	s0,72(sp)
    1a2a:	6161                	addi	sp,sp,80
    1a2c:	8082                	ret

0000000000001a2e <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    1a2e:	7175                	addi	sp,sp,-144
    1a30:	e506                	sd	ra,136(sp)
    1a32:	e122                	sd	s0,128(sp)
    1a34:	fca6                	sd	s1,120(sp)
    1a36:	f8ca                	sd	s2,112(sp)
    1a38:	f4ce                	sd	s3,104(sp)
    1a3a:	0900                	addi	s0,sp,144
    1a3c:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    1a3e:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    1a42:	800007b7          	lui	a5,0x80000
    1a46:	fff7c793          	not	a5,a5
    1a4a:	faf42e23          	sw	a5,-68(s0)

    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    1a4e:	649c                	ld	a5,8(s1)
    1a50:	639c                	ld	a5,0(a5)
    1a52:	faf43823          	sd	a5,-80(s0)
    1a56:	fb043783          	ld	a5,-80(s0)
    1a5a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdbb8>
    1a5e:	fcf43023          	sd	a5,-64(s0)
    1a62:	a089                	j	1aa4 <schedule_dm+0x76>
        if (t->is_real_time && t->period < earliest_deadline) {
    1a64:	fc043783          	ld	a5,-64(s0)
    1a68:	43bc                	lw	a5,64(a5)
    1a6a:	c395                	beqz	a5,1a8e <schedule_dm+0x60>
    1a6c:	fc043783          	ld	a5,-64(s0)
    1a70:	4bb8                	lw	a4,80(a5)
    1a72:	fbc42783          	lw	a5,-68(s0)
    1a76:	2781                	sext.w	a5,a5
    1a78:	00f75b63          	bge	a4,a5,1a8e <schedule_dm+0x60>
            earliest_deadline_thread = t;
    1a7c:	fc043783          	ld	a5,-64(s0)
    1a80:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    1a84:	fc043783          	ld	a5,-64(s0)
    1a88:	4bbc                	lw	a5,80(a5)
    1a8a:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1a8e:	fc043783          	ld	a5,-64(s0)
    1a92:	779c                	ld	a5,40(a5)
    1a94:	f8f43c23          	sd	a5,-104(s0)
    1a98:	f9843783          	ld	a5,-104(s0)
    1a9c:	fd878793          	addi	a5,a5,-40
    1aa0:	fcf43023          	sd	a5,-64(s0)
    1aa4:	fc043783          	ld	a5,-64(s0)
    1aa8:	02878713          	addi	a4,a5,40
    1aac:	649c                	ld	a5,8(s1)
    1aae:	faf71be3          	bne	a4,a5,1a64 <schedule_dm+0x36>
        }
    }
    ...
    1ab2:	689c                	ld	a5,16(s1)
    1ab4:	4098                	lw	a4,0(s1)
    1ab6:	fbc42683          	lw	a3,-68(s0)
    1aba:	8636                	mv	a2,a3
    1abc:	85ba                	mv	a1,a4
    1abe:	853e                	mv	a0,a5
    1ac0:	00000097          	auipc	ra,0x0
    1ac4:	e46080e7          	jalr	-442(ra) # 1906 <find_earliest_impactful_release_time_dm>
    1ac8:	87aa                	mv	a5,a0
    1aca:	faf42623          	sw	a5,-84(s0)

    if (earliest_deadline_thread) {
    1ace:	fc843783          	ld	a5,-56(s0)
    1ad2:	c3c9                	beqz	a5,1b54 <schedule_dm+0x126>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    1ad4:	fc843783          	ld	a5,-56(s0)
    1ad8:	4ff8                	lw	a4,92(a5)
    1ada:	409c                	lw	a5,0(s1)
    1adc:	40f707bb          	subw	a5,a4,a5
    1ae0:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline < 0) {
    1ae4:	fa842783          	lw	a5,-88(s0)
    1ae8:	2781                	sext.w	a5,a5
    1aea:	0007db63          	bgez	a5,1b00 <schedule_dm+0xd2>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1aee:	fc843783          	ld	a5,-56(s0)
    1af2:	02878793          	addi	a5,a5,40
    1af6:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    1afa:	f8042023          	sw	zero,-128(s0)
    1afe:	a88d                	j	1b70 <schedule_dm+0x142>
        } else {
    ...
    1b00:	fac42783          	lw	a5,-84(s0)
    1b04:	0007871b          	sext.w	a4,a5
    1b08:	57fd                	li	a5,-1
    1b0a:	02f70563          	beq	a4,a5,1b34 <schedule_dm+0x106>
    1b0e:	409c                	lw	a5,0(s1)
    1b10:	fac42703          	lw	a4,-84(s0)
    1b14:	40f707bb          	subw	a5,a4,a5
    1b18:	0007871b          	sext.w	a4,a5
    1b1c:	fc843783          	ld	a5,-56(s0)
    1b20:	4fbc                	lw	a5,88(a5)
    1b22:	00f75963          	bge	a4,a5,1b34 <schedule_dm+0x106>
    1b26:	409c                	lw	a5,0(s1)
    1b28:	fac42703          	lw	a4,-84(s0)
    1b2c:	40f707bb          	subw	a5,a4,a5
    1b30:	2781                	sext.w	a5,a5
    1b32:	a021                	j	1b3a <schedule_dm+0x10c>
    1b34:	fc843783          	ld	a5,-56(s0)
    1b38:	4fbc                	lw	a5,88(a5)
    1b3a:	faf42223          	sw	a5,-92(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1b3e:	fc843783          	ld	a5,-56(s0)
    1b42:	02878793          	addi	a5,a5,40
    1b46:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    1b4a:	fa442783          	lw	a5,-92(s0)
    1b4e:	f8f42023          	sw	a5,-128(s0)
    1b52:	a839                	j	1b70 <schedule_dm+0x142>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    1b54:	649c                	ld	a5,8(s1)
    1b56:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1b5a:	689c                	ld	a5,16(s1)
    1b5c:	4098                	lw	a4,0(s1)
    1b5e:	85ba                	mv	a1,a4
    1b60:	853e                	mv	a0,a5
    1b62:	fffff097          	auipc	ra,0xfffff
    1b66:	7d2080e7          	jalr	2002(ra) # 1334 <find_next_release_time>
    1b6a:	87aa                	mv	a5,a0
    1b6c:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    1b70:	f7843783          	ld	a5,-136(s0)
    1b74:	f8f43423          	sd	a5,-120(s0)
    1b78:	f8043783          	ld	a5,-128(s0)
    1b7c:	f8f43823          	sd	a5,-112(s0)
    1b80:	4701                	li	a4,0
    1b82:	f8843703          	ld	a4,-120(s0)
    1b86:	4781                	li	a5,0
    1b88:	f9043783          	ld	a5,-112(s0)
    1b8c:	893a                	mv	s2,a4
    1b8e:	89be                	mv	s3,a5
    1b90:	874a                	mv	a4,s2
    1b92:	87ce                	mv	a5,s3
    ...
    1b94:	853a                	mv	a0,a4
    1b96:	85be                	mv	a1,a5
    1b98:	60aa                	ld	ra,136(sp)
    1b9a:	640a                	ld	s0,128(sp)
    1b9c:	74e6                	ld	s1,120(sp)
    1b9e:	7946                	ld	s2,112(sp)
    1ba0:	79a6                	ld	s3,104(sp)
    1ba2:	6149                	addi	sp,sp,144
    1ba4:	8082                	ret

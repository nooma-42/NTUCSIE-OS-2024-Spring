...
main(void)
{
  ...
  if(open("console", O_RDWR) < 0){
       ...
       e:	5a650513          	addi	a0,a0,1446 # 15b0 <schedule_dm+0x214>
    ...
    mknod("console", CONSOLE, 0);
      ...
      28:	58c50513          	addi	a0,a0,1420 # 15b0 <schedule_dm+0x214>
      2c:	00000097          	auipc	ra,0x0
      30:	5ca080e7          	jalr	1482(ra) # 5f6 <mknod>
    open("console", O_RDWR);
      34:	4589                	li	a1,2
      36:	00001517          	auipc	a0,0x1
      3a:	57a50513          	addi	a0,a0,1402 # 15b0 <schedule_dm+0x214>
  ...
  for(;;){
    printf("init: starting sh\n");
      ...
      5e:	55e50513          	addi	a0,a0,1374 # 15b8 <schedule_dm+0x21c>
    ...
    if(pid < 0){
      ...
      86:	54e50513          	addi	a0,a0,1358 # 15d0 <schedule_dm+0x234>
    ...
    if(pid == 0){
      ...
      a8:	5ac58593          	addi	a1,a1,1452 # 1650 <argv>
      ac:	00001517          	auipc	a0,0x1
      b0:	4fc50513          	addi	a0,a0,1276 # 15a8 <schedule_dm+0x20c>
      b4:	00000097          	auipc	ra,0x0
      b8:	532080e7          	jalr	1330(ra) # 5e6 <exec>
      printf("init: exec sh failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	52c50513          	addi	a0,a0,1324 # 15e8 <schedule_dm+0x24c>
    ...
    for(;;){
     ...
     104:	50050513          	addi	a0,a0,1280 # 1600 <schedule_dm+0x264>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     716:	f4e68693          	addi	a3,a3,-178 # 1660 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     7f0:	e7470713          	addi	a4,a4,-396 # 1660 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     9b0:	c7478793          	addi	a5,a5,-908 # 1620 <schedule_dm+0x284>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     b5c:	b3078793          	addi	a5,a5,-1232 # 1688 <freep>
     b60:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     c54:	a3878793          	addi	a5,a5,-1480 # 1688 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     cd6:	9b678793          	addi	a5,a5,-1610 # 1688 <freep>
     cda:	639c                	ld	a5,0(a5)
}
     cdc:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d08:	98478793          	addi	a5,a5,-1660 # 1688 <freep>
     d0c:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d1c:	96078793          	addi	a5,a5,-1696 # 1678 <base>
     d20:	fef43023          	sd	a5,-32(s0)
     d24:	00001797          	auipc	a5,0x1
     d28:	96478793          	addi	a5,a5,-1692 # 1688 <freep>
     d2c:	fe043703          	ld	a4,-32(s0)
     d30:	e398                	sd	a4,0(a5)
     d32:	00001797          	auipc	a5,0x1
     d36:	95678793          	addi	a5,a5,-1706 # 1688 <freep>
     d3a:	6398                	ld	a4,0(a5)
     d3c:	00001797          	auipc	a5,0x1
     d40:	93c78793          	addi	a5,a5,-1732 # 1678 <base>
     d44:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     d46:	00001797          	auipc	a5,0x1
     d4a:	93278793          	addi	a5,a5,-1742 # 1678 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     dc6:	8c678793          	addi	a5,a5,-1850 # 1688 <freep>
    ...
    if(p == freep)
     ...
     ddc:	8b078793          	addi	a5,a5,-1872 # 1688 <freep>
     de0:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     f74:	72078793          	addi	a5,a5,1824 # 1690 <last_thread.1226>
     f78:	639c                	ld	a5,0(a5)
     f7a:	cb89                	beqz	a5,f8c <schedule_wrr+0x2e>
     f7c:	00000797          	auipc	a5,0x0
     f80:	71478793          	addi	a5,a5,1812 # 1690 <last_thread.1226>
     f84:	639c                	ld	a5,0(a5)
     f86:	4fbc                	lw	a5,88(a5)
     f88:	00f04863          	bgtz	a5,f98 <schedule_wrr+0x3a>
        last_thread = NULL;
     f8c:	00000797          	auipc	a5,0x0
     f90:	70478793          	addi	a5,a5,1796 # 1690 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     fb2:	6e278793          	addi	a5,a5,1762 # 1690 <last_thread.1226>
     fb6:	639c                	ld	a5,0(a5)
    ...
    100e:	68678793          	addi	a5,a5,1670 # 1690 <last_thread.1226>
    1012:	639c                	ld	a5,0(a5)
    1014:	c385                	beqz	a5,1034 <schedule_wrr+0xd6>
    1016:	00000797          	auipc	a5,0x0
    101a:	67a78793          	addi	a5,a5,1658 # 1690 <last_thread.1226>
    ...
    102a:	66a78793          	addi	a5,a5,1642 # 1690 <last_thread.1226>
    ...
    107a:	61a78793          	addi	a5,a5,1562 # 1690 <last_thread.1226>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args)
{
    ...
    10d2:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int shortest_time = INT_MAX;
    10d6:	800007b7          	lui	a5,0x80000
    10da:	fff7c793          	not	a5,a5
    10de:	faf42e23          	sw	a5,-68(s0)

    // Find the thread with the shortest remaining time that is ready to run
    list_for_each_entry(t, args.run_queue, thread_list) {
    10e2:	649c                	ld	a5,8(s1)
    10e4:	639c                	ld	a5,0(a5)
    10e6:	faf43823          	sd	a5,-80(s0)
    10ea:	fb043783          	ld	a5,-80(s0)
    10ee:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe188>
    10f2:	fcf43023          	sd	a5,-64(s0)
    10f6:	a8a9                	j	1150 <schedule_sjf+0x8e>
        printf("Thread ID: %d, Remaining Time: %d\n", t->ID, t->remaining_time);
    10f8:	fc043783          	ld	a5,-64(s0)
    10fc:	5fd8                	lw	a4,60(a5)
    10fe:	fc043783          	ld	a5,-64(s0)
    1102:	4fbc                	lw	a5,88(a5)
    1104:	863e                	mv	a2,a5
    1106:	85ba                	mv	a1,a4
    1108:	00000517          	auipc	a0,0x0
    110c:	52050513          	addi	a0,a0,1312 # 1628 <schedule_dm+0x28c>
    1110:	00000097          	auipc	ra,0x0
    1114:	9e4080e7          	jalr	-1564(ra) # af4 <printf>
        if (t->remaining_time < shortest_time) {
    1118:	fc043783          	ld	a5,-64(s0)
    111c:	4fb8                	lw	a4,88(a5)
    111e:	fbc42783          	lw	a5,-68(s0)
    1122:	2781                	sext.w	a5,a5
    1124:	00f75b63          	bge	a4,a5,113a <schedule_sjf+0x78>
            shortest_time = t->remaining_time;
    1128:	fc043783          	ld	a5,-64(s0)
    112c:	4fbc                	lw	a5,88(a5)
    112e:	faf42e23          	sw	a5,-68(s0)
            shortest_job = t;
    1132:	fc043783          	ld	a5,-64(s0)
    1136:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    113a:	fc043783          	ld	a5,-64(s0)
    113e:	779c                	ld	a5,40(a5)
    1140:	faf43423          	sd	a5,-88(s0)
    ...
    115a:	f8f71fe3          	bne	a4,a5,10f8 <schedule_sjf+0x36>
        }
    }

    if (shortest_job) {
    115e:	fc843783          	ld	a5,-56(s0)
    1162:	cf89                	beqz	a5,117c <schedule_sjf+0xba>
        r.scheduled_thread_list_member = &shortest_job->thread_list;
    1164:	fc843783          	ld	a5,-56(s0)
    1168:	02878793          	addi	a5,a5,40
    116c:	f8f43423          	sd	a5,-120(s0)
    ...
    1176:	f8f42823          	sw	a5,-112(s0)
    117a:	a039                	j	1188 <schedule_sjf+0xc6>
    } else {
        // If no threads are ready, find the next release time or idle
        r.scheduled_thread_list_member = args.run_queue;
    117c:	649c                	ld	a5,8(s1)
    117e:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;  // Default minimal quantum if unsure
    1182:	4785                	li	a5,1
    1184:	f8f42823          	sw	a5,-112(s0)
    }
    return r;
    1188:	f8843783          	ld	a5,-120(s0)
    118c:	f8f43c23          	sd	a5,-104(s0)
    1190:	f9043783          	ld	a5,-112(s0)
    1194:	faf43023          	sd	a5,-96(s0)
    1198:	4701                	li	a4,0
    119a:	f9843703          	ld	a4,-104(s0)
    119e:	4781                	li	a5,0
...
00000000000011be <find_next_release_time>:

int find_next_release_time(struct list_head *release_queue, int current_time) {
    11be:	7139                	addi	sp,sp,-64
    11c0:	fc22                	sd	s0,56(sp)
    11c2:	0080                	addi	s0,sp,64
    11c4:	fca43423          	sd	a0,-56(s0)
    11c8:	87ae                	mv	a5,a1
    11ca:	fcf42223          	sw	a5,-60(s0)
    struct release_queue_entry *next_release = NULL;
    11ce:	fe043423          	sd	zero,-24(s0)
    int next_release_time = INT_MAX;
    11d2:	800007b7          	lui	a5,0x80000
    11d6:	fff7c793          	not	a5,a5
    11da:	fef42223          	sw	a5,-28(s0)

    list_for_each_entry(next_release, release_queue, thread_list) {
    11de:	fc843783          	ld	a5,-56(s0)
    11e2:	639c                	ld	a5,0(a5)
    11e4:	fcf43c23          	sd	a5,-40(s0)
    11e8:	fd843783          	ld	a5,-40(s0)
    11ec:	17e1                	addi	a5,a5,-8
    11ee:	fef43423          	sd	a5,-24(s0)
    11f2:	a081                	j	1232 <find_next_release_time+0x74>
        if (next_release->release_time > current_time &&
    11f4:	fe843783          	ld	a5,-24(s0)
    11f8:	4f98                	lw	a4,24(a5)
    11fa:	fc442783          	lw	a5,-60(s0)
    11fe:	2781                	sext.w	a5,a5
    1200:	00e7df63          	bge	a5,a4,121e <find_next_release_time+0x60>
            next_release->release_time < next_release_time) {
    1204:	fe843783          	ld	a5,-24(s0)
    1208:	4f98                	lw	a4,24(a5)
        if (next_release->release_time > current_time &&
    120a:	fe442783          	lw	a5,-28(s0)
    120e:	2781                	sext.w	a5,a5
    1210:	00f75763          	bge	a4,a5,121e <find_next_release_time+0x60>
            next_release_time = next_release->release_time;
    1214:	fe843783          	ld	a5,-24(s0)
    1218:	4f9c                	lw	a5,24(a5)
    121a:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(next_release, release_queue, thread_list) {
    121e:	fe843783          	ld	a5,-24(s0)
    1222:	679c                	ld	a5,8(a5)
    1224:	fcf43823          	sd	a5,-48(s0)
    1228:	fd043783          	ld	a5,-48(s0)
    122c:	17e1                	addi	a5,a5,-8
    122e:	fef43423          	sd	a5,-24(s0)
    1232:	fe843783          	ld	a5,-24(s0)
    1236:	07a1                	addi	a5,a5,8
    1238:	fc843703          	ld	a4,-56(s0)
    123c:	faf71ce3          	bne	a4,a5,11f4 <find_next_release_time+0x36>
        }
    }

    if (next_release_time == INT_MAX)
    1240:	fe442783          	lw	a5,-28(s0)
    1244:	0007871b          	sext.w	a4,a5
    1248:	800007b7          	lui	a5,0x80000
    124c:	fff7c793          	not	a5,a5
    1250:	00f71463          	bne	a4,a5,1258 <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    1254:	57fd                	li	a5,-1
    1256:	a801                	j	1266 <find_next_release_time+0xa8>

    return next_release_time - current_time;
    1258:	fe442703          	lw	a4,-28(s0)
    125c:	fc442783          	lw	a5,-60(s0)
    1260:	40f707bb          	subw	a5,a4,a5
    1264:	2781                	sext.w	a5,a5
}
    1266:	853e                	mv	a0,a5
    1268:	7462                	ld	s0,56(sp)
    126a:	6121                	addi	sp,sp,64
    126c:	8082                	ret

000000000000126e <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args)
{
    126e:	7119                	addi	sp,sp,-128
    1270:	fc86                	sd	ra,120(sp)
    1272:	f8a2                	sd	s0,112(sp)
    1274:	f4a6                	sd	s1,104(sp)
    ...
    127e:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    1282:	800007b7          	lui	a5,0x80000
    1286:	fff7c793          	not	a5,a5
    128a:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    ...
    1292:	faf43823          	sd	a5,-80(s0)
    1296:	fb043783          	ld	a5,-80(s0)
    129a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe188>
    129e:	faf43c23          	sd	a5,-72(s0)
    12a2:	a8b5                	j	131e <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    12a4:	fb843783          	ld	a5,-72(s0)
    12a8:	47f8                	lw	a4,76(a5)
    12aa:	409c                	lw	a5,0(s1)
    12ac:	40f707bb          	subw	a5,a4,a5
    12b0:	0007871b          	sext.w	a4,a5
    12b4:	fb843783          	ld	a5,-72(s0)
    12b8:	4fbc                	lw	a5,88(a5)
    12ba:	40f707bb          	subw	a5,a4,a5
    12be:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    12c2:	fc843783          	ld	a5,-56(s0)
    12c6:	cb8d                	beqz	a5,12f8 <schedule_lst+0x8a>
    12c8:	fac42703          	lw	a4,-84(s0)
    12cc:	fc442783          	lw	a5,-60(s0)
    12d0:	2701                	sext.w	a4,a4
    12d2:	2781                	sext.w	a5,a5
    12d4:	02f74263          	blt	a4,a5,12f8 <schedule_lst+0x8a>
    12d8:	fac42703          	lw	a4,-84(s0)
    12dc:	fc442783          	lw	a5,-60(s0)
    12e0:	2701                	sext.w	a4,a4
    12e2:	2781                	sext.w	a5,a5
    12e4:	02f71263          	bne	a4,a5,1308 <schedule_lst+0x9a>
    ...
    12f4:	00f75a63          	bge	a4,a5,1308 <schedule_lst+0x9a>
            min_slack = t;
    12f8:	fb843783          	ld	a5,-72(s0)
    12fc:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    1300:	fac42783          	lw	a5,-84(s0)
    1304:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1308:	fb843783          	ld	a5,-72(s0)
    130c:	779c                	ld	a5,40(a5)
    130e:	faf43023          	sd	a5,-96(s0)
    1312:	fa043783          	ld	a5,-96(s0)
    1316:	fd878793          	addi	a5,a5,-40
    131a:	faf43c23          	sd	a5,-72(s0)
    131e:	fb843783          	ld	a5,-72(s0)
    1322:	02878713          	addi	a4,a5,40
    1326:	649c                	ld	a5,8(s1)
    1328:	f6f71ee3          	bne	a4,a5,12a4 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    132c:	fc843783          	ld	a5,-56(s0)
    1330:	cf89                	beqz	a5,134a <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    1332:	fc843783          	ld	a5,-56(s0)
    1336:	02878793          	addi	a5,a5,40
    133a:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    133e:	fc843783          	ld	a5,-56(s0)
    1342:	4fbc                	lw	a5,88(a5)
    1344:	f8f42423          	sw	a5,-120(s0)
    1348:	a839                	j	1366 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    134a:	649c                	ld	a5,8(s1)
    134c:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1350:	689c                	ld	a5,16(s1)
    1352:	4098                	lw	a4,0(s1)
    1354:	85ba                	mv	a1,a4
    1356:	853e                	mv	a0,a5
    1358:	00000097          	auipc	ra,0x0
    135c:	e66080e7          	jalr	-410(ra) # 11be <find_next_release_time>
    1360:	87aa                	mv	a5,a0
    1362:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    1366:	f8043783          	ld	a5,-128(s0)
    136a:	f8f43823          	sd	a5,-112(s0)
    136e:	f8843783          	ld	a5,-120(s0)
    1372:	f8f43c23          	sd	a5,-104(s0)
    1376:	4701                	li	a4,0
    1378:	f9043703          	ld	a4,-112(s0)
    137c:	4781                	li	a5,0
    137e:	f9843783          	ld	a5,-104(s0)
    1382:	893a                	mv	s2,a4
    1384:	89be                	mv	s3,a5
    1386:	874a                	mv	a4,s2
    1388:	87ce                	mv	a5,s3
    ...
    1398:	6109                	addi	sp,sp,128
    139a:	8082                	ret

000000000000139c <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    139c:	7135                	addi	sp,sp,-160
    139e:	ed06                	sd	ra,152(sp)
    13a0:	e922                	sd	s0,144(sp)
    13a2:	e526                	sd	s1,136(sp)
    13a4:	e14a                	sd	s2,128(sp)
    13a6:	fcce                	sd	s3,120(sp)
    13a8:	1100                	addi	s0,sp,160
    13aa:	84aa                	mv	s1,a0
    struct threads_sched_result r;
   ...
   struct thread *earliest_deadline_thread = NULL;
    ...
    13c0:	faf43423          	sd	a5,-88(s0)
    13c4:	fa843783          	ld	a5,-88(s0)
    13c8:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe188>
    13cc:	fcf43023          	sd	a5,-64(s0)
    13d0:	a841                	j	1460 <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    13d2:	fc043783          	ld	a5,-64(s0)
    13d6:	43bc                	lw	a5,64(a5)
    13d8:	cb95                	beqz	a5,140c <schedule_dm+0x70>
    13da:	fc043783          	ld	a5,-64(s0)
    13de:	4bbc                	lw	a5,80(a5)
    13e0:	873e                	mv	a4,a5
    13e2:	57fd                	li	a5,-1
    13e4:	02f70463          	beq	a4,a5,140c <schedule_dm+0x70>
    13e8:	fc043783          	ld	a5,-64(s0)
    13ec:	4ff8                	lw	a4,92(a5)
    13ee:	fbc42783          	lw	a5,-68(s0)
    13f2:	2781                	sext.w	a5,a5
    13f4:	00f75c63          	bge	a4,a5,140c <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    13f8:	fc043783          	ld	a5,-64(s0)
    13fc:	4ffc                	lw	a5,92(a5)
    13fe:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    1402:	fc043783          	ld	a5,-64(s0)
    1406:	fcf43423          	sd	a5,-56(s0)
    140a:	a081                	j	144a <schedule_dm+0xae>
    ...
    1410:	43bc                	lw	a5,64(a5)
    1412:	cf85                	beqz	a5,144a <schedule_dm+0xae>
    1414:	fc043783          	ld	a5,-64(s0)
    1418:	4bbc                	lw	a5,80(a5)
    141a:	873e                	mv	a4,a5
    141c:	57fd                	li	a5,-1
    141e:	02f70663          	beq	a4,a5,144a <schedule_dm+0xae>
    1422:	fc043783          	ld	a5,-64(s0)
    1426:	4ff8                	lw	a4,92(a5)
    1428:	fbc42783          	lw	a5,-68(s0)
    142c:	2781                	sext.w	a5,a5
    142e:	00e79e63          	bne	a5,a4,144a <schedule_dm+0xae>
    1432:	fc043783          	ld	a5,-64(s0)
    1436:	5fd8                	lw	a4,60(a5)
    1438:	fc843783          	ld	a5,-56(s0)
    143c:	5fdc                	lw	a5,60(a5)
    143e:	00f75663          	bge	a4,a5,144a <schedule_dm+0xae>
    ...
    1450:	f8f43423          	sd	a5,-120(s0)
    1454:	f8843783          	ld	a5,-120(s0)
    1458:	fd878793          	addi	a5,a5,-40
    145c:	fcf43023          	sd	a5,-64(s0)
    1460:	fc043783          	ld	a5,-64(s0)
    1464:	02878713          	addi	a4,a5,40
    1468:	649c                	ld	a5,8(s1)
    146a:	f6f714e3          	bne	a4,a5,13d2 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    146e:	fc843783          	ld	a5,-56(s0)
    1472:	c7a5                	beqz	a5,14da <schedule_dm+0x13e>
    ...
    147a:	409c                	lw	a5,0(s1)
    147c:	40f707bb          	subw	a5,a4,a5
    1480:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    1484:	fc843783          	ld	a5,-56(s0)
    1488:	4fb8                	lw	a4,88(a5)
    148a:	f9442783          	lw	a5,-108(s0)
    148e:	2781                	sext.w	a5,a5
    1490:	00e7db63          	bge	a5,a4,14a6 <schedule_dm+0x10a>
    ...
    14a0:	f6042823          	sw	zero,-144(s0)
    14a4:	a0f1                	j	1570 <schedule_dm+0x1d4>
        } else {
    ...
    14aa:	4fbc                	lw	a5,88(a5)
    14ac:	863e                	mv	a2,a5
    14ae:	f9442783          	lw	a5,-108(s0)
    14b2:	0007869b          	sext.w	a3,a5
    14b6:	0006071b          	sext.w	a4,a2
    14ba:	00d75363          	bge	a4,a3,14c0 <schedule_dm+0x124>
    14be:	87b2                	mv	a5,a2
    14c0:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    14c4:	fc843783          	ld	a5,-56(s0)
    14c8:	02878793          	addi	a5,a5,40
    14cc:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    14d0:	f9042783          	lw	a5,-112(s0)
    14d4:	f6f42823          	sw	a5,-144(s0)
    14d8:	a861                	j	1570 <schedule_dm+0x1d4>
        }
    } else {
    ...
    14da:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    14de:	649c                	ld	a5,8(s1)
    14e0:	639c                	ld	a5,0(a5)
    14e2:	faf43023          	sd	a5,-96(s0)
    14e6:	fa043783          	ld	a5,-96(s0)
    14ea:	fd878793          	addi	a5,a5,-40
    14ee:	fcf43023          	sd	a5,-64(s0)
    14f2:	a81d                	j	1528 <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    14f4:	fb043783          	ld	a5,-80(s0)
    14f8:	cb89                	beqz	a5,150a <schedule_dm+0x16e>
    14fa:	fc043783          	ld	a5,-64(s0)
    14fe:	5fd8                	lw	a4,60(a5)
    1500:	fb043783          	ld	a5,-80(s0)
    1504:	5fdc                	lw	a5,60(a5)
    1506:	00f75663          	bge	a4,a5,1512 <schedule_dm+0x176>
                smallest_id_thread = t;
    150a:	fc043783          	ld	a5,-64(s0)
    150e:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    1512:	fc043783          	ld	a5,-64(s0)
    1516:	779c                	ld	a5,40(a5)
    1518:	f8f43c23          	sd	a5,-104(s0)
    151c:	f9843783          	ld	a5,-104(s0)
    1520:	fd878793          	addi	a5,a5,-40
    1524:	fcf43023          	sd	a5,-64(s0)
    1528:	fc043783          	ld	a5,-64(s0)
    152c:	02878713          	addi	a4,a5,40
    1530:	649c                	ld	a5,8(s1)
    1532:	fcf711e3          	bne	a4,a5,14f4 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    1536:	fb043783          	ld	a5,-80(s0)
    153a:	cf89                	beqz	a5,1554 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    153c:	fb043783          	ld	a5,-80(s0)
    1540:	02878793          	addi	a5,a5,40
    1544:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    1548:	fb043783          	ld	a5,-80(s0)
    154c:	4fbc                	lw	a5,88(a5)
    154e:	f6f42823          	sw	a5,-144(s0)
    1552:	a839                	j	1570 <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    1554:	649c                	ld	a5,8(s1)
    1556:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    155a:	689c                	ld	a5,16(s1)
    155c:	4098                	lw	a4,0(s1)
    155e:	85ba                	mv	a1,a4
    1560:	853e                	mv	a0,a5
    1562:	00000097          	auipc	ra,0x0
    1566:	c5c080e7          	jalr	-932(ra) # 11be <find_next_release_time>
    156a:	87aa                	mv	a5,a0
    156c:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    1570:	f6843783          	ld	a5,-152(s0)
    1574:	f6f43c23          	sd	a5,-136(s0)
    1578:	f7043783          	ld	a5,-144(s0)
    157c:	f8f43023          	sd	a5,-128(s0)
    1580:	4701                	li	a4,0
    1582:	f7843703          	ld	a4,-136(s0)
    1586:	4781                	li	a5,0
    ...
    1594:	853a                	mv	a0,a4
    1596:	85be                	mv	a1,a5
    1598:	60ea                	ld	ra,152(sp)
    159a:	644a                	ld	s0,144(sp)
    159c:	64aa                	ld	s1,136(sp)
    159e:	690a                	ld	s2,128(sp)
    15a0:	79e6                	ld	s3,120(sp)
    15a2:	610d                	addi	sp,sp,160
    15a4:	8082                	ret

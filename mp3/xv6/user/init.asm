...
main(void)
{
  ...
  if(open("console", O_RDWR) < 0){
       ...
       e:	93650513          	addi	a0,a0,-1738 # 1940 <schedule_dm+0x184>
    ...
    mknod("console", CONSOLE, 0);
      ...
      28:	91c50513          	addi	a0,a0,-1764 # 1940 <schedule_dm+0x184>
      2c:	00000097          	auipc	ra,0x0
      30:	5ca080e7          	jalr	1482(ra) # 5f6 <mknod>
    open("console", O_RDWR);
      34:	4589                	li	a1,2
      36:	00002517          	auipc	a0,0x2
      3a:	90a50513          	addi	a0,a0,-1782 # 1940 <schedule_dm+0x184>
  ...
  for(;;){
    printf("init: starting sh\n");
      ...
      5e:	8ee50513          	addi	a0,a0,-1810 # 1948 <schedule_dm+0x18c>
    ...
    if(pid < 0){
      ...
      86:	8de50513          	addi	a0,a0,-1826 # 1960 <schedule_dm+0x1a4>
    ...
    if(pid == 0){
      ...
      a8:	91458593          	addi	a1,a1,-1772 # 19b8 <argv>
      ac:	00002517          	auipc	a0,0x2
      b0:	88c50513          	addi	a0,a0,-1908 # 1938 <schedule_dm+0x17c>
      b4:	00000097          	auipc	ra,0x0
      b8:	532080e7          	jalr	1330(ra) # 5e6 <exec>
      printf("init: exec sh failed\n");
      bc:	00002517          	auipc	a0,0x2
      c0:	8bc50513          	addi	a0,a0,-1860 # 1978 <schedule_dm+0x1bc>
    ...
    for(;;){
     ...
     104:	89050513          	addi	a0,a0,-1904 # 1990 <schedule_dm+0x1d4>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     716:	2b668693          	addi	a3,a3,694 # 19c8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     7f0:	1dc70713          	addi	a4,a4,476 # 19c8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     9b0:	00478793          	addi	a5,a5,4 # 19b0 <schedule_dm+0x1f4>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     b5c:	e9878793          	addi	a5,a5,-360 # 19f0 <freep>
     b60:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     c54:	da078793          	addi	a5,a5,-608 # 19f0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     cd6:	d1e78793          	addi	a5,a5,-738 # 19f0 <freep>
     cda:	639c                	ld	a5,0(a5)
}
     cdc:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d08:	cec78793          	addi	a5,a5,-788 # 19f0 <freep>
     d0c:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d1c:	cc878793          	addi	a5,a5,-824 # 19e0 <base>
     d20:	fef43023          	sd	a5,-32(s0)
     d24:	00001797          	auipc	a5,0x1
     d28:	ccc78793          	addi	a5,a5,-820 # 19f0 <freep>
     d2c:	fe043703          	ld	a4,-32(s0)
     d30:	e398                	sd	a4,0(a5)
     d32:	00001797          	auipc	a5,0x1
     d36:	cbe78793          	addi	a5,a5,-834 # 19f0 <freep>
     d3a:	6398                	ld	a4,0(a5)
     d3c:	00001797          	auipc	a5,0x1
     d40:	ca478793          	addi	a5,a5,-860 # 19e0 <base>
     d44:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     d46:	00001797          	auipc	a5,0x1
     d4a:	c9a78793          	addi	a5,a5,-870 # 19e0 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     dc6:	c2e78793          	addi	a5,a5,-978 # 19f0 <freep>
    ...
    if(p == freep)
     ...
     ddc:	c1878793          	addi	a5,a5,-1000 # 19f0 <freep>
     de0:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     f74:	a8878793          	addi	a5,a5,-1400 # 19f8 <last_thread.1226>
     f78:	639c                	ld	a5,0(a5)
     f7a:	cb89                	beqz	a5,f8c <schedule_wrr+0x2e>
     f7c:	00001797          	auipc	a5,0x1
     f80:	a7c78793          	addi	a5,a5,-1412 # 19f8 <last_thread.1226>
     f84:	639c                	ld	a5,0(a5)
     f86:	4fbc                	lw	a5,88(a5)
     f88:	00f04863          	bgtz	a5,f98 <schedule_wrr+0x3a>
        last_thread = NULL;
     f8c:	00001797          	auipc	a5,0x1
     f90:	a6c78793          	addi	a5,a5,-1428 # 19f8 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     fb2:	a4a78793          	addi	a5,a5,-1462 # 19f8 <last_thread.1226>
     fb6:	639c                	ld	a5,0(a5)
    ...
    100e:	9ee78793          	addi	a5,a5,-1554 # 19f8 <last_thread.1226>
    1012:	639c                	ld	a5,0(a5)
    1014:	c385                	beqz	a5,1034 <schedule_wrr+0xd6>
    1016:	00001797          	auipc	a5,0x1
    101a:	9e278793          	addi	a5,a5,-1566 # 19f8 <last_thread.1226>
    ...
    102a:	9d278793          	addi	a5,a5,-1582 # 19f8 <last_thread.1226>
    ...
    107a:	98278793          	addi	a5,a5,-1662 # 19f8 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    11ac:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffde20>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    12de:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffde20>
    ...
    1378:	a80d                	j	13aa <schedule_sjf+0x112>
    } else {
    ...
    1388:	57fd                	li	a5,-1
    138a:	00f71c63          	bne	a4,a5,13a2 <schedule_sjf+0x10a>
    138e:	689c                	ld	a5,16(s1)
    1390:	4098                	lw	a4,0(s1)
    1392:	85ba                	mv	a1,a4
    1394:	853e                	mv	a0,a5
    1396:	00000097          	auipc	ra,0x0
    139a:	d2c080e7          	jalr	-724(ra) # 10c2 <find_next_release_time>
    139e:	87aa                	mv	a5,a0
    13a0:	a019                	j	13a6 <schedule_sjf+0x10e>
    13a2:	fb442783          	lw	a5,-76(s0)
    13a6:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    13aa:	f8043783          	ld	a5,-128(s0)
    13ae:	f8f43823          	sd	a5,-112(s0)
    13b2:	f8843783          	ld	a5,-120(s0)
    13b6:	f8f43c23          	sd	a5,-104(s0)
    13ba:	4701                	li	a4,0
    13bc:	f9043703          	ld	a4,-112(s0)
    13c0:	4781                	li	a5,0
    13c2:	f9843783          	ld	a5,-104(s0)
    13c6:	893a                	mv	s2,a4
    13c8:	89be                	mv	s3,a5
    13ca:	874a                	mv	a4,s2
    13cc:	87ce                	mv	a5,s3
    ...
    13ce:	853a                	mv	a0,a4
    13d0:	85be                	mv	a1,a5
    13d2:	70e6                	ld	ra,120(sp)
    13d4:	7446                	ld	s0,112(sp)
    13d6:	74a6                	ld	s1,104(sp)
    13d8:	7906                	ld	s2,96(sp)
    13da:	69e6                	ld	s3,88(sp)
    13dc:	6109                	addi	sp,sp,128
    13de:	8082                	ret

00000000000013e0 <min>:
...
int min(int a, int b) {
    ...
    return (a < b) ? a : b;
    13f4:	fec42603          	lw	a2,-20(s0)
    13f8:	fe842783          	lw	a5,-24(s0)
    13fc:	0007869b          	sext.w	a3,a5
    1400:	0006071b          	sext.w	a4,a2
    1404:	00d75363          	bge	a4,a3,140a <min+0x2a>
    1408:	87b2                	mv	a5,a2
    140a:	2781                	sext.w	a5,a5
}
    140c:	853e                	mv	a0,a5
    140e:	6462                	ld	s0,24(sp)
    1410:	6105                	addi	sp,sp,32
    1412:	8082                	ret

0000000000001414 <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    1414:	7131                	addi	sp,sp,-192
    1416:	fd06                	sd	ra,184(sp)
    1418:	f922                	sd	s0,176(sp)
    141a:	f526                	sd	s1,168(sp)
    141c:	f14a                	sd	s2,160(sp)
    141e:	ed4e                	sd	s3,152(sp)
    1420:	0180                	addi	s0,sp,192
    1422:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *min_slack_thread = NULL;
    1424:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    1428:	800007b7          	lui	a5,0x80000
    142c:	fff7c793          	not	a5,a5
    1430:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    // int ddl;
    ...
    1440:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffde20>
    1444:	faf43c23          	sd	a5,-72(s0)
    1448:	a069                	j	14d2 <schedule_lst+0xbe>
    ...
    1452:	40f707bb          	subw	a5,a4,a5
    1456:	0007871b          	sext.w	a4,a5
    145a:	fb843783          	ld	a5,-72(s0)
    145e:	4fbc                	lw	a5,88(a5)
    1460:	40f707bb          	subw	a5,a4,a5
    1464:	f6f42a23          	sw	a5,-140(s0)
        if (slack_time < min_slack_time || (slack_time == min_slack_time && t->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))) {
    1468:	f7442703          	lw	a4,-140(s0)
    146c:	fc442783          	lw	a5,-60(s0)
    1470:	2701                	sext.w	a4,a4
    1472:	2781                	sext.w	a5,a5
    1474:	02f74c63          	blt	a4,a5,14ac <schedule_lst+0x98>
    1478:	f7442703          	lw	a4,-140(s0)
    147c:	fc442783          	lw	a5,-60(s0)
    1480:	2701                	sext.w	a4,a4
    1482:	2781                	sext.w	a5,a5
    1484:	02f71c63          	bne	a4,a5,14bc <schedule_lst+0xa8>
    1488:	fb843783          	ld	a5,-72(s0)
    148c:	5fd4                	lw	a3,60(a5)
    148e:	fc843783          	ld	a5,-56(s0)
    1492:	c789                	beqz	a5,149c <schedule_lst+0x88>
    1494:	fc843783          	ld	a5,-56(s0)
    1498:	5fdc                	lw	a5,60(a5)
    149a:	a029                	j	14a4 <schedule_lst+0x90>
    149c:	800007b7          	lui	a5,0x80000
    14a0:	fff7c793          	not	a5,a5
    14a4:	873e                	mv	a4,a5
    14a6:	87b6                	mv	a5,a3
    14a8:	00e7da63          	bge	a5,a4,14bc <schedule_lst+0xa8>
            min_slack_thread = t;
    14ac:	fb843783          	ld	a5,-72(s0)
    14b0:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    14b4:	f7442783          	lw	a5,-140(s0)
    14b8:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    14bc:	fb843783          	ld	a5,-72(s0)
    14c0:	779c                	ld	a5,40(a5)
    14c2:	f6f43423          	sd	a5,-152(s0)
    14c6:	f6843783          	ld	a5,-152(s0)
    14ca:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffde20>
    14ce:	faf43c23          	sd	a5,-72(s0)
    14d2:	fb843783          	ld	a5,-72(s0)
    14d6:	02878713          	addi	a4,a5,40
    14da:	649c                	ld	a5,8(s1)
    14dc:	f6f717e3          	bne	a4,a5,144a <schedule_lst+0x36>
    ...
    14f0:	f8f43c23          	sd	a5,-104(s0)
    14f4:	f9843783          	ld	a5,-104(s0)
    14f8:	17e1                	addi	a5,a5,-8
    14fa:	faf43423          	sd	a5,-88(s0)
    14fe:	a0f1                	j	15ca <schedule_lst+0x1b6>
        if (entry->release_time > args.current_time) {
    1500:	fa843783          	ld	a5,-88(s0)
    1504:	4f98                	lw	a4,24(a5)
    1506:	409c                	lw	a5,0(s1)
    1508:	0ae7d763          	bge	a5,a4,15b6 <schedule_lst+0x1a2>
            struct thread *upcoming_thread = entry->thrd;
    150c:	fa843783          	ld	a5,-88(s0)
    1510:	639c                	ld	a5,0(a5)
    1512:	f8f43423          	sd	a5,-120(s0)
            int upcoming_slack_time = upcoming_thread->current_deadline - entry->release_time - upcoming_thread->remaining_time;
    1516:	f8843783          	ld	a5,-120(s0)
    151a:	4ff8                	lw	a4,92(a5)
    151c:	fa843783          	ld	a5,-88(s0)
    1520:	4f9c                	lw	a5,24(a5)
    1522:	40f707bb          	subw	a5,a4,a5
    1526:	0007871b          	sext.w	a4,a5
    152a:	f8843783          	ld	a5,-120(s0)
    152e:	4fbc                	lw	a5,88(a5)
    1530:	40f707bb          	subw	a5,a4,a5
    1534:	f8f42223          	sw	a5,-124(s0)
    ...
    1538:	f8442703          	lw	a4,-124(s0)
    153c:	fc442783          	lw	a5,-60(s0)
    1540:	2701                	sext.w	a4,a4
    1542:	2781                	sext.w	a5,a5
    1544:	02f75163          	bge	a4,a5,1566 <schedule_lst+0x152>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    1548:	fa843783          	ld	a5,-88(s0)
    154c:	4f98                	lw	a4,24(a5)
    154e:	fb442783          	lw	a5,-76(s0)
    1552:	85ba                	mv	a1,a4
    1554:	853e                	mv	a0,a5
    1556:	00000097          	auipc	ra,0x0
    155a:	e8a080e7          	jalr	-374(ra) # 13e0 <min>
    155e:	87aa                	mv	a5,a0
    1560:	faf42a23          	sw	a5,-76(s0)
    1564:	a889                	j	15b6 <schedule_lst+0x1a2>
            } else if (upcoming_slack_time == min_slack_time && upcoming_thread->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))
    1566:	f8442703          	lw	a4,-124(s0)
    156a:	fc442783          	lw	a5,-60(s0)
    156e:	2701                	sext.w	a4,a4
    1570:	2781                	sext.w	a5,a5
    1572:	04f71263          	bne	a4,a5,15b6 <schedule_lst+0x1a2>
    1576:	f8843783          	ld	a5,-120(s0)
    157a:	5fd4                	lw	a3,60(a5)
    157c:	fc843783          	ld	a5,-56(s0)
    1580:	c789                	beqz	a5,158a <schedule_lst+0x176>
    1582:	fc843783          	ld	a5,-56(s0)
    1586:	5fdc                	lw	a5,60(a5)
    1588:	a029                	j	1592 <schedule_lst+0x17e>
    158a:	800007b7          	lui	a5,0x80000
    158e:	fff7c793          	not	a5,a5
    1592:	873e                	mv	a4,a5
    1594:	87b6                	mv	a5,a3
    1596:	02e7d063          	bge	a5,a4,15b6 <schedule_lst+0x1a2>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    159a:	fa843783          	ld	a5,-88(s0)
    159e:	4f98                	lw	a4,24(a5)
    15a0:	fb442783          	lw	a5,-76(s0)
    15a4:	85ba                	mv	a1,a4
    15a6:	853e                	mv	a0,a5
    15a8:	00000097          	auipc	ra,0x0
    15ac:	e38080e7          	jalr	-456(ra) # 13e0 <min>
    15b0:	87aa                	mv	a5,a0
    15b2:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(entry, args.release_queue, thread_list) {
    15b6:	fa843783          	ld	a5,-88(s0)
    15ba:	679c                	ld	a5,8(a5)
    15bc:	f6f43c23          	sd	a5,-136(s0)
    15c0:	f7843783          	ld	a5,-136(s0)
    15c4:	17e1                	addi	a5,a5,-8
    15c6:	faf43423          	sd	a5,-88(s0)
    15ca:	fa843783          	ld	a5,-88(s0)
    15ce:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffde50>
    15d2:	689c                	ld	a5,16(s1)
    15d4:	f2f716e3          	bne	a4,a5,1500 <schedule_lst+0xec>
        }
    }

    // Decide the allocated time based on current minimum slack or upcoming preemption needs
    if (min_slack_thread) {
    15d8:	fc843783          	ld	a5,-56(s0)
    15dc:	c3b1                	beqz	a5,1620 <schedule_lst+0x20c>
    ...
    15de:	fb442783          	lw	a5,-76(s0)
    15e2:	0007871b          	sext.w	a4,a5
    15e6:	800007b7          	lui	a5,0x80000
    15ea:	fff7c793          	not	a5,a5
    15ee:	00f71663          	bne	a4,a5,15fa <schedule_lst+0x1e6>
    15f2:	fc843783          	ld	a5,-56(s0)
    15f6:	4fbc                	lw	a5,88(a5)
    15f8:	a039                	j	1606 <schedule_lst+0x1f2>
    15fa:	409c                	lw	a5,0(s1)
    15fc:	fb442703          	lw	a4,-76(s0)
    1600:	40f707bb          	subw	a5,a4,a5
    1604:	2781                	sext.w	a5,a5
    1606:	f8f42a23          	sw	a5,-108(s0)
        r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    160a:	fc843783          	ld	a5,-56(s0)
    160e:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffde70>
    1612:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = allocated_time;
    1616:	f9442783          	lw	a5,-108(s0)
    161a:	f4f42823          	sw	a5,-176(s0)
    161e:	a081                	j	165e <schedule_lst+0x24a>
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    1620:	649c                	ld	a5,8(s1)
    1622:	f4f43423          	sd	a5,-184(s0)
    ...
    1626:	fb442783          	lw	a5,-76(s0)
    162a:	0007871b          	sext.w	a4,a5
    162e:	800007b7          	lui	a5,0x80000
    1632:	fff7c793          	not	a5,a5
    1636:	00f70963          	beq	a4,a5,1648 <schedule_lst+0x234>
    163a:	409c                	lw	a5,0(s1)
    163c:	fb442703          	lw	a4,-76(s0)
    1640:	40f707bb          	subw	a5,a4,a5
    1644:	2781                	sext.w	a5,a5
    1646:	a811                	j	165a <schedule_lst+0x246>
    1648:	689c                	ld	a5,16(s1)
    164a:	4098                	lw	a4,0(s1)
    164c:	85ba                	mv	a1,a4
    164e:	853e                	mv	a0,a5
    1650:	00000097          	auipc	ra,0x0
    1654:	a72080e7          	jalr	-1422(ra) # 10c2 <find_next_release_time>
    1658:	87aa                	mv	a5,a0
    165a:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    165e:	f4843783          	ld	a5,-184(s0)
    1662:	f4f43c23          	sd	a5,-168(s0)
    1666:	f5043783          	ld	a5,-176(s0)
    166a:	f6f43023          	sd	a5,-160(s0)
    166e:	4701                	li	a4,0
    1670:	f5843703          	ld	a4,-168(s0)
    1674:	4781                	li	a5,0
    1676:	f6043783          	ld	a5,-160(s0)
    167a:	893a                	mv	s2,a4
    167c:	89be                	mv	s3,a5
    167e:	874a                	mv	a4,s2
    1680:	87ce                	mv	a5,s3
    ...
    1682:	853a                	mv	a0,a4
    1684:	85be                	mv	a1,a5
    1686:	70ea                	ld	ra,184(sp)
    1688:	744a                	ld	s0,176(sp)
    168a:	74aa                	ld	s1,168(sp)
    168c:	790a                	ld	s2,160(sp)
    168e:	69ea                	ld	s3,152(sp)
    1690:	6129                	addi	sp,sp,192
    1692:	8082                	ret

0000000000001694 <find_earliest_impactful_release_time_dm>:
...
int find_earliest_impactful_release_time_dm(struct list_head *release_queue, int current_time, int current_deadline) {
    ...
    1696:	e4a2                	sd	s0,72(sp)
    1698:	0880                	addi	s0,sp,80
    169a:	faa43c23          	sd	a0,-72(s0)
    169e:	87ae                	mv	a5,a1
    16a0:	8732                	mv	a4,a2
    16a2:	faf42a23          	sw	a5,-76(s0)
    16a6:	87ba                	mv	a5,a4
    16a8:	faf42823          	sw	a5,-80(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_event = INT_MAX;
    16ac:	800007b7          	lui	a5,0x80000
    16b0:	fff7c793          	not	a5,a5
    16b4:	fef42223          	sw	a5,-28(s0)
    struct thread *earliest_deadline_thread = NULL;
    16b8:	fc043c23          	sd	zero,-40(s0)
    earliest_deadline_thread->ID = INT_MAX;
    16bc:	fd843783          	ld	a5,-40(s0)
    16c0:	80000737          	lui	a4,0x80000
    16c4:	fff74713          	not	a4,a4
    16c8:	dfd8                	sw	a4,60(a5)

    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    16ca:	fb843783          	ld	a5,-72(s0)
    16ce:	639c                	ld	a5,0(a5)
    16d0:	fcf43823          	sd	a5,-48(s0)
    16d4:	fd043783          	ld	a5,-48(s0)
    16d8:	17e1                	addi	a5,a5,-8
    16da:	fef43423          	sd	a5,-24(s0)
    16de:	a075                	j	178a <find_earliest_impactful_release_time_dm+0xf6>
        if (entry->release_time > current_time && entry->thrd->period < current_deadline) {
    16e0:	fe843783          	ld	a5,-24(s0)
    16e4:	4f98                	lw	a4,24(a5)
    16e6:	fb442783          	lw	a5,-76(s0)
    16ea:	2781                	sext.w	a5,a5
    16ec:	02e7d963          	bge	a5,a4,171e <find_earliest_impactful_release_time_dm+0x8a>
    16f0:	fe843783          	ld	a5,-24(s0)
    16f4:	639c                	ld	a5,0(a5)
    16f6:	4bb8                	lw	a4,80(a5)
    16f8:	fb042783          	lw	a5,-80(s0)
    16fc:	2781                	sext.w	a5,a5
    16fe:	02f75063          	bge	a4,a5,171e <find_earliest_impactful_release_time_dm+0x8a>
            if (entry->release_time < earliest_impactful_event) {
    1702:	fe843783          	ld	a5,-24(s0)
    1706:	4f98                	lw	a4,24(a5)
    1708:	fe442783          	lw	a5,-28(s0)
    170c:	2781                	sext.w	a5,a5
    170e:	06f75463          	bge	a4,a5,1776 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    1712:	fe843783          	ld	a5,-24(s0)
    1716:	4f9c                	lw	a5,24(a5)
    1718:	fef42223          	sw	a5,-28(s0)
            if (entry->release_time < earliest_impactful_event) {
    171c:	a8a9                	j	1776 <find_earliest_impactful_release_time_dm+0xe2>
            }
        } 
    ...
    1722:	4f98                	lw	a4,24(a5)
    1724:	fb442783          	lw	a5,-76(s0)
    1728:	2781                	sext.w	a5,a5
    172a:	04e7d663          	bge	a5,a4,1776 <find_earliest_impactful_release_time_dm+0xe2>
    172e:	fe843783          	ld	a5,-24(s0)
    1732:	639c                	ld	a5,0(a5)
    1734:	4bb8                	lw	a4,80(a5)
    1736:	fb042783          	lw	a5,-80(s0)
    173a:	2781                	sext.w	a5,a5
    173c:	02e79d63          	bne	a5,a4,1776 <find_earliest_impactful_release_time_dm+0xe2>
    ...
    1746:	fe442783          	lw	a5,-28(s0)
    174a:	2781                	sext.w	a5,a5
    174c:	02f75563          	bge	a4,a5,1776 <find_earliest_impactful_release_time_dm+0xe2>
    1750:	fe843783          	ld	a5,-24(s0)
    1754:	639c                	ld	a5,0(a5)
    1756:	5fd8                	lw	a4,60(a5)
    1758:	fd843783          	ld	a5,-40(s0)
    175c:	5fdc                	lw	a5,60(a5)
    175e:	00f75c63          	bge	a4,a5,1776 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    1762:	fe843783          	ld	a5,-24(s0)
    1766:	4f9c                	lw	a5,24(a5)
    1768:	fef42223          	sw	a5,-28(s0)
                earliest_deadline_thread = entry->thrd;
    176c:	fe843783          	ld	a5,-24(s0)
    1770:	639c                	ld	a5,0(a5)
    1772:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    ...
    1786:	fef43423          	sd	a5,-24(s0)
    178a:	fe843783          	ld	a5,-24(s0)
    178e:	07a1                	addi	a5,a5,8
    1790:	fb843703          	ld	a4,-72(s0)
    1794:	f4f716e3          	bne	a4,a5,16e0 <find_earliest_impactful_release_time_dm+0x4c>
            }
        }
    }
    ...
    1798:	fe442783          	lw	a5,-28(s0)
    179c:	0007871b          	sext.w	a4,a5
    17a0:	800007b7          	lui	a5,0x80000
    17a4:	fff7c793          	not	a5,a5
    17a8:	00f70563          	beq	a4,a5,17b2 <find_earliest_impactful_release_time_dm+0x11e>
    17ac:	fe442783          	lw	a5,-28(s0)
    17b0:	a011                	j	17b4 <find_earliest_impactful_release_time_dm+0x120>
    17b2:	57fd                	li	a5,-1
}
    17b4:	853e                	mv	a0,a5
    17b6:	6426                	ld	s0,72(sp)
    17b8:	6161                	addi	sp,sp,80
    17ba:	8082                	ret

00000000000017bc <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    17bc:	7175                	addi	sp,sp,-144
    17be:	e506                	sd	ra,136(sp)
    17c0:	e122                	sd	s0,128(sp)
    17c2:	fca6                	sd	s1,120(sp)
    17c4:	f8ca                	sd	s2,112(sp)
    17c6:	f4ce                	sd	s3,104(sp)
    17c8:	0900                	addi	s0,sp,144
    17ca:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    17cc:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    17d0:	800007b7          	lui	a5,0x80000
    17d4:	fff7c793          	not	a5,a5
    17d8:	faf42e23          	sw	a5,-68(s0)

    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    17dc:	649c                	ld	a5,8(s1)
    17de:	639c                	ld	a5,0(a5)
    17e0:	faf43823          	sd	a5,-80(s0)
    17e4:	fb043783          	ld	a5,-80(s0)
    17e8:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffde20>
    17ec:	fcf43023          	sd	a5,-64(s0)
    17f0:	a089                	j	1832 <schedule_dm+0x76>
        if (t->is_real_time && t->period < earliest_deadline) {
    17f2:	fc043783          	ld	a5,-64(s0)
    17f6:	43bc                	lw	a5,64(a5)
    17f8:	c395                	beqz	a5,181c <schedule_dm+0x60>
    17fa:	fc043783          	ld	a5,-64(s0)
    17fe:	4bb8                	lw	a4,80(a5)
    1800:	fbc42783          	lw	a5,-68(s0)
    1804:	2781                	sext.w	a5,a5
    1806:	00f75b63          	bge	a4,a5,181c <schedule_dm+0x60>
            earliest_deadline_thread = t;
    180a:	fc043783          	ld	a5,-64(s0)
    180e:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    1812:	fc043783          	ld	a5,-64(s0)
    1816:	4bbc                	lw	a5,80(a5)
    1818:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    181c:	fc043783          	ld	a5,-64(s0)
    1820:	779c                	ld	a5,40(a5)
    1822:	f8f43c23          	sd	a5,-104(s0)
    1826:	f9843783          	ld	a5,-104(s0)
    182a:	fd878793          	addi	a5,a5,-40
    182e:	fcf43023          	sd	a5,-64(s0)
    1832:	fc043783          	ld	a5,-64(s0)
    1836:	02878713          	addi	a4,a5,40
    183a:	649c                	ld	a5,8(s1)
    183c:	faf71be3          	bne	a4,a5,17f2 <schedule_dm+0x36>
        }
    }
    ...
    1840:	689c                	ld	a5,16(s1)
    1842:	4098                	lw	a4,0(s1)
    1844:	fbc42683          	lw	a3,-68(s0)
    1848:	8636                	mv	a2,a3
    184a:	85ba                	mv	a1,a4
    184c:	853e                	mv	a0,a5
    184e:	00000097          	auipc	ra,0x0
    1852:	e46080e7          	jalr	-442(ra) # 1694 <find_earliest_impactful_release_time_dm>
    1856:	87aa                	mv	a5,a0
    1858:	faf42623          	sw	a5,-84(s0)

    if (earliest_deadline_thread) {
    185c:	fc843783          	ld	a5,-56(s0)
    1860:	c3c9                	beqz	a5,18e2 <schedule_dm+0x126>
    ...
    186e:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline < 0) {
    1872:	fa842783          	lw	a5,-88(s0)
    1876:	2781                	sext.w	a5,a5
    1878:	0007db63          	bgez	a5,188e <schedule_dm+0xd2>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    187c:	fc843783          	ld	a5,-56(s0)
    1880:	02878793          	addi	a5,a5,40
    1884:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    1888:	f8042023          	sw	zero,-128(s0)
    188c:	a88d                	j	18fe <schedule_dm+0x142>
        } else {
    ...
    1896:	57fd                	li	a5,-1
    1898:	02f70563          	beq	a4,a5,18c2 <schedule_dm+0x106>
    189c:	409c                	lw	a5,0(s1)
    189e:	fac42703          	lw	a4,-84(s0)
    18a2:	40f707bb          	subw	a5,a4,a5
    18a6:	0007871b          	sext.w	a4,a5
    18aa:	fc843783          	ld	a5,-56(s0)
    18ae:	4fbc                	lw	a5,88(a5)
    18b0:	00f75963          	bge	a4,a5,18c2 <schedule_dm+0x106>
    18b4:	409c                	lw	a5,0(s1)
    18b6:	fac42703          	lw	a4,-84(s0)
    18ba:	40f707bb          	subw	a5,a4,a5
    18be:	2781                	sext.w	a5,a5
    18c0:	a021                	j	18c8 <schedule_dm+0x10c>
    18c2:	fc843783          	ld	a5,-56(s0)
    18c6:	4fbc                	lw	a5,88(a5)
    18c8:	faf42223          	sw	a5,-92(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    18cc:	fc843783          	ld	a5,-56(s0)
    18d0:	02878793          	addi	a5,a5,40
    18d4:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    18d8:	fa442783          	lw	a5,-92(s0)
    18dc:	f8f42023          	sw	a5,-128(s0)
    18e0:	a839                	j	18fe <schedule_dm+0x142>
        }
    } else {
    ...
    18f4:	7d2080e7          	jalr	2002(ra) # 10c2 <find_next_release_time>
    18f8:	87aa                	mv	a5,a0
    18fa:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    18fe:	f7843783          	ld	a5,-136(s0)
    1902:	f8f43423          	sd	a5,-120(s0)
    1906:	f8043783          	ld	a5,-128(s0)
    190a:	f8f43823          	sd	a5,-112(s0)
    190e:	4701                	li	a4,0
    1910:	f8843703          	ld	a4,-120(s0)
    1914:	4781                	li	a5,0
    1916:	f9043783          	ld	a5,-112(s0)
    191a:	893a                	mv	s2,a4
    191c:	89be                	mv	s3,a5
    191e:	874a                	mv	a4,s2
    1920:	87ce                	mv	a5,s3

...
wc(int fd, char *name)
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    for(i=0; i<n; i++){
      ...
      40:	83c70713          	addi	a4,a4,-1988 # 1878 <buf>
      ...
      64:	81870713          	addi	a4,a4,-2024 # 1878 <buf>
      68:	fec42783          	lw	a5,-20(s0)
      6c:	97ba                	add	a5,a5,a4
      6e:	0007c783          	lbu	a5,0(a5)
      72:	85be                	mv	a1,a5
      74:	00001517          	auipc	a0,0x1
      78:	79c50513          	addi	a0,a0,1948 # 1810 <schedule_dm+0x20e>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
      ...
      cc:	7b058593          	addi	a1,a1,1968 # 1878 <buf>
      d0:	853e                	mv	a0,a5
  ...
  if(n < 0){
    ...
    printf("wc: read error\n");
      ...
      f8:	72450513          	addi	a0,a0,1828 # 1818 <schedule_dm+0x216>
  ...
  printf("%d %d %d %s\n", l, w, c, name);
     ...
     124:	70850513          	addi	a0,a0,1800 # 1828 <schedule_dm+0x226>
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    wc(0, "");
     ...
     15e:	6de58593          	addi	a1,a1,1758 # 1838 <schedule_dm+0x236>
     162:	4501                	li	a0,0
  ...
  for(i = 1; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     1bc:	68850513          	addi	a0,a0,1672 # 1840 <schedule_dm+0x23e>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     81a:	04a68693          	addi	a3,a3,74 # 1860 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     8f4:	f7070713          	addi	a4,a4,-144 # 1860 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ab4:	da878793          	addi	a5,a5,-600 # 1858 <schedule_dm+0x256>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     c60:	e2c78793          	addi	a5,a5,-468 # 1a88 <freep>
     c64:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     d58:	d3478793          	addi	a5,a5,-716 # 1a88 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     dda:	cb278793          	addi	a5,a5,-846 # 1a88 <freep>
     dde:	639c                	ld	a5,0(a5)
}
     de0:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     e0c:	c8078793          	addi	a5,a5,-896 # 1a88 <freep>
     e10:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     e20:	c5c78793          	addi	a5,a5,-932 # 1a78 <base>
     e24:	fef43023          	sd	a5,-32(s0)
     e28:	00001797          	auipc	a5,0x1
     e2c:	c6078793          	addi	a5,a5,-928 # 1a88 <freep>
     e30:	fe043703          	ld	a4,-32(s0)
     e34:	e398                	sd	a4,0(a5)
     e36:	00001797          	auipc	a5,0x1
     e3a:	c5278793          	addi	a5,a5,-942 # 1a88 <freep>
     e3e:	6398                	ld	a4,0(a5)
     e40:	00001797          	auipc	a5,0x1
     e44:	c3878793          	addi	a5,a5,-968 # 1a78 <base>
     e48:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     e4a:	00001797          	auipc	a5,0x1
     e4e:	c2e78793          	addi	a5,a5,-978 # 1a78 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     eca:	bc278793          	addi	a5,a5,-1086 # 1a88 <freep>
    ...
    if(p == freep)
     ...
     ee0:	bac78793          	addi	a5,a5,-1108 # 1a88 <freep>
     ee4:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    10b6:	9de78793          	addi	a5,a5,-1570 # 1a90 <last_thread.1226>
    ...
    1112:	98278793          	addi	a5,a5,-1662 # 1a90 <last_thread.1226>
    1116:	639c                	ld	a5,0(a5)
    1118:	c385                	beqz	a5,1138 <schedule_wrr+0xd6>
    111a:	00001797          	auipc	a5,0x1
    111e:	97678793          	addi	a5,a5,-1674 # 1a90 <last_thread.1226>
    ...
    112e:	96678793          	addi	a5,a5,-1690 # 1a90 <last_thread.1226>
    ...
    117e:	91678793          	addi	a5,a5,-1770 # 1a90 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    12b0:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdf78>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    13e2:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdf78>
    ...
    147c:	a00d                	j	149e <schedule_sjf+0x102>
    } else {
    ...
    148c:	57fd                	li	a5,-1
    148e:	00f70563          	beq	a4,a5,1498 <schedule_sjf+0xfc>
    1492:	fb442783          	lw	a5,-76(s0)
    1496:	a011                	j	149a <schedule_sjf+0xfe>
    1498:	4785                	li	a5,1
    149a:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    149e:	f8043783          	ld	a5,-128(s0)
    14a2:	f8f43823          	sd	a5,-112(s0)
    14a6:	f8843783          	ld	a5,-120(s0)
    14aa:	f8f43c23          	sd	a5,-104(s0)
    14ae:	4701                	li	a4,0
    14b0:	f9043703          	ld	a4,-112(s0)
    14b4:	4781                	li	a5,0
    14b6:	f9843783          	ld	a5,-104(s0)
    14ba:	893a                	mv	s2,a4
    14bc:	89be                	mv	s3,a5
    14be:	874a                	mv	a4,s2
    14c0:	87ce                	mv	a5,s3
    ...
    14c2:	853a                	mv	a0,a4
    14c4:	85be                	mv	a1,a5
    14c6:	70e6                	ld	ra,120(sp)
    14c8:	7446                	ld	s0,112(sp)
    14ca:	74a6                	ld	s1,104(sp)
    14cc:	7906                	ld	s2,96(sp)
    14ce:	69e6                	ld	s3,88(sp)
    14d0:	6109                	addi	sp,sp,128
    14d2:	8082                	ret

00000000000014d4 <schedule_lst>:
...
{
    14d4:	7119                	addi	sp,sp,-128
    14d6:	fc86                	sd	ra,120(sp)
    14d8:	f8a2                	sd	s0,112(sp)
    14da:	f4a6                	sd	s1,104(sp)
    14dc:	f0ca                	sd	s2,96(sp)
    14de:	ecce                	sd	s3,88(sp)
    14e0:	0100                	addi	s0,sp,128
    14e2:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the least-slack-time scheduling algorithm
    struct thread *min_slack = NULL;
    14e4:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    14e8:	800007b7          	lui	a5,0x80000
    14ec:	fff7c793          	not	a5,a5
    14f0:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;

    // Find the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    14f4:	649c                	ld	a5,8(s1)
    14f6:	639c                	ld	a5,0(a5)
    14f8:	faf43823          	sd	a5,-80(s0)
    14fc:	fb043783          	ld	a5,-80(s0)
    1500:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdf78>
    1504:	faf43c23          	sd	a5,-72(s0)
    1508:	a8b5                	j	1584 <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    150a:	fb843783          	ld	a5,-72(s0)
    150e:	47f8                	lw	a4,76(a5)
    1510:	409c                	lw	a5,0(s1)
    1512:	40f707bb          	subw	a5,a4,a5
    1516:	0007871b          	sext.w	a4,a5
    151a:	fb843783          	ld	a5,-72(s0)
    151e:	4fbc                	lw	a5,88(a5)
    1520:	40f707bb          	subw	a5,a4,a5
    1524:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    1528:	fc843783          	ld	a5,-56(s0)
    152c:	cb8d                	beqz	a5,155e <schedule_lst+0x8a>
    152e:	fac42703          	lw	a4,-84(s0)
    1532:	fc442783          	lw	a5,-60(s0)
    1536:	2701                	sext.w	a4,a4
    1538:	2781                	sext.w	a5,a5
    153a:	02f74263          	blt	a4,a5,155e <schedule_lst+0x8a>
    153e:	fac42703          	lw	a4,-84(s0)
    1542:	fc442783          	lw	a5,-60(s0)
    1546:	2701                	sext.w	a4,a4
    1548:	2781                	sext.w	a5,a5
    154a:	02f71263          	bne	a4,a5,156e <schedule_lst+0x9a>
    ...
    155a:	00f75a63          	bge	a4,a5,156e <schedule_lst+0x9a>
            min_slack = t;
    155e:	fb843783          	ld	a5,-72(s0)
    1562:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    1566:	fac42783          	lw	a5,-84(s0)
    156a:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    156e:	fb843783          	ld	a5,-72(s0)
    1572:	779c                	ld	a5,40(a5)
    1574:	faf43023          	sd	a5,-96(s0)
    1578:	fa043783          	ld	a5,-96(s0)
    157c:	fd878793          	addi	a5,a5,-40
    1580:	faf43c23          	sd	a5,-72(s0)
    1584:	fb843783          	ld	a5,-72(s0)
    1588:	02878713          	addi	a4,a5,40
    158c:	649c                	ld	a5,8(s1)
    158e:	f6f71ee3          	bne	a4,a5,150a <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    1592:	fc843783          	ld	a5,-56(s0)
    1596:	cf89                	beqz	a5,15b0 <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    1598:	fc843783          	ld	a5,-56(s0)
    159c:	02878793          	addi	a5,a5,40
    15a0:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    15a4:	fc843783          	ld	a5,-56(s0)
    15a8:	4fbc                	lw	a5,88(a5)
    15aa:	f8f42423          	sw	a5,-120(s0)
    15ae:	a839                	j	15cc <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    15b0:	649c                	ld	a5,8(s1)
    15b2:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    15b6:	689c                	ld	a5,16(s1)
    15b8:	4098                	lw	a4,0(s1)
    15ba:	85ba                	mv	a1,a4
    15bc:	853e                	mv	a0,a5
    15be:	00000097          	auipc	ra,0x0
    15c2:	c08080e7          	jalr	-1016(ra) # 11c6 <find_next_release_time>
    15c6:	87aa                	mv	a5,a0
    15c8:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    15cc:	f8043783          	ld	a5,-128(s0)
    15d0:	f8f43823          	sd	a5,-112(s0)
    15d4:	f8843783          	ld	a5,-120(s0)
    15d8:	f8f43c23          	sd	a5,-104(s0)
    15dc:	4701                	li	a4,0
    15de:	f9043703          	ld	a4,-112(s0)
    15e2:	4781                	li	a5,0
    15e4:	f9843783          	ld	a5,-104(s0)
    15e8:	893a                	mv	s2,a4
    15ea:	89be                	mv	s3,a5
    15ec:	874a                	mv	a4,s2
    15ee:	87ce                	mv	a5,s3
    ...
    15f0:	853a                	mv	a0,a4
    15f2:	85be                	mv	a1,a5
    15f4:	70e6                	ld	ra,120(sp)
    15f6:	7446                	ld	s0,112(sp)
    15f8:	74a6                	ld	s1,104(sp)
    15fa:	7906                	ld	s2,96(sp)
    15fc:	69e6                	ld	s3,88(sp)
    15fe:	6109                	addi	sp,sp,128
    1600:	8082                	ret

0000000000001602 <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    1602:	7135                	addi	sp,sp,-160
    1604:	ed06                	sd	ra,152(sp)
    1606:	e922                	sd	s0,144(sp)
    1608:	e526                	sd	s1,136(sp)
    160a:	e14a                	sd	s2,128(sp)
    160c:	fcce                	sd	s3,120(sp)
    160e:	1100                	addi	s0,sp,160
    1610:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    1612:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    1616:	800007b7          	lui	a5,0x80000
    161a:	fff7c793          	not	a5,a5
    161e:	faf42e23          	sw	a5,-68(s0)
    ...
    162e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdf78>
    1632:	fcf43023          	sd	a5,-64(s0)
    1636:	a841                	j	16c6 <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    1638:	fc043783          	ld	a5,-64(s0)
    163c:	43bc                	lw	a5,64(a5)
    163e:	cb95                	beqz	a5,1672 <schedule_dm+0x70>
    1640:	fc043783          	ld	a5,-64(s0)
    1644:	4bbc                	lw	a5,80(a5)
    1646:	873e                	mv	a4,a5
    1648:	57fd                	li	a5,-1
    164a:	02f70463          	beq	a4,a5,1672 <schedule_dm+0x70>
    164e:	fc043783          	ld	a5,-64(s0)
    1652:	4ff8                	lw	a4,92(a5)
    1654:	fbc42783          	lw	a5,-68(s0)
    1658:	2781                	sext.w	a5,a5
    165a:	00f75c63          	bge	a4,a5,1672 <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    165e:	fc043783          	ld	a5,-64(s0)
    1662:	4ffc                	lw	a5,92(a5)
    1664:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    1668:	fc043783          	ld	a5,-64(s0)
    166c:	fcf43423          	sd	a5,-56(s0)
    1670:	a081                	j	16b0 <schedule_dm+0xae>
        } else if (t->is_real_time && t->period != -1 && t->current_deadline == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    1672:	fc043783          	ld	a5,-64(s0)
    1676:	43bc                	lw	a5,64(a5)
    1678:	cf85                	beqz	a5,16b0 <schedule_dm+0xae>
    167a:	fc043783          	ld	a5,-64(s0)
    167e:	4bbc                	lw	a5,80(a5)
    1680:	873e                	mv	a4,a5
    1682:	57fd                	li	a5,-1
    1684:	02f70663          	beq	a4,a5,16b0 <schedule_dm+0xae>
    1688:	fc043783          	ld	a5,-64(s0)
    168c:	4ff8                	lw	a4,92(a5)
    168e:	fbc42783          	lw	a5,-68(s0)
    1692:	2781                	sext.w	a5,a5
    1694:	00e79e63          	bne	a5,a4,16b0 <schedule_dm+0xae>
    1698:	fc043783          	ld	a5,-64(s0)
    169c:	5fd8                	lw	a4,60(a5)
    169e:	fc843783          	ld	a5,-56(s0)
    16a2:	5fdc                	lw	a5,60(a5)
    16a4:	00f75663          	bge	a4,a5,16b0 <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    16a8:	fc043783          	ld	a5,-64(s0)
    16ac:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    16b0:	fc043783          	ld	a5,-64(s0)
    16b4:	779c                	ld	a5,40(a5)
    16b6:	f8f43423          	sd	a5,-120(s0)
    16ba:	f8843783          	ld	a5,-120(s0)
    16be:	fd878793          	addi	a5,a5,-40
    16c2:	fcf43023          	sd	a5,-64(s0)
    16c6:	fc043783          	ld	a5,-64(s0)
    16ca:	02878713          	addi	a4,a5,40
    16ce:	649c                	ld	a5,8(s1)
    16d0:	f6f714e3          	bne	a4,a5,1638 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    16d4:	fc843783          	ld	a5,-56(s0)
    16d8:	c7a5                	beqz	a5,1740 <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    16da:	fc843783          	ld	a5,-56(s0)
    16de:	4ff8                	lw	a4,92(a5)
    16e0:	409c                	lw	a5,0(s1)
    16e2:	40f707bb          	subw	a5,a4,a5
    16e6:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    16ea:	fc843783          	ld	a5,-56(s0)
    16ee:	4fb8                	lw	a4,88(a5)
    16f0:	f9442783          	lw	a5,-108(s0)
    16f4:	2781                	sext.w	a5,a5
    16f6:	00e7db63          	bge	a5,a4,170c <schedule_dm+0x10a>
    ...
    16fa:	fc843783          	ld	a5,-56(s0)
    16fe:	02878793          	addi	a5,a5,40
    1702:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    1706:	f6042823          	sw	zero,-144(s0)
    170a:	a0f1                	j	17d6 <schedule_dm+0x1d4>
        } else {
    ...
    1712:	863e                	mv	a2,a5
    1714:	f9442783          	lw	a5,-108(s0)
    1718:	0007869b          	sext.w	a3,a5
    171c:	0006071b          	sext.w	a4,a2
    1720:	00d75363          	bge	a4,a3,1726 <schedule_dm+0x124>
    1724:	87b2                	mv	a5,a2
    1726:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    172a:	fc843783          	ld	a5,-56(s0)
    172e:	02878793          	addi	a5,a5,40
    1732:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    1736:	f9042783          	lw	a5,-112(s0)
    173a:	f6f42823          	sw	a5,-144(s0)
    173e:	a861                	j	17d6 <schedule_dm+0x1d4>
        }
    } else {
    ...
    1740:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    1744:	649c                	ld	a5,8(s1)
    1746:	639c                	ld	a5,0(a5)
    1748:	faf43023          	sd	a5,-96(s0)
    174c:	fa043783          	ld	a5,-96(s0)
    1750:	fd878793          	addi	a5,a5,-40
    1754:	fcf43023          	sd	a5,-64(s0)
    1758:	a81d                	j	178e <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    175a:	fb043783          	ld	a5,-80(s0)
    175e:	cb89                	beqz	a5,1770 <schedule_dm+0x16e>
    1760:	fc043783          	ld	a5,-64(s0)
    1764:	5fd8                	lw	a4,60(a5)
    1766:	fb043783          	ld	a5,-80(s0)
    176a:	5fdc                	lw	a5,60(a5)
    176c:	00f75663          	bge	a4,a5,1778 <schedule_dm+0x176>
                smallest_id_thread = t;
    1770:	fc043783          	ld	a5,-64(s0)
    1774:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    1778:	fc043783          	ld	a5,-64(s0)
    177c:	779c                	ld	a5,40(a5)
    177e:	f8f43c23          	sd	a5,-104(s0)
    1782:	f9843783          	ld	a5,-104(s0)
    1786:	fd878793          	addi	a5,a5,-40
    178a:	fcf43023          	sd	a5,-64(s0)
    178e:	fc043783          	ld	a5,-64(s0)
    1792:	02878713          	addi	a4,a5,40
    1796:	649c                	ld	a5,8(s1)
    1798:	fcf711e3          	bne	a4,a5,175a <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    179c:	fb043783          	ld	a5,-80(s0)
    17a0:	cf89                	beqz	a5,17ba <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    17a2:	fb043783          	ld	a5,-80(s0)
    17a6:	02878793          	addi	a5,a5,40
    17aa:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    17ae:	fb043783          	ld	a5,-80(s0)
    17b2:	4fbc                	lw	a5,88(a5)
    17b4:	f6f42823          	sw	a5,-144(s0)
    17b8:	a839                	j	17d6 <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    17ba:	649c                	ld	a5,8(s1)
    17bc:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    17c0:	689c                	ld	a5,16(s1)
    17c2:	4098                	lw	a4,0(s1)
    17c4:	85ba                	mv	a1,a4
    17c6:	853e                	mv	a0,a5
    17c8:	00000097          	auipc	ra,0x0
    17cc:	9fe080e7          	jalr	-1538(ra) # 11c6 <find_next_release_time>
    17d0:	87aa                	mv	a5,a0
    17d2:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    17d6:	f6843783          	ld	a5,-152(s0)
    17da:	f6f43c23          	sd	a5,-136(s0)
    17de:	f7043783          	ld	a5,-144(s0)
    17e2:	f8f43023          	sd	a5,-128(s0)
    17e6:	4701                	li	a4,0
    17e8:	f7843703          	ld	a4,-136(s0)
    17ec:	4781                	li	a5,0
    17ee:	f8043783          	ld	a5,-128(s0)
    17f2:	893a                	mv	s2,a4
    17f4:	89be                	mv	s3,a5
    17f6:	874a                	mv	a4,s2
    17f8:	87ce                	mv	a5,s3
    ...
    17fa:	853a                	mv	a0,a4
    17fc:	85be                	mv	a1,a5
    17fe:	60ea                	ld	ra,152(sp)
    1800:	644a                	ld	s0,144(sp)
    1802:	64aa                	ld	s1,136(sp)
    1804:	690a                	ld	s2,128(sp)
    1806:	79e6                	ld	s3,120(sp)
    1808:	610d                	addi	sp,sp,160
    180a:	8082                	ret

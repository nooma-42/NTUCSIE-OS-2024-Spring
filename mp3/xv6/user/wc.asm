...
wc(int fd, char *name)
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    for(i=0; i<n; i++){
      ...
      40:	70470713          	addi	a4,a4,1796 # 1740 <buf>
      ...
      64:	6e070713          	addi	a4,a4,1760 # 1740 <buf>
      68:	fec42783          	lw	a5,-20(s0)
      6c:	97ba                	add	a5,a5,a4
      6e:	0007c783          	lbu	a5,0(a5)
      72:	85be                	mv	a1,a5
      74:	00001517          	auipc	a0,0x1
      78:	63c50513          	addi	a0,a0,1596 # 16b0 <schedule_dm+0x210>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
      ...
      cc:	67858593          	addi	a1,a1,1656 # 1740 <buf>
      d0:	853e                	mv	a0,a5
  ...
  if(n < 0){
    ...
    printf("wc: read error\n");
      ...
      f8:	5c450513          	addi	a0,a0,1476 # 16b8 <schedule_dm+0x218>
  ...
  printf("%d %d %d %s\n", l, w, c, name);
     ...
     124:	5a850513          	addi	a0,a0,1448 # 16c8 <schedule_dm+0x228>
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    wc(0, "");
     ...
     15e:	57e58593          	addi	a1,a1,1406 # 16d8 <schedule_dm+0x238>
     162:	4501                	li	a0,0
  ...
  for(i = 1; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     1bc:	52850513          	addi	a0,a0,1320 # 16e0 <schedule_dm+0x240>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     81a:	f1268693          	addi	a3,a3,-238 # 1728 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     8f4:	e3870713          	addi	a4,a4,-456 # 1728 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ab4:	c4878793          	addi	a5,a5,-952 # 16f8 <schedule_dm+0x258>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     c60:	cf478793          	addi	a5,a5,-780 # 1950 <freep>
     c64:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     d58:	bfc78793          	addi	a5,a5,-1028 # 1950 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     dda:	b7a78793          	addi	a5,a5,-1158 # 1950 <freep>
     dde:	639c                	ld	a5,0(a5)
}
     de0:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     e0c:	b4878793          	addi	a5,a5,-1208 # 1950 <freep>
     e10:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     e20:	b2478793          	addi	a5,a5,-1244 # 1940 <base>
     e24:	fef43023          	sd	a5,-32(s0)
     e28:	00001797          	auipc	a5,0x1
     e2c:	b2878793          	addi	a5,a5,-1240 # 1950 <freep>
     e30:	fe043703          	ld	a4,-32(s0)
     e34:	e398                	sd	a4,0(a5)
     e36:	00001797          	auipc	a5,0x1
     e3a:	b1a78793          	addi	a5,a5,-1254 # 1950 <freep>
     e3e:	6398                	ld	a4,0(a5)
     e40:	00001797          	auipc	a5,0x1
     e44:	b0078793          	addi	a5,a5,-1280 # 1940 <base>
     e48:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     e4a:	00001797          	auipc	a5,0x1
     e4e:	af678793          	addi	a5,a5,-1290 # 1940 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     eca:	a8a78793          	addi	a5,a5,-1398 # 1950 <freep>
    ...
    if(p == freep)
     ...
     ee0:	a7478793          	addi	a5,a5,-1420 # 1950 <freep>
     ee4:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    10b6:	8a678793          	addi	a5,a5,-1882 # 1958 <last_thread.1226>
    ...
    1112:	84a78793          	addi	a5,a5,-1974 # 1958 <last_thread.1226>
    1116:	639c                	ld	a5,0(a5)
    1118:	c385                	beqz	a5,1138 <schedule_wrr+0xd6>
    111a:	00001797          	auipc	a5,0x1
    111e:	83e78793          	addi	a5,a5,-1986 # 1958 <last_thread.1226>
    ...
    112e:	82e78793          	addi	a5,a5,-2002 # 1958 <last_thread.1226>
    ...
    117e:	7de78793          	addi	a5,a5,2014 # 1958 <last_thread.1226>
...
00000000000011c6 <schedule_sjf>:

struct threads_sched_result schedule_sjf(struct threads_sched_args args)
{
    11c6:	7119                	addi	sp,sp,-128
    11c8:	fc86                	sd	ra,120(sp)
    11ca:	f8a2                	sd	s0,112(sp)
    11cc:	f4a6                	sd	s1,104(sp)
    ...
    125e:	f8f71fe3          	bne	a4,a5,11fc <schedule_sjf+0x36>
        }
    }

    if (shortest_job) {
    1262:	fc843783          	ld	a5,-56(s0)
    1266:	cf89                	beqz	a5,1280 <schedule_sjf+0xba>
        r.scheduled_thread_list_member = &shortest_job->thread_list;
    1268:	fc843783          	ld	a5,-56(s0)
    ...
    1274:	fc843783          	ld	a5,-56(s0)
    1278:	4fbc                	lw	a5,88(a5)
    127a:	f8f42823          	sw	a5,-112(s0)
    127e:	a039                	j	128c <schedule_sjf+0xc6>
    } else {
        // If no threads are ready, find the next release time or idle
        r.scheduled_thread_list_member = args.run_queue;
    1280:	649c                	ld	a5,8(s1)
    1282:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;  // Default minimal quantum if unsure
    1286:	4785                	li	a5,1
    1288:	f8f42823          	sw	a5,-112(s0)
    }
    return r;
    128c:	f8843783          	ld	a5,-120(s0)
    1290:	f8f43c23          	sd	a5,-104(s0)
    1294:	f9043783          	ld	a5,-112(s0)
    1298:	faf43023          	sd	a5,-96(s0)
    129c:	4701                	li	a4,0
    129e:	f9843703          	ld	a4,-104(s0)
    12a2:	4781                	li	a5,0
...
00000000000012c2 <find_next_release_time>:

int find_next_release_time(struct list_head *release_queue, int current_time) {
    12c2:	7139                	addi	sp,sp,-64
    12c4:	fc22                	sd	s0,56(sp)
    12c6:	0080                	addi	s0,sp,64
    12c8:	fca43423          	sd	a0,-56(s0)
    12cc:	87ae                	mv	a5,a1
    12ce:	fcf42223          	sw	a5,-60(s0)
    struct release_queue_entry *next_release = NULL;
    12d2:	fe043423          	sd	zero,-24(s0)
    int next_release_time = INT_MAX;
    12d6:	800007b7          	lui	a5,0x80000
    12da:	fff7c793          	not	a5,a5
    12de:	fef42223          	sw	a5,-28(s0)

    list_for_each_entry(next_release, release_queue, thread_list) {
    12e2:	fc843783          	ld	a5,-56(s0)
    12e6:	639c                	ld	a5,0(a5)
    12e8:	fcf43c23          	sd	a5,-40(s0)
    12ec:	fd843783          	ld	a5,-40(s0)
    12f0:	17e1                	addi	a5,a5,-8
    12f2:	fef43423          	sd	a5,-24(s0)
    12f6:	a081                	j	1336 <find_next_release_time+0x74>
        if (next_release->release_time > current_time &&
    12f8:	fe843783          	ld	a5,-24(s0)
    12fc:	4f98                	lw	a4,24(a5)
    12fe:	fc442783          	lw	a5,-60(s0)
    1302:	2781                	sext.w	a5,a5
    1304:	00e7df63          	bge	a5,a4,1322 <find_next_release_time+0x60>
            next_release->release_time < next_release_time) {
    1308:	fe843783          	ld	a5,-24(s0)
    130c:	4f98                	lw	a4,24(a5)
        if (next_release->release_time > current_time &&
    130e:	fe442783          	lw	a5,-28(s0)
    1312:	2781                	sext.w	a5,a5
    1314:	00f75763          	bge	a4,a5,1322 <find_next_release_time+0x60>
            next_release_time = next_release->release_time;
    1318:	fe843783          	ld	a5,-24(s0)
    131c:	4f9c                	lw	a5,24(a5)
    131e:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(next_release, release_queue, thread_list) {
    1322:	fe843783          	ld	a5,-24(s0)
    1326:	679c                	ld	a5,8(a5)
    1328:	fcf43823          	sd	a5,-48(s0)
    132c:	fd043783          	ld	a5,-48(s0)
    1330:	17e1                	addi	a5,a5,-8
    1332:	fef43423          	sd	a5,-24(s0)
    1336:	fe843783          	ld	a5,-24(s0)
    133a:	07a1                	addi	a5,a5,8
    133c:	fc843703          	ld	a4,-56(s0)
    1340:	faf71ce3          	bne	a4,a5,12f8 <find_next_release_time+0x36>
        }
    }

    if (next_release_time == INT_MAX)
    1344:	fe442783          	lw	a5,-28(s0)
    1348:	0007871b          	sext.w	a4,a5
    134c:	800007b7          	lui	a5,0x80000
    1350:	fff7c793          	not	a5,a5
    1354:	00f71463          	bne	a4,a5,135c <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    1358:	57fd                	li	a5,-1
    135a:	a801                	j	136a <find_next_release_time+0xa8>

    return next_release_time - current_time;
    135c:	fe442703          	lw	a4,-28(s0)
    1360:	fc442783          	lw	a5,-60(s0)
    1364:	40f707bb          	subw	a5,a4,a5
    1368:	2781                	sext.w	a5,a5
}
    136a:	853e                	mv	a0,a5
    136c:	7462                	ld	s0,56(sp)
    136e:	6121                	addi	sp,sp,64
    1370:	8082                	ret

0000000000001372 <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args)
{
    1372:	7119                	addi	sp,sp,-128
    ...
    1386:	800007b7          	lui	a5,0x80000
    138a:	fff7c793          	not	a5,a5
    138e:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    ...
    139e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe0b0>
    13a2:	faf43c23          	sd	a5,-72(s0)
    13a6:	a8b5                	j	1422 <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    13a8:	fb843783          	ld	a5,-72(s0)
    13ac:	47f8                	lw	a4,76(a5)
    13ae:	409c                	lw	a5,0(s1)
    13b0:	40f707bb          	subw	a5,a4,a5
    13b4:	0007871b          	sext.w	a4,a5
    13b8:	fb843783          	ld	a5,-72(s0)
    13bc:	4fbc                	lw	a5,88(a5)
    13be:	40f707bb          	subw	a5,a4,a5
    13c2:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    13c6:	fc843783          	ld	a5,-56(s0)
    13ca:	cb8d                	beqz	a5,13fc <schedule_lst+0x8a>
    13cc:	fac42703          	lw	a4,-84(s0)
    13d0:	fc442783          	lw	a5,-60(s0)
    13d4:	2701                	sext.w	a4,a4
    13d6:	2781                	sext.w	a5,a5
    13d8:	02f74263          	blt	a4,a5,13fc <schedule_lst+0x8a>
    13dc:	fac42703          	lw	a4,-84(s0)
    13e0:	fc442783          	lw	a5,-60(s0)
    13e4:	2701                	sext.w	a4,a4
    13e6:	2781                	sext.w	a5,a5
    13e8:	02f71263          	bne	a4,a5,140c <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    13ec:	fb843783          	ld	a5,-72(s0)
    13f0:	5fd8                	lw	a4,60(a5)
    13f2:	fc843783          	ld	a5,-56(s0)
    13f6:	5fdc                	lw	a5,60(a5)
    13f8:	00f75a63          	bge	a4,a5,140c <schedule_lst+0x9a>
            min_slack = t;
    13fc:	fb843783          	ld	a5,-72(s0)
    1400:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    1404:	fac42783          	lw	a5,-84(s0)
    1408:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    140c:	fb843783          	ld	a5,-72(s0)
    1410:	779c                	ld	a5,40(a5)
    1412:	faf43023          	sd	a5,-96(s0)
    1416:	fa043783          	ld	a5,-96(s0)
    141a:	fd878793          	addi	a5,a5,-40
    141e:	faf43c23          	sd	a5,-72(s0)
    1422:	fb843783          	ld	a5,-72(s0)
    1426:	02878713          	addi	a4,a5,40
    142a:	649c                	ld	a5,8(s1)
    142c:	f6f71ee3          	bne	a4,a5,13a8 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    1430:	fc843783          	ld	a5,-56(s0)
    1434:	cf89                	beqz	a5,144e <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    1436:	fc843783          	ld	a5,-56(s0)
    143a:	02878793          	addi	a5,a5,40
    143e:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    1442:	fc843783          	ld	a5,-56(s0)
    1446:	4fbc                	lw	a5,88(a5)
    1448:	f8f42423          	sw	a5,-120(s0)
    144c:	a839                	j	146a <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    144e:	649c                	ld	a5,8(s1)
    1450:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1454:	689c                	ld	a5,16(s1)
    1456:	4098                	lw	a4,0(s1)
    1458:	85ba                	mv	a1,a4
    145a:	853e                	mv	a0,a5
    145c:	00000097          	auipc	ra,0x0
    1460:	e66080e7          	jalr	-410(ra) # 12c2 <find_next_release_time>
    1464:	87aa                	mv	a5,a0
    1466:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    146a:	f8043783          	ld	a5,-128(s0)
    146e:	f8f43823          	sd	a5,-112(s0)
    1472:	f8843783          	ld	a5,-120(s0)
    1476:	f8f43c23          	sd	a5,-104(s0)
    147a:	4701                	li	a4,0
    147c:	f9043703          	ld	a4,-112(s0)
    1480:	4781                	li	a5,0
    1482:	f9843783          	ld	a5,-104(s0)
    1486:	893a                	mv	s2,a4
    1488:	89be                	mv	s3,a5
    148a:	874a                	mv	a4,s2
    148c:	87ce                	mv	a5,s3
    ...
    148e:	853a                	mv	a0,a4
    1490:	85be                	mv	a1,a5
    1492:	70e6                	ld	ra,120(sp)
    1494:	7446                	ld	s0,112(sp)
    1496:	74a6                	ld	s1,104(sp)
    1498:	7906                	ld	s2,96(sp)
    149a:	69e6                	ld	s3,88(sp)
    149c:	6109                	addi	sp,sp,128
    149e:	8082                	ret

00000000000014a0 <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    14a0:	7135                	addi	sp,sp,-160
    14a2:	ed06                	sd	ra,152(sp)
    14a4:	e922                	sd	s0,144(sp)
    14a6:	e526                	sd	s1,136(sp)
    14a8:	e14a                	sd	s2,128(sp)
    14aa:	fcce                	sd	s3,120(sp)
    14ac:	1100                	addi	s0,sp,160
    14ae:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    14b0:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    14b4:	800007b7          	lui	a5,0x80000
    14b8:	fff7c793          	not	a5,a5
    14bc:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    14c0:	649c                	ld	a5,8(s1)
    14c2:	639c                	ld	a5,0(a5)
    14c4:	faf43423          	sd	a5,-88(s0)
    14c8:	fa843783          	ld	a5,-88(s0)
    14cc:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe0b0>
    14d0:	fcf43023          	sd	a5,-64(s0)
    14d4:	a841                	j	1564 <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    14d6:	fc043783          	ld	a5,-64(s0)
    14da:	43bc                	lw	a5,64(a5)
    14dc:	cb95                	beqz	a5,1510 <schedule_dm+0x70>
    14de:	fc043783          	ld	a5,-64(s0)
    14e2:	4bbc                	lw	a5,80(a5)
    14e4:	873e                	mv	a4,a5
    14e6:	57fd                	li	a5,-1
    14e8:	02f70463          	beq	a4,a5,1510 <schedule_dm+0x70>
    14ec:	fc043783          	ld	a5,-64(s0)
    14f0:	4ff8                	lw	a4,92(a5)
    14f2:	fbc42783          	lw	a5,-68(s0)
    14f6:	2781                	sext.w	a5,a5
    14f8:	00f75c63          	bge	a4,a5,1510 <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    14fc:	fc043783          	ld	a5,-64(s0)
    1500:	4ffc                	lw	a5,92(a5)
    1502:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    1506:	fc043783          	ld	a5,-64(s0)
    150a:	fcf43423          	sd	a5,-56(s0)
    150e:	a081                	j	154e <schedule_dm+0xae>
    ...
    1514:	43bc                	lw	a5,64(a5)
    1516:	cf85                	beqz	a5,154e <schedule_dm+0xae>
    1518:	fc043783          	ld	a5,-64(s0)
    151c:	4bbc                	lw	a5,80(a5)
    151e:	873e                	mv	a4,a5
    1520:	57fd                	li	a5,-1
    1522:	02f70663          	beq	a4,a5,154e <schedule_dm+0xae>
    1526:	fc043783          	ld	a5,-64(s0)
    152a:	4ff8                	lw	a4,92(a5)
    152c:	fbc42783          	lw	a5,-68(s0)
    1530:	2781                	sext.w	a5,a5
    1532:	00e79e63          	bne	a5,a4,154e <schedule_dm+0xae>
    1536:	fc043783          	ld	a5,-64(s0)
    153a:	5fd8                	lw	a4,60(a5)
    153c:	fc843783          	ld	a5,-56(s0)
    1540:	5fdc                	lw	a5,60(a5)
    1542:	00f75663          	bge	a4,a5,154e <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    1546:	fc043783          	ld	a5,-64(s0)
    154a:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    154e:	fc043783          	ld	a5,-64(s0)
    1552:	779c                	ld	a5,40(a5)
    1554:	f8f43423          	sd	a5,-120(s0)
    1558:	f8843783          	ld	a5,-120(s0)
    155c:	fd878793          	addi	a5,a5,-40
    1560:	fcf43023          	sd	a5,-64(s0)
    1564:	fc043783          	ld	a5,-64(s0)
    1568:	02878713          	addi	a4,a5,40
    156c:	649c                	ld	a5,8(s1)
    156e:	f6f714e3          	bne	a4,a5,14d6 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    1572:	fc843783          	ld	a5,-56(s0)
    1576:	c7a5                	beqz	a5,15de <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    1578:	fc843783          	ld	a5,-56(s0)
    157c:	4ff8                	lw	a4,92(a5)
    157e:	409c                	lw	a5,0(s1)
    1580:	40f707bb          	subw	a5,a4,a5
    1584:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    1588:	fc843783          	ld	a5,-56(s0)
    158c:	4fb8                	lw	a4,88(a5)
    158e:	f9442783          	lw	a5,-108(s0)
    1592:	2781                	sext.w	a5,a5
    1594:	00e7db63          	bge	a5,a4,15aa <schedule_dm+0x10a>
    ...
    15a0:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    15a4:	f6042823          	sw	zero,-144(s0)
    15a8:	a0f1                	j	1674 <schedule_dm+0x1d4>
        } else {
    ...
    15b0:	863e                	mv	a2,a5
    15b2:	f9442783          	lw	a5,-108(s0)
    15b6:	0007869b          	sext.w	a3,a5
    15ba:	0006071b          	sext.w	a4,a2
    15be:	00d75363          	bge	a4,a3,15c4 <schedule_dm+0x124>
    15c2:	87b2                	mv	a5,a2
    15c4:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    15c8:	fc843783          	ld	a5,-56(s0)
    15cc:	02878793          	addi	a5,a5,40
    15d0:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    15d4:	f9042783          	lw	a5,-112(s0)
    15d8:	f6f42823          	sw	a5,-144(s0)
    15dc:	a861                	j	1674 <schedule_dm+0x1d4>
        }
    } else {
    ...
    15de:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    15e2:	649c                	ld	a5,8(s1)
    15e4:	639c                	ld	a5,0(a5)
    15e6:	faf43023          	sd	a5,-96(s0)
    15ea:	fa043783          	ld	a5,-96(s0)
    15ee:	fd878793          	addi	a5,a5,-40
    15f2:	fcf43023          	sd	a5,-64(s0)
    15f6:	a81d                	j	162c <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    15f8:	fb043783          	ld	a5,-80(s0)
    15fc:	cb89                	beqz	a5,160e <schedule_dm+0x16e>
    15fe:	fc043783          	ld	a5,-64(s0)
    1602:	5fd8                	lw	a4,60(a5)
    1604:	fb043783          	ld	a5,-80(s0)
    1608:	5fdc                	lw	a5,60(a5)
    160a:	00f75663          	bge	a4,a5,1616 <schedule_dm+0x176>
                smallest_id_thread = t;
    160e:	fc043783          	ld	a5,-64(s0)
    1612:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    1616:	fc043783          	ld	a5,-64(s0)
    161a:	779c                	ld	a5,40(a5)
    161c:	f8f43c23          	sd	a5,-104(s0)
    1620:	f9843783          	ld	a5,-104(s0)
    1624:	fd878793          	addi	a5,a5,-40
    1628:	fcf43023          	sd	a5,-64(s0)
    162c:	fc043783          	ld	a5,-64(s0)
    1630:	02878713          	addi	a4,a5,40
    1634:	649c                	ld	a5,8(s1)
    1636:	fcf711e3          	bne	a4,a5,15f8 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    163a:	fb043783          	ld	a5,-80(s0)
    163e:	cf89                	beqz	a5,1658 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    1640:	fb043783          	ld	a5,-80(s0)
    1644:	02878793          	addi	a5,a5,40
    1648:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    164c:	fb043783          	ld	a5,-80(s0)
    1650:	4fbc                	lw	a5,88(a5)
    1652:	f6f42823          	sw	a5,-144(s0)
    1656:	a839                	j	1674 <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    1658:	649c                	ld	a5,8(s1)
    165a:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    165e:	689c                	ld	a5,16(s1)
    1660:	4098                	lw	a4,0(s1)
    1662:	85ba                	mv	a1,a4
    1664:	853e                	mv	a0,a5
    1666:	00000097          	auipc	ra,0x0
    166a:	c5c080e7          	jalr	-932(ra) # 12c2 <find_next_release_time>
    166e:	87aa                	mv	a5,a0
    1670:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    1674:	f6843783          	ld	a5,-152(s0)
    1678:	f6f43c23          	sd	a5,-136(s0)
    167c:	f7043783          	ld	a5,-144(s0)
    1680:	f8f43023          	sd	a5,-128(s0)
    1684:	4701                	li	a4,0
    1686:	f7843703          	ld	a4,-136(s0)
    168a:	4781                	li	a5,0
    168c:	f8043783          	ld	a5,-128(s0)
    1690:	893a                	mv	s2,a4
    1692:	89be                	mv	s3,a5
    1694:	874a                	mv	a4,s2
    1696:	87ce                	mv	a5,s3
    ...
    1698:	853a                	mv	a0,a4
    169a:	85be                	mv	a1,a5
    169c:	60ea                	ld	ra,152(sp)
    169e:	644a                	ld	s0,144(sp)
    16a0:	64aa                	ld	s1,136(sp)
    16a2:	690a                	ld	s2,128(sp)
    16a4:	79e6                	ld	s3,120(sp)
    16a6:	610d                	addi	sp,sp,160
    16a8:	8082                	ret

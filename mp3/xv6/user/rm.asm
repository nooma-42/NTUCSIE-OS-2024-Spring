...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    fprintf(2, "Usage: rm files...\n");
      ...
      24:	51858593          	addi	a1,a1,1304 # 1538 <schedule_dm+0x210>
      28:	4509                	li	a0,2
  ...
  for(i = 1; i < argc; i++){
    ...
    if(unlink(argv[i]) < 0){
      ...
      76:	4de58593          	addi	a1,a1,1246 # 1550 <schedule_dm+0x228>
      7a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6a2:	f0268693          	addi	a3,a3,-254 # 15a0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     77c:	e2870713          	addi	a4,a4,-472 # 15a0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     93c:	c3878793          	addi	a5,a5,-968 # 1570 <schedule_dm+0x248>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     ae8:	ae478793          	addi	a5,a5,-1308 # 15c8 <freep>
     aec:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     be0:	9ec78793          	addi	a5,a5,-1556 # 15c8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c62:	96a78793          	addi	a5,a5,-1686 # 15c8 <freep>
     c66:	639c                	ld	a5,0(a5)
}
     c68:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c94:	93878793          	addi	a5,a5,-1736 # 15c8 <freep>
     c98:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     ca8:	91478793          	addi	a5,a5,-1772 # 15b8 <base>
     cac:	fef43023          	sd	a5,-32(s0)
     cb0:	00001797          	auipc	a5,0x1
     cb4:	91878793          	addi	a5,a5,-1768 # 15c8 <freep>
     cb8:	fe043703          	ld	a4,-32(s0)
     cbc:	e398                	sd	a4,0(a5)
     cbe:	00001797          	auipc	a5,0x1
     cc2:	90a78793          	addi	a5,a5,-1782 # 15c8 <freep>
     cc6:	6398                	ld	a4,0(a5)
     cc8:	00001797          	auipc	a5,0x1
     ccc:	8f078793          	addi	a5,a5,-1808 # 15b8 <base>
     cd0:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     cd2:	00001797          	auipc	a5,0x1
     cd6:	8e678793          	addi	a5,a5,-1818 # 15b8 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d52:	87a78793          	addi	a5,a5,-1926 # 15c8 <freep>
    ...
    if(p == freep)
     ...
     d68:	86478793          	addi	a5,a5,-1948 # 15c8 <freep>
     d6c:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     f00:	6d478793          	addi	a5,a5,1748 # 15d0 <last_thread.1226>
     f04:	639c                	ld	a5,0(a5)
     f06:	cb89                	beqz	a5,f18 <schedule_wrr+0x2e>
     f08:	00000797          	auipc	a5,0x0
     f0c:	6c878793          	addi	a5,a5,1736 # 15d0 <last_thread.1226>
     f10:	639c                	ld	a5,0(a5)
     f12:	4fbc                	lw	a5,88(a5)
     f14:	00f04863          	bgtz	a5,f24 <schedule_wrr+0x3a>
        last_thread = NULL;
     f18:	00000797          	auipc	a5,0x0
     f1c:	6b878793          	addi	a5,a5,1720 # 15d0 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     f3e:	69678793          	addi	a5,a5,1686 # 15d0 <last_thread.1226>
     f42:	639c                	ld	a5,0(a5)
    ...
    1006:	5ce78793          	addi	a5,a5,1486 # 15d0 <last_thread.1226>
...
000000000000104e <schedule_sjf>:

struct threads_sched_result schedule_sjf(struct threads_sched_args args)
{
    104e:	7119                	addi	sp,sp,-128
    1050:	fc86                	sd	ra,120(sp)
    1052:	f8a2                	sd	s0,112(sp)
    1054:	f4a6                	sd	s1,104(sp)
    1056:	f0ca                	sd	s2,96(sp)
    1058:	ecce                	sd	s3,88(sp)
    105a:	0100                	addi	s0,sp,128
    105c:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the shortest-job-first scheduling algorithm
    struct thread *shortest_job = NULL;
    105e:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    ...
    106e:	649c                	ld	a5,8(s1)
    1070:	639c                	ld	a5,0(a5)
    1072:	faf43823          	sd	a5,-80(s0)
    1076:	fb043783          	ld	a5,-80(s0)
    107a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe238>
    107e:	fcf43023          	sd	a5,-64(s0)
    1082:	a8a9                	j	10dc <schedule_sjf+0x8e>
        printf("Thread ID: %d, Remaining Time: %d\n", t->ID, t->remaining_time);
    1084:	fc043783          	ld	a5,-64(s0)
    1088:	5fd8                	lw	a4,60(a5)
    108a:	fc043783          	ld	a5,-64(s0)
    108e:	4fbc                	lw	a5,88(a5)
    1090:	863e                	mv	a2,a5
    1092:	85ba                	mv	a1,a4
    1094:	00000517          	auipc	a0,0x0
    1098:	4e450513          	addi	a0,a0,1252 # 1578 <schedule_dm+0x250>
    109c:	00000097          	auipc	ra,0x0
    10a0:	9e4080e7          	jalr	-1564(ra) # a80 <printf>
        if (t->remaining_time < shortest_time) {
    10a4:	fc043783          	ld	a5,-64(s0)
    10a8:	4fb8                	lw	a4,88(a5)
    10aa:	fbc42783          	lw	a5,-68(s0)
    10ae:	2781                	sext.w	a5,a5
    10b0:	00f75b63          	bge	a4,a5,10c6 <schedule_sjf+0x78>
            shortest_time = t->remaining_time;
    10b4:	fc043783          	ld	a5,-64(s0)
    10b8:	4fbc                	lw	a5,88(a5)
    10ba:	faf42e23          	sw	a5,-68(s0)
            shortest_job = t;
    10be:	fc043783          	ld	a5,-64(s0)
    10c2:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    10c6:	fc043783          	ld	a5,-64(s0)
    10ca:	779c                	ld	a5,40(a5)
    10cc:	faf43423          	sd	a5,-88(s0)
    10d0:	fa843783          	ld	a5,-88(s0)
    10d4:	fd878793          	addi	a5,a5,-40
    10d8:	fcf43023          	sd	a5,-64(s0)
    10dc:	fc043783          	ld	a5,-64(s0)
    10e0:	02878713          	addi	a4,a5,40
    10e4:	649c                	ld	a5,8(s1)
    10e6:	f8f71fe3          	bne	a4,a5,1084 <schedule_sjf+0x36>
        }
    }

    if (shortest_job) {
    10ea:	fc843783          	ld	a5,-56(s0)
    10ee:	cf89                	beqz	a5,1108 <schedule_sjf+0xba>
        r.scheduled_thread_list_member = &shortest_job->thread_list;
    10f0:	fc843783          	ld	a5,-56(s0)
    10f4:	02878793          	addi	a5,a5,40
    10f8:	f8f43423          	sd	a5,-120(s0)
    ...
    1102:	f8f42823          	sw	a5,-112(s0)
    1106:	a039                	j	1114 <schedule_sjf+0xc6>
    } else {
    ...
    return r;
    1114:	f8843783          	ld	a5,-120(s0)
    1118:	f8f43c23          	sd	a5,-104(s0)
    111c:	f9043783          	ld	a5,-112(s0)
    1120:	faf43023          	sd	a5,-96(s0)
    1124:	4701                	li	a4,0
    1126:	f9843703          	ld	a4,-104(s0)
    112a:	4781                	li	a5,0
    ...
    1138:	853a                	mv	a0,a4
    113a:	85be                	mv	a1,a5
    113c:	70e6                	ld	ra,120(sp)
    113e:	7446                	ld	s0,112(sp)
    1140:	74a6                	ld	s1,104(sp)
    1142:	7906                	ld	s2,96(sp)
    1144:	69e6                	ld	s3,88(sp)
    1146:	6109                	addi	sp,sp,128
    1148:	8082                	ret

000000000000114a <find_next_release_time>:

int find_next_release_time(struct list_head *release_queue, int current_time) {
    114a:	7139                	addi	sp,sp,-64
    114c:	fc22                	sd	s0,56(sp)
    114e:	0080                	addi	s0,sp,64
    1150:	fca43423          	sd	a0,-56(s0)
    1154:	87ae                	mv	a5,a1
    1156:	fcf42223          	sw	a5,-60(s0)
    struct release_queue_entry *next_release = NULL;
    115a:	fe043423          	sd	zero,-24(s0)
    int next_release_time = INT_MAX;
    115e:	800007b7          	lui	a5,0x80000
    1162:	fff7c793          	not	a5,a5
    1166:	fef42223          	sw	a5,-28(s0)

    list_for_each_entry(next_release, release_queue, thread_list) {
    116a:	fc843783          	ld	a5,-56(s0)
    116e:	639c                	ld	a5,0(a5)
    1170:	fcf43c23          	sd	a5,-40(s0)
    1174:	fd843783          	ld	a5,-40(s0)
    1178:	17e1                	addi	a5,a5,-8
    117a:	fef43423          	sd	a5,-24(s0)
    117e:	a081                	j	11be <find_next_release_time+0x74>
        if (next_release->release_time > current_time &&
    1180:	fe843783          	ld	a5,-24(s0)
    1184:	4f98                	lw	a4,24(a5)
    1186:	fc442783          	lw	a5,-60(s0)
    118a:	2781                	sext.w	a5,a5
    118c:	00e7df63          	bge	a5,a4,11aa <find_next_release_time+0x60>
            next_release->release_time < next_release_time) {
    1190:	fe843783          	ld	a5,-24(s0)
    1194:	4f98                	lw	a4,24(a5)
        if (next_release->release_time > current_time &&
    1196:	fe442783          	lw	a5,-28(s0)
    119a:	2781                	sext.w	a5,a5
    119c:	00f75763          	bge	a4,a5,11aa <find_next_release_time+0x60>
            next_release_time = next_release->release_time;
    11a0:	fe843783          	ld	a5,-24(s0)
    11a4:	4f9c                	lw	a5,24(a5)
    11a6:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(next_release, release_queue, thread_list) {
    11aa:	fe843783          	ld	a5,-24(s0)
    11ae:	679c                	ld	a5,8(a5)
    11b0:	fcf43823          	sd	a5,-48(s0)
    11b4:	fd043783          	ld	a5,-48(s0)
    11b8:	17e1                	addi	a5,a5,-8
    11ba:	fef43423          	sd	a5,-24(s0)
    11be:	fe843783          	ld	a5,-24(s0)
    11c2:	07a1                	addi	a5,a5,8
    11c4:	fc843703          	ld	a4,-56(s0)
    11c8:	faf71ce3          	bne	a4,a5,1180 <find_next_release_time+0x36>
        }
    }
    ...
    11d4:	800007b7          	lui	a5,0x80000
    11d8:	fff7c793          	not	a5,a5
    11dc:	00f71463          	bne	a4,a5,11e4 <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    11e0:	57fd                	li	a5,-1
    11e2:	a801                	j	11f2 <find_next_release_time+0xa8>
    ...
    11f2:	853e                	mv	a0,a5
    11f4:	7462                	ld	s0,56(sp)
    11f6:	6121                	addi	sp,sp,64
    11f8:	8082                	ret

00000000000011fa <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args)
{
    11fa:	7119                	addi	sp,sp,-128
    11fc:	fc86                	sd	ra,120(sp)
    11fe:	f8a2                	sd	s0,112(sp)
    1200:	f4a6                	sd	s1,104(sp)
    1202:	f0ca                	sd	s2,96(sp)
    1204:	ecce                	sd	s3,88(sp)
    1206:	0100                	addi	s0,sp,128
    1208:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the least-slack-time scheduling algorithm
    struct thread *min_slack = NULL;
    120a:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    120e:	800007b7          	lui	a5,0x80000
    1212:	fff7c793          	not	a5,a5
    1216:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    ...
    1226:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe238>
    122a:	faf43c23          	sd	a5,-72(s0)
    122e:	a8b5                	j	12aa <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    1230:	fb843783          	ld	a5,-72(s0)
    1234:	47f8                	lw	a4,76(a5)
    ...
    124a:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    124e:	fc843783          	ld	a5,-56(s0)
    1252:	cb8d                	beqz	a5,1284 <schedule_lst+0x8a>
    1254:	fac42703          	lw	a4,-84(s0)
    1258:	fc442783          	lw	a5,-60(s0)
    125c:	2701                	sext.w	a4,a4
    125e:	2781                	sext.w	a5,a5
    1260:	02f74263          	blt	a4,a5,1284 <schedule_lst+0x8a>
    1264:	fac42703          	lw	a4,-84(s0)
    1268:	fc442783          	lw	a5,-60(s0)
    126c:	2701                	sext.w	a4,a4
    126e:	2781                	sext.w	a5,a5
    1270:	02f71263          	bne	a4,a5,1294 <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    1274:	fb843783          	ld	a5,-72(s0)
    1278:	5fd8                	lw	a4,60(a5)
    127a:	fc843783          	ld	a5,-56(s0)
    127e:	5fdc                	lw	a5,60(a5)
    1280:	00f75a63          	bge	a4,a5,1294 <schedule_lst+0x9a>
            min_slack = t;
    1284:	fb843783          	ld	a5,-72(s0)
    1288:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    128c:	fac42783          	lw	a5,-84(s0)
    1290:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1294:	fb843783          	ld	a5,-72(s0)
    1298:	779c                	ld	a5,40(a5)
    129a:	faf43023          	sd	a5,-96(s0)
    129e:	fa043783          	ld	a5,-96(s0)
    12a2:	fd878793          	addi	a5,a5,-40
    12a6:	faf43c23          	sd	a5,-72(s0)
    12aa:	fb843783          	ld	a5,-72(s0)
    12ae:	02878713          	addi	a4,a5,40
    12b2:	649c                	ld	a5,8(s1)
    12b4:	f6f71ee3          	bne	a4,a5,1230 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    12b8:	fc843783          	ld	a5,-56(s0)
    12bc:	cf89                	beqz	a5,12d6 <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    12be:	fc843783          	ld	a5,-56(s0)
    12c2:	02878793          	addi	a5,a5,40
    12c6:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    12ca:	fc843783          	ld	a5,-56(s0)
    12ce:	4fbc                	lw	a5,88(a5)
    12d0:	f8f42423          	sw	a5,-120(s0)
    12d4:	a839                	j	12f2 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    12d6:	649c                	ld	a5,8(s1)
    12d8:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    12dc:	689c                	ld	a5,16(s1)
    12de:	4098                	lw	a4,0(s1)
    12e0:	85ba                	mv	a1,a4
    12e2:	853e                	mv	a0,a5
    12e4:	00000097          	auipc	ra,0x0
    12e8:	e66080e7          	jalr	-410(ra) # 114a <find_next_release_time>
    12ec:	87aa                	mv	a5,a0
    12ee:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    12f2:	f8043783          	ld	a5,-128(s0)
    12f6:	f8f43823          	sd	a5,-112(s0)
    12fa:	f8843783          	ld	a5,-120(s0)
    12fe:	f8f43c23          	sd	a5,-104(s0)
    1302:	4701                	li	a4,0
    1304:	f9043703          	ld	a4,-112(s0)
    1308:	4781                	li	a5,0
    130a:	f9843783          	ld	a5,-104(s0)
    130e:	893a                	mv	s2,a4
    1310:	89be                	mv	s3,a5
    1312:	874a                	mv	a4,s2
    1314:	87ce                	mv	a5,s3
...
0000000000001328 <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    1328:	7135                	addi	sp,sp,-160
    132a:	ed06                	sd	ra,152(sp)
    132c:	e922                	sd	s0,144(sp)
    132e:	e526                	sd	s1,136(sp)
    1330:	e14a                	sd	s2,128(sp)
    1332:	fcce                	sd	s3,120(sp)
    1334:	1100                	addi	s0,sp,160
    1336:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    1338:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    133c:	800007b7          	lui	a5,0x80000
    1340:	fff7c793          	not	a5,a5
    1344:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    1348:	649c                	ld	a5,8(s1)
    134a:	639c                	ld	a5,0(a5)
    134c:	faf43423          	sd	a5,-88(s0)
    1350:	fa843783          	ld	a5,-88(s0)
    1354:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe238>
    1358:	fcf43023          	sd	a5,-64(s0)
    135c:	a841                	j	13ec <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    135e:	fc043783          	ld	a5,-64(s0)
    1362:	43bc                	lw	a5,64(a5)
    1364:	cb95                	beqz	a5,1398 <schedule_dm+0x70>
    1366:	fc043783          	ld	a5,-64(s0)
    136a:	4bbc                	lw	a5,80(a5)
    136c:	873e                	mv	a4,a5
    136e:	57fd                	li	a5,-1
    1370:	02f70463          	beq	a4,a5,1398 <schedule_dm+0x70>
    1374:	fc043783          	ld	a5,-64(s0)
    1378:	4ff8                	lw	a4,92(a5)
    137a:	fbc42783          	lw	a5,-68(s0)
    137e:	2781                	sext.w	a5,a5
    1380:	00f75c63          	bge	a4,a5,1398 <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    1384:	fc043783          	ld	a5,-64(s0)
    1388:	4ffc                	lw	a5,92(a5)
    138a:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    138e:	fc043783          	ld	a5,-64(s0)
    1392:	fcf43423          	sd	a5,-56(s0)
    1396:	a081                	j	13d6 <schedule_dm+0xae>
    ...
    139c:	43bc                	lw	a5,64(a5)
    139e:	cf85                	beqz	a5,13d6 <schedule_dm+0xae>
    13a0:	fc043783          	ld	a5,-64(s0)
    13a4:	4bbc                	lw	a5,80(a5)
    13a6:	873e                	mv	a4,a5
    13a8:	57fd                	li	a5,-1
    13aa:	02f70663          	beq	a4,a5,13d6 <schedule_dm+0xae>
    13ae:	fc043783          	ld	a5,-64(s0)
    13b2:	4ff8                	lw	a4,92(a5)
    13b4:	fbc42783          	lw	a5,-68(s0)
    13b8:	2781                	sext.w	a5,a5
    13ba:	00e79e63          	bne	a5,a4,13d6 <schedule_dm+0xae>
    13be:	fc043783          	ld	a5,-64(s0)
    13c2:	5fd8                	lw	a4,60(a5)
    13c4:	fc843783          	ld	a5,-56(s0)
    13c8:	5fdc                	lw	a5,60(a5)
    13ca:	00f75663          	bge	a4,a5,13d6 <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    13ce:	fc043783          	ld	a5,-64(s0)
    13d2:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    13d6:	fc043783          	ld	a5,-64(s0)
    13da:	779c                	ld	a5,40(a5)
    13dc:	f8f43423          	sd	a5,-120(s0)
    13e0:	f8843783          	ld	a5,-120(s0)
    13e4:	fd878793          	addi	a5,a5,-40
    13e8:	fcf43023          	sd	a5,-64(s0)
    13ec:	fc043783          	ld	a5,-64(s0)
    13f0:	02878713          	addi	a4,a5,40
    13f4:	649c                	ld	a5,8(s1)
    13f6:	f6f714e3          	bne	a4,a5,135e <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    13fa:	fc843783          	ld	a5,-56(s0)
    13fe:	c7a5                	beqz	a5,1466 <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    1400:	fc843783          	ld	a5,-56(s0)
    1404:	4ff8                	lw	a4,92(a5)
    1406:	409c                	lw	a5,0(s1)
    1408:	40f707bb          	subw	a5,a4,a5
    140c:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    1410:	fc843783          	ld	a5,-56(s0)
    1414:	4fb8                	lw	a4,88(a5)
    1416:	f9442783          	lw	a5,-108(s0)
    141a:	2781                	sext.w	a5,a5
    141c:	00e7db63          	bge	a5,a4,1432 <schedule_dm+0x10a>
    ...
    1428:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    142c:	f6042823          	sw	zero,-144(s0)
    1430:	a0f1                	j	14fc <schedule_dm+0x1d4>
        } else {
    ...
    1436:	4fbc                	lw	a5,88(a5)
    1438:	863e                	mv	a2,a5
    143a:	f9442783          	lw	a5,-108(s0)
    143e:	0007869b          	sext.w	a3,a5
    1442:	0006071b          	sext.w	a4,a2
    1446:	00d75363          	bge	a4,a3,144c <schedule_dm+0x124>
    144a:	87b2                	mv	a5,a2
    144c:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1450:	fc843783          	ld	a5,-56(s0)
    1454:	02878793          	addi	a5,a5,40
    1458:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    145c:	f9042783          	lw	a5,-112(s0)
    1460:	f6f42823          	sw	a5,-144(s0)
    1464:	a861                	j	14fc <schedule_dm+0x1d4>
        }
    } else {
    ...
    14be:	fcf711e3          	bne	a4,a5,1480 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    14c2:	fb043783          	ld	a5,-80(s0)
    14c6:	cf89                	beqz	a5,14e0 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    14c8:	fb043783          	ld	a5,-80(s0)
    14cc:	02878793          	addi	a5,a5,40
    14d0:	f6f43423          	sd	a5,-152(s0)
    ...
    14de:	a839                	j	14fc <schedule_dm+0x1d4>
        } else {
    ...
    14e2:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    14e6:	689c                	ld	a5,16(s1)
    14e8:	4098                	lw	a4,0(s1)
    14ea:	85ba                	mv	a1,a4
    14ec:	853e                	mv	a0,a5
    14ee:	00000097          	auipc	ra,0x0
    14f2:	c5c080e7          	jalr	-932(ra) # 114a <find_next_release_time>
    14f6:	87aa                	mv	a5,a0
    14f8:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    14fc:	f6843783          	ld	a5,-152(s0)
    1500:	f6f43c23          	sd	a5,-136(s0)
    1504:	f7043783          	ld	a5,-144(s0)
    1508:	f8f43023          	sd	a5,-128(s0)
    150c:	4701                	li	a4,0
    150e:	f7843703          	ld	a4,-136(s0)
    1512:	4781                	li	a5,0
    1514:	f8043783          	ld	a5,-128(s0)
    1518:	893a                	mv	s2,a4
    151a:	89be                	mv	s3,a5
    151c:	874a                	mv	a4,s2
    151e:	87ce                	mv	a5,s3

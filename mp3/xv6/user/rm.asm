...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    fprintf(2, "Usage: rm files...\n");
      ...
      24:	8a058593          	addi	a1,a1,-1888 # 18c0 <schedule_dm+0x178>
      28:	4509                	li	a0,2
  ...
  for(i = 1; i < argc; i++){
    ...
    if(unlink(argv[i]) < 0){
      ...
      76:	86658593          	addi	a1,a1,-1946 # 18d8 <schedule_dm+0x190>
      7a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6a2:	26268693          	addi	a3,a3,610 # 1900 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     77c:	18870713          	addi	a4,a4,392 # 1900 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     93c:	fc078793          	addi	a5,a5,-64 # 18f8 <schedule_dm+0x1b0>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     ae8:	e4478793          	addi	a5,a5,-444 # 1928 <freep>
     aec:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     be0:	d4c78793          	addi	a5,a5,-692 # 1928 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c62:	cca78793          	addi	a5,a5,-822 # 1928 <freep>
     c66:	639c                	ld	a5,0(a5)
}
     c68:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c94:	c9878793          	addi	a5,a5,-872 # 1928 <freep>
     c98:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     ca8:	c7478793          	addi	a5,a5,-908 # 1918 <base>
     cac:	fef43023          	sd	a5,-32(s0)
     cb0:	00001797          	auipc	a5,0x1
     cb4:	c7878793          	addi	a5,a5,-904 # 1928 <freep>
     cb8:	fe043703          	ld	a4,-32(s0)
     cbc:	e398                	sd	a4,0(a5)
     cbe:	00001797          	auipc	a5,0x1
     cc2:	c6a78793          	addi	a5,a5,-918 # 1928 <freep>
     cc6:	6398                	ld	a4,0(a5)
     cc8:	00001797          	auipc	a5,0x1
     ccc:	c5078793          	addi	a5,a5,-944 # 1918 <base>
     cd0:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     cd2:	00001797          	auipc	a5,0x1
     cd6:	c4678793          	addi	a5,a5,-954 # 1918 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d52:	bda78793          	addi	a5,a5,-1062 # 1928 <freep>
    ...
    if(p == freep)
     ...
     d68:	bc478793          	addi	a5,a5,-1084 # 1928 <freep>
     d6c:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     f00:	a3478793          	addi	a5,a5,-1484 # 1930 <last_thread.1226>
     f04:	639c                	ld	a5,0(a5)
     f06:	cb89                	beqz	a5,f18 <schedule_wrr+0x2e>
     f08:	00001797          	auipc	a5,0x1
     f0c:	a2878793          	addi	a5,a5,-1496 # 1930 <last_thread.1226>
     f10:	639c                	ld	a5,0(a5)
     f12:	4fbc                	lw	a5,88(a5)
     f14:	00f04863          	bgtz	a5,f24 <schedule_wrr+0x3a>
        last_thread = NULL;
     f18:	00001797          	auipc	a5,0x1
     f1c:	a1878793          	addi	a5,a5,-1512 # 1930 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     f3e:	9f678793          	addi	a5,a5,-1546 # 1930 <last_thread.1226>
     f42:	639c                	ld	a5,0(a5)
    ...
    1006:	92e78793          	addi	a5,a5,-1746 # 1930 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    1138:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffded8>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    126a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffded8>
    ...
    1326:	d2c080e7          	jalr	-724(ra) # 104e <find_next_release_time>
    132a:	87aa                	mv	a5,a0
...
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    ...
    13cc:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffded8>
    ...
    1456:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffded8>
    ...
    155a:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffdf08>
    ...
    1568:	c3b1                	beqz	a5,15ac <schedule_lst+0x20c>
    ...
    1572:	800007b7          	lui	a5,0x80000
    1576:	fff7c793          	not	a5,a5
    157a:	00f71663          	bne	a4,a5,1586 <schedule_lst+0x1e6>
    157e:	fc843783          	ld	a5,-56(s0)
    1582:	4fbc                	lw	a5,88(a5)
    1584:	a039                	j	1592 <schedule_lst+0x1f2>
    1586:	409c                	lw	a5,0(s1)
    1588:	fb442703          	lw	a4,-76(s0)
    158c:	40f707bb          	subw	a5,a4,a5
    1590:	2781                	sext.w	a5,a5
    1592:	f8f42a23          	sw	a5,-108(s0)
        r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    1596:	fc843783          	ld	a5,-56(s0)
    159a:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffdf28>
    159e:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = allocated_time;
    15a2:	f9442783          	lw	a5,-108(s0)
    15a6:	f4f42823          	sw	a5,-176(s0)
    15aa:	a081                	j	15ea <schedule_lst+0x24a>
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    15ac:	649c                	ld	a5,8(s1)
    15ae:	f4f43423          	sd	a5,-184(s0)
    ...
    15b6:	0007871b          	sext.w	a4,a5
    15ba:	800007b7          	lui	a5,0x80000
    15be:	fff7c793          	not	a5,a5
    15c2:	00f70963          	beq	a4,a5,15d4 <schedule_lst+0x234>
    15c6:	409c                	lw	a5,0(s1)
    15c8:	fb442703          	lw	a4,-76(s0)
    15cc:	40f707bb          	subw	a5,a4,a5
    15d0:	2781                	sext.w	a5,a5
    15d2:	a811                	j	15e6 <schedule_lst+0x246>
    15d4:	689c                	ld	a5,16(s1)
    15d6:	4098                	lw	a4,0(s1)
    15d8:	85ba                	mv	a1,a4
    15da:	853e                	mv	a0,a5
    15dc:	00000097          	auipc	ra,0x0
    15e0:	a72080e7          	jalr	-1422(ra) # 104e <find_next_release_time>
    15e4:	87aa                	mv	a5,a0
    15e6:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    15ea:	f4843783          	ld	a5,-184(s0)
    15ee:	f4f43c23          	sd	a5,-168(s0)
    15f2:	f5043783          	ld	a5,-176(s0)
    15f6:	f6f43023          	sd	a5,-160(s0)
    15fa:	4701                	li	a4,0
    15fc:	f5843703          	ld	a4,-168(s0)
    1600:	4781                	li	a5,0
    1602:	f6043783          	ld	a5,-160(s0)
    1606:	893a                	mv	s2,a4
    1608:	89be                	mv	s3,a5
    160a:	874a                	mv	a4,s2
    160c:	87ce                	mv	a5,s3
    ...
    160e:	853a                	mv	a0,a4
    1610:	85be                	mv	a1,a5
    1612:	70ea                	ld	ra,184(sp)
    1614:	744a                	ld	s0,176(sp)
    1616:	74aa                	ld	s1,168(sp)
    1618:	790a                	ld	s2,160(sp)
    161a:	69ea                	ld	s3,152(sp)
    161c:	6129                	addi	sp,sp,192
    161e:	8082                	ret

0000000000001620 <find_earliest_impactful_release_time_dm>:
...
int find_earliest_impactful_release_time_dm(struct list_head *release_queue, int current_time, int current_deadline) {
    ...
    1622:	e4a2                	sd	s0,72(sp)
    1624:	0880                	addi	s0,sp,80
    1626:	faa43c23          	sd	a0,-72(s0)
    162a:	87ae                	mv	a5,a1
    162c:	8732                	mv	a4,a2
    162e:	faf42a23          	sw	a5,-76(s0)
    1632:	87ba                	mv	a5,a4
    1634:	faf42823          	sw	a5,-80(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_event = INT_MAX;
    1638:	800007b7          	lui	a5,0x80000
    163c:	fff7c793          	not	a5,a5
    1640:	fef42223          	sw	a5,-28(s0)
    struct thread *earliest_deadline_thread = NULL;
    1644:	fc043c23          	sd	zero,-40(s0)
    earliest_deadline_thread->ID = INT_MAX;
    1648:	fd843783          	ld	a5,-40(s0)
    164c:	80000737          	lui	a4,0x80000
    1650:	fff74713          	not	a4,a4
    1654:	dfd8                	sw	a4,60(a5)
    ...
    165c:	fcf43823          	sd	a5,-48(s0)
    1660:	fd043783          	ld	a5,-48(s0)
    1664:	17e1                	addi	a5,a5,-8
    1666:	fef43423          	sd	a5,-24(s0)
    166a:	a075                	j	1716 <find_earliest_impactful_release_time_dm+0xf6>
        if (entry->release_time > current_time && entry->thrd->period < current_deadline) {
    166c:	fe843783          	ld	a5,-24(s0)
    1670:	4f98                	lw	a4,24(a5)
    1672:	fb442783          	lw	a5,-76(s0)
    1676:	2781                	sext.w	a5,a5
    1678:	02e7d963          	bge	a5,a4,16aa <find_earliest_impactful_release_time_dm+0x8a>
    167c:	fe843783          	ld	a5,-24(s0)
    1680:	639c                	ld	a5,0(a5)
    1682:	4bb8                	lw	a4,80(a5)
    1684:	fb042783          	lw	a5,-80(s0)
    1688:	2781                	sext.w	a5,a5
    168a:	02f75063          	bge	a4,a5,16aa <find_earliest_impactful_release_time_dm+0x8a>
    ...
    169a:	06f75463          	bge	a4,a5,1702 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    169e:	fe843783          	ld	a5,-24(s0)
    16a2:	4f9c                	lw	a5,24(a5)
    16a4:	fef42223          	sw	a5,-28(s0)
            if (entry->release_time < earliest_impactful_event) {
    16a8:	a8a9                	j	1702 <find_earliest_impactful_release_time_dm+0xe2>
            }
        } 
    ...
    16aa:	fe843783          	ld	a5,-24(s0)
    16ae:	4f98                	lw	a4,24(a5)
    16b0:	fb442783          	lw	a5,-76(s0)
    16b4:	2781                	sext.w	a5,a5
    16b6:	04e7d663          	bge	a5,a4,1702 <find_earliest_impactful_release_time_dm+0xe2>
    16ba:	fe843783          	ld	a5,-24(s0)
    16be:	639c                	ld	a5,0(a5)
    16c0:	4bb8                	lw	a4,80(a5)
    16c2:	fb042783          	lw	a5,-80(s0)
    16c6:	2781                	sext.w	a5,a5
    16c8:	02e79d63          	bne	a5,a4,1702 <find_earliest_impactful_release_time_dm+0xe2>
            if (entry->release_time < earliest_impactful_event && entry->thrd->ID < earliest_deadline_thread->ID) {
    16cc:	fe843783          	ld	a5,-24(s0)
    16d0:	4f98                	lw	a4,24(a5)
    16d2:	fe442783          	lw	a5,-28(s0)
    16d6:	2781                	sext.w	a5,a5
    16d8:	02f75563          	bge	a4,a5,1702 <find_earliest_impactful_release_time_dm+0xe2>
    16dc:	fe843783          	ld	a5,-24(s0)
    16e0:	639c                	ld	a5,0(a5)
    16e2:	5fd8                	lw	a4,60(a5)
    16e4:	fd843783          	ld	a5,-40(s0)
    16e8:	5fdc                	lw	a5,60(a5)
    16ea:	00f75c63          	bge	a4,a5,1702 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    16ee:	fe843783          	ld	a5,-24(s0)
    16f2:	4f9c                	lw	a5,24(a5)
    16f4:	fef42223          	sw	a5,-28(s0)
                earliest_deadline_thread = entry->thrd;
    16f8:	fe843783          	ld	a5,-24(s0)
    16fc:	639c                	ld	a5,0(a5)
    16fe:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    1702:	fe843783          	ld	a5,-24(s0)
    1706:	679c                	ld	a5,8(a5)
    1708:	fcf43423          	sd	a5,-56(s0)
    170c:	fc843783          	ld	a5,-56(s0)
    1710:	17e1                	addi	a5,a5,-8
    1712:	fef43423          	sd	a5,-24(s0)
    1716:	fe843783          	ld	a5,-24(s0)
    171a:	07a1                	addi	a5,a5,8
    171c:	fb843703          	ld	a4,-72(s0)
    1720:	f4f716e3          	bne	a4,a5,166c <find_earliest_impactful_release_time_dm+0x4c>
            }
        }
    }
    ...
    1730:	fff7c793          	not	a5,a5
    1734:	00f70563          	beq	a4,a5,173e <find_earliest_impactful_release_time_dm+0x11e>
    1738:	fe442783          	lw	a5,-28(s0)
    173c:	a011                	j	1740 <find_earliest_impactful_release_time_dm+0x120>
    173e:	57fd                	li	a5,-1
}
    1740:	853e                	mv	a0,a5
    1742:	6426                	ld	s0,72(sp)
    1744:	6161                	addi	sp,sp,80
    1746:	8082                	ret

0000000000001748 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    1748:	7175                	addi	sp,sp,-144
    174a:	e506                	sd	ra,136(sp)
    174c:	e122                	sd	s0,128(sp)
    174e:	fca6                	sd	s1,120(sp)
    1750:	f8ca                	sd	s2,112(sp)
    1752:	f4ce                	sd	s3,104(sp)
    1754:	0900                	addi	s0,sp,144
    1756:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    1758:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    175c:	800007b7          	lui	a5,0x80000
    1760:	fff7c793          	not	a5,a5
    1764:	faf42e23          	sw	a5,-68(s0)

    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    1768:	649c                	ld	a5,8(s1)
    176a:	639c                	ld	a5,0(a5)
    176c:	faf43823          	sd	a5,-80(s0)
    1770:	fb043783          	ld	a5,-80(s0)
    1774:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffded8>
    1778:	fcf43023          	sd	a5,-64(s0)
    177c:	a089                	j	17be <schedule_dm+0x76>
        if (t->is_real_time && t->period < earliest_deadline) {
    177e:	fc043783          	ld	a5,-64(s0)
    1782:	43bc                	lw	a5,64(a5)
    1784:	c395                	beqz	a5,17a8 <schedule_dm+0x60>
    1786:	fc043783          	ld	a5,-64(s0)
    178a:	4bb8                	lw	a4,80(a5)
    178c:	fbc42783          	lw	a5,-68(s0)
    1790:	2781                	sext.w	a5,a5
    1792:	00f75b63          	bge	a4,a5,17a8 <schedule_dm+0x60>
            earliest_deadline_thread = t;
    1796:	fc043783          	ld	a5,-64(s0)
    179a:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    179e:	fc043783          	ld	a5,-64(s0)
    17a2:	4bbc                	lw	a5,80(a5)
    17a4:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    17a8:	fc043783          	ld	a5,-64(s0)
    17ac:	779c                	ld	a5,40(a5)
    17ae:	f8f43c23          	sd	a5,-104(s0)
    17b2:	f9843783          	ld	a5,-104(s0)
    17b6:	fd878793          	addi	a5,a5,-40
    17ba:	fcf43023          	sd	a5,-64(s0)
    17be:	fc043783          	ld	a5,-64(s0)
    17c2:	02878713          	addi	a4,a5,40
    17c6:	649c                	ld	a5,8(s1)
    17c8:	faf71be3          	bne	a4,a5,177e <schedule_dm+0x36>
        }
    }
    ...
    181a:	fac42783          	lw	a5,-84(s0)
    181e:	0007871b          	sext.w	a4,a5
    1822:	57fd                	li	a5,-1
    1824:	02f70563          	beq	a4,a5,184e <schedule_dm+0x106>
    1828:	409c                	lw	a5,0(s1)
    182a:	fac42703          	lw	a4,-84(s0)
    182e:	40f707bb          	subw	a5,a4,a5
    1832:	0007871b          	sext.w	a4,a5
    1836:	fc843783          	ld	a5,-56(s0)
    183a:	4fbc                	lw	a5,88(a5)
    183c:	00f75963          	bge	a4,a5,184e <schedule_dm+0x106>
    1840:	409c                	lw	a5,0(s1)
    1842:	fac42703          	lw	a4,-84(s0)
    1846:	40f707bb          	subw	a5,a4,a5
    184a:	2781                	sext.w	a5,a5
    184c:	a021                	j	1854 <schedule_dm+0x10c>
    184e:	fc843783          	ld	a5,-56(s0)
    1852:	4fbc                	lw	a5,88(a5)
    1854:	faf42223          	sw	a5,-92(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1858:	fc843783          	ld	a5,-56(s0)
    185c:	02878793          	addi	a5,a5,40
    1860:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    1864:	fa442783          	lw	a5,-92(s0)
    1868:	f8f42023          	sw	a5,-128(s0)
    186c:	a839                	j	188a <schedule_dm+0x142>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    186e:	649c                	ld	a5,8(s1)
    ...
    1876:	4098                	lw	a4,0(s1)
    1878:	85ba                	mv	a1,a4
    187a:	853e                	mv	a0,a5
    187c:	fffff097          	auipc	ra,0xfffff
    1880:	7d2080e7          	jalr	2002(ra) # 104e <find_next_release_time>
    1884:	87aa                	mv	a5,a0
    1886:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    188a:	f7843783          	ld	a5,-136(s0)
    188e:	f8f43423          	sd	a5,-120(s0)
    1892:	f8043783          	ld	a5,-128(s0)
    1896:	f8f43823          	sd	a5,-112(s0)
    189a:	4701                	li	a4,0
    189c:	f8843703          	ld	a4,-120(s0)
    18a0:	4781                	li	a5,0
    18a2:	f9043783          	ld	a5,-112(s0)
    18a6:	893a                	mv	s2,a4
    18a8:	89be                	mv	s3,a5
    18aa:	874a                	mv	a4,s2
    18ac:	87ce                	mv	a5,s3
    ...
    18ae:	853a                	mv	a0,a4
    18b0:	85be                	mv	a1,a5
    18b2:	60aa                	ld	ra,136(sp)
    18b4:	640a                	ld	s0,128(sp)
    18b6:	74e6                	ld	s1,120(sp)
    18b8:	7946                	ld	s2,112(sp)
    18ba:	79a6                	ld	s3,104(sp)
    18bc:	6149                	addi	sp,sp,144
    18be:	8082                	ret

...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     66e:	f8e68693          	addi	a3,a3,-114 # 15f8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     748:	eb470713          	addi	a4,a4,-332 # 15f8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     908:	cec78793          	addi	a5,a5,-788 # 15f0 <schedule_dm+0x210>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     ab4:	b7078793          	addi	a5,a5,-1168 # 1620 <freep>
     ab8:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bac:	a7878793          	addi	a5,a5,-1416 # 1620 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c2e:	9f678793          	addi	a5,a5,-1546 # 1620 <freep>
     c32:	639c                	ld	a5,0(a5)
}
     c34:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c60:	9c478793          	addi	a5,a5,-1596 # 1620 <freep>
     c64:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     c74:	9a078793          	addi	a5,a5,-1632 # 1610 <base>
     c78:	fef43023          	sd	a5,-32(s0)
     c7c:	00001797          	auipc	a5,0x1
     c80:	9a478793          	addi	a5,a5,-1628 # 1620 <freep>
     c84:	fe043703          	ld	a4,-32(s0)
     c88:	e398                	sd	a4,0(a5)
     c8a:	00001797          	auipc	a5,0x1
     c8e:	99678793          	addi	a5,a5,-1642 # 1620 <freep>
     c92:	6398                	ld	a4,0(a5)
     c94:	00001797          	auipc	a5,0x1
     c98:	97c78793          	addi	a5,a5,-1668 # 1610 <base>
     c9c:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     c9e:	00001797          	auipc	a5,0x1
     ca2:	97278793          	addi	a5,a5,-1678 # 1610 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d1e:	90678793          	addi	a5,a5,-1786 # 1620 <freep>
    ...
    if(p == freep)
     ...
     d34:	8f078793          	addi	a5,a5,-1808 # 1620 <freep>
     d38:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     e56:	7d678793          	addi	a5,a5,2006 # 1628 <last_thread.1226>
     e5a:	639c                	ld	a5,0(a5)
     e5c:	cb89                	beqz	a5,e6e <schedule_wrr+0x2e>
     e5e:	00000797          	auipc	a5,0x0
     e62:	7ca78793          	addi	a5,a5,1994 # 1628 <last_thread.1226>
     e66:	639c                	ld	a5,0(a5)
     e68:	4fbc                	lw	a5,88(a5)
     e6a:	00f04863          	bgtz	a5,e7a <schedule_wrr+0x3a>
        last_thread = NULL;
     e6e:	00000797          	auipc	a5,0x0
     e72:	7ba78793          	addi	a5,a5,1978 # 1628 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     e94:	79878793          	addi	a5,a5,1944 # 1628 <last_thread.1226>
     e98:	639c                	ld	a5,0(a5)
    ...
    if (selected_thread) {
     ...
     f5c:	6d078793          	addi	a5,a5,1744 # 1628 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    108e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe1e0>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    11c0:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe1e0>
    ...
    125a:	a00d                	j	127c <schedule_sjf+0x102>
    } else {
    ...
    126a:	57fd                	li	a5,-1
    126c:	00f70563          	beq	a4,a5,1276 <schedule_sjf+0xfc>
    1270:	fb442783          	lw	a5,-76(s0)
    1274:	a011                	j	1278 <schedule_sjf+0xfe>
    1276:	4785                	li	a5,1
    1278:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    127c:	f8043783          	ld	a5,-128(s0)
    1280:	f8f43823          	sd	a5,-112(s0)
    1284:	f8843783          	ld	a5,-120(s0)
    1288:	f8f43c23          	sd	a5,-104(s0)
    128c:	4701                	li	a4,0
    128e:	f9043703          	ld	a4,-112(s0)
    1292:	4781                	li	a5,0
    1294:	f9843783          	ld	a5,-104(s0)
    1298:	893a                	mv	s2,a4
    129a:	89be                	mv	s3,a5
    129c:	874a                	mv	a4,s2
    129e:	87ce                	mv	a5,s3
    ...
    12a0:	853a                	mv	a0,a4
    12a2:	85be                	mv	a1,a5
    12a4:	70e6                	ld	ra,120(sp)
    12a6:	7446                	ld	s0,112(sp)
    12a8:	74a6                	ld	s1,104(sp)
    12aa:	7906                	ld	s2,96(sp)
    12ac:	69e6                	ld	s3,88(sp)
    12ae:	6109                	addi	sp,sp,128
    12b0:	8082                	ret

00000000000012b2 <schedule_lst>:
...
{
    12b2:	7119                	addi	sp,sp,-128
    12b4:	fc86                	sd	ra,120(sp)
    12b6:	f8a2                	sd	s0,112(sp)
    12b8:	f4a6                	sd	s1,104(sp)
    ...
    12c2:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    12c6:	800007b7          	lui	a5,0x80000
    12ca:	fff7c793          	not	a5,a5
    ...
    12d6:	faf43823          	sd	a5,-80(s0)
    12da:	fb043783          	ld	a5,-80(s0)
    12de:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe1e0>
    12e2:	faf43c23          	sd	a5,-72(s0)
    12e6:	a8b5                	j	1362 <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    12e8:	fb843783          	ld	a5,-72(s0)
    12ec:	47f8                	lw	a4,76(a5)
    ...
    1302:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    1306:	fc843783          	ld	a5,-56(s0)
    130a:	cb8d                	beqz	a5,133c <schedule_lst+0x8a>
    130c:	fac42703          	lw	a4,-84(s0)
    1310:	fc442783          	lw	a5,-60(s0)
    1314:	2701                	sext.w	a4,a4
    1316:	2781                	sext.w	a5,a5
    1318:	02f74263          	blt	a4,a5,133c <schedule_lst+0x8a>
    131c:	fac42703          	lw	a4,-84(s0)
    1320:	fc442783          	lw	a5,-60(s0)
    1324:	2701                	sext.w	a4,a4
    1326:	2781                	sext.w	a5,a5
    1328:	02f71263          	bne	a4,a5,134c <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    132c:	fb843783          	ld	a5,-72(s0)
    1330:	5fd8                	lw	a4,60(a5)
    1332:	fc843783          	ld	a5,-56(s0)
    1336:	5fdc                	lw	a5,60(a5)
    1338:	00f75a63          	bge	a4,a5,134c <schedule_lst+0x9a>
            min_slack = t;
    133c:	fb843783          	ld	a5,-72(s0)
    1340:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    1344:	fac42783          	lw	a5,-84(s0)
    1348:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    134c:	fb843783          	ld	a5,-72(s0)
    1350:	779c                	ld	a5,40(a5)
    1352:	faf43023          	sd	a5,-96(s0)
    1356:	fa043783          	ld	a5,-96(s0)
    135a:	fd878793          	addi	a5,a5,-40
    135e:	faf43c23          	sd	a5,-72(s0)
    1362:	fb843783          	ld	a5,-72(s0)
    1366:	02878713          	addi	a4,a5,40
    136a:	649c                	ld	a5,8(s1)
    136c:	f6f71ee3          	bne	a4,a5,12e8 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    1370:	fc843783          	ld	a5,-56(s0)
    1374:	cf89                	beqz	a5,138e <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    1376:	fc843783          	ld	a5,-56(s0)
    137a:	02878793          	addi	a5,a5,40
    137e:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    1382:	fc843783          	ld	a5,-56(s0)
    1386:	4fbc                	lw	a5,88(a5)
    1388:	f8f42423          	sw	a5,-120(s0)
    138c:	a839                	j	13aa <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    138e:	649c                	ld	a5,8(s1)
    1390:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1394:	689c                	ld	a5,16(s1)
    1396:	4098                	lw	a4,0(s1)
    1398:	85ba                	mv	a1,a4
    139a:	853e                	mv	a0,a5
    139c:	00000097          	auipc	ra,0x0
    13a0:	c08080e7          	jalr	-1016(ra) # fa4 <find_next_release_time>
    13a4:	87aa                	mv	a5,a0
...
00000000000013e0 <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    13e0:	7135                	addi	sp,sp,-160
    13e2:	ed06                	sd	ra,152(sp)
    13e4:	e922                	sd	s0,144(sp)
    13e6:	e526                	sd	s1,136(sp)
    13e8:	e14a                	sd	s2,128(sp)
    13ea:	fcce                	sd	s3,120(sp)
    13ec:	1100                	addi	s0,sp,160
    13ee:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    13f0:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    13f4:	800007b7          	lui	a5,0x80000
    13f8:	fff7c793          	not	a5,a5
    13fc:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    1400:	649c                	ld	a5,8(s1)
    1402:	639c                	ld	a5,0(a5)
    1404:	faf43423          	sd	a5,-88(s0)
    1408:	fa843783          	ld	a5,-88(s0)
    140c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe1e0>
    1410:	fcf43023          	sd	a5,-64(s0)
    1414:	a841                	j	14a4 <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    1416:	fc043783          	ld	a5,-64(s0)
    141a:	43bc                	lw	a5,64(a5)
    141c:	cb95                	beqz	a5,1450 <schedule_dm+0x70>
    141e:	fc043783          	ld	a5,-64(s0)
    1422:	4bbc                	lw	a5,80(a5)
    1424:	873e                	mv	a4,a5
    1426:	57fd                	li	a5,-1
    1428:	02f70463          	beq	a4,a5,1450 <schedule_dm+0x70>
    142c:	fc043783          	ld	a5,-64(s0)
    1430:	4ff8                	lw	a4,92(a5)
    1432:	fbc42783          	lw	a5,-68(s0)
    1436:	2781                	sext.w	a5,a5
    1438:	00f75c63          	bge	a4,a5,1450 <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    143c:	fc043783          	ld	a5,-64(s0)
    1440:	4ffc                	lw	a5,92(a5)
    1442:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    1446:	fc043783          	ld	a5,-64(s0)
    144a:	fcf43423          	sd	a5,-56(s0)
    144e:	a081                	j	148e <schedule_dm+0xae>
    ...
    14dc:	02878793          	addi	a5,a5,40
    14e0:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    14e4:	f6042823          	sw	zero,-144(s0)
    14e8:	a0f1                	j	15b4 <schedule_dm+0x1d4>
        } else {
    ...
    14f0:	863e                	mv	a2,a5
    14f2:	f9442783          	lw	a5,-108(s0)
    14f6:	0007869b          	sext.w	a3,a5
    14fa:	0006071b          	sext.w	a4,a2
    14fe:	00d75363          	bge	a4,a3,1504 <schedule_dm+0x124>
    1502:	87b2                	mv	a5,a2
    1504:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1508:	fc843783          	ld	a5,-56(s0)
    150c:	02878793          	addi	a5,a5,40
    1510:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    1514:	f9042783          	lw	a5,-112(s0)
    1518:	f6f42823          	sw	a5,-144(s0)
    151c:	a861                	j	15b4 <schedule_dm+0x1d4>
        }
    } else {
    ...
    151e:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    1522:	649c                	ld	a5,8(s1)
    1524:	639c                	ld	a5,0(a5)
    1526:	faf43023          	sd	a5,-96(s0)
    152a:	fa043783          	ld	a5,-96(s0)
    152e:	fd878793          	addi	a5,a5,-40
    1532:	fcf43023          	sd	a5,-64(s0)
    1536:	a81d                	j	156c <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    1538:	fb043783          	ld	a5,-80(s0)
    153c:	cb89                	beqz	a5,154e <schedule_dm+0x16e>
    153e:	fc043783          	ld	a5,-64(s0)
    1542:	5fd8                	lw	a4,60(a5)
    1544:	fb043783          	ld	a5,-80(s0)
    1548:	5fdc                	lw	a5,60(a5)
    154a:	00f75663          	bge	a4,a5,1556 <schedule_dm+0x176>
                smallest_id_thread = t;
    154e:	fc043783          	ld	a5,-64(s0)
    1552:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    1556:	fc043783          	ld	a5,-64(s0)
    155a:	779c                	ld	a5,40(a5)
    155c:	f8f43c23          	sd	a5,-104(s0)
    1560:	f9843783          	ld	a5,-104(s0)
    1564:	fd878793          	addi	a5,a5,-40
    1568:	fcf43023          	sd	a5,-64(s0)
    156c:	fc043783          	ld	a5,-64(s0)
    1570:	02878713          	addi	a4,a5,40
    1574:	649c                	ld	a5,8(s1)
    1576:	fcf711e3          	bne	a4,a5,1538 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    157a:	fb043783          	ld	a5,-80(s0)
    157e:	cf89                	beqz	a5,1598 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    1580:	fb043783          	ld	a5,-80(s0)
    ...
    1592:	f6f42823          	sw	a5,-144(s0)
    1596:	a839                	j	15b4 <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    1598:	649c                	ld	a5,8(s1)
    159a:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    159e:	689c                	ld	a5,16(s1)
    15a0:	4098                	lw	a4,0(s1)
    15a2:	85ba                	mv	a1,a4
    15a4:	853e                	mv	a0,a5
    15a6:	00000097          	auipc	ra,0x0
    15aa:	9fe080e7          	jalr	-1538(ra) # fa4 <find_next_release_time>
    15ae:	87aa                	mv	a5,a0
    ...
    15d8:	853a                	mv	a0,a4
    15da:	85be                	mv	a1,a5
    15dc:	60ea                	ld	ra,152(sp)
    15de:	644a                	ld	s0,144(sp)
    15e0:	64aa                	ld	s1,136(sp)
    15e2:	690a                	ld	s2,128(sp)
    15e4:	79e6                	ld	s3,120(sp)
    15e6:	610d                	addi	sp,sp,160
    15e8:	8082                	ret

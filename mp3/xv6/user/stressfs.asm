...
main(int argc, char *argv[])
{
  ...
  char path[] = "stressfs0";
      ...
      1c:	79078793          	addi	a5,a5,1936 # 17a8 <schedule_dm+0x23e>
      20:	6398                	ld	a4,0(a5)
  ...
  printf("stressfs starting\n");
      ...
      32:	74a50513          	addi	a0,a0,1866 # 1778 <schedule_dm+0x20e>
  ...
  printf("write %d\n", i);
      ...
      8e:	70650513          	addi	a0,a0,1798 # 1790 <schedule_dm+0x226>
...
//    printf(fd, "%d\n", i);
  ...
  printf("read\n");
     ...
     110:	69450513          	addi	a0,a0,1684 # 17a0 <schedule_dm+0x236>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     782:	04268693          	addi	a3,a3,66 # 17c0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     85c:	f6870713          	addi	a4,a4,-152 # 17c0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     a1c:	da078793          	addi	a5,a5,-608 # 17b8 <schedule_dm+0x24e>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     bc8:	c2478793          	addi	a5,a5,-988 # 17e8 <freep>
     bcc:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     cc0:	b2c78793          	addi	a5,a5,-1236 # 17e8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     d42:	aaa78793          	addi	a5,a5,-1366 # 17e8 <freep>
     d46:	639c                	ld	a5,0(a5)
}
     d48:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d74:	a7878793          	addi	a5,a5,-1416 # 17e8 <freep>
     d78:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d88:	a5478793          	addi	a5,a5,-1452 # 17d8 <base>
     d8c:	fef43023          	sd	a5,-32(s0)
     d90:	00001797          	auipc	a5,0x1
     d94:	a5878793          	addi	a5,a5,-1448 # 17e8 <freep>
     d98:	fe043703          	ld	a4,-32(s0)
     d9c:	e398                	sd	a4,0(a5)
     d9e:	00001797          	auipc	a5,0x1
     da2:	a4a78793          	addi	a5,a5,-1462 # 17e8 <freep>
     da6:	6398                	ld	a4,0(a5)
     da8:	00001797          	auipc	a5,0x1
     dac:	a3078793          	addi	a5,a5,-1488 # 17d8 <base>
     db0:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     db2:	00001797          	auipc	a5,0x1
     db6:	a2678793          	addi	a5,a5,-1498 # 17d8 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     e32:	9ba78793          	addi	a5,a5,-1606 # 17e8 <freep>
    ...
    if(p == freep)
     ...
     e48:	9a478793          	addi	a5,a5,-1628 # 17e8 <freep>
     e4c:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    101e:	7d678793          	addi	a5,a5,2006 # 17f0 <last_thread.1226>
    ...
    107a:	77a78793          	addi	a5,a5,1914 # 17f0 <last_thread.1226>
    107e:	639c                	ld	a5,0(a5)
    1080:	c385                	beqz	a5,10a0 <schedule_wrr+0xd6>
    1082:	00000797          	auipc	a5,0x0
    1086:	76e78793          	addi	a5,a5,1902 # 17f0 <last_thread.1226>
    ...
    1096:	75e78793          	addi	a5,a5,1886 # 17f0 <last_thread.1226>
    ...
    10e6:	70e78793          	addi	a5,a5,1806 # 17f0 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    1218:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe018>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    134a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe018>
    ...
    13e4:	a00d                	j	1406 <schedule_sjf+0x102>
    } else {
    ...
    13f4:	57fd                	li	a5,-1
    13f6:	00f70563          	beq	a4,a5,1400 <schedule_sjf+0xfc>
    13fa:	fb442783          	lw	a5,-76(s0)
    13fe:	a011                	j	1402 <schedule_sjf+0xfe>
    1400:	4785                	li	a5,1
    1402:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    1406:	f8043783          	ld	a5,-128(s0)
    140a:	f8f43823          	sd	a5,-112(s0)
    140e:	f8843783          	ld	a5,-120(s0)
    1412:	f8f43c23          	sd	a5,-104(s0)
    1416:	4701                	li	a4,0
    1418:	f9043703          	ld	a4,-112(s0)
    141c:	4781                	li	a5,0
    141e:	f9843783          	ld	a5,-104(s0)
    1422:	893a                	mv	s2,a4
    1424:	89be                	mv	s3,a5
    1426:	874a                	mv	a4,s2
    1428:	87ce                	mv	a5,s3
    ...
    142a:	853a                	mv	a0,a4
    142c:	85be                	mv	a1,a5
    142e:	70e6                	ld	ra,120(sp)
    1430:	7446                	ld	s0,112(sp)
    1432:	74a6                	ld	s1,104(sp)
    1434:	7906                	ld	s2,96(sp)
    1436:	69e6                	ld	s3,88(sp)
    1438:	6109                	addi	sp,sp,128
    143a:	8082                	ret

000000000000143c <schedule_lst>:
...
{
    143c:	7119                	addi	sp,sp,-128
    143e:	fc86                	sd	ra,120(sp)
    1440:	f8a2                	sd	s0,112(sp)
    1442:	f4a6                	sd	s1,104(sp)
    1444:	f0ca                	sd	s2,96(sp)
    1446:	ecce                	sd	s3,88(sp)
    1448:	0100                	addi	s0,sp,128
    144a:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the least-slack-time scheduling algorithm
    struct thread *min_slack = NULL;
    144c:	fc043423          	sd	zero,-56(s0)
    ...
    145c:	649c                	ld	a5,8(s1)
    145e:	639c                	ld	a5,0(a5)
    1460:	faf43823          	sd	a5,-80(s0)
    1464:	fb043783          	ld	a5,-80(s0)
    1468:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe018>
    146c:	faf43c23          	sd	a5,-72(s0)
    1470:	a8b5                	j	14ec <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    1472:	fb843783          	ld	a5,-72(s0)
    1476:	47f8                	lw	a4,76(a5)
    1478:	409c                	lw	a5,0(s1)
    ...
    148c:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    1490:	fc843783          	ld	a5,-56(s0)
    1494:	cb8d                	beqz	a5,14c6 <schedule_lst+0x8a>
    1496:	fac42703          	lw	a4,-84(s0)
    149a:	fc442783          	lw	a5,-60(s0)
    149e:	2701                	sext.w	a4,a4
    14a0:	2781                	sext.w	a5,a5
    14a2:	02f74263          	blt	a4,a5,14c6 <schedule_lst+0x8a>
    14a6:	fac42703          	lw	a4,-84(s0)
    14aa:	fc442783          	lw	a5,-60(s0)
    14ae:	2701                	sext.w	a4,a4
    14b0:	2781                	sext.w	a5,a5
    14b2:	02f71263          	bne	a4,a5,14d6 <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    14b6:	fb843783          	ld	a5,-72(s0)
    14ba:	5fd8                	lw	a4,60(a5)
    14bc:	fc843783          	ld	a5,-56(s0)
    14c0:	5fdc                	lw	a5,60(a5)
    14c2:	00f75a63          	bge	a4,a5,14d6 <schedule_lst+0x9a>
            min_slack = t;
    14c6:	fb843783          	ld	a5,-72(s0)
    14ca:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    14ce:	fac42783          	lw	a5,-84(s0)
    14d2:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    14d6:	fb843783          	ld	a5,-72(s0)
    14da:	779c                	ld	a5,40(a5)
    14dc:	faf43023          	sd	a5,-96(s0)
    14e0:	fa043783          	ld	a5,-96(s0)
    14e4:	fd878793          	addi	a5,a5,-40
    14e8:	faf43c23          	sd	a5,-72(s0)
    14ec:	fb843783          	ld	a5,-72(s0)
    14f0:	02878713          	addi	a4,a5,40
    14f4:	649c                	ld	a5,8(s1)
    14f6:	f6f71ee3          	bne	a4,a5,1472 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    14fa:	fc843783          	ld	a5,-56(s0)
    14fe:	cf89                	beqz	a5,1518 <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    1500:	fc843783          	ld	a5,-56(s0)
    1504:	02878793          	addi	a5,a5,40
    1508:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    150c:	fc843783          	ld	a5,-56(s0)
    1510:	4fbc                	lw	a5,88(a5)
    1512:	f8f42423          	sw	a5,-120(s0)
    1516:	a839                	j	1534 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    1518:	649c                	ld	a5,8(s1)
    151a:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    151e:	689c                	ld	a5,16(s1)
    1520:	4098                	lw	a4,0(s1)
    1522:	85ba                	mv	a1,a4
    1524:	853e                	mv	a0,a5
    1526:	00000097          	auipc	ra,0x0
    152a:	c08080e7          	jalr	-1016(ra) # 112e <find_next_release_time>
    152e:	87aa                	mv	a5,a0
    1530:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    1534:	f8043783          	ld	a5,-128(s0)
    1538:	f8f43823          	sd	a5,-112(s0)
    153c:	f8843783          	ld	a5,-120(s0)
    1540:	f8f43c23          	sd	a5,-104(s0)
    1544:	4701                	li	a4,0
    1546:	f9043703          	ld	a4,-112(s0)
    154a:	4781                	li	a5,0
    ...
    1566:	6109                	addi	sp,sp,128
    1568:	8082                	ret

000000000000156a <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    156a:	7135                	addi	sp,sp,-160
    156c:	ed06                	sd	ra,152(sp)
    156e:	e922                	sd	s0,144(sp)
    1570:	e526                	sd	s1,136(sp)
    1572:	e14a                	sd	s2,128(sp)
    1574:	fcce                	sd	s3,120(sp)
    1576:	1100                	addi	s0,sp,160
    1578:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    157a:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    157e:	800007b7          	lui	a5,0x80000
    1582:	fff7c793          	not	a5,a5
    1586:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    158a:	649c                	ld	a5,8(s1)
    158c:	639c                	ld	a5,0(a5)
    158e:	faf43423          	sd	a5,-88(s0)
    1592:	fa843783          	ld	a5,-88(s0)
    1596:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe018>
    159a:	fcf43023          	sd	a5,-64(s0)
    159e:	a841                	j	162e <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    15a0:	fc043783          	ld	a5,-64(s0)
    15a4:	43bc                	lw	a5,64(a5)
    15a6:	cb95                	beqz	a5,15da <schedule_dm+0x70>
    15a8:	fc043783          	ld	a5,-64(s0)
    15ac:	4bbc                	lw	a5,80(a5)
    15ae:	873e                	mv	a4,a5
    15b0:	57fd                	li	a5,-1
    15b2:	02f70463          	beq	a4,a5,15da <schedule_dm+0x70>
    15b6:	fc043783          	ld	a5,-64(s0)
    15ba:	4ff8                	lw	a4,92(a5)
    15bc:	fbc42783          	lw	a5,-68(s0)
    15c0:	2781                	sext.w	a5,a5
    15c2:	00f75c63          	bge	a4,a5,15da <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    15c6:	fc043783          	ld	a5,-64(s0)
    15ca:	4ffc                	lw	a5,92(a5)
    15cc:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    15d0:	fc043783          	ld	a5,-64(s0)
    15d4:	fcf43423          	sd	a5,-56(s0)
    15d8:	a081                	j	1618 <schedule_dm+0xae>
    ...
    15de:	43bc                	lw	a5,64(a5)
    15e0:	cf85                	beqz	a5,1618 <schedule_dm+0xae>
    15e2:	fc043783          	ld	a5,-64(s0)
    15e6:	4bbc                	lw	a5,80(a5)
    15e8:	873e                	mv	a4,a5
    15ea:	57fd                	li	a5,-1
    15ec:	02f70663          	beq	a4,a5,1618 <schedule_dm+0xae>
    15f0:	fc043783          	ld	a5,-64(s0)
    15f4:	4ff8                	lw	a4,92(a5)
    15f6:	fbc42783          	lw	a5,-68(s0)
    15fa:	2781                	sext.w	a5,a5
    15fc:	00e79e63          	bne	a5,a4,1618 <schedule_dm+0xae>
    1600:	fc043783          	ld	a5,-64(s0)
    1604:	5fd8                	lw	a4,60(a5)
    1606:	fc843783          	ld	a5,-56(s0)
    160a:	5fdc                	lw	a5,60(a5)
    160c:	00f75663          	bge	a4,a5,1618 <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    1610:	fc043783          	ld	a5,-64(s0)
    1614:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1618:	fc043783          	ld	a5,-64(s0)
    161c:	779c                	ld	a5,40(a5)
    161e:	f8f43423          	sd	a5,-120(s0)
    1622:	f8843783          	ld	a5,-120(s0)
    1626:	fd878793          	addi	a5,a5,-40
    162a:	fcf43023          	sd	a5,-64(s0)
    162e:	fc043783          	ld	a5,-64(s0)
    1632:	02878713          	addi	a4,a5,40
    1636:	649c                	ld	a5,8(s1)
    1638:	f6f714e3          	bne	a4,a5,15a0 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    163c:	fc843783          	ld	a5,-56(s0)
    1640:	c7a5                	beqz	a5,16a8 <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    1642:	fc843783          	ld	a5,-56(s0)
    1646:	4ff8                	lw	a4,92(a5)
    1648:	409c                	lw	a5,0(s1)
    164a:	40f707bb          	subw	a5,a4,a5
    164e:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    1652:	fc843783          	ld	a5,-56(s0)
    1656:	4fb8                	lw	a4,88(a5)
    1658:	f9442783          	lw	a5,-108(s0)
    165c:	2781                	sext.w	a5,a5
    165e:	00e7db63          	bge	a5,a4,1674 <schedule_dm+0x10a>
    ...
    1666:	02878793          	addi	a5,a5,40
    166a:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    166e:	f6042823          	sw	zero,-144(s0)
    1672:	a0f1                	j	173e <schedule_dm+0x1d4>
        } else {
    ...
    167a:	863e                	mv	a2,a5
    167c:	f9442783          	lw	a5,-108(s0)
    1680:	0007869b          	sext.w	a3,a5
    1684:	0006071b          	sext.w	a4,a2
    1688:	00d75363          	bge	a4,a3,168e <schedule_dm+0x124>
    168c:	87b2                	mv	a5,a2
    168e:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1692:	fc843783          	ld	a5,-56(s0)
    1696:	02878793          	addi	a5,a5,40
    169a:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    169e:	f9042783          	lw	a5,-112(s0)
    16a2:	f6f42823          	sw	a5,-144(s0)
    16a6:	a861                	j	173e <schedule_dm+0x1d4>
        }
    } else {
    ...
    16a8:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    16ac:	649c                	ld	a5,8(s1)
    16ae:	639c                	ld	a5,0(a5)
    16b0:	faf43023          	sd	a5,-96(s0)
    16b4:	fa043783          	ld	a5,-96(s0)
    16b8:	fd878793          	addi	a5,a5,-40
    16bc:	fcf43023          	sd	a5,-64(s0)
    16c0:	a81d                	j	16f6 <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    16c2:	fb043783          	ld	a5,-80(s0)
    16c6:	cb89                	beqz	a5,16d8 <schedule_dm+0x16e>
    16c8:	fc043783          	ld	a5,-64(s0)
    16cc:	5fd8                	lw	a4,60(a5)
    16ce:	fb043783          	ld	a5,-80(s0)
    16d2:	5fdc                	lw	a5,60(a5)
    16d4:	00f75663          	bge	a4,a5,16e0 <schedule_dm+0x176>
                smallest_id_thread = t;
    16d8:	fc043783          	ld	a5,-64(s0)
    16dc:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    16e0:	fc043783          	ld	a5,-64(s0)
    16e4:	779c                	ld	a5,40(a5)
    16e6:	f8f43c23          	sd	a5,-104(s0)
    16ea:	f9843783          	ld	a5,-104(s0)
    16ee:	fd878793          	addi	a5,a5,-40
    16f2:	fcf43023          	sd	a5,-64(s0)
    16f6:	fc043783          	ld	a5,-64(s0)
    16fa:	02878713          	addi	a4,a5,40
    16fe:	649c                	ld	a5,8(s1)
    1700:	fcf711e3          	bne	a4,a5,16c2 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    1704:	fb043783          	ld	a5,-80(s0)
    1708:	cf89                	beqz	a5,1722 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    170a:	fb043783          	ld	a5,-80(s0)
    170e:	02878793          	addi	a5,a5,40
    1712:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    1716:	fb043783          	ld	a5,-80(s0)
    171a:	4fbc                	lw	a5,88(a5)
    171c:	f6f42823          	sw	a5,-144(s0)
    1720:	a839                	j	173e <schedule_dm+0x1d4>
        } else {
    ...
    1724:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1728:	689c                	ld	a5,16(s1)
    172a:	4098                	lw	a4,0(s1)
    172c:	85ba                	mv	a1,a4
    172e:	853e                	mv	a0,a5
    1730:	00000097          	auipc	ra,0x0
    1734:	9fe080e7          	jalr	-1538(ra) # 112e <find_next_release_time>
    1738:	87aa                	mv	a5,a0
    ...
    return r;
    173e:	f6843783          	ld	a5,-152(s0)
    1742:	f6f43c23          	sd	a5,-136(s0)
    1746:	f7043783          	ld	a5,-144(s0)
    174a:	f8f43023          	sd	a5,-128(s0)
    174e:	4701                	li	a4,0
    1750:	f7843703          	ld	a4,-136(s0)
    1754:	4781                	li	a5,0
    1756:	f8043783          	ld	a5,-128(s0)
    175a:	893a                	mv	s2,a4
    175c:	89be                	mv	s3,a5
    175e:	874a                	mv	a4,s2
    1760:	87ce                	mv	a5,s3
    ...
    1762:	853a                	mv	a0,a4
    1764:	85be                	mv	a1,a5
    1766:	60ea                	ld	ra,152(sp)
    1768:	644a                	ld	s0,144(sp)
    176a:	64aa                	ld	s1,136(sp)
    176c:	690a                	ld	s2,128(sp)
    176e:	79e6                	ld	s3,120(sp)
    1770:	610d                	addi	sp,sp,160
    1772:	8082                	ret

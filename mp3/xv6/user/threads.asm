...
static inline void list_del(struct list_head *entry)
{
    ...
    entry->next = LIST_POISON1;
      ...
      ca:	10070713          	addi	a4,a4,256 # 100100 <__global_pointer$+0xfd400>
      ce:	e398                	sd	a4,0(a5)
    entry->prev = LIST_POISON2;
      d0:	fe843783          	ld	a5,-24(s0)
      d4:	00200737          	lui	a4,0x200
      d8:	20070713          	addi	a4,a4,512 # 200200 <__global_pointer$+0x1fd500>
      dc:	e798                	sd	a4,8(a5)
}
      de:	0001                	nop
      e0:	60e2                	ld	ra,24(sp)
...
struct thread *thread_create(void (*f)(void *), void *arg, int is_real_time, int processing_time, int period, int n)
{
    ...
    t->ID = _id++;
     ...
     188:	3b478793          	addi	a5,a5,948 # 2538 <_id.1229>
     18c:	439c                	lw	a5,0(a5)
     18e:	0017871b          	addiw	a4,a5,1
     192:	0007069b          	sext.w	a3,a4
     196:	00002717          	auipc	a4,0x2
     19a:	3a270713          	addi	a4,a4,930 # 2538 <_id.1229>
     19e:	c314                	sw	a3,0(a4)
...
void thread_add_at(struct thread *t, int arrival_time)
{
    ...
    list_add_tail(&new_entry->thread_list, &release_queue);
     ...
     2a6:	26e58593          	addi	a1,a1,622 # 2510 <release_queue>
     2aa:	853e                	mv	a0,a5
...
void __release()
{
    ...
    list_for_each_entry_safe(cur, nxt, &release_queue, thread_list) {
     ...
     2ca:	24a78793          	addi	a5,a5,586 # 2510 <release_queue>
     2ce:	639c                	ld	a5,0(a5)
     ...
     2fe:	24e78793          	addi	a5,a5,590 # 2548 <threading_system_time>
     302:	439c                	lw	a5,0(a5)
     ...
     340:	1c458593          	addi	a1,a1,452 # 2500 <run_queue>
     344:	853e                	mv	a0,a5
    ...
    list_for_each_entry_safe(cur, nxt, &release_queue, thread_list) {
     ...
     392:	18278793          	addi	a5,a5,386 # 2510 <release_queue>
...
void __thread_exit(struct thread *to_remove)
{
    ...
    current = to_remove->thread_list.prev;
     ...
     3bc:	18878793          	addi	a5,a5,392 # 2540 <current>
     3c0:	e398                	sd	a4,0(a5)
    ...
    thrdresume(main_thrd_id);
     ...
     404:	13478793          	addi	a5,a5,308 # 2534 <main_thrd_id>
     408:	439c                	lw	a5,0(a5)
     40a:	853e                	mv	a0,a5
...
void thread_exit(void)
{
    ...
    if (current == &run_queue) {
     ...
     42a:	11a78793          	addi	a5,a5,282 # 2540 <current>
     42e:	6398                	ld	a4,0(a5)
     430:	00002797          	auipc	a5,0x2
     434:	0d078793          	addi	a5,a5,208 # 2500 <run_queue>
     ...
     440:	f7c58593          	addi	a1,a1,-132 # 23b8 <schedule_dm+0x17c>
     444:	4509                	li	a0,2
    ...
    struct thread *to_remove = list_entry(current, struct thread, thread_list);
     ...
     45c:	0e878793          	addi	a5,a5,232 # 2540 <current>
     460:	639c                	ld	a5,0(a5)
    ...
    threading_system_time += consume_ticks;
     ...
     48e:	0be78793          	addi	a5,a5,190 # 2548 <threading_system_time>
     492:	439c                	lw	a5,0(a5)
     494:	fdc42703          	lw	a4,-36(s0)
     498:	9fb9                	addw	a5,a5,a4
     49a:	0007871b          	sext.w	a4,a5
     49e:	00002797          	auipc	a5,0x2
     4a2:	0aa78793          	addi	a5,a5,170 # 2548 <threading_system_time>
     4a6:	c398                	sw	a4,0(a5)
...
void __finish_current()
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     4d2:	07278793          	addi	a5,a5,114 # 2540 <current>
     4d6:	639c                	ld	a5,0(a5)
    ...
    printf("thread#%d finish at %d\n",
     ...
     504:	04878793          	addi	a5,a5,72 # 2548 <threading_system_time>
     508:	4390                	lw	a2,0(a5)
     ...
     518:	edc50513          	addi	a0,a0,-292 # 23f0 <schedule_dm+0x1b4>
    ...
    if (current_thread->n > 0) {
     ...
     532:	01278793          	addi	a5,a5,18 # 2540 <current>
     536:	639c                	ld	a5,0(a5)
     538:	fcf43c23          	sd	a5,-40(s0)
        current = current->prev;
     53c:	00002797          	auipc	a5,0x2
     540:	00478793          	addi	a5,a5,4 # 2540 <current>
     544:	639c                	ld	a5,0(a5)
     546:	6798                	ld	a4,8(a5)
     548:	00002797          	auipc	a5,0x2
     54c:	ff878793          	addi	a5,a5,-8 # 2540 <current>
     550:	e398                	sd	a4,0(a5)
        list_del(to_remove);
...
void __rt_finish_current()
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     596:	fae78793          	addi	a5,a5,-82 # 2540 <current>
     59a:	639c                	ld	a5,0(a5)
    ...
    printf("thread#%d finish one cycle at %d: %d cycles left\n",
     ...
     5c8:	f8478793          	addi	a5,a5,-124 # 2548 <threading_system_time>
     5cc:	4390                	lw	a2,0(a5)
     ...
     5dc:	e3050513          	addi	a0,a0,-464 # 2408 <schedule_dm+0x1cc>
    ...
    if (current_thread->n > 0) {
     ...
     5f6:	f4e78793          	addi	a5,a5,-178 # 2540 <current>
     5fa:	639c                	ld	a5,0(a5)
     5fc:	fcf43c23          	sd	a5,-40(s0)
        current = current->prev;
     600:	00002797          	auipc	a5,0x2
     604:	f4078793          	addi	a5,a5,-192 # 2540 <current>
     608:	639c                	ld	a5,0(a5)
     60a:	6798                	ld	a4,8(a5)
     60c:	00002797          	auipc	a5,0x2
     610:	f3478793          	addi	a5,a5,-204 # 2540 <current>
     614:	e398                	sd	a4,0(a5)
        list_del(to_remove);
...
void switch_handler(void *arg)
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     666:	ede78793          	addi	a5,a5,-290 # 2540 <current>
     66a:	639c                	ld	a5,0(a5)
    ...
    threading_system_time += elapsed_time;
     ...
     688:	ec478793          	addi	a5,a5,-316 # 2548 <threading_system_time>
     68c:	439c                	lw	a5,0(a5)
     ...
     69c:	eb078793          	addi	a5,a5,-336 # 2548 <threading_system_time>
     6a0:	c398                	sw	a4,0(a5)
     __release();
    ...
    if (current_thread->is_real_time)
     ...
     6dc:	e7078793          	addi	a5,a5,-400 # 2548 <threading_system_time>
     6e0:	439c                	lw	a5,0(a5)
     ...
     6f0:	e5c78793          	addi	a5,a5,-420 # 2548 <threading_system_time>
     6f4:	439c                	lw	a5,0(a5)
        if (threading_system_time > current_thread->current_deadline || 
     ...
     70e:	e3e78793          	addi	a5,a5,-450 # 2548 <threading_system_time>
     712:	439c                	lw	a5,0(a5)
     714:	863e                	mv	a2,a5
     716:	85ba                	mv	a1,a4
     718:	00002517          	auipc	a0,0x2
     71c:	d2850513          	addi	a0,a0,-728 # 2440 <schedule_dm+0x204>
    ...
    if (current_thread->remaining_time <= 0) {
     ...
     75c:	de878793          	addi	a5,a5,-536 # 2540 <current>
     760:	639c                	ld	a5,0(a5)
     762:	fcf43823          	sd	a5,-48(s0)
        current = current->prev;
     766:	00002797          	auipc	a5,0x2
     76a:	dda78793          	addi	a5,a5,-550 # 2540 <current>
     76e:	639c                	ld	a5,0(a5)
     770:	6798                	ld	a4,8(a5)
     772:	00002797          	auipc	a5,0x2
     776:	dce78793          	addi	a5,a5,-562 # 2540 <current>
     77a:	e398                	sd	a4,0(a5)
        list_del(to_remove);
     ...
     78c:	d7858593          	addi	a1,a1,-648 # 2500 <run_queue>
    ...
    thrdresume(main_thrd_id);
     ...
     7b8:	d8078793          	addi	a5,a5,-640 # 2534 <main_thrd_id>
     7bc:	439c                	lw	a5,0(a5)
     7be:	853e                	mv	a0,a5
...
void __dispatch()
{
    ...
    if (current == &run_queue) {
     ...
     7de:	d6678793          	addi	a5,a5,-666 # 2540 <current>
     7e2:	6398                	ld	a4,0(a5)
     7e4:	00002797          	auipc	a5,0x2
     7e8:	d1c78793          	addi	a5,a5,-740 # 2500 <run_queue>
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     7f4:	d5078793          	addi	a5,a5,-688 # 2540 <current>
     7f8:	639c                	ld	a5,0(a5)
    ...
    if (current_thread->is_real_time && allocated_time == 0) { // miss deadline, abort
     ...
     816:	d3e78793          	addi	a5,a5,-706 # 2550 <allocated_time>
     81a:	639c                	ld	a5,0(a5)
     ...
     832:	c1250513          	addi	a0,a0,-1006 # 2440 <schedule_dm+0x204>
    ...
    printf("dispatch thread#%d at %d: allocated_time=%d\n", current_thread->ID, threading_system_time, allocated_time);
     ...
     852:	cfa78793          	addi	a5,a5,-774 # 2548 <threading_system_time>
     856:	4390                	lw	a2,0(a5)
     858:	00002797          	auipc	a5,0x2
     85c:	cf878793          	addi	a5,a5,-776 # 2550 <allocated_time>
     860:	639c                	ld	a5,0(a5)
     862:	86be                	mv	a3,a5
     864:	85ba                	mv	a1,a4
     866:	00002517          	auipc	a0,0x2
     86a:	c0250513          	addi	a0,a0,-1022 # 2468 <schedule_dm+0x22c>
    ...
    if (current_thread->buf_set) {
     ...
     920:	b7c58593          	addi	a1,a1,-1156 # 2498 <schedule_dm+0x25c>
     924:	4509                	li	a0,2
...
void __schedule()
{
    ...
    struct threads_sched_args args = {
     ...
     96e:	bde78793          	addi	a5,a5,-1058 # 2548 <threading_system_time>
     972:	439c                	lw	a5,0(a5)
     974:	fcf42c23          	sw	a5,-40(s0)
     978:	4789                	li	a5,2
     97a:	fcf42e23          	sw	a5,-36(s0)
     97e:	00002797          	auipc	a5,0x2
     982:	b8278793          	addi	a5,a5,-1150 # 2500 <run_queue>
     986:	fef43023          	sd	a5,-32(s0)
     98a:	00002797          	auipc	a5,0x2
     98e:	b8678793          	addi	a5,a5,-1146 # 2510 <release_queue>
    ...
    r = schedule_dm(args);
     ...
     9b2:	853e                	mv	a0,a5
     9b4:	00002097          	auipc	ra,0x2
     9b8:	888080e7          	jalr	-1912(ra) # 223c <schedule_dm>
     9bc:	872a                	mv	a4,a0
     9be:	87ae                	mv	a5,a1
    ...
    current = r.scheduled_thread_list_member;
     ...
     9d0:	b7478793          	addi	a5,a5,-1164 # 2540 <current>
     9d4:	e398                	sd	a4,0(a5)
    allocated_time = r.allocated_time;
     9d6:	fd042783          	lw	a5,-48(s0)
     9da:	873e                	mv	a4,a5
     9dc:	00002797          	auipc	a5,0x2
     9e0:	b7478793          	addi	a5,a5,-1164 # 2550 <allocated_time>
     9e4:	e398                	sd	a4,0(a5)
}
     9e6:	0001                	nop
...
void back_to_main_handler(void *arg)
{
    ...
    sleeping = 0;
     ...
     a00:	b5078793          	addi	a5,a5,-1200 # 254c <sleeping>
    ...
    threading_system_time += (uint64)arg;
     ...
     a14:	b3878793          	addi	a5,a5,-1224 # 2548 <threading_system_time>
     a18:	439c                	lw	a5,0(a5)
     ...
     a28:	b2478793          	addi	a5,a5,-1244 # 2548 <threading_system_time>
     a2c:	c398                	sw	a4,0(a5)
    thrdresume(main_thrd_id);
     a2e:	00002797          	auipc	a5,0x2
     a32:	b0678793          	addi	a5,a5,-1274 # 2534 <main_thrd_id>
     a36:	439c                	lw	a5,0(a5)
     a38:	853e                	mv	a0,a5
...
void thread_start_threading()
{
    ...
    threading_system_time = 0;
     ...
     a58:	af478793          	addi	a5,a5,-1292 # 2548 <threading_system_time>
     a5c:	0007a023          	sw	zero,0(a5)
    current = &run_queue;
     a60:	00002797          	auipc	a5,0x2
     a64:	ae078793          	addi	a5,a5,-1312 # 2540 <current>
     a68:	00002717          	auipc	a4,0x2
     a6c:	a9870713          	addi	a4,a4,-1384 # 2500 <run_queue>
     a70:	e398                	sd	a4,0(a5)
    ...
    thrdstop(1000, &main_thrd_id, back_to_main_handler, (void *)0);
     ...
     a80:	ab858593          	addi	a1,a1,-1352 # 2534 <main_thrd_id>
    ...
    cancelthrdstop(main_thrd_id, 0);
     ...
     a94:	aa478793          	addi	a5,a5,-1372 # 2534 <main_thrd_id>
     a98:	439c                	lw	a5,0(a5)
     a9a:	4581                	li	a1,0
     a9c:	853e                	mv	a0,a5
    ...
    while (!list_empty(&run_queue) || !list_empty(&release_queue)) {
     ...
     abc:	a7c78793          	addi	a5,a5,-1412 # 2534 <main_thrd_id>
     ac0:	439c                	lw	a5,0(a5)
     ac2:	4581                	li	a1,0
     ac4:	853e                	mv	a0,a5
     ...
     ada:	a2a50513          	addi	a0,a0,-1494 # 2500 <run_queue>
     ...
     aee:	a2650513          	addi	a0,a0,-1498 # 2510 <release_queue>
     ...
     b60:	9f078793          	addi	a5,a5,-1552 # 254c <sleeping>
     b64:	439c                	lw	a5,0(a5)
     b66:	fbfd                	bnez	a5,b5c <thread_start_threading+0x110>
    while (!list_empty(&run_queue) || !list_empty(&release_queue)) {
     b68:	00002517          	auipc	a0,0x2
     b6c:	99850513          	addi	a0,a0,-1640 # 2500 <run_queue>
     ...
     b80:	99450513          	addi	a0,a0,-1644 # 2510 <release_queue>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1196:	38e68693          	addi	a3,a3,910 # 2520 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1270:	2b470713          	addi	a4,a4,692 # 2520 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1430:	0cc78793          	addi	a5,a5,204 # 24f8 <schedule_dm+0x2bc>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    15dc:	f9078793          	addi	a5,a5,-112 # 2568 <freep>
  ...
  freep = p;
    ...
    16d4:	e9878793          	addi	a5,a5,-360 # 2568 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1756:	e1678793          	addi	a5,a5,-490 # 2568 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1788:	de478793          	addi	a5,a5,-540 # 2568 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1846:	d2678793          	addi	a5,a5,-730 # 2568 <freep>
    ...
    185c:	d1078793          	addi	a5,a5,-752 # 2568 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    1a32:	b4278793          	addi	a5,a5,-1214 # 2570 <last_thread.1226>
    ...
    1a8e:	ae678793          	addi	a5,a5,-1306 # 2570 <last_thread.1226>
    1a92:	639c                	ld	a5,0(a5)
    1a94:	c385                	beqz	a5,1ab4 <schedule_wrr+0xd6>
    1a96:	00001797          	auipc	a5,0x1
    1a9a:	ada78793          	addi	a5,a5,-1318 # 2570 <last_thread.1226>
    ...
    1aaa:	aca78793          	addi	a5,a5,-1334 # 2570 <last_thread.1226>
    ...
    1afa:	a7a78793          	addi	a5,a5,-1414 # 2570 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    1c2c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd2d8>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    1d5e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd2d8>
    ...
    1df8:	a80d                	j	1e2a <schedule_sjf+0x112>
    } else {
    ...
    1e08:	57fd                	li	a5,-1
    1e0a:	00f71c63          	bne	a4,a5,1e22 <schedule_sjf+0x10a>
    1e0e:	689c                	ld	a5,16(s1)
    1e10:	4098                	lw	a4,0(s1)
    1e12:	85ba                	mv	a1,a4
    1e14:	853e                	mv	a0,a5
    1e16:	00000097          	auipc	ra,0x0
    1e1a:	d2c080e7          	jalr	-724(ra) # 1b42 <find_next_release_time>
    1e1e:	87aa                	mv	a5,a0
    1e20:	a019                	j	1e26 <schedule_sjf+0x10e>
    1e22:	fb442783          	lw	a5,-76(s0)
    1e26:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    1e2a:	f8043783          	ld	a5,-128(s0)
    1e2e:	f8f43823          	sd	a5,-112(s0)
    1e32:	f8843783          	ld	a5,-120(s0)
    1e36:	f8f43c23          	sd	a5,-104(s0)
    1e3a:	4701                	li	a4,0
    1e3c:	f9043703          	ld	a4,-112(s0)
    1e40:	4781                	li	a5,0
    1e42:	f9843783          	ld	a5,-104(s0)
    1e46:	893a                	mv	s2,a4
    1e48:	89be                	mv	s3,a5
    1e4a:	874a                	mv	a4,s2
    1e4c:	87ce                	mv	a5,s3
    ...
    1e4e:	853a                	mv	a0,a4
    1e50:	85be                	mv	a1,a5
    1e52:	70e6                	ld	ra,120(sp)
    1e54:	7446                	ld	s0,112(sp)
    1e56:	74a6                	ld	s1,104(sp)
    1e58:	7906                	ld	s2,96(sp)
    1e5a:	69e6                	ld	s3,88(sp)
    1e5c:	6109                	addi	sp,sp,128
    1e5e:	8082                	ret

0000000000001e60 <min>:

int min(int a, int b) {
    1e60:	1101                	addi	sp,sp,-32
    1e62:	ec22                	sd	s0,24(sp)
    1e64:	1000                	addi	s0,sp,32
    1e66:	87aa                	mv	a5,a0
    1e68:	872e                	mv	a4,a1
    1e6a:	fef42623          	sw	a5,-20(s0)
    1e6e:	87ba                	mv	a5,a4
    1e70:	fef42423          	sw	a5,-24(s0)
    return (a < b) ? a : b;
    1e74:	fec42603          	lw	a2,-20(s0)
    1e78:	fe842783          	lw	a5,-24(s0)
    1e7c:	0007869b          	sext.w	a3,a5
    1e80:	0006071b          	sext.w	a4,a2
    1e84:	00d75363          	bge	a4,a3,1e8a <min+0x2a>
    1e88:	87b2                	mv	a5,a2
    1e8a:	2781                	sext.w	a5,a5
}
    1e8c:	853e                	mv	a0,a5
    1e8e:	6462                	ld	s0,24(sp)
    1e90:	6105                	addi	sp,sp,32
    1e92:	8082                	ret

0000000000001e94 <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    1e94:	7131                	addi	sp,sp,-192
    1e96:	fd06                	sd	ra,184(sp)
    1e98:	f922                	sd	s0,176(sp)
    1e9a:	f526                	sd	s1,168(sp)
    1e9c:	f14a                	sd	s2,160(sp)
    1e9e:	ed4e                	sd	s3,152(sp)
    1ea0:	0180                	addi	s0,sp,192
    1ea2:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *min_slack_thread = NULL;
    1ea4:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    1ea8:	800007b7          	lui	a5,0x80000
    1eac:	fff7c793          	not	a5,a5
    1eb0:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    // int ddl;
    ...
    1eb8:	faf43023          	sd	a5,-96(s0)
    1ebc:	fa043783          	ld	a5,-96(s0)
    1ec0:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd2d8>
    1ec4:	faf43c23          	sd	a5,-72(s0)
    1ec8:	a069                	j	1f52 <schedule_lst+0xbe>
    ...
    1ee4:	f6f42a23          	sw	a5,-140(s0)
        if (slack_time < min_slack_time || (slack_time == min_slack_time && t->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))) {
    1ee8:	f7442703          	lw	a4,-140(s0)
    1eec:	fc442783          	lw	a5,-60(s0)
    1ef0:	2701                	sext.w	a4,a4
    1ef2:	2781                	sext.w	a5,a5
    1ef4:	02f74c63          	blt	a4,a5,1f2c <schedule_lst+0x98>
    1ef8:	f7442703          	lw	a4,-140(s0)
    1efc:	fc442783          	lw	a5,-60(s0)
    1f00:	2701                	sext.w	a4,a4
    1f02:	2781                	sext.w	a5,a5
    1f04:	02f71c63          	bne	a4,a5,1f3c <schedule_lst+0xa8>
    1f08:	fb843783          	ld	a5,-72(s0)
    1f0c:	5fd4                	lw	a3,60(a5)
    1f0e:	fc843783          	ld	a5,-56(s0)
    1f12:	c789                	beqz	a5,1f1c <schedule_lst+0x88>
    1f14:	fc843783          	ld	a5,-56(s0)
    1f18:	5fdc                	lw	a5,60(a5)
    1f1a:	a029                	j	1f24 <schedule_lst+0x90>
    1f1c:	800007b7          	lui	a5,0x80000
    1f20:	fff7c793          	not	a5,a5
    1f24:	873e                	mv	a4,a5
    1f26:	87b6                	mv	a5,a3
    1f28:	00e7da63          	bge	a5,a4,1f3c <schedule_lst+0xa8>
            min_slack_thread = t;
    1f2c:	fb843783          	ld	a5,-72(s0)
    1f30:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    1f34:	f7442783          	lw	a5,-140(s0)
    1f38:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1f3c:	fb843783          	ld	a5,-72(s0)
    1f40:	779c                	ld	a5,40(a5)
    1f42:	f6f43423          	sd	a5,-152(s0)
    1f46:	f6843783          	ld	a5,-152(s0)
    1f4a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd2d8>
    1f4e:	faf43c23          	sd	a5,-72(s0)
    1f52:	fb843783          	ld	a5,-72(s0)
    1f56:	02878713          	addi	a4,a5,40
    1f5a:	649c                	ld	a5,8(s1)
    1f5c:	f6f717e3          	bne	a4,a5,1eca <schedule_lst+0x36>
    ...
    1f60:	800007b7          	lui	a5,0x80000
    1f64:	fff7c793          	not	a5,a5
    1f68:	faf42a23          	sw	a5,-76(s0)
    ...
    1f6c:	689c                	ld	a5,16(s1)
    1f6e:	639c                	ld	a5,0(a5)
    1f70:	f8f43c23          	sd	a5,-104(s0)
    1f74:	f9843783          	ld	a5,-104(s0)
    1f78:	17e1                	addi	a5,a5,-8
    1f7a:	faf43423          	sd	a5,-88(s0)
    1f7e:	a0f1                	j	204a <schedule_lst+0x1b6>
        if (entry->release_time > args.current_time) {
    1f80:	fa843783          	ld	a5,-88(s0)
    1f84:	4f98                	lw	a4,24(a5)
    1f86:	409c                	lw	a5,0(s1)
    1f88:	0ae7d763          	bge	a5,a4,2036 <schedule_lst+0x1a2>
            struct thread *upcoming_thread = entry->thrd;
    1f8c:	fa843783          	ld	a5,-88(s0)
    1f90:	639c                	ld	a5,0(a5)
    1f92:	f8f43423          	sd	a5,-120(s0)
    ...
    1fb8:	f8442703          	lw	a4,-124(s0)
    1fbc:	fc442783          	lw	a5,-60(s0)
    1fc0:	2701                	sext.w	a4,a4
    1fc2:	2781                	sext.w	a5,a5
    1fc4:	02f75163          	bge	a4,a5,1fe6 <schedule_lst+0x152>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    1fc8:	fa843783          	ld	a5,-88(s0)
    1fcc:	4f98                	lw	a4,24(a5)
    1fce:	fb442783          	lw	a5,-76(s0)
    1fd2:	85ba                	mv	a1,a4
    1fd4:	853e                	mv	a0,a5
    1fd6:	00000097          	auipc	ra,0x0
    1fda:	e8a080e7          	jalr	-374(ra) # 1e60 <min>
    1fde:	87aa                	mv	a5,a0
    1fe0:	faf42a23          	sw	a5,-76(s0)
    1fe4:	a889                	j	2036 <schedule_lst+0x1a2>
            } else if (upcoming_slack_time == min_slack_time && upcoming_thread->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))
    1fe6:	f8442703          	lw	a4,-124(s0)
    1fea:	fc442783          	lw	a5,-60(s0)
    1fee:	2701                	sext.w	a4,a4
    1ff0:	2781                	sext.w	a5,a5
    1ff2:	04f71263          	bne	a4,a5,2036 <schedule_lst+0x1a2>
    1ff6:	f8843783          	ld	a5,-120(s0)
    1ffa:	5fd4                	lw	a3,60(a5)
    1ffc:	fc843783          	ld	a5,-56(s0)
    2000:	c789                	beqz	a5,200a <schedule_lst+0x176>
    2002:	fc843783          	ld	a5,-56(s0)
    2006:	5fdc                	lw	a5,60(a5)
    2008:	a029                	j	2012 <schedule_lst+0x17e>
    200a:	800007b7          	lui	a5,0x80000
    200e:	fff7c793          	not	a5,a5
    2012:	873e                	mv	a4,a5
    2014:	87b6                	mv	a5,a3
    2016:	02e7d063          	bge	a5,a4,2036 <schedule_lst+0x1a2>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    201a:	fa843783          	ld	a5,-88(s0)
    201e:	4f98                	lw	a4,24(a5)
    2020:	fb442783          	lw	a5,-76(s0)
    2024:	85ba                	mv	a1,a4
    2026:	853e                	mv	a0,a5
    2028:	00000097          	auipc	ra,0x0
    202c:	e38080e7          	jalr	-456(ra) # 1e60 <min>
    2030:	87aa                	mv	a5,a0
    2032:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(entry, args.release_queue, thread_list) {
    2036:	fa843783          	ld	a5,-88(s0)
    203a:	679c                	ld	a5,8(a5)
    203c:	f6f43c23          	sd	a5,-136(s0)
    2040:	f7843783          	ld	a5,-136(s0)
    2044:	17e1                	addi	a5,a5,-8
    2046:	faf43423          	sd	a5,-88(s0)
    204a:	fa843783          	ld	a5,-88(s0)
    204e:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffd308>
    2052:	689c                	ld	a5,16(s1)
    2054:	f2f716e3          	bne	a4,a5,1f80 <schedule_lst+0xec>
        }
    }
    ...
    205c:	c3b1                	beqz	a5,20a0 <schedule_lst+0x20c>
    ...
    205e:	fb442783          	lw	a5,-76(s0)
    2062:	0007871b          	sext.w	a4,a5
    2066:	800007b7          	lui	a5,0x80000
    206a:	fff7c793          	not	a5,a5
    206e:	00f71663          	bne	a4,a5,207a <schedule_lst+0x1e6>
    2072:	fc843783          	ld	a5,-56(s0)
    2076:	4fbc                	lw	a5,88(a5)
    2078:	a039                	j	2086 <schedule_lst+0x1f2>
    207a:	409c                	lw	a5,0(s1)
    207c:	fb442703          	lw	a4,-76(s0)
    2080:	40f707bb          	subw	a5,a4,a5
    2084:	2781                	sext.w	a5,a5
    2086:	f8f42a23          	sw	a5,-108(s0)
        r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    208a:	fc843783          	ld	a5,-56(s0)
    208e:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffd328>
    2092:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = allocated_time;
    2096:	f9442783          	lw	a5,-108(s0)
    209a:	f4f42823          	sw	a5,-176(s0)
    209e:	a081                	j	20de <schedule_lst+0x24a>
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    20a0:	649c                	ld	a5,8(s1)
    20a2:	f4f43423          	sd	a5,-184(s0)
    ...
    20a6:	fb442783          	lw	a5,-76(s0)
    20aa:	0007871b          	sext.w	a4,a5
    20ae:	800007b7          	lui	a5,0x80000
    20b2:	fff7c793          	not	a5,a5
    20b6:	00f70963          	beq	a4,a5,20c8 <schedule_lst+0x234>
    20ba:	409c                	lw	a5,0(s1)
    20bc:	fb442703          	lw	a4,-76(s0)
    20c0:	40f707bb          	subw	a5,a4,a5
    20c4:	2781                	sext.w	a5,a5
    20c6:	a811                	j	20da <schedule_lst+0x246>
    20c8:	689c                	ld	a5,16(s1)
    20ca:	4098                	lw	a4,0(s1)
    20cc:	85ba                	mv	a1,a4
    20ce:	853e                	mv	a0,a5
    20d0:	00000097          	auipc	ra,0x0
    20d4:	a72080e7          	jalr	-1422(ra) # 1b42 <find_next_release_time>
    20d8:	87aa                	mv	a5,a0
    20da:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    20de:	f4843783          	ld	a5,-184(s0)
    20e2:	f4f43c23          	sd	a5,-168(s0)
    20e6:	f5043783          	ld	a5,-176(s0)
    20ea:	f6f43023          	sd	a5,-160(s0)
    20ee:	4701                	li	a4,0
    20f0:	f5843703          	ld	a4,-168(s0)
    20f4:	4781                	li	a5,0
    20f6:	f6043783          	ld	a5,-160(s0)
    20fa:	893a                	mv	s2,a4
    20fc:	89be                	mv	s3,a5
    20fe:	874a                	mv	a4,s2
    2100:	87ce                	mv	a5,s3
    ...
    2102:	853a                	mv	a0,a4
    2104:	85be                	mv	a1,a5
    2106:	70ea                	ld	ra,184(sp)
    2108:	744a                	ld	s0,176(sp)
    210a:	74aa                	ld	s1,168(sp)
    210c:	790a                	ld	s2,160(sp)
    210e:	69ea                	ld	s3,152(sp)
    2110:	6129                	addi	sp,sp,192
    2112:	8082                	ret

0000000000002114 <find_earliest_impactful_release_time_dm>:

int find_earliest_impactful_release_time_dm(struct list_head *release_queue, int current_time, int current_deadline) {
    2114:	715d                	addi	sp,sp,-80
    2116:	e4a2                	sd	s0,72(sp)
    2118:	0880                	addi	s0,sp,80
    211a:	faa43c23          	sd	a0,-72(s0)
    211e:	87ae                	mv	a5,a1
    2120:	8732                	mv	a4,a2
    2122:	faf42a23          	sw	a5,-76(s0)
    2126:	87ba                	mv	a5,a4
    2128:	faf42823          	sw	a5,-80(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_event = INT_MAX;
    212c:	800007b7          	lui	a5,0x80000
    2130:	fff7c793          	not	a5,a5
    2134:	fef42223          	sw	a5,-28(s0)
    struct thread *earliest_deadline_thread = NULL;
    2138:	fc043c23          	sd	zero,-40(s0)
    earliest_deadline_thread->ID = INT_MAX;
    213c:	fd843783          	ld	a5,-40(s0)
    2140:	80000737          	lui	a4,0x80000
    2144:	fff74713          	not	a4,a4
    2148:	dfd8                	sw	a4,60(a5)

    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    214a:	fb843783          	ld	a5,-72(s0)
    214e:	639c                	ld	a5,0(a5)
    2150:	fcf43823          	sd	a5,-48(s0)
    2154:	fd043783          	ld	a5,-48(s0)
    2158:	17e1                	addi	a5,a5,-8
    215a:	fef43423          	sd	a5,-24(s0)
    215e:	a075                	j	220a <find_earliest_impactful_release_time_dm+0xf6>
        if (entry->release_time > current_time && entry->thrd->period < current_deadline) {
    2160:	fe843783          	ld	a5,-24(s0)
    2164:	4f98                	lw	a4,24(a5)
    2166:	fb442783          	lw	a5,-76(s0)
    216a:	2781                	sext.w	a5,a5
    216c:	02e7d963          	bge	a5,a4,219e <find_earliest_impactful_release_time_dm+0x8a>
    2170:	fe843783          	ld	a5,-24(s0)
    2174:	639c                	ld	a5,0(a5)
    2176:	4bb8                	lw	a4,80(a5)
    2178:	fb042783          	lw	a5,-80(s0)
    217c:	2781                	sext.w	a5,a5
    217e:	02f75063          	bge	a4,a5,219e <find_earliest_impactful_release_time_dm+0x8a>
            if (entry->release_time < earliest_impactful_event) {
    2182:	fe843783          	ld	a5,-24(s0)
    2186:	4f98                	lw	a4,24(a5)
    2188:	fe442783          	lw	a5,-28(s0)
    218c:	2781                	sext.w	a5,a5
    218e:	06f75463          	bge	a4,a5,21f6 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    2192:	fe843783          	ld	a5,-24(s0)
    2196:	4f9c                	lw	a5,24(a5)
    2198:	fef42223          	sw	a5,-28(s0)
            if (entry->release_time < earliest_impactful_event) {
    219c:	a8a9                	j	21f6 <find_earliest_impactful_release_time_dm+0xe2>
            }
        } 
    ...
    219e:	fe843783          	ld	a5,-24(s0)
    21a2:	4f98                	lw	a4,24(a5)
    21a4:	fb442783          	lw	a5,-76(s0)
    21a8:	2781                	sext.w	a5,a5
    21aa:	04e7d663          	bge	a5,a4,21f6 <find_earliest_impactful_release_time_dm+0xe2>
    21ae:	fe843783          	ld	a5,-24(s0)
    21b2:	639c                	ld	a5,0(a5)
    21b4:	4bb8                	lw	a4,80(a5)
    21b6:	fb042783          	lw	a5,-80(s0)
    21ba:	2781                	sext.w	a5,a5
    21bc:	02e79d63          	bne	a5,a4,21f6 <find_earliest_impactful_release_time_dm+0xe2>
            if (entry->release_time < earliest_impactful_event && entry->thrd->ID < earliest_deadline_thread->ID) {
    21c0:	fe843783          	ld	a5,-24(s0)
    21c4:	4f98                	lw	a4,24(a5)
    21c6:	fe442783          	lw	a5,-28(s0)
    21ca:	2781                	sext.w	a5,a5
    21cc:	02f75563          	bge	a4,a5,21f6 <find_earliest_impactful_release_time_dm+0xe2>
    21d0:	fe843783          	ld	a5,-24(s0)
    21d4:	639c                	ld	a5,0(a5)
    21d6:	5fd8                	lw	a4,60(a5)
    21d8:	fd843783          	ld	a5,-40(s0)
    21dc:	5fdc                	lw	a5,60(a5)
    21de:	00f75c63          	bge	a4,a5,21f6 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    21e2:	fe843783          	ld	a5,-24(s0)
    21e6:	4f9c                	lw	a5,24(a5)
    21e8:	fef42223          	sw	a5,-28(s0)
                earliest_deadline_thread = entry->thrd;
    21ec:	fe843783          	ld	a5,-24(s0)
    21f0:	639c                	ld	a5,0(a5)
    21f2:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    21f6:	fe843783          	ld	a5,-24(s0)
    21fa:	679c                	ld	a5,8(a5)
    21fc:	fcf43423          	sd	a5,-56(s0)
    2200:	fc843783          	ld	a5,-56(s0)
    2204:	17e1                	addi	a5,a5,-8
    2206:	fef43423          	sd	a5,-24(s0)
    220a:	fe843783          	ld	a5,-24(s0)
    220e:	07a1                	addi	a5,a5,8
    2210:	fb843703          	ld	a4,-72(s0)
    2214:	f4f716e3          	bne	a4,a5,2160 <find_earliest_impactful_release_time_dm+0x4c>
            }
        }
    }
    ...
    2218:	fe442783          	lw	a5,-28(s0)
    221c:	0007871b          	sext.w	a4,a5
    2220:	800007b7          	lui	a5,0x80000
    2224:	fff7c793          	not	a5,a5
    2228:	00f70563          	beq	a4,a5,2232 <find_earliest_impactful_release_time_dm+0x11e>
    222c:	fe442783          	lw	a5,-28(s0)
    2230:	a011                	j	2234 <find_earliest_impactful_release_time_dm+0x120>
    2232:	57fd                	li	a5,-1
}
    2234:	853e                	mv	a0,a5
    2236:	6426                	ld	s0,72(sp)
    2238:	6161                	addi	sp,sp,80
    223a:	8082                	ret

000000000000223c <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    223c:	7175                	addi	sp,sp,-144
    223e:	e506                	sd	ra,136(sp)
    2240:	e122                	sd	s0,128(sp)
    2242:	fca6                	sd	s1,120(sp)
    2244:	f8ca                	sd	s2,112(sp)
    2246:	f4ce                	sd	s3,104(sp)
    2248:	0900                	addi	s0,sp,144
    224a:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    224c:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    2250:	800007b7          	lui	a5,0x80000
    2254:	fff7c793          	not	a5,a5
    2258:	faf42e23          	sw	a5,-68(s0)

    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    225c:	649c                	ld	a5,8(s1)
    225e:	639c                	ld	a5,0(a5)
    2260:	faf43823          	sd	a5,-80(s0)
    2264:	fb043783          	ld	a5,-80(s0)
    2268:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd2d8>
    226c:	fcf43023          	sd	a5,-64(s0)
    2270:	a089                	j	22b2 <schedule_dm+0x76>
        if (t->is_real_time && t->period < earliest_deadline) {
    2272:	fc043783          	ld	a5,-64(s0)
    2276:	43bc                	lw	a5,64(a5)
    2278:	c395                	beqz	a5,229c <schedule_dm+0x60>
    227a:	fc043783          	ld	a5,-64(s0)
    227e:	4bb8                	lw	a4,80(a5)
    2280:	fbc42783          	lw	a5,-68(s0)
    2284:	2781                	sext.w	a5,a5
    2286:	00f75b63          	bge	a4,a5,229c <schedule_dm+0x60>
            earliest_deadline_thread = t;
    228a:	fc043783          	ld	a5,-64(s0)
    228e:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    2292:	fc043783          	ld	a5,-64(s0)
    2296:	4bbc                	lw	a5,80(a5)
    2298:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    229c:	fc043783          	ld	a5,-64(s0)
    22a0:	779c                	ld	a5,40(a5)
    22a2:	f8f43c23          	sd	a5,-104(s0)
    22a6:	f9843783          	ld	a5,-104(s0)
    22aa:	fd878793          	addi	a5,a5,-40
    22ae:	fcf43023          	sd	a5,-64(s0)
    22b2:	fc043783          	ld	a5,-64(s0)
    22b6:	02878713          	addi	a4,a5,40
    22ba:	649c                	ld	a5,8(s1)
    22bc:	faf71be3          	bne	a4,a5,2272 <schedule_dm+0x36>
        }
    }
    ...
    22c4:	fbc42683          	lw	a3,-68(s0)
    22c8:	8636                	mv	a2,a3
    22ca:	85ba                	mv	a1,a4
    22cc:	853e                	mv	a0,a5
    22ce:	00000097          	auipc	ra,0x0
    22d2:	e46080e7          	jalr	-442(ra) # 2114 <find_earliest_impactful_release_time_dm>
    22d6:	87aa                	mv	a5,a0
    22d8:	faf42623          	sw	a5,-84(s0)

    if (earliest_deadline_thread) {
    22dc:	fc843783          	ld	a5,-56(s0)
    22e0:	c3c9                	beqz	a5,2362 <schedule_dm+0x126>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    22e2:	fc843783          	ld	a5,-56(s0)
    22e6:	4ff8                	lw	a4,92(a5)
    22e8:	409c                	lw	a5,0(s1)
    22ea:	40f707bb          	subw	a5,a4,a5
    22ee:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline < 0) {
    22f2:	fa842783          	lw	a5,-88(s0)
    22f6:	2781                	sext.w	a5,a5
    22f8:	0007db63          	bgez	a5,230e <schedule_dm+0xd2>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    22fc:	fc843783          	ld	a5,-56(s0)
    2300:	02878793          	addi	a5,a5,40
    2304:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    2308:	f8042023          	sw	zero,-128(s0)
    230c:	a88d                	j	237e <schedule_dm+0x142>
        } else {
    ...
    230e:	fac42783          	lw	a5,-84(s0)
    2312:	0007871b          	sext.w	a4,a5
    2316:	57fd                	li	a5,-1
    2318:	02f70563          	beq	a4,a5,2342 <schedule_dm+0x106>
    231c:	409c                	lw	a5,0(s1)
    231e:	fac42703          	lw	a4,-84(s0)
    2322:	40f707bb          	subw	a5,a4,a5
    2326:	0007871b          	sext.w	a4,a5
    232a:	fc843783          	ld	a5,-56(s0)
    232e:	4fbc                	lw	a5,88(a5)
    2330:	00f75963          	bge	a4,a5,2342 <schedule_dm+0x106>
    2334:	409c                	lw	a5,0(s1)
    2336:	fac42703          	lw	a4,-84(s0)
    233a:	40f707bb          	subw	a5,a4,a5
    233e:	2781                	sext.w	a5,a5
    2340:	a021                	j	2348 <schedule_dm+0x10c>
    2342:	fc843783          	ld	a5,-56(s0)
    2346:	4fbc                	lw	a5,88(a5)
    2348:	faf42223          	sw	a5,-92(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    234c:	fc843783          	ld	a5,-56(s0)
    2350:	02878793          	addi	a5,a5,40
    2354:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    2358:	fa442783          	lw	a5,-92(s0)
    235c:	f8f42023          	sw	a5,-128(s0)
    2360:	a839                	j	237e <schedule_dm+0x142>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    2362:	649c                	ld	a5,8(s1)
    2364:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    2368:	689c                	ld	a5,16(s1)
    236a:	4098                	lw	a4,0(s1)
    236c:	85ba                	mv	a1,a4
    236e:	853e                	mv	a0,a5
    2370:	fffff097          	auipc	ra,0xfffff
    2374:	7d2080e7          	jalr	2002(ra) # 1b42 <find_next_release_time>
    2378:	87aa                	mv	a5,a0
    237a:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    237e:	f7843783          	ld	a5,-136(s0)
    2382:	f8f43423          	sd	a5,-120(s0)
    2386:	f8043783          	ld	a5,-128(s0)
    238a:	f8f43823          	sd	a5,-112(s0)
    238e:	4701                	li	a4,0
    2390:	f8843703          	ld	a4,-120(s0)
    2394:	4781                	li	a5,0
    2396:	f9043783          	ld	a5,-112(s0)
    239a:	893a                	mv	s2,a4
    239c:	89be                	mv	s3,a5
    239e:	874a                	mv	a4,s2
    23a0:	87ce                	mv	a5,s3
    ...
    23a2:	853a                	mv	a0,a4
    23a4:	85be                	mv	a1,a5
    23a6:	60aa                	ld	ra,136(sp)
    23a8:	640a                	ld	s0,128(sp)
    23aa:	74e6                	ld	s1,120(sp)
    23ac:	7946                	ld	s2,112(sp)
    23ae:	79a6                	ld	s3,104(sp)
    23b0:	6149                	addi	sp,sp,144
    23b2:	8082                	ret

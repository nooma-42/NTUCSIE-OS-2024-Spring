...
static inline void list_del(struct list_head *entry)
{
    ...
    entry->next = LIST_POISON1;
      ...
      ca:	10070713          	addi	a4,a4,256 # 100100 <__global_pointer$+0xfd768>
      ce:	e398                	sd	a4,0(a5)
    entry->prev = LIST_POISON2;
      d0:	fe843783          	ld	a5,-24(s0)
      d4:	00200737          	lui	a4,0x200
      d8:	20070713          	addi	a4,a4,512 # 200200 <__global_pointer$+0x1fd868>
      dc:	e798                	sd	a4,8(a5)
}
      de:	0001                	nop
      e0:	60e2                	ld	ra,24(sp)
...
struct thread *thread_create(void (*f)(void *), void *arg, int is_real_time, int processing_time, int period, int n)
{
    ...
    t->ID = _id++;
     ...
     188:	04c78793          	addi	a5,a5,76 # 21d0 <_id.1229>
     18c:	439c                	lw	a5,0(a5)
     18e:	0017871b          	addiw	a4,a5,1
     192:	0007069b          	sext.w	a3,a4
     196:	00002717          	auipc	a4,0x2
     19a:	03a70713          	addi	a4,a4,58 # 21d0 <_id.1229>
     19e:	c314                	sw	a3,0(a4)
...
void thread_add_at(struct thread *t, int arrival_time)
{
    ...
    list_add_tail(&new_entry->thread_list, &release_queue);
     ...
     2a6:	f0658593          	addi	a1,a1,-250 # 21a8 <release_queue>
     2aa:	853e                	mv	a0,a5
...
void __release()
{
    ...
    list_for_each_entry_safe(cur, nxt, &release_queue, thread_list) {
     ...
     2ca:	ee278793          	addi	a5,a5,-286 # 21a8 <release_queue>
     2ce:	639c                	ld	a5,0(a5)
     ...
     2fe:	ee678793          	addi	a5,a5,-282 # 21e0 <threading_system_time>
     302:	439c                	lw	a5,0(a5)
     ...
     340:	e5c58593          	addi	a1,a1,-420 # 2198 <run_queue>
     344:	853e                	mv	a0,a5
    ...
    list_for_each_entry_safe(cur, nxt, &release_queue, thread_list) {
     ...
     392:	e1a78793          	addi	a5,a5,-486 # 21a8 <release_queue>
...
void __thread_exit(struct thread *to_remove)
{
    ...
    current = to_remove->thread_list.prev;
     ...
     3bc:	e2078793          	addi	a5,a5,-480 # 21d8 <current>
     3c0:	e398                	sd	a4,0(a5)
    ...
    thrdresume(main_thrd_id);
     ...
     404:	dcc78793          	addi	a5,a5,-564 # 21cc <main_thrd_id>
     408:	439c                	lw	a5,0(a5)
     40a:	853e                	mv	a0,a5
...
void thread_exit(void)
{
    ...
    if (current == &run_queue) {
     ...
     42a:	db278793          	addi	a5,a5,-590 # 21d8 <current>
     42e:	6398                	ld	a4,0(a5)
     430:	00002797          	auipc	a5,0x2
     434:	d6878793          	addi	a5,a5,-664 # 2198 <run_queue>
     ...
     440:	bec58593          	addi	a1,a1,-1044 # 2028 <schedule_dm+0x20c>
     444:	4509                	li	a0,2
    ...
    struct thread *to_remove = list_entry(current, struct thread, thread_list);
     ...
     45c:	d8078793          	addi	a5,a5,-640 # 21d8 <current>
     460:	639c                	ld	a5,0(a5)
    ...
    threading_system_time += consume_ticks;
     ...
     48e:	d5678793          	addi	a5,a5,-682 # 21e0 <threading_system_time>
     492:	439c                	lw	a5,0(a5)
     494:	fdc42703          	lw	a4,-36(s0)
     498:	9fb9                	addw	a5,a5,a4
     49a:	0007871b          	sext.w	a4,a5
     49e:	00002797          	auipc	a5,0x2
     4a2:	d4278793          	addi	a5,a5,-702 # 21e0 <threading_system_time>
     4a6:	c398                	sw	a4,0(a5)
...
void __finish_current()
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     4d2:	d0a78793          	addi	a5,a5,-758 # 21d8 <current>
     4d6:	639c                	ld	a5,0(a5)
    ...
    printf("thread#%d finish at %d\n",
     ...
     504:	ce078793          	addi	a5,a5,-800 # 21e0 <threading_system_time>
     508:	4390                	lw	a2,0(a5)
     ...
     518:	b4c50513          	addi	a0,a0,-1204 # 2060 <schedule_dm+0x244>
    ...
    if (current_thread->n > 0) {
     ...
     532:	caa78793          	addi	a5,a5,-854 # 21d8 <current>
     536:	639c                	ld	a5,0(a5)
     538:	fcf43c23          	sd	a5,-40(s0)
        current = current->prev;
     53c:	00002797          	auipc	a5,0x2
     540:	c9c78793          	addi	a5,a5,-868 # 21d8 <current>
     544:	639c                	ld	a5,0(a5)
     546:	6798                	ld	a4,8(a5)
     548:	00002797          	auipc	a5,0x2
     54c:	c9078793          	addi	a5,a5,-880 # 21d8 <current>
     550:	e398                	sd	a4,0(a5)
        list_del(to_remove);
...
void __rt_finish_current()
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     596:	c4678793          	addi	a5,a5,-954 # 21d8 <current>
     59a:	639c                	ld	a5,0(a5)
    ...
    printf("thread#%d finish one cycle at %d: %d cycles left\n",
     ...
     5c8:	c1c78793          	addi	a5,a5,-996 # 21e0 <threading_system_time>
     5cc:	4390                	lw	a2,0(a5)
     ...
     5dc:	aa050513          	addi	a0,a0,-1376 # 2078 <schedule_dm+0x25c>
    ...
    if (current_thread->n > 0) {
     ...
     5f6:	be678793          	addi	a5,a5,-1050 # 21d8 <current>
     5fa:	639c                	ld	a5,0(a5)
     5fc:	fcf43c23          	sd	a5,-40(s0)
        current = current->prev;
     600:	00002797          	auipc	a5,0x2
     604:	bd878793          	addi	a5,a5,-1064 # 21d8 <current>
     608:	639c                	ld	a5,0(a5)
     60a:	6798                	ld	a4,8(a5)
     60c:	00002797          	auipc	a5,0x2
     610:	bcc78793          	addi	a5,a5,-1076 # 21d8 <current>
     614:	e398                	sd	a4,0(a5)
        list_del(to_remove);
...
void switch_handler(void *arg)
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     666:	b7678793          	addi	a5,a5,-1162 # 21d8 <current>
     66a:	639c                	ld	a5,0(a5)
    ...
    threading_system_time += elapsed_time;
     ...
     688:	b5c78793          	addi	a5,a5,-1188 # 21e0 <threading_system_time>
     68c:	439c                	lw	a5,0(a5)
     ...
     69c:	b4878793          	addi	a5,a5,-1208 # 21e0 <threading_system_time>
     6a0:	c398                	sw	a4,0(a5)
     __release();
    ...
    if (current_thread->is_real_time)
     ...
     6dc:	b0878793          	addi	a5,a5,-1272 # 21e0 <threading_system_time>
     6e0:	439c                	lw	a5,0(a5)
     ...
     6f0:	af478793          	addi	a5,a5,-1292 # 21e0 <threading_system_time>
     6f4:	439c                	lw	a5,0(a5)
        if (threading_system_time > current_thread->current_deadline || 
     ...
     70e:	ad678793          	addi	a5,a5,-1322 # 21e0 <threading_system_time>
     712:	439c                	lw	a5,0(a5)
     714:	863e                	mv	a2,a5
     716:	85ba                	mv	a1,a4
     718:	00002517          	auipc	a0,0x2
     71c:	99850513          	addi	a0,a0,-1640 # 20b0 <schedule_dm+0x294>
    ...
    if (current_thread->remaining_time <= 0) {
     ...
     75c:	a8078793          	addi	a5,a5,-1408 # 21d8 <current>
     760:	639c                	ld	a5,0(a5)
     762:	fcf43823          	sd	a5,-48(s0)
        current = current->prev;
     766:	00002797          	auipc	a5,0x2
     76a:	a7278793          	addi	a5,a5,-1422 # 21d8 <current>
     76e:	639c                	ld	a5,0(a5)
     770:	6798                	ld	a4,8(a5)
     772:	00002797          	auipc	a5,0x2
     776:	a6678793          	addi	a5,a5,-1434 # 21d8 <current>
     77a:	e398                	sd	a4,0(a5)
        list_del(to_remove);
     ...
     78c:	a1058593          	addi	a1,a1,-1520 # 2198 <run_queue>
    ...
    thrdresume(main_thrd_id);
     ...
     7b8:	a1878793          	addi	a5,a5,-1512 # 21cc <main_thrd_id>
     7bc:	439c                	lw	a5,0(a5)
     7be:	853e                	mv	a0,a5
...
void __dispatch()
{
    ...
    if (current == &run_queue) {
     ...
     7de:	9fe78793          	addi	a5,a5,-1538 # 21d8 <current>
     7e2:	6398                	ld	a4,0(a5)
     7e4:	00002797          	auipc	a5,0x2
     7e8:	9b478793          	addi	a5,a5,-1612 # 2198 <run_queue>
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     7f4:	9e878793          	addi	a5,a5,-1560 # 21d8 <current>
     7f8:	639c                	ld	a5,0(a5)
    ...
    if (current_thread->is_real_time && allocated_time == 0) { // miss deadline, abort
     ...
     816:	9d678793          	addi	a5,a5,-1578 # 21e8 <allocated_time>
     81a:	639c                	ld	a5,0(a5)
     ...
     832:	88250513          	addi	a0,a0,-1918 # 20b0 <schedule_dm+0x294>
    ...
    printf("dispatch thread#%d at %d: allocated_time=%d\n", current_thread->ID, threading_system_time, allocated_time);
     ...
     852:	99278793          	addi	a5,a5,-1646 # 21e0 <threading_system_time>
     856:	4390                	lw	a2,0(a5)
     858:	00002797          	auipc	a5,0x2
     85c:	99078793          	addi	a5,a5,-1648 # 21e8 <allocated_time>
     860:	639c                	ld	a5,0(a5)
     862:	86be                	mv	a3,a5
     864:	85ba                	mv	a1,a4
     866:	00002517          	auipc	a0,0x2
     86a:	87250513          	addi	a0,a0,-1934 # 20d8 <schedule_dm+0x2bc>
    ...
    if (current_thread->buf_set) {
     ...
     920:	7ec58593          	addi	a1,a1,2028 # 2108 <schedule_dm+0x2ec>
     924:	4509                	li	a0,2
...
void __schedule()
{
    ...
    struct threads_sched_args args = {
     ...
     96e:	87678793          	addi	a5,a5,-1930 # 21e0 <threading_system_time>
     972:	439c                	lw	a5,0(a5)
     974:	fcf42c23          	sw	a5,-40(s0)
     978:	4789                	li	a5,2
     97a:	fcf42e23          	sw	a5,-36(s0)
     97e:	00002797          	auipc	a5,0x2
     982:	81a78793          	addi	a5,a5,-2022 # 2198 <run_queue>
     986:	fef43023          	sd	a5,-32(s0)
     98a:	00002797          	auipc	a5,0x2
     98e:	81e78793          	addi	a5,a5,-2018 # 21a8 <release_queue>
    ...
    r = schedule_sjf(args);
     ...
     9b8:	18e080e7          	jalr	398(ra) # 1b42 <schedule_sjf>
     9bc:	872a                	mv	a4,a0
     9be:	87ae                	mv	a5,a1
    ...
    current = r.scheduled_thread_list_member;
     ...
     9d0:	80c78793          	addi	a5,a5,-2036 # 21d8 <current>
     9d4:	e398                	sd	a4,0(a5)
    allocated_time = r.allocated_time;
     9d6:	fd042783          	lw	a5,-48(s0)
     9da:	873e                	mv	a4,a5
     9dc:	00002797          	auipc	a5,0x2
     9e0:	80c78793          	addi	a5,a5,-2036 # 21e8 <allocated_time>
     9e4:	e398                	sd	a4,0(a5)
}
     9e6:	0001                	nop
...
void back_to_main_handler(void *arg)
{
    ...
    sleeping = 0;
     ...
     a00:	7e878793          	addi	a5,a5,2024 # 21e4 <sleeping>
    ...
    threading_system_time += (uint64)arg;
     ...
     a14:	7d078793          	addi	a5,a5,2000 # 21e0 <threading_system_time>
     a18:	439c                	lw	a5,0(a5)
     ...
     a28:	7bc78793          	addi	a5,a5,1980 # 21e0 <threading_system_time>
     a2c:	c398                	sw	a4,0(a5)
    thrdresume(main_thrd_id);
     a2e:	00001797          	auipc	a5,0x1
     a32:	79e78793          	addi	a5,a5,1950 # 21cc <main_thrd_id>
     a36:	439c                	lw	a5,0(a5)
     a38:	853e                	mv	a0,a5
...
void thread_start_threading()
{
    ...
    threading_system_time = 0;
     ...
     a58:	78c78793          	addi	a5,a5,1932 # 21e0 <threading_system_time>
     a5c:	0007a023          	sw	zero,0(a5)
    current = &run_queue;
     a60:	00001797          	auipc	a5,0x1
     a64:	77878793          	addi	a5,a5,1912 # 21d8 <current>
     a68:	00001717          	auipc	a4,0x1
     a6c:	73070713          	addi	a4,a4,1840 # 2198 <run_queue>
     a70:	e398                	sd	a4,0(a5)
    ...
    thrdstop(1000, &main_thrd_id, back_to_main_handler, (void *)0);
     ...
     a80:	75058593          	addi	a1,a1,1872 # 21cc <main_thrd_id>
    ...
    cancelthrdstop(main_thrd_id, 0);
     ...
     a94:	73c78793          	addi	a5,a5,1852 # 21cc <main_thrd_id>
     a98:	439c                	lw	a5,0(a5)
     a9a:	4581                	li	a1,0
     a9c:	853e                	mv	a0,a5
    ...
    while (!list_empty(&run_queue) || !list_empty(&release_queue)) {
     ...
     abc:	71478793          	addi	a5,a5,1812 # 21cc <main_thrd_id>
     ac0:	439c                	lw	a5,0(a5)
     ac2:	4581                	li	a1,0
     ac4:	853e                	mv	a0,a5
     ...
     ada:	6c250513          	addi	a0,a0,1730 # 2198 <run_queue>
     ...
     aee:	6be50513          	addi	a0,a0,1726 # 21a8 <release_queue>
     ...
     b60:	68878793          	addi	a5,a5,1672 # 21e4 <sleeping>
     b64:	439c                	lw	a5,0(a5)
     b66:	fbfd                	bnez	a5,b5c <thread_start_threading+0x110>
    while (!list_empty(&run_queue) || !list_empty(&release_queue)) {
     b68:	00001517          	auipc	a0,0x1
     b6c:	63050513          	addi	a0,a0,1584 # 2198 <run_queue>
     ...
     b80:	62c50513          	addi	a0,a0,1580 # 21a8 <release_queue>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1196:	02668693          	addi	a3,a3,38 # 21b8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1270:	f4c70713          	addi	a4,a4,-180 # 21b8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1430:	d3c78793          	addi	a5,a5,-708 # 2168 <schedule_dm+0x34c>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    15dc:	c2878793          	addi	a5,a5,-984 # 2200 <freep>
  ...
  freep = p;
    ...
    16d4:	b3078793          	addi	a5,a5,-1232 # 2200 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1756:	aae78793          	addi	a5,a5,-1362 # 2200 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1788:	a7c78793          	addi	a5,a5,-1412 # 2200 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1846:	9be78793          	addi	a5,a5,-1602 # 2200 <freep>
    ...
    185c:	9a878793          	addi	a5,a5,-1624 # 2200 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    19f4:	81878793          	addi	a5,a5,-2024 # 2208 <last_thread.1226>
    19f8:	639c                	ld	a5,0(a5)
    19fa:	cb89                	beqz	a5,1a0c <schedule_wrr+0x2e>
    19fc:	00001797          	auipc	a5,0x1
    1a00:	80c78793          	addi	a5,a5,-2036 # 2208 <last_thread.1226>
    1a04:	639c                	ld	a5,0(a5)
    1a06:	4fbc                	lw	a5,88(a5)
    1a08:	00f04863          	bgtz	a5,1a18 <schedule_wrr+0x3a>
        last_thread = NULL;
    1a0c:	00000797          	auipc	a5,0x0
    1a10:	7fc78793          	addi	a5,a5,2044 # 2208 <last_thread.1226>
    ...
    1a32:	7da78793          	addi	a5,a5,2010 # 2208 <last_thread.1226>
    ...
    1af6:	00000797          	auipc	a5,0x0
    1afa:	71278793          	addi	a5,a5,1810 # 2208 <last_thread.1226>
...
0000000000001b42 <schedule_sjf>:

struct threads_sched_result schedule_sjf(struct threads_sched_args args)
{
    1b42:	7119                	addi	sp,sp,-128
    1b44:	fc86                	sd	ra,120(sp)
    1b46:	f8a2                	sd	s0,112(sp)
    1b48:	f4a6                	sd	s1,104(sp)
    1b4a:	f0ca                	sd	s2,96(sp)
    1b4c:	ecce                	sd	s3,88(sp)
    1b4e:	0100                	addi	s0,sp,128
    1b50:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the shortest-job-first scheduling algorithm
    struct thread *shortest_job = NULL;
    1b52:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int shortest_time = INT_MAX;
    1b56:	800007b7          	lui	a5,0x80000
    1b5a:	fff7c793          	not	a5,a5
    1b5e:	faf42e23          	sw	a5,-68(s0)

    // Find the thread with the shortest remaining time that is ready to run
    list_for_each_entry(t, args.run_queue, thread_list) {
    1b62:	649c                	ld	a5,8(s1)
    1b64:	639c                	ld	a5,0(a5)
    1b66:	faf43823          	sd	a5,-80(s0)
    1b6a:	fb043783          	ld	a5,-80(s0)
    1b6e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd640>
    1b72:	fcf43023          	sd	a5,-64(s0)
    1b76:	a8a9                	j	1bd0 <schedule_sjf+0x8e>
        printf("Thread ID: %d, Remaining Time: %d\n", t->ID, t->remaining_time);
    1b78:	fc043783          	ld	a5,-64(s0)
    1b7c:	5fd8                	lw	a4,60(a5)
    1b7e:	fc043783          	ld	a5,-64(s0)
    1b82:	4fbc                	lw	a5,88(a5)
    1b84:	863e                	mv	a2,a5
    1b86:	85ba                	mv	a1,a4
    1b88:	00000517          	auipc	a0,0x0
    1b8c:	5e850513          	addi	a0,a0,1512 # 2170 <schedule_dm+0x354>
    1b90:	00000097          	auipc	ra,0x0
    1b94:	9e4080e7          	jalr	-1564(ra) # 1574 <printf>
        if (t->remaining_time < shortest_time) {
    1b98:	fc043783          	ld	a5,-64(s0)
    1b9c:	4fb8                	lw	a4,88(a5)
    1b9e:	fbc42783          	lw	a5,-68(s0)
    1ba2:	2781                	sext.w	a5,a5
    1ba4:	00f75b63          	bge	a4,a5,1bba <schedule_sjf+0x78>
            shortest_time = t->remaining_time;
    1ba8:	fc043783          	ld	a5,-64(s0)
    1bac:	4fbc                	lw	a5,88(a5)
    1bae:	faf42e23          	sw	a5,-68(s0)
            shortest_job = t;
    1bb2:	fc043783          	ld	a5,-64(s0)
    1bb6:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1bba:	fc043783          	ld	a5,-64(s0)
    1bbe:	779c                	ld	a5,40(a5)
    1bc0:	faf43423          	sd	a5,-88(s0)
    1bc4:	fa843783          	ld	a5,-88(s0)
    1bc8:	fd878793          	addi	a5,a5,-40
    1bcc:	fcf43023          	sd	a5,-64(s0)
    1bd0:	fc043783          	ld	a5,-64(s0)
    1bd4:	02878713          	addi	a4,a5,40
    1bd8:	649c                	ld	a5,8(s1)
    1bda:	f8f71fe3          	bne	a4,a5,1b78 <schedule_sjf+0x36>
        }
    }

    if (shortest_job) {
    1bde:	fc843783          	ld	a5,-56(s0)
    1be2:	cf89                	beqz	a5,1bfc <schedule_sjf+0xba>
        r.scheduled_thread_list_member = &shortest_job->thread_list;
    1be4:	fc843783          	ld	a5,-56(s0)
    1be8:	02878793          	addi	a5,a5,40
    1bec:	f8f43423          	sd	a5,-120(s0)
    ...
    1bf6:	f8f42823          	sw	a5,-112(s0)
    1bfa:	a039                	j	1c08 <schedule_sjf+0xc6>
    } else {
        // If no threads are ready, find the next release time or idle
        r.scheduled_thread_list_member = args.run_queue;
    1bfc:	649c                	ld	a5,8(s1)
    1bfe:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;  // Default minimal quantum if unsure
    1c02:	4785                	li	a5,1
    1c04:	f8f42823          	sw	a5,-112(s0)
    }
    return r;
    1c08:	f8843783          	ld	a5,-120(s0)
    1c0c:	f8f43c23          	sd	a5,-104(s0)
    1c10:	f9043783          	ld	a5,-112(s0)
    1c14:	faf43023          	sd	a5,-96(s0)
    1c18:	4701                	li	a4,0
    1c1a:	f9843703          	ld	a4,-104(s0)
    1c1e:	4781                	li	a5,0
    1c20:	fa043783          	ld	a5,-96(s0)
    1c24:	893a                	mv	s2,a4
    1c26:	89be                	mv	s3,a5
    1c28:	874a                	mv	a4,s2
    1c2a:	87ce                	mv	a5,s3
    ...
    1c2c:	853a                	mv	a0,a4
    1c2e:	85be                	mv	a1,a5
    1c30:	70e6                	ld	ra,120(sp)
    1c32:	7446                	ld	s0,112(sp)
    1c34:	74a6                	ld	s1,104(sp)
    1c36:	7906                	ld	s2,96(sp)
    1c38:	69e6                	ld	s3,88(sp)
    1c3a:	6109                	addi	sp,sp,128
    1c3c:	8082                	ret

0000000000001c3e <find_next_release_time>:

int find_next_release_time(struct list_head *release_queue, int current_time) {
    1c3e:	7139                	addi	sp,sp,-64
    1c40:	fc22                	sd	s0,56(sp)
    1c42:	0080                	addi	s0,sp,64
    1c44:	fca43423          	sd	a0,-56(s0)
    1c48:	87ae                	mv	a5,a1
    1c4a:	fcf42223          	sw	a5,-60(s0)
    struct release_queue_entry *next_release = NULL;
    1c4e:	fe043423          	sd	zero,-24(s0)
    int next_release_time = INT_MAX;
    1c52:	800007b7          	lui	a5,0x80000
    1c56:	fff7c793          	not	a5,a5
    1c5a:	fef42223          	sw	a5,-28(s0)

    list_for_each_entry(next_release, release_queue, thread_list) {
    1c5e:	fc843783          	ld	a5,-56(s0)
    1c62:	639c                	ld	a5,0(a5)
    1c64:	fcf43c23          	sd	a5,-40(s0)
    1c68:	fd843783          	ld	a5,-40(s0)
    1c6c:	17e1                	addi	a5,a5,-8
    1c6e:	fef43423          	sd	a5,-24(s0)
    1c72:	a081                	j	1cb2 <find_next_release_time+0x74>
        if (next_release->release_time > current_time &&
    1c74:	fe843783          	ld	a5,-24(s0)
    1c78:	4f98                	lw	a4,24(a5)
    1c7a:	fc442783          	lw	a5,-60(s0)
    1c7e:	2781                	sext.w	a5,a5
    1c80:	00e7df63          	bge	a5,a4,1c9e <find_next_release_time+0x60>
            next_release->release_time < next_release_time) {
    1c84:	fe843783          	ld	a5,-24(s0)
    1c88:	4f98                	lw	a4,24(a5)
        if (next_release->release_time > current_time &&
    1c8a:	fe442783          	lw	a5,-28(s0)
    1c8e:	2781                	sext.w	a5,a5
    1c90:	00f75763          	bge	a4,a5,1c9e <find_next_release_time+0x60>
            next_release_time = next_release->release_time;
    1c94:	fe843783          	ld	a5,-24(s0)
    1c98:	4f9c                	lw	a5,24(a5)
    1c9a:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(next_release, release_queue, thread_list) {
    1c9e:	fe843783          	ld	a5,-24(s0)
    1ca2:	679c                	ld	a5,8(a5)
    1ca4:	fcf43823          	sd	a5,-48(s0)
    1ca8:	fd043783          	ld	a5,-48(s0)
    1cac:	17e1                	addi	a5,a5,-8
    1cae:	fef43423          	sd	a5,-24(s0)
    1cb2:	fe843783          	ld	a5,-24(s0)
    1cb6:	07a1                	addi	a5,a5,8
    1cb8:	fc843703          	ld	a4,-56(s0)
    1cbc:	faf71ce3          	bne	a4,a5,1c74 <find_next_release_time+0x36>
        }
    }

    if (next_release_time == INT_MAX)
    1cc0:	fe442783          	lw	a5,-28(s0)
    1cc4:	0007871b          	sext.w	a4,a5
    1cc8:	800007b7          	lui	a5,0x80000
    1ccc:	fff7c793          	not	a5,a5
    1cd0:	00f71463          	bne	a4,a5,1cd8 <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    1cd4:	57fd                	li	a5,-1
    1cd6:	a801                	j	1ce6 <find_next_release_time+0xa8>

    return next_release_time - current_time;
    1cd8:	fe442703          	lw	a4,-28(s0)
    1cdc:	fc442783          	lw	a5,-60(s0)
    1ce0:	40f707bb          	subw	a5,a4,a5
    1ce4:	2781                	sext.w	a5,a5
}
    1ce6:	853e                	mv	a0,a5
...
0000000000001cee <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args)
{
    1cee:	7119                	addi	sp,sp,-128
    1cf0:	fc86                	sd	ra,120(sp)
    1cf2:	f8a2                	sd	s0,112(sp)
    1cf4:	f4a6                	sd	s1,104(sp)
    1cf6:	f0ca                	sd	s2,96(sp)
    1cf8:	ecce                	sd	s3,88(sp)
    1cfa:	0100                	addi	s0,sp,128
    1cfc:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the least-slack-time scheduling algorithm
    struct thread *min_slack = NULL;
    1cfe:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    1d02:	800007b7          	lui	a5,0x80000
    1d06:	fff7c793          	not	a5,a5
    1d0a:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    ...
    1d12:	faf43823          	sd	a5,-80(s0)
    1d16:	fb043783          	ld	a5,-80(s0)
    1d1a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd640>
    1d1e:	faf43c23          	sd	a5,-72(s0)
    1d22:	a8b5                	j	1d9e <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    1d24:	fb843783          	ld	a5,-72(s0)
    1d28:	47f8                	lw	a4,76(a5)
    1d2a:	409c                	lw	a5,0(s1)
    1d2c:	40f707bb          	subw	a5,a4,a5
    1d30:	0007871b          	sext.w	a4,a5
    1d34:	fb843783          	ld	a5,-72(s0)
    1d38:	4fbc                	lw	a5,88(a5)
    1d3a:	40f707bb          	subw	a5,a4,a5
    1d3e:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    1d42:	fc843783          	ld	a5,-56(s0)
    1d46:	cb8d                	beqz	a5,1d78 <schedule_lst+0x8a>
    1d48:	fac42703          	lw	a4,-84(s0)
    1d4c:	fc442783          	lw	a5,-60(s0)
    1d50:	2701                	sext.w	a4,a4
    1d52:	2781                	sext.w	a5,a5
    1d54:	02f74263          	blt	a4,a5,1d78 <schedule_lst+0x8a>
    1d58:	fac42703          	lw	a4,-84(s0)
    1d5c:	fc442783          	lw	a5,-60(s0)
    1d60:	2701                	sext.w	a4,a4
    1d62:	2781                	sext.w	a5,a5
    1d64:	02f71263          	bne	a4,a5,1d88 <schedule_lst+0x9a>
    ...
    1da8:	f6f71ee3          	bne	a4,a5,1d24 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    1dac:	fc843783          	ld	a5,-56(s0)
    1db0:	cf89                	beqz	a5,1dca <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    1db2:	fc843783          	ld	a5,-56(s0)
    1db6:	02878793          	addi	a5,a5,40
    1dba:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    1dbe:	fc843783          	ld	a5,-56(s0)
    1dc2:	4fbc                	lw	a5,88(a5)
    1dc4:	f8f42423          	sw	a5,-120(s0)
    1dc8:	a839                	j	1de6 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    1dca:	649c                	ld	a5,8(s1)
    1dcc:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1dd0:	689c                	ld	a5,16(s1)
    1dd2:	4098                	lw	a4,0(s1)
    1dd4:	85ba                	mv	a1,a4
    1dd6:	853e                	mv	a0,a5
    1dd8:	00000097          	auipc	ra,0x0
    1ddc:	e66080e7          	jalr	-410(ra) # 1c3e <find_next_release_time>
    1de0:	87aa                	mv	a5,a0
    1de2:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    1de6:	f8043783          	ld	a5,-128(s0)
    1dea:	f8f43823          	sd	a5,-112(s0)
    1dee:	f8843783          	ld	a5,-120(s0)
    1df2:	f8f43c23          	sd	a5,-104(s0)
    1df6:	4701                	li	a4,0
    1df8:	f9043703          	ld	a4,-112(s0)
    1dfc:	4781                	li	a5,0
    1dfe:	f9843783          	ld	a5,-104(s0)
    1e02:	893a                	mv	s2,a4
    1e04:	89be                	mv	s3,a5
    1e06:	874a                	mv	a4,s2
    1e08:	87ce                	mv	a5,s3
    ...
    1e0a:	853a                	mv	a0,a4
    1e0c:	85be                	mv	a1,a5
    1e0e:	70e6                	ld	ra,120(sp)
    1e10:	7446                	ld	s0,112(sp)
    1e12:	74a6                	ld	s1,104(sp)
    1e14:	7906                	ld	s2,96(sp)
    1e16:	69e6                	ld	s3,88(sp)
    1e18:	6109                	addi	sp,sp,128
    1e1a:	8082                	ret

0000000000001e1c <schedule_dm>:
...
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    ...
    1e28:	1100                	addi	s0,sp,160
    1e2a:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    1e2c:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    1e30:	800007b7          	lui	a5,0x80000
    1e34:	fff7c793          	not	a5,a5
    1e38:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    1e3c:	649c                	ld	a5,8(s1)
    1e3e:	639c                	ld	a5,0(a5)
    1e40:	faf43423          	sd	a5,-88(s0)
    1e44:	fa843783          	ld	a5,-88(s0)
    1e48:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd640>
    1e4c:	fcf43023          	sd	a5,-64(s0)
    1e50:	a841                	j	1ee0 <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    1e52:	fc043783          	ld	a5,-64(s0)
    1e56:	43bc                	lw	a5,64(a5)
    1e58:	cb95                	beqz	a5,1e8c <schedule_dm+0x70>
    1e5a:	fc043783          	ld	a5,-64(s0)
    1e5e:	4bbc                	lw	a5,80(a5)
    1e60:	873e                	mv	a4,a5
    1e62:	57fd                	li	a5,-1
    1e64:	02f70463          	beq	a4,a5,1e8c <schedule_dm+0x70>
    1e68:	fc043783          	ld	a5,-64(s0)
    1e6c:	4ff8                	lw	a4,92(a5)
    1e6e:	fbc42783          	lw	a5,-68(s0)
    1e72:	2781                	sext.w	a5,a5
    1e74:	00f75c63          	bge	a4,a5,1e8c <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    1e78:	fc043783          	ld	a5,-64(s0)
    1e7c:	4ffc                	lw	a5,92(a5)
    1e7e:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    1e82:	fc043783          	ld	a5,-64(s0)
    1e86:	fcf43423          	sd	a5,-56(s0)
    1e8a:	a081                	j	1eca <schedule_dm+0xae>
    ...
    1e90:	43bc                	lw	a5,64(a5)
    1e92:	cf85                	beqz	a5,1eca <schedule_dm+0xae>
    1e94:	fc043783          	ld	a5,-64(s0)
    1e98:	4bbc                	lw	a5,80(a5)
    1e9a:	873e                	mv	a4,a5
    1e9c:	57fd                	li	a5,-1
    1e9e:	02f70663          	beq	a4,a5,1eca <schedule_dm+0xae>
    1ea2:	fc043783          	ld	a5,-64(s0)
    1ea6:	4ff8                	lw	a4,92(a5)
    1ea8:	fbc42783          	lw	a5,-68(s0)
    1eac:	2781                	sext.w	a5,a5
    1eae:	00e79e63          	bne	a5,a4,1eca <schedule_dm+0xae>
    1eb2:	fc043783          	ld	a5,-64(s0)
    1eb6:	5fd8                	lw	a4,60(a5)
    1eb8:	fc843783          	ld	a5,-56(s0)
    1ebc:	5fdc                	lw	a5,60(a5)
    1ebe:	00f75663          	bge	a4,a5,1eca <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    1ec2:	fc043783          	ld	a5,-64(s0)
    1ec6:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1eca:	fc043783          	ld	a5,-64(s0)
    1ece:	779c                	ld	a5,40(a5)
    1ed0:	f8f43423          	sd	a5,-120(s0)
    1ed4:	f8843783          	ld	a5,-120(s0)
    1ed8:	fd878793          	addi	a5,a5,-40
    1edc:	fcf43023          	sd	a5,-64(s0)
    1ee0:	fc043783          	ld	a5,-64(s0)
    1ee4:	02878713          	addi	a4,a5,40
    1ee8:	649c                	ld	a5,8(s1)
    1eea:	f6f714e3          	bne	a4,a5,1e52 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    1eee:	fc843783          	ld	a5,-56(s0)
    1ef2:	c7a5                	beqz	a5,1f5a <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    1ef4:	fc843783          	ld	a5,-56(s0)
    1ef8:	4ff8                	lw	a4,92(a5)
    1efa:	409c                	lw	a5,0(s1)
    1efc:	40f707bb          	subw	a5,a4,a5
    1f00:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    1f04:	fc843783          	ld	a5,-56(s0)
    1f08:	4fb8                	lw	a4,88(a5)
    1f0a:	f9442783          	lw	a5,-108(s0)
    1f0e:	2781                	sext.w	a5,a5
    1f10:	00e7db63          	bge	a5,a4,1f26 <schedule_dm+0x10a>
    ...
    1f1c:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    1f20:	f6042823          	sw	zero,-144(s0)
    1f24:	a0f1                	j	1ff0 <schedule_dm+0x1d4>
        } else {
    ...
    1f26:	fc843783          	ld	a5,-56(s0)
    1f2a:	4fbc                	lw	a5,88(a5)
    1f2c:	863e                	mv	a2,a5
    1f2e:	f9442783          	lw	a5,-108(s0)
    1f32:	0007869b          	sext.w	a3,a5
    1f36:	0006071b          	sext.w	a4,a2
    1f3a:	00d75363          	bge	a4,a3,1f40 <schedule_dm+0x124>
    1f3e:	87b2                	mv	a5,a2
    1f40:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1f44:	fc843783          	ld	a5,-56(s0)
    1f48:	02878793          	addi	a5,a5,40
    1f4c:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    1f50:	f9042783          	lw	a5,-112(s0)
    1f54:	f6f42823          	sw	a5,-144(s0)
    1f58:	a861                	j	1ff0 <schedule_dm+0x1d4>
        }
    } else {
    ...
    1f72:	a81d                	j	1fa8 <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    1f74:	fb043783          	ld	a5,-80(s0)
    1f78:	cb89                	beqz	a5,1f8a <schedule_dm+0x16e>
    1f7a:	fc043783          	ld	a5,-64(s0)
    1f7e:	5fd8                	lw	a4,60(a5)
    1f80:	fb043783          	ld	a5,-80(s0)
    1f84:	5fdc                	lw	a5,60(a5)
    1f86:	00f75663          	bge	a4,a5,1f92 <schedule_dm+0x176>
                smallest_id_thread = t;
    1f8a:	fc043783          	ld	a5,-64(s0)
    1f8e:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    1f92:	fc043783          	ld	a5,-64(s0)
    1f96:	779c                	ld	a5,40(a5)
    1f98:	f8f43c23          	sd	a5,-104(s0)
    1f9c:	f9843783          	ld	a5,-104(s0)
    1fa0:	fd878793          	addi	a5,a5,-40
    1fa4:	fcf43023          	sd	a5,-64(s0)
    1fa8:	fc043783          	ld	a5,-64(s0)
    1fac:	02878713          	addi	a4,a5,40
    1fb0:	649c                	ld	a5,8(s1)
    1fb2:	fcf711e3          	bne	a4,a5,1f74 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    1fb6:	fb043783          	ld	a5,-80(s0)
    1fba:	cf89                	beqz	a5,1fd4 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    1fbc:	fb043783          	ld	a5,-80(s0)
    1fc0:	02878793          	addi	a5,a5,40
    1fc4:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    1fc8:	fb043783          	ld	a5,-80(s0)
    1fcc:	4fbc                	lw	a5,88(a5)
    1fce:	f6f42823          	sw	a5,-144(s0)
    1fd2:	a839                	j	1ff0 <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    1fd4:	649c                	ld	a5,8(s1)
    1fd6:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1fda:	689c                	ld	a5,16(s1)
    1fdc:	4098                	lw	a4,0(s1)
    1fde:	85ba                	mv	a1,a4
    1fe0:	853e                	mv	a0,a5
    1fe2:	00000097          	auipc	ra,0x0
    1fe6:	c5c080e7          	jalr	-932(ra) # 1c3e <find_next_release_time>
    1fea:	87aa                	mv	a5,a0
    1fec:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    1ff0:	f6843783          	ld	a5,-152(s0)
    1ff4:	f6f43c23          	sd	a5,-136(s0)
    1ff8:	f7043783          	ld	a5,-144(s0)
    1ffc:	f8f43023          	sd	a5,-128(s0)
    2000:	4701                	li	a4,0
    2002:	f7843703          	ld	a4,-136(s0)
    2006:	4781                	li	a5,0
    2008:	f8043783          	ld	a5,-128(s0)
    200c:	893a                	mv	s2,a4
    200e:	89be                	mv	s3,a5
    2010:	874a                	mv	a4,s2
    2012:	87ce                	mv	a5,s3
    ...
    2014:	853a                	mv	a0,a4
    2016:	85be                	mv	a1,a5
    2018:	60ea                	ld	ra,152(sp)
    201a:	644a                	ld	s0,144(sp)
    201c:	64aa                	ld	s1,136(sp)
    201e:	690a                	ld	s2,128(sp)
    2020:	79e6                	ld	s3,120(sp)
    2022:	610d                	addi	sp,sp,160
    2024:	8082                	ret

...
grep(char *pattern, int fd)
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    if(m > 0){
      ...
      c6:	bc678793          	addi	a5,a5,-1082 # 1c88 <buf>
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    fprintf(2, "usage: grep pattern [file ...]\n");
     ...
     168:	acc58593          	addi	a1,a1,-1332 # 1c30 <schedule_dm+0x17a>
     16c:	4509                	li	a0,2
  ...
  for(i = 2; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     1f6:	a5e50513          	addi	a0,a0,-1442 # 1c50 <schedule_dm+0x19a>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     a10:	26468693          	addi	a3,a3,612 # 1c70 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     aea:	18a70713          	addi	a4,a4,394 # 1c70 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     caa:	fc278793          	addi	a5,a5,-62 # 1c68 <schedule_dm+0x1b2>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     e56:	24678793          	addi	a5,a5,582 # 2098 <freep>
     e5a:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     f4e:	14e78793          	addi	a5,a5,334 # 2098 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     fd0:	0cc78793          	addi	a5,a5,204 # 2098 <freep>
     fd4:	639c                	ld	a5,0(a5)
}
     fd6:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1002:	09a78793          	addi	a5,a5,154 # 2098 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10c0:	fdc78793          	addi	a5,a5,-36 # 2098 <freep>
    ...
    10d6:	fc678793          	addi	a5,a5,-58 # 2098 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    12ac:	df878793          	addi	a5,a5,-520 # 20a0 <last_thread.1226>
    ...
    1308:	d9c78793          	addi	a5,a5,-612 # 20a0 <last_thread.1226>
    130c:	639c                	ld	a5,0(a5)
    130e:	c385                	beqz	a5,132e <schedule_wrr+0xd6>
    1310:	00001797          	auipc	a5,0x1
    1314:	d9078793          	addi	a5,a5,-624 # 20a0 <last_thread.1226>
    ...
    1324:	d8078793          	addi	a5,a5,-640 # 20a0 <last_thread.1226>
    ...
    1374:	d3078793          	addi	a5,a5,-720 # 20a0 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    14a6:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdb68>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    15d8:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdb68>
    ...
    1672:	a80d                	j	16a4 <schedule_sjf+0x112>
    } else {
    ...
    1682:	57fd                	li	a5,-1
    1684:	00f71c63          	bne	a4,a5,169c <schedule_sjf+0x10a>
    1688:	689c                	ld	a5,16(s1)
    168a:	4098                	lw	a4,0(s1)
    168c:	85ba                	mv	a1,a4
    168e:	853e                	mv	a0,a5
    1690:	00000097          	auipc	ra,0x0
    1694:	d2c080e7          	jalr	-724(ra) # 13bc <find_next_release_time>
    1698:	87aa                	mv	a5,a0
    169a:	a019                	j	16a0 <schedule_sjf+0x10e>
    169c:	fb442783          	lw	a5,-76(s0)
    16a0:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    16a4:	f8043783          	ld	a5,-128(s0)
    16a8:	f8f43823          	sd	a5,-112(s0)
    16ac:	f8843783          	ld	a5,-120(s0)
    16b0:	f8f43c23          	sd	a5,-104(s0)
    16b4:	4701                	li	a4,0
    16b6:	f9043703          	ld	a4,-112(s0)
    16ba:	4781                	li	a5,0
    16bc:	f9843783          	ld	a5,-104(s0)
    16c0:	893a                	mv	s2,a4
    16c2:	89be                	mv	s3,a5
    16c4:	874a                	mv	a4,s2
    16c6:	87ce                	mv	a5,s3
    ...
    16c8:	853a                	mv	a0,a4
    16ca:	85be                	mv	a1,a5
    16cc:	70e6                	ld	ra,120(sp)
    16ce:	7446                	ld	s0,112(sp)
    16d0:	74a6                	ld	s1,104(sp)
    16d2:	7906                	ld	s2,96(sp)
    16d4:	69e6                	ld	s3,88(sp)
    16d6:	6109                	addi	sp,sp,128
    16d8:	8082                	ret

00000000000016da <min>:

int min(int a, int b) {
    16da:	1101                	addi	sp,sp,-32
    16dc:	ec22                	sd	s0,24(sp)
    16de:	1000                	addi	s0,sp,32
    16e0:	87aa                	mv	a5,a0
    16e2:	872e                	mv	a4,a1
    16e4:	fef42623          	sw	a5,-20(s0)
    16e8:	87ba                	mv	a5,a4
    16ea:	fef42423          	sw	a5,-24(s0)
    return (a < b) ? a : b;
    16ee:	fec42603          	lw	a2,-20(s0)
    16f2:	fe842783          	lw	a5,-24(s0)
    16f6:	0007869b          	sext.w	a3,a5
    16fa:	0006071b          	sext.w	a4,a2
    16fe:	00d75363          	bge	a4,a3,1704 <min+0x2a>
    1702:	87b2                	mv	a5,a2
    1704:	2781                	sext.w	a5,a5
}
    1706:	853e                	mv	a0,a5
    1708:	6462                	ld	s0,24(sp)
    170a:	6105                	addi	sp,sp,32
    170c:	8082                	ret

000000000000170e <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    170e:	7131                	addi	sp,sp,-192
    1710:	fd06                	sd	ra,184(sp)
    1712:	f922                	sd	s0,176(sp)
    1714:	f526                	sd	s1,168(sp)
    1716:	f14a                	sd	s2,160(sp)
    1718:	ed4e                	sd	s3,152(sp)
    171a:	0180                	addi	s0,sp,192
    171c:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *min_slack_thread = NULL;
    171e:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    1722:	800007b7          	lui	a5,0x80000
    1726:	fff7c793          	not	a5,a5
    172a:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    // int ddl;
    // Determine the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    172e:	649c                	ld	a5,8(s1)
    1730:	639c                	ld	a5,0(a5)
    1732:	faf43023          	sd	a5,-96(s0)
    1736:	fa043783          	ld	a5,-96(s0)
    173a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdb68>
    173e:	faf43c23          	sd	a5,-72(s0)
    1742:	a069                	j	17cc <schedule_lst+0xbe>
    ...
    1750:	0007871b          	sext.w	a4,a5
    1754:	fb843783          	ld	a5,-72(s0)
    1758:	4fbc                	lw	a5,88(a5)
    175a:	40f707bb          	subw	a5,a4,a5
    175e:	f6f42a23          	sw	a5,-140(s0)
        if (slack_time < min_slack_time || (slack_time == min_slack_time && t->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))) {
    1762:	f7442703          	lw	a4,-140(s0)
    1766:	fc442783          	lw	a5,-60(s0)
    176a:	2701                	sext.w	a4,a4
    176c:	2781                	sext.w	a5,a5
    176e:	02f74c63          	blt	a4,a5,17a6 <schedule_lst+0x98>
    1772:	f7442703          	lw	a4,-140(s0)
    1776:	fc442783          	lw	a5,-60(s0)
    177a:	2701                	sext.w	a4,a4
    177c:	2781                	sext.w	a5,a5
    177e:	02f71c63          	bne	a4,a5,17b6 <schedule_lst+0xa8>
    1782:	fb843783          	ld	a5,-72(s0)
    1786:	5fd4                	lw	a3,60(a5)
    1788:	fc843783          	ld	a5,-56(s0)
    178c:	c789                	beqz	a5,1796 <schedule_lst+0x88>
    178e:	fc843783          	ld	a5,-56(s0)
    1792:	5fdc                	lw	a5,60(a5)
    1794:	a029                	j	179e <schedule_lst+0x90>
    1796:	800007b7          	lui	a5,0x80000
    179a:	fff7c793          	not	a5,a5
    179e:	873e                	mv	a4,a5
    17a0:	87b6                	mv	a5,a3
    17a2:	00e7da63          	bge	a5,a4,17b6 <schedule_lst+0xa8>
            min_slack_thread = t;
    17a6:	fb843783          	ld	a5,-72(s0)
    17aa:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    17ae:	f7442783          	lw	a5,-140(s0)
    17b2:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    17b6:	fb843783          	ld	a5,-72(s0)
    17ba:	779c                	ld	a5,40(a5)
    17bc:	f6f43423          	sd	a5,-152(s0)
    17c0:	f6843783          	ld	a5,-152(s0)
    17c4:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdb68>
    17c8:	faf43c23          	sd	a5,-72(s0)
    17cc:	fb843783          	ld	a5,-72(s0)
    17d0:	02878713          	addi	a4,a5,40
    17d4:	649c                	ld	a5,8(s1)
    17d6:	f6f717e3          	bne	a4,a5,1744 <schedule_lst+0x36>
    ...
    17da:	800007b7          	lui	a5,0x80000
    17de:	fff7c793          	not	a5,a5
    17e2:	faf42a23          	sw	a5,-76(s0)
    ...
    17e6:	689c                	ld	a5,16(s1)
    17e8:	639c                	ld	a5,0(a5)
    17ea:	f8f43c23          	sd	a5,-104(s0)
    17ee:	f9843783          	ld	a5,-104(s0)
    17f2:	17e1                	addi	a5,a5,-8
    17f4:	faf43423          	sd	a5,-88(s0)
    17f8:	a0f1                	j	18c4 <schedule_lst+0x1b6>
        if (entry->release_time > args.current_time) {
    17fa:	fa843783          	ld	a5,-88(s0)
    17fe:	4f98                	lw	a4,24(a5)
    1800:	409c                	lw	a5,0(s1)
    1802:	0ae7d763          	bge	a5,a4,18b0 <schedule_lst+0x1a2>
            struct thread *upcoming_thread = entry->thrd;
    1806:	fa843783          	ld	a5,-88(s0)
    180a:	639c                	ld	a5,0(a5)
    180c:	f8f43423          	sd	a5,-120(s0)
            int upcoming_slack_time = upcoming_thread->current_deadline - entry->release_time - upcoming_thread->remaining_time;
    1810:	f8843783          	ld	a5,-120(s0)
    1814:	4ff8                	lw	a4,92(a5)
    1816:	fa843783          	ld	a5,-88(s0)
    181a:	4f9c                	lw	a5,24(a5)
    181c:	40f707bb          	subw	a5,a4,a5
    1820:	0007871b          	sext.w	a4,a5
    1824:	f8843783          	ld	a5,-120(s0)
    1828:	4fbc                	lw	a5,88(a5)
    182a:	40f707bb          	subw	a5,a4,a5
    182e:	f8f42223          	sw	a5,-124(s0)
    ...
    1832:	f8442703          	lw	a4,-124(s0)
    1836:	fc442783          	lw	a5,-60(s0)
    183a:	2701                	sext.w	a4,a4
    183c:	2781                	sext.w	a5,a5
    183e:	02f75163          	bge	a4,a5,1860 <schedule_lst+0x152>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    1842:	fa843783          	ld	a5,-88(s0)
    1846:	4f98                	lw	a4,24(a5)
    1848:	fb442783          	lw	a5,-76(s0)
    184c:	85ba                	mv	a1,a4
    184e:	853e                	mv	a0,a5
    1850:	00000097          	auipc	ra,0x0
    1854:	e8a080e7          	jalr	-374(ra) # 16da <min>
    1858:	87aa                	mv	a5,a0
    185a:	faf42a23          	sw	a5,-76(s0)
    185e:	a889                	j	18b0 <schedule_lst+0x1a2>
            } else if (upcoming_slack_time == min_slack_time && upcoming_thread->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))
    1860:	f8442703          	lw	a4,-124(s0)
    1864:	fc442783          	lw	a5,-60(s0)
    1868:	2701                	sext.w	a4,a4
    186a:	2781                	sext.w	a5,a5
    186c:	04f71263          	bne	a4,a5,18b0 <schedule_lst+0x1a2>
    1870:	f8843783          	ld	a5,-120(s0)
    1874:	5fd4                	lw	a3,60(a5)
    1876:	fc843783          	ld	a5,-56(s0)
    187a:	c789                	beqz	a5,1884 <schedule_lst+0x176>
    187c:	fc843783          	ld	a5,-56(s0)
    1880:	5fdc                	lw	a5,60(a5)
    1882:	a029                	j	188c <schedule_lst+0x17e>
    1884:	800007b7          	lui	a5,0x80000
    1888:	fff7c793          	not	a5,a5
    188c:	873e                	mv	a4,a5
    188e:	87b6                	mv	a5,a3
    1890:	02e7d063          	bge	a5,a4,18b0 <schedule_lst+0x1a2>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    1894:	fa843783          	ld	a5,-88(s0)
    1898:	4f98                	lw	a4,24(a5)
    189a:	fb442783          	lw	a5,-76(s0)
    189e:	85ba                	mv	a1,a4
    18a0:	853e                	mv	a0,a5
    18a2:	00000097          	auipc	ra,0x0
    18a6:	e38080e7          	jalr	-456(ra) # 16da <min>
    18aa:	87aa                	mv	a5,a0
    18ac:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(entry, args.release_queue, thread_list) {
    18b0:	fa843783          	ld	a5,-88(s0)
    18b4:	679c                	ld	a5,8(a5)
    18b6:	f6f43c23          	sd	a5,-136(s0)
    18ba:	f7843783          	ld	a5,-136(s0)
    18be:	17e1                	addi	a5,a5,-8
    18c0:	faf43423          	sd	a5,-88(s0)
    18c4:	fa843783          	ld	a5,-88(s0)
    18c8:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffdb98>
    18cc:	689c                	ld	a5,16(s1)
    18ce:	f2f716e3          	bne	a4,a5,17fa <schedule_lst+0xec>
        }
    }

    // Decide the allocated time based on current minimum slack or upcoming preemption needs
    if (min_slack_thread) {
    18d2:	fc843783          	ld	a5,-56(s0)
    18d6:	c3b1                	beqz	a5,191a <schedule_lst+0x20c>
    ...
    18d8:	fb442783          	lw	a5,-76(s0)
    18dc:	0007871b          	sext.w	a4,a5
    18e0:	800007b7          	lui	a5,0x80000
    18e4:	fff7c793          	not	a5,a5
    18e8:	00f71663          	bne	a4,a5,18f4 <schedule_lst+0x1e6>
    18ec:	fc843783          	ld	a5,-56(s0)
    18f0:	4fbc                	lw	a5,88(a5)
    18f2:	a039                	j	1900 <schedule_lst+0x1f2>
    18f4:	409c                	lw	a5,0(s1)
    18f6:	fb442703          	lw	a4,-76(s0)
    18fa:	40f707bb          	subw	a5,a4,a5
    18fe:	2781                	sext.w	a5,a5
    1900:	f8f42a23          	sw	a5,-108(s0)
        r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    1904:	fc843783          	ld	a5,-56(s0)
    1908:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffdbb8>
    190c:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = allocated_time;
    1910:	f9442783          	lw	a5,-108(s0)
    1914:	f4f42823          	sw	a5,-176(s0)
    1918:	a081                	j	1958 <schedule_lst+0x24a>
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    191a:	649c                	ld	a5,8(s1)
    191c:	f4f43423          	sd	a5,-184(s0)
    ...
    1920:	fb442783          	lw	a5,-76(s0)
    1924:	0007871b          	sext.w	a4,a5
    1928:	800007b7          	lui	a5,0x80000
    192c:	fff7c793          	not	a5,a5
    1930:	00f70963          	beq	a4,a5,1942 <schedule_lst+0x234>
    1934:	409c                	lw	a5,0(s1)
    1936:	fb442703          	lw	a4,-76(s0)
    193a:	40f707bb          	subw	a5,a4,a5
    193e:	2781                	sext.w	a5,a5
    1940:	a811                	j	1954 <schedule_lst+0x246>
    1942:	689c                	ld	a5,16(s1)
    1944:	4098                	lw	a4,0(s1)
    1946:	85ba                	mv	a1,a4
    1948:	853e                	mv	a0,a5
    194a:	00000097          	auipc	ra,0x0
    194e:	a72080e7          	jalr	-1422(ra) # 13bc <find_next_release_time>
    1952:	87aa                	mv	a5,a0
    1954:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    1958:	f4843783          	ld	a5,-184(s0)
    195c:	f4f43c23          	sd	a5,-168(s0)
    1960:	f5043783          	ld	a5,-176(s0)
    1964:	f6f43023          	sd	a5,-160(s0)
    1968:	4701                	li	a4,0
    196a:	f5843703          	ld	a4,-168(s0)
    196e:	4781                	li	a5,0
    1970:	f6043783          	ld	a5,-160(s0)
    1974:	893a                	mv	s2,a4
    1976:	89be                	mv	s3,a5
    1978:	874a                	mv	a4,s2
    197a:	87ce                	mv	a5,s3
    ...
    197c:	853a                	mv	a0,a4
    197e:	85be                	mv	a1,a5
    1980:	70ea                	ld	ra,184(sp)
    1982:	744a                	ld	s0,176(sp)
    1984:	74aa                	ld	s1,168(sp)
    1986:	790a                	ld	s2,160(sp)
    1988:	69ea                	ld	s3,152(sp)
    198a:	6129                	addi	sp,sp,192
    198c:	8082                	ret

000000000000198e <find_earliest_impactful_release_time_dm>:

int find_earliest_impactful_release_time_dm(struct list_head *release_queue, int current_time, int current_deadline) {
    198e:	715d                	addi	sp,sp,-80
    1990:	e4a2                	sd	s0,72(sp)
    1992:	0880                	addi	s0,sp,80
    1994:	faa43c23          	sd	a0,-72(s0)
    1998:	87ae                	mv	a5,a1
    199a:	8732                	mv	a4,a2
    199c:	faf42a23          	sw	a5,-76(s0)
    19a0:	87ba                	mv	a5,a4
    19a2:	faf42823          	sw	a5,-80(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_event = INT_MAX;
    19a6:	800007b7          	lui	a5,0x80000
    19aa:	fff7c793          	not	a5,a5
    19ae:	fef42223          	sw	a5,-28(s0)
    struct thread *earliest_deadline_thread = NULL;
    19b2:	fc043c23          	sd	zero,-40(s0)
    earliest_deadline_thread->ID = INT_MAX;
    19b6:	fd843783          	ld	a5,-40(s0)
    19ba:	80000737          	lui	a4,0x80000
    19be:	fff74713          	not	a4,a4
    19c2:	dfd8                	sw	a4,60(a5)

    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    19c4:	fb843783          	ld	a5,-72(s0)
    19c8:	639c                	ld	a5,0(a5)
    19ca:	fcf43823          	sd	a5,-48(s0)
    19ce:	fd043783          	ld	a5,-48(s0)
    19d2:	17e1                	addi	a5,a5,-8
    19d4:	fef43423          	sd	a5,-24(s0)
    19d8:	a075                	j	1a84 <find_earliest_impactful_release_time_dm+0xf6>
        if (entry->release_time > current_time && entry->thrd->period < current_deadline) {
    19da:	fe843783          	ld	a5,-24(s0)
    19de:	4f98                	lw	a4,24(a5)
    19e0:	fb442783          	lw	a5,-76(s0)
    19e4:	2781                	sext.w	a5,a5
    19e6:	02e7d963          	bge	a5,a4,1a18 <find_earliest_impactful_release_time_dm+0x8a>
    19ea:	fe843783          	ld	a5,-24(s0)
    19ee:	639c                	ld	a5,0(a5)
    19f0:	4bb8                	lw	a4,80(a5)
    19f2:	fb042783          	lw	a5,-80(s0)
    19f6:	2781                	sext.w	a5,a5
    19f8:	02f75063          	bge	a4,a5,1a18 <find_earliest_impactful_release_time_dm+0x8a>
            if (entry->release_time < earliest_impactful_event) {
    19fc:	fe843783          	ld	a5,-24(s0)
    1a00:	4f98                	lw	a4,24(a5)
    1a02:	fe442783          	lw	a5,-28(s0)
    1a06:	2781                	sext.w	a5,a5
    1a08:	06f75463          	bge	a4,a5,1a70 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    1a0c:	fe843783          	ld	a5,-24(s0)
    1a10:	4f9c                	lw	a5,24(a5)
    1a12:	fef42223          	sw	a5,-28(s0)
            if (entry->release_time < earliest_impactful_event) {
    1a16:	a8a9                	j	1a70 <find_earliest_impactful_release_time_dm+0xe2>
            }
        } 
    ...
    1a1c:	4f98                	lw	a4,24(a5)
    1a1e:	fb442783          	lw	a5,-76(s0)
    1a22:	2781                	sext.w	a5,a5
    1a24:	04e7d663          	bge	a5,a4,1a70 <find_earliest_impactful_release_time_dm+0xe2>
    1a28:	fe843783          	ld	a5,-24(s0)
    1a2c:	639c                	ld	a5,0(a5)
    1a2e:	4bb8                	lw	a4,80(a5)
    1a30:	fb042783          	lw	a5,-80(s0)
    1a34:	2781                	sext.w	a5,a5
    1a36:	02e79d63          	bne	a5,a4,1a70 <find_earliest_impactful_release_time_dm+0xe2>
            if (entry->release_time < earliest_impactful_event && entry->thrd->ID < earliest_deadline_thread->ID) {
    1a3a:	fe843783          	ld	a5,-24(s0)
    1a3e:	4f98                	lw	a4,24(a5)
    1a40:	fe442783          	lw	a5,-28(s0)
    1a44:	2781                	sext.w	a5,a5
    1a46:	02f75563          	bge	a4,a5,1a70 <find_earliest_impactful_release_time_dm+0xe2>
    1a4a:	fe843783          	ld	a5,-24(s0)
    1a4e:	639c                	ld	a5,0(a5)
    1a50:	5fd8                	lw	a4,60(a5)
    1a52:	fd843783          	ld	a5,-40(s0)
    1a56:	5fdc                	lw	a5,60(a5)
    1a58:	00f75c63          	bge	a4,a5,1a70 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    1a5c:	fe843783          	ld	a5,-24(s0)
    1a60:	4f9c                	lw	a5,24(a5)
    1a62:	fef42223          	sw	a5,-28(s0)
                earliest_deadline_thread = entry->thrd;
    1a66:	fe843783          	ld	a5,-24(s0)
    1a6a:	639c                	ld	a5,0(a5)
    1a6c:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    1a70:	fe843783          	ld	a5,-24(s0)
    1a74:	679c                	ld	a5,8(a5)
    1a76:	fcf43423          	sd	a5,-56(s0)
    1a7a:	fc843783          	ld	a5,-56(s0)
    1a7e:	17e1                	addi	a5,a5,-8
    1a80:	fef43423          	sd	a5,-24(s0)
    1a84:	fe843783          	ld	a5,-24(s0)
    1a88:	07a1                	addi	a5,a5,8
    1a8a:	fb843703          	ld	a4,-72(s0)
    1a8e:	f4f716e3          	bne	a4,a5,19da <find_earliest_impactful_release_time_dm+0x4c>
            }
        }
    }
    ...
    1a92:	fe442783          	lw	a5,-28(s0)
    1a96:	0007871b          	sext.w	a4,a5
    1a9a:	800007b7          	lui	a5,0x80000
    1a9e:	fff7c793          	not	a5,a5
    1aa2:	00f70563          	beq	a4,a5,1aac <find_earliest_impactful_release_time_dm+0x11e>
    1aa6:	fe442783          	lw	a5,-28(s0)
    1aaa:	a011                	j	1aae <find_earliest_impactful_release_time_dm+0x120>
    1aac:	57fd                	li	a5,-1
}
    1aae:	853e                	mv	a0,a5
    1ab0:	6426                	ld	s0,72(sp)
    1ab2:	6161                	addi	sp,sp,80
    1ab4:	8082                	ret

0000000000001ab6 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    1ab6:	7175                	addi	sp,sp,-144
    1ab8:	e506                	sd	ra,136(sp)
    1aba:	e122                	sd	s0,128(sp)
    1abc:	fca6                	sd	s1,120(sp)
    1abe:	f8ca                	sd	s2,112(sp)
    1ac0:	f4ce                	sd	s3,104(sp)
    1ac2:	0900                	addi	s0,sp,144
    1ac4:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    1ac6:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    1aca:	800007b7          	lui	a5,0x80000
    1ace:	fff7c793          	not	a5,a5
    1ad2:	faf42e23          	sw	a5,-68(s0)

    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    1ad6:	649c                	ld	a5,8(s1)
    1ad8:	639c                	ld	a5,0(a5)
    1ada:	faf43823          	sd	a5,-80(s0)
    1ade:	fb043783          	ld	a5,-80(s0)
    1ae2:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdb68>
    1ae6:	fcf43023          	sd	a5,-64(s0)
    1aea:	a089                	j	1b2c <schedule_dm+0x76>
        if (t->is_real_time && t->period < earliest_deadline) {
    1aec:	fc043783          	ld	a5,-64(s0)
    1af0:	43bc                	lw	a5,64(a5)
    1af2:	c395                	beqz	a5,1b16 <schedule_dm+0x60>
    1af4:	fc043783          	ld	a5,-64(s0)
    1af8:	4bb8                	lw	a4,80(a5)
    1afa:	fbc42783          	lw	a5,-68(s0)
    1afe:	2781                	sext.w	a5,a5
    1b00:	00f75b63          	bge	a4,a5,1b16 <schedule_dm+0x60>
            earliest_deadline_thread = t;
    1b04:	fc043783          	ld	a5,-64(s0)
    1b08:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    1b0c:	fc043783          	ld	a5,-64(s0)
    1b10:	4bbc                	lw	a5,80(a5)
    1b12:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1b16:	fc043783          	ld	a5,-64(s0)
    1b1a:	779c                	ld	a5,40(a5)
    1b1c:	f8f43c23          	sd	a5,-104(s0)
    1b20:	f9843783          	ld	a5,-104(s0)
    ...
    1b36:	faf71be3          	bne	a4,a5,1aec <schedule_dm+0x36>
        }
    }
    ...
    1b3a:	689c                	ld	a5,16(s1)
    1b3c:	4098                	lw	a4,0(s1)
    1b3e:	fbc42683          	lw	a3,-68(s0)
    1b42:	8636                	mv	a2,a3
    1b44:	85ba                	mv	a1,a4
    1b46:	853e                	mv	a0,a5
    1b48:	00000097          	auipc	ra,0x0
    1b4c:	e46080e7          	jalr	-442(ra) # 198e <find_earliest_impactful_release_time_dm>
    1b50:	87aa                	mv	a5,a0
    1b52:	faf42623          	sw	a5,-84(s0)

    if (earliest_deadline_thread) {
    1b56:	fc843783          	ld	a5,-56(s0)
    1b5a:	c3c9                	beqz	a5,1bdc <schedule_dm+0x126>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    1b5c:	fc843783          	ld	a5,-56(s0)
    1b60:	4ff8                	lw	a4,92(a5)
    1b62:	409c                	lw	a5,0(s1)
    1b64:	40f707bb          	subw	a5,a4,a5
    1b68:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline < 0) {
    1b6c:	fa842783          	lw	a5,-88(s0)
    1b70:	2781                	sext.w	a5,a5
    1b72:	0007db63          	bgez	a5,1b88 <schedule_dm+0xd2>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1b76:	fc843783          	ld	a5,-56(s0)
    1b7a:	02878793          	addi	a5,a5,40
    1b7e:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    1b82:	f8042023          	sw	zero,-128(s0)
    1b86:	a88d                	j	1bf8 <schedule_dm+0x142>
        } else {
    ...
    1b88:	fac42783          	lw	a5,-84(s0)
    1b8c:	0007871b          	sext.w	a4,a5
    1b90:	57fd                	li	a5,-1
    1b92:	02f70563          	beq	a4,a5,1bbc <schedule_dm+0x106>
    1b96:	409c                	lw	a5,0(s1)
    1b98:	fac42703          	lw	a4,-84(s0)
    1b9c:	40f707bb          	subw	a5,a4,a5
    1ba0:	0007871b          	sext.w	a4,a5
    1ba4:	fc843783          	ld	a5,-56(s0)
    1ba8:	4fbc                	lw	a5,88(a5)
    1baa:	00f75963          	bge	a4,a5,1bbc <schedule_dm+0x106>
    1bae:	409c                	lw	a5,0(s1)
    1bb0:	fac42703          	lw	a4,-84(s0)
    1bb4:	40f707bb          	subw	a5,a4,a5
    1bb8:	2781                	sext.w	a5,a5
    1bba:	a021                	j	1bc2 <schedule_dm+0x10c>
    1bbc:	fc843783          	ld	a5,-56(s0)
    1bc0:	4fbc                	lw	a5,88(a5)
    1bc2:	faf42223          	sw	a5,-92(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1bc6:	fc843783          	ld	a5,-56(s0)
    1bca:	02878793          	addi	a5,a5,40
    1bce:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    1bd2:	fa442783          	lw	a5,-92(s0)
    1bd6:	f8f42023          	sw	a5,-128(s0)
    1bda:	a839                	j	1bf8 <schedule_dm+0x142>
        }
    } else {
    ...
    1be4:	4098                	lw	a4,0(s1)
    1be6:	85ba                	mv	a1,a4
    1be8:	853e                	mv	a0,a5
    1bea:	fffff097          	auipc	ra,0xfffff
    1bee:	7d2080e7          	jalr	2002(ra) # 13bc <find_next_release_time>
    1bf2:	87aa                	mv	a5,a0
    1bf4:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    1bf8:	f7843783          	ld	a5,-136(s0)
    1bfc:	f8f43423          	sd	a5,-120(s0)
    1c00:	f8043783          	ld	a5,-128(s0)
    1c04:	f8f43823          	sd	a5,-112(s0)
    1c08:	4701                	li	a4,0
    1c0a:	f8843703          	ld	a4,-120(s0)
    1c0e:	4781                	li	a5,0
    ...
    1c1c:	853a                	mv	a0,a4
    1c1e:	85be                	mv	a1,a5
    1c20:	60aa                	ld	ra,136(sp)
    1c22:	640a                	ld	s0,128(sp)
    1c24:	74e6                	ld	s1,120(sp)
    1c26:	7946                	ld	s2,112(sp)
    1c28:	79a6                	ld	s3,104(sp)
    1c2a:	6149                	addi	sp,sp,144
    1c2c:	8082                	ret

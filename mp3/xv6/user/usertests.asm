...
copyin(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
      ...
      54:	4a850513          	addi	a0,a0,1192 # 84f8 <schedule_dm+0x52e>
    ...
    if(fd < 0){
      ...
      74:	49050513          	addi	a0,a0,1168 # 8500 <schedule_dm+0x536>
    ...
    if(n >= 0){
      ...
      be:	45e50513          	addi	a0,a0,1118 # 8518 <schedule_dm+0x54e>
    ...
    unlink("copyin1");
      ...
      e6:	41650513          	addi	a0,a0,1046 # 84f8 <schedule_dm+0x52e>
    ...
    if(n > 0){
     ...
     122:	42a50513          	addi	a0,a0,1066 # 8548 <schedule_dm+0x57e>
    ...
    if(pipe(fds) < 0){
     ...
     150:	42c50513          	addi	a0,a0,1068 # 8578 <schedule_dm+0x5ae>
    ...
    if(n > 0){
     ...
     19a:	3f250513          	addi	a0,a0,1010 # 8588 <schedule_dm+0x5be>
...
copyout(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     22a:	39250513          	addi	a0,a0,914 # 85b8 <schedule_dm+0x5ee>
    ...
    if(fd < 0){
     ...
     24a:	37a50513          	addi	a0,a0,890 # 85c0 <schedule_dm+0x5f6>
    ...
    if(n > 0){
     ...
     294:	34850513          	addi	a0,a0,840 # 85d8 <schedule_dm+0x60e>
    ...
    if(pipe(fds) < 0){
     ...
     2d0:	2ac50513          	addi	a0,a0,684 # 8578 <schedule_dm+0x5ae>
    ...
    n = write(fds[1], "x", 1);
     ...
     2f0:	31c58593          	addi	a1,a1,796 # 8608 <schedule_dm+0x63e>
     2f4:	853e                	mv	a0,a5
    ...
    if(n != 1){
     ...
     316:	2fe50513          	addi	a0,a0,766 # 8610 <schedule_dm+0x646>
    ...
    if(n > 0){
     ...
     360:	2cc50513          	addi	a0,a0,716 # 8628 <schedule_dm+0x65e>
...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    if(fd >= 0){
     ...
     41a:	24250513          	addi	a0,a0,578 # 8658 <schedule_dm+0x68e>
...
copyinstr2(char *s)
{
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     4c8:	1b450513          	addi	a0,a0,436 # 8678 <schedule_dm+0x6ae>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     514:	18850513          	addi	a0,a0,392 # 8698 <schedule_dm+0x6ce>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     566:	15650513          	addi	a0,a0,342 # 86b8 <schedule_dm+0x6ee>
  ...
  char *args[] = { "xx", 0 };
     ...
     580:	16478793          	addi	a5,a5,356 # 86e0 <schedule_dm+0x716>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     5c4:	12850513          	addi	a0,a0,296 # 86e8 <schedule_dm+0x71e>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
     ...
     5f6:	11650513          	addi	a0,a0,278 # 8708 <schedule_dm+0x73e>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     61e:	a7670713          	addi	a4,a4,-1418 # 10090 <big.1275>
    ...
    ret = exec("echo", args2);
     ...
     682:	09a50513          	addi	a0,a0,154 # 8718 <schedule_dm+0x74e>
    ...
    if(ret != -1){
     ...
     6ac:	07850513          	addi	a0,a0,120 # 8720 <schedule_dm+0x756>
  ...
  if(st != 747){
    ...
    printf("exec(echo, BIG) succeeded, should have failed\n");
     ...
     6f2:	05a50513          	addi	a0,a0,90 # 8748 <schedule_dm+0x77e>
...
copyinstr3(char *s)
{
  ...
  if(top % PGSIZE){
    ...
    printf("oops\n");
     ...
     788:	01450513          	addi	a0,a0,20 # 8798 <schedule_dm+0x7ce>
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     7e2:	e9a50513          	addi	a0,a0,-358 # 8678 <schedule_dm+0x6ae>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     82a:	e7250513          	addi	a0,a0,-398 # 8698 <schedule_dm+0x6ce>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     876:	e4650513          	addi	a0,a0,-442 # 86b8 <schedule_dm+0x6ee>
  ...
  char *args[] = { "xx", 0 };
     ...
     890:	e5478793          	addi	a5,a5,-428 # 86e0 <schedule_dm+0x716>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     8d0:	e1c50513          	addi	a0,a0,-484 # 86e8 <schedule_dm+0x71e>
...
rwsbrk()
{
  ...
  if(a == 0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) failed\n");
     ...
     916:	e8e50513          	addi	a0,a0,-370 # 87a0 <schedule_dm+0x7d6>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) shrink failed\n");
     ...
     942:	e7a50513          	addi	a0,a0,-390 # 87b8 <schedule_dm+0x7ee>
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
     ...
     960:	8f450513          	addi	a0,a0,-1804 # 8250 <schedule_dm+0x286>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     980:	e5c50513          	addi	a0,a0,-420 # 87d8 <schedule_dm+0x80e>
  ...
  if(n >= 0){
    ...
    printf("write(fd, %p, 1024) returned %d, not -1\n", a+4096, n);
     ...
     9d8:	e1c50513          	addi	a0,a0,-484 # 87f0 <schedule_dm+0x826>
  ...
  unlink("rwsbrk");
     ...
     a00:	85450513          	addi	a0,a0,-1964 # 8250 <schedule_dm+0x286>
  ...
  fd = open("README", O_RDONLY);
     ...
     a12:	baa50513          	addi	a0,a0,-1110 # 85b8 <schedule_dm+0x5ee>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     a32:	daa50513          	addi	a0,a0,-598 # 87d8 <schedule_dm+0x80e>
  ...
  if(n >= 0){
    ...
    printf("read(fd, %p, 10) returned %d, not -1\n", a+4096, n);
     ...
     a88:	d9c50513          	addi	a0,a0,-612 # 8820 <schedule_dm+0x856>
...
truncate1(char *s)
{
  ...
  write(fd1, "abcd", 4);
     ...
     af6:	d6658593          	addi	a1,a1,-666 # 8858 <schedule_dm+0x88e>
     afa:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     b18:	d3450513          	addi	a0,a0,-716 # 8848 <schedule_dm+0x87e>
  ...
  if(n != 4){
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     b64:	d0050513          	addi	a0,a0,-768 # 8860 <schedule_dm+0x896>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     b82:	cca50513          	addi	a0,a0,-822 # 8848 <schedule_dm+0x87e>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     b9a:	cb250513          	addi	a0,a0,-846 # 8848 <schedule_dm+0x87e>
  ...
  if(n != 0){
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     bdc:	ca850513          	addi	a0,a0,-856 # 8880 <schedule_dm+0x8b6>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     bf6:	c9e50513          	addi	a0,a0,-866 # 8890 <schedule_dm+0x8c6>
  ...
  if(n != 0){
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     c3c:	c7850513          	addi	a0,a0,-904 # 88b0 <schedule_dm+0x8e6>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     c56:	c3e50513          	addi	a0,a0,-962 # 8890 <schedule_dm+0x8c6>
  ...
  write(fd1, "abcdef", 6);
     ...
     c76:	c4e58593          	addi	a1,a1,-946 # 88c0 <schedule_dm+0x8f6>
     c7a:	853e                	mv	a0,a5
  ...
  if(n != 6){
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     cbe:	c0e50513          	addi	a0,a0,-1010 # 88c8 <schedule_dm+0x8fe>
  ...
  if(n != 2){
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     d0e:	bde50513          	addi	a0,a0,-1058 # 88e8 <schedule_dm+0x91e>
  ...
  unlink("truncfile");
     ...
     d28:	b2450513          	addi	a0,a0,-1244 # 8848 <schedule_dm+0x87e>
...
truncate2(char *s)
{
  ...
  unlink("truncfile");
     ...
     d78:	ad450513          	addi	a0,a0,-1324 # 8848 <schedule_dm+0x87e>
  ...
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     ...
     d8c:	ac050513          	addi	a0,a0,-1344 # 8848 <schedule_dm+0x87e>
  ...
  write(fd1, "abcd", 4);
     ...
     da8:	ab458593          	addi	a1,a1,-1356 # 8858 <schedule_dm+0x88e>
     dac:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     ...
     dbe:	a8e50513          	addi	a0,a0,-1394 # 8848 <schedule_dm+0x87e>
  ...
  int n = write(fd1, "x", 1);
     ...
     dda:	83258593          	addi	a1,a1,-1998 # 8608 <schedule_dm+0x63e>
     dde:	853e                	mv	a0,a5
  ...
  if(n != -1){
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     e0a:	b0250513          	addi	a0,a0,-1278 # 8908 <schedule_dm+0x93e>
  ...
  unlink("truncfile");
     ...
     e24:	a2850513          	addi	a0,a0,-1496 # 8848 <schedule_dm+0x87e>
...
truncate3(char *s)
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     e6a:	9e250513          	addi	a0,a0,-1566 # 8848 <schedule_dm+0x87e>
  ...
  if(pid < 0){
    ...
    printf("%s: fork failed\n", s);
     ...
     ea2:	a9250513          	addi	a0,a0,-1390 # 8930 <schedule_dm+0x966>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < 100; i++){
     ...
     ece:	97e50513          	addi	a0,a0,-1666 # 8848 <schedule_dm+0x87e>
     ...
     ef2:	a5a50513          	addi	a0,a0,-1446 # 8948 <schedule_dm+0x97e>
     ...
     f12:	a5258593          	addi	a1,a1,-1454 # 8960 <schedule_dm+0x996>
     f16:	853e                	mv	a0,a5
     ...
     f42:	a3250513          	addi	a0,a0,-1486 # 8970 <schedule_dm+0x9a6>
     ...
     f6c:	8e050513          	addi	a0,a0,-1824 # 8848 <schedule_dm+0x87e>
  ...
  for(int i = 0; i < 150; i++){
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     fd6:	87650513          	addi	a0,a0,-1930 # 8848 <schedule_dm+0x87e>
    ...
    if(fd < 0){
     ...
     ffa:	95250513          	addi	a0,a0,-1710 # 8948 <schedule_dm+0x97e>
    ...
    101a:	97a58593          	addi	a1,a1,-1670 # 8990 <schedule_dm+0x9c6>
    101e:	853e                	mv	a0,a5
    ...
    104a:	95250513          	addi	a0,a0,-1710 # 8998 <schedule_dm+0x9ce>
  ...
  unlink("truncfile");
    ...
    109a:	7b250513          	addi	a0,a0,1970 # 8848 <schedule_dm+0x87e>
...
iputtest(char *s)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    10c4:	8f850513          	addi	a0,a0,-1800 # 89b8 <schedule_dm+0x9ee>
    ...
    10de:	8e650513          	addi	a0,a0,-1818 # 89c0 <schedule_dm+0x9f6>
  ...
  if(chdir("iputdir") < 0){
    ...
    10f8:	8c450513          	addi	a0,a0,-1852 # 89b8 <schedule_dm+0x9ee>
    ...
    1112:	8ca50513          	addi	a0,a0,-1846 # 89d8 <schedule_dm+0xa0e>
  ...
  if(unlink("../iputdir") < 0){
    ...
    112c:	8d050513          	addi	a0,a0,-1840 # 89f8 <schedule_dm+0xa2e>
    ...
    1146:	8c650513          	addi	a0,a0,-1850 # 8a08 <schedule_dm+0xa3e>
  ...
  if(chdir("/") < 0){
    ...
    1160:	8cc50513          	addi	a0,a0,-1844 # 8a28 <schedule_dm+0xa5e>
    ...
    117a:	8ba50513          	addi	a0,a0,-1862 # 8a30 <schedule_dm+0xa66>
...
exitiputtest(char *s)
{
  ...
  if(pid < 0){
    ...
    11c6:	76e50513          	addi	a0,a0,1902 # 8930 <schedule_dm+0x966>
  ...
  if(pid == 0){
    ...
    11e8:	7d450513          	addi	a0,a0,2004 # 89b8 <schedule_dm+0x9ee>
    ...
    1202:	7c250513          	addi	a0,a0,1986 # 89c0 <schedule_dm+0x9f6>
    ...
    121c:	7a050513          	addi	a0,a0,1952 # 89b8 <schedule_dm+0x9ee>
    ...
    1236:	81650513          	addi	a0,a0,-2026 # 8a48 <schedule_dm+0xa7e>
    ...
    1250:	7ac50513          	addi	a0,a0,1964 # 89f8 <schedule_dm+0xa2e>
    ...
    126a:	7a250513          	addi	a0,a0,1954 # 8a08 <schedule_dm+0xa3e>
...
openiputtest(char *s)
{
  ...
  if(mkdir("oidir") < 0){
    ...
    12b6:	7ae50513          	addi	a0,a0,1966 # 8a60 <schedule_dm+0xa96>
    ...
    12d0:	79c50513          	addi	a0,a0,1948 # 8a68 <schedule_dm+0xa9e>
  ...
  if(pid < 0){
    ...
    1306:	62e50513          	addi	a0,a0,1582 # 8930 <schedule_dm+0x966>
  ...
  if(pid == 0){
    ...
    132a:	73a50513          	addi	a0,a0,1850 # 8a60 <schedule_dm+0xa96>
    ...
    134e:	73650513          	addi	a0,a0,1846 # 8a80 <schedule_dm+0xab6>
  ...
  if(unlink("oidir") != 0){
    ...
    137c:	6e850513          	addi	a0,a0,1768 # 8a60 <schedule_dm+0xa96>
    ...
    1394:	71850513          	addi	a0,a0,1816 # 8aa8 <schedule_dm+0xade>
...
opentest(char *s)
{
  ...
  fd = open("echo", 0);
    ...
    13d8:	34450513          	addi	a0,a0,836 # 8718 <schedule_dm+0x74e>
  ...
  if(fd < 0){
    ...
    13fc:	6c850513          	addi	a0,a0,1736 # 8ac0 <schedule_dm+0xaf6>
  ...
  fd = open("doesnotexist", 0);
    ...
    1426:	6b650513          	addi	a0,a0,1718 # 8ad8 <schedule_dm+0xb0e>
  ...
  if(fd >= 0){
    ...
    144a:	6a250513          	addi	a0,a0,1698 # 8ae8 <schedule_dm+0xb1e>
...
writetest(char *s)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    147e:	69650513          	addi	a0,a0,1686 # 8b10 <schedule_dm+0xb46>
  ...
  if(fd < 0){
    ...
    14a2:	67a50513          	addi	a0,a0,1658 # 8b18 <schedule_dm+0xb4e>
  ...
  for(i = 0; i < N; i++){
    ...
    14c8:	67458593          	addi	a1,a1,1652 # 8b38 <schedule_dm+0xb6e>
    14cc:	853e                	mv	a0,a5
    ...
    14ee:	65e50513          	addi	a0,a0,1630 # 8b48 <schedule_dm+0xb7e>
    ...
    150e:	66658593          	addi	a1,a1,1638 # 8b70 <schedule_dm+0xba6>
    1512:	853e                	mv	a0,a5
    ...
    1534:	65050513          	addi	a0,a0,1616 # 8b80 <schedule_dm+0xbb6>
  ...
  fd = open("small", O_RDONLY);
    ...
    1578:	59c50513          	addi	a0,a0,1436 # 8b10 <schedule_dm+0xb46>
  ...
  if(fd < 0){
    ...
    159c:	61050513          	addi	a0,a0,1552 # 8ba8 <schedule_dm+0xbde>
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    15be:	3c658593          	addi	a1,a1,966 # a980 <buf>
    15c2:	853e                	mv	a0,a5
  ...
  if(i != N*SZ*2){
    ...
    15ea:	5e250513          	addi	a0,a0,1506 # 8bc8 <schedule_dm+0xbfe>
  ...
  if(unlink("small") < 0){
    ...
    1612:	50250513          	addi	a0,a0,1282 # 8b10 <schedule_dm+0xb46>
    ...
    162c:	5b850513          	addi	a0,a0,1464 # 8be0 <schedule_dm+0xc16>
...
writebig(char *s)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    1660:	5a450513          	addi	a0,a0,1444 # 8c00 <schedule_dm+0xc36>
  ...
  if(fd < 0){
    ...
    1684:	58850513          	addi	a0,a0,1416 # 8c08 <schedule_dm+0xc3e>
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	2e078793          	addi	a5,a5,736 # a980 <buf>
    ...
    16ba:	2ca58593          	addi	a1,a1,714 # a980 <buf>
    16be:	853e                	mv	a0,a5
    ...
    16e2:	54a50513          	addi	a0,a0,1354 # 8c28 <schedule_dm+0xc5e>
  ...
  fd = open("big", O_RDONLY);
    ...
    1726:	4de50513          	addi	a0,a0,1246 # 8c00 <schedule_dm+0xc36>
  ...
  if(fd < 0){
    ...
    174a:	50a50513          	addi	a0,a0,1290 # 8c50 <schedule_dm+0xc86>
  ...
  for(;;){
    ...
    1770:	21458593          	addi	a1,a1,532 # a980 <buf>
    1774:	853e                	mv	a0,a5
    ...
    17aa:	4ca50513          	addi	a0,a0,1226 # 8c70 <schedule_dm+0xca6>
    ...
    17de:	4be50513          	addi	a0,a0,1214 # 8c98 <schedule_dm+0xcce>
    ...
    17f8:	18c78793          	addi	a5,a5,396 # a980 <buf>
    ...
    180c:	17878793          	addi	a5,a5,376 # a980 <buf>
      printf("%s: read content of block %d is %d\n", s,
    ...
    1822:	49250513          	addi	a0,a0,1170 # 8cb0 <schedule_dm+0xce6>
  ...
  if(unlink("big") < 0){
    ...
    1858:	3ac50513          	addi	a0,a0,940 # 8c00 <schedule_dm+0xc36>
    ...
    1872:	46a50513          	addi	a0,a0,1130 # 8cd8 <schedule_dm+0xd0e>
...
void dirtest(char *s)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    196e:	38650513          	addi	a0,a0,902 # 8cf0 <schedule_dm+0xd26>
    ...
    1988:	03c50513          	addi	a0,a0,60 # 89c0 <schedule_dm+0x9f6>
  ...
  if(chdir("dir0") < 0){
    ...
    19a2:	35250513          	addi	a0,a0,850 # 8cf0 <schedule_dm+0xd26>
    ...
    19bc:	34050513          	addi	a0,a0,832 # 8cf8 <schedule_dm+0xd2e>
  ...
  if(chdir("..") < 0){
    ...
    19d6:	33e50513          	addi	a0,a0,830 # 8d10 <schedule_dm+0xd46>
    ...
    19f0:	32c50513          	addi	a0,a0,812 # 8d18 <schedule_dm+0xd4e>
  ...
  if(unlink("dir0") < 0){
    ...
    1a0a:	2ea50513          	addi	a0,a0,746 # 8cf0 <schedule_dm+0xd26>
    ...
    1a24:	31050513          	addi	a0,a0,784 # 8d30 <schedule_dm+0xd66>
...
exectest(char *s)
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1a54:	cc878793          	addi	a5,a5,-824 # 8718 <schedule_dm+0x74e>
    1a58:	fcf43423          	sd	a5,-56(s0)
    1a5c:	00007797          	auipc	a5,0x7
    1a60:	2ec78793          	addi	a5,a5,748 # 8d48 <schedule_dm+0xd7e>
  ...
  unlink("echo-ok");
    ...
    1a70:	2e450513          	addi	a0,a0,740 # 8d50 <schedule_dm+0xd86>
  ...
  if(pid < 0) {
    ...
    1a9c:	e9850513          	addi	a0,a0,-360 # 8930 <schedule_dm+0x966>
  ...
  if(pid == 0) {
    ...
    1acc:	28850513          	addi	a0,a0,648 # 8d50 <schedule_dm+0xd86>
    ...
    1af0:	26c50513          	addi	a0,a0,620 # 8d58 <schedule_dm+0xd8e>
    ...
    1b1c:	25850513          	addi	a0,a0,600 # 8d70 <schedule_dm+0xda6>
    ...
    1b3c:	be050513          	addi	a0,a0,-1056 # 8718 <schedule_dm+0x74e>
    ...
    1b56:	22e50513          	addi	a0,a0,558 # 8d80 <schedule_dm+0xdb6>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1b90:	20c50513          	addi	a0,a0,524 # 8d98 <schedule_dm+0xdce>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1bb6:	19e50513          	addi	a0,a0,414 # 8d50 <schedule_dm+0xd86>
  ...
  if(fd < 0) {
    ...
    1bda:	d7250513          	addi	a0,a0,-654 # 8948 <schedule_dm+0x97e>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1c18:	fb450513          	addi	a0,a0,-76 # 8bc8 <schedule_dm+0xbfe>
  ...
  unlink("echo-ok");
    ...
    1c32:	12250513          	addi	a0,a0,290 # 8d50 <schedule_dm+0xd86>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1c6c:	14850513          	addi	a0,a0,328 # 8db0 <schedule_dm+0xde6>
...
pipe1(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    1ca8:	12450513          	addi	a0,a0,292 # 8dc8 <schedule_dm+0xdfe>
  ...
  if(pid == 0){
    ...
    1d06:	c7e68693          	addi	a3,a3,-898 # a980 <buf>
    ...
    1d3a:	c4a58593          	addi	a1,a1,-950 # a980 <buf>
    1d3e:	853e                	mv	a0,a5
    ...
    1d5c:	08850513          	addi	a0,a0,136 # 8de0 <schedule_dm+0xe16>
    ...
    1dc2:	bc270713          	addi	a4,a4,-1086 # a980 <buf>
    ...
    1df4:	00850513          	addi	a0,a0,8 # 8df8 <schedule_dm+0xe2e>
    ...
    1e56:	b2e58593          	addi	a1,a1,-1234 # a980 <buf>
    1e5a:	853e                	mv	a0,a5
    ...
    1e90:	f8450513          	addi	a0,a0,-124 # 8e10 <schedule_dm+0xe46>
    ...
    1ed8:	f5c50513          	addi	a0,a0,-164 # 8e30 <schedule_dm+0xe66>
...
preempt(char *s)
{
  ...
  if(pid1 < 0) {
    ...
    1f22:	f2a50513          	addi	a0,a0,-214 # 8e48 <schedule_dm+0xe7e>
  ...
  if(pid2 < 0) {
    ...
    1f62:	9d250513          	addi	a0,a0,-1582 # 8930 <schedule_dm+0x966>
  ...
  if(pid3 < 0) {
    ...
    1fb0:	98450513          	addi	a0,a0,-1660 # 8930 <schedule_dm+0x966>
  ...
  if(pid3 == 0){
    ...
    1fe6:	62658593          	addi	a1,a1,1574 # 8608 <schedule_dm+0x63e>
    1fea:	853e                	mv	a0,a5
    ...
    2006:	e5650513          	addi	a0,a0,-426 # 8e58 <schedule_dm+0xe8e>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    203a:	94a58593          	addi	a1,a1,-1718 # a980 <buf>
    203e:	853e                	mv	a0,a5
    ...
    205a:	e1a50513          	addi	a0,a0,-486 # 8e70 <schedule_dm+0xea6>
  ...
  printf("kill... ");
    ...
    207a:	e1250513          	addi	a0,a0,-494 # 8e88 <schedule_dm+0xebe>
  ...
  printf("wait... ");
    ...
    20b4:	de850513          	addi	a0,a0,-536 # 8e98 <schedule_dm+0xece>
...
exitwait(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    2118:	81c50513          	addi	a0,a0,-2020 # 8930 <schedule_dm+0x966>
    ...
    215a:	d5250513          	addi	a0,a0,-686 # 8ea8 <schedule_dm+0xede>
    ...
    2186:	d3e50513          	addi	a0,a0,-706 # 8ec0 <schedule_dm+0xef6>
...
reparent(char *s)
{
  ...
  for(int i = 0; i < 200; i++){
    ...
    2210:	72450513          	addi	a0,a0,1828 # 8930 <schedule_dm+0x966>
    ...
    224e:	c5e50513          	addi	a0,a0,-930 # 8ea8 <schedule_dm+0xede>
...
twochildren(char *s)
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    22f4:	64050513          	addi	a0,a0,1600 # 8930 <schedule_dm+0x966>
    ...
    233c:	5f850513          	addi	a0,a0,1528 # 8930 <schedule_dm+0x966>
...
forkfork(char *s)
{
  ...
  for(int i = 0; i < N; i++){
    ...
    23d0:	a7c50513          	addi	a0,a0,-1412 # 8e48 <schedule_dm+0xe7e>
  ...
  for(int i = 0; i < N; i++){
    ...
    2490:	a5450513          	addi	a0,a0,-1452 # 8ee0 <schedule_dm+0xf16>
...
forkforkfork(char *s)
{
  ...
  unlink("stopforking");
    ...
    24da:	a2a50513          	addi	a0,a0,-1494 # 8f00 <schedule_dm+0xf36>
  ...
  if(pid < 0){
    ...
    2506:	94650513          	addi	a0,a0,-1722 # 8e48 <schedule_dm+0xe7e>
  ...
  if(pid == 0){
    ...
    252a:	9da50513          	addi	a0,a0,-1574 # 8f00 <schedule_dm+0xf36>
    ...
    2566:	99e50513          	addi	a0,a0,-1634 # 8f00 <schedule_dm+0xf36>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    2592:	97250513          	addi	a0,a0,-1678 # 8f00 <schedule_dm+0xf36>
...
reparent2(char *s)
{
  ...
  for(int i = 0; i < 800; i++){
    ...
    25f6:	11650513          	addi	a0,a0,278 # 8708 <schedule_dm+0x73e>
...
mem(char *s)
{
  ...
  if((pid = fork()) == 0){
    ...
    26f0:	82450513          	addi	a0,a0,-2012 # 8f10 <schedule_dm+0xf46>
...
sharedfd(char *s)
{
  ...
  if(fd < 0){
    ...
    2796:	79e50513          	addi	a0,a0,1950 # 8f30 <schedule_dm+0xf66>
  ...
  for(i = 0; i < N; i++){
    ...
    280c:	75050513          	addi	a0,a0,1872 # 8f58 <schedule_dm+0xf8e>
  ...
  fd = open("sharedfd", 0);
    ...
    2884:	af050513          	addi	a0,a0,-1296 # 8370 <schedule_dm+0x3a6>
  ...
  if(fd < 0){
    ...
    28a8:	6d450513          	addi	a0,a0,1748 # 8f78 <schedule_dm+0xfae>
  ...
  unlink("sharedfd");
    ...
    2964:	a1050513          	addi	a0,a0,-1520 # 8370 <schedule_dm+0x3a6>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    29a6:	5fe50513          	addi	a0,a0,1534 # 8fa0 <schedule_dm+0xfd6>
...
fourfiles(char *s)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    29cc:	64078793          	addi	a5,a5,1600 # 9008 <schedule_dm+0x103e>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2a2e:	cde50513          	addi	a0,a0,-802 # 8708 <schedule_dm+0x73e>
    ...
    2a74:	54850513          	addi	a0,a0,1352 # 8fb8 <schedule_dm+0xfee>
    ...
    2a9e:	ee650513          	addi	a0,a0,-282 # a980 <buf>
    ...
    2abc:	ec858593          	addi	a1,a1,-312 # a980 <buf>
    2ac0:	853e                	mv	a0,a5
    ...
    2aea:	4e250513          	addi	a0,a0,1250 # 8fc8 <schedule_dm+0xffe>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2bb8:	dcc70713          	addi	a4,a4,-564 # a980 <buf>
    ...
    2be0:	40450513          	addi	a0,a0,1028 # 8fe0 <schedule_dm+0x1016>
    ...
    2c28:	d5c58593          	addi	a1,a1,-676 # a980 <buf>
    2c2c:	853e                	mv	a0,a5
    ...
    2c70:	38450513          	addi	a0,a0,900 # 8ff0 <schedule_dm+0x1026>
...
createdelete(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2ce8:	a2450513          	addi	a0,a0,-1500 # 8708 <schedule_dm+0x73e>
    ...
    2d64:	ff850513          	addi	a0,a0,-8 # 8d58 <schedule_dm+0xd8e>
    ...
    2dd8:	cd450513          	addi	a0,a0,-812 # 8aa8 <schedule_dm+0xade>
  ...
  for(i = 0; i < N; i++){
    ...
    2ef0:	13c50513          	addi	a0,a0,316 # 9028 <schedule_dm+0x105e>
    ...
    2f36:	11e50513          	addi	a0,a0,286 # 9050 <schedule_dm+0x1086>
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3026:	31650513          	addi	a0,a0,790 # 8338 <schedule_dm+0x36e>
  ...
  if(fd < 0){
    ...
    304a:	03250513          	addi	a0,a0,50 # 9078 <schedule_dm+0x10ae>
  ...
  write(fd, "hello", SZ);
    ...
    306a:	03258593          	addi	a1,a1,50 # 9098 <schedule_dm+0x10ce>
    306e:	853e                	mv	a0,a5
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    308c:	2b050513          	addi	a0,a0,688 # 8338 <schedule_dm+0x36e>
  ...
  if(fd < 0){
    ...
    30b0:	ff450513          	addi	a0,a0,-12 # 90a0 <schedule_dm+0x10d6>
  ...
  if(unlink("unlinkread") != 0){
    ...
    30ca:	27250513          	addi	a0,a0,626 # 8338 <schedule_dm+0x36e>
    ...
    30e2:	fe250513          	addi	a0,a0,-30 # 90c0 <schedule_dm+0x10f6>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3100:	23c50513          	addi	a0,a0,572 # 8338 <schedule_dm+0x36e>
  ...
  write(fd1, "yyy", 3);
    ...
    311c:	fc858593          	addi	a1,a1,-56 # 90e0 <schedule_dm+0x1116>
    3120:	853e                	mv	a0,a5
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3142:	84258593          	addi	a1,a1,-1982 # a980 <buf>
    3146:	853e                	mv	a0,a5
    ...
    3162:	f8a50513          	addi	a0,a0,-118 # 90e8 <schedule_dm+0x111e>
  ...
  if(buf[0] != 'h'){
    ...
    317c:	80878793          	addi	a5,a5,-2040 # a980 <buf>
    ...
    3196:	f7650513          	addi	a0,a0,-138 # 9108 <schedule_dm+0x113e>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    31b6:	7ce58593          	addi	a1,a1,1998 # a980 <buf>
    31ba:	853e                	mv	a0,a5
    ...
    31d6:	f5650513          	addi	a0,a0,-170 # 9128 <schedule_dm+0x115e>
  ...
  unlink("unlinkread");
    ...
    31fe:	13e50513          	addi	a0,a0,318 # 8338 <schedule_dm+0x36e>
...
linktest(char *s)
{
  ...
  unlink("lf1");
    ...
    3224:	f2850513          	addi	a0,a0,-216 # 9148 <schedule_dm+0x117e>
    3228:	00004097          	auipc	ra,0x4
    322c:	ea2080e7          	jalr	-350(ra) # 70ca <unlink>
  unlink("lf2");
    3230:	00006517          	auipc	a0,0x6
    3234:	f2050513          	addi	a0,a0,-224 # 9150 <schedule_dm+0x1186>
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    3248:	f0450513          	addi	a0,a0,-252 # 9148 <schedule_dm+0x117e>
  ...
  if(fd < 0){
    ...
    326c:	ef050513          	addi	a0,a0,-272 # 9158 <schedule_dm+0x118e>
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    328c:	e1058593          	addi	a1,a1,-496 # 9098 <schedule_dm+0x10ce>
    3290:	853e                	mv	a0,a5
    ...
    32ac:	ec850513          	addi	a0,a0,-312 # 9170 <schedule_dm+0x11a6>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    32d4:	e8058593          	addi	a1,a1,-384 # 9150 <schedule_dm+0x1186>
    32d8:	00006517          	auipc	a0,0x6
    32dc:	e7050513          	addi	a0,a0,-400 # 9148 <schedule_dm+0x117e>
    ...
    32f6:	e9650513          	addi	a0,a0,-362 # 9188 <schedule_dm+0x11be>
  ...
  unlink("lf1");
    ...
    3310:	e3c50513          	addi	a0,a0,-452 # 9148 <schedule_dm+0x117e>
  ...
  if(open("lf1", 0) >= 0){
    ...
    3322:	e2a50513          	addi	a0,a0,-470 # 9148 <schedule_dm+0x117e>
    ...
    333c:	e7050513          	addi	a0,a0,-400 # 91a8 <schedule_dm+0x11de>
  ...
  fd = open("lf2", 0);
    ...
    3358:	dfc50513          	addi	a0,a0,-516 # 9150 <schedule_dm+0x1186>
  ...
  if(fd < 0){
    ...
    337c:	e6050513          	addi	a0,a0,-416 # 91d8 <schedule_dm+0x120e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    339c:	5e858593          	addi	a1,a1,1512 # a980 <buf>
    33a0:	853e                	mv	a0,a5
    ...
    33bc:	e3850513          	addi	a0,a0,-456 # 91f0 <schedule_dm+0x1226>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    33e4:	d7058593          	addi	a1,a1,-656 # 9150 <schedule_dm+0x1186>
    33e8:	00006517          	auipc	a0,0x6
    33ec:	d6850513          	addi	a0,a0,-664 # 9150 <schedule_dm+0x1186>
    ...
    3406:	e0650513          	addi	a0,a0,-506 # 9208 <schedule_dm+0x123e>
  ...
  unlink("lf2");
    ...
    3420:	d3450513          	addi	a0,a0,-716 # 9150 <schedule_dm+0x1186>
    3424:	00004097          	auipc	ra,0x4
    3428:	ca6080e7          	jalr	-858(ra) # 70ca <unlink>
  if(link("lf2", "lf1") >= 0){
    342c:	00006597          	auipc	a1,0x6
    3430:	d1c58593          	addi	a1,a1,-740 # 9148 <schedule_dm+0x117e>
    3434:	00006517          	auipc	a0,0x6
    3438:	d1c50513          	addi	a0,a0,-740 # 9150 <schedule_dm+0x1186>
    ...
    3452:	de250513          	addi	a0,a0,-542 # 9230 <schedule_dm+0x1266>
  ...
  if(link(".", "lf1") >= 0){
    ...
    346c:	ce058593          	addi	a1,a1,-800 # 9148 <schedule_dm+0x117e>
    3470:	00006517          	auipc	a0,0x6
    3474:	de850513          	addi	a0,a0,-536 # 9258 <schedule_dm+0x128e>
    ...
    348e:	dd650513          	addi	a0,a0,-554 # 9260 <schedule_dm+0x1296>
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    3522:	d6250513          	addi	a0,a0,-670 # 9280 <schedule_dm+0x12b6>
    ...
    3556:	d2e50513          	addi	a0,a0,-722 # 9280 <schedule_dm+0x12b6>
    ...
    3590:	cfc50513          	addi	a0,a0,-772 # 9288 <schedule_dm+0x12be>
  ...
  fd = open(".", 0);
    ...
    3618:	c4450513          	addi	a0,a0,-956 # 9258 <schedule_dm+0x128e>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3682:	c2a50513          	addi	a0,a0,-982 # 92a8 <schedule_dm+0x12de>
    ...
    36b8:	c1450513          	addi	a0,a0,-1004 # 92c8 <schedule_dm+0x12fe>
  ...
  if(n != N){
    ...
    372a:	bca50513          	addi	a0,a0,-1078 # 92f0 <schedule_dm+0x1326>
  ...
  for(i = 0; i < N; i++){
    ...
    377a:	1ba50513          	addi	a0,a0,442 # 8930 <schedule_dm+0x966>
...
linkunlink(char *s)
{
  ...
  unlink("x");
    ...
    3912:	cfa50513          	addi	a0,a0,-774 # 8608 <schedule_dm+0x63e>
  ...
  if(pid < 0){
    ...
    393e:	ff650513          	addi	a0,a0,-10 # 8930 <schedule_dm+0x966>
  ...
  for(i = 0; i < 100; i++){
    ...
    39a4:	c6850513          	addi	a0,a0,-920 # 8608 <schedule_dm+0x63e>
    ...
    39d6:	c3658593          	addi	a1,a1,-970 # 8608 <schedule_dm+0x63e>
    39da:	00006517          	auipc	a0,0x6
    39de:	94e50513          	addi	a0,a0,-1714 # 9328 <schedule_dm+0x135e>
    ...
    39f0:	c1c50513          	addi	a0,a0,-996 # 8608 <schedule_dm+0x63e>
...
bigdir(char *s)
{
  ...
  unlink("bd");
    ...
    3a4c:	8e850513          	addi	a0,a0,-1816 # 9330 <schedule_dm+0x1366>
  ...
  fd = open("bd", O_CREATE);
    ...
    3a60:	8d450513          	addi	a0,a0,-1836 # 9330 <schedule_dm+0x1366>
  ...
  if(fd < 0){
    ...
    3a84:	8b850513          	addi	a0,a0,-1864 # 9338 <schedule_dm+0x136e>
  ...
  for(i = 0; i < N; i++){
    ...
    3b10:	82450513          	addi	a0,a0,-2012 # 9330 <schedule_dm+0x1366>
    ...
    3b2e:	82e50513          	addi	a0,a0,-2002 # 9358 <schedule_dm+0x138e>
  ...
  unlink("bd");
    ...
    3b62:	7d250513          	addi	a0,a0,2002 # 9330 <schedule_dm+0x1366>
  ...
  for(i = 0; i < N; i++){
    ...
    3be6:	79650513          	addi	a0,a0,1942 # 9378 <schedule_dm+0x13ae>
...
subdir(char *s)
{
  ...
  unlink("ff");
    ...
    3c32:	76a50513          	addi	a0,a0,1898 # 9398 <schedule_dm+0x13ce>
    3c36:	00003097          	auipc	ra,0x3
    3c3a:	494080e7          	jalr	1172(ra) # 70ca <unlink>
  if(mkdir("dd") != 0){
    3c3e:	00005517          	auipc	a0,0x5
    3c42:	76250513          	addi	a0,a0,1890 # 93a0 <schedule_dm+0x13d6>
    ...
    3c5a:	75250513          	addi	a0,a0,1874 # 93a8 <schedule_dm+0x13de>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3c78:	74c50513          	addi	a0,a0,1868 # 93c0 <schedule_dm+0x13f6>
  ...
  if(fd < 0){
    ...
    3c9c:	73050513          	addi	a0,a0,1840 # 93c8 <schedule_dm+0x13fe>
  ...
  write(fd, "ff", 2);
    ...
    3cbc:	6e058593          	addi	a1,a1,1760 # 9398 <schedule_dm+0x13ce>
    3cc0:	853e                	mv	a0,a5
  ...
  if(unlink("dd") >= 0){
    ...
    3cdc:	6c850513          	addi	a0,a0,1736 # 93a0 <schedule_dm+0x13d6>
    ...
    3cf6:	6f650513          	addi	a0,a0,1782 # 93e8 <schedule_dm+0x141e>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3d10:	70c50513          	addi	a0,a0,1804 # 9418 <schedule_dm+0x144e>
    ...
    3d28:	6fc50513          	addi	a0,a0,1788 # 9420 <schedule_dm+0x1456>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3d46:	6fe50513          	addi	a0,a0,1790 # 9440 <schedule_dm+0x1476>
  ...
  if(fd < 0){
    ...
    3d6a:	6ea50513          	addi	a0,a0,1770 # 9450 <schedule_dm+0x1486>
  ...
  write(fd, "FF", 2);
    ...
    3d8a:	6ea58593          	addi	a1,a1,1770 # 9470 <schedule_dm+0x14a6>
    3d8e:	853e                	mv	a0,a5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3dac:	6d050513          	addi	a0,a0,1744 # 9478 <schedule_dm+0x14ae>
  ...
  if(fd < 0){
    ...
    3dd0:	6bc50513          	addi	a0,a0,1724 # 9488 <schedule_dm+0x14be>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3df0:	b9458593          	addi	a1,a1,-1132 # a980 <buf>
    3df4:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3e16:	b6e78793          	addi	a5,a5,-1170 # a980 <buf>
    ...
    3e30:	67c50513          	addi	a0,a0,1660 # 94a8 <schedule_dm+0x14de>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3e58:	67458593          	addi	a1,a1,1652 # 94c8 <schedule_dm+0x14fe>
    3e5c:	00005517          	auipc	a0,0x5
    3e60:	5e450513          	addi	a0,a0,1508 # 9440 <schedule_dm+0x1476>
    ...
    3e78:	66450513          	addi	a0,a0,1636 # 94d8 <schedule_dm+0x150e>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3e92:	5b250513          	addi	a0,a0,1458 # 9440 <schedule_dm+0x1476>
    ...
    3eaa:	65a50513          	addi	a0,a0,1626 # 9500 <schedule_dm+0x1536>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3ec6:	57e50513          	addi	a0,a0,1406 # 9440 <schedule_dm+0x1476>
    ...
    3ee0:	64450513          	addi	a0,a0,1604 # 9520 <schedule_dm+0x1556>
  ...
  if(chdir("dd") != 0){
    ...
    3efa:	4aa50513          	addi	a0,a0,1194 # 93a0 <schedule_dm+0x13d6>
    ...
    3f12:	63a50513          	addi	a0,a0,1594 # 9548 <schedule_dm+0x157e>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3f2c:	63850513          	addi	a0,a0,1592 # 9560 <schedule_dm+0x1596>
    ...
    3f44:	63050513          	addi	a0,a0,1584 # 9570 <schedule_dm+0x15a6>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3f5e:	63650513          	addi	a0,a0,1590 # 9590 <schedule_dm+0x15c6>
    ...
    3f76:	62e50513          	addi	a0,a0,1582 # 95a0 <schedule_dm+0x15d6>
  ...
  if(chdir("./..") != 0){
    ...
    3f90:	63450513          	addi	a0,a0,1588 # 95c0 <schedule_dm+0x15f6>
    ...
    3fa8:	62450513          	addi	a0,a0,1572 # 95c8 <schedule_dm+0x15fe>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3fc4:	50850513          	addi	a0,a0,1288 # 94c8 <schedule_dm+0x14fe>
  ...
  if(fd < 0){
    ...
    3fe8:	5fc50513          	addi	a0,a0,1532 # 95e0 <schedule_dm+0x1616>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    4008:	97c58593          	addi	a1,a1,-1668 # a980 <buf>
    400c:	853e                	mv	a0,a5
    ...
    4028:	5dc50513          	addi	a0,a0,1500 # 9600 <schedule_dm+0x1636>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    4052:	3f250513          	addi	a0,a0,1010 # 9440 <schedule_dm+0x1476>
    ...
    406c:	5b850513          	addi	a0,a0,1464 # 9620 <schedule_dm+0x1656>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    408a:	5ca50513          	addi	a0,a0,1482 # 9650 <schedule_dm+0x1686>
    ...
    40a4:	5c050513          	addi	a0,a0,1472 # 9660 <schedule_dm+0x1696>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    40c2:	5c250513          	addi	a0,a0,1474 # 9680 <schedule_dm+0x16b6>
    ...
    40dc:	5b850513          	addi	a0,a0,1464 # 9690 <schedule_dm+0x16c6>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    40fa:	2aa50513          	addi	a0,a0,682 # 93a0 <schedule_dm+0x13d6>
    ...
    4114:	5a050513          	addi	a0,a0,1440 # 96b0 <schedule_dm+0x16e6>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    4130:	27450513          	addi	a0,a0,628 # 93a0 <schedule_dm+0x13d6>
    ...
    414a:	58a50513          	addi	a0,a0,1418 # 96d0 <schedule_dm+0x1706>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    4166:	23e50513          	addi	a0,a0,574 # 93a0 <schedule_dm+0x13d6>
    ...
    4180:	57450513          	addi	a0,a0,1396 # 96f0 <schedule_dm+0x1726>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    419a:	57a58593          	addi	a1,a1,1402 # 9710 <schedule_dm+0x1746>
    419e:	00005517          	auipc	a0,0x5
    41a2:	4b250513          	addi	a0,a0,1202 # 9650 <schedule_dm+0x1686>
    ...
    41ba:	56a50513          	addi	a0,a0,1386 # 9720 <schedule_dm+0x1756>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    41d4:	54058593          	addi	a1,a1,1344 # 9710 <schedule_dm+0x1746>
    41d8:	00005517          	auipc	a0,0x5
    41dc:	4a850513          	addi	a0,a0,1192 # 9680 <schedule_dm+0x16b6>
    ...
    41f4:	55850513          	addi	a0,a0,1368 # 9748 <schedule_dm+0x177e>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    420e:	2be58593          	addi	a1,a1,702 # 94c8 <schedule_dm+0x14fe>
    4212:	00005517          	auipc	a0,0x5
    4216:	1ae50513          	addi	a0,a0,430 # 93c0 <schedule_dm+0x13f6>
    ...
    422e:	54650513          	addi	a0,a0,1350 # 9770 <schedule_dm+0x17a6>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    4248:	40c50513          	addi	a0,a0,1036 # 9650 <schedule_dm+0x1686>
    ...
    4260:	53c50513          	addi	a0,a0,1340 # 9798 <schedule_dm+0x17ce>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    427a:	40a50513          	addi	a0,a0,1034 # 9680 <schedule_dm+0x16b6>
    ...
    4292:	52a50513          	addi	a0,a0,1322 # 97b8 <schedule_dm+0x17ee>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    42ac:	22050513          	addi	a0,a0,544 # 94c8 <schedule_dm+0x14fe>
    ...
    42c4:	51850513          	addi	a0,a0,1304 # 97d8 <schedule_dm+0x180e>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    42de:	3a650513          	addi	a0,a0,934 # 9680 <schedule_dm+0x16b6>
    ...
    42f6:	50e50513          	addi	a0,a0,1294 # 9800 <schedule_dm+0x1836>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    4310:	34450513          	addi	a0,a0,836 # 9650 <schedule_dm+0x1686>
    ...
    4328:	4fc50513          	addi	a0,a0,1276 # 9820 <schedule_dm+0x1856>
  ...
  if(chdir("dd/ff") == 0){
    ...
    4342:	08250513          	addi	a0,a0,130 # 93c0 <schedule_dm+0x13f6>
    ...
    435a:	4ea50513          	addi	a0,a0,1258 # 9840 <schedule_dm+0x1876>
  ...
  if(chdir("dd/xx") == 0){
    ...
    4374:	4f050513          	addi	a0,a0,1264 # 9860 <schedule_dm+0x1896>
    ...
    438c:	4e050513          	addi	a0,a0,1248 # 9868 <schedule_dm+0x189e>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    43a6:	12650513          	addi	a0,a0,294 # 94c8 <schedule_dm+0x14fe>
    ...
    43be:	14650513          	addi	a0,a0,326 # 9500 <schedule_dm+0x1536>
  ...
  if(unlink("dd/ff") != 0){
    ...
    43d8:	fec50513          	addi	a0,a0,-20 # 93c0 <schedule_dm+0x13f6>
    ...
    43f0:	49c50513          	addi	a0,a0,1180 # 9888 <schedule_dm+0x18be>
  ...
  if(unlink("dd") == 0){
    ...
    440a:	f9a50513          	addi	a0,a0,-102 # 93a0 <schedule_dm+0x13d6>
    ...
    4422:	48a50513          	addi	a0,a0,1162 # 98a8 <schedule_dm+0x18de>
  ...
  if(unlink("dd/dd") < 0){
    ...
    443c:	49850513          	addi	a0,a0,1176 # 98d0 <schedule_dm+0x1906>
    ...
    4456:	48650513          	addi	a0,a0,1158 # 98d8 <schedule_dm+0x190e>
  ...
  if(unlink("dd") < 0){
    ...
    4470:	f3450513          	addi	a0,a0,-204 # 93a0 <schedule_dm+0x13d6>
    ...
    448a:	47250513          	addi	a0,a0,1138 # 98f8 <schedule_dm+0x192e>
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
    ...
    44ba:	ef250513          	addi	a0,a0,-270 # 83a8 <schedule_dm+0x3de>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    44d8:	ed450513          	addi	a0,a0,-300 # 83a8 <schedule_dm+0x3de>
    ...
    44fc:	41850513          	addi	a0,a0,1048 # 9910 <schedule_dm+0x1946>
    ...
    4526:	45e58593          	addi	a1,a1,1118 # a980 <buf>
    452a:	853e                	mv	a0,a5
    ...
    455e:	3d650513          	addi	a0,a0,982 # 9930 <schedule_dm+0x1966>
    ...
    459e:	e0e50513          	addi	a0,a0,-498 # 83a8 <schedule_dm+0x3de>
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    460a:	10250513          	addi	a0,a0,258 # 8708 <schedule_dm+0x73e>
    ...
    4694:	2b850513          	addi	a0,a0,696 # 9948 <schedule_dm+0x197e>
    ...
    46be:	2c658593          	addi	a1,a1,710 # a980 <buf>
    46c2:	853e                	mv	a0,a5
    ...
    46f6:	23e50513          	addi	a0,a0,574 # 9930 <schedule_dm+0x1966>
...
bigfile(char *s)
{
  ...
  if(fd < 0){
    ...
    4826:	14e50513          	addi	a0,a0,334 # 9970 <schedule_dm+0x19a6>
  ...
  for(i = 0; i < N; i++){
    ...
    4850:	13450513          	addi	a0,a0,308 # a980 <buf>
    ...
    4868:	11c58593          	addi	a1,a1,284 # a980 <buf>
    486c:	853e                	mv	a0,a5
    ...
    488a:	10a50513          	addi	a0,a0,266 # 9990 <schedule_dm+0x19c6>
  ...
  fd = open("bigfile.dat", 0);
    ...
    48cc:	09850513          	addi	a0,a0,152 # 9960 <schedule_dm+0x1996>
  ...
  if(fd < 0){
    ...
    48f0:	0c450513          	addi	a0,a0,196 # 99b0 <schedule_dm+0x19e6>
  ...
  for(i = 0; ; i++){
    ...
    491a:	06a58593          	addi	a1,a1,106 # a980 <buf>
    491e:	853e                	mv	a0,a5
    ...
    4940:	09450513          	addi	a0,a0,148 # 99d0 <schedule_dm+0x1a06>
    ...
    4976:	07e50513          	addi	a0,a0,126 # 99f0 <schedule_dm+0x1a26>
    ...
    4990:	ff478793          	addi	a5,a5,-12 # a980 <buf>
    ...
    49b6:	fce78793          	addi	a5,a5,-50 # a980 <buf>
    ...
    49e0:	02c50513          	addi	a0,a0,44 # 9a08 <schedule_dm+0x1a3e>
  ...
  if(total != N*SZ){
    ...
    4a3a:	ff250513          	addi	a0,a0,-14 # 9a28 <schedule_dm+0x1a5e>
  ...
  unlink("bigfile.dat");
    ...
    4a54:	f1050513          	addi	a0,a0,-240 # 9960 <schedule_dm+0x1996>
...
fourteen(char *s)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    4a7a:	fd250513          	addi	a0,a0,-46 # 9a48 <schedule_dm+0x1a7e>
    ...
    4a92:	fca50513          	addi	a0,a0,-54 # 9a58 <schedule_dm+0x1a8e>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    4aac:	fd850513          	addi	a0,a0,-40 # 9a80 <schedule_dm+0x1ab6>
    ...
    4ac4:	fe050513          	addi	a0,a0,-32 # 9aa0 <schedule_dm+0x1ad6>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    4ae2:	ffa50513          	addi	a0,a0,-6 # 9ad8 <schedule_dm+0x1b0e>
  ...
  if(fd < 0){
    ...
    4b06:	00650513          	addi	a0,a0,6 # 9b08 <schedule_dm+0x1b3e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    4b30:	02450513          	addi	a0,a0,36 # 9b50 <schedule_dm+0x1b86>
  ...
  if(fd < 0){
    ...
    4b54:	03050513          	addi	a0,a0,48 # 9b80 <schedule_dm+0x1bb6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    4b7c:	04850513          	addi	a0,a0,72 # 9bc0 <schedule_dm+0x1bf6>
    ...
    4b94:	05050513          	addi	a0,a0,80 # 9be0 <schedule_dm+0x1c16>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    4bae:	06e50513          	addi	a0,a0,110 # 9c18 <schedule_dm+0x1c4e>
    ...
    4bc6:	07650513          	addi	a0,a0,118 # 9c38 <schedule_dm+0x1c6e>
...
rmdot(char *s)
{
  ...
  if(mkdir("dots") != 0){
    ...
    4c56:	01e50513          	addi	a0,a0,30 # 9c70 <schedule_dm+0x1ca6>
    ...
    4c6e:	00e50513          	addi	a0,a0,14 # 9c78 <schedule_dm+0x1cae>
  ...
  if(chdir("dots") != 0){
    ...
    4c88:	fec50513          	addi	a0,a0,-20 # 9c70 <schedule_dm+0x1ca6>
    ...
    4ca0:	ff450513          	addi	a0,a0,-12 # 9c90 <schedule_dm+0x1cc6>
  ...
  if(unlink(".") == 0){
    ...
    4cba:	5a250513          	addi	a0,a0,1442 # 9258 <schedule_dm+0x128e>
    ...
    4cd2:	fda50513          	addi	a0,a0,-38 # 9ca8 <schedule_dm+0x1cde>
  ...
  if(unlink("..") == 0){
    ...
    4cec:	02850513          	addi	a0,a0,40 # 8d10 <schedule_dm+0xd46>
    ...
    4d04:	fc050513          	addi	a0,a0,-64 # 9cc0 <schedule_dm+0x1cf6>
  ...
  if(chdir("/") != 0){
    ...
    4d1e:	d0e50513          	addi	a0,a0,-754 # 8a28 <schedule_dm+0xa5e>
    ...
    4d36:	cfe50513          	addi	a0,a0,-770 # 8a30 <schedule_dm+0xa66>
  ...
  if(unlink("dots/.") == 0){
    ...
    4d50:	f8c50513          	addi	a0,a0,-116 # 9cd8 <schedule_dm+0x1d0e>
    ...
    4d68:	f7c50513          	addi	a0,a0,-132 # 9ce0 <schedule_dm+0x1d16>
  ...
  if(unlink("dots/..") == 0){
    ...
    4d82:	f8250513          	addi	a0,a0,-126 # 9d00 <schedule_dm+0x1d36>
    ...
    4d9a:	f7250513          	addi	a0,a0,-142 # 9d08 <schedule_dm+0x1d3e>
  ...
  if(unlink("dots") != 0){
    ...
    4db4:	ec050513          	addi	a0,a0,-320 # 9c70 <schedule_dm+0x1ca6>
    ...
    4dcc:	f6050513          	addi	a0,a0,-160 # 9d28 <schedule_dm+0x1d5e>
...
dirfile(char *s)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4e00:	6d450513          	addi	a0,a0,1748 # 84d0 <schedule_dm+0x506>
  ...
  if(fd < 0){
    ...
    4e24:	f2850513          	addi	a0,a0,-216 # 9d48 <schedule_dm+0x1d7e>
  ...
  if(chdir("dirfile") == 0){
    ...
    4e4c:	68850513          	addi	a0,a0,1672 # 84d0 <schedule_dm+0x506>
    ...
    4e64:	f0850513          	addi	a0,a0,-248 # 9d68 <schedule_dm+0x1d9e>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4e80:	f0c50513          	addi	a0,a0,-244 # 9d88 <schedule_dm+0x1dbe>
  ...
  if(fd >= 0){
    ...
    4ea4:	ef850513          	addi	a0,a0,-264 # 9d98 <schedule_dm+0x1dce>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4ec2:	eca50513          	addi	a0,a0,-310 # 9d88 <schedule_dm+0x1dbe>
  ...
  if(fd >= 0){
    ...
    4ee6:	eb650513          	addi	a0,a0,-330 # 9d98 <schedule_dm+0x1dce>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4f00:	e8c50513          	addi	a0,a0,-372 # 9d88 <schedule_dm+0x1dbe>
    ...
    4f18:	eac50513          	addi	a0,a0,-340 # 9dc0 <schedule_dm+0x1df6>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4f32:	e5a50513          	addi	a0,a0,-422 # 9d88 <schedule_dm+0x1dbe>
    ...
    4f4a:	ea250513          	addi	a0,a0,-350 # 9de8 <schedule_dm+0x1e1e>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4f64:	e2858593          	addi	a1,a1,-472 # 9d88 <schedule_dm+0x1dbe>
    4f68:	00003517          	auipc	a0,0x3
    4f6c:	65050513          	addi	a0,a0,1616 # 85b8 <schedule_dm+0x5ee>
    ...
    4f84:	e9050513          	addi	a0,a0,-368 # 9e10 <schedule_dm+0x1e46>
  ...
  if(unlink("dirfile") != 0){
    ...
    4f9e:	53650513          	addi	a0,a0,1334 # 84d0 <schedule_dm+0x506>
    ...
    4fb6:	e8650513          	addi	a0,a0,-378 # 9e38 <schedule_dm+0x1e6e>
  ...
  fd = open(".", O_RDWR);
    ...
    4fd2:	28a50513          	addi	a0,a0,650 # 9258 <schedule_dm+0x128e>
  ...
  if(fd >= 0){
    ...
    4ff6:	e6650513          	addi	a0,a0,-410 # 9e58 <schedule_dm+0x1e8e>
  ...
  fd = open(".", 0);
    ...
    5012:	24a50513          	addi	a0,a0,586 # 9258 <schedule_dm+0x128e>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    502e:	5de58593          	addi	a1,a1,1502 # 8608 <schedule_dm+0x63e>
    5032:	853e                	mv	a0,a5
    ...
    504a:	e3a50513          	addi	a0,a0,-454 # 9e80 <schedule_dm+0x1eb6>
...
iref(char *s)
{
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    508e:	e0e50513          	addi	a0,a0,-498 # 9e98 <schedule_dm+0x1ece>
    ...
    50a6:	dfe50513          	addi	a0,a0,-514 # 9ea0 <schedule_dm+0x1ed6>
    ...
    50c0:	ddc50513          	addi	a0,a0,-548 # 9e98 <schedule_dm+0x1ece>
    ...
    50d8:	de450513          	addi	a0,a0,-540 # 9eb8 <schedule_dm+0x1eee>
    ...
    5150:	59450513          	addi	a0,a0,1428 # 86e0 <schedule_dm+0x716>
    ...
    517e:	56650513          	addi	a0,a0,1382 # 86e0 <schedule_dm+0x716>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    51ae:	b6650513          	addi	a0,a0,-1178 # 8d10 <schedule_dm+0xd46>
    51b2:	00002097          	auipc	ra,0x2
    51b6:	f38080e7          	jalr	-200(ra) # 70ea <chdir>
    unlink("irefd");
    51ba:	00005517          	auipc	a0,0x5
    51be:	cde50513          	addi	a0,a0,-802 # 9e98 <schedule_dm+0x1ece>
  ...
  chdir("/");
    ...
    51e8:	84450513          	addi	a0,a0,-1980 # 8a28 <schedule_dm+0xa5e>
...
forktest(char *s)
{
  ...
  if (n == 0) {
    ...
    5268:	c7450513          	addi	a0,a0,-908 # 9ed8 <schedule_dm+0x1f0e>
  ...
  if(n == N){
    ...
    5296:	c5e50513          	addi	a0,a0,-930 # 9ef0 <schedule_dm+0x1f26>
  ...
  for(; n > 0; n--){
    ...
    52c4:	c5850513          	addi	a0,a0,-936 # 9f18 <schedule_dm+0x1f4e>
  ...
  if(wait(0) != -1){
    ...
    530a:	c2a50513          	addi	a0,a0,-982 # 9f30 <schedule_dm+0x1f66>
...
sbrkbasic(char *s)
{
  ...
  if(pid < 0){
    ...
    5352:	bfa50513          	addi	a0,a0,-1030 # 9f48 <schedule_dm+0x1f7e>
  ...
  if(xstatus == 1){
    ...
    53f4:	b7850513          	addi	a0,a0,-1160 # 9f68 <schedule_dm+0x1f9e>
  ...
  for(i = 0; i < 5000; i++){
    ...
    544a:	b4250513          	addi	a0,a0,-1214 # 9f88 <schedule_dm+0x1fbe>
    ...
    *b = 1;
    ...
    5464:	4705                	li	a4,1
    5466:	00e78023          	sb	a4,0(a5) # 40000000 <__BSS_END__+0x3ffeee48>
    a = b + 1;
  ...
  if(pid < 0){
    ...
    54b0:	afc50513          	addi	a0,a0,-1284 # 9fa8 <schedule_dm+0x1fde>
  ...
  if(c != a + 1){
    ...
    54f8:	ad450513          	addi	a0,a0,-1324 # 9fc8 <schedule_dm+0x1ffe>
...
sbrkmuch(char *s)
{
  ...
  if (p != a) {
    ...
    559c:	a5050513          	addi	a0,a0,-1456 # 9fe8 <schedule_dm+0x201e>
  ...
  *lastaddr = 99;
    ...
    55fe:	00e78023          	sb	a4,0(a5) # 6400000 <__BSS_END__+0x63eee48>
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5630:	a0450513          	addi	a0,a0,-1532 # a030 <schedule_dm+0x2066>
  ...
  if(c != a - PGSIZE){
    ...
    5674:	9e050513          	addi	a0,a0,-1568 # a050 <schedule_dm+0x2086>
  ...
  if(c != a || sbrk(0) != a + PGSIZE){
    ...
    56da:	9ba50513          	addi	a0,a0,-1606 # a090 <schedule_dm+0x20c6>
  ...
  if(*lastaddr == 99){
    ...
    570a:	9ba50513          	addi	a0,a0,-1606 # a0c0 <schedule_dm+0x20f6>
  ...
  if(c != a){
    ...
    576c:	99050513          	addi	a0,a0,-1648 # a0f8 <schedule_dm+0x212e>
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    57c2:	17250513          	addi	a0,a0,370 # 8930 <schedule_dm+0x966>
    ...
    57f8:	92c50513          	addi	a0,a0,-1748 # a120 <schedule_dm+0x2156>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    5838:	35078793          	addi	a5,a5,848 # c350 <__global_pointer$+0x11d8>
    ...
    584c:	47f78793          	addi	a5,a5,1151 # 1003d47f <__BSS_END__+0x1002c2c7>
...
sbrkfail(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    5886:	54650513          	addi	a0,a0,1350 # 8dc8 <schedule_dm+0xdfe>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    58fe:	d0e58593          	addi	a1,a1,-754 # 8608 <schedule_dm+0x63e>
    5902:	853e                	mv	a0,a5
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    59da:	76a50513          	addi	a0,a0,1898 # a140 <schedule_dm+0x2176>
  ...
  if(pid < 0){
    ...
    5a10:	f2450513          	addi	a0,a0,-220 # 8930 <schedule_dm+0x966>
  ...
  if(pid == 0){
    ...
    5a96:	6ce50513          	addi	a0,a0,1742 # a160 <schedule_dm+0x2196>
...
sbrkarg(char *s)
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    5b08:	68c50513          	addi	a0,a0,1676 # a190 <schedule_dm+0x21c6>
  ...
  unlink("sbrk");
    ...
    5b1e:	67650513          	addi	a0,a0,1654 # a190 <schedule_dm+0x21c6>
  ...
  if(fd < 0)  {
    ...
    5b3c:	66050513          	addi	a0,a0,1632 # a198 <schedule_dm+0x21ce>
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    5b7e:	63650513          	addi	a0,a0,1590 # a1b0 <schedule_dm+0x21e6>
  ...
  if(pipe((int *) a) != 0){
    ...
    5bc8:	20450513          	addi	a0,a0,516 # 8dc8 <schedule_dm+0xdfe>
...
validatetest(char *s)
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    5c0c:	5c050513          	addi	a0,a0,1472 # a1c8 <schedule_dm+0x21fe>
    ...
    5c2a:	5b250513          	addi	a0,a0,1458 # a1d8 <schedule_dm+0x220e>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    5c7e:	d0670713          	addi	a4,a4,-762 # d980 <uninit>
    ...
    5c96:	56650513          	addi	a0,a0,1382 # a1f8 <schedule_dm+0x222e>
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    ...
    5ce2:	53250513          	addi	a0,a0,1330 # a210 <schedule_dm+0x2246>
  ...
  if(pid == 0){
    ...
    5d0e:	38e70713          	addi	a4,a4,910 # 11098 <args.1845>
    5d12:	fec42783          	lw	a5,-20(s0)
    5d16:	078e                	slli	a5,a5,0x3
    5d18:	97ba                	add	a5,a5,a4
    5d1a:	00004717          	auipc	a4,0x4
    5d1e:	50670713          	addi	a4,a4,1286 # a220 <schedule_dm+0x2256>
    ...
    5da4:	56050513          	addi	a0,a0,1376 # a300 <schedule_dm+0x2336>
  ...
  fd = open("bigarg-ok", 0);
    ...
    5de2:	43250513          	addi	a0,a0,1074 # a210 <schedule_dm+0x2246>
  ...
  if(fd < 0){
    ...
    5e06:	51e50513          	addi	a0,a0,1310 # a320 <schedule_dm+0x2356>
...
fsfull()
{
  ...
  printf("fsfull test\n");
    ...
    5e44:	50050513          	addi	a0,a0,1280 # a340 <schedule_dm+0x2376>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5ef6:	45e50513          	addi	a0,a0,1118 # a350 <schedule_dm+0x2386>
    ...
    5f2e:	43650513          	addi	a0,a0,1078 # a360 <schedule_dm+0x2396>
    ...
    5f4c:	a3858593          	addi	a1,a1,-1480 # a980 <buf>
    5f50:	853e                	mv	a0,a5
    ...
    5f96:	3de50513          	addi	a0,a0,990 # a370 <schedule_dm+0x23a6>
  ...
  printf("fsfull test finished\n");
    ...
    6086:	2fe50513          	addi	a0,a0,766 # a380 <schedule_dm+0x23b6>
...
void argptest(char *s)
{
  ...
  fd = open("init", O_RDONLY);
    ...
    60ae:	2ee50513          	addi	a0,a0,750 # a398 <schedule_dm+0x23ce>
  ...
  if (fd < 0) {
    ...
    60d2:	87a50513          	addi	a0,a0,-1926 # 8948 <schedule_dm+0x97e>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    612c:	85078793          	addi	a5,a5,-1968 # a978 <randstate>
    6130:	6398                	ld	a4,0(a5)
    6132:	001967b7          	lui	a5,0x196
    6136:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x185455>
    613a:	02f70733          	mul	a4,a4,a5
    613e:	3c6ef7b7          	lui	a5,0x3c6ef
    6142:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6de1a7>
    6146:	973e                	add	a4,a4,a5
    6148:	00005797          	auipc	a5,0x5
    614c:	83078793          	addi	a5,a5,-2000 # a978 <randstate>
    6150:	e398                	sd	a4,0(a5)
  return randstate;
    6152:	00005797          	auipc	a5,0x5
    6156:	82678793          	addi	a5,a5,-2010 # a978 <randstate>
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    61a6:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffede48>
    61aa:	2781                	sext.w	a5,a5
    61ac:	863e                	mv	a2,a5
    61ae:	fc843583          	ld	a1,-56(s0)
    61b2:	00004517          	auipc	a0,0x4
    61b6:	1ee50513          	addi	a0,a0,494 # a3a0 <schedule_dm+0x23d6>
    ...
    61de:	75650513          	addi	a0,a0,1878 # 8930 <schedule_dm+0x966>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    623e:	71678793          	addi	a5,a5,1814 # a950 <schedule_dm+0x2986>
  ...
  pipe((int*)0xeaeb0b5b00002f5e);
    ...
    6254:	70078793          	addi	a5,a5,1792 # a950 <schedule_dm+0x2986>
...
sbrkbugs(char *s)
{
  ...
  if(pid < 0){
    ...
    6296:	47650513          	addi	a0,a0,1142 # 8708 <schedule_dm+0x73e>
  ...
  if(pid < 0){
    ...
    6308:	40450513          	addi	a0,a0,1028 # 8708 <schedule_dm+0x73e>
  ...
  if(pid < 0){
    ...
    6380:	38c50513          	addi	a0,a0,908 # 8708 <schedule_dm+0x73e>
...
badwrite(char *s)
{
  ...
  unlink("junk");
    ...
    6404:	fc850513          	addi	a0,a0,-56 # a3c8 <schedule_dm+0x23fe>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    641e:	fae50513          	addi	a0,a0,-82 # a3c8 <schedule_dm+0x23fe>
    ...
    643e:	f9650513          	addi	a0,a0,-106 # a3d0 <schedule_dm+0x2406>
    ...
    647c:	f5050513          	addi	a0,a0,-176 # a3c8 <schedule_dm+0x23fe>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    64aa:	f2250513          	addi	a0,a0,-222 # a3c8 <schedule_dm+0x23fe>
  ...
  if(fd < 0){
    ...
    64ca:	f0a50513          	addi	a0,a0,-246 # a3d0 <schedule_dm+0x2406>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    64ea:	12258593          	addi	a1,a1,290 # 8608 <schedule_dm+0x63e>
    64ee:	853e                	mv	a0,a5
    ...
    6506:	ee650513          	addi	a0,a0,-282 # a3e8 <schedule_dm+0x241e>
  ...
  unlink("junk");
    ...
    652e:	e9e50513          	addi	a0,a0,-354 # a3c8 <schedule_dm+0x23fe>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    656c:	1b050513          	addi	a0,a0,432 # 8718 <schedule_dm+0x74e>
  ...
  for(int i = 0; i < 50000; i++){
    ...
    658c:	34f78793          	addi	a5,a5,847 # c34f <__global_pointer$+0x11d7>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    65cc:	14050513          	addi	a0,a0,320 # 8708 <schedule_dm+0x73e>
    ...
    660e:	873e                	mv	a4,a5
    6610:	4785                	li	a5,1
    6612:	00f70023          	sb	a5,0(a4) # b000 <buf+0x680>
      while(1){
    ...
    6652:	0ca78793          	addi	a5,a5,202 # 8718 <schedule_dm+0x74e>
    6656:	fcf43023          	sd	a5,-64(s0)
    665a:	00002797          	auipc	a5,0x2
    665e:	fae78793          	addi	a5,a5,-82 # 8608 <schedule_dm+0x63e>
    ...
    6674:	0a850513          	addi	a0,a0,168 # 8718 <schedule_dm+0x74e>
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    66d6:	d2650513          	addi	a0,a0,-730 # a3f8 <schedule_dm+0x242e>
  ...
  if(pid < 0){
    ...
    6708:	d1450513          	addi	a0,a0,-748 # a418 <schedule_dm+0x244e>
  ...
  if(pid == 0){
    ...
    676a:	ea258593          	addi	a1,a1,-350 # 8608 <schedule_dm+0x63e>
    676e:	853e                	mv	a0,a5
    ...
    6786:	cb650513          	addi	a0,a0,-842 # a438 <schedule_dm+0x246e>
  ...
  while(1){
    ...
    67e4:	c7850513          	addi	a0,a0,-904 # a458 <schedule_dm+0x248e>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    684e:	c2e50513          	addi	a0,a0,-978 # a478 <schedule_dm+0x24ae>
  ...
  if((pid = fork()) < 0) {
    ...
    6876:	c1650513          	addi	a0,a0,-1002 # a488 <schedule_dm+0x24be>
  ...
  if(pid == 0) {
    ...
    68c0:	be450513          	addi	a0,a0,-1052 # a4a0 <schedule_dm+0x24d6>
    ...
    68d2:	bda50513          	addi	a0,a0,-1062 # a4a8 <schedule_dm+0x24de>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    6932:	b8258593          	addi	a1,a1,-1150 # a4b0 <schedule_dm+0x24e6>
    6936:	853e                	mv	a0,a5
    ...
    6966:	b5658593          	addi	a1,a1,-1194 # a4b8 <schedule_dm+0x24ee>
    696a:	853e                	mv	a0,a5
    ...
    69c2:	b0250513          	addi	a0,a0,-1278 # a4c0 <schedule_dm+0x24f6>
  ...
  struct test {
    ...
    69dc:	bc870713          	addi	a4,a4,-1080 # a5a0 <schedule_dm+0x25d6>
  ...
  if(continuous){
    ...
    6a04:	ae850513          	addi	a0,a0,-1304 # a4e8 <schedule_dm+0x251e>
    ...
    6a6e:	a9e50513          	addi	a0,a0,-1378 # a508 <schedule_dm+0x253e>
    ...
    6ac4:	a6050513          	addi	a0,a0,-1440 # a520 <schedule_dm+0x2556>
  ...
  printf("usertests starting\n");
    ...
    6aec:	a5850513          	addi	a0,a0,-1448 # a540 <schedule_dm+0x2576>
  ...
  if(fail){
    ...
    6b76:	99650513          	addi	a0,a0,-1642 # a508 <schedule_dm+0x253e>
    ...
    6bba:	9a250513          	addi	a0,a0,-1630 # a558 <schedule_dm+0x258e>
    ...
    6bd4:	9b850513          	addi	a0,a0,-1608 # a588 <schedule_dm+0x25be>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    71e2:	78268693          	addi	a3,a3,1922 # a960 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    72bc:	6a870713          	addi	a4,a4,1704 # a960 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    747c:	4e078793          	addi	a5,a5,1248 # a958 <schedule_dm+0x298e>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    7628:	b8478793          	addi	a5,a5,-1148 # 111a8 <freep>
  ...
  freep = p;
    ...
    7720:	a8c78793          	addi	a5,a5,-1396 # 111a8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    77a2:	a0a78793          	addi	a5,a5,-1526 # 111a8 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    77d4:	9d878793          	addi	a5,a5,-1576 # 111a8 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    7892:	91a78793          	addi	a5,a5,-1766 # 111a8 <freep>
    ...
    78a8:	90478793          	addi	a5,a5,-1788 # 111a8 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    7a7a:	00009797          	auipc	a5,0x9
    7a7e:	73678793          	addi	a5,a5,1846 # 111b0 <last_thread.1226>
    ...
    7ad6:	00009797          	auipc	a5,0x9
    7ada:	6da78793          	addi	a5,a5,1754 # 111b0 <last_thread.1226>
    7ade:	639c                	ld	a5,0(a5)
    7ae0:	c385                	beqz	a5,7b00 <schedule_wrr+0xd6>
    7ae2:	00009797          	auipc	a5,0x9
    7ae6:	6ce78793          	addi	a5,a5,1742 # 111b0 <last_thread.1226>
    7aea:	639c                	ld	a5,0(a5)
    7aec:	4fbc                	lw	a5,88(a5)
    7aee:	00f05963          	blez	a5,7b00 <schedule_wrr+0xd6>
        selected_thread = last_thread;
    7af2:	00009797          	auipc	a5,0x9
    7af6:	6be78793          	addi	a5,a5,1726 # 111b0 <last_thread.1226>
    ...
    7b42:	00009797          	auipc	a5,0x9
    7b46:	66e78793          	addi	a5,a5,1646 # 111b0 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    7c78:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeee20>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    7daa:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeee20>
    ...
    7e44:	a00d                	j	7e66 <schedule_sjf+0x102>
    } else {
    ...
    7e54:	57fd                	li	a5,-1
    7e56:	00f70563          	beq	a4,a5,7e60 <schedule_sjf+0xfc>
    7e5a:	fb442783          	lw	a5,-76(s0)
    7e5e:	a011                	j	7e62 <schedule_sjf+0xfe>
    7e60:	4785                	li	a5,1
    7e62:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    7e66:	f8043783          	ld	a5,-128(s0)
    7e6a:	f8f43823          	sd	a5,-112(s0)
    7e6e:	f8843783          	ld	a5,-120(s0)
    7e72:	f8f43c23          	sd	a5,-104(s0)
    7e76:	4701                	li	a4,0
    7e78:	f9043703          	ld	a4,-112(s0)
    7e7c:	4781                	li	a5,0
    7e7e:	f9843783          	ld	a5,-104(s0)
    7e82:	893a                	mv	s2,a4
    7e84:	89be                	mv	s3,a5
    7e86:	874a                	mv	a4,s2
    7e88:	87ce                	mv	a5,s3
    ...
    7e8a:	853a                	mv	a0,a4
    7e8c:	85be                	mv	a1,a5
    7e8e:	70e6                	ld	ra,120(sp)
    7e90:	7446                	ld	s0,112(sp)
    7e92:	74a6                	ld	s1,104(sp)
    7e94:	7906                	ld	s2,96(sp)
    7e96:	69e6                	ld	s3,88(sp)
    7e98:	6109                	addi	sp,sp,128
    7e9a:	8082                	ret

0000000000007e9c <schedule_lst>:
...
{
    7e9c:	7119                	addi	sp,sp,-128
    7e9e:	fc86                	sd	ra,120(sp)
    7ea0:	f8a2                	sd	s0,112(sp)
    7ea2:	f4a6                	sd	s1,104(sp)
    7ea4:	f0ca                	sd	s2,96(sp)
    7ea6:	ecce                	sd	s3,88(sp)
    7ea8:	0100                	addi	s0,sp,128
    7eaa:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the least-slack-time scheduling algorithm
    struct thread *min_slack = NULL;
    7eac:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    7eb0:	800007b7          	lui	a5,0x80000
    7eb4:	fff7c793          	not	a5,a5
    7eb8:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;

    // Find the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    7ebc:	649c                	ld	a5,8(s1)
    7ebe:	639c                	ld	a5,0(a5)
    7ec0:	faf43823          	sd	a5,-80(s0)
    7ec4:	fb043783          	ld	a5,-80(s0)
    7ec8:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeee20>
    7ecc:	faf43c23          	sd	a5,-72(s0)
    7ed0:	a8b5                	j	7f4c <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    7ed2:	fb843783          	ld	a5,-72(s0)
    7ed6:	47f8                	lw	a4,76(a5)
    7ed8:	409c                	lw	a5,0(s1)
    7eda:	40f707bb          	subw	a5,a4,a5
    7ede:	0007871b          	sext.w	a4,a5
    7ee2:	fb843783          	ld	a5,-72(s0)
    7ee6:	4fbc                	lw	a5,88(a5)
    7ee8:	40f707bb          	subw	a5,a4,a5
    7eec:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    7ef0:	fc843783          	ld	a5,-56(s0)
    7ef4:	cb8d                	beqz	a5,7f26 <schedule_lst+0x8a>
    7ef6:	fac42703          	lw	a4,-84(s0)
    7efa:	fc442783          	lw	a5,-60(s0)
    7efe:	2701                	sext.w	a4,a4
    7f00:	2781                	sext.w	a5,a5
    7f02:	02f74263          	blt	a4,a5,7f26 <schedule_lst+0x8a>
    7f06:	fac42703          	lw	a4,-84(s0)
    7f0a:	fc442783          	lw	a5,-60(s0)
    7f0e:	2701                	sext.w	a4,a4
    7f10:	2781                	sext.w	a5,a5
    7f12:	02f71263          	bne	a4,a5,7f36 <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    7f16:	fb843783          	ld	a5,-72(s0)
    7f1a:	5fd8                	lw	a4,60(a5)
    7f1c:	fc843783          	ld	a5,-56(s0)
    7f20:	5fdc                	lw	a5,60(a5)
    7f22:	00f75a63          	bge	a4,a5,7f36 <schedule_lst+0x9a>
            min_slack = t;
    7f26:	fb843783          	ld	a5,-72(s0)
    7f2a:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    7f2e:	fac42783          	lw	a5,-84(s0)
    7f32:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    7f36:	fb843783          	ld	a5,-72(s0)
    7f3a:	779c                	ld	a5,40(a5)
    7f3c:	faf43023          	sd	a5,-96(s0)
    7f40:	fa043783          	ld	a5,-96(s0)
    7f44:	fd878793          	addi	a5,a5,-40
    7f48:	faf43c23          	sd	a5,-72(s0)
    7f4c:	fb843783          	ld	a5,-72(s0)
    7f50:	02878713          	addi	a4,a5,40
    7f54:	649c                	ld	a5,8(s1)
    7f56:	f6f71ee3          	bne	a4,a5,7ed2 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    7f5a:	fc843783          	ld	a5,-56(s0)
    7f5e:	cf89                	beqz	a5,7f78 <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    7f60:	fc843783          	ld	a5,-56(s0)
    7f64:	02878793          	addi	a5,a5,40
    7f68:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    7f6c:	fc843783          	ld	a5,-56(s0)
    7f70:	4fbc                	lw	a5,88(a5)
    7f72:	f8f42423          	sw	a5,-120(s0)
    7f76:	a839                	j	7f94 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    7f78:	649c                	ld	a5,8(s1)
    7f7a:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    7f7e:	689c                	ld	a5,16(s1)
    7f80:	4098                	lw	a4,0(s1)
    7f82:	85ba                	mv	a1,a4
    7f84:	853e                	mv	a0,a5
    7f86:	00000097          	auipc	ra,0x0
    7f8a:	c08080e7          	jalr	-1016(ra) # 7b8e <find_next_release_time>
    7f8e:	87aa                	mv	a5,a0
    7f90:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    7f94:	f8043783          	ld	a5,-128(s0)
    7f98:	f8f43823          	sd	a5,-112(s0)
    7f9c:	f8843783          	ld	a5,-120(s0)
    7fa0:	f8f43c23          	sd	a5,-104(s0)
    7fa4:	4701                	li	a4,0
    7fa6:	f9043703          	ld	a4,-112(s0)
    7faa:	4781                	li	a5,0
    7fac:	f9843783          	ld	a5,-104(s0)
    7fb0:	893a                	mv	s2,a4
    7fb2:	89be                	mv	s3,a5
    7fb4:	874a                	mv	a4,s2
    7fb6:	87ce                	mv	a5,s3
    ...
    7fb8:	853a                	mv	a0,a4
    7fba:	85be                	mv	a1,a5
    7fbc:	70e6                	ld	ra,120(sp)
    7fbe:	7446                	ld	s0,112(sp)
    7fc0:	74a6                	ld	s1,104(sp)
    7fc2:	7906                	ld	s2,96(sp)
    7fc4:	69e6                	ld	s3,88(sp)
    7fc6:	6109                	addi	sp,sp,128
    7fc8:	8082                	ret

0000000000007fca <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    7fca:	7135                	addi	sp,sp,-160
    7fcc:	ed06                	sd	ra,152(sp)
    7fce:	e922                	sd	s0,144(sp)
    7fd0:	e526                	sd	s1,136(sp)
    7fd2:	e14a                	sd	s2,128(sp)
    7fd4:	fcce                	sd	s3,120(sp)
    7fd6:	1100                	addi	s0,sp,160
    7fd8:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    7fda:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    7fde:	800007b7          	lui	a5,0x80000
    7fe2:	fff7c793          	not	a5,a5
    7fe6:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    7fea:	649c                	ld	a5,8(s1)
    7fec:	639c                	ld	a5,0(a5)
    7fee:	faf43423          	sd	a5,-88(s0)
    7ff2:	fa843783          	ld	a5,-88(s0)
    7ff6:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeee20>
    7ffa:	fcf43023          	sd	a5,-64(s0)
    7ffe:	a841                	j	808e <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    8000:	fc043783          	ld	a5,-64(s0)
    8004:	43bc                	lw	a5,64(a5)
    8006:	cb95                	beqz	a5,803a <schedule_dm+0x70>
    8008:	fc043783          	ld	a5,-64(s0)
    800c:	4bbc                	lw	a5,80(a5)
    800e:	873e                	mv	a4,a5
    8010:	57fd                	li	a5,-1
    8012:	02f70463          	beq	a4,a5,803a <schedule_dm+0x70>
    8016:	fc043783          	ld	a5,-64(s0)
    801a:	4ff8                	lw	a4,92(a5)
    801c:	fbc42783          	lw	a5,-68(s0)
    8020:	2781                	sext.w	a5,a5
    8022:	00f75c63          	bge	a4,a5,803a <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    8026:	fc043783          	ld	a5,-64(s0)
    802a:	4ffc                	lw	a5,92(a5)
    802c:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    8030:	fc043783          	ld	a5,-64(s0)
    8034:	fcf43423          	sd	a5,-56(s0)
    8038:	a081                	j	8078 <schedule_dm+0xae>
        } else if (t->is_real_time && t->period != -1 && t->current_deadline == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    803a:	fc043783          	ld	a5,-64(s0)
    803e:	43bc                	lw	a5,64(a5)
    8040:	cf85                	beqz	a5,8078 <schedule_dm+0xae>
    8042:	fc043783          	ld	a5,-64(s0)
    8046:	4bbc                	lw	a5,80(a5)
    8048:	873e                	mv	a4,a5
    804a:	57fd                	li	a5,-1
    804c:	02f70663          	beq	a4,a5,8078 <schedule_dm+0xae>
    8050:	fc043783          	ld	a5,-64(s0)
    8054:	4ff8                	lw	a4,92(a5)
    8056:	fbc42783          	lw	a5,-68(s0)
    805a:	2781                	sext.w	a5,a5
    805c:	00e79e63          	bne	a5,a4,8078 <schedule_dm+0xae>
    8060:	fc043783          	ld	a5,-64(s0)
    8064:	5fd8                	lw	a4,60(a5)
    8066:	fc843783          	ld	a5,-56(s0)
    806a:	5fdc                	lw	a5,60(a5)
    806c:	00f75663          	bge	a4,a5,8078 <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    8070:	fc043783          	ld	a5,-64(s0)
    8074:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    8078:	fc043783          	ld	a5,-64(s0)
    807c:	779c                	ld	a5,40(a5)
    807e:	f8f43423          	sd	a5,-120(s0)
    8082:	f8843783          	ld	a5,-120(s0)
    8086:	fd878793          	addi	a5,a5,-40
    808a:	fcf43023          	sd	a5,-64(s0)
    808e:	fc043783          	ld	a5,-64(s0)
    8092:	02878713          	addi	a4,a5,40
    8096:	649c                	ld	a5,8(s1)
    8098:	f6f714e3          	bne	a4,a5,8000 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    809c:	fc843783          	ld	a5,-56(s0)
    80a0:	c7a5                	beqz	a5,8108 <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    80a2:	fc843783          	ld	a5,-56(s0)
    80a6:	4ff8                	lw	a4,92(a5)
    80a8:	409c                	lw	a5,0(s1)
    80aa:	40f707bb          	subw	a5,a4,a5
    80ae:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    80b2:	fc843783          	ld	a5,-56(s0)
    80b6:	4fb8                	lw	a4,88(a5)
    80b8:	f9442783          	lw	a5,-108(s0)
    80bc:	2781                	sext.w	a5,a5
    80be:	00e7db63          	bge	a5,a4,80d4 <schedule_dm+0x10a>
    ...
    80c2:	fc843783          	ld	a5,-56(s0)
    80c6:	02878793          	addi	a5,a5,40
    80ca:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    80ce:	f6042823          	sw	zero,-144(s0)
    80d2:	a0f1                	j	819e <schedule_dm+0x1d4>
        } else {
    ...
    80da:	863e                	mv	a2,a5
    80dc:	f9442783          	lw	a5,-108(s0)
    80e0:	0007869b          	sext.w	a3,a5
    80e4:	0006071b          	sext.w	a4,a2
    80e8:	00d75363          	bge	a4,a3,80ee <schedule_dm+0x124>
    80ec:	87b2                	mv	a5,a2
    80ee:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    80f2:	fc843783          	ld	a5,-56(s0)
    80f6:	02878793          	addi	a5,a5,40
    80fa:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    80fe:	f9042783          	lw	a5,-112(s0)
    8102:	f6f42823          	sw	a5,-144(s0)
    8106:	a861                	j	819e <schedule_dm+0x1d4>
        }
    } else {
    ...
    8108:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    810c:	649c                	ld	a5,8(s1)
    810e:	639c                	ld	a5,0(a5)
    8110:	faf43023          	sd	a5,-96(s0)
    8114:	fa043783          	ld	a5,-96(s0)
    8118:	fd878793          	addi	a5,a5,-40
    811c:	fcf43023          	sd	a5,-64(s0)
    8120:	a81d                	j	8156 <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    8122:	fb043783          	ld	a5,-80(s0)
    8126:	cb89                	beqz	a5,8138 <schedule_dm+0x16e>
    8128:	fc043783          	ld	a5,-64(s0)
    812c:	5fd8                	lw	a4,60(a5)
    812e:	fb043783          	ld	a5,-80(s0)
    8132:	5fdc                	lw	a5,60(a5)
    8134:	00f75663          	bge	a4,a5,8140 <schedule_dm+0x176>
                smallest_id_thread = t;
    8138:	fc043783          	ld	a5,-64(s0)
    813c:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    8140:	fc043783          	ld	a5,-64(s0)
    8144:	779c                	ld	a5,40(a5)
    8146:	f8f43c23          	sd	a5,-104(s0)
    814a:	f9843783          	ld	a5,-104(s0)
    814e:	fd878793          	addi	a5,a5,-40
    8152:	fcf43023          	sd	a5,-64(s0)
    8156:	fc043783          	ld	a5,-64(s0)
    815a:	02878713          	addi	a4,a5,40
    815e:	649c                	ld	a5,8(s1)
    8160:	fcf711e3          	bne	a4,a5,8122 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    8164:	fb043783          	ld	a5,-80(s0)
    8168:	cf89                	beqz	a5,8182 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    816a:	fb043783          	ld	a5,-80(s0)
    816e:	02878793          	addi	a5,a5,40
    8172:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    8176:	fb043783          	ld	a5,-80(s0)
    817a:	4fbc                	lw	a5,88(a5)
    817c:	f6f42823          	sw	a5,-144(s0)
    8180:	a839                	j	819e <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    8182:	649c                	ld	a5,8(s1)
    8184:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    8188:	689c                	ld	a5,16(s1)
    818a:	4098                	lw	a4,0(s1)
    818c:	85ba                	mv	a1,a4
    818e:	853e                	mv	a0,a5
    8190:	00000097          	auipc	ra,0x0
    8194:	9fe080e7          	jalr	-1538(ra) # 7b8e <find_next_release_time>
    8198:	87aa                	mv	a5,a0
    819a:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    819e:	f6843783          	ld	a5,-152(s0)
    81a2:	f6f43c23          	sd	a5,-136(s0)
    81a6:	f7043783          	ld	a5,-144(s0)
    81aa:	f8f43023          	sd	a5,-128(s0)
    81ae:	4701                	li	a4,0
    81b0:	f7843703          	ld	a4,-136(s0)
    81b4:	4781                	li	a5,0
    81b6:	f8043783          	ld	a5,-128(s0)
    81ba:	893a                	mv	s2,a4
    81bc:	89be                	mv	s3,a5
    81be:	874a                	mv	a4,s2
    81c0:	87ce                	mv	a5,s3
    ...
    81c2:	853a                	mv	a0,a4
    81c4:	85be                	mv	a1,a5
    81c6:	60ea                	ld	ra,152(sp)
    81c8:	644a                	ld	s0,144(sp)
    81ca:	64aa                	ld	s1,136(sp)
    81cc:	690a                	ld	s2,128(sp)
    81ce:	79e6                	ld	s3,120(sp)
    81d0:	610d                	addi	sp,sp,160
    81d2:	8082                	ret

...
copyin(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
      ...
      54:	6d050513          	addi	a0,a0,1744 # 8720 <schedule_dm+0x498>
    ...
    if(fd < 0){
      ...
      74:	6b850513          	addi	a0,a0,1720 # 8728 <schedule_dm+0x4a0>
    ...
    if(n >= 0){
      ...
      be:	68650513          	addi	a0,a0,1670 # 8740 <schedule_dm+0x4b8>
    ...
    unlink("copyin1");
      ...
      e6:	63e50513          	addi	a0,a0,1598 # 8720 <schedule_dm+0x498>
    ...
    if(n > 0){
     ...
     122:	65250513          	addi	a0,a0,1618 # 8770 <schedule_dm+0x4e8>
    ...
    if(pipe(fds) < 0){
     ...
     150:	65450513          	addi	a0,a0,1620 # 87a0 <schedule_dm+0x518>
    ...
    if(n > 0){
     ...
     19a:	61a50513          	addi	a0,a0,1562 # 87b0 <schedule_dm+0x528>
...
copyout(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     22a:	5ba50513          	addi	a0,a0,1466 # 87e0 <schedule_dm+0x558>
    ...
    if(fd < 0){
     ...
     24a:	5a250513          	addi	a0,a0,1442 # 87e8 <schedule_dm+0x560>
    ...
    if(n > 0){
     ...
     294:	57050513          	addi	a0,a0,1392 # 8800 <schedule_dm+0x578>
    ...
    if(pipe(fds) < 0){
     ...
     2d0:	4d450513          	addi	a0,a0,1236 # 87a0 <schedule_dm+0x518>
    ...
    n = write(fds[1], "x", 1);
     ...
     2f0:	54458593          	addi	a1,a1,1348 # 8830 <schedule_dm+0x5a8>
     2f4:	853e                	mv	a0,a5
    ...
    if(n != 1){
     ...
     316:	52650513          	addi	a0,a0,1318 # 8838 <schedule_dm+0x5b0>
    ...
    if(n > 0){
     ...
     360:	4f450513          	addi	a0,a0,1268 # 8850 <schedule_dm+0x5c8>
...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    if(fd >= 0){
     ...
     41a:	46a50513          	addi	a0,a0,1130 # 8880 <schedule_dm+0x5f8>
...
copyinstr2(char *s)
{
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     4c8:	3dc50513          	addi	a0,a0,988 # 88a0 <schedule_dm+0x618>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     514:	3b050513          	addi	a0,a0,944 # 88c0 <schedule_dm+0x638>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     566:	37e50513          	addi	a0,a0,894 # 88e0 <schedule_dm+0x658>
  ...
  char *args[] = { "xx", 0 };
     ...
     580:	38c78793          	addi	a5,a5,908 # 8908 <schedule_dm+0x680>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     5c4:	35050513          	addi	a0,a0,848 # 8910 <schedule_dm+0x688>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
     ...
     5f6:	33e50513          	addi	a0,a0,830 # 8930 <schedule_dm+0x6a8>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     61e:	c9e70713          	addi	a4,a4,-866 # 102b8 <big.1275>
    ...
    ret = exec("echo", args2);
     ...
     682:	2c250513          	addi	a0,a0,706 # 8940 <schedule_dm+0x6b8>
    ...
    if(ret != -1){
     ...
     6ac:	2a050513          	addi	a0,a0,672 # 8948 <schedule_dm+0x6c0>
  ...
  if(st != 747){
    ...
    printf("exec(echo, BIG) succeeded, should have failed\n");
     ...
     6f2:	28250513          	addi	a0,a0,642 # 8970 <schedule_dm+0x6e8>
...
copyinstr3(char *s)
{
  ...
  if(top % PGSIZE){
    ...
    printf("oops\n");
     ...
     788:	23c50513          	addi	a0,a0,572 # 89c0 <schedule_dm+0x738>
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     7e2:	0c250513          	addi	a0,a0,194 # 88a0 <schedule_dm+0x618>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     82a:	09a50513          	addi	a0,a0,154 # 88c0 <schedule_dm+0x638>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     876:	06e50513          	addi	a0,a0,110 # 88e0 <schedule_dm+0x658>
  ...
  char *args[] = { "xx", 0 };
     ...
     890:	07c78793          	addi	a5,a5,124 # 8908 <schedule_dm+0x680>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     8d0:	04450513          	addi	a0,a0,68 # 8910 <schedule_dm+0x688>
...
rwsbrk()
{
  ...
  if(a == 0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) failed\n");
     ...
     916:	0b650513          	addi	a0,a0,182 # 89c8 <schedule_dm+0x740>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) shrink failed\n");
     ...
     942:	0a250513          	addi	a0,a0,162 # 89e0 <schedule_dm+0x758>
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
     ...
     960:	b1c50513          	addi	a0,a0,-1252 # 8478 <schedule_dm+0x1f0>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     980:	08450513          	addi	a0,a0,132 # 8a00 <schedule_dm+0x778>
  ...
  if(n >= 0){
    ...
    printf("write(fd, %p, 1024) returned %d, not -1\n", a+4096, n);
     ...
     9d8:	04450513          	addi	a0,a0,68 # 8a18 <schedule_dm+0x790>
  ...
  unlink("rwsbrk");
     ...
     a00:	a7c50513          	addi	a0,a0,-1412 # 8478 <schedule_dm+0x1f0>
  ...
  fd = open("README", O_RDONLY);
     ...
     a12:	dd250513          	addi	a0,a0,-558 # 87e0 <schedule_dm+0x558>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     a32:	fd250513          	addi	a0,a0,-46 # 8a00 <schedule_dm+0x778>
  ...
  if(n >= 0){
    ...
    printf("read(fd, %p, 10) returned %d, not -1\n", a+4096, n);
     ...
     a88:	fc450513          	addi	a0,a0,-60 # 8a48 <schedule_dm+0x7c0>
...
truncate1(char *s)
{
  ...
  write(fd1, "abcd", 4);
     ...
     af6:	f8e58593          	addi	a1,a1,-114 # 8a80 <schedule_dm+0x7f8>
     afa:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     b18:	f5c50513          	addi	a0,a0,-164 # 8a70 <schedule_dm+0x7e8>
  ...
  if(n != 4){
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     b64:	f2850513          	addi	a0,a0,-216 # 8a88 <schedule_dm+0x800>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     b82:	ef250513          	addi	a0,a0,-270 # 8a70 <schedule_dm+0x7e8>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     b9a:	eda50513          	addi	a0,a0,-294 # 8a70 <schedule_dm+0x7e8>
  ...
  if(n != 0){
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     bdc:	ed050513          	addi	a0,a0,-304 # 8aa8 <schedule_dm+0x820>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     bf6:	ec650513          	addi	a0,a0,-314 # 8ab8 <schedule_dm+0x830>
  ...
  if(n != 0){
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     c3c:	ea050513          	addi	a0,a0,-352 # 8ad8 <schedule_dm+0x850>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     c56:	e6650513          	addi	a0,a0,-410 # 8ab8 <schedule_dm+0x830>
  ...
  write(fd1, "abcdef", 6);
     ...
     c76:	e7658593          	addi	a1,a1,-394 # 8ae8 <schedule_dm+0x860>
     c7a:	853e                	mv	a0,a5
  ...
  if(n != 6){
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     cbe:	e3650513          	addi	a0,a0,-458 # 8af0 <schedule_dm+0x868>
  ...
  if(n != 2){
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     d0e:	e0650513          	addi	a0,a0,-506 # 8b10 <schedule_dm+0x888>
  ...
  unlink("truncfile");
     ...
     d28:	d4c50513          	addi	a0,a0,-692 # 8a70 <schedule_dm+0x7e8>
...
truncate2(char *s)
{
  ...
  unlink("truncfile");
     ...
     d78:	cfc50513          	addi	a0,a0,-772 # 8a70 <schedule_dm+0x7e8>
  ...
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     ...
     d8c:	ce850513          	addi	a0,a0,-792 # 8a70 <schedule_dm+0x7e8>
  ...
  write(fd1, "abcd", 4);
     ...
     da8:	cdc58593          	addi	a1,a1,-804 # 8a80 <schedule_dm+0x7f8>
     dac:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     ...
     dbe:	cb650513          	addi	a0,a0,-842 # 8a70 <schedule_dm+0x7e8>
  ...
  int n = write(fd1, "x", 1);
     ...
     dda:	a5a58593          	addi	a1,a1,-1446 # 8830 <schedule_dm+0x5a8>
     dde:	853e                	mv	a0,a5
  ...
  if(n != -1){
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     e0a:	d2a50513          	addi	a0,a0,-726 # 8b30 <schedule_dm+0x8a8>
  ...
  unlink("truncfile");
     ...
     e24:	c5050513          	addi	a0,a0,-944 # 8a70 <schedule_dm+0x7e8>
...
truncate3(char *s)
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     e6a:	c0a50513          	addi	a0,a0,-1014 # 8a70 <schedule_dm+0x7e8>
  ...
  if(pid < 0){
    ...
    printf("%s: fork failed\n", s);
     ...
     ea2:	cba50513          	addi	a0,a0,-838 # 8b58 <schedule_dm+0x8d0>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < 100; i++){
     ...
     ece:	ba650513          	addi	a0,a0,-1114 # 8a70 <schedule_dm+0x7e8>
     ...
     ef2:	c8250513          	addi	a0,a0,-894 # 8b70 <schedule_dm+0x8e8>
     ...
     f12:	c7a58593          	addi	a1,a1,-902 # 8b88 <schedule_dm+0x900>
     f16:	853e                	mv	a0,a5
     ...
     f42:	c5a50513          	addi	a0,a0,-934 # 8b98 <schedule_dm+0x910>
     ...
     f6c:	b0850513          	addi	a0,a0,-1272 # 8a70 <schedule_dm+0x7e8>
  ...
  for(int i = 0; i < 150; i++){
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     fd6:	a9e50513          	addi	a0,a0,-1378 # 8a70 <schedule_dm+0x7e8>
    ...
    if(fd < 0){
     ...
     ffa:	b7a50513          	addi	a0,a0,-1158 # 8b70 <schedule_dm+0x8e8>
    ...
    101a:	ba258593          	addi	a1,a1,-1118 # 8bb8 <schedule_dm+0x930>
    101e:	853e                	mv	a0,a5
    ...
    104a:	b7a50513          	addi	a0,a0,-1158 # 8bc0 <schedule_dm+0x938>
  ...
  unlink("truncfile");
    ...
    109a:	9da50513          	addi	a0,a0,-1574 # 8a70 <schedule_dm+0x7e8>
...
iputtest(char *s)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    10c4:	b2050513          	addi	a0,a0,-1248 # 8be0 <schedule_dm+0x958>
    ...
    10de:	b0e50513          	addi	a0,a0,-1266 # 8be8 <schedule_dm+0x960>
  ...
  if(chdir("iputdir") < 0){
    ...
    10f8:	aec50513          	addi	a0,a0,-1300 # 8be0 <schedule_dm+0x958>
    ...
    1112:	af250513          	addi	a0,a0,-1294 # 8c00 <schedule_dm+0x978>
  ...
  if(unlink("../iputdir") < 0){
    ...
    112c:	af850513          	addi	a0,a0,-1288 # 8c20 <schedule_dm+0x998>
    ...
    1146:	aee50513          	addi	a0,a0,-1298 # 8c30 <schedule_dm+0x9a8>
  ...
  if(chdir("/") < 0){
    ...
    1160:	af450513          	addi	a0,a0,-1292 # 8c50 <schedule_dm+0x9c8>
    ...
    117a:	ae250513          	addi	a0,a0,-1310 # 8c58 <schedule_dm+0x9d0>
...
exitiputtest(char *s)
{
  ...
  if(pid < 0){
    ...
    11c6:	99650513          	addi	a0,a0,-1642 # 8b58 <schedule_dm+0x8d0>
  ...
  if(pid == 0){
    ...
    11e8:	9fc50513          	addi	a0,a0,-1540 # 8be0 <schedule_dm+0x958>
    ...
    1202:	9ea50513          	addi	a0,a0,-1558 # 8be8 <schedule_dm+0x960>
    ...
    121c:	9c850513          	addi	a0,a0,-1592 # 8be0 <schedule_dm+0x958>
    ...
    1236:	a3e50513          	addi	a0,a0,-1474 # 8c70 <schedule_dm+0x9e8>
    ...
    1250:	9d450513          	addi	a0,a0,-1580 # 8c20 <schedule_dm+0x998>
    ...
    126a:	9ca50513          	addi	a0,a0,-1590 # 8c30 <schedule_dm+0x9a8>
...
openiputtest(char *s)
{
  ...
  if(mkdir("oidir") < 0){
    ...
    12b6:	9d650513          	addi	a0,a0,-1578 # 8c88 <schedule_dm+0xa00>
    ...
    12d0:	9c450513          	addi	a0,a0,-1596 # 8c90 <schedule_dm+0xa08>
  ...
  if(pid < 0){
    ...
    1306:	85650513          	addi	a0,a0,-1962 # 8b58 <schedule_dm+0x8d0>
  ...
  if(pid == 0){
    ...
    132a:	96250513          	addi	a0,a0,-1694 # 8c88 <schedule_dm+0xa00>
    ...
    134e:	95e50513          	addi	a0,a0,-1698 # 8ca8 <schedule_dm+0xa20>
  ...
  if(unlink("oidir") != 0){
    ...
    137c:	91050513          	addi	a0,a0,-1776 # 8c88 <schedule_dm+0xa00>
    ...
    1394:	94050513          	addi	a0,a0,-1728 # 8cd0 <schedule_dm+0xa48>
...
opentest(char *s)
{
  ...
  fd = open("echo", 0);
    ...
    13d8:	56c50513          	addi	a0,a0,1388 # 8940 <schedule_dm+0x6b8>
  ...
  if(fd < 0){
    ...
    13fc:	8f050513          	addi	a0,a0,-1808 # 8ce8 <schedule_dm+0xa60>
  ...
  fd = open("doesnotexist", 0);
    ...
    1426:	8de50513          	addi	a0,a0,-1826 # 8d00 <schedule_dm+0xa78>
  ...
  if(fd >= 0){
    ...
    144a:	8ca50513          	addi	a0,a0,-1846 # 8d10 <schedule_dm+0xa88>
...
writetest(char *s)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    147e:	8be50513          	addi	a0,a0,-1858 # 8d38 <schedule_dm+0xab0>
  ...
  if(fd < 0){
    ...
    14a2:	8a250513          	addi	a0,a0,-1886 # 8d40 <schedule_dm+0xab8>
  ...
  for(i = 0; i < N; i++){
    ...
    14c8:	89c58593          	addi	a1,a1,-1892 # 8d60 <schedule_dm+0xad8>
    14cc:	853e                	mv	a0,a5
    ...
    14ee:	88650513          	addi	a0,a0,-1914 # 8d70 <schedule_dm+0xae8>
    ...
    150e:	88e58593          	addi	a1,a1,-1906 # 8d98 <schedule_dm+0xb10>
    1512:	853e                	mv	a0,a5
    ...
    1534:	87850513          	addi	a0,a0,-1928 # 8da8 <schedule_dm+0xb20>
  ...
  fd = open("small", O_RDONLY);
    ...
    1578:	7c450513          	addi	a0,a0,1988 # 8d38 <schedule_dm+0xab0>
  ...
  if(fd < 0){
    ...
    159c:	83850513          	addi	a0,a0,-1992 # 8dd0 <schedule_dm+0xb48>
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    15be:	5ee58593          	addi	a1,a1,1518 # aba8 <buf>
    15c2:	853e                	mv	a0,a5
  ...
  if(i != N*SZ*2){
    ...
    15ea:	80a50513          	addi	a0,a0,-2038 # 8df0 <schedule_dm+0xb68>
  ...
  if(unlink("small") < 0){
    ...
    1612:	72a50513          	addi	a0,a0,1834 # 8d38 <schedule_dm+0xab0>
    ...
    162c:	7e050513          	addi	a0,a0,2016 # 8e08 <schedule_dm+0xb80>
...
writebig(char *s)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    1660:	7cc50513          	addi	a0,a0,1996 # 8e28 <schedule_dm+0xba0>
  ...
  if(fd < 0){
    ...
    1684:	7b050513          	addi	a0,a0,1968 # 8e30 <schedule_dm+0xba8>
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	50878793          	addi	a5,a5,1288 # aba8 <buf>
    ...
    16ba:	4f258593          	addi	a1,a1,1266 # aba8 <buf>
    16be:	853e                	mv	a0,a5
    ...
    16e2:	77250513          	addi	a0,a0,1906 # 8e50 <schedule_dm+0xbc8>
  ...
  fd = open("big", O_RDONLY);
    ...
    1726:	70650513          	addi	a0,a0,1798 # 8e28 <schedule_dm+0xba0>
  ...
  if(fd < 0){
    ...
    174a:	73250513          	addi	a0,a0,1842 # 8e78 <schedule_dm+0xbf0>
  ...
  for(;;){
    ...
    1770:	43c58593          	addi	a1,a1,1084 # aba8 <buf>
    1774:	853e                	mv	a0,a5
    ...
    17aa:	6f250513          	addi	a0,a0,1778 # 8e98 <schedule_dm+0xc10>
    ...
    17de:	6e650513          	addi	a0,a0,1766 # 8ec0 <schedule_dm+0xc38>
    ...
    17f8:	3b478793          	addi	a5,a5,948 # aba8 <buf>
    ...
    180c:	3a078793          	addi	a5,a5,928 # aba8 <buf>
      printf("%s: read content of block %d is %d\n", s,
    ...
    1822:	6ba50513          	addi	a0,a0,1722 # 8ed8 <schedule_dm+0xc50>
  ...
  if(unlink("big") < 0){
    ...
    1858:	5d450513          	addi	a0,a0,1492 # 8e28 <schedule_dm+0xba0>
    ...
    1872:	69250513          	addi	a0,a0,1682 # 8f00 <schedule_dm+0xc78>
...
void dirtest(char *s)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    196e:	5ae50513          	addi	a0,a0,1454 # 8f18 <schedule_dm+0xc90>
    ...
    1988:	26450513          	addi	a0,a0,612 # 8be8 <schedule_dm+0x960>
  ...
  if(chdir("dir0") < 0){
    ...
    19a2:	57a50513          	addi	a0,a0,1402 # 8f18 <schedule_dm+0xc90>
    ...
    19bc:	56850513          	addi	a0,a0,1384 # 8f20 <schedule_dm+0xc98>
  ...
  if(chdir("..") < 0){
    ...
    19d6:	56650513          	addi	a0,a0,1382 # 8f38 <schedule_dm+0xcb0>
    ...
    19f0:	55450513          	addi	a0,a0,1364 # 8f40 <schedule_dm+0xcb8>
  ...
  if(unlink("dir0") < 0){
    ...
    1a0a:	51250513          	addi	a0,a0,1298 # 8f18 <schedule_dm+0xc90>
    ...
    1a24:	53850513          	addi	a0,a0,1336 # 8f58 <schedule_dm+0xcd0>
...
exectest(char *s)
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1a54:	ef078793          	addi	a5,a5,-272 # 8940 <schedule_dm+0x6b8>
    1a58:	fcf43423          	sd	a5,-56(s0)
    1a5c:	00007797          	auipc	a5,0x7
    1a60:	51478793          	addi	a5,a5,1300 # 8f70 <schedule_dm+0xce8>
  ...
  unlink("echo-ok");
    ...
    1a70:	50c50513          	addi	a0,a0,1292 # 8f78 <schedule_dm+0xcf0>
  ...
  if(pid < 0) {
    ...
    1a9c:	0c050513          	addi	a0,a0,192 # 8b58 <schedule_dm+0x8d0>
  ...
  if(pid == 0) {
    ...
    1acc:	4b050513          	addi	a0,a0,1200 # 8f78 <schedule_dm+0xcf0>
    ...
    1af0:	49450513          	addi	a0,a0,1172 # 8f80 <schedule_dm+0xcf8>
    ...
    1b1c:	48050513          	addi	a0,a0,1152 # 8f98 <schedule_dm+0xd10>
    ...
    1b3c:	e0850513          	addi	a0,a0,-504 # 8940 <schedule_dm+0x6b8>
    ...
    1b56:	45650513          	addi	a0,a0,1110 # 8fa8 <schedule_dm+0xd20>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1b90:	43450513          	addi	a0,a0,1076 # 8fc0 <schedule_dm+0xd38>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1bb6:	3c650513          	addi	a0,a0,966 # 8f78 <schedule_dm+0xcf0>
  ...
  if(fd < 0) {
    ...
    1bda:	f9a50513          	addi	a0,a0,-102 # 8b70 <schedule_dm+0x8e8>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1c18:	1dc50513          	addi	a0,a0,476 # 8df0 <schedule_dm+0xb68>
  ...
  unlink("echo-ok");
    ...
    1c32:	34a50513          	addi	a0,a0,842 # 8f78 <schedule_dm+0xcf0>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1c6c:	37050513          	addi	a0,a0,880 # 8fd8 <schedule_dm+0xd50>
...
pipe1(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    1ca8:	34c50513          	addi	a0,a0,844 # 8ff0 <schedule_dm+0xd68>
  ...
  if(pid == 0){
    ...
    1d06:	ea668693          	addi	a3,a3,-346 # aba8 <buf>
    ...
    1d3a:	e7258593          	addi	a1,a1,-398 # aba8 <buf>
    1d3e:	853e                	mv	a0,a5
    ...
    1d5c:	2b050513          	addi	a0,a0,688 # 9008 <schedule_dm+0xd80>
    ...
    1dc2:	dea70713          	addi	a4,a4,-534 # aba8 <buf>
    ...
    1df4:	23050513          	addi	a0,a0,560 # 9020 <schedule_dm+0xd98>
    ...
    1e56:	d5658593          	addi	a1,a1,-682 # aba8 <buf>
    1e5a:	853e                	mv	a0,a5
    ...
    1e90:	1ac50513          	addi	a0,a0,428 # 9038 <schedule_dm+0xdb0>
    ...
    1ed8:	18450513          	addi	a0,a0,388 # 9058 <schedule_dm+0xdd0>
...
preempt(char *s)
{
  ...
  if(pid1 < 0) {
    ...
    1f22:	15250513          	addi	a0,a0,338 # 9070 <schedule_dm+0xde8>
  ...
  if(pid2 < 0) {
    ...
    1f62:	bfa50513          	addi	a0,a0,-1030 # 8b58 <schedule_dm+0x8d0>
  ...
  if(pid3 < 0) {
    ...
    1fb0:	bac50513          	addi	a0,a0,-1108 # 8b58 <schedule_dm+0x8d0>
  ...
  if(pid3 == 0){
    ...
    1fe6:	84e58593          	addi	a1,a1,-1970 # 8830 <schedule_dm+0x5a8>
    1fea:	853e                	mv	a0,a5
    ...
    2006:	07e50513          	addi	a0,a0,126 # 9080 <schedule_dm+0xdf8>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    203a:	b7258593          	addi	a1,a1,-1166 # aba8 <buf>
    203e:	853e                	mv	a0,a5
    ...
    205a:	04250513          	addi	a0,a0,66 # 9098 <schedule_dm+0xe10>
  ...
  printf("kill... ");
    ...
    207a:	03a50513          	addi	a0,a0,58 # 90b0 <schedule_dm+0xe28>
  ...
  printf("wait... ");
    ...
    20b4:	01050513          	addi	a0,a0,16 # 90c0 <schedule_dm+0xe38>
...
exitwait(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    2118:	a4450513          	addi	a0,a0,-1468 # 8b58 <schedule_dm+0x8d0>
    ...
    215a:	f7a50513          	addi	a0,a0,-134 # 90d0 <schedule_dm+0xe48>
    ...
    2186:	f6650513          	addi	a0,a0,-154 # 90e8 <schedule_dm+0xe60>
...
reparent(char *s)
{
  ...
  for(int i = 0; i < 200; i++){
    ...
    2210:	94c50513          	addi	a0,a0,-1716 # 8b58 <schedule_dm+0x8d0>
    ...
    224e:	e8650513          	addi	a0,a0,-378 # 90d0 <schedule_dm+0xe48>
...
twochildren(char *s)
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    22f4:	86850513          	addi	a0,a0,-1944 # 8b58 <schedule_dm+0x8d0>
    ...
    233c:	82050513          	addi	a0,a0,-2016 # 8b58 <schedule_dm+0x8d0>
...
forkfork(char *s)
{
  ...
  for(int i = 0; i < N; i++){
    ...
    23d0:	ca450513          	addi	a0,a0,-860 # 9070 <schedule_dm+0xde8>
  ...
  for(int i = 0; i < N; i++){
    ...
    2490:	c7c50513          	addi	a0,a0,-900 # 9108 <schedule_dm+0xe80>
...
forkforkfork(char *s)
{
  ...
  unlink("stopforking");
    ...
    24da:	c5250513          	addi	a0,a0,-942 # 9128 <schedule_dm+0xea0>
  ...
  if(pid < 0){
    ...
    2506:	b6e50513          	addi	a0,a0,-1170 # 9070 <schedule_dm+0xde8>
  ...
  if(pid == 0){
    ...
    252a:	c0250513          	addi	a0,a0,-1022 # 9128 <schedule_dm+0xea0>
    ...
    2566:	bc650513          	addi	a0,a0,-1082 # 9128 <schedule_dm+0xea0>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    2592:	b9a50513          	addi	a0,a0,-1126 # 9128 <schedule_dm+0xea0>
...
reparent2(char *s)
{
  ...
  for(int i = 0; i < 800; i++){
    ...
    25f6:	33e50513          	addi	a0,a0,830 # 8930 <schedule_dm+0x6a8>
...
mem(char *s)
{
  ...
  if((pid = fork()) == 0){
    ...
    26f0:	a4c50513          	addi	a0,a0,-1460 # 9138 <schedule_dm+0xeb0>
...
sharedfd(char *s)
{
  ...
  if(fd < 0){
    ...
    2796:	9c650513          	addi	a0,a0,-1594 # 9158 <schedule_dm+0xed0>
  ...
  for(i = 0; i < N; i++){
    ...
    280c:	97850513          	addi	a0,a0,-1672 # 9180 <schedule_dm+0xef8>
  ...
  fd = open("sharedfd", 0);
    ...
    2884:	d1850513          	addi	a0,a0,-744 # 8598 <schedule_dm+0x310>
  ...
  if(fd < 0){
    ...
    28a8:	8fc50513          	addi	a0,a0,-1796 # 91a0 <schedule_dm+0xf18>
  ...
  unlink("sharedfd");
    ...
    2964:	c3850513          	addi	a0,a0,-968 # 8598 <schedule_dm+0x310>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    29a6:	82650513          	addi	a0,a0,-2010 # 91c8 <schedule_dm+0xf40>
...
fourfiles(char *s)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    29cc:	86878793          	addi	a5,a5,-1944 # 9230 <schedule_dm+0xfa8>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2a2e:	f0650513          	addi	a0,a0,-250 # 8930 <schedule_dm+0x6a8>
    ...
    2a74:	77050513          	addi	a0,a0,1904 # 91e0 <schedule_dm+0xf58>
    ...
    2a9e:	10e50513          	addi	a0,a0,270 # aba8 <buf>
    ...
    2abc:	0f058593          	addi	a1,a1,240 # aba8 <buf>
    2ac0:	853e                	mv	a0,a5
    ...
    2aea:	70a50513          	addi	a0,a0,1802 # 91f0 <schedule_dm+0xf68>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2bb8:	ff470713          	addi	a4,a4,-12 # aba8 <buf>
    ...
    2be0:	62c50513          	addi	a0,a0,1580 # 9208 <schedule_dm+0xf80>
    ...
    2c28:	f8458593          	addi	a1,a1,-124 # aba8 <buf>
    2c2c:	853e                	mv	a0,a5
    ...
    2c70:	5ac50513          	addi	a0,a0,1452 # 9218 <schedule_dm+0xf90>
...
createdelete(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2ce8:	c4c50513          	addi	a0,a0,-948 # 8930 <schedule_dm+0x6a8>
    ...
    2d64:	22050513          	addi	a0,a0,544 # 8f80 <schedule_dm+0xcf8>
    ...
    2dd8:	efc50513          	addi	a0,a0,-260 # 8cd0 <schedule_dm+0xa48>
  ...
  for(i = 0; i < N; i++){
    ...
    2ef0:	36450513          	addi	a0,a0,868 # 9250 <schedule_dm+0xfc8>
    ...
    2f36:	34650513          	addi	a0,a0,838 # 9278 <schedule_dm+0xff0>
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3026:	53e50513          	addi	a0,a0,1342 # 8560 <schedule_dm+0x2d8>
  ...
  if(fd < 0){
    ...
    304a:	25a50513          	addi	a0,a0,602 # 92a0 <schedule_dm+0x1018>
  ...
  write(fd, "hello", SZ);
    ...
    306a:	25a58593          	addi	a1,a1,602 # 92c0 <schedule_dm+0x1038>
    306e:	853e                	mv	a0,a5
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    308c:	4d850513          	addi	a0,a0,1240 # 8560 <schedule_dm+0x2d8>
  ...
  if(fd < 0){
    ...
    30b0:	21c50513          	addi	a0,a0,540 # 92c8 <schedule_dm+0x1040>
  ...
  if(unlink("unlinkread") != 0){
    ...
    30ca:	49a50513          	addi	a0,a0,1178 # 8560 <schedule_dm+0x2d8>
    ...
    30e2:	20a50513          	addi	a0,a0,522 # 92e8 <schedule_dm+0x1060>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3100:	46450513          	addi	a0,a0,1124 # 8560 <schedule_dm+0x2d8>
  ...
  write(fd1, "yyy", 3);
    ...
    311c:	1f058593          	addi	a1,a1,496 # 9308 <schedule_dm+0x1080>
    3120:	853e                	mv	a0,a5
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3142:	a6a58593          	addi	a1,a1,-1430 # aba8 <buf>
    3146:	853e                	mv	a0,a5
    ...
    3162:	1b250513          	addi	a0,a0,434 # 9310 <schedule_dm+0x1088>
  ...
  if(buf[0] != 'h'){
    ...
    317c:	a3078793          	addi	a5,a5,-1488 # aba8 <buf>
    ...
    3196:	19e50513          	addi	a0,a0,414 # 9330 <schedule_dm+0x10a8>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    31b6:	9f658593          	addi	a1,a1,-1546 # aba8 <buf>
    31ba:	853e                	mv	a0,a5
    ...
    31d6:	17e50513          	addi	a0,a0,382 # 9350 <schedule_dm+0x10c8>
  ...
  unlink("unlinkread");
    ...
    31fe:	36650513          	addi	a0,a0,870 # 8560 <schedule_dm+0x2d8>
...
linktest(char *s)
{
  ...
  unlink("lf1");
    ...
    3224:	15050513          	addi	a0,a0,336 # 9370 <schedule_dm+0x10e8>
    3228:	00004097          	auipc	ra,0x4
    322c:	ea2080e7          	jalr	-350(ra) # 70ca <unlink>
  unlink("lf2");
    3230:	00006517          	auipc	a0,0x6
    3234:	14850513          	addi	a0,a0,328 # 9378 <schedule_dm+0x10f0>
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    3248:	12c50513          	addi	a0,a0,300 # 9370 <schedule_dm+0x10e8>
  ...
  if(fd < 0){
    ...
    326c:	11850513          	addi	a0,a0,280 # 9380 <schedule_dm+0x10f8>
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    328c:	03858593          	addi	a1,a1,56 # 92c0 <schedule_dm+0x1038>
    3290:	853e                	mv	a0,a5
    ...
    32ac:	0f050513          	addi	a0,a0,240 # 9398 <schedule_dm+0x1110>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    32d4:	0a858593          	addi	a1,a1,168 # 9378 <schedule_dm+0x10f0>
    32d8:	00006517          	auipc	a0,0x6
    32dc:	09850513          	addi	a0,a0,152 # 9370 <schedule_dm+0x10e8>
    ...
    32f6:	0be50513          	addi	a0,a0,190 # 93b0 <schedule_dm+0x1128>
  ...
  unlink("lf1");
    ...
    3310:	06450513          	addi	a0,a0,100 # 9370 <schedule_dm+0x10e8>
  ...
  if(open("lf1", 0) >= 0){
    ...
    3322:	05250513          	addi	a0,a0,82 # 9370 <schedule_dm+0x10e8>
    ...
    333c:	09850513          	addi	a0,a0,152 # 93d0 <schedule_dm+0x1148>
  ...
  fd = open("lf2", 0);
    ...
    3358:	02450513          	addi	a0,a0,36 # 9378 <schedule_dm+0x10f0>
  ...
  if(fd < 0){
    ...
    337c:	08850513          	addi	a0,a0,136 # 9400 <schedule_dm+0x1178>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    339c:	81058593          	addi	a1,a1,-2032 # aba8 <buf>
    33a0:	853e                	mv	a0,a5
    ...
    33bc:	06050513          	addi	a0,a0,96 # 9418 <schedule_dm+0x1190>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    33e4:	f9858593          	addi	a1,a1,-104 # 9378 <schedule_dm+0x10f0>
    33e8:	00006517          	auipc	a0,0x6
    33ec:	f9050513          	addi	a0,a0,-112 # 9378 <schedule_dm+0x10f0>
    ...
    3406:	02e50513          	addi	a0,a0,46 # 9430 <schedule_dm+0x11a8>
  ...
  unlink("lf2");
    ...
    3420:	f5c50513          	addi	a0,a0,-164 # 9378 <schedule_dm+0x10f0>
    3424:	00004097          	auipc	ra,0x4
    3428:	ca6080e7          	jalr	-858(ra) # 70ca <unlink>
  if(link("lf2", "lf1") >= 0){
    342c:	00006597          	auipc	a1,0x6
    3430:	f4458593          	addi	a1,a1,-188 # 9370 <schedule_dm+0x10e8>
    3434:	00006517          	auipc	a0,0x6
    3438:	f4450513          	addi	a0,a0,-188 # 9378 <schedule_dm+0x10f0>
    ...
    3452:	00a50513          	addi	a0,a0,10 # 9458 <schedule_dm+0x11d0>
  ...
  if(link(".", "lf1") >= 0){
    ...
    346c:	f0858593          	addi	a1,a1,-248 # 9370 <schedule_dm+0x10e8>
    3470:	00006517          	auipc	a0,0x6
    3474:	01050513          	addi	a0,a0,16 # 9480 <schedule_dm+0x11f8>
    ...
    348e:	ffe50513          	addi	a0,a0,-2 # 9488 <schedule_dm+0x1200>
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    3522:	f8a50513          	addi	a0,a0,-118 # 94a8 <schedule_dm+0x1220>
    ...
    3556:	f5650513          	addi	a0,a0,-170 # 94a8 <schedule_dm+0x1220>
    ...
    3590:	f2450513          	addi	a0,a0,-220 # 94b0 <schedule_dm+0x1228>
  ...
  fd = open(".", 0);
    ...
    3618:	e6c50513          	addi	a0,a0,-404 # 9480 <schedule_dm+0x11f8>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3682:	e5250513          	addi	a0,a0,-430 # 94d0 <schedule_dm+0x1248>
    ...
    36b8:	e3c50513          	addi	a0,a0,-452 # 94f0 <schedule_dm+0x1268>
  ...
  if(n != N){
    ...
    372a:	df250513          	addi	a0,a0,-526 # 9518 <schedule_dm+0x1290>
  ...
  for(i = 0; i < N; i++){
    ...
    377a:	3e250513          	addi	a0,a0,994 # 8b58 <schedule_dm+0x8d0>
...
linkunlink(char *s)
{
  ...
  unlink("x");
    ...
    3912:	f2250513          	addi	a0,a0,-222 # 8830 <schedule_dm+0x5a8>
  ...
  if(pid < 0){
    ...
    393e:	21e50513          	addi	a0,a0,542 # 8b58 <schedule_dm+0x8d0>
  ...
  for(i = 0; i < 100; i++){
    ...
    39a4:	e9050513          	addi	a0,a0,-368 # 8830 <schedule_dm+0x5a8>
    ...
    39d6:	e5e58593          	addi	a1,a1,-418 # 8830 <schedule_dm+0x5a8>
    39da:	00006517          	auipc	a0,0x6
    39de:	b7650513          	addi	a0,a0,-1162 # 9550 <schedule_dm+0x12c8>
    ...
    39f0:	e4450513          	addi	a0,a0,-444 # 8830 <schedule_dm+0x5a8>
...
bigdir(char *s)
{
  ...
  unlink("bd");
    ...
    3a4c:	b1050513          	addi	a0,a0,-1264 # 9558 <schedule_dm+0x12d0>
  ...
  fd = open("bd", O_CREATE);
    ...
    3a60:	afc50513          	addi	a0,a0,-1284 # 9558 <schedule_dm+0x12d0>
  ...
  if(fd < 0){
    ...
    3a84:	ae050513          	addi	a0,a0,-1312 # 9560 <schedule_dm+0x12d8>
  ...
  for(i = 0; i < N; i++){
    ...
    3b10:	a4c50513          	addi	a0,a0,-1460 # 9558 <schedule_dm+0x12d0>
    ...
    3b2e:	a5650513          	addi	a0,a0,-1450 # 9580 <schedule_dm+0x12f8>
  ...
  unlink("bd");
    ...
    3b62:	9fa50513          	addi	a0,a0,-1542 # 9558 <schedule_dm+0x12d0>
  ...
  for(i = 0; i < N; i++){
    ...
    3be6:	9be50513          	addi	a0,a0,-1602 # 95a0 <schedule_dm+0x1318>
...
subdir(char *s)
{
  ...
  unlink("ff");
    ...
    3c32:	99250513          	addi	a0,a0,-1646 # 95c0 <schedule_dm+0x1338>
    3c36:	00003097          	auipc	ra,0x3
    3c3a:	494080e7          	jalr	1172(ra) # 70ca <unlink>
  if(mkdir("dd") != 0){
    3c3e:	00006517          	auipc	a0,0x6
    3c42:	98a50513          	addi	a0,a0,-1654 # 95c8 <schedule_dm+0x1340>
    ...
    3c5a:	97a50513          	addi	a0,a0,-1670 # 95d0 <schedule_dm+0x1348>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3c78:	97450513          	addi	a0,a0,-1676 # 95e8 <schedule_dm+0x1360>
  ...
  if(fd < 0){
    ...
    3c9c:	95850513          	addi	a0,a0,-1704 # 95f0 <schedule_dm+0x1368>
  ...
  write(fd, "ff", 2);
    ...
    3cbc:	90858593          	addi	a1,a1,-1784 # 95c0 <schedule_dm+0x1338>
    3cc0:	853e                	mv	a0,a5
  ...
  if(unlink("dd") >= 0){
    ...
    3cdc:	8f050513          	addi	a0,a0,-1808 # 95c8 <schedule_dm+0x1340>
    ...
    3cf6:	91e50513          	addi	a0,a0,-1762 # 9610 <schedule_dm+0x1388>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3d10:	93450513          	addi	a0,a0,-1740 # 9640 <schedule_dm+0x13b8>
    ...
    3d28:	92450513          	addi	a0,a0,-1756 # 9648 <schedule_dm+0x13c0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3d46:	92650513          	addi	a0,a0,-1754 # 9668 <schedule_dm+0x13e0>
  ...
  if(fd < 0){
    ...
    3d6a:	91250513          	addi	a0,a0,-1774 # 9678 <schedule_dm+0x13f0>
  ...
  write(fd, "FF", 2);
    ...
    3d8a:	91258593          	addi	a1,a1,-1774 # 9698 <schedule_dm+0x1410>
    3d8e:	853e                	mv	a0,a5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3dac:	8f850513          	addi	a0,a0,-1800 # 96a0 <schedule_dm+0x1418>
  ...
  if(fd < 0){
    ...
    3dd0:	8e450513          	addi	a0,a0,-1820 # 96b0 <schedule_dm+0x1428>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3df0:	dbc58593          	addi	a1,a1,-580 # aba8 <buf>
    3df4:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3e16:	d9678793          	addi	a5,a5,-618 # aba8 <buf>
    ...
    3e30:	8a450513          	addi	a0,a0,-1884 # 96d0 <schedule_dm+0x1448>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3e58:	89c58593          	addi	a1,a1,-1892 # 96f0 <schedule_dm+0x1468>
    3e5c:	00006517          	auipc	a0,0x6
    3e60:	80c50513          	addi	a0,a0,-2036 # 9668 <schedule_dm+0x13e0>
    ...
    3e78:	88c50513          	addi	a0,a0,-1908 # 9700 <schedule_dm+0x1478>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3e92:	7da50513          	addi	a0,a0,2010 # 9668 <schedule_dm+0x13e0>
    ...
    3eaa:	88250513          	addi	a0,a0,-1918 # 9728 <schedule_dm+0x14a0>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3ec6:	7a650513          	addi	a0,a0,1958 # 9668 <schedule_dm+0x13e0>
    ...
    3ee0:	86c50513          	addi	a0,a0,-1940 # 9748 <schedule_dm+0x14c0>
  ...
  if(chdir("dd") != 0){
    ...
    3efa:	6d250513          	addi	a0,a0,1746 # 95c8 <schedule_dm+0x1340>
    ...
    3f12:	86250513          	addi	a0,a0,-1950 # 9770 <schedule_dm+0x14e8>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3f2c:	86050513          	addi	a0,a0,-1952 # 9788 <schedule_dm+0x1500>
    ...
    3f44:	85850513          	addi	a0,a0,-1960 # 9798 <schedule_dm+0x1510>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3f5e:	85e50513          	addi	a0,a0,-1954 # 97b8 <schedule_dm+0x1530>
    ...
    3f76:	85650513          	addi	a0,a0,-1962 # 97c8 <schedule_dm+0x1540>
  ...
  if(chdir("./..") != 0){
    ...
    3f90:	85c50513          	addi	a0,a0,-1956 # 97e8 <schedule_dm+0x1560>
    ...
    3fa8:	84c50513          	addi	a0,a0,-1972 # 97f0 <schedule_dm+0x1568>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3fc4:	73050513          	addi	a0,a0,1840 # 96f0 <schedule_dm+0x1468>
  ...
  if(fd < 0){
    ...
    3fe8:	82450513          	addi	a0,a0,-2012 # 9808 <schedule_dm+0x1580>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    4008:	ba458593          	addi	a1,a1,-1116 # aba8 <buf>
    400c:	853e                	mv	a0,a5
    ...
    4028:	80450513          	addi	a0,a0,-2044 # 9828 <schedule_dm+0x15a0>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    4052:	61a50513          	addi	a0,a0,1562 # 9668 <schedule_dm+0x13e0>
    ...
    406c:	7e050513          	addi	a0,a0,2016 # 9848 <schedule_dm+0x15c0>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    408a:	7f250513          	addi	a0,a0,2034 # 9878 <schedule_dm+0x15f0>
    ...
    40a4:	7e850513          	addi	a0,a0,2024 # 9888 <schedule_dm+0x1600>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    40c2:	7ea50513          	addi	a0,a0,2026 # 98a8 <schedule_dm+0x1620>
    ...
    40dc:	7e050513          	addi	a0,a0,2016 # 98b8 <schedule_dm+0x1630>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    40fa:	4d250513          	addi	a0,a0,1234 # 95c8 <schedule_dm+0x1340>
    ...
    4114:	7c850513          	addi	a0,a0,1992 # 98d8 <schedule_dm+0x1650>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    4130:	49c50513          	addi	a0,a0,1180 # 95c8 <schedule_dm+0x1340>
    ...
    414a:	7b250513          	addi	a0,a0,1970 # 98f8 <schedule_dm+0x1670>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    4166:	46650513          	addi	a0,a0,1126 # 95c8 <schedule_dm+0x1340>
    ...
    4180:	79c50513          	addi	a0,a0,1948 # 9918 <schedule_dm+0x1690>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    419a:	7a258593          	addi	a1,a1,1954 # 9938 <schedule_dm+0x16b0>
    419e:	00005517          	auipc	a0,0x5
    41a2:	6da50513          	addi	a0,a0,1754 # 9878 <schedule_dm+0x15f0>
    ...
    41ba:	79250513          	addi	a0,a0,1938 # 9948 <schedule_dm+0x16c0>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    41d4:	76858593          	addi	a1,a1,1896 # 9938 <schedule_dm+0x16b0>
    41d8:	00005517          	auipc	a0,0x5
    41dc:	6d050513          	addi	a0,a0,1744 # 98a8 <schedule_dm+0x1620>
    ...
    41f4:	78050513          	addi	a0,a0,1920 # 9970 <schedule_dm+0x16e8>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    420e:	4e658593          	addi	a1,a1,1254 # 96f0 <schedule_dm+0x1468>
    4212:	00005517          	auipc	a0,0x5
    4216:	3d650513          	addi	a0,a0,982 # 95e8 <schedule_dm+0x1360>
    ...
    422e:	76e50513          	addi	a0,a0,1902 # 9998 <schedule_dm+0x1710>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    4248:	63450513          	addi	a0,a0,1588 # 9878 <schedule_dm+0x15f0>
    ...
    4260:	76450513          	addi	a0,a0,1892 # 99c0 <schedule_dm+0x1738>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    427a:	63250513          	addi	a0,a0,1586 # 98a8 <schedule_dm+0x1620>
    ...
    4292:	75250513          	addi	a0,a0,1874 # 99e0 <schedule_dm+0x1758>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    42ac:	44850513          	addi	a0,a0,1096 # 96f0 <schedule_dm+0x1468>
    ...
    42c4:	74050513          	addi	a0,a0,1856 # 9a00 <schedule_dm+0x1778>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    42de:	5ce50513          	addi	a0,a0,1486 # 98a8 <schedule_dm+0x1620>
    ...
    42f6:	73650513          	addi	a0,a0,1846 # 9a28 <schedule_dm+0x17a0>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    4310:	56c50513          	addi	a0,a0,1388 # 9878 <schedule_dm+0x15f0>
    ...
    4328:	72450513          	addi	a0,a0,1828 # 9a48 <schedule_dm+0x17c0>
  ...
  if(chdir("dd/ff") == 0){
    ...
    4342:	2aa50513          	addi	a0,a0,682 # 95e8 <schedule_dm+0x1360>
    ...
    435a:	71250513          	addi	a0,a0,1810 # 9a68 <schedule_dm+0x17e0>
  ...
  if(chdir("dd/xx") == 0){
    ...
    4374:	71850513          	addi	a0,a0,1816 # 9a88 <schedule_dm+0x1800>
    ...
    438c:	70850513          	addi	a0,a0,1800 # 9a90 <schedule_dm+0x1808>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    43a6:	34e50513          	addi	a0,a0,846 # 96f0 <schedule_dm+0x1468>
    ...
    43be:	36e50513          	addi	a0,a0,878 # 9728 <schedule_dm+0x14a0>
  ...
  if(unlink("dd/ff") != 0){
    ...
    43d8:	21450513          	addi	a0,a0,532 # 95e8 <schedule_dm+0x1360>
    ...
    43f0:	6c450513          	addi	a0,a0,1732 # 9ab0 <schedule_dm+0x1828>
  ...
  if(unlink("dd") == 0){
    ...
    440a:	1c250513          	addi	a0,a0,450 # 95c8 <schedule_dm+0x1340>
    ...
    4422:	6b250513          	addi	a0,a0,1714 # 9ad0 <schedule_dm+0x1848>
  ...
  if(unlink("dd/dd") < 0){
    ...
    443c:	6c050513          	addi	a0,a0,1728 # 9af8 <schedule_dm+0x1870>
    ...
    4456:	6ae50513          	addi	a0,a0,1710 # 9b00 <schedule_dm+0x1878>
  ...
  if(unlink("dd") < 0){
    ...
    4470:	15c50513          	addi	a0,a0,348 # 95c8 <schedule_dm+0x1340>
    ...
    448a:	69a50513          	addi	a0,a0,1690 # 9b20 <schedule_dm+0x1898>
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
    ...
    44ba:	11a50513          	addi	a0,a0,282 # 85d0 <schedule_dm+0x348>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    44d8:	0fc50513          	addi	a0,a0,252 # 85d0 <schedule_dm+0x348>
    ...
    44fc:	64050513          	addi	a0,a0,1600 # 9b38 <schedule_dm+0x18b0>
    ...
    4526:	68658593          	addi	a1,a1,1670 # aba8 <buf>
    452a:	853e                	mv	a0,a5
    ...
    455e:	5fe50513          	addi	a0,a0,1534 # 9b58 <schedule_dm+0x18d0>
    ...
    459e:	03650513          	addi	a0,a0,54 # 85d0 <schedule_dm+0x348>
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    460a:	32a50513          	addi	a0,a0,810 # 8930 <schedule_dm+0x6a8>
    ...
    4694:	4e050513          	addi	a0,a0,1248 # 9b70 <schedule_dm+0x18e8>
    ...
    46be:	4ee58593          	addi	a1,a1,1262 # aba8 <buf>
    46c2:	853e                	mv	a0,a5
    ...
    46f6:	46650513          	addi	a0,a0,1126 # 9b58 <schedule_dm+0x18d0>
...
bigfile(char *s)
{
  ...
  if(fd < 0){
    ...
    4826:	37650513          	addi	a0,a0,886 # 9b98 <schedule_dm+0x1910>
  ...
  for(i = 0; i < N; i++){
    ...
    4850:	35c50513          	addi	a0,a0,860 # aba8 <buf>
    ...
    4868:	34458593          	addi	a1,a1,836 # aba8 <buf>
    486c:	853e                	mv	a0,a5
    ...
    488a:	33250513          	addi	a0,a0,818 # 9bb8 <schedule_dm+0x1930>
  ...
  fd = open("bigfile.dat", 0);
    ...
    48cc:	2c050513          	addi	a0,a0,704 # 9b88 <schedule_dm+0x1900>
  ...
  if(fd < 0){
    ...
    48f0:	2ec50513          	addi	a0,a0,748 # 9bd8 <schedule_dm+0x1950>
  ...
  for(i = 0; ; i++){
    ...
    491a:	29258593          	addi	a1,a1,658 # aba8 <buf>
    491e:	853e                	mv	a0,a5
    ...
    4940:	2bc50513          	addi	a0,a0,700 # 9bf8 <schedule_dm+0x1970>
    ...
    4976:	2a650513          	addi	a0,a0,678 # 9c18 <schedule_dm+0x1990>
    ...
    4990:	21c78793          	addi	a5,a5,540 # aba8 <buf>
    ...
    49b6:	1f678793          	addi	a5,a5,502 # aba8 <buf>
    ...
    49e0:	25450513          	addi	a0,a0,596 # 9c30 <schedule_dm+0x19a8>
  ...
  if(total != N*SZ){
    ...
    4a3a:	21a50513          	addi	a0,a0,538 # 9c50 <schedule_dm+0x19c8>
  ...
  unlink("bigfile.dat");
    ...
    4a54:	13850513          	addi	a0,a0,312 # 9b88 <schedule_dm+0x1900>
...
fourteen(char *s)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    4a7a:	1fa50513          	addi	a0,a0,506 # 9c70 <schedule_dm+0x19e8>
    ...
    4a92:	1f250513          	addi	a0,a0,498 # 9c80 <schedule_dm+0x19f8>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    4aac:	20050513          	addi	a0,a0,512 # 9ca8 <schedule_dm+0x1a20>
    ...
    4ac4:	20850513          	addi	a0,a0,520 # 9cc8 <schedule_dm+0x1a40>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    4ae2:	22250513          	addi	a0,a0,546 # 9d00 <schedule_dm+0x1a78>
  ...
  if(fd < 0){
    ...
    4b06:	22e50513          	addi	a0,a0,558 # 9d30 <schedule_dm+0x1aa8>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    4b30:	24c50513          	addi	a0,a0,588 # 9d78 <schedule_dm+0x1af0>
  ...
  if(fd < 0){
    ...
    4b54:	25850513          	addi	a0,a0,600 # 9da8 <schedule_dm+0x1b20>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    4b7c:	27050513          	addi	a0,a0,624 # 9de8 <schedule_dm+0x1b60>
    ...
    4b94:	27850513          	addi	a0,a0,632 # 9e08 <schedule_dm+0x1b80>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    4bae:	29650513          	addi	a0,a0,662 # 9e40 <schedule_dm+0x1bb8>
    ...
    4bc6:	29e50513          	addi	a0,a0,670 # 9e60 <schedule_dm+0x1bd8>
...
rmdot(char *s)
{
  ...
  if(mkdir("dots") != 0){
    ...
    4c56:	24650513          	addi	a0,a0,582 # 9e98 <schedule_dm+0x1c10>
    ...
    4c6e:	23650513          	addi	a0,a0,566 # 9ea0 <schedule_dm+0x1c18>
  ...
  if(chdir("dots") != 0){
    ...
    4c88:	21450513          	addi	a0,a0,532 # 9e98 <schedule_dm+0x1c10>
    ...
    4ca0:	21c50513          	addi	a0,a0,540 # 9eb8 <schedule_dm+0x1c30>
  ...
  if(unlink(".") == 0){
    ...
    4cba:	7ca50513          	addi	a0,a0,1994 # 9480 <schedule_dm+0x11f8>
    ...
    4cd2:	20250513          	addi	a0,a0,514 # 9ed0 <schedule_dm+0x1c48>
  ...
  if(unlink("..") == 0){
    ...
    4cec:	25050513          	addi	a0,a0,592 # 8f38 <schedule_dm+0xcb0>
    ...
    4d04:	1e850513          	addi	a0,a0,488 # 9ee8 <schedule_dm+0x1c60>
  ...
  if(chdir("/") != 0){
    ...
    4d1e:	f3650513          	addi	a0,a0,-202 # 8c50 <schedule_dm+0x9c8>
    ...
    4d36:	f2650513          	addi	a0,a0,-218 # 8c58 <schedule_dm+0x9d0>
  ...
  if(unlink("dots/.") == 0){
    ...
    4d50:	1b450513          	addi	a0,a0,436 # 9f00 <schedule_dm+0x1c78>
    ...
    4d68:	1a450513          	addi	a0,a0,420 # 9f08 <schedule_dm+0x1c80>
  ...
  if(unlink("dots/..") == 0){
    ...
    4d82:	1aa50513          	addi	a0,a0,426 # 9f28 <schedule_dm+0x1ca0>
    ...
    4d9a:	19a50513          	addi	a0,a0,410 # 9f30 <schedule_dm+0x1ca8>
  ...
  if(unlink("dots") != 0){
    ...
    4db4:	0e850513          	addi	a0,a0,232 # 9e98 <schedule_dm+0x1c10>
    ...
    4dcc:	18850513          	addi	a0,a0,392 # 9f50 <schedule_dm+0x1cc8>
...
dirfile(char *s)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4e00:	8fc50513          	addi	a0,a0,-1796 # 86f8 <schedule_dm+0x470>
  ...
  if(fd < 0){
    ...
    4e24:	15050513          	addi	a0,a0,336 # 9f70 <schedule_dm+0x1ce8>
  ...
  if(chdir("dirfile") == 0){
    ...
    4e4c:	8b050513          	addi	a0,a0,-1872 # 86f8 <schedule_dm+0x470>
    ...
    4e64:	13050513          	addi	a0,a0,304 # 9f90 <schedule_dm+0x1d08>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4e80:	13450513          	addi	a0,a0,308 # 9fb0 <schedule_dm+0x1d28>
  ...
  if(fd >= 0){
    ...
    4ea4:	12050513          	addi	a0,a0,288 # 9fc0 <schedule_dm+0x1d38>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4ec2:	0f250513          	addi	a0,a0,242 # 9fb0 <schedule_dm+0x1d28>
  ...
  if(fd >= 0){
    ...
    4ee6:	0de50513          	addi	a0,a0,222 # 9fc0 <schedule_dm+0x1d38>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4f00:	0b450513          	addi	a0,a0,180 # 9fb0 <schedule_dm+0x1d28>
    ...
    4f18:	0d450513          	addi	a0,a0,212 # 9fe8 <schedule_dm+0x1d60>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4f32:	08250513          	addi	a0,a0,130 # 9fb0 <schedule_dm+0x1d28>
    ...
    4f4a:	0ca50513          	addi	a0,a0,202 # a010 <schedule_dm+0x1d88>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4f64:	05058593          	addi	a1,a1,80 # 9fb0 <schedule_dm+0x1d28>
    4f68:	00004517          	auipc	a0,0x4
    4f6c:	87850513          	addi	a0,a0,-1928 # 87e0 <schedule_dm+0x558>
    ...
    4f84:	0b850513          	addi	a0,a0,184 # a038 <schedule_dm+0x1db0>
  ...
  if(unlink("dirfile") != 0){
    ...
    4f9e:	75e50513          	addi	a0,a0,1886 # 86f8 <schedule_dm+0x470>
    ...
    4fb6:	0ae50513          	addi	a0,a0,174 # a060 <schedule_dm+0x1dd8>
  ...
  fd = open(".", O_RDWR);
    ...
    4fd2:	4b250513          	addi	a0,a0,1202 # 9480 <schedule_dm+0x11f8>
  ...
  if(fd >= 0){
    ...
    4ff6:	08e50513          	addi	a0,a0,142 # a080 <schedule_dm+0x1df8>
  ...
  fd = open(".", 0);
    ...
    5012:	47250513          	addi	a0,a0,1138 # 9480 <schedule_dm+0x11f8>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    502e:	80658593          	addi	a1,a1,-2042 # 8830 <schedule_dm+0x5a8>
    5032:	853e                	mv	a0,a5
    ...
    504a:	06250513          	addi	a0,a0,98 # a0a8 <schedule_dm+0x1e20>
...
iref(char *s)
{
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    508e:	03650513          	addi	a0,a0,54 # a0c0 <schedule_dm+0x1e38>
    ...
    50a6:	02650513          	addi	a0,a0,38 # a0c8 <schedule_dm+0x1e40>
    ...
    50c0:	00450513          	addi	a0,a0,4 # a0c0 <schedule_dm+0x1e38>
    ...
    50d8:	00c50513          	addi	a0,a0,12 # a0e0 <schedule_dm+0x1e58>
    ...
    5150:	7bc50513          	addi	a0,a0,1980 # 8908 <schedule_dm+0x680>
    ...
    517e:	78e50513          	addi	a0,a0,1934 # 8908 <schedule_dm+0x680>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    51ae:	d8e50513          	addi	a0,a0,-626 # 8f38 <schedule_dm+0xcb0>
    51b2:	00002097          	auipc	ra,0x2
    51b6:	f38080e7          	jalr	-200(ra) # 70ea <chdir>
    unlink("irefd");
    51ba:	00005517          	auipc	a0,0x5
    51be:	f0650513          	addi	a0,a0,-250 # a0c0 <schedule_dm+0x1e38>
  ...
  chdir("/");
    ...
    51e8:	a6c50513          	addi	a0,a0,-1428 # 8c50 <schedule_dm+0x9c8>
...
forktest(char *s)
{
  ...
  if (n == 0) {
    ...
    5268:	e9c50513          	addi	a0,a0,-356 # a100 <schedule_dm+0x1e78>
  ...
  if(n == N){
    ...
    5296:	e8650513          	addi	a0,a0,-378 # a118 <schedule_dm+0x1e90>
  ...
  for(; n > 0; n--){
    ...
    52c4:	e8050513          	addi	a0,a0,-384 # a140 <schedule_dm+0x1eb8>
  ...
  if(wait(0) != -1){
    ...
    530a:	e5250513          	addi	a0,a0,-430 # a158 <schedule_dm+0x1ed0>
...
sbrkbasic(char *s)
{
  ...
  if(pid < 0){
    ...
    5352:	e2250513          	addi	a0,a0,-478 # a170 <schedule_dm+0x1ee8>
  ...
  if(xstatus == 1){
    ...
    53f4:	da050513          	addi	a0,a0,-608 # a190 <schedule_dm+0x1f08>
  ...
  for(i = 0; i < 5000; i++){
    ...
    544a:	d6a50513          	addi	a0,a0,-662 # a1b0 <schedule_dm+0x1f28>
    ...
    *b = 1;
    ...
    5464:	4705                	li	a4,1
    5466:	00e78023          	sb	a4,0(a5) # 40000000 <__BSS_END__+0x3ffeec20>
    a = b + 1;
  ...
  if(pid < 0){
    ...
    54b0:	d2450513          	addi	a0,a0,-732 # a1d0 <schedule_dm+0x1f48>
  ...
  if(c != a + 1){
    ...
    54f8:	cfc50513          	addi	a0,a0,-772 # a1f0 <schedule_dm+0x1f68>
...
sbrkmuch(char *s)
{
  ...
  if (p != a) {
    ...
    559c:	c7850513          	addi	a0,a0,-904 # a210 <schedule_dm+0x1f88>
  ...
  *lastaddr = 99;
    ...
    55fe:	00e78023          	sb	a4,0(a5) # 6400000 <__BSS_END__+0x63eec20>
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5630:	c2c50513          	addi	a0,a0,-980 # a258 <schedule_dm+0x1fd0>
  ...
  if(c != a - PGSIZE){
    ...
    5674:	c0850513          	addi	a0,a0,-1016 # a278 <schedule_dm+0x1ff0>
  ...
  if(c != a || sbrk(0) != a + PGSIZE){
    ...
    56da:	be250513          	addi	a0,a0,-1054 # a2b8 <schedule_dm+0x2030>
  ...
  if(*lastaddr == 99){
    ...
    570a:	be250513          	addi	a0,a0,-1054 # a2e8 <schedule_dm+0x2060>
  ...
  if(c != a){
    ...
    576c:	bb850513          	addi	a0,a0,-1096 # a320 <schedule_dm+0x2098>
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    57c2:	39a50513          	addi	a0,a0,922 # 8b58 <schedule_dm+0x8d0>
    ...
    57f8:	b5450513          	addi	a0,a0,-1196 # a348 <schedule_dm+0x20c0>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    5838:	35078793          	addi	a5,a5,848 # c350 <__global_pointer$+0xfb0>
    ...
    584c:	47f78793          	addi	a5,a5,1151 # 1003d47f <__BSS_END__+0x1002c09f>
...
sbrkfail(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    5886:	76e50513          	addi	a0,a0,1902 # 8ff0 <schedule_dm+0xd68>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    58fe:	f3658593          	addi	a1,a1,-202 # 8830 <schedule_dm+0x5a8>
    5902:	853e                	mv	a0,a5
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    59da:	99250513          	addi	a0,a0,-1646 # a368 <schedule_dm+0x20e0>
  ...
  if(pid < 0){
    ...
    5a10:	14c50513          	addi	a0,a0,332 # 8b58 <schedule_dm+0x8d0>
  ...
  if(pid == 0){
    ...
    5a96:	8f650513          	addi	a0,a0,-1802 # a388 <schedule_dm+0x2100>
...
sbrkarg(char *s)
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    5b08:	8b450513          	addi	a0,a0,-1868 # a3b8 <schedule_dm+0x2130>
  ...
  unlink("sbrk");
    ...
    5b1e:	89e50513          	addi	a0,a0,-1890 # a3b8 <schedule_dm+0x2130>
  ...
  if(fd < 0)  {
    ...
    5b3c:	88850513          	addi	a0,a0,-1912 # a3c0 <schedule_dm+0x2138>
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    5b7e:	85e50513          	addi	a0,a0,-1954 # a3d8 <schedule_dm+0x2150>
  ...
  if(pipe((int *) a) != 0){
    ...
    5bc8:	42c50513          	addi	a0,a0,1068 # 8ff0 <schedule_dm+0xd68>
...
validatetest(char *s)
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    5c0c:	7e850513          	addi	a0,a0,2024 # a3f0 <schedule_dm+0x2168>
    ...
    5c2a:	7da50513          	addi	a0,a0,2010 # a400 <schedule_dm+0x2178>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    5c7e:	f2e70713          	addi	a4,a4,-210 # dba8 <uninit>
    ...
    5c96:	78e50513          	addi	a0,a0,1934 # a420 <schedule_dm+0x2198>
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    ...
    5ce2:	75a50513          	addi	a0,a0,1882 # a438 <schedule_dm+0x21b0>
  ...
  if(pid == 0){
    ...
    5d0e:	5b670713          	addi	a4,a4,1462 # 112c0 <args.1845>
    5d12:	fec42783          	lw	a5,-20(s0)
    5d16:	078e                	slli	a5,a5,0x3
    5d18:	97ba                	add	a5,a5,a4
    5d1a:	00004717          	auipc	a4,0x4
    5d1e:	72e70713          	addi	a4,a4,1838 # a448 <schedule_dm+0x21c0>
    ...
    5d40:	58478793          	addi	a5,a5,1412 # 112c0 <args.1845>
    5d44:	0e07bc23          	sd	zero,248(a5)
    exec("echo", args);
    5d48:	0000b597          	auipc	a1,0xb
    5d4c:	57858593          	addi	a1,a1,1400 # 112c0 <args.1845>
    5d50:	00003517          	auipc	a0,0x3
    5d54:	bf050513          	addi	a0,a0,-1040 # 8940 <schedule_dm+0x6b8>
    5d58:	00001097          	auipc	ra,0x1
    5d5c:	35a080e7          	jalr	858(ra) # 70b2 <exec>
    fd = open("bigarg-ok", O_CREATE);
    5d60:	20000593          	li	a1,512
    5d64:	00004517          	auipc	a0,0x4
    5d68:	6d450513          	addi	a0,a0,1748 # a438 <schedule_dm+0x21b0>
    ...
    5da4:	78850513          	addi	a0,a0,1928 # a528 <schedule_dm+0x22a0>
  ...
  fd = open("bigarg-ok", 0);
    ...
    5de2:	65a50513          	addi	a0,a0,1626 # a438 <schedule_dm+0x21b0>
  ...
  if(fd < 0){
    ...
    5e06:	74650513          	addi	a0,a0,1862 # a548 <schedule_dm+0x22c0>
...
fsfull()
{
  ...
  printf("fsfull test\n");
    ...
    5e44:	72850513          	addi	a0,a0,1832 # a568 <schedule_dm+0x22e0>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5ef6:	68650513          	addi	a0,a0,1670 # a578 <schedule_dm+0x22f0>
    ...
    5f2e:	65e50513          	addi	a0,a0,1630 # a588 <schedule_dm+0x2300>
    ...
    5f4c:	c6058593          	addi	a1,a1,-928 # aba8 <buf>
    5f50:	853e                	mv	a0,a5
    ...
    5f96:	60650513          	addi	a0,a0,1542 # a598 <schedule_dm+0x2310>
  ...
  printf("fsfull test finished\n");
    ...
    6086:	52650513          	addi	a0,a0,1318 # a5a8 <schedule_dm+0x2320>
...
void argptest(char *s)
{
  ...
  fd = open("init", O_RDONLY);
    ...
    60ae:	51650513          	addi	a0,a0,1302 # a5c0 <schedule_dm+0x2338>
  ...
  if (fd < 0) {
    ...
    60d2:	aa250513          	addi	a0,a0,-1374 # 8b70 <schedule_dm+0x8e8>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    612c:	a7878793          	addi	a5,a5,-1416 # aba0 <randstate>
    6130:	6398                	ld	a4,0(a5)
    6132:	001967b7          	lui	a5,0x196
    6136:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x18522d>
    613a:	02f70733          	mul	a4,a4,a5
    613e:	3c6ef7b7          	lui	a5,0x3c6ef
    6142:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6ddf7f>
    6146:	973e                	add	a4,a4,a5
    6148:	00005797          	auipc	a5,0x5
    614c:	a5878793          	addi	a5,a5,-1448 # aba0 <randstate>
    6150:	e398                	sd	a4,0(a5)
  return randstate;
    6152:	00005797          	auipc	a5,0x5
    6156:	a4e78793          	addi	a5,a5,-1458 # aba0 <randstate>
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    61a6:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffedc20>
    61aa:	2781                	sext.w	a5,a5
    61ac:	863e                	mv	a2,a5
    61ae:	fc843583          	ld	a1,-56(s0)
    61b2:	00004517          	auipc	a0,0x4
    61b6:	41650513          	addi	a0,a0,1046 # a5c8 <schedule_dm+0x2340>
    ...
    61de:	97e50513          	addi	a0,a0,-1666 # 8b58 <schedule_dm+0x8d0>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    623e:	93e78793          	addi	a5,a5,-1730 # ab78 <schedule_dm+0x28f0>
  ...
  pipe((int*)0xeaeb0b5b00002f5e);
    ...
    6254:	92878793          	addi	a5,a5,-1752 # ab78 <schedule_dm+0x28f0>
...
sbrkbugs(char *s)
{
  ...
  if(pid < 0){
    ...
    6296:	69e50513          	addi	a0,a0,1694 # 8930 <schedule_dm+0x6a8>
  ...
  if(pid < 0){
    ...
    6308:	62c50513          	addi	a0,a0,1580 # 8930 <schedule_dm+0x6a8>
  ...
  if(pid < 0){
    ...
    6380:	5b450513          	addi	a0,a0,1460 # 8930 <schedule_dm+0x6a8>
...
badwrite(char *s)
{
  ...
  unlink("junk");
    ...
    6404:	1f050513          	addi	a0,a0,496 # a5f0 <schedule_dm+0x2368>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    641e:	1d650513          	addi	a0,a0,470 # a5f0 <schedule_dm+0x2368>
    ...
    643e:	1be50513          	addi	a0,a0,446 # a5f8 <schedule_dm+0x2370>
    ...
    647c:	17850513          	addi	a0,a0,376 # a5f0 <schedule_dm+0x2368>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    64aa:	14a50513          	addi	a0,a0,330 # a5f0 <schedule_dm+0x2368>
  ...
  if(fd < 0){
    ...
    64ca:	13250513          	addi	a0,a0,306 # a5f8 <schedule_dm+0x2370>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    64ea:	34a58593          	addi	a1,a1,842 # 8830 <schedule_dm+0x5a8>
    64ee:	853e                	mv	a0,a5
    ...
    6506:	10e50513          	addi	a0,a0,270 # a610 <schedule_dm+0x2388>
  ...
  unlink("junk");
    ...
    652e:	0c650513          	addi	a0,a0,198 # a5f0 <schedule_dm+0x2368>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    656c:	3d850513          	addi	a0,a0,984 # 8940 <schedule_dm+0x6b8>
  ...
  for(int i = 0; i < 50000; i++){
    ...
    658c:	34f78793          	addi	a5,a5,847 # c34f <__global_pointer$+0xfaf>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    65cc:	36850513          	addi	a0,a0,872 # 8930 <schedule_dm+0x6a8>
    ...
    660e:	873e                	mv	a4,a5
    6610:	4785                	li	a5,1
    6612:	00f70023          	sb	a5,0(a4) # b000 <buf+0x458>
      while(1){
    ...
    6652:	2f278793          	addi	a5,a5,754 # 8940 <schedule_dm+0x6b8>
    6656:	fcf43023          	sd	a5,-64(s0)
    665a:	00002797          	auipc	a5,0x2
    665e:	1d678793          	addi	a5,a5,470 # 8830 <schedule_dm+0x5a8>
    ...
    6674:	2d050513          	addi	a0,a0,720 # 8940 <schedule_dm+0x6b8>
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    66d6:	f4e50513          	addi	a0,a0,-178 # a620 <schedule_dm+0x2398>
  ...
  if(pid < 0){
    ...
    6708:	f3c50513          	addi	a0,a0,-196 # a640 <schedule_dm+0x23b8>
  ...
  if(pid == 0){
    ...
    676a:	0ca58593          	addi	a1,a1,202 # 8830 <schedule_dm+0x5a8>
    676e:	853e                	mv	a0,a5
    ...
    6786:	ede50513          	addi	a0,a0,-290 # a660 <schedule_dm+0x23d8>
  ...
  while(1){
    ...
    67e4:	ea050513          	addi	a0,a0,-352 # a680 <schedule_dm+0x23f8>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    684e:	e5650513          	addi	a0,a0,-426 # a6a0 <schedule_dm+0x2418>
  ...
  if((pid = fork()) < 0) {
    ...
    6876:	e3e50513          	addi	a0,a0,-450 # a6b0 <schedule_dm+0x2428>
  ...
  if(pid == 0) {
    ...
    68c0:	e0c50513          	addi	a0,a0,-500 # a6c8 <schedule_dm+0x2440>
    ...
    68d2:	e0250513          	addi	a0,a0,-510 # a6d0 <schedule_dm+0x2448>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    6932:	daa58593          	addi	a1,a1,-598 # a6d8 <schedule_dm+0x2450>
    6936:	853e                	mv	a0,a5
    ...
    6966:	d7e58593          	addi	a1,a1,-642 # a6e0 <schedule_dm+0x2458>
    696a:	853e                	mv	a0,a5
    ...
    69c2:	d2a50513          	addi	a0,a0,-726 # a6e8 <schedule_dm+0x2460>
  ...
  struct test {
    ...
    69dc:	df070713          	addi	a4,a4,-528 # a7c8 <schedule_dm+0x2540>
  ...
  if(continuous){
    ...
    6a04:	d1050513          	addi	a0,a0,-752 # a710 <schedule_dm+0x2488>
    ...
    6a6e:	cc650513          	addi	a0,a0,-826 # a730 <schedule_dm+0x24a8>
    ...
    6ac4:	c8850513          	addi	a0,a0,-888 # a748 <schedule_dm+0x24c0>
  ...
  printf("usertests starting\n");
    ...
    6aec:	c8050513          	addi	a0,a0,-896 # a768 <schedule_dm+0x24e0>
  ...
  if(fail){
    ...
    6b76:	bbe50513          	addi	a0,a0,-1090 # a730 <schedule_dm+0x24a8>
    ...
    6bba:	bca50513          	addi	a0,a0,-1078 # a780 <schedule_dm+0x24f8>
    ...
    6bd4:	be050513          	addi	a0,a0,-1056 # a7b0 <schedule_dm+0x2528>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    71e2:	9aa68693          	addi	a3,a3,-1622 # ab88 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    72bc:	8d070713          	addi	a4,a4,-1840 # ab88 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    747c:	70878793          	addi	a5,a5,1800 # ab80 <schedule_dm+0x28f8>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    7628:	dac78793          	addi	a5,a5,-596 # 113d0 <freep>
  ...
  freep = p;
    ...
    7720:	cb478793          	addi	a5,a5,-844 # 113d0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    77a2:	c3278793          	addi	a5,a5,-974 # 113d0 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    77d4:	c0078793          	addi	a5,a5,-1024 # 113d0 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    7892:	b4278793          	addi	a5,a5,-1214 # 113d0 <freep>
    ...
    78a8:	b2c78793          	addi	a5,a5,-1236 # 113d0 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    7a3c:	0000a797          	auipc	a5,0xa
    7a40:	99c78793          	addi	a5,a5,-1636 # 113d8 <last_thread.1226>
    7a44:	639c                	ld	a5,0(a5)
    7a46:	cb89                	beqz	a5,7a58 <schedule_wrr+0x2e>
    7a48:	0000a797          	auipc	a5,0xa
    7a4c:	99078793          	addi	a5,a5,-1648 # 113d8 <last_thread.1226>
    7a50:	639c                	ld	a5,0(a5)
    7a52:	4fbc                	lw	a5,88(a5)
    7a54:	00f04863          	bgtz	a5,7a64 <schedule_wrr+0x3a>
        last_thread = NULL;
    7a58:	0000a797          	auipc	a5,0xa
    7a5c:	98078793          	addi	a5,a5,-1664 # 113d8 <last_thread.1226>
    ...
    7a66:	639c                	ld	a5,0(a5)
    7a68:	fcf43823          	sd	a5,-48(s0)
    7a6c:	fd043783          	ld	a5,-48(s0)
    7a70:	fd878793          	addi	a5,a5,-40
    7a74:	fef43023          	sd	a5,-32(s0)
    7a78:	a0a9                	j	7ac2 <schedule_wrr+0x98>
        if (!last_thread && candidate->remaining_time > 0)
    7a7a:	0000a797          	auipc	a5,0xa
    7a7e:	95e78793          	addi	a5,a5,-1698 # 113d8 <last_thread.1226>
    7a82:	639c                	ld	a5,0(a5)
    7a84:	eb91                	bnez	a5,7a98 <schedule_wrr+0x6e>
    7a86:	fe043783          	ld	a5,-32(s0)
    7a8a:	4fbc                	lw	a5,88(a5)
    7a8c:	00f05663          	blez	a5,7a98 <schedule_wrr+0x6e>
            selected_thread = candidate;
    7a90:	fe043783          	ld	a5,-32(s0)
    7a94:	fef43423          	sd	a5,-24(s0)
        if (candidate->remaining_time > 0) {
    7a98:	fe043783          	ld	a5,-32(s0)
    7a9c:	4fbc                	lw	a5,88(a5)
    7a9e:	00f05763          	blez	a5,7aac <schedule_wrr+0x82>
            selected_thread = candidate;
    7aa2:	fe043783          	ld	a5,-32(s0)
    7aa6:	fef43423          	sd	a5,-24(s0)
            break;
    7aaa:	a01d                	j	7ad0 <schedule_wrr+0xa6>
    list_for_each_entry(candidate, args.run_queue, thread_list) {
    7aac:	fe043783          	ld	a5,-32(s0)
    7ab0:	779c                	ld	a5,40(a5)
    7ab2:	fcf43423          	sd	a5,-56(s0)
    7ab6:	fc843783          	ld	a5,-56(s0)
    7aba:	fd878793          	addi	a5,a5,-40
    7abe:	fef43023          	sd	a5,-32(s0)
    7ac2:	fe043783          	ld	a5,-32(s0)
    7ac6:	02878713          	addi	a4,a5,40
    7aca:	649c                	ld	a5,8(s1)
    7acc:	faf717e3          	bne	a4,a5,7a7a <schedule_wrr+0x50>
        }
    }
    ...
    7ad0:	fe843783          	ld	a5,-24(s0)
    7ad4:	e795                	bnez	a5,7b00 <schedule_wrr+0xd6>
    7ad6:	0000a797          	auipc	a5,0xa
    7ada:	90278793          	addi	a5,a5,-1790 # 113d8 <last_thread.1226>
    7ade:	639c                	ld	a5,0(a5)
    7ae0:	c385                	beqz	a5,7b00 <schedule_wrr+0xd6>
    7ae2:	0000a797          	auipc	a5,0xa
    7ae6:	8f678793          	addi	a5,a5,-1802 # 113d8 <last_thread.1226>
    7aea:	639c                	ld	a5,0(a5)
    7aec:	4fbc                	lw	a5,88(a5)
    7aee:	00f05963          	blez	a5,7b00 <schedule_wrr+0xd6>
        selected_thread = last_thread;
    7af2:	0000a797          	auipc	a5,0xa
    7af6:	8e678793          	addi	a5,a5,-1818 # 113d8 <last_thread.1226>
    7afa:	639c                	ld	a5,0(a5)
    7afc:	fef43423          	sd	a5,-24(s0)
    }

    // Set the scheduling result
    if (selected_thread) {
    7b00:	fe843783          	ld	a5,-24(s0)
    7b04:	c7b9                	beqz	a5,7b52 <schedule_wrr+0x128>
        int time_slice = selected_thread->weight * TIME_QUANTUM;
    7b06:	fe843783          	ld	a5,-24(s0)
    7b0a:	47bc                	lw	a5,72(a5)
    7b0c:	0017979b          	slliw	a5,a5,0x1
    7b10:	fcf42e23          	sw	a5,-36(s0)
        if (time_slice > selected_thread->remaining_time) {
    7b14:	fe843783          	ld	a5,-24(s0)
    7b18:	4fb8                	lw	a4,88(a5)
    7b1a:	fdc42783          	lw	a5,-36(s0)
    7b1e:	2781                	sext.w	a5,a5
    7b20:	00f75763          	bge	a4,a5,7b2e <schedule_wrr+0x104>
            time_slice = selected_thread->remaining_time;
    7b24:	fe843783          	ld	a5,-24(s0)
    7b28:	4fbc                	lw	a5,88(a5)
    7b2a:	fcf42e23          	sw	a5,-36(s0)
        }
        r.scheduled_thread_list_member = &selected_thread->thread_list;
    7b2e:	fe843783          	ld	a5,-24(s0)
    7b32:	02878793          	addi	a5,a5,40
    7b36:	faf43423          	sd	a5,-88(s0)
        r.allocated_time = time_slice;
    7b3a:	fdc42783          	lw	a5,-36(s0)
    7b3e:	faf42823          	sw	a5,-80(s0)
        last_thread = selected_thread;  // Update the last run thread
    7b42:	0000a797          	auipc	a5,0xa
    7b46:	89678793          	addi	a5,a5,-1898 # 113d8 <last_thread.1226>
    7b4a:	fe843703          	ld	a4,-24(s0)
    7b4e:	e398                	sd	a4,0(a5)
    7b50:	a039                	j	7b5e <schedule_wrr+0x134>
    } else {
        // Idle if no suitable thread is found
        r.scheduled_thread_list_member = args.run_queue;
    7b52:	649c                	ld	a5,8(s1)
    7b54:	faf43423          	sd	a5,-88(s0)
        r.allocated_time = 1;
    7b58:	4785                	li	a5,1
    7b5a:	faf42823          	sw	a5,-80(s0)
    }

    return r;
    7b5e:	fa843783          	ld	a5,-88(s0)
    7b62:	faf43c23          	sd	a5,-72(s0)
    7b66:	fb043783          	ld	a5,-80(s0)
    7b6a:	fcf43023          	sd	a5,-64(s0)
    7b6e:	4701                	li	a4,0
    7b70:	fb843703          	ld	a4,-72(s0)
    7b74:	4781                	li	a5,0
    7b76:	fc043783          	ld	a5,-64(s0)
    7b7a:	863a                	mv	a2,a4
    7b7c:	86be                	mv	a3,a5
    7b7e:	8732                	mv	a4,a2
    7b80:	87b6                	mv	a5,a3
    ...
    7b82:	853a                	mv	a0,a4
    7b84:	85be                	mv	a1,a5
    7b86:	6466                	ld	s0,88(sp)
    7b88:	64c6                	ld	s1,80(sp)
    7b8a:	6125                	addi	sp,sp,96
    7b8c:	8082                	ret

0000000000007b8e <find_next_release_time>:

int find_next_release_time(struct list_head *release_queue, int current_time) {
    7b8e:	7139                	addi	sp,sp,-64
    7b90:	fc22                	sd	s0,56(sp)
    7b92:	0080                	addi	s0,sp,64
    7b94:	fca43423          	sd	a0,-56(s0)
    7b98:	87ae                	mv	a5,a1
    7b9a:	fcf42223          	sw	a5,-60(s0)
    struct release_queue_entry *next_release = NULL;
    7b9e:	fe043423          	sd	zero,-24(s0)
    int next_release_time = INT_MAX;
    7ba2:	800007b7          	lui	a5,0x80000
    7ba6:	fff7c793          	not	a5,a5
    7baa:	fef42223          	sw	a5,-28(s0)

    list_for_each_entry(next_release, release_queue, thread_list) {
    7bae:	fc843783          	ld	a5,-56(s0)
    7bb2:	639c                	ld	a5,0(a5)
    7bb4:	fcf43c23          	sd	a5,-40(s0)
    7bb8:	fd843783          	ld	a5,-40(s0)
    7bbc:	17e1                	addi	a5,a5,-8
    7bbe:	fef43423          	sd	a5,-24(s0)
    7bc2:	a081                	j	7c02 <find_next_release_time+0x74>
        if (next_release->release_time > current_time && next_release->release_time < next_release_time) {
    7bc4:	fe843783          	ld	a5,-24(s0)
    7bc8:	4f98                	lw	a4,24(a5)
    7bca:	fc442783          	lw	a5,-60(s0)
    7bce:	2781                	sext.w	a5,a5
    7bd0:	00e7df63          	bge	a5,a4,7bee <find_next_release_time+0x60>
    7bd4:	fe843783          	ld	a5,-24(s0)
    7bd8:	4f98                	lw	a4,24(a5)
    7bda:	fe442783          	lw	a5,-28(s0)
    7bde:	2781                	sext.w	a5,a5
    7be0:	00f75763          	bge	a4,a5,7bee <find_next_release_time+0x60>
            next_release_time = next_release->release_time;
    7be4:	fe843783          	ld	a5,-24(s0)
    7be8:	4f9c                	lw	a5,24(a5)
    7bea:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(next_release, release_queue, thread_list) {
    7bee:	fe843783          	ld	a5,-24(s0)
    7bf2:	679c                	ld	a5,8(a5)
    7bf4:	fcf43823          	sd	a5,-48(s0)
    7bf8:	fd043783          	ld	a5,-48(s0)
    7bfc:	17e1                	addi	a5,a5,-8
    7bfe:	fef43423          	sd	a5,-24(s0)
    7c02:	fe843783          	ld	a5,-24(s0)
    7c06:	07a1                	addi	a5,a5,8
    7c08:	fc843703          	ld	a4,-56(s0)
    7c0c:	faf71ce3          	bne	a4,a5,7bc4 <find_next_release_time+0x36>
        }
    }

    if (next_release_time == INT_MAX)
    7c10:	fe442783          	lw	a5,-28(s0)
    7c14:	0007871b          	sext.w	a4,a5
    7c18:	800007b7          	lui	a5,0x80000
    7c1c:	fff7c793          	not	a5,a5
    7c20:	00f71463          	bne	a4,a5,7c28 <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    7c24:	57fd                	li	a5,-1
    7c26:	a801                	j	7c36 <find_next_release_time+0xa8>

    return next_release_time - current_time;
    7c28:	fe442703          	lw	a4,-28(s0)
    7c2c:	fc442783          	lw	a5,-60(s0)
    7c30:	40f707bb          	subw	a5,a4,a5
    7c34:	2781                	sext.w	a5,a5
}
    7c36:	853e                	mv	a0,a5
    7c38:	7462                	ld	s0,56(sp)
    7c3a:	6121                	addi	sp,sp,64
    7c3c:	8082                	ret

0000000000007c3e <find_earliest_impactful_release_time>:



int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    7c3e:	7159                	addi	sp,sp,-112
    7c40:	f4a2                	sd	s0,104(sp)
    7c42:	1880                	addi	s0,sp,112
    7c44:	faa43423          	sd	a0,-88(s0)
    7c48:	fab43023          	sd	a1,-96(s0)
    7c4c:	87b2                	mv	a5,a2
    7c4e:	f8f42e23          	sw	a5,-100(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_time = INT_MAX;
    7c52:	800007b7          	lui	a5,0x80000
    7c56:	fff7c793          	not	a5,a5
    7c5a:	fef42223          	sw	a5,-28(s0)
    int shortest_current_time = INT_MAX;
    7c5e:	800007b7          	lui	a5,0x80000
    7c62:	fff7c793          	not	a5,a5
    7c66:	fef42023          	sw	a5,-32(s0)

    // Find the shortest remaining time among currently running tasks
    struct thread *t;
    list_for_each_entry(t, run_queue, thread_list) {
    7c6a:	fa043783          	ld	a5,-96(s0)
    7c6e:	639c                	ld	a5,0(a5)
    7c70:	fcf43823          	sd	a5,-48(s0)
    7c74:	fd043783          	ld	a5,-48(s0)
    7c78:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeebf8>
    7c7c:	fcf43c23          	sd	a5,-40(s0)
    7c80:	a80d                	j	7cb2 <find_earliest_impactful_release_time+0x74>
        if (t->remaining_time < shortest_current_time) {
    7c82:	fd843783          	ld	a5,-40(s0)
    7c86:	4fb8                	lw	a4,88(a5)
    7c88:	fe042783          	lw	a5,-32(s0)
    7c8c:	2781                	sext.w	a5,a5
    7c8e:	00f75763          	bge	a4,a5,7c9c <find_earliest_impactful_release_time+0x5e>
            shortest_current_time = t->remaining_time;
    7c92:	fd843783          	ld	a5,-40(s0)
    7c96:	4fbc                	lw	a5,88(a5)
    7c98:	fef42023          	sw	a5,-32(s0)
    list_for_each_entry(t, run_queue, thread_list) {
    7c9c:	fd843783          	ld	a5,-40(s0)
    7ca0:	779c                	ld	a5,40(a5)
    7ca2:	faf43c23          	sd	a5,-72(s0)
    7ca6:	fb843783          	ld	a5,-72(s0)
    7caa:	fd878793          	addi	a5,a5,-40
    7cae:	fcf43c23          	sd	a5,-40(s0)
    7cb2:	fd843783          	ld	a5,-40(s0)
    7cb6:	02878793          	addi	a5,a5,40
    7cba:	fa043703          	ld	a4,-96(s0)
    7cbe:	fcf712e3          	bne	a4,a5,7c82 <find_earliest_impactful_release_time+0x44>
        }
    }
    ...
    7cc2:	fa843783          	ld	a5,-88(s0)
    7cc6:	639c                	ld	a5,0(a5)
    7cc8:	fcf43423          	sd	a5,-56(s0)
    7ccc:	fc843783          	ld	a5,-56(s0)
    7cd0:	17e1                	addi	a5,a5,-8
    7cd2:	fef43423          	sd	a5,-24(s0)
    7cd6:	a889                	j	7d28 <find_earliest_impactful_release_time+0xea>
        if (entry->release_time > current_time && entry->release_time < earliest_impactful_time) {
    7cd8:	fe843783          	ld	a5,-24(s0)
    7cdc:	4f98                	lw	a4,24(a5)
    7cde:	f9c42783          	lw	a5,-100(s0)
    7ce2:	2781                	sext.w	a5,a5
    7ce4:	02e7d863          	bge	a5,a4,7d14 <find_earliest_impactful_release_time+0xd6>
    7ce8:	fe843783          	ld	a5,-24(s0)
    7cec:	4f98                	lw	a4,24(a5)
    7cee:	fe442783          	lw	a5,-28(s0)
    7cf2:	2781                	sext.w	a5,a5
    7cf4:	02f75063          	bge	a4,a5,7d14 <find_earliest_impactful_release_time+0xd6>
            if (entry->thrd->remaining_time < shortest_current_time) {
    7cf8:	fe843783          	ld	a5,-24(s0)
    7cfc:	639c                	ld	a5,0(a5)
    7cfe:	4fb8                	lw	a4,88(a5)
    7d00:	fe042783          	lw	a5,-32(s0)
    7d04:	2781                	sext.w	a5,a5
    7d06:	00f75763          	bge	a4,a5,7d14 <find_earliest_impactful_release_time+0xd6>
                earliest_impactful_time = entry->release_time;
    7d0a:	fe843783          	ld	a5,-24(s0)
    7d0e:	4f9c                	lw	a5,24(a5)
    7d10:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    7d14:	fe843783          	ld	a5,-24(s0)
    7d18:	679c                	ld	a5,8(a5)
    7d1a:	fcf43023          	sd	a5,-64(s0)
    7d1e:	fc043783          	ld	a5,-64(s0)
    7d22:	17e1                	addi	a5,a5,-8
    7d24:	fef43423          	sd	a5,-24(s0)
    7d28:	fe843783          	ld	a5,-24(s0)
    7d2c:	07a1                	addi	a5,a5,8
    7d2e:	fa843703          	ld	a4,-88(s0)
    7d32:	faf713e3          	bne	a4,a5,7cd8 <find_earliest_impactful_release_time+0x9a>
            }
        }
    }
    ...
    7d3a:	0007871b          	sext.w	a4,a5
    7d3e:	800007b7          	lui	a5,0x80000
    7d42:	fff7c793          	not	a5,a5
    7d46:	00f70a63          	beq	a4,a5,7d5a <find_earliest_impactful_release_time+0x11c>
    7d4a:	fe442703          	lw	a4,-28(s0)
    7d4e:	f9c42783          	lw	a5,-100(s0)
    7d52:	40f707bb          	subw	a5,a4,a5
    7d56:	2781                	sext.w	a5,a5
    7d58:	a011                	j	7d5c <find_earliest_impactful_release_time+0x11e>
    7d5a:	57fd                	li	a5,-1
}
    7d5c:	853e                	mv	a0,a5
    7d5e:	7426                	ld	s0,104(sp)
    7d60:	6165                	addi	sp,sp,112
    7d62:	8082                	ret

0000000000007d64 <schedule_sjf>:


struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    7d64:	7119                	addi	sp,sp,-128
    7d66:	fc86                	sd	ra,120(sp)
    7d68:	f8a2                	sd	s0,112(sp)
    7d6a:	f4a6                	sd	s1,104(sp)
    7d6c:	f0ca                	sd	s2,96(sp)
    7d6e:	ecce                	sd	s3,88(sp)
    7d70:	0100                	addi	s0,sp,128
    7d72:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *shortest_job = NULL;
    7d74:	fc043423          	sd	zero,-56(s0)
    struct thread *current;
    int shortest_time = INT_MAX;
    7d78:	800007b7          	lui	a5,0x80000
    7d7c:	fff7c793          	not	a5,a5
    7d80:	faf42e23          	sw	a5,-68(s0)
    int earliest_impactful_time = find_earliest_impactful_release_time(args.release_queue, args.run_queue, args.current_time);
    7d84:	689c                	ld	a5,16(s1)
    7d86:	6498                	ld	a4,8(s1)
    7d88:	4094                	lw	a3,0(s1)
    7d8a:	8636                	mv	a2,a3
    7d8c:	85ba                	mv	a1,a4
    7d8e:	853e                	mv	a0,a5
    7d90:	00000097          	auipc	ra,0x0
    7d94:	eae080e7          	jalr	-338(ra) # 7c3e <find_earliest_impactful_release_time>
    7d98:	87aa                	mv	a5,a0
    7d9a:	faf42a23          	sw	a5,-76(s0)

    // Determine the shortest job from the run queue
    list_for_each_entry(current, args.run_queue, thread_list) {
    7d9e:	649c                	ld	a5,8(s1)
    7da0:	639c                	ld	a5,0(a5)
    7da2:	faf43423          	sd	a5,-88(s0)
    7da6:	fa843783          	ld	a5,-88(s0)
    7daa:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeebf8>
    7dae:	fcf43023          	sd	a5,-64(s0)
    7db2:	a82d                	j	7dec <schedule_sjf+0x88>
        if (current->remaining_time < shortest_time) {
    7db4:	fc043783          	ld	a5,-64(s0)
    7db8:	4fb8                	lw	a4,88(a5)
    7dba:	fbc42783          	lw	a5,-68(s0)
    7dbe:	2781                	sext.w	a5,a5
    7dc0:	00f75b63          	bge	a4,a5,7dd6 <schedule_sjf+0x72>
            shortest_time = current->remaining_time;
    7dc4:	fc043783          	ld	a5,-64(s0)
    7dc8:	4fbc                	lw	a5,88(a5)
    7dca:	faf42e23          	sw	a5,-68(s0)
            shortest_job = current;
    7dce:	fc043783          	ld	a5,-64(s0)
    7dd2:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(current, args.run_queue, thread_list) {
    7dd6:	fc043783          	ld	a5,-64(s0)
    7dda:	779c                	ld	a5,40(a5)
    7ddc:	faf43023          	sd	a5,-96(s0)
    7de0:	fa043783          	ld	a5,-96(s0)
    7de4:	fd878793          	addi	a5,a5,-40
    7de8:	fcf43023          	sd	a5,-64(s0)
    7dec:	fc043783          	ld	a5,-64(s0)
    7df0:	02878713          	addi	a4,a5,40
    7df4:	649c                	ld	a5,8(s1)
    7df6:	faf71fe3          	bne	a4,a5,7db4 <schedule_sjf+0x50>
        }
    }

    if (shortest_job) {
    7dfa:	fc843783          	ld	a5,-56(s0)
    7dfe:	c7a1                	beqz	a5,7e46 <schedule_sjf+0xe2>
        int time_to_allocate = shortest_job->remaining_time;
    7e00:	fc843783          	ld	a5,-56(s0)
    7e04:	4fbc                	lw	a5,88(a5)
    7e06:	faf42c23          	sw	a5,-72(s0)
    ...
    7e0a:	fb442783          	lw	a5,-76(s0)
    7e0e:	0007871b          	sext.w	a4,a5
    7e12:	57fd                	li	a5,-1
    7e14:	00f70e63          	beq	a4,a5,7e30 <schedule_sjf+0xcc>
    7e18:	fb442703          	lw	a4,-76(s0)
    7e1c:	fb842783          	lw	a5,-72(s0)
    7e20:	2701                	sext.w	a4,a4
    7e22:	2781                	sext.w	a5,a5
    7e24:	00f75663          	bge	a4,a5,7e30 <schedule_sjf+0xcc>
            time_to_allocate = earliest_impactful_time;
    7e28:	fb442783          	lw	a5,-76(s0)
    7e2c:	faf42c23          	sw	a5,-72(s0)
        }

        r.scheduled_thread_list_member = &shortest_job->thread_list;
    7e30:	fc843783          	ld	a5,-56(s0)
    7e34:	02878793          	addi	a5,a5,40
    7e38:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = time_to_allocate;
    7e3c:	fb842783          	lw	a5,-72(s0)
    7e40:	f8f42423          	sw	a5,-120(s0)
    7e44:	a80d                	j	7e76 <schedule_sjf+0x112>
    } else {
        // If no current tasks are ready, wait for the next impactful task
        r.scheduled_thread_list_member = args.run_queue;
    7e46:	649c                	ld	a5,8(s1)
    7e48:	f8f43023          	sd	a5,-128(s0)
    ...
    7e4c:	fb442783          	lw	a5,-76(s0)
    7e50:	0007871b          	sext.w	a4,a5
    7e54:	57fd                	li	a5,-1
    7e56:	00f71c63          	bne	a4,a5,7e6e <schedule_sjf+0x10a>
    7e5a:	689c                	ld	a5,16(s1)
    7e5c:	4098                	lw	a4,0(s1)
    7e5e:	85ba                	mv	a1,a4
    7e60:	853e                	mv	a0,a5
    7e62:	00000097          	auipc	ra,0x0
    7e66:	d2c080e7          	jalr	-724(ra) # 7b8e <find_next_release_time>
    7e6a:	87aa                	mv	a5,a0
    7e6c:	a019                	j	7e72 <schedule_sjf+0x10e>
    7e6e:	fb442783          	lw	a5,-76(s0)
    7e72:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    7e76:	f8043783          	ld	a5,-128(s0)
    7e7a:	f8f43823          	sd	a5,-112(s0)
    7e7e:	f8843783          	ld	a5,-120(s0)
    7e82:	f8f43c23          	sd	a5,-104(s0)
    7e86:	4701                	li	a4,0
    7e88:	f9043703          	ld	a4,-112(s0)
    7e8c:	4781                	li	a5,0
    7e8e:	f9843783          	ld	a5,-104(s0)
    7e92:	893a                	mv	s2,a4
    7e94:	89be                	mv	s3,a5
    7e96:	874a                	mv	a4,s2
    7e98:	87ce                	mv	a5,s3
    ...
    7e9a:	853a                	mv	a0,a4
    7e9c:	85be                	mv	a1,a5
    7e9e:	70e6                	ld	ra,120(sp)
    7ea0:	7446                	ld	s0,112(sp)
    7ea2:	74a6                	ld	s1,104(sp)
    7ea4:	7906                	ld	s2,96(sp)
    7ea6:	69e6                	ld	s3,88(sp)
    7ea8:	6109                	addi	sp,sp,128
    7eaa:	8082                	ret

0000000000007eac <min>:

int min(int a, int b) {
    7eac:	1101                	addi	sp,sp,-32
    7eae:	ec22                	sd	s0,24(sp)
    7eb0:	1000                	addi	s0,sp,32
    7eb2:	87aa                	mv	a5,a0
    7eb4:	872e                	mv	a4,a1
    7eb6:	fef42623          	sw	a5,-20(s0)
    7eba:	87ba                	mv	a5,a4
    7ebc:	fef42423          	sw	a5,-24(s0)
    return (a < b) ? a : b;
    7ec0:	fec42603          	lw	a2,-20(s0)
    7ec4:	fe842783          	lw	a5,-24(s0)
    7ec8:	0007869b          	sext.w	a3,a5
    7ecc:	0006071b          	sext.w	a4,a2
    7ed0:	00d75363          	bge	a4,a3,7ed6 <min+0x2a>
    7ed4:	87b2                	mv	a5,a2
    7ed6:	2781                	sext.w	a5,a5
}
    7ed8:	853e                	mv	a0,a5
    7eda:	6462                	ld	s0,24(sp)
    7edc:	6105                	addi	sp,sp,32
    7ede:	8082                	ret

0000000000007ee0 <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    7ee0:	7131                	addi	sp,sp,-192
    7ee2:	fd06                	sd	ra,184(sp)
    7ee4:	f922                	sd	s0,176(sp)
    7ee6:	f526                	sd	s1,168(sp)
    7ee8:	f14a                	sd	s2,160(sp)
    7eea:	ed4e                	sd	s3,152(sp)
    7eec:	0180                	addi	s0,sp,192
    7eee:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *min_slack_thread = NULL;
    7ef0:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    7ef4:	800007b7          	lui	a5,0x80000
    7ef8:	fff7c793          	not	a5,a5
    7efc:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    // int ddl;
    // Determine the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    7f00:	649c                	ld	a5,8(s1)
    7f02:	639c                	ld	a5,0(a5)
    7f04:	faf43023          	sd	a5,-96(s0)
    7f08:	fa043783          	ld	a5,-96(s0)
    7f0c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeebf8>
    7f10:	faf43c23          	sd	a5,-72(s0)
    7f14:	a069                	j	7f9e <schedule_lst+0xbe>
        int slack_time = t->current_deadline - args.current_time - t->remaining_time;
    7f16:	fb843783          	ld	a5,-72(s0)
    7f1a:	4ff8                	lw	a4,92(a5)
    7f1c:	409c                	lw	a5,0(s1)
    7f1e:	40f707bb          	subw	a5,a4,a5
    7f22:	0007871b          	sext.w	a4,a5
    7f26:	fb843783          	ld	a5,-72(s0)
    7f2a:	4fbc                	lw	a5,88(a5)
    7f2c:	40f707bb          	subw	a5,a4,a5
    7f30:	f6f42a23          	sw	a5,-140(s0)
        if (slack_time < min_slack_time || (slack_time == min_slack_time && t->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))) {
    7f34:	f7442703          	lw	a4,-140(s0)
    7f38:	fc442783          	lw	a5,-60(s0)
    7f3c:	2701                	sext.w	a4,a4
    7f3e:	2781                	sext.w	a5,a5
    7f40:	02f74c63          	blt	a4,a5,7f78 <schedule_lst+0x98>
    7f44:	f7442703          	lw	a4,-140(s0)
    7f48:	fc442783          	lw	a5,-60(s0)
    7f4c:	2701                	sext.w	a4,a4
    7f4e:	2781                	sext.w	a5,a5
    7f50:	02f71c63          	bne	a4,a5,7f88 <schedule_lst+0xa8>
    7f54:	fb843783          	ld	a5,-72(s0)
    7f58:	5fd4                	lw	a3,60(a5)
    7f5a:	fc843783          	ld	a5,-56(s0)
    7f5e:	c789                	beqz	a5,7f68 <schedule_lst+0x88>
    7f60:	fc843783          	ld	a5,-56(s0)
    7f64:	5fdc                	lw	a5,60(a5)
    7f66:	a029                	j	7f70 <schedule_lst+0x90>
    7f68:	800007b7          	lui	a5,0x80000
    7f6c:	fff7c793          	not	a5,a5
    7f70:	873e                	mv	a4,a5
    7f72:	87b6                	mv	a5,a3
    7f74:	00e7da63          	bge	a5,a4,7f88 <schedule_lst+0xa8>
            min_slack_thread = t;
    7f78:	fb843783          	ld	a5,-72(s0)
    7f7c:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    7f80:	f7442783          	lw	a5,-140(s0)
    7f84:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    7f88:	fb843783          	ld	a5,-72(s0)
    7f8c:	779c                	ld	a5,40(a5)
    7f8e:	f6f43423          	sd	a5,-152(s0)
    7f92:	f6843783          	ld	a5,-152(s0)
    7f96:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeebf8>
    7f9a:	faf43c23          	sd	a5,-72(s0)
    7f9e:	fb843783          	ld	a5,-72(s0)
    7fa2:	02878713          	addi	a4,a5,40
    7fa6:	649c                	ld	a5,8(s1)
    7fa8:	f6f717e3          	bne	a4,a5,7f16 <schedule_lst+0x36>
    ...
    7fac:	800007b7          	lui	a5,0x80000
    7fb0:	fff7c793          	not	a5,a5
    7fb4:	faf42a23          	sw	a5,-76(s0)
    ...
    7fb8:	689c                	ld	a5,16(s1)
    7fba:	639c                	ld	a5,0(a5)
    7fbc:	f8f43c23          	sd	a5,-104(s0)
    7fc0:	f9843783          	ld	a5,-104(s0)
    7fc4:	17e1                	addi	a5,a5,-8
    7fc6:	faf43423          	sd	a5,-88(s0)
    7fca:	a0f1                	j	8096 <schedule_lst+0x1b6>
        if (entry->release_time > args.current_time) {
    7fcc:	fa843783          	ld	a5,-88(s0)
    7fd0:	4f98                	lw	a4,24(a5)
    7fd2:	409c                	lw	a5,0(s1)
    7fd4:	0ae7d763          	bge	a5,a4,8082 <schedule_lst+0x1a2>
            struct thread *upcoming_thread = entry->thrd;
    7fd8:	fa843783          	ld	a5,-88(s0)
    7fdc:	639c                	ld	a5,0(a5)
    7fde:	f8f43423          	sd	a5,-120(s0)
            int upcoming_slack_time = upcoming_thread->current_deadline - entry->release_time - upcoming_thread->remaining_time;
    7fe2:	f8843783          	ld	a5,-120(s0)
    7fe6:	4ff8                	lw	a4,92(a5)
    7fe8:	fa843783          	ld	a5,-88(s0)
    7fec:	4f9c                	lw	a5,24(a5)
    7fee:	40f707bb          	subw	a5,a4,a5
    7ff2:	0007871b          	sext.w	a4,a5
    7ff6:	f8843783          	ld	a5,-120(s0)
    7ffa:	4fbc                	lw	a5,88(a5)
    7ffc:	40f707bb          	subw	a5,a4,a5
    8000:	f8f42223          	sw	a5,-124(s0)
    ...
    8004:	f8442703          	lw	a4,-124(s0)
    8008:	fc442783          	lw	a5,-60(s0)
    800c:	2701                	sext.w	a4,a4
    800e:	2781                	sext.w	a5,a5
    8010:	02f75163          	bge	a4,a5,8032 <schedule_lst+0x152>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    8014:	fa843783          	ld	a5,-88(s0)
    8018:	4f98                	lw	a4,24(a5)
    801a:	fb442783          	lw	a5,-76(s0)
    801e:	85ba                	mv	a1,a4
    8020:	853e                	mv	a0,a5
    8022:	00000097          	auipc	ra,0x0
    8026:	e8a080e7          	jalr	-374(ra) # 7eac <min>
    802a:	87aa                	mv	a5,a0
    802c:	faf42a23          	sw	a5,-76(s0)
    8030:	a889                	j	8082 <schedule_lst+0x1a2>
            } else if (upcoming_slack_time == min_slack_time && upcoming_thread->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))
    8032:	f8442703          	lw	a4,-124(s0)
    8036:	fc442783          	lw	a5,-60(s0)
    803a:	2701                	sext.w	a4,a4
    803c:	2781                	sext.w	a5,a5
    803e:	04f71263          	bne	a4,a5,8082 <schedule_lst+0x1a2>
    8042:	f8843783          	ld	a5,-120(s0)
    8046:	5fd4                	lw	a3,60(a5)
    8048:	fc843783          	ld	a5,-56(s0)
    804c:	c789                	beqz	a5,8056 <schedule_lst+0x176>
    804e:	fc843783          	ld	a5,-56(s0)
    8052:	5fdc                	lw	a5,60(a5)
    8054:	a029                	j	805e <schedule_lst+0x17e>
    8056:	800007b7          	lui	a5,0x80000
    805a:	fff7c793          	not	a5,a5
    805e:	873e                	mv	a4,a5
    8060:	87b6                	mv	a5,a3
    8062:	02e7d063          	bge	a5,a4,8082 <schedule_lst+0x1a2>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    8066:	fa843783          	ld	a5,-88(s0)
    806a:	4f98                	lw	a4,24(a5)
    806c:	fb442783          	lw	a5,-76(s0)
    8070:	85ba                	mv	a1,a4
    8072:	853e                	mv	a0,a5
    8074:	00000097          	auipc	ra,0x0
    8078:	e38080e7          	jalr	-456(ra) # 7eac <min>
    807c:	87aa                	mv	a5,a0
    807e:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(entry, args.release_queue, thread_list) {
    8082:	fa843783          	ld	a5,-88(s0)
    8086:	679c                	ld	a5,8(a5)
    8088:	f6f43c23          	sd	a5,-136(s0)
    808c:	f7843783          	ld	a5,-136(s0)
    8090:	17e1                	addi	a5,a5,-8
    8092:	faf43423          	sd	a5,-88(s0)
    8096:	fa843783          	ld	a5,-88(s0)
    809a:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__BSS_END__+0xffffffff7ffeec28>
    809e:	689c                	ld	a5,16(s1)
    80a0:	f2f716e3          	bne	a4,a5,7fcc <schedule_lst+0xec>
        }
    }

    // Decide the allocated time based on current minimum slack or upcoming preemption needs
    if (min_slack_thread) {
    80a4:	fc843783          	ld	a5,-56(s0)
    80a8:	c3b1                	beqz	a5,80ec <schedule_lst+0x20c>
    ...
    80aa:	fb442783          	lw	a5,-76(s0)
    80ae:	0007871b          	sext.w	a4,a5
    80b2:	800007b7          	lui	a5,0x80000
    80b6:	fff7c793          	not	a5,a5
    80ba:	00f71663          	bne	a4,a5,80c6 <schedule_lst+0x1e6>
    80be:	fc843783          	ld	a5,-56(s0)
    80c2:	4fbc                	lw	a5,88(a5)
    80c4:	a039                	j	80d2 <schedule_lst+0x1f2>
    80c6:	409c                	lw	a5,0(s1)
    80c8:	fb442703          	lw	a4,-76(s0)
    80cc:	40f707bb          	subw	a5,a4,a5
    80d0:	2781                	sext.w	a5,a5
    80d2:	f8f42a23          	sw	a5,-108(s0)
        r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    80d6:	fc843783          	ld	a5,-56(s0)
    80da:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__BSS_END__+0xffffffff7ffeec48>
    80de:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = allocated_time;
    80e2:	f9442783          	lw	a5,-108(s0)
    80e6:	f4f42823          	sw	a5,-176(s0)
    80ea:	a081                	j	812a <schedule_lst+0x24a>
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    80ec:	649c                	ld	a5,8(s1)
    80ee:	f4f43423          	sd	a5,-184(s0)
    ...
    80f2:	fb442783          	lw	a5,-76(s0)
    80f6:	0007871b          	sext.w	a4,a5
    80fa:	800007b7          	lui	a5,0x80000
    80fe:	fff7c793          	not	a5,a5
    8102:	00f70963          	beq	a4,a5,8114 <schedule_lst+0x234>
    8106:	409c                	lw	a5,0(s1)
    8108:	fb442703          	lw	a4,-76(s0)
    810c:	40f707bb          	subw	a5,a4,a5
    8110:	2781                	sext.w	a5,a5
    8112:	a811                	j	8126 <schedule_lst+0x246>
    8114:	689c                	ld	a5,16(s1)
    8116:	4098                	lw	a4,0(s1)
    8118:	85ba                	mv	a1,a4
    811a:	853e                	mv	a0,a5
    811c:	00000097          	auipc	ra,0x0
    8120:	a72080e7          	jalr	-1422(ra) # 7b8e <find_next_release_time>
    8124:	87aa                	mv	a5,a0
    8126:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    812a:	f4843783          	ld	a5,-184(s0)
    812e:	f4f43c23          	sd	a5,-168(s0)
    8132:	f5043783          	ld	a5,-176(s0)
    8136:	f6f43023          	sd	a5,-160(s0)
    813a:	4701                	li	a4,0
    813c:	f5843703          	ld	a4,-168(s0)
    8140:	4781                	li	a5,0
    8142:	f6043783          	ld	a5,-160(s0)
    8146:	893a                	mv	s2,a4
    8148:	89be                	mv	s3,a5
    814a:	874a                	mv	a4,s2
    814c:	87ce                	mv	a5,s3
    ...
    814e:	853a                	mv	a0,a4
    8150:	85be                	mv	a1,a5
    8152:	70ea                	ld	ra,184(sp)
    8154:	744a                	ld	s0,176(sp)
    8156:	74aa                	ld	s1,168(sp)
    8158:	790a                	ld	s2,160(sp)
    815a:	69ea                	ld	s3,152(sp)
    815c:	6129                	addi	sp,sp,192
    815e:	8082                	ret

0000000000008160 <find_earliest_impactful_release_time_dm>:

int find_earliest_impactful_release_time_dm(struct list_head *release_queue, int current_time, int current_deadline) {
    8160:	715d                	addi	sp,sp,-80
    8162:	e4a2                	sd	s0,72(sp)
    8164:	0880                	addi	s0,sp,80
    8166:	faa43c23          	sd	a0,-72(s0)
    816a:	87ae                	mv	a5,a1
    816c:	8732                	mv	a4,a2
    816e:	faf42a23          	sw	a5,-76(s0)
    8172:	87ba                	mv	a5,a4
    8174:	faf42823          	sw	a5,-80(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_event = INT_MAX;
    8178:	800007b7          	lui	a5,0x80000
    817c:	fff7c793          	not	a5,a5
    8180:	fef42223          	sw	a5,-28(s0)
    struct thread *earliest_deadline_thread = NULL;
    8184:	fc043c23          	sd	zero,-40(s0)
    earliest_deadline_thread->ID = INT_MAX;
    8188:	fd843783          	ld	a5,-40(s0)
    818c:	80000737          	lui	a4,0x80000
    8190:	fff74713          	not	a4,a4
    8194:	dfd8                	sw	a4,60(a5)

    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    8196:	fb843783          	ld	a5,-72(s0)
    819a:	639c                	ld	a5,0(a5)
    819c:	fcf43823          	sd	a5,-48(s0)
    81a0:	fd043783          	ld	a5,-48(s0)
    81a4:	17e1                	addi	a5,a5,-8
    81a6:	fef43423          	sd	a5,-24(s0)
    81aa:	a075                	j	8256 <find_earliest_impactful_release_time_dm+0xf6>
        if (entry->release_time > current_time && entry->thrd->period < current_deadline) {
    81ac:	fe843783          	ld	a5,-24(s0)
    81b0:	4f98                	lw	a4,24(a5)
    81b2:	fb442783          	lw	a5,-76(s0)
    81b6:	2781                	sext.w	a5,a5
    81b8:	02e7d963          	bge	a5,a4,81ea <find_earliest_impactful_release_time_dm+0x8a>
    81bc:	fe843783          	ld	a5,-24(s0)
    81c0:	639c                	ld	a5,0(a5)
    81c2:	4bb8                	lw	a4,80(a5)
    81c4:	fb042783          	lw	a5,-80(s0)
    81c8:	2781                	sext.w	a5,a5
    81ca:	02f75063          	bge	a4,a5,81ea <find_earliest_impactful_release_time_dm+0x8a>
            if (entry->release_time < earliest_impactful_event) {
    81ce:	fe843783          	ld	a5,-24(s0)
    81d2:	4f98                	lw	a4,24(a5)
    81d4:	fe442783          	lw	a5,-28(s0)
    81d8:	2781                	sext.w	a5,a5
    81da:	06f75463          	bge	a4,a5,8242 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    81de:	fe843783          	ld	a5,-24(s0)
    81e2:	4f9c                	lw	a5,24(a5)
    81e4:	fef42223          	sw	a5,-28(s0)
            if (entry->release_time < earliest_impactful_event) {
    81e8:	a8a9                	j	8242 <find_earliest_impactful_release_time_dm+0xe2>
            }
        } 
    ...
    81ea:	fe843783          	ld	a5,-24(s0)
    81ee:	4f98                	lw	a4,24(a5)
    81f0:	fb442783          	lw	a5,-76(s0)
    81f4:	2781                	sext.w	a5,a5
    81f6:	04e7d663          	bge	a5,a4,8242 <find_earliest_impactful_release_time_dm+0xe2>
    81fa:	fe843783          	ld	a5,-24(s0)
    81fe:	639c                	ld	a5,0(a5)
    8200:	4bb8                	lw	a4,80(a5)
    8202:	fb042783          	lw	a5,-80(s0)
    8206:	2781                	sext.w	a5,a5
    8208:	02e79d63          	bne	a5,a4,8242 <find_earliest_impactful_release_time_dm+0xe2>
            if (entry->release_time < earliest_impactful_event && entry->thrd->ID < earliest_deadline_thread->ID) {
    820c:	fe843783          	ld	a5,-24(s0)
    8210:	4f98                	lw	a4,24(a5)
    8212:	fe442783          	lw	a5,-28(s0)
    8216:	2781                	sext.w	a5,a5
    8218:	02f75563          	bge	a4,a5,8242 <find_earliest_impactful_release_time_dm+0xe2>
    821c:	fe843783          	ld	a5,-24(s0)
    8220:	639c                	ld	a5,0(a5)
    8222:	5fd8                	lw	a4,60(a5)
    8224:	fd843783          	ld	a5,-40(s0)
    8228:	5fdc                	lw	a5,60(a5)
    822a:	00f75c63          	bge	a4,a5,8242 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    822e:	fe843783          	ld	a5,-24(s0)
    8232:	4f9c                	lw	a5,24(a5)
    8234:	fef42223          	sw	a5,-28(s0)
                earliest_deadline_thread = entry->thrd;
    8238:	fe843783          	ld	a5,-24(s0)
    823c:	639c                	ld	a5,0(a5)
    823e:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    8242:	fe843783          	ld	a5,-24(s0)
    8246:	679c                	ld	a5,8(a5)
    8248:	fcf43423          	sd	a5,-56(s0)
    824c:	fc843783          	ld	a5,-56(s0)
    8250:	17e1                	addi	a5,a5,-8
    8252:	fef43423          	sd	a5,-24(s0)
    8256:	fe843783          	ld	a5,-24(s0)
    825a:	07a1                	addi	a5,a5,8
    825c:	fb843703          	ld	a4,-72(s0)
    8260:	f4f716e3          	bne	a4,a5,81ac <find_earliest_impactful_release_time_dm+0x4c>
            }
        }
    }
    ...
    8264:	fe442783          	lw	a5,-28(s0)
    8268:	0007871b          	sext.w	a4,a5
    826c:	800007b7          	lui	a5,0x80000
    8270:	fff7c793          	not	a5,a5
    8274:	00f70563          	beq	a4,a5,827e <find_earliest_impactful_release_time_dm+0x11e>
    8278:	fe442783          	lw	a5,-28(s0)
    827c:	a011                	j	8280 <find_earliest_impactful_release_time_dm+0x120>
    827e:	57fd                	li	a5,-1
}
    8280:	853e                	mv	a0,a5
    8282:	6426                	ld	s0,72(sp)
    8284:	6161                	addi	sp,sp,80
    8286:	8082                	ret

0000000000008288 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    8288:	7175                	addi	sp,sp,-144
    828a:	e506                	sd	ra,136(sp)
    828c:	e122                	sd	s0,128(sp)
    828e:	fca6                	sd	s1,120(sp)
    8290:	f8ca                	sd	s2,112(sp)
    8292:	f4ce                	sd	s3,104(sp)
    8294:	0900                	addi	s0,sp,144
    8296:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    8298:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    829c:	800007b7          	lui	a5,0x80000
    82a0:	fff7c793          	not	a5,a5
    82a4:	faf42e23          	sw	a5,-68(s0)

    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    82a8:	649c                	ld	a5,8(s1)
    82aa:	639c                	ld	a5,0(a5)
    82ac:	faf43823          	sd	a5,-80(s0)
    82b0:	fb043783          	ld	a5,-80(s0)
    82b4:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeebf8>
    82b8:	fcf43023          	sd	a5,-64(s0)
    82bc:	a089                	j	82fe <schedule_dm+0x76>
        if (t->is_real_time && t->period < earliest_deadline) {
    82be:	fc043783          	ld	a5,-64(s0)
    82c2:	43bc                	lw	a5,64(a5)
    82c4:	c395                	beqz	a5,82e8 <schedule_dm+0x60>
    82c6:	fc043783          	ld	a5,-64(s0)
    82ca:	4bb8                	lw	a4,80(a5)
    82cc:	fbc42783          	lw	a5,-68(s0)
    82d0:	2781                	sext.w	a5,a5
    82d2:	00f75b63          	bge	a4,a5,82e8 <schedule_dm+0x60>
            earliest_deadline_thread = t;
    82d6:	fc043783          	ld	a5,-64(s0)
    82da:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    82de:	fc043783          	ld	a5,-64(s0)
    82e2:	4bbc                	lw	a5,80(a5)
    82e4:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    82e8:	fc043783          	ld	a5,-64(s0)
    82ec:	779c                	ld	a5,40(a5)
    82ee:	f8f43c23          	sd	a5,-104(s0)
    82f2:	f9843783          	ld	a5,-104(s0)
    82f6:	fd878793          	addi	a5,a5,-40
    82fa:	fcf43023          	sd	a5,-64(s0)
    82fe:	fc043783          	ld	a5,-64(s0)
    8302:	02878713          	addi	a4,a5,40
    8306:	649c                	ld	a5,8(s1)
    8308:	faf71be3          	bne	a4,a5,82be <schedule_dm+0x36>
        }
    }
    ...
    830c:	689c                	ld	a5,16(s1)
    830e:	4098                	lw	a4,0(s1)
    8310:	fbc42683          	lw	a3,-68(s0)
    8314:	8636                	mv	a2,a3
    8316:	85ba                	mv	a1,a4
    8318:	853e                	mv	a0,a5
    831a:	00000097          	auipc	ra,0x0
    831e:	e46080e7          	jalr	-442(ra) # 8160 <find_earliest_impactful_release_time_dm>
    8322:	87aa                	mv	a5,a0
    8324:	faf42623          	sw	a5,-84(s0)

    if (earliest_deadline_thread) {
    8328:	fc843783          	ld	a5,-56(s0)
    832c:	c3c9                	beqz	a5,83ae <schedule_dm+0x126>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    832e:	fc843783          	ld	a5,-56(s0)
    8332:	4ff8                	lw	a4,92(a5)
    8334:	409c                	lw	a5,0(s1)
    8336:	40f707bb          	subw	a5,a4,a5
    833a:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline < 0) {
    833e:	fa842783          	lw	a5,-88(s0)
    8342:	2781                	sext.w	a5,a5
    8344:	0007db63          	bgez	a5,835a <schedule_dm+0xd2>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    8348:	fc843783          	ld	a5,-56(s0)
    834c:	02878793          	addi	a5,a5,40
    8350:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    8354:	f8042023          	sw	zero,-128(s0)
    8358:	a88d                	j	83ca <schedule_dm+0x142>
        } else {
    ...
    835a:	fac42783          	lw	a5,-84(s0)
    835e:	0007871b          	sext.w	a4,a5
    8362:	57fd                	li	a5,-1
    8364:	02f70563          	beq	a4,a5,838e <schedule_dm+0x106>
    8368:	409c                	lw	a5,0(s1)
    836a:	fac42703          	lw	a4,-84(s0)
    836e:	40f707bb          	subw	a5,a4,a5
    8372:	0007871b          	sext.w	a4,a5
    8376:	fc843783          	ld	a5,-56(s0)
    837a:	4fbc                	lw	a5,88(a5)
    837c:	00f75963          	bge	a4,a5,838e <schedule_dm+0x106>
    8380:	409c                	lw	a5,0(s1)
    8382:	fac42703          	lw	a4,-84(s0)
    8386:	40f707bb          	subw	a5,a4,a5
    838a:	2781                	sext.w	a5,a5
    838c:	a021                	j	8394 <schedule_dm+0x10c>
    838e:	fc843783          	ld	a5,-56(s0)
    8392:	4fbc                	lw	a5,88(a5)
    8394:	faf42223          	sw	a5,-92(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    8398:	fc843783          	ld	a5,-56(s0)
    839c:	02878793          	addi	a5,a5,40
    83a0:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    83a4:	fa442783          	lw	a5,-92(s0)
    83a8:	f8f42023          	sw	a5,-128(s0)
    83ac:	a839                	j	83ca <schedule_dm+0x142>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    83ae:	649c                	ld	a5,8(s1)
    83b0:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    83b4:	689c                	ld	a5,16(s1)
    83b6:	4098                	lw	a4,0(s1)
    83b8:	85ba                	mv	a1,a4
    83ba:	853e                	mv	a0,a5
    83bc:	fffff097          	auipc	ra,0xfffff
    83c0:	7d2080e7          	jalr	2002(ra) # 7b8e <find_next_release_time>
    83c4:	87aa                	mv	a5,a0
    83c6:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    83ca:	f7843783          	ld	a5,-136(s0)
    83ce:	f8f43423          	sd	a5,-120(s0)
    83d2:	f8043783          	ld	a5,-128(s0)
    83d6:	f8f43823          	sd	a5,-112(s0)
    83da:	4701                	li	a4,0
    83dc:	f8843703          	ld	a4,-120(s0)
    83e0:	4781                	li	a5,0
    83e2:	f9043783          	ld	a5,-112(s0)
    83e6:	893a                	mv	s2,a4
    83e8:	89be                	mv	s3,a5
    83ea:	874a                	mv	a4,s2
    83ec:	87ce                	mv	a5,s3
    ...
    83ee:	853a                	mv	a0,a4
    83f0:	85be                	mv	a1,a5
    83f2:	60aa                	ld	ra,136(sp)
    83f4:	640a                	ld	s0,128(sp)
    83f6:	74e6                	ld	s1,120(sp)
    83f8:	7946                	ld	s2,112(sp)
    83fa:	79a6                	ld	s3,104(sp)
    83fc:	6149                	addi	sp,sp,144
    83fe:	8082                	ret

...
copyin(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
      ...
      54:	34850513          	addi	a0,a0,840 # 8398 <schedule_dm+0x530>
    ...
    if(fd < 0){
      ...
      74:	33050513          	addi	a0,a0,816 # 83a0 <schedule_dm+0x538>
    ...
    if(n >= 0){
      ...
      be:	2fe50513          	addi	a0,a0,766 # 83b8 <schedule_dm+0x550>
    ...
    unlink("copyin1");
      ...
      e6:	2b650513          	addi	a0,a0,694 # 8398 <schedule_dm+0x530>
    ...
    if(n > 0){
     ...
     122:	2ca50513          	addi	a0,a0,714 # 83e8 <schedule_dm+0x580>
    ...
    if(pipe(fds) < 0){
     ...
     150:	2cc50513          	addi	a0,a0,716 # 8418 <schedule_dm+0x5b0>
    ...
    if(n > 0){
     ...
     19a:	29250513          	addi	a0,a0,658 # 8428 <schedule_dm+0x5c0>
...
copyout(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     22a:	23250513          	addi	a0,a0,562 # 8458 <schedule_dm+0x5f0>
    ...
    if(fd < 0){
     ...
     24a:	21a50513          	addi	a0,a0,538 # 8460 <schedule_dm+0x5f8>
    ...
    if(n > 0){
     ...
     294:	1e850513          	addi	a0,a0,488 # 8478 <schedule_dm+0x610>
    ...
    if(pipe(fds) < 0){
     ...
     2d0:	14c50513          	addi	a0,a0,332 # 8418 <schedule_dm+0x5b0>
    ...
    n = write(fds[1], "x", 1);
     ...
     2f0:	1bc58593          	addi	a1,a1,444 # 84a8 <schedule_dm+0x640>
     2f4:	853e                	mv	a0,a5
    ...
    if(n != 1){
     ...
     316:	19e50513          	addi	a0,a0,414 # 84b0 <schedule_dm+0x648>
    ...
    if(n > 0){
     ...
     360:	16c50513          	addi	a0,a0,364 # 84c8 <schedule_dm+0x660>
...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    if(fd >= 0){
     ...
     41a:	0e250513          	addi	a0,a0,226 # 84f8 <schedule_dm+0x690>
...
copyinstr2(char *s)
{
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     4c8:	05450513          	addi	a0,a0,84 # 8518 <schedule_dm+0x6b0>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     514:	02850513          	addi	a0,a0,40 # 8538 <schedule_dm+0x6d0>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     566:	ff650513          	addi	a0,a0,-10 # 8558 <schedule_dm+0x6f0>
  ...
  char *args[] = { "xx", 0 };
     ...
     580:	00478793          	addi	a5,a5,4 # 8580 <schedule_dm+0x718>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     5c4:	fc850513          	addi	a0,a0,-56 # 8588 <schedule_dm+0x720>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
     ...
     5f6:	fb650513          	addi	a0,a0,-74 # 85a8 <schedule_dm+0x740>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     61e:	93e70713          	addi	a4,a4,-1730 # ff58 <big.1275>
    ...
    ret = exec("echo", args2);
     ...
     682:	f3a50513          	addi	a0,a0,-198 # 85b8 <schedule_dm+0x750>
    ...
    if(ret != -1){
     ...
     6ac:	f1850513          	addi	a0,a0,-232 # 85c0 <schedule_dm+0x758>
  ...
  if(st != 747){
    ...
    printf("exec(echo, BIG) succeeded, should have failed\n");
     ...
     6f2:	efa50513          	addi	a0,a0,-262 # 85e8 <schedule_dm+0x780>
...
copyinstr3(char *s)
{
  ...
  if(top % PGSIZE){
    ...
    printf("oops\n");
     ...
     788:	eb450513          	addi	a0,a0,-332 # 8638 <schedule_dm+0x7d0>
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     7e2:	d3a50513          	addi	a0,a0,-710 # 8518 <schedule_dm+0x6b0>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     82a:	d1250513          	addi	a0,a0,-750 # 8538 <schedule_dm+0x6d0>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     876:	ce650513          	addi	a0,a0,-794 # 8558 <schedule_dm+0x6f0>
  ...
  char *args[] = { "xx", 0 };
     ...
     890:	cf478793          	addi	a5,a5,-780 # 8580 <schedule_dm+0x718>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     8d0:	cbc50513          	addi	a0,a0,-836 # 8588 <schedule_dm+0x720>
...
rwsbrk()
{
  ...
  if(a == 0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) failed\n");
     ...
     916:	d2e50513          	addi	a0,a0,-722 # 8640 <schedule_dm+0x7d8>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) shrink failed\n");
     ...
     942:	d1a50513          	addi	a0,a0,-742 # 8658 <schedule_dm+0x7f0>
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
     ...
     960:	79450513          	addi	a0,a0,1940 # 80f0 <schedule_dm+0x288>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     980:	cfc50513          	addi	a0,a0,-772 # 8678 <schedule_dm+0x810>
  ...
  if(n >= 0){
    ...
    printf("write(fd, %p, 1024) returned %d, not -1\n", a+4096, n);
     ...
     9d8:	cbc50513          	addi	a0,a0,-836 # 8690 <schedule_dm+0x828>
  ...
  unlink("rwsbrk");
     ...
     a00:	6f450513          	addi	a0,a0,1780 # 80f0 <schedule_dm+0x288>
  ...
  fd = open("README", O_RDONLY);
     ...
     a12:	a4a50513          	addi	a0,a0,-1462 # 8458 <schedule_dm+0x5f0>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     a32:	c4a50513          	addi	a0,a0,-950 # 8678 <schedule_dm+0x810>
  ...
  if(n >= 0){
    ...
    printf("read(fd, %p, 10) returned %d, not -1\n", a+4096, n);
     ...
     a88:	c3c50513          	addi	a0,a0,-964 # 86c0 <schedule_dm+0x858>
...
truncate1(char *s)
{
  ...
  write(fd1, "abcd", 4);
     ...
     af6:	c0658593          	addi	a1,a1,-1018 # 86f8 <schedule_dm+0x890>
     afa:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     b18:	bd450513          	addi	a0,a0,-1068 # 86e8 <schedule_dm+0x880>
  ...
  if(n != 4){
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     b64:	ba050513          	addi	a0,a0,-1120 # 8700 <schedule_dm+0x898>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     b82:	b6a50513          	addi	a0,a0,-1174 # 86e8 <schedule_dm+0x880>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     b9a:	b5250513          	addi	a0,a0,-1198 # 86e8 <schedule_dm+0x880>
  ...
  if(n != 0){
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     bdc:	b4850513          	addi	a0,a0,-1208 # 8720 <schedule_dm+0x8b8>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     bf6:	b3e50513          	addi	a0,a0,-1218 # 8730 <schedule_dm+0x8c8>
  ...
  if(n != 0){
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     c3c:	b1850513          	addi	a0,a0,-1256 # 8750 <schedule_dm+0x8e8>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     c56:	ade50513          	addi	a0,a0,-1314 # 8730 <schedule_dm+0x8c8>
  ...
  write(fd1, "abcdef", 6);
     ...
     c76:	aee58593          	addi	a1,a1,-1298 # 8760 <schedule_dm+0x8f8>
     c7a:	853e                	mv	a0,a5
  ...
  if(n != 6){
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     cbe:	aae50513          	addi	a0,a0,-1362 # 8768 <schedule_dm+0x900>
  ...
  if(n != 2){
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     d0e:	a7e50513          	addi	a0,a0,-1410 # 8788 <schedule_dm+0x920>
  ...
  unlink("truncfile");
     ...
     d28:	9c450513          	addi	a0,a0,-1596 # 86e8 <schedule_dm+0x880>
...
truncate2(char *s)
{
  ...
  unlink("truncfile");
     ...
     d78:	97450513          	addi	a0,a0,-1676 # 86e8 <schedule_dm+0x880>
  ...
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     ...
     d8c:	96050513          	addi	a0,a0,-1696 # 86e8 <schedule_dm+0x880>
  ...
  write(fd1, "abcd", 4);
     ...
     da8:	95458593          	addi	a1,a1,-1708 # 86f8 <schedule_dm+0x890>
     dac:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     ...
     dbe:	92e50513          	addi	a0,a0,-1746 # 86e8 <schedule_dm+0x880>
  ...
  int n = write(fd1, "x", 1);
     ...
     dda:	6d258593          	addi	a1,a1,1746 # 84a8 <schedule_dm+0x640>
     dde:	853e                	mv	a0,a5
  ...
  if(n != -1){
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     e0a:	9a250513          	addi	a0,a0,-1630 # 87a8 <schedule_dm+0x940>
  ...
  unlink("truncfile");
     ...
     e24:	8c850513          	addi	a0,a0,-1848 # 86e8 <schedule_dm+0x880>
...
truncate3(char *s)
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     e6a:	88250513          	addi	a0,a0,-1918 # 86e8 <schedule_dm+0x880>
  ...
  if(pid < 0){
    ...
    printf("%s: fork failed\n", s);
     ...
     ea2:	93250513          	addi	a0,a0,-1742 # 87d0 <schedule_dm+0x968>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < 100; i++){
     ...
     ece:	81e50513          	addi	a0,a0,-2018 # 86e8 <schedule_dm+0x880>
     ...
     ef2:	8fa50513          	addi	a0,a0,-1798 # 87e8 <schedule_dm+0x980>
     ...
     f12:	8f258593          	addi	a1,a1,-1806 # 8800 <schedule_dm+0x998>
     f16:	853e                	mv	a0,a5
     ...
     f42:	8d250513          	addi	a0,a0,-1838 # 8810 <schedule_dm+0x9a8>
     ...
     f6c:	78050513          	addi	a0,a0,1920 # 86e8 <schedule_dm+0x880>
  ...
  for(int i = 0; i < 150; i++){
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     fd6:	71650513          	addi	a0,a0,1814 # 86e8 <schedule_dm+0x880>
    ...
    if(fd < 0){
     ...
     ffa:	7f250513          	addi	a0,a0,2034 # 87e8 <schedule_dm+0x980>
    ...
    101a:	81a58593          	addi	a1,a1,-2022 # 8830 <schedule_dm+0x9c8>
    101e:	853e                	mv	a0,a5
    ...
    104a:	7f250513          	addi	a0,a0,2034 # 8838 <schedule_dm+0x9d0>
  ...
  unlink("truncfile");
    ...
    109a:	65250513          	addi	a0,a0,1618 # 86e8 <schedule_dm+0x880>
...
iputtest(char *s)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    10c4:	79850513          	addi	a0,a0,1944 # 8858 <schedule_dm+0x9f0>
    ...
    10de:	78650513          	addi	a0,a0,1926 # 8860 <schedule_dm+0x9f8>
  ...
  if(chdir("iputdir") < 0){
    ...
    10f8:	76450513          	addi	a0,a0,1892 # 8858 <schedule_dm+0x9f0>
    ...
    1112:	76a50513          	addi	a0,a0,1898 # 8878 <schedule_dm+0xa10>
  ...
  if(unlink("../iputdir") < 0){
    ...
    112c:	77050513          	addi	a0,a0,1904 # 8898 <schedule_dm+0xa30>
    ...
    1146:	76650513          	addi	a0,a0,1894 # 88a8 <schedule_dm+0xa40>
  ...
  if(chdir("/") < 0){
    ...
    1160:	76c50513          	addi	a0,a0,1900 # 88c8 <schedule_dm+0xa60>
    ...
    117a:	75a50513          	addi	a0,a0,1882 # 88d0 <schedule_dm+0xa68>
...
exitiputtest(char *s)
{
  ...
  if(pid < 0){
    ...
    11c6:	60e50513          	addi	a0,a0,1550 # 87d0 <schedule_dm+0x968>
  ...
  if(pid == 0){
    ...
    11e8:	67450513          	addi	a0,a0,1652 # 8858 <schedule_dm+0x9f0>
    ...
    1202:	66250513          	addi	a0,a0,1634 # 8860 <schedule_dm+0x9f8>
    ...
    121c:	64050513          	addi	a0,a0,1600 # 8858 <schedule_dm+0x9f0>
    ...
    1236:	6b650513          	addi	a0,a0,1718 # 88e8 <schedule_dm+0xa80>
    ...
    1250:	64c50513          	addi	a0,a0,1612 # 8898 <schedule_dm+0xa30>
    ...
    126a:	64250513          	addi	a0,a0,1602 # 88a8 <schedule_dm+0xa40>
...
openiputtest(char *s)
{
  ...
  if(mkdir("oidir") < 0){
    ...
    12b6:	64e50513          	addi	a0,a0,1614 # 8900 <schedule_dm+0xa98>
    ...
    12d0:	63c50513          	addi	a0,a0,1596 # 8908 <schedule_dm+0xaa0>
  ...
  if(pid < 0){
    ...
    1306:	4ce50513          	addi	a0,a0,1230 # 87d0 <schedule_dm+0x968>
  ...
  if(pid == 0){
    ...
    132a:	5da50513          	addi	a0,a0,1498 # 8900 <schedule_dm+0xa98>
    ...
    134e:	5d650513          	addi	a0,a0,1494 # 8920 <schedule_dm+0xab8>
  ...
  if(unlink("oidir") != 0){
    ...
    137c:	58850513          	addi	a0,a0,1416 # 8900 <schedule_dm+0xa98>
    ...
    1394:	5b850513          	addi	a0,a0,1464 # 8948 <schedule_dm+0xae0>
...
opentest(char *s)
{
  ...
  fd = open("echo", 0);
    ...
    13d8:	1e450513          	addi	a0,a0,484 # 85b8 <schedule_dm+0x750>
  ...
  if(fd < 0){
    ...
    13fc:	56850513          	addi	a0,a0,1384 # 8960 <schedule_dm+0xaf8>
  ...
  fd = open("doesnotexist", 0);
    ...
    1426:	55650513          	addi	a0,a0,1366 # 8978 <schedule_dm+0xb10>
  ...
  if(fd >= 0){
    ...
    144a:	54250513          	addi	a0,a0,1346 # 8988 <schedule_dm+0xb20>
...
writetest(char *s)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    147e:	53650513          	addi	a0,a0,1334 # 89b0 <schedule_dm+0xb48>
  ...
  if(fd < 0){
    ...
    14a2:	51a50513          	addi	a0,a0,1306 # 89b8 <schedule_dm+0xb50>
  ...
  for(i = 0; i < N; i++){
    ...
    14c8:	51458593          	addi	a1,a1,1300 # 89d8 <schedule_dm+0xb70>
    14cc:	853e                	mv	a0,a5
    ...
    14ee:	4fe50513          	addi	a0,a0,1278 # 89e8 <schedule_dm+0xb80>
    ...
    150e:	50658593          	addi	a1,a1,1286 # 8a10 <schedule_dm+0xba8>
    1512:	853e                	mv	a0,a5
    ...
    1534:	4f050513          	addi	a0,a0,1264 # 8a20 <schedule_dm+0xbb8>
  ...
  fd = open("small", O_RDONLY);
    ...
    1578:	43c50513          	addi	a0,a0,1084 # 89b0 <schedule_dm+0xb48>
  ...
  if(fd < 0){
    ...
    159c:	4b050513          	addi	a0,a0,1200 # 8a48 <schedule_dm+0xbe0>
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    15be:	28e58593          	addi	a1,a1,654 # a848 <buf>
    15c2:	853e                	mv	a0,a5
  ...
  if(i != N*SZ*2){
    ...
    15ea:	48250513          	addi	a0,a0,1154 # 8a68 <schedule_dm+0xc00>
  ...
  if(unlink("small") < 0){
    ...
    1612:	3a250513          	addi	a0,a0,930 # 89b0 <schedule_dm+0xb48>
    ...
    162c:	45850513          	addi	a0,a0,1112 # 8a80 <schedule_dm+0xc18>
...
writebig(char *s)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    1660:	44450513          	addi	a0,a0,1092 # 8aa0 <schedule_dm+0xc38>
  ...
  if(fd < 0){
    ...
    1684:	42850513          	addi	a0,a0,1064 # 8aa8 <schedule_dm+0xc40>
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	1a878793          	addi	a5,a5,424 # a848 <buf>
    ...
    16ba:	19258593          	addi	a1,a1,402 # a848 <buf>
    16be:	853e                	mv	a0,a5
    ...
    16e2:	3ea50513          	addi	a0,a0,1002 # 8ac8 <schedule_dm+0xc60>
  ...
  fd = open("big", O_RDONLY);
    ...
    1726:	37e50513          	addi	a0,a0,894 # 8aa0 <schedule_dm+0xc38>
  ...
  if(fd < 0){
    ...
    174a:	3aa50513          	addi	a0,a0,938 # 8af0 <schedule_dm+0xc88>
  ...
  for(;;){
    ...
    1770:	0dc58593          	addi	a1,a1,220 # a848 <buf>
    1774:	853e                	mv	a0,a5
    ...
    17aa:	36a50513          	addi	a0,a0,874 # 8b10 <schedule_dm+0xca8>
    ...
    17de:	35e50513          	addi	a0,a0,862 # 8b38 <schedule_dm+0xcd0>
    ...
    17f8:	05478793          	addi	a5,a5,84 # a848 <buf>
    ...
    180c:	04078793          	addi	a5,a5,64 # a848 <buf>
      printf("%s: read content of block %d is %d\n", s,
    ...
    1822:	33250513          	addi	a0,a0,818 # 8b50 <schedule_dm+0xce8>
  ...
  if(unlink("big") < 0){
    ...
    1858:	24c50513          	addi	a0,a0,588 # 8aa0 <schedule_dm+0xc38>
    ...
    1872:	30a50513          	addi	a0,a0,778 # 8b78 <schedule_dm+0xd10>
...
void dirtest(char *s)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    196e:	22650513          	addi	a0,a0,550 # 8b90 <schedule_dm+0xd28>
    ...
    1988:	edc50513          	addi	a0,a0,-292 # 8860 <schedule_dm+0x9f8>
  ...
  if(chdir("dir0") < 0){
    ...
    19a2:	1f250513          	addi	a0,a0,498 # 8b90 <schedule_dm+0xd28>
    ...
    19bc:	1e050513          	addi	a0,a0,480 # 8b98 <schedule_dm+0xd30>
  ...
  if(chdir("..") < 0){
    ...
    19d6:	1de50513          	addi	a0,a0,478 # 8bb0 <schedule_dm+0xd48>
    ...
    19f0:	1cc50513          	addi	a0,a0,460 # 8bb8 <schedule_dm+0xd50>
  ...
  if(unlink("dir0") < 0){
    ...
    1a0a:	18a50513          	addi	a0,a0,394 # 8b90 <schedule_dm+0xd28>
    ...
    1a24:	1b050513          	addi	a0,a0,432 # 8bd0 <schedule_dm+0xd68>
...
exectest(char *s)
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1a54:	b6878793          	addi	a5,a5,-1176 # 85b8 <schedule_dm+0x750>
    1a58:	fcf43423          	sd	a5,-56(s0)
    1a5c:	00007797          	auipc	a5,0x7
    1a60:	18c78793          	addi	a5,a5,396 # 8be8 <schedule_dm+0xd80>
  ...
  unlink("echo-ok");
    ...
    1a70:	18450513          	addi	a0,a0,388 # 8bf0 <schedule_dm+0xd88>
  ...
  if(pid < 0) {
    ...
    1a9c:	d3850513          	addi	a0,a0,-712 # 87d0 <schedule_dm+0x968>
  ...
  if(pid == 0) {
    ...
    1acc:	12850513          	addi	a0,a0,296 # 8bf0 <schedule_dm+0xd88>
    ...
    1af0:	10c50513          	addi	a0,a0,268 # 8bf8 <schedule_dm+0xd90>
    ...
    1b1c:	0f850513          	addi	a0,a0,248 # 8c10 <schedule_dm+0xda8>
    ...
    1b3c:	a8050513          	addi	a0,a0,-1408 # 85b8 <schedule_dm+0x750>
    ...
    1b56:	0ce50513          	addi	a0,a0,206 # 8c20 <schedule_dm+0xdb8>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1b90:	0ac50513          	addi	a0,a0,172 # 8c38 <schedule_dm+0xdd0>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1bb6:	03e50513          	addi	a0,a0,62 # 8bf0 <schedule_dm+0xd88>
  ...
  if(fd < 0) {
    ...
    1bda:	c1250513          	addi	a0,a0,-1006 # 87e8 <schedule_dm+0x980>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1c18:	e5450513          	addi	a0,a0,-428 # 8a68 <schedule_dm+0xc00>
  ...
  unlink("echo-ok");
    ...
    1c32:	fc250513          	addi	a0,a0,-62 # 8bf0 <schedule_dm+0xd88>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1c6c:	fe850513          	addi	a0,a0,-24 # 8c50 <schedule_dm+0xde8>
...
pipe1(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    1ca8:	fc450513          	addi	a0,a0,-60 # 8c68 <schedule_dm+0xe00>
  ...
  if(pid == 0){
    ...
    1d06:	b4668693          	addi	a3,a3,-1210 # a848 <buf>
    ...
    1d3a:	b1258593          	addi	a1,a1,-1262 # a848 <buf>
    1d3e:	853e                	mv	a0,a5
    ...
    1d5c:	f2850513          	addi	a0,a0,-216 # 8c80 <schedule_dm+0xe18>
    ...
    1dc2:	a8a70713          	addi	a4,a4,-1398 # a848 <buf>
    ...
    1df4:	ea850513          	addi	a0,a0,-344 # 8c98 <schedule_dm+0xe30>
    ...
    1e56:	9f658593          	addi	a1,a1,-1546 # a848 <buf>
    1e5a:	853e                	mv	a0,a5
    ...
    1e90:	e2450513          	addi	a0,a0,-476 # 8cb0 <schedule_dm+0xe48>
    ...
    1ed8:	dfc50513          	addi	a0,a0,-516 # 8cd0 <schedule_dm+0xe68>
...
preempt(char *s)
{
  ...
  if(pid1 < 0) {
    ...
    1f22:	dca50513          	addi	a0,a0,-566 # 8ce8 <schedule_dm+0xe80>
  ...
  if(pid2 < 0) {
    ...
    1f62:	87250513          	addi	a0,a0,-1934 # 87d0 <schedule_dm+0x968>
  ...
  if(pid3 < 0) {
    ...
    1fb0:	82450513          	addi	a0,a0,-2012 # 87d0 <schedule_dm+0x968>
  ...
  if(pid3 == 0){
    ...
    1fe6:	4c658593          	addi	a1,a1,1222 # 84a8 <schedule_dm+0x640>
    1fea:	853e                	mv	a0,a5
    ...
    2006:	cf650513          	addi	a0,a0,-778 # 8cf8 <schedule_dm+0xe90>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    203a:	81258593          	addi	a1,a1,-2030 # a848 <buf>
    203e:	853e                	mv	a0,a5
    ...
    205a:	cba50513          	addi	a0,a0,-838 # 8d10 <schedule_dm+0xea8>
  ...
  printf("kill... ");
    ...
    207a:	cb250513          	addi	a0,a0,-846 # 8d28 <schedule_dm+0xec0>
  ...
  printf("wait... ");
    ...
    20b4:	c8850513          	addi	a0,a0,-888 # 8d38 <schedule_dm+0xed0>
...
exitwait(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    2118:	6bc50513          	addi	a0,a0,1724 # 87d0 <schedule_dm+0x968>
    ...
    215a:	bf250513          	addi	a0,a0,-1038 # 8d48 <schedule_dm+0xee0>
    ...
    2186:	bde50513          	addi	a0,a0,-1058 # 8d60 <schedule_dm+0xef8>
...
reparent(char *s)
{
  ...
  for(int i = 0; i < 200; i++){
    ...
    2210:	5c450513          	addi	a0,a0,1476 # 87d0 <schedule_dm+0x968>
    ...
    224e:	afe50513          	addi	a0,a0,-1282 # 8d48 <schedule_dm+0xee0>
...
twochildren(char *s)
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    22f4:	4e050513          	addi	a0,a0,1248 # 87d0 <schedule_dm+0x968>
    ...
    233c:	49850513          	addi	a0,a0,1176 # 87d0 <schedule_dm+0x968>
...
forkfork(char *s)
{
  ...
  for(int i = 0; i < N; i++){
    ...
    23d0:	91c50513          	addi	a0,a0,-1764 # 8ce8 <schedule_dm+0xe80>
  ...
  for(int i = 0; i < N; i++){
    ...
    2490:	8f450513          	addi	a0,a0,-1804 # 8d80 <schedule_dm+0xf18>
...
forkforkfork(char *s)
{
  ...
  unlink("stopforking");
    ...
    24da:	8ca50513          	addi	a0,a0,-1846 # 8da0 <schedule_dm+0xf38>
  ...
  if(pid < 0){
    ...
    2506:	7e650513          	addi	a0,a0,2022 # 8ce8 <schedule_dm+0xe80>
  ...
  if(pid == 0){
    ...
    252a:	87a50513          	addi	a0,a0,-1926 # 8da0 <schedule_dm+0xf38>
    ...
    2566:	83e50513          	addi	a0,a0,-1986 # 8da0 <schedule_dm+0xf38>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    2592:	81250513          	addi	a0,a0,-2030 # 8da0 <schedule_dm+0xf38>
...
reparent2(char *s)
{
  ...
  for(int i = 0; i < 800; i++){
    ...
    25f6:	fb650513          	addi	a0,a0,-74 # 85a8 <schedule_dm+0x740>
...
mem(char *s)
{
  ...
  if((pid = fork()) == 0){
    ...
    26f0:	6c450513          	addi	a0,a0,1732 # 8db0 <schedule_dm+0xf48>
...
sharedfd(char *s)
{
  ...
  if(fd < 0){
    ...
    2796:	63e50513          	addi	a0,a0,1598 # 8dd0 <schedule_dm+0xf68>
  ...
  for(i = 0; i < N; i++){
    ...
    280c:	5f050513          	addi	a0,a0,1520 # 8df8 <schedule_dm+0xf90>
  ...
  fd = open("sharedfd", 0);
    ...
    2884:	99050513          	addi	a0,a0,-1648 # 8210 <schedule_dm+0x3a8>
  ...
  if(fd < 0){
    ...
    28a8:	57450513          	addi	a0,a0,1396 # 8e18 <schedule_dm+0xfb0>
  ...
  unlink("sharedfd");
    ...
    2964:	8b050513          	addi	a0,a0,-1872 # 8210 <schedule_dm+0x3a8>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    29a6:	49e50513          	addi	a0,a0,1182 # 8e40 <schedule_dm+0xfd8>
...
fourfiles(char *s)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    29cc:	4e078793          	addi	a5,a5,1248 # 8ea8 <schedule_dm+0x1040>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2a2e:	b7e50513          	addi	a0,a0,-1154 # 85a8 <schedule_dm+0x740>
    ...
    2a74:	3e850513          	addi	a0,a0,1000 # 8e58 <schedule_dm+0xff0>
    ...
    2a9e:	dae50513          	addi	a0,a0,-594 # a848 <buf>
    ...
    2abc:	d9058593          	addi	a1,a1,-624 # a848 <buf>
    2ac0:	853e                	mv	a0,a5
    ...
    2aea:	38250513          	addi	a0,a0,898 # 8e68 <schedule_dm+0x1000>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2bb8:	c9470713          	addi	a4,a4,-876 # a848 <buf>
    ...
    2be0:	2a450513          	addi	a0,a0,676 # 8e80 <schedule_dm+0x1018>
    ...
    2c28:	c2458593          	addi	a1,a1,-988 # a848 <buf>
    2c2c:	853e                	mv	a0,a5
    ...
    2c70:	22450513          	addi	a0,a0,548 # 8e90 <schedule_dm+0x1028>
...
createdelete(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2ce8:	8c450513          	addi	a0,a0,-1852 # 85a8 <schedule_dm+0x740>
    ...
    2d64:	e9850513          	addi	a0,a0,-360 # 8bf8 <schedule_dm+0xd90>
    ...
    2dd8:	b7450513          	addi	a0,a0,-1164 # 8948 <schedule_dm+0xae0>
  ...
  for(i = 0; i < N; i++){
    ...
    2ef0:	fdc50513          	addi	a0,a0,-36 # 8ec8 <schedule_dm+0x1060>
    ...
    2f36:	fbe50513          	addi	a0,a0,-66 # 8ef0 <schedule_dm+0x1088>
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3026:	1b650513          	addi	a0,a0,438 # 81d8 <schedule_dm+0x370>
  ...
  if(fd < 0){
    ...
    304a:	ed250513          	addi	a0,a0,-302 # 8f18 <schedule_dm+0x10b0>
  ...
  write(fd, "hello", SZ);
    ...
    306a:	ed258593          	addi	a1,a1,-302 # 8f38 <schedule_dm+0x10d0>
    306e:	853e                	mv	a0,a5
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    308c:	15050513          	addi	a0,a0,336 # 81d8 <schedule_dm+0x370>
  ...
  if(fd < 0){
    ...
    30b0:	e9450513          	addi	a0,a0,-364 # 8f40 <schedule_dm+0x10d8>
  ...
  if(unlink("unlinkread") != 0){
    ...
    30ca:	11250513          	addi	a0,a0,274 # 81d8 <schedule_dm+0x370>
    ...
    30e2:	e8250513          	addi	a0,a0,-382 # 8f60 <schedule_dm+0x10f8>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3100:	0dc50513          	addi	a0,a0,220 # 81d8 <schedule_dm+0x370>
  ...
  write(fd1, "yyy", 3);
    ...
    311c:	e6858593          	addi	a1,a1,-408 # 8f80 <schedule_dm+0x1118>
    3120:	853e                	mv	a0,a5
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3142:	70a58593          	addi	a1,a1,1802 # a848 <buf>
    3146:	853e                	mv	a0,a5
    ...
    3162:	e2a50513          	addi	a0,a0,-470 # 8f88 <schedule_dm+0x1120>
  ...
  if(buf[0] != 'h'){
    ...
    317c:	6d078793          	addi	a5,a5,1744 # a848 <buf>
    ...
    3196:	e1650513          	addi	a0,a0,-490 # 8fa8 <schedule_dm+0x1140>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    31b6:	69658593          	addi	a1,a1,1686 # a848 <buf>
    31ba:	853e                	mv	a0,a5
    ...
    31d6:	df650513          	addi	a0,a0,-522 # 8fc8 <schedule_dm+0x1160>
  ...
  unlink("unlinkread");
    ...
    31fe:	fde50513          	addi	a0,a0,-34 # 81d8 <schedule_dm+0x370>
...
linktest(char *s)
{
  ...
  unlink("lf1");
    ...
    3224:	dc850513          	addi	a0,a0,-568 # 8fe8 <schedule_dm+0x1180>
    3228:	00004097          	auipc	ra,0x4
    322c:	ea2080e7          	jalr	-350(ra) # 70ca <unlink>
  unlink("lf2");
    3230:	00006517          	auipc	a0,0x6
    3234:	dc050513          	addi	a0,a0,-576 # 8ff0 <schedule_dm+0x1188>
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    3248:	da450513          	addi	a0,a0,-604 # 8fe8 <schedule_dm+0x1180>
  ...
  if(fd < 0){
    ...
    326c:	d9050513          	addi	a0,a0,-624 # 8ff8 <schedule_dm+0x1190>
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    328c:	cb058593          	addi	a1,a1,-848 # 8f38 <schedule_dm+0x10d0>
    3290:	853e                	mv	a0,a5
    ...
    32ac:	d6850513          	addi	a0,a0,-664 # 9010 <schedule_dm+0x11a8>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    32d4:	d2058593          	addi	a1,a1,-736 # 8ff0 <schedule_dm+0x1188>
    32d8:	00006517          	auipc	a0,0x6
    32dc:	d1050513          	addi	a0,a0,-752 # 8fe8 <schedule_dm+0x1180>
    ...
    32f6:	d3650513          	addi	a0,a0,-714 # 9028 <schedule_dm+0x11c0>
  ...
  unlink("lf1");
    ...
    3310:	cdc50513          	addi	a0,a0,-804 # 8fe8 <schedule_dm+0x1180>
  ...
  if(open("lf1", 0) >= 0){
    ...
    3322:	cca50513          	addi	a0,a0,-822 # 8fe8 <schedule_dm+0x1180>
    ...
    333c:	d1050513          	addi	a0,a0,-752 # 9048 <schedule_dm+0x11e0>
  ...
  fd = open("lf2", 0);
    ...
    3358:	c9c50513          	addi	a0,a0,-868 # 8ff0 <schedule_dm+0x1188>
  ...
  if(fd < 0){
    ...
    337c:	d0050513          	addi	a0,a0,-768 # 9078 <schedule_dm+0x1210>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    339c:	4b058593          	addi	a1,a1,1200 # a848 <buf>
    33a0:	853e                	mv	a0,a5
    ...
    33bc:	cd850513          	addi	a0,a0,-808 # 9090 <schedule_dm+0x1228>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    33e4:	c1058593          	addi	a1,a1,-1008 # 8ff0 <schedule_dm+0x1188>
    33e8:	00006517          	auipc	a0,0x6
    33ec:	c0850513          	addi	a0,a0,-1016 # 8ff0 <schedule_dm+0x1188>
    ...
    3406:	ca650513          	addi	a0,a0,-858 # 90a8 <schedule_dm+0x1240>
  ...
  unlink("lf2");
    ...
    3420:	bd450513          	addi	a0,a0,-1068 # 8ff0 <schedule_dm+0x1188>
    3424:	00004097          	auipc	ra,0x4
    3428:	ca6080e7          	jalr	-858(ra) # 70ca <unlink>
  if(link("lf2", "lf1") >= 0){
    342c:	00006597          	auipc	a1,0x6
    3430:	bbc58593          	addi	a1,a1,-1092 # 8fe8 <schedule_dm+0x1180>
    3434:	00006517          	auipc	a0,0x6
    3438:	bbc50513          	addi	a0,a0,-1092 # 8ff0 <schedule_dm+0x1188>
    ...
    3452:	c8250513          	addi	a0,a0,-894 # 90d0 <schedule_dm+0x1268>
  ...
  if(link(".", "lf1") >= 0){
    ...
    346c:	b8058593          	addi	a1,a1,-1152 # 8fe8 <schedule_dm+0x1180>
    3470:	00006517          	auipc	a0,0x6
    3474:	c8850513          	addi	a0,a0,-888 # 90f8 <schedule_dm+0x1290>
    ...
    348e:	c7650513          	addi	a0,a0,-906 # 9100 <schedule_dm+0x1298>
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    3522:	c0250513          	addi	a0,a0,-1022 # 9120 <schedule_dm+0x12b8>
    ...
    3556:	bce50513          	addi	a0,a0,-1074 # 9120 <schedule_dm+0x12b8>
    ...
    3590:	b9c50513          	addi	a0,a0,-1124 # 9128 <schedule_dm+0x12c0>
  ...
  fd = open(".", 0);
    ...
    3618:	ae450513          	addi	a0,a0,-1308 # 90f8 <schedule_dm+0x1290>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3682:	aca50513          	addi	a0,a0,-1334 # 9148 <schedule_dm+0x12e0>
    ...
    36b8:	ab450513          	addi	a0,a0,-1356 # 9168 <schedule_dm+0x1300>
  ...
  if(n != N){
    ...
    372a:	a6a50513          	addi	a0,a0,-1430 # 9190 <schedule_dm+0x1328>
  ...
  for(i = 0; i < N; i++){
    ...
    377a:	05a50513          	addi	a0,a0,90 # 87d0 <schedule_dm+0x968>
...
linkunlink(char *s)
{
  ...
  unlink("x");
    ...
    3912:	b9a50513          	addi	a0,a0,-1126 # 84a8 <schedule_dm+0x640>
  ...
  if(pid < 0){
    ...
    393e:	e9650513          	addi	a0,a0,-362 # 87d0 <schedule_dm+0x968>
  ...
  for(i = 0; i < 100; i++){
    ...
    39a4:	b0850513          	addi	a0,a0,-1272 # 84a8 <schedule_dm+0x640>
    ...
    39d6:	ad658593          	addi	a1,a1,-1322 # 84a8 <schedule_dm+0x640>
    39da:	00005517          	auipc	a0,0x5
    39de:	7ee50513          	addi	a0,a0,2030 # 91c8 <schedule_dm+0x1360>
    ...
    39f0:	abc50513          	addi	a0,a0,-1348 # 84a8 <schedule_dm+0x640>
...
bigdir(char *s)
{
  ...
  unlink("bd");
    ...
    3a4c:	78850513          	addi	a0,a0,1928 # 91d0 <schedule_dm+0x1368>
  ...
  fd = open("bd", O_CREATE);
    ...
    3a60:	77450513          	addi	a0,a0,1908 # 91d0 <schedule_dm+0x1368>
  ...
  if(fd < 0){
    ...
    3a84:	75850513          	addi	a0,a0,1880 # 91d8 <schedule_dm+0x1370>
  ...
  for(i = 0; i < N; i++){
    ...
    3b10:	6c450513          	addi	a0,a0,1732 # 91d0 <schedule_dm+0x1368>
    ...
    3b2e:	6ce50513          	addi	a0,a0,1742 # 91f8 <schedule_dm+0x1390>
  ...
  unlink("bd");
    ...
    3b62:	67250513          	addi	a0,a0,1650 # 91d0 <schedule_dm+0x1368>
  ...
  for(i = 0; i < N; i++){
    ...
    3be6:	63650513          	addi	a0,a0,1590 # 9218 <schedule_dm+0x13b0>
...
subdir(char *s)
{
  ...
  unlink("ff");
    ...
    3c32:	60a50513          	addi	a0,a0,1546 # 9238 <schedule_dm+0x13d0>
    3c36:	00003097          	auipc	ra,0x3
    3c3a:	494080e7          	jalr	1172(ra) # 70ca <unlink>
  if(mkdir("dd") != 0){
    3c3e:	00005517          	auipc	a0,0x5
    3c42:	60250513          	addi	a0,a0,1538 # 9240 <schedule_dm+0x13d8>
    ...
    3c5a:	5f250513          	addi	a0,a0,1522 # 9248 <schedule_dm+0x13e0>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3c78:	5ec50513          	addi	a0,a0,1516 # 9260 <schedule_dm+0x13f8>
  ...
  if(fd < 0){
    ...
    3c9c:	5d050513          	addi	a0,a0,1488 # 9268 <schedule_dm+0x1400>
  ...
  write(fd, "ff", 2);
    ...
    3cbc:	58058593          	addi	a1,a1,1408 # 9238 <schedule_dm+0x13d0>
    3cc0:	853e                	mv	a0,a5
  ...
  if(unlink("dd") >= 0){
    ...
    3cdc:	56850513          	addi	a0,a0,1384 # 9240 <schedule_dm+0x13d8>
    ...
    3cf6:	59650513          	addi	a0,a0,1430 # 9288 <schedule_dm+0x1420>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3d10:	5ac50513          	addi	a0,a0,1452 # 92b8 <schedule_dm+0x1450>
    ...
    3d28:	59c50513          	addi	a0,a0,1436 # 92c0 <schedule_dm+0x1458>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3d46:	59e50513          	addi	a0,a0,1438 # 92e0 <schedule_dm+0x1478>
  ...
  if(fd < 0){
    ...
    3d6a:	58a50513          	addi	a0,a0,1418 # 92f0 <schedule_dm+0x1488>
  ...
  write(fd, "FF", 2);
    ...
    3d8a:	58a58593          	addi	a1,a1,1418 # 9310 <schedule_dm+0x14a8>
    3d8e:	853e                	mv	a0,a5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3dac:	57050513          	addi	a0,a0,1392 # 9318 <schedule_dm+0x14b0>
  ...
  if(fd < 0){
    ...
    3dd0:	55c50513          	addi	a0,a0,1372 # 9328 <schedule_dm+0x14c0>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3df0:	a5c58593          	addi	a1,a1,-1444 # a848 <buf>
    3df4:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3e16:	a3678793          	addi	a5,a5,-1482 # a848 <buf>
    ...
    3e30:	51c50513          	addi	a0,a0,1308 # 9348 <schedule_dm+0x14e0>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3e58:	51458593          	addi	a1,a1,1300 # 9368 <schedule_dm+0x1500>
    3e5c:	00005517          	auipc	a0,0x5
    3e60:	48450513          	addi	a0,a0,1156 # 92e0 <schedule_dm+0x1478>
    ...
    3e78:	50450513          	addi	a0,a0,1284 # 9378 <schedule_dm+0x1510>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3e92:	45250513          	addi	a0,a0,1106 # 92e0 <schedule_dm+0x1478>
    ...
    3eaa:	4fa50513          	addi	a0,a0,1274 # 93a0 <schedule_dm+0x1538>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3ec6:	41e50513          	addi	a0,a0,1054 # 92e0 <schedule_dm+0x1478>
    ...
    3ee0:	4e450513          	addi	a0,a0,1252 # 93c0 <schedule_dm+0x1558>
  ...
  if(chdir("dd") != 0){
    ...
    3efa:	34a50513          	addi	a0,a0,842 # 9240 <schedule_dm+0x13d8>
    ...
    3f12:	4da50513          	addi	a0,a0,1242 # 93e8 <schedule_dm+0x1580>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3f2c:	4d850513          	addi	a0,a0,1240 # 9400 <schedule_dm+0x1598>
    ...
    3f44:	4d050513          	addi	a0,a0,1232 # 9410 <schedule_dm+0x15a8>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3f5e:	4d650513          	addi	a0,a0,1238 # 9430 <schedule_dm+0x15c8>
    ...
    3f76:	4ce50513          	addi	a0,a0,1230 # 9440 <schedule_dm+0x15d8>
  ...
  if(chdir("./..") != 0){
    ...
    3f90:	4d450513          	addi	a0,a0,1236 # 9460 <schedule_dm+0x15f8>
    ...
    3fa8:	4c450513          	addi	a0,a0,1220 # 9468 <schedule_dm+0x1600>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3fc4:	3a850513          	addi	a0,a0,936 # 9368 <schedule_dm+0x1500>
  ...
  if(fd < 0){
    ...
    3fe8:	49c50513          	addi	a0,a0,1180 # 9480 <schedule_dm+0x1618>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    4008:	84458593          	addi	a1,a1,-1980 # a848 <buf>
    400c:	853e                	mv	a0,a5
    ...
    4028:	47c50513          	addi	a0,a0,1148 # 94a0 <schedule_dm+0x1638>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    4052:	29250513          	addi	a0,a0,658 # 92e0 <schedule_dm+0x1478>
    ...
    406c:	45850513          	addi	a0,a0,1112 # 94c0 <schedule_dm+0x1658>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    408a:	46a50513          	addi	a0,a0,1130 # 94f0 <schedule_dm+0x1688>
    ...
    40a4:	46050513          	addi	a0,a0,1120 # 9500 <schedule_dm+0x1698>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    40c2:	46250513          	addi	a0,a0,1122 # 9520 <schedule_dm+0x16b8>
    ...
    40dc:	45850513          	addi	a0,a0,1112 # 9530 <schedule_dm+0x16c8>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    40fa:	14a50513          	addi	a0,a0,330 # 9240 <schedule_dm+0x13d8>
    ...
    4114:	44050513          	addi	a0,a0,1088 # 9550 <schedule_dm+0x16e8>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    4130:	11450513          	addi	a0,a0,276 # 9240 <schedule_dm+0x13d8>
    ...
    414a:	42a50513          	addi	a0,a0,1066 # 9570 <schedule_dm+0x1708>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    4166:	0de50513          	addi	a0,a0,222 # 9240 <schedule_dm+0x13d8>
    ...
    4180:	41450513          	addi	a0,a0,1044 # 9590 <schedule_dm+0x1728>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    419a:	41a58593          	addi	a1,a1,1050 # 95b0 <schedule_dm+0x1748>
    419e:	00005517          	auipc	a0,0x5
    41a2:	35250513          	addi	a0,a0,850 # 94f0 <schedule_dm+0x1688>
    ...
    41ba:	40a50513          	addi	a0,a0,1034 # 95c0 <schedule_dm+0x1758>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    41d4:	3e058593          	addi	a1,a1,992 # 95b0 <schedule_dm+0x1748>
    41d8:	00005517          	auipc	a0,0x5
    41dc:	34850513          	addi	a0,a0,840 # 9520 <schedule_dm+0x16b8>
    ...
    41f4:	3f850513          	addi	a0,a0,1016 # 95e8 <schedule_dm+0x1780>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    420e:	15e58593          	addi	a1,a1,350 # 9368 <schedule_dm+0x1500>
    4212:	00005517          	auipc	a0,0x5
    4216:	04e50513          	addi	a0,a0,78 # 9260 <schedule_dm+0x13f8>
    ...
    422e:	3e650513          	addi	a0,a0,998 # 9610 <schedule_dm+0x17a8>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    4248:	2ac50513          	addi	a0,a0,684 # 94f0 <schedule_dm+0x1688>
    ...
    4260:	3dc50513          	addi	a0,a0,988 # 9638 <schedule_dm+0x17d0>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    427a:	2aa50513          	addi	a0,a0,682 # 9520 <schedule_dm+0x16b8>
    ...
    4292:	3ca50513          	addi	a0,a0,970 # 9658 <schedule_dm+0x17f0>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    42ac:	0c050513          	addi	a0,a0,192 # 9368 <schedule_dm+0x1500>
    ...
    42c4:	3b850513          	addi	a0,a0,952 # 9678 <schedule_dm+0x1810>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    42de:	24650513          	addi	a0,a0,582 # 9520 <schedule_dm+0x16b8>
    ...
    42f6:	3ae50513          	addi	a0,a0,942 # 96a0 <schedule_dm+0x1838>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    4310:	1e450513          	addi	a0,a0,484 # 94f0 <schedule_dm+0x1688>
    ...
    4328:	39c50513          	addi	a0,a0,924 # 96c0 <schedule_dm+0x1858>
  ...
  if(chdir("dd/ff") == 0){
    ...
    4342:	f2250513          	addi	a0,a0,-222 # 9260 <schedule_dm+0x13f8>
    ...
    435a:	38a50513          	addi	a0,a0,906 # 96e0 <schedule_dm+0x1878>
  ...
  if(chdir("dd/xx") == 0){
    ...
    4374:	39050513          	addi	a0,a0,912 # 9700 <schedule_dm+0x1898>
    ...
    438c:	38050513          	addi	a0,a0,896 # 9708 <schedule_dm+0x18a0>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    43a6:	fc650513          	addi	a0,a0,-58 # 9368 <schedule_dm+0x1500>
    ...
    43be:	fe650513          	addi	a0,a0,-26 # 93a0 <schedule_dm+0x1538>
  ...
  if(unlink("dd/ff") != 0){
    ...
    43d8:	e8c50513          	addi	a0,a0,-372 # 9260 <schedule_dm+0x13f8>
    ...
    43f0:	33c50513          	addi	a0,a0,828 # 9728 <schedule_dm+0x18c0>
  ...
  if(unlink("dd") == 0){
    ...
    440a:	e3a50513          	addi	a0,a0,-454 # 9240 <schedule_dm+0x13d8>
    ...
    4422:	32a50513          	addi	a0,a0,810 # 9748 <schedule_dm+0x18e0>
  ...
  if(unlink("dd/dd") < 0){
    ...
    443c:	33850513          	addi	a0,a0,824 # 9770 <schedule_dm+0x1908>
    ...
    4456:	32650513          	addi	a0,a0,806 # 9778 <schedule_dm+0x1910>
  ...
  if(unlink("dd") < 0){
    ...
    4470:	dd450513          	addi	a0,a0,-556 # 9240 <schedule_dm+0x13d8>
    ...
    448a:	31250513          	addi	a0,a0,786 # 9798 <schedule_dm+0x1930>
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
    ...
    44ba:	d9250513          	addi	a0,a0,-622 # 8248 <schedule_dm+0x3e0>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    44d8:	d7450513          	addi	a0,a0,-652 # 8248 <schedule_dm+0x3e0>
    ...
    44fc:	2b850513          	addi	a0,a0,696 # 97b0 <schedule_dm+0x1948>
    ...
    4526:	32658593          	addi	a1,a1,806 # a848 <buf>
    452a:	853e                	mv	a0,a5
    ...
    455e:	27650513          	addi	a0,a0,630 # 97d0 <schedule_dm+0x1968>
    ...
    459e:	cae50513          	addi	a0,a0,-850 # 8248 <schedule_dm+0x3e0>
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    460a:	fa250513          	addi	a0,a0,-94 # 85a8 <schedule_dm+0x740>
    ...
    4694:	15850513          	addi	a0,a0,344 # 97e8 <schedule_dm+0x1980>
    ...
    46be:	18e58593          	addi	a1,a1,398 # a848 <buf>
    46c2:	853e                	mv	a0,a5
    ...
    46f6:	0de50513          	addi	a0,a0,222 # 97d0 <schedule_dm+0x1968>
...
bigfile(char *s)
{
  ...
  if(fd < 0){
    ...
    4826:	fee50513          	addi	a0,a0,-18 # 9810 <schedule_dm+0x19a8>
  ...
  for(i = 0; i < N; i++){
    ...
    4850:	ffc50513          	addi	a0,a0,-4 # a848 <buf>
    ...
    4868:	fe458593          	addi	a1,a1,-28 # a848 <buf>
    486c:	853e                	mv	a0,a5
    ...
    488a:	faa50513          	addi	a0,a0,-86 # 9830 <schedule_dm+0x19c8>
  ...
  fd = open("bigfile.dat", 0);
    ...
    48cc:	f3850513          	addi	a0,a0,-200 # 9800 <schedule_dm+0x1998>
  ...
  if(fd < 0){
    ...
    48f0:	f6450513          	addi	a0,a0,-156 # 9850 <schedule_dm+0x19e8>
  ...
  for(i = 0; ; i++){
    ...
    491a:	f3258593          	addi	a1,a1,-206 # a848 <buf>
    491e:	853e                	mv	a0,a5
    ...
    4940:	f3450513          	addi	a0,a0,-204 # 9870 <schedule_dm+0x1a08>
    ...
    4976:	f1e50513          	addi	a0,a0,-226 # 9890 <schedule_dm+0x1a28>
    ...
    4990:	ebc78793          	addi	a5,a5,-324 # a848 <buf>
    ...
    49b6:	e9678793          	addi	a5,a5,-362 # a848 <buf>
    ...
    49e0:	ecc50513          	addi	a0,a0,-308 # 98a8 <schedule_dm+0x1a40>
  ...
  if(total != N*SZ){
    ...
    4a3a:	e9250513          	addi	a0,a0,-366 # 98c8 <schedule_dm+0x1a60>
  ...
  unlink("bigfile.dat");
    ...
    4a54:	db050513          	addi	a0,a0,-592 # 9800 <schedule_dm+0x1998>
...
fourteen(char *s)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    4a7a:	e7250513          	addi	a0,a0,-398 # 98e8 <schedule_dm+0x1a80>
    ...
    4a92:	e6a50513          	addi	a0,a0,-406 # 98f8 <schedule_dm+0x1a90>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    4aac:	e7850513          	addi	a0,a0,-392 # 9920 <schedule_dm+0x1ab8>
    ...
    4ac4:	e8050513          	addi	a0,a0,-384 # 9940 <schedule_dm+0x1ad8>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    4ae2:	e9a50513          	addi	a0,a0,-358 # 9978 <schedule_dm+0x1b10>
  ...
  if(fd < 0){
    ...
    4b06:	ea650513          	addi	a0,a0,-346 # 99a8 <schedule_dm+0x1b40>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    4b30:	ec450513          	addi	a0,a0,-316 # 99f0 <schedule_dm+0x1b88>
  ...
  if(fd < 0){
    ...
    4b54:	ed050513          	addi	a0,a0,-304 # 9a20 <schedule_dm+0x1bb8>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    4b7c:	ee850513          	addi	a0,a0,-280 # 9a60 <schedule_dm+0x1bf8>
    ...
    4b94:	ef050513          	addi	a0,a0,-272 # 9a80 <schedule_dm+0x1c18>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    4bae:	f0e50513          	addi	a0,a0,-242 # 9ab8 <schedule_dm+0x1c50>
    ...
    4bc6:	f1650513          	addi	a0,a0,-234 # 9ad8 <schedule_dm+0x1c70>
...
rmdot(char *s)
{
  ...
  if(mkdir("dots") != 0){
    ...
    4c56:	ebe50513          	addi	a0,a0,-322 # 9b10 <schedule_dm+0x1ca8>
    ...
    4c6e:	eae50513          	addi	a0,a0,-338 # 9b18 <schedule_dm+0x1cb0>
  ...
  if(chdir("dots") != 0){
    ...
    4c88:	e8c50513          	addi	a0,a0,-372 # 9b10 <schedule_dm+0x1ca8>
    ...
    4ca0:	e9450513          	addi	a0,a0,-364 # 9b30 <schedule_dm+0x1cc8>
  ...
  if(unlink(".") == 0){
    ...
    4cba:	44250513          	addi	a0,a0,1090 # 90f8 <schedule_dm+0x1290>
    ...
    4cd2:	e7a50513          	addi	a0,a0,-390 # 9b48 <schedule_dm+0x1ce0>
  ...
  if(unlink("..") == 0){
    ...
    4cec:	ec850513          	addi	a0,a0,-312 # 8bb0 <schedule_dm+0xd48>
    ...
    4d04:	e6050513          	addi	a0,a0,-416 # 9b60 <schedule_dm+0x1cf8>
  ...
  if(chdir("/") != 0){
    ...
    4d1e:	bae50513          	addi	a0,a0,-1106 # 88c8 <schedule_dm+0xa60>
    ...
    4d36:	b9e50513          	addi	a0,a0,-1122 # 88d0 <schedule_dm+0xa68>
  ...
  if(unlink("dots/.") == 0){
    ...
    4d50:	e2c50513          	addi	a0,a0,-468 # 9b78 <schedule_dm+0x1d10>
    ...
    4d68:	e1c50513          	addi	a0,a0,-484 # 9b80 <schedule_dm+0x1d18>
  ...
  if(unlink("dots/..") == 0){
    ...
    4d82:	e2250513          	addi	a0,a0,-478 # 9ba0 <schedule_dm+0x1d38>
    ...
    4d9a:	e1250513          	addi	a0,a0,-494 # 9ba8 <schedule_dm+0x1d40>
  ...
  if(unlink("dots") != 0){
    ...
    4db4:	d6050513          	addi	a0,a0,-672 # 9b10 <schedule_dm+0x1ca8>
    ...
    4dcc:	e0050513          	addi	a0,a0,-512 # 9bc8 <schedule_dm+0x1d60>
...
dirfile(char *s)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4e00:	57450513          	addi	a0,a0,1396 # 8370 <schedule_dm+0x508>
  ...
  if(fd < 0){
    ...
    4e24:	dc850513          	addi	a0,a0,-568 # 9be8 <schedule_dm+0x1d80>
  ...
  if(chdir("dirfile") == 0){
    ...
    4e4c:	52850513          	addi	a0,a0,1320 # 8370 <schedule_dm+0x508>
    ...
    4e64:	da850513          	addi	a0,a0,-600 # 9c08 <schedule_dm+0x1da0>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4e80:	dac50513          	addi	a0,a0,-596 # 9c28 <schedule_dm+0x1dc0>
  ...
  if(fd >= 0){
    ...
    4ea4:	d9850513          	addi	a0,a0,-616 # 9c38 <schedule_dm+0x1dd0>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4ec2:	d6a50513          	addi	a0,a0,-662 # 9c28 <schedule_dm+0x1dc0>
  ...
  if(fd >= 0){
    ...
    4ee6:	d5650513          	addi	a0,a0,-682 # 9c38 <schedule_dm+0x1dd0>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4f00:	d2c50513          	addi	a0,a0,-724 # 9c28 <schedule_dm+0x1dc0>
    ...
    4f18:	d4c50513          	addi	a0,a0,-692 # 9c60 <schedule_dm+0x1df8>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4f32:	cfa50513          	addi	a0,a0,-774 # 9c28 <schedule_dm+0x1dc0>
    ...
    4f4a:	d4250513          	addi	a0,a0,-702 # 9c88 <schedule_dm+0x1e20>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4f64:	cc858593          	addi	a1,a1,-824 # 9c28 <schedule_dm+0x1dc0>
    4f68:	00003517          	auipc	a0,0x3
    4f6c:	4f050513          	addi	a0,a0,1264 # 8458 <schedule_dm+0x5f0>
    ...
    4f84:	d3050513          	addi	a0,a0,-720 # 9cb0 <schedule_dm+0x1e48>
  ...
  if(unlink("dirfile") != 0){
    ...
    4f9e:	3d650513          	addi	a0,a0,982 # 8370 <schedule_dm+0x508>
    ...
    4fb6:	d2650513          	addi	a0,a0,-730 # 9cd8 <schedule_dm+0x1e70>
  ...
  fd = open(".", O_RDWR);
    ...
    4fd2:	12a50513          	addi	a0,a0,298 # 90f8 <schedule_dm+0x1290>
  ...
  if(fd >= 0){
    ...
    4ff6:	d0650513          	addi	a0,a0,-762 # 9cf8 <schedule_dm+0x1e90>
  ...
  fd = open(".", 0);
    ...
    5012:	0ea50513          	addi	a0,a0,234 # 90f8 <schedule_dm+0x1290>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    502e:	47e58593          	addi	a1,a1,1150 # 84a8 <schedule_dm+0x640>
    5032:	853e                	mv	a0,a5
    ...
    504a:	cda50513          	addi	a0,a0,-806 # 9d20 <schedule_dm+0x1eb8>
...
iref(char *s)
{
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    508e:	cae50513          	addi	a0,a0,-850 # 9d38 <schedule_dm+0x1ed0>
    ...
    50a6:	c9e50513          	addi	a0,a0,-866 # 9d40 <schedule_dm+0x1ed8>
    ...
    50c0:	c7c50513          	addi	a0,a0,-900 # 9d38 <schedule_dm+0x1ed0>
    ...
    50d8:	c8450513          	addi	a0,a0,-892 # 9d58 <schedule_dm+0x1ef0>
    ...
    5150:	43450513          	addi	a0,a0,1076 # 8580 <schedule_dm+0x718>
    ...
    517e:	40650513          	addi	a0,a0,1030 # 8580 <schedule_dm+0x718>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    51ae:	a0650513          	addi	a0,a0,-1530 # 8bb0 <schedule_dm+0xd48>
    51b2:	00002097          	auipc	ra,0x2
    51b6:	f38080e7          	jalr	-200(ra) # 70ea <chdir>
    unlink("irefd");
    51ba:	00005517          	auipc	a0,0x5
    51be:	b7e50513          	addi	a0,a0,-1154 # 9d38 <schedule_dm+0x1ed0>
  ...
  chdir("/");
    ...
    51e8:	6e450513          	addi	a0,a0,1764 # 88c8 <schedule_dm+0xa60>
...
forktest(char *s)
{
  ...
  if (n == 0) {
    ...
    5268:	b1450513          	addi	a0,a0,-1260 # 9d78 <schedule_dm+0x1f10>
  ...
  if(n == N){
    ...
    5296:	afe50513          	addi	a0,a0,-1282 # 9d90 <schedule_dm+0x1f28>
  ...
  for(; n > 0; n--){
    ...
    52c4:	af850513          	addi	a0,a0,-1288 # 9db8 <schedule_dm+0x1f50>
  ...
  if(wait(0) != -1){
    ...
    530a:	aca50513          	addi	a0,a0,-1334 # 9dd0 <schedule_dm+0x1f68>
...
sbrkbasic(char *s)
{
  ...
  if(pid < 0){
    ...
    5352:	a9a50513          	addi	a0,a0,-1382 # 9de8 <schedule_dm+0x1f80>
  ...
  if(xstatus == 1){
    ...
    53f4:	a1850513          	addi	a0,a0,-1512 # 9e08 <schedule_dm+0x1fa0>
  ...
  for(i = 0; i < 5000; i++){
    ...
    544a:	9e250513          	addi	a0,a0,-1566 # 9e28 <schedule_dm+0x1fc0>
    ...
    *b = 1;
    ...
    5464:	4705                	li	a4,1
    5466:	00e78023          	sb	a4,0(a5) # 40000000 <__BSS_END__+0x3ffeef80>
    a = b + 1;
  ...
  if(pid < 0){
    ...
    54b0:	99c50513          	addi	a0,a0,-1636 # 9e48 <schedule_dm+0x1fe0>
  ...
  if(c != a + 1){
    ...
    54f8:	97450513          	addi	a0,a0,-1676 # 9e68 <schedule_dm+0x2000>
...
sbrkmuch(char *s)
{
  ...
  if (p != a) {
    ...
    559c:	8f050513          	addi	a0,a0,-1808 # 9e88 <schedule_dm+0x2020>
  ...
  *lastaddr = 99;
    ...
    55fe:	00e78023          	sb	a4,0(a5) # 6400000 <__BSS_END__+0x63eef80>
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5630:	8a450513          	addi	a0,a0,-1884 # 9ed0 <schedule_dm+0x2068>
  ...
  if(c != a - PGSIZE){
    ...
    5674:	88050513          	addi	a0,a0,-1920 # 9ef0 <schedule_dm+0x2088>
  ...
  if(c != a || sbrk(0) != a + PGSIZE){
    ...
    56da:	85a50513          	addi	a0,a0,-1958 # 9f30 <schedule_dm+0x20c8>
  ...
  if(*lastaddr == 99){
    ...
    570a:	85a50513          	addi	a0,a0,-1958 # 9f60 <schedule_dm+0x20f8>
  ...
  if(c != a){
    ...
    576c:	83050513          	addi	a0,a0,-2000 # 9f98 <schedule_dm+0x2130>
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    57c2:	01250513          	addi	a0,a0,18 # 87d0 <schedule_dm+0x968>
    ...
    57f8:	7cc50513          	addi	a0,a0,1996 # 9fc0 <schedule_dm+0x2158>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    5838:	35078793          	addi	a5,a5,848 # c350 <__global_pointer$+0x1310>
    ...
    584c:	47f78793          	addi	a5,a5,1151 # 1003d47f <__BSS_END__+0x1002c3ff>
...
sbrkfail(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    5886:	3e650513          	addi	a0,a0,998 # 8c68 <schedule_dm+0xe00>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    58fe:	bae58593          	addi	a1,a1,-1106 # 84a8 <schedule_dm+0x640>
    5902:	853e                	mv	a0,a5
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    59da:	60a50513          	addi	a0,a0,1546 # 9fe0 <schedule_dm+0x2178>
  ...
  if(pid < 0){
    ...
    5a10:	dc450513          	addi	a0,a0,-572 # 87d0 <schedule_dm+0x968>
  ...
  if(pid == 0){
    ...
    5a96:	56e50513          	addi	a0,a0,1390 # a000 <schedule_dm+0x2198>
...
sbrkarg(char *s)
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    5b08:	52c50513          	addi	a0,a0,1324 # a030 <schedule_dm+0x21c8>
  ...
  unlink("sbrk");
    ...
    5b1e:	51650513          	addi	a0,a0,1302 # a030 <schedule_dm+0x21c8>
  ...
  if(fd < 0)  {
    ...
    5b3c:	50050513          	addi	a0,a0,1280 # a038 <schedule_dm+0x21d0>
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    5b7e:	4d650513          	addi	a0,a0,1238 # a050 <schedule_dm+0x21e8>
  ...
  if(pipe((int *) a) != 0){
    ...
    5bc8:	0a450513          	addi	a0,a0,164 # 8c68 <schedule_dm+0xe00>
...
validatetest(char *s)
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    5c0c:	46050513          	addi	a0,a0,1120 # a068 <schedule_dm+0x2200>
    ...
    5c2a:	45250513          	addi	a0,a0,1106 # a078 <schedule_dm+0x2210>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    5c7e:	bce70713          	addi	a4,a4,-1074 # d848 <uninit>
    ...
    5c96:	40650513          	addi	a0,a0,1030 # a098 <schedule_dm+0x2230>
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    ...
    5ce2:	3d250513          	addi	a0,a0,978 # a0b0 <schedule_dm+0x2248>
  ...
  if(pid == 0){
    ...
    5da4:	40050513          	addi	a0,a0,1024 # a1a0 <schedule_dm+0x2338>
  ...
  fd = open("bigarg-ok", 0);
    ...
    5de2:	2d250513          	addi	a0,a0,722 # a0b0 <schedule_dm+0x2248>
  ...
  if(fd < 0){
    ...
    5e06:	3be50513          	addi	a0,a0,958 # a1c0 <schedule_dm+0x2358>
...
fsfull()
{
  ...
  printf("fsfull test\n");
    ...
    5e44:	3a050513          	addi	a0,a0,928 # a1e0 <schedule_dm+0x2378>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5ef6:	2fe50513          	addi	a0,a0,766 # a1f0 <schedule_dm+0x2388>
    ...
    5f2e:	2d650513          	addi	a0,a0,726 # a200 <schedule_dm+0x2398>
    ...
    5f4c:	90058593          	addi	a1,a1,-1792 # a848 <buf>
    5f50:	853e                	mv	a0,a5
    ...
    5f96:	27e50513          	addi	a0,a0,638 # a210 <schedule_dm+0x23a8>
  ...
  printf("fsfull test finished\n");
    ...
    6086:	19e50513          	addi	a0,a0,414 # a220 <schedule_dm+0x23b8>
...
void argptest(char *s)
{
  ...
  fd = open("init", O_RDONLY);
    ...
    60ae:	18e50513          	addi	a0,a0,398 # a238 <schedule_dm+0x23d0>
  ...
  if (fd < 0) {
    ...
    60d2:	71a50513          	addi	a0,a0,1818 # 87e8 <schedule_dm+0x980>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    612c:	71878793          	addi	a5,a5,1816 # a840 <randstate>
    6130:	6398                	ld	a4,0(a5)
    6132:	001967b7          	lui	a5,0x196
    6136:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x18558d>
    613a:	02f70733          	mul	a4,a4,a5
    613e:	3c6ef7b7          	lui	a5,0x3c6ef
    6142:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6de2df>
    6146:	973e                	add	a4,a4,a5
    6148:	00004797          	auipc	a5,0x4
    614c:	6f878793          	addi	a5,a5,1784 # a840 <randstate>
    6150:	e398                	sd	a4,0(a5)
  return randstate;
    6152:	00004797          	auipc	a5,0x4
    6156:	6ee78793          	addi	a5,a5,1774 # a840 <randstate>
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    61a6:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffedf80>
    61aa:	2781                	sext.w	a5,a5
    61ac:	863e                	mv	a2,a5
    61ae:	fc843583          	ld	a1,-56(s0)
    61b2:	00004517          	auipc	a0,0x4
    61b6:	08e50513          	addi	a0,a0,142 # a240 <schedule_dm+0x23d8>
    ...
    61de:	5f650513          	addi	a0,a0,1526 # 87d0 <schedule_dm+0x968>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    623e:	5b678793          	addi	a5,a5,1462 # a7f0 <schedule_dm+0x2988>
  ...
  pipe((int*)0xeaeb0b5b00002f5e);
    ...
    6254:	5a078793          	addi	a5,a5,1440 # a7f0 <schedule_dm+0x2988>
...
sbrkbugs(char *s)
{
  ...
  if(pid < 0){
    ...
    6296:	31650513          	addi	a0,a0,790 # 85a8 <schedule_dm+0x740>
  ...
  if(pid < 0){
    ...
    6308:	2a450513          	addi	a0,a0,676 # 85a8 <schedule_dm+0x740>
  ...
  if(pid < 0){
    ...
    6380:	22c50513          	addi	a0,a0,556 # 85a8 <schedule_dm+0x740>
...
badwrite(char *s)
{
  ...
  unlink("junk");
    ...
    6404:	e6850513          	addi	a0,a0,-408 # a268 <schedule_dm+0x2400>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    641e:	e4e50513          	addi	a0,a0,-434 # a268 <schedule_dm+0x2400>
    ...
    643e:	e3650513          	addi	a0,a0,-458 # a270 <schedule_dm+0x2408>
    ...
    647c:	df050513          	addi	a0,a0,-528 # a268 <schedule_dm+0x2400>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    64aa:	dc250513          	addi	a0,a0,-574 # a268 <schedule_dm+0x2400>
  ...
  if(fd < 0){
    ...
    64ca:	daa50513          	addi	a0,a0,-598 # a270 <schedule_dm+0x2408>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    64ea:	fc258593          	addi	a1,a1,-62 # 84a8 <schedule_dm+0x640>
    64ee:	853e                	mv	a0,a5
    ...
    6506:	d8650513          	addi	a0,a0,-634 # a288 <schedule_dm+0x2420>
  ...
  unlink("junk");
    ...
    652e:	d3e50513          	addi	a0,a0,-706 # a268 <schedule_dm+0x2400>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    656c:	05050513          	addi	a0,a0,80 # 85b8 <schedule_dm+0x750>
  ...
  for(int i = 0; i < 50000; i++){
    ...
    658c:	34f78793          	addi	a5,a5,847 # c34f <__global_pointer$+0x130f>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    65cc:	fe050513          	addi	a0,a0,-32 # 85a8 <schedule_dm+0x740>
    ...
    660e:	873e                	mv	a4,a5
    6610:	4785                	li	a5,1
    6612:	00f70023          	sb	a5,0(a4) # b000 <buf+0x7b8>
      while(1){
    ...
    6652:	f6a78793          	addi	a5,a5,-150 # 85b8 <schedule_dm+0x750>
    6656:	fcf43023          	sd	a5,-64(s0)
    665a:	00002797          	auipc	a5,0x2
    665e:	e4e78793          	addi	a5,a5,-434 # 84a8 <schedule_dm+0x640>
    ...
    6674:	f4850513          	addi	a0,a0,-184 # 85b8 <schedule_dm+0x750>
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    66d6:	bc650513          	addi	a0,a0,-1082 # a298 <schedule_dm+0x2430>
  ...
  if(pid < 0){
    ...
    6708:	bb450513          	addi	a0,a0,-1100 # a2b8 <schedule_dm+0x2450>
  ...
  if(pid == 0){
    ...
    676a:	d4258593          	addi	a1,a1,-702 # 84a8 <schedule_dm+0x640>
    676e:	853e                	mv	a0,a5
    ...
    6786:	b5650513          	addi	a0,a0,-1194 # a2d8 <schedule_dm+0x2470>
  ...
  while(1){
    ...
    67e4:	b1850513          	addi	a0,a0,-1256 # a2f8 <schedule_dm+0x2490>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    684e:	ace50513          	addi	a0,a0,-1330 # a318 <schedule_dm+0x24b0>
  ...
  if((pid = fork()) < 0) {
    ...
    6876:	ab650513          	addi	a0,a0,-1354 # a328 <schedule_dm+0x24c0>
  ...
  if(pid == 0) {
    ...
    68c0:	a8450513          	addi	a0,a0,-1404 # a340 <schedule_dm+0x24d8>
    ...
    68d2:	a7a50513          	addi	a0,a0,-1414 # a348 <schedule_dm+0x24e0>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    6932:	a2258593          	addi	a1,a1,-1502 # a350 <schedule_dm+0x24e8>
    6936:	853e                	mv	a0,a5
    ...
    6966:	9f658593          	addi	a1,a1,-1546 # a358 <schedule_dm+0x24f0>
    696a:	853e                	mv	a0,a5
    ...
    69c2:	9a250513          	addi	a0,a0,-1630 # a360 <schedule_dm+0x24f8>
  ...
  struct test {
    ...
    69dc:	a6870713          	addi	a4,a4,-1432 # a440 <schedule_dm+0x25d8>
  ...
  if(continuous){
    ...
    6a04:	98850513          	addi	a0,a0,-1656 # a388 <schedule_dm+0x2520>
    ...
    6a6e:	93e50513          	addi	a0,a0,-1730 # a3a8 <schedule_dm+0x2540>
    ...
    6ac4:	90050513          	addi	a0,a0,-1792 # a3c0 <schedule_dm+0x2558>
  ...
  printf("usertests starting\n");
    ...
    6aec:	8f850513          	addi	a0,a0,-1800 # a3e0 <schedule_dm+0x2578>
  ...
  if(fail){
    ...
    6b76:	83650513          	addi	a0,a0,-1994 # a3a8 <schedule_dm+0x2540>
    ...
    6bba:	84250513          	addi	a0,a0,-1982 # a3f8 <schedule_dm+0x2590>
    ...
    6bd4:	85850513          	addi	a0,a0,-1960 # a428 <schedule_dm+0x25c0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    71e2:	64a68693          	addi	a3,a3,1610 # a828 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    72bc:	57070713          	addi	a4,a4,1392 # a828 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    747c:	38078793          	addi	a5,a5,896 # a7f8 <schedule_dm+0x2990>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    7628:	a4c78793          	addi	a5,a5,-1460 # 11070 <freep>
  ...
  freep = p;
    ...
    7720:	95478793          	addi	a5,a5,-1708 # 11070 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    77a2:	8d278793          	addi	a5,a5,-1838 # 11070 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    77d4:	8a078793          	addi	a5,a5,-1888 # 11070 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    7892:	7e278793          	addi	a5,a5,2018 # 11070 <freep>
    ...
    78a8:	7cc78793          	addi	a5,a5,1996 # 11070 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    7a7e:	5fe78793          	addi	a5,a5,1534 # 11078 <last_thread.1226>
    ...
    7ada:	5a278793          	addi	a5,a5,1442 # 11078 <last_thread.1226>
    7ade:	639c                	ld	a5,0(a5)
    7ae0:	c385                	beqz	a5,7b00 <schedule_wrr+0xd6>
    7ae2:	00009797          	auipc	a5,0x9
    7ae6:	59678793          	addi	a5,a5,1430 # 11078 <last_thread.1226>
    ...
    7af6:	58678793          	addi	a5,a5,1414 # 11078 <last_thread.1226>
    ...
    7b46:	53678793          	addi	a5,a5,1334 # 11078 <last_thread.1226>
...
0000000000007b8e <schedule_sjf>:

struct threads_sched_result schedule_sjf(struct threads_sched_args args)
{
    7b8e:	7119                	addi	sp,sp,-128
    7b90:	fc86                	sd	ra,120(sp)
    7b92:	f8a2                	sd	s0,112(sp)
    7b94:	f4a6                	sd	s1,104(sp)
    7b96:	f0ca                	sd	s2,96(sp)
    7b98:	ecce                	sd	s3,88(sp)
    7b9a:	0100                	addi	s0,sp,128
    7b9c:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the shortest-job-first scheduling algorithm
    struct thread *shortest_job = NULL;
    7b9e:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int shortest_time = INT_MAX;
    7ba2:	800007b7          	lui	a5,0x80000
    7ba6:	fff7c793          	not	a5,a5
    7baa:	faf42e23          	sw	a5,-68(s0)

    // Find the thread with the shortest remaining time that is ready to run
    list_for_each_entry(t, args.run_queue, thread_list) {
    7bae:	649c                	ld	a5,8(s1)
    7bb0:	639c                	ld	a5,0(a5)
    7bb2:	faf43823          	sd	a5,-80(s0)
    7bb6:	fb043783          	ld	a5,-80(s0)
    7bba:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeef58>
    7bbe:	fcf43023          	sd	a5,-64(s0)
    7bc2:	a8a9                	j	7c1c <schedule_sjf+0x8e>
        printf("Thread ID: %d, Remaining Time: %d\n", t->ID, t->remaining_time);
    7bc4:	fc043783          	ld	a5,-64(s0)
    7bc8:	5fd8                	lw	a4,60(a5)
    7bca:	fc043783          	ld	a5,-64(s0)
    7bce:	4fbc                	lw	a5,88(a5)
    7bd0:	863e                	mv	a2,a5
    7bd2:	85ba                	mv	a1,a4
    7bd4:	00003517          	auipc	a0,0x3
    7bd8:	c2c50513          	addi	a0,a0,-980 # a800 <schedule_dm+0x2998>
    7bdc:	00000097          	auipc	ra,0x0
    7be0:	9e4080e7          	jalr	-1564(ra) # 75c0 <printf>
        if (t->remaining_time < shortest_time) {
    7be4:	fc043783          	ld	a5,-64(s0)
    7be8:	4fb8                	lw	a4,88(a5)
    7bea:	fbc42783          	lw	a5,-68(s0)
    7bee:	2781                	sext.w	a5,a5
    7bf0:	00f75b63          	bge	a4,a5,7c06 <schedule_sjf+0x78>
            shortest_time = t->remaining_time;
    7bf4:	fc043783          	ld	a5,-64(s0)
    7bf8:	4fbc                	lw	a5,88(a5)
    7bfa:	faf42e23          	sw	a5,-68(s0)
            shortest_job = t;
    7bfe:	fc043783          	ld	a5,-64(s0)
    7c02:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    7c06:	fc043783          	ld	a5,-64(s0)
    7c0a:	779c                	ld	a5,40(a5)
    7c0c:	faf43423          	sd	a5,-88(s0)
    7c10:	fa843783          	ld	a5,-88(s0)
    7c14:	fd878793          	addi	a5,a5,-40
    7c18:	fcf43023          	sd	a5,-64(s0)
    7c1c:	fc043783          	ld	a5,-64(s0)
    7c20:	02878713          	addi	a4,a5,40
    7c24:	649c                	ld	a5,8(s1)
    7c26:	f8f71fe3          	bne	a4,a5,7bc4 <schedule_sjf+0x36>
        }
    }

    if (shortest_job) {
    7c2a:	fc843783          	ld	a5,-56(s0)
    7c2e:	cf89                	beqz	a5,7c48 <schedule_sjf+0xba>
        r.scheduled_thread_list_member = &shortest_job->thread_list;
    7c30:	fc843783          	ld	a5,-56(s0)
    7c34:	02878793          	addi	a5,a5,40
    7c38:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = shortest_job->remaining_time;  // Allow the thread to run to completion
    7c3c:	fc843783          	ld	a5,-56(s0)
    7c40:	4fbc                	lw	a5,88(a5)
    7c42:	f8f42823          	sw	a5,-112(s0)
    7c46:	a039                	j	7c54 <schedule_sjf+0xc6>
    } else {
        // If no threads are ready, find the next release time or idle
        r.scheduled_thread_list_member = args.run_queue;
    7c48:	649c                	ld	a5,8(s1)
    7c4a:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;  // Default minimal quantum if unsure
    7c4e:	4785                	li	a5,1
    7c50:	f8f42823          	sw	a5,-112(s0)
    }
    return r;
    7c54:	f8843783          	ld	a5,-120(s0)
    7c58:	f8f43c23          	sd	a5,-104(s0)
    7c5c:	f9043783          	ld	a5,-112(s0)
    7c60:	faf43023          	sd	a5,-96(s0)
    7c64:	4701                	li	a4,0
    7c66:	f9843703          	ld	a4,-104(s0)
    7c6a:	4781                	li	a5,0
    7c6c:	fa043783          	ld	a5,-96(s0)
    7c70:	893a                	mv	s2,a4
    7c72:	89be                	mv	s3,a5
    7c74:	874a                	mv	a4,s2
    7c76:	87ce                	mv	a5,s3
    ...
    7c78:	853a                	mv	a0,a4
    7c7a:	85be                	mv	a1,a5
    7c7c:	70e6                	ld	ra,120(sp)
    7c7e:	7446                	ld	s0,112(sp)
    7c80:	74a6                	ld	s1,104(sp)
    7c82:	7906                	ld	s2,96(sp)
    7c84:	69e6                	ld	s3,88(sp)
    7c86:	6109                	addi	sp,sp,128
    7c88:	8082                	ret

0000000000007c8a <find_next_release_time>:

int find_next_release_time(struct list_head *release_queue, int current_time) {
    7c8a:	7139                	addi	sp,sp,-64
    7c8c:	fc22                	sd	s0,56(sp)
    7c8e:	0080                	addi	s0,sp,64
    7c90:	fca43423          	sd	a0,-56(s0)
    7c94:	87ae                	mv	a5,a1
    7c96:	fcf42223          	sw	a5,-60(s0)
    struct release_queue_entry *next_release = NULL;
    7c9a:	fe043423          	sd	zero,-24(s0)
    int next_release_time = INT_MAX;
    7c9e:	800007b7          	lui	a5,0x80000
    7ca2:	fff7c793          	not	a5,a5
    7ca6:	fef42223          	sw	a5,-28(s0)

    list_for_each_entry(next_release, release_queue, thread_list) {
    7caa:	fc843783          	ld	a5,-56(s0)
    7cae:	639c                	ld	a5,0(a5)
    7cb0:	fcf43c23          	sd	a5,-40(s0)
    7cb4:	fd843783          	ld	a5,-40(s0)
    7cb8:	17e1                	addi	a5,a5,-8
    7cba:	fef43423          	sd	a5,-24(s0)
    7cbe:	a081                	j	7cfe <find_next_release_time+0x74>
        if (next_release->release_time > current_time &&
    7cc0:	fe843783          	ld	a5,-24(s0)
    7cc4:	4f98                	lw	a4,24(a5)
    7cc6:	fc442783          	lw	a5,-60(s0)
    7cca:	2781                	sext.w	a5,a5
    7ccc:	00e7df63          	bge	a5,a4,7cea <find_next_release_time+0x60>
            next_release->release_time < next_release_time) {
    7cd0:	fe843783          	ld	a5,-24(s0)
    7cd4:	4f98                	lw	a4,24(a5)
        if (next_release->release_time > current_time &&
    7cd6:	fe442783          	lw	a5,-28(s0)
    7cda:	2781                	sext.w	a5,a5
    7cdc:	00f75763          	bge	a4,a5,7cea <find_next_release_time+0x60>
            next_release_time = next_release->release_time;
    7ce0:	fe843783          	ld	a5,-24(s0)
    7ce4:	4f9c                	lw	a5,24(a5)
    7ce6:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(next_release, release_queue, thread_list) {
    7cea:	fe843783          	ld	a5,-24(s0)
    7cee:	679c                	ld	a5,8(a5)
    7cf0:	fcf43823          	sd	a5,-48(s0)
    7cf4:	fd043783          	ld	a5,-48(s0)
    7cf8:	17e1                	addi	a5,a5,-8
    7cfa:	fef43423          	sd	a5,-24(s0)
    7cfe:	fe843783          	ld	a5,-24(s0)
    7d02:	07a1                	addi	a5,a5,8
    7d04:	fc843703          	ld	a4,-56(s0)
    7d08:	faf71ce3          	bne	a4,a5,7cc0 <find_next_release_time+0x36>
        }
    }

    if (next_release_time == INT_MAX)
    7d0c:	fe442783          	lw	a5,-28(s0)
    7d10:	0007871b          	sext.w	a4,a5
    7d14:	800007b7          	lui	a5,0x80000
    7d18:	fff7c793          	not	a5,a5
    7d1c:	00f71463          	bne	a4,a5,7d24 <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    7d20:	57fd                	li	a5,-1
    7d22:	a801                	j	7d32 <find_next_release_time+0xa8>

    return next_release_time - current_time;
    7d24:	fe442703          	lw	a4,-28(s0)
    7d28:	fc442783          	lw	a5,-60(s0)
    7d2c:	40f707bb          	subw	a5,a4,a5
    7d30:	2781                	sext.w	a5,a5
}
    7d32:	853e                	mv	a0,a5
    7d34:	7462                	ld	s0,56(sp)
    7d36:	6121                	addi	sp,sp,64
    7d38:	8082                	ret

0000000000007d3a <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args)
{
    7d3a:	7119                	addi	sp,sp,-128
    7d3c:	fc86                	sd	ra,120(sp)
    7d3e:	f8a2                	sd	s0,112(sp)
    7d40:	f4a6                	sd	s1,104(sp)
    7d42:	f0ca                	sd	s2,96(sp)
    7d44:	ecce                	sd	s3,88(sp)
    7d46:	0100                	addi	s0,sp,128
    7d48:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the least-slack-time scheduling algorithm
    struct thread *min_slack = NULL;
    7d4a:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    7d4e:	800007b7          	lui	a5,0x80000
    7d52:	fff7c793          	not	a5,a5
    7d56:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;

    // Find the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    7d5a:	649c                	ld	a5,8(s1)
    7d5c:	639c                	ld	a5,0(a5)
    7d5e:	faf43823          	sd	a5,-80(s0)
    7d62:	fb043783          	ld	a5,-80(s0)
    7d66:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeef58>
    7d6a:	faf43c23          	sd	a5,-72(s0)
    7d6e:	a8b5                	j	7dea <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    7d70:	fb843783          	ld	a5,-72(s0)
    7d74:	47f8                	lw	a4,76(a5)
    7d76:	409c                	lw	a5,0(s1)
    7d78:	40f707bb          	subw	a5,a4,a5
    7d7c:	0007871b          	sext.w	a4,a5
    7d80:	fb843783          	ld	a5,-72(s0)
    7d84:	4fbc                	lw	a5,88(a5)
    7d86:	40f707bb          	subw	a5,a4,a5
    7d8a:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    7d8e:	fc843783          	ld	a5,-56(s0)
    7d92:	cb8d                	beqz	a5,7dc4 <schedule_lst+0x8a>
    7d94:	fac42703          	lw	a4,-84(s0)
    7d98:	fc442783          	lw	a5,-60(s0)
    7d9c:	2701                	sext.w	a4,a4
    7d9e:	2781                	sext.w	a5,a5
    7da0:	02f74263          	blt	a4,a5,7dc4 <schedule_lst+0x8a>
    7da4:	fac42703          	lw	a4,-84(s0)
    7da8:	fc442783          	lw	a5,-60(s0)
    7dac:	2701                	sext.w	a4,a4
    7dae:	2781                	sext.w	a5,a5
    7db0:	02f71263          	bne	a4,a5,7dd4 <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    7db4:	fb843783          	ld	a5,-72(s0)
    7db8:	5fd8                	lw	a4,60(a5)
    7dba:	fc843783          	ld	a5,-56(s0)
    7dbe:	5fdc                	lw	a5,60(a5)
    7dc0:	00f75a63          	bge	a4,a5,7dd4 <schedule_lst+0x9a>
            min_slack = t;
    7dc4:	fb843783          	ld	a5,-72(s0)
    7dc8:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    7dcc:	fac42783          	lw	a5,-84(s0)
    7dd0:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    7dd4:	fb843783          	ld	a5,-72(s0)
    7dd8:	779c                	ld	a5,40(a5)
    7dda:	faf43023          	sd	a5,-96(s0)
    7dde:	fa043783          	ld	a5,-96(s0)
    7de2:	fd878793          	addi	a5,a5,-40
    7de6:	faf43c23          	sd	a5,-72(s0)
    7dea:	fb843783          	ld	a5,-72(s0)
    7dee:	02878713          	addi	a4,a5,40
    7df2:	649c                	ld	a5,8(s1)
    7df4:	f6f71ee3          	bne	a4,a5,7d70 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    7df8:	fc843783          	ld	a5,-56(s0)
    7dfc:	cf89                	beqz	a5,7e16 <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    7dfe:	fc843783          	ld	a5,-56(s0)
    7e02:	02878793          	addi	a5,a5,40
    7e06:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    7e0a:	fc843783          	ld	a5,-56(s0)
    7e0e:	4fbc                	lw	a5,88(a5)
    7e10:	f8f42423          	sw	a5,-120(s0)
    7e14:	a839                	j	7e32 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    7e16:	649c                	ld	a5,8(s1)
    7e18:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    7e1c:	689c                	ld	a5,16(s1)
    7e1e:	4098                	lw	a4,0(s1)
    7e20:	85ba                	mv	a1,a4
    7e22:	853e                	mv	a0,a5
    7e24:	00000097          	auipc	ra,0x0
    7e28:	e66080e7          	jalr	-410(ra) # 7c8a <find_next_release_time>
    7e2c:	87aa                	mv	a5,a0
    7e2e:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    7e32:	f8043783          	ld	a5,-128(s0)
    7e36:	f8f43823          	sd	a5,-112(s0)
    7e3a:	f8843783          	ld	a5,-120(s0)
    7e3e:	f8f43c23          	sd	a5,-104(s0)
    7e42:	4701                	li	a4,0
    7e44:	f9043703          	ld	a4,-112(s0)
    7e48:	4781                	li	a5,0
    7e4a:	f9843783          	ld	a5,-104(s0)
    7e4e:	893a                	mv	s2,a4
    7e50:	89be                	mv	s3,a5
    7e52:	874a                	mv	a4,s2
    7e54:	87ce                	mv	a5,s3
    ...
    7e56:	853a                	mv	a0,a4
    7e58:	85be                	mv	a1,a5
    7e5a:	70e6                	ld	ra,120(sp)
    7e5c:	7446                	ld	s0,112(sp)
    7e5e:	74a6                	ld	s1,104(sp)
    7e60:	7906                	ld	s2,96(sp)
    7e62:	69e6                	ld	s3,88(sp)
    7e64:	6109                	addi	sp,sp,128
    7e66:	8082                	ret

0000000000007e68 <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    7e68:	7135                	addi	sp,sp,-160
    7e6a:	ed06                	sd	ra,152(sp)
    7e6c:	e922                	sd	s0,144(sp)
    7e6e:	e526                	sd	s1,136(sp)
    7e70:	e14a                	sd	s2,128(sp)
    7e72:	fcce                	sd	s3,120(sp)
    7e74:	1100                	addi	s0,sp,160
    7e76:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    7e78:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    7e7c:	800007b7          	lui	a5,0x80000
    7e80:	fff7c793          	not	a5,a5
    7e84:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    7e88:	649c                	ld	a5,8(s1)
    7e8a:	639c                	ld	a5,0(a5)
    7e8c:	faf43423          	sd	a5,-88(s0)
    7e90:	fa843783          	ld	a5,-88(s0)
    7e94:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeef58>
    7e98:	fcf43023          	sd	a5,-64(s0)
    7e9c:	a841                	j	7f2c <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    7e9e:	fc043783          	ld	a5,-64(s0)
    7ea2:	43bc                	lw	a5,64(a5)
    7ea4:	cb95                	beqz	a5,7ed8 <schedule_dm+0x70>
    7ea6:	fc043783          	ld	a5,-64(s0)
    7eaa:	4bbc                	lw	a5,80(a5)
    7eac:	873e                	mv	a4,a5
    7eae:	57fd                	li	a5,-1
    7eb0:	02f70463          	beq	a4,a5,7ed8 <schedule_dm+0x70>
    7eb4:	fc043783          	ld	a5,-64(s0)
    7eb8:	4ff8                	lw	a4,92(a5)
    7eba:	fbc42783          	lw	a5,-68(s0)
    7ebe:	2781                	sext.w	a5,a5
    7ec0:	00f75c63          	bge	a4,a5,7ed8 <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    7ec4:	fc043783          	ld	a5,-64(s0)
    7ec8:	4ffc                	lw	a5,92(a5)
    7eca:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    7ece:	fc043783          	ld	a5,-64(s0)
    7ed2:	fcf43423          	sd	a5,-56(s0)
    7ed6:	a081                	j	7f16 <schedule_dm+0xae>
        } else if (t->is_real_time && t->period != -1 && t->current_deadline == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    7ed8:	fc043783          	ld	a5,-64(s0)
    7edc:	43bc                	lw	a5,64(a5)
    7ede:	cf85                	beqz	a5,7f16 <schedule_dm+0xae>
    7ee0:	fc043783          	ld	a5,-64(s0)
    7ee4:	4bbc                	lw	a5,80(a5)
    7ee6:	873e                	mv	a4,a5
    7ee8:	57fd                	li	a5,-1
    7eea:	02f70663          	beq	a4,a5,7f16 <schedule_dm+0xae>
    7eee:	fc043783          	ld	a5,-64(s0)
    7ef2:	4ff8                	lw	a4,92(a5)
    7ef4:	fbc42783          	lw	a5,-68(s0)
    7ef8:	2781                	sext.w	a5,a5
    7efa:	00e79e63          	bne	a5,a4,7f16 <schedule_dm+0xae>
    7efe:	fc043783          	ld	a5,-64(s0)
    7f02:	5fd8                	lw	a4,60(a5)
    7f04:	fc843783          	ld	a5,-56(s0)
    7f08:	5fdc                	lw	a5,60(a5)
    7f0a:	00f75663          	bge	a4,a5,7f16 <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    7f0e:	fc043783          	ld	a5,-64(s0)
    7f12:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    7f16:	fc043783          	ld	a5,-64(s0)
    7f1a:	779c                	ld	a5,40(a5)
    7f1c:	f8f43423          	sd	a5,-120(s0)
    7f20:	f8843783          	ld	a5,-120(s0)
    7f24:	fd878793          	addi	a5,a5,-40
    7f28:	fcf43023          	sd	a5,-64(s0)
    7f2c:	fc043783          	ld	a5,-64(s0)
    7f30:	02878713          	addi	a4,a5,40
    7f34:	649c                	ld	a5,8(s1)
    7f36:	f6f714e3          	bne	a4,a5,7e9e <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    7f3a:	fc843783          	ld	a5,-56(s0)
    7f3e:	c7a5                	beqz	a5,7fa6 <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    7f40:	fc843783          	ld	a5,-56(s0)
    7f44:	4ff8                	lw	a4,92(a5)
    7f46:	409c                	lw	a5,0(s1)
    7f48:	40f707bb          	subw	a5,a4,a5
    7f4c:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    7f50:	fc843783          	ld	a5,-56(s0)
    7f54:	4fb8                	lw	a4,88(a5)
    7f56:	f9442783          	lw	a5,-108(s0)
    7f5a:	2781                	sext.w	a5,a5
    7f5c:	00e7db63          	bge	a5,a4,7f72 <schedule_dm+0x10a>
    ...
    7f68:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    7f6c:	f6042823          	sw	zero,-144(s0)
    7f70:	a0f1                	j	803c <schedule_dm+0x1d4>
        } else {
    ...
    7f72:	fc843783          	ld	a5,-56(s0)
    7f76:	4fbc                	lw	a5,88(a5)
    7f78:	863e                	mv	a2,a5
    7f7a:	f9442783          	lw	a5,-108(s0)
    7f7e:	0007869b          	sext.w	a3,a5
    7f82:	0006071b          	sext.w	a4,a2
    7f86:	00d75363          	bge	a4,a3,7f8c <schedule_dm+0x124>
    7f8a:	87b2                	mv	a5,a2
    7f8c:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    7f90:	fc843783          	ld	a5,-56(s0)
    7f94:	02878793          	addi	a5,a5,40
    7f98:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    7f9c:	f9042783          	lw	a5,-112(s0)
    7fa0:	f6f42823          	sw	a5,-144(s0)
    7fa4:	a861                	j	803c <schedule_dm+0x1d4>
        }
    } else {
    ...
    7fa6:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    7faa:	649c                	ld	a5,8(s1)
    7fac:	639c                	ld	a5,0(a5)
    7fae:	faf43023          	sd	a5,-96(s0)
    7fb2:	fa043783          	ld	a5,-96(s0)
    7fb6:	fd878793          	addi	a5,a5,-40
    7fba:	fcf43023          	sd	a5,-64(s0)
    7fbe:	a81d                	j	7ff4 <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    7fc0:	fb043783          	ld	a5,-80(s0)
    7fc4:	cb89                	beqz	a5,7fd6 <schedule_dm+0x16e>
    7fc6:	fc043783          	ld	a5,-64(s0)
    7fca:	5fd8                	lw	a4,60(a5)
    7fcc:	fb043783          	ld	a5,-80(s0)
    7fd0:	5fdc                	lw	a5,60(a5)
    7fd2:	00f75663          	bge	a4,a5,7fde <schedule_dm+0x176>
                smallest_id_thread = t;
    7fd6:	fc043783          	ld	a5,-64(s0)
    7fda:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    7fde:	fc043783          	ld	a5,-64(s0)
    7fe2:	779c                	ld	a5,40(a5)
    7fe4:	f8f43c23          	sd	a5,-104(s0)
    7fe8:	f9843783          	ld	a5,-104(s0)
    7fec:	fd878793          	addi	a5,a5,-40
    7ff0:	fcf43023          	sd	a5,-64(s0)
    7ff4:	fc043783          	ld	a5,-64(s0)
    7ff8:	02878713          	addi	a4,a5,40
    7ffc:	649c                	ld	a5,8(s1)
    7ffe:	fcf711e3          	bne	a4,a5,7fc0 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    8002:	fb043783          	ld	a5,-80(s0)
    8006:	cf89                	beqz	a5,8020 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    8008:	fb043783          	ld	a5,-80(s0)
    800c:	02878793          	addi	a5,a5,40
    8010:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    8014:	fb043783          	ld	a5,-80(s0)
    8018:	4fbc                	lw	a5,88(a5)
    801a:	f6f42823          	sw	a5,-144(s0)
    801e:	a839                	j	803c <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    8020:	649c                	ld	a5,8(s1)
    8022:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    8026:	689c                	ld	a5,16(s1)
    8028:	4098                	lw	a4,0(s1)
    802a:	85ba                	mv	a1,a4
    802c:	853e                	mv	a0,a5
    802e:	00000097          	auipc	ra,0x0
    8032:	c5c080e7          	jalr	-932(ra) # 7c8a <find_next_release_time>
    8036:	87aa                	mv	a5,a0
    8038:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    803c:	f6843783          	ld	a5,-152(s0)
    8040:	f6f43c23          	sd	a5,-136(s0)
    8044:	f7043783          	ld	a5,-144(s0)
    8048:	f8f43023          	sd	a5,-128(s0)
    804c:	4701                	li	a4,0
    804e:	f7843703          	ld	a4,-136(s0)
    8052:	4781                	li	a5,0
    8054:	f8043783          	ld	a5,-128(s0)
    8058:	893a                	mv	s2,a4
    805a:	89be                	mv	s3,a5
    805c:	874a                	mv	a4,s2
    805e:	87ce                	mv	a5,s3
    ...
    8060:	853a                	mv	a0,a4
    8062:	85be                	mv	a1,a5
    8064:	60ea                	ld	ra,152(sp)
    8066:	644a                	ld	s0,144(sp)
    8068:	64aa                	ld	s1,136(sp)
    806a:	690a                	ld	s2,128(sp)
    806c:	79e6                	ld	s3,120(sp)
    806e:	610d                	addi	sp,sp,160
    8070:	8082                	ret

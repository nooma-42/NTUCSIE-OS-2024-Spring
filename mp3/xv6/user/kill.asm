...
main(int argc, char **argv)
{
  ...
  if(argc < 2){
    ...
    fprintf(2, "usage: kill pid...\n");
      ...
      24:	4f858593          	addi	a1,a1,1272 # 1518 <schedule_dm+0x20e>
      28:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     684:	ee068693          	addi	a3,a3,-288 # 1560 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     75e:	e0670713          	addi	a4,a4,-506 # 1560 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     91e:	c1678793          	addi	a5,a5,-1002 # 1530 <schedule_dm+0x226>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     aca:	ac278793          	addi	a5,a5,-1342 # 1588 <freep>
     ace:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bc2:	9ca78793          	addi	a5,a5,-1590 # 1588 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c44:	94878793          	addi	a5,a5,-1720 # 1588 <freep>
     c48:	639c                	ld	a5,0(a5)
}
     c4a:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c76:	91678793          	addi	a5,a5,-1770 # 1588 <freep>
     c7a:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     c8a:	8f278793          	addi	a5,a5,-1806 # 1578 <base>
     c8e:	fef43023          	sd	a5,-32(s0)
     c92:	00001797          	auipc	a5,0x1
     c96:	8f678793          	addi	a5,a5,-1802 # 1588 <freep>
     c9a:	fe043703          	ld	a4,-32(s0)
     c9e:	e398                	sd	a4,0(a5)
     ca0:	00001797          	auipc	a5,0x1
     ca4:	8e878793          	addi	a5,a5,-1816 # 1588 <freep>
     ca8:	6398                	ld	a4,0(a5)
     caa:	00001797          	auipc	a5,0x1
     cae:	8ce78793          	addi	a5,a5,-1842 # 1578 <base>
     cb2:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     cb4:	00001797          	auipc	a5,0x1
     cb8:	8c478793          	addi	a5,a5,-1852 # 1578 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d34:	85878793          	addi	a5,a5,-1960 # 1588 <freep>
    ...
    if(p == freep)
     ...
     d4a:	84278793          	addi	a5,a5,-1982 # 1588 <freep>
     d4e:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     ee2:	6b278793          	addi	a5,a5,1714 # 1590 <last_thread.1226>
     ee6:	639c                	ld	a5,0(a5)
     ee8:	cb89                	beqz	a5,efa <schedule_wrr+0x2e>
     eea:	00000797          	auipc	a5,0x0
     eee:	6a678793          	addi	a5,a5,1702 # 1590 <last_thread.1226>
     ef2:	639c                	ld	a5,0(a5)
     ef4:	4fbc                	lw	a5,88(a5)
     ef6:	00f04863          	bgtz	a5,f06 <schedule_wrr+0x3a>
        last_thread = NULL;
     efa:	00000797          	auipc	a5,0x0
     efe:	69678793          	addi	a5,a5,1686 # 1590 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     f20:	67478793          	addi	a5,a5,1652 # 1590 <last_thread.1226>
     f24:	639c                	ld	a5,0(a5)
    ...
    if (selected_thread) {
     ...
     fe8:	5ac78793          	addi	a5,a5,1452 # 1590 <last_thread.1226>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args)
{
    ...
    105c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe278>
    1060:	fcf43023          	sd	a5,-64(s0)
    1064:	a8a9                	j	10be <schedule_sjf+0x8e>
        printf("Thread ID: %d, Remaining Time: %d\n", t->ID, t->remaining_time);
    1066:	fc043783          	ld	a5,-64(s0)
    106a:	5fd8                	lw	a4,60(a5)
    106c:	fc043783          	ld	a5,-64(s0)
    1070:	4fbc                	lw	a5,88(a5)
    1072:	863e                	mv	a2,a5
    1074:	85ba                	mv	a1,a4
    1076:	00000517          	auipc	a0,0x0
    107a:	4c250513          	addi	a0,a0,1218 # 1538 <schedule_dm+0x22e>
    107e:	00000097          	auipc	ra,0x0
    1082:	9e4080e7          	jalr	-1564(ra) # a62 <printf>
        if (t->remaining_time < shortest_time) {
    1086:	fc043783          	ld	a5,-64(s0)
    108a:	4fb8                	lw	a4,88(a5)
    108c:	fbc42783          	lw	a5,-68(s0)
    1090:	2781                	sext.w	a5,a5
    1092:	00f75b63          	bge	a4,a5,10a8 <schedule_sjf+0x78>
            shortest_time = t->remaining_time;
    1096:	fc043783          	ld	a5,-64(s0)
    109a:	4fbc                	lw	a5,88(a5)
    109c:	faf42e23          	sw	a5,-68(s0)
            shortest_job = t;
    10a0:	fc043783          	ld	a5,-64(s0)
    10a4:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    10a8:	fc043783          	ld	a5,-64(s0)
    10ac:	779c                	ld	a5,40(a5)
    10ae:	faf43423          	sd	a5,-88(s0)
    10b2:	fa843783          	ld	a5,-88(s0)
    10b6:	fd878793          	addi	a5,a5,-40
    10ba:	fcf43023          	sd	a5,-64(s0)
    10be:	fc043783          	ld	a5,-64(s0)
    10c2:	02878713          	addi	a4,a5,40
    10c6:	649c                	ld	a5,8(s1)
    10c8:	f8f71fe3          	bne	a4,a5,1066 <schedule_sjf+0x36>
        }
    }

    if (shortest_job) {
    10cc:	fc843783          	ld	a5,-56(s0)
    10d0:	cf89                	beqz	a5,10ea <schedule_sjf+0xba>
        r.scheduled_thread_list_member = &shortest_job->thread_list;
    10d2:	fc843783          	ld	a5,-56(s0)
    10d6:	02878793          	addi	a5,a5,40
    10da:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = shortest_job->remaining_time;  // Allow the thread to run to completion
    10de:	fc843783          	ld	a5,-56(s0)
    10e2:	4fbc                	lw	a5,88(a5)
    10e4:	f8f42823          	sw	a5,-112(s0)
    10e8:	a039                	j	10f6 <schedule_sjf+0xc6>
    } else {
        // If no threads are ready, find the next release time or idle
        r.scheduled_thread_list_member = args.run_queue;
    10ea:	649c                	ld	a5,8(s1)
    10ec:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;  // Default minimal quantum if unsure
    10f0:	4785                	li	a5,1
    10f2:	f8f42823          	sw	a5,-112(s0)
    }
    return r;
    10f6:	f8843783          	ld	a5,-120(s0)
    10fa:	f8f43c23          	sd	a5,-104(s0)
    10fe:	f9043783          	ld	a5,-112(s0)
    1102:	faf43023          	sd	a5,-96(s0)
    1106:	4701                	li	a4,0
    1108:	f9843703          	ld	a4,-104(s0)
    110c:	4781                	li	a5,0
...
000000000000112c <find_next_release_time>:

int find_next_release_time(struct list_head *release_queue, int current_time) {
    112c:	7139                	addi	sp,sp,-64
    112e:	fc22                	sd	s0,56(sp)
    1130:	0080                	addi	s0,sp,64
    1132:	fca43423          	sd	a0,-56(s0)
    1136:	87ae                	mv	a5,a1
    1138:	fcf42223          	sw	a5,-60(s0)
    struct release_queue_entry *next_release = NULL;
    113c:	fe043423          	sd	zero,-24(s0)
    int next_release_time = INT_MAX;
    1140:	800007b7          	lui	a5,0x80000
    ...
    115a:	17e1                	addi	a5,a5,-8
    115c:	fef43423          	sd	a5,-24(s0)
    1160:	a081                	j	11a0 <find_next_release_time+0x74>
        if (next_release->release_time > current_time &&
    1162:	fe843783          	ld	a5,-24(s0)
    1166:	4f98                	lw	a4,24(a5)
    1168:	fc442783          	lw	a5,-60(s0)
    116c:	2781                	sext.w	a5,a5
    116e:	00e7df63          	bge	a5,a4,118c <find_next_release_time+0x60>
            next_release->release_time < next_release_time) {
    1172:	fe843783          	ld	a5,-24(s0)
    1176:	4f98                	lw	a4,24(a5)
        if (next_release->release_time > current_time &&
    1178:	fe442783          	lw	a5,-28(s0)
    117c:	2781                	sext.w	a5,a5
    117e:	00f75763          	bge	a4,a5,118c <find_next_release_time+0x60>
            next_release_time = next_release->release_time;
    1182:	fe843783          	ld	a5,-24(s0)
    1186:	4f9c                	lw	a5,24(a5)
    1188:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(next_release, release_queue, thread_list) {
    118c:	fe843783          	ld	a5,-24(s0)
    1190:	679c                	ld	a5,8(a5)
    1192:	fcf43823          	sd	a5,-48(s0)
    1196:	fd043783          	ld	a5,-48(s0)
    119a:	17e1                	addi	a5,a5,-8
    119c:	fef43423          	sd	a5,-24(s0)
    11a0:	fe843783          	ld	a5,-24(s0)
    11a4:	07a1                	addi	a5,a5,8
    11a6:	fc843703          	ld	a4,-56(s0)
    11aa:	faf71ce3          	bne	a4,a5,1162 <find_next_release_time+0x36>
        }
    }

    if (next_release_time == INT_MAX)
    11ae:	fe442783          	lw	a5,-28(s0)
    11b2:	0007871b          	sext.w	a4,a5
    11b6:	800007b7          	lui	a5,0x80000
    11ba:	fff7c793          	not	a5,a5
    11be:	00f71463          	bne	a4,a5,11c6 <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    11c2:	57fd                	li	a5,-1
    11c4:	a801                	j	11d4 <find_next_release_time+0xa8>

    return next_release_time - current_time;
    11c6:	fe442703          	lw	a4,-28(s0)
    11ca:	fc442783          	lw	a5,-60(s0)
    11ce:	40f707bb          	subw	a5,a4,a5
    11d2:	2781                	sext.w	a5,a5
}
    11d4:	853e                	mv	a0,a5
    11d6:	7462                	ld	s0,56(sp)
    11d8:	6121                	addi	sp,sp,64
    11da:	8082                	ret

00000000000011dc <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args)
{
    11dc:	7119                	addi	sp,sp,-128
    11de:	fc86                	sd	ra,120(sp)
    11e0:	f8a2                	sd	s0,112(sp)
    11e2:	f4a6                	sd	s1,104(sp)
    11e4:	f0ca                	sd	s2,96(sp)
    ...
    11ec:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    11f0:	800007b7          	lui	a5,0x80000
    11f4:	fff7c793          	not	a5,a5
    11f8:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;

    // Find the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    11fc:	649c                	ld	a5,8(s1)
    11fe:	639c                	ld	a5,0(a5)
    1200:	faf43823          	sd	a5,-80(s0)
    1204:	fb043783          	ld	a5,-80(s0)
    1208:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe278>
    120c:	faf43c23          	sd	a5,-72(s0)
    1210:	a8b5                	j	128c <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    1212:	fb843783          	ld	a5,-72(s0)
    1216:	47f8                	lw	a4,76(a5)
    1218:	409c                	lw	a5,0(s1)
    121a:	40f707bb          	subw	a5,a4,a5
    121e:	0007871b          	sext.w	a4,a5
    1222:	fb843783          	ld	a5,-72(s0)
    1226:	4fbc                	lw	a5,88(a5)
    1228:	40f707bb          	subw	a5,a4,a5
    122c:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    1230:	fc843783          	ld	a5,-56(s0)
    1234:	cb8d                	beqz	a5,1266 <schedule_lst+0x8a>
    1236:	fac42703          	lw	a4,-84(s0)
    123a:	fc442783          	lw	a5,-60(s0)
    123e:	2701                	sext.w	a4,a4
    1240:	2781                	sext.w	a5,a5
    1242:	02f74263          	blt	a4,a5,1266 <schedule_lst+0x8a>
    1246:	fac42703          	lw	a4,-84(s0)
    124a:	fc442783          	lw	a5,-60(s0)
    124e:	2701                	sext.w	a4,a4
    1250:	2781                	sext.w	a5,a5
    1252:	02f71263          	bne	a4,a5,1276 <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    1256:	fb843783          	ld	a5,-72(s0)
    125a:	5fd8                	lw	a4,60(a5)
    125c:	fc843783          	ld	a5,-56(s0)
    1260:	5fdc                	lw	a5,60(a5)
    1262:	00f75a63          	bge	a4,a5,1276 <schedule_lst+0x9a>
            min_slack = t;
    1266:	fb843783          	ld	a5,-72(s0)
    126a:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    126e:	fac42783          	lw	a5,-84(s0)
    1272:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1276:	fb843783          	ld	a5,-72(s0)
    127a:	779c                	ld	a5,40(a5)
    127c:	faf43023          	sd	a5,-96(s0)
    1280:	fa043783          	ld	a5,-96(s0)
    1284:	fd878793          	addi	a5,a5,-40
    1288:	faf43c23          	sd	a5,-72(s0)
    128c:	fb843783          	ld	a5,-72(s0)
    1290:	02878713          	addi	a4,a5,40
    1294:	649c                	ld	a5,8(s1)
    1296:	f6f71ee3          	bne	a4,a5,1212 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    129a:	fc843783          	ld	a5,-56(s0)
    129e:	cf89                	beqz	a5,12b8 <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    12a0:	fc843783          	ld	a5,-56(s0)
    12a4:	02878793          	addi	a5,a5,40
    12a8:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    12ac:	fc843783          	ld	a5,-56(s0)
    12b0:	4fbc                	lw	a5,88(a5)
    12b2:	f8f42423          	sw	a5,-120(s0)
    12b6:	a839                	j	12d4 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    ...
    12c0:	4098                	lw	a4,0(s1)
    12c2:	85ba                	mv	a1,a4
    12c4:	853e                	mv	a0,a5
    12c6:	00000097          	auipc	ra,0x0
    12ca:	e66080e7          	jalr	-410(ra) # 112c <find_next_release_time>
    12ce:	87aa                	mv	a5,a0
    12d0:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    12d4:	f8043783          	ld	a5,-128(s0)
    12d8:	f8f43823          	sd	a5,-112(s0)
    12dc:	f8843783          	ld	a5,-120(s0)
    12e0:	f8f43c23          	sd	a5,-104(s0)
    12e4:	4701                	li	a4,0
    12e6:	f9043703          	ld	a4,-112(s0)
    12ea:	4781                	li	a5,0
    12ec:	f9843783          	ld	a5,-104(s0)
    12f0:	893a                	mv	s2,a4
    12f2:	89be                	mv	s3,a5
    12f4:	874a                	mv	a4,s2
    12f6:	87ce                	mv	a5,s3
    ...
    12f8:	853a                	mv	a0,a4
    12fa:	85be                	mv	a1,a5
    12fc:	70e6                	ld	ra,120(sp)
    12fe:	7446                	ld	s0,112(sp)
    1300:	74a6                	ld	s1,104(sp)
    1302:	7906                	ld	s2,96(sp)
    1304:	69e6                	ld	s3,88(sp)
    1306:	6109                	addi	sp,sp,128
    1308:	8082                	ret

000000000000130a <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    130a:	7135                	addi	sp,sp,-160
    130c:	ed06                	sd	ra,152(sp)
    130e:	e922                	sd	s0,144(sp)
    1310:	e526                	sd	s1,136(sp)
    1312:	e14a                	sd	s2,128(sp)
    1314:	fcce                	sd	s3,120(sp)
    1316:	1100                	addi	s0,sp,160
    1318:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    131a:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    131e:	800007b7          	lui	a5,0x80000
    1322:	fff7c793          	not	a5,a5
    1326:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    132a:	649c                	ld	a5,8(s1)
    132c:	639c                	ld	a5,0(a5)
    132e:	faf43423          	sd	a5,-88(s0)
    1332:	fa843783          	ld	a5,-88(s0)
    1336:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe278>
    133a:	fcf43023          	sd	a5,-64(s0)
    133e:	a841                	j	13ce <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    1340:	fc043783          	ld	a5,-64(s0)
    1344:	43bc                	lw	a5,64(a5)
    1346:	cb95                	beqz	a5,137a <schedule_dm+0x70>
    1348:	fc043783          	ld	a5,-64(s0)
    134c:	4bbc                	lw	a5,80(a5)
    134e:	873e                	mv	a4,a5
    1350:	57fd                	li	a5,-1
    1352:	02f70463          	beq	a4,a5,137a <schedule_dm+0x70>
    1356:	fc043783          	ld	a5,-64(s0)
    135a:	4ff8                	lw	a4,92(a5)
    135c:	fbc42783          	lw	a5,-68(s0)
    1360:	2781                	sext.w	a5,a5
    1362:	00f75c63          	bge	a4,a5,137a <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    1366:	fc043783          	ld	a5,-64(s0)
    136a:	4ffc                	lw	a5,92(a5)
    136c:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    1370:	fc043783          	ld	a5,-64(s0)
    1374:	fcf43423          	sd	a5,-56(s0)
    1378:	a081                	j	13b8 <schedule_dm+0xae>
    ...
    137e:	43bc                	lw	a5,64(a5)
    1380:	cf85                	beqz	a5,13b8 <schedule_dm+0xae>
    1382:	fc043783          	ld	a5,-64(s0)
    1386:	4bbc                	lw	a5,80(a5)
    1388:	873e                	mv	a4,a5
    138a:	57fd                	li	a5,-1
    138c:	02f70663          	beq	a4,a5,13b8 <schedule_dm+0xae>
    1390:	fc043783          	ld	a5,-64(s0)
    1394:	4ff8                	lw	a4,92(a5)
    1396:	fbc42783          	lw	a5,-68(s0)
    139a:	2781                	sext.w	a5,a5
    139c:	00e79e63          	bne	a5,a4,13b8 <schedule_dm+0xae>
    13a0:	fc043783          	ld	a5,-64(s0)
    13a4:	5fd8                	lw	a4,60(a5)
    13a6:	fc843783          	ld	a5,-56(s0)
    13aa:	5fdc                	lw	a5,60(a5)
    13ac:	00f75663          	bge	a4,a5,13b8 <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    13b0:	fc043783          	ld	a5,-64(s0)
    13b4:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    13b8:	fc043783          	ld	a5,-64(s0)
    13bc:	779c                	ld	a5,40(a5)
    13be:	f8f43423          	sd	a5,-120(s0)
    13c2:	f8843783          	ld	a5,-120(s0)
    13c6:	fd878793          	addi	a5,a5,-40
    13ca:	fcf43023          	sd	a5,-64(s0)
    13ce:	fc043783          	ld	a5,-64(s0)
    13d2:	02878713          	addi	a4,a5,40
    13d6:	649c                	ld	a5,8(s1)
    13d8:	f6f714e3          	bne	a4,a5,1340 <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    13dc:	fc843783          	ld	a5,-56(s0)
    13e0:	c7a5                	beqz	a5,1448 <schedule_dm+0x13e>
    ...
    140a:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    140e:	f6042823          	sw	zero,-144(s0)
    1412:	a0f1                	j	14de <schedule_dm+0x1d4>
        } else {
    ...
    1418:	4fbc                	lw	a5,88(a5)
    141a:	863e                	mv	a2,a5
    141c:	f9442783          	lw	a5,-108(s0)
    1420:	0007869b          	sext.w	a3,a5
    1424:	0006071b          	sext.w	a4,a2
    1428:	00d75363          	bge	a4,a3,142e <schedule_dm+0x124>
    142c:	87b2                	mv	a5,a2
    142e:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1432:	fc843783          	ld	a5,-56(s0)
    1436:	02878793          	addi	a5,a5,40
    143a:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    143e:	f9042783          	lw	a5,-112(s0)
    1442:	f6f42823          	sw	a5,-144(s0)
    1446:	a861                	j	14de <schedule_dm+0x1d4>
        }
    } else {
    ...
    1460:	a81d                	j	1496 <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    1462:	fb043783          	ld	a5,-80(s0)
    1466:	cb89                	beqz	a5,1478 <schedule_dm+0x16e>
    1468:	fc043783          	ld	a5,-64(s0)
    146c:	5fd8                	lw	a4,60(a5)
    146e:	fb043783          	ld	a5,-80(s0)
    1472:	5fdc                	lw	a5,60(a5)
    1474:	00f75663          	bge	a4,a5,1480 <schedule_dm+0x176>
                smallest_id_thread = t;
    1478:	fc043783          	ld	a5,-64(s0)
    147c:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    1480:	fc043783          	ld	a5,-64(s0)
    1484:	779c                	ld	a5,40(a5)
    1486:	f8f43c23          	sd	a5,-104(s0)
    148a:	f9843783          	ld	a5,-104(s0)
    148e:	fd878793          	addi	a5,a5,-40
    1492:	fcf43023          	sd	a5,-64(s0)
    1496:	fc043783          	ld	a5,-64(s0)
    149a:	02878713          	addi	a4,a5,40
    149e:	649c                	ld	a5,8(s1)
    14a0:	fcf711e3          	bne	a4,a5,1462 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    14a4:	fb043783          	ld	a5,-80(s0)
    14a8:	cf89                	beqz	a5,14c2 <schedule_dm+0x1b8>
    ...
    14c0:	a839                	j	14de <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    14c2:	649c                	ld	a5,8(s1)
    14c4:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    14c8:	689c                	ld	a5,16(s1)
    14ca:	4098                	lw	a4,0(s1)
    14cc:	85ba                	mv	a1,a4
    14ce:	853e                	mv	a0,a5
    14d0:	00000097          	auipc	ra,0x0
    14d4:	c5c080e7          	jalr	-932(ra) # 112c <find_next_release_time>
    14d8:	87aa                	mv	a5,a0
    14da:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    14de:	f6843783          	ld	a5,-152(s0)
    14e2:	f6f43c23          	sd	a5,-136(s0)
    14e6:	f7043783          	ld	a5,-144(s0)
    14ea:	f8f43023          	sd	a5,-128(s0)
    14ee:	4701                	li	a4,0
    14f0:	f7843703          	ld	a4,-136(s0)
    14f4:	4781                	li	a5,0
    14f6:	f8043783          	ld	a5,-128(s0)
    14fa:	893a                	mv	s2,a4
    14fc:	89be                	mv	s3,a5
    14fe:	874a                	mv	a4,s2
    1500:	87ce                	mv	a5,s3
    ...
    1502:	853a                	mv	a0,a4
    1504:	85be                	mv	a1,a5
    1506:	60ea                	ld	ra,152(sp)
    1508:	644a                	ld	s0,144(sp)
    150a:	64aa                	ld	s1,136(sp)
    150c:	690a                	ld	s2,128(sp)
    150e:	79e6                	ld	s3,120(sp)
    1510:	610d                	addi	sp,sp,160
    1512:	8082                	ret

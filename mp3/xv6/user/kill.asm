...
main(int argc, char **argv)
{
  ...
  if(argc < 2){
    ...
    fprintf(2, "usage: kill pid...\n");
      ...
      24:	88858593          	addi	a1,a1,-1912 # 18a8 <schedule_dm+0x17e>
      28:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     684:	24868693          	addi	a3,a3,584 # 18c8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     75e:	16e70713          	addi	a4,a4,366 # 18c8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     91e:	fa678793          	addi	a5,a5,-90 # 18c0 <schedule_dm+0x196>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     aca:	e2a78793          	addi	a5,a5,-470 # 18f0 <freep>
     ace:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bc2:	d3278793          	addi	a5,a5,-718 # 18f0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c44:	cb078793          	addi	a5,a5,-848 # 18f0 <freep>
     c48:	639c                	ld	a5,0(a5)
}
     c4a:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c76:	c7e78793          	addi	a5,a5,-898 # 18f0 <freep>
     c7a:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     c8a:	c5a78793          	addi	a5,a5,-934 # 18e0 <base>
     c8e:	fef43023          	sd	a5,-32(s0)
     c92:	00001797          	auipc	a5,0x1
     c96:	c5e78793          	addi	a5,a5,-930 # 18f0 <freep>
     c9a:	fe043703          	ld	a4,-32(s0)
     c9e:	e398                	sd	a4,0(a5)
     ca0:	00001797          	auipc	a5,0x1
     ca4:	c5078793          	addi	a5,a5,-944 # 18f0 <freep>
     ca8:	6398                	ld	a4,0(a5)
     caa:	00001797          	auipc	a5,0x1
     cae:	c3678793          	addi	a5,a5,-970 # 18e0 <base>
     cb2:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     cb4:	00001797          	auipc	a5,0x1
     cb8:	c2c78793          	addi	a5,a5,-980 # 18e0 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d34:	bc078793          	addi	a5,a5,-1088 # 18f0 <freep>
    ...
    if(p == freep)
     ...
     d4a:	baa78793          	addi	a5,a5,-1110 # 18f0 <freep>
     d4e:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     ee2:	a1a78793          	addi	a5,a5,-1510 # 18f8 <last_thread.1226>
     ee6:	639c                	ld	a5,0(a5)
     ee8:	cb89                	beqz	a5,efa <schedule_wrr+0x2e>
     eea:	00001797          	auipc	a5,0x1
     eee:	a0e78793          	addi	a5,a5,-1522 # 18f8 <last_thread.1226>
     ef2:	639c                	ld	a5,0(a5)
     ef4:	4fbc                	lw	a5,88(a5)
     ef6:	00f04863          	bgtz	a5,f06 <schedule_wrr+0x3a>
        last_thread = NULL;
     efa:	00001797          	auipc	a5,0x1
     efe:	9fe78793          	addi	a5,a5,-1538 # 18f8 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     f20:	9dc78793          	addi	a5,a5,-1572 # 18f8 <last_thread.1226>
     f24:	639c                	ld	a5,0(a5)
    ...
    if (selected_thread) {
     ...
     fe8:	91478793          	addi	a5,a5,-1772 # 18f8 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    111a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdf10>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    124c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdf10>
    ...
    12e6:	a80d                	j	1318 <schedule_sjf+0x112>
    } else {
    ...
    12f6:	57fd                	li	a5,-1
    12f8:	00f71c63          	bne	a4,a5,1310 <schedule_sjf+0x10a>
    12fc:	689c                	ld	a5,16(s1)
    12fe:	4098                	lw	a4,0(s1)
    1300:	85ba                	mv	a1,a4
    1302:	853e                	mv	a0,a5
    1304:	00000097          	auipc	ra,0x0
    1308:	d2c080e7          	jalr	-724(ra) # 1030 <find_next_release_time>
    130c:	87aa                	mv	a5,a0
    130e:	a019                	j	1314 <schedule_sjf+0x10e>
    1310:	fb442783          	lw	a5,-76(s0)
    1314:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    1318:	f8043783          	ld	a5,-128(s0)
    131c:	f8f43823          	sd	a5,-112(s0)
    1320:	f8843783          	ld	a5,-120(s0)
    1324:	f8f43c23          	sd	a5,-104(s0)
    1328:	4701                	li	a4,0
    132a:	f9043703          	ld	a4,-112(s0)
    132e:	4781                	li	a5,0
    1330:	f9843783          	ld	a5,-104(s0)
    1334:	893a                	mv	s2,a4
    1336:	89be                	mv	s3,a5
    1338:	874a                	mv	a4,s2
    133a:	87ce                	mv	a5,s3
    ...
    133c:	853a                	mv	a0,a4
    133e:	85be                	mv	a1,a5
    1340:	70e6                	ld	ra,120(sp)
    1342:	7446                	ld	s0,112(sp)
    1344:	74a6                	ld	s1,104(sp)
    1346:	7906                	ld	s2,96(sp)
    1348:	69e6                	ld	s3,88(sp)
    134a:	6109                	addi	sp,sp,128
    134c:	8082                	ret

000000000000134e <min>:

int min(int a, int b) {
    134e:	1101                	addi	sp,sp,-32
    1350:	ec22                	sd	s0,24(sp)
    1352:	1000                	addi	s0,sp,32
    1354:	87aa                	mv	a5,a0
    1356:	872e                	mv	a4,a1
    1358:	fef42623          	sw	a5,-20(s0)
    135c:	87ba                	mv	a5,a4
    135e:	fef42423          	sw	a5,-24(s0)
    return (a < b) ? a : b;
    1362:	fec42603          	lw	a2,-20(s0)
    1366:	fe842783          	lw	a5,-24(s0)
    136a:	0007869b          	sext.w	a3,a5
    136e:	0006071b          	sext.w	a4,a2
    1372:	00d75363          	bge	a4,a3,1378 <min+0x2a>
    1376:	87b2                	mv	a5,a2
    1378:	2781                	sext.w	a5,a5
}
    137a:	853e                	mv	a0,a5
    137c:	6462                	ld	s0,24(sp)
    137e:	6105                	addi	sp,sp,32
    1380:	8082                	ret

0000000000001382 <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    1382:	7131                	addi	sp,sp,-192
    1384:	fd06                	sd	ra,184(sp)
    1386:	f922                	sd	s0,176(sp)
    1388:	f526                	sd	s1,168(sp)
    138a:	f14a                	sd	s2,160(sp)
    138c:	ed4e                	sd	s3,152(sp)
    138e:	0180                	addi	s0,sp,192
    1390:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *min_slack_thread = NULL;
    1392:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    1396:	800007b7          	lui	a5,0x80000
    139a:	fff7c793          	not	a5,a5
    139e:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    // int ddl;
    // Determine the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    13a2:	649c                	ld	a5,8(s1)
    13a4:	639c                	ld	a5,0(a5)
    13a6:	faf43023          	sd	a5,-96(s0)
    13aa:	fa043783          	ld	a5,-96(s0)
    13ae:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdf10>
    13b2:	faf43c23          	sd	a5,-72(s0)
    13b6:	a069                	j	1440 <schedule_lst+0xbe>
        int slack_time = t->current_deadline - args.current_time - t->remaining_time;
    13b8:	fb843783          	ld	a5,-72(s0)
    13bc:	4ff8                	lw	a4,92(a5)
    13be:	409c                	lw	a5,0(s1)
    13c0:	40f707bb          	subw	a5,a4,a5
    13c4:	0007871b          	sext.w	a4,a5
    13c8:	fb843783          	ld	a5,-72(s0)
    13cc:	4fbc                	lw	a5,88(a5)
    13ce:	40f707bb          	subw	a5,a4,a5
    13d2:	f6f42a23          	sw	a5,-140(s0)
        if (slack_time < min_slack_time || (slack_time == min_slack_time && t->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))) {
    13d6:	f7442703          	lw	a4,-140(s0)
    13da:	fc442783          	lw	a5,-60(s0)
    13de:	2701                	sext.w	a4,a4
    13e0:	2781                	sext.w	a5,a5
    13e2:	02f74c63          	blt	a4,a5,141a <schedule_lst+0x98>
    13e6:	f7442703          	lw	a4,-140(s0)
    13ea:	fc442783          	lw	a5,-60(s0)
    13ee:	2701                	sext.w	a4,a4
    13f0:	2781                	sext.w	a5,a5
    13f2:	02f71c63          	bne	a4,a5,142a <schedule_lst+0xa8>
    13f6:	fb843783          	ld	a5,-72(s0)
    13fa:	5fd4                	lw	a3,60(a5)
    13fc:	fc843783          	ld	a5,-56(s0)
    1400:	c789                	beqz	a5,140a <schedule_lst+0x88>
    1402:	fc843783          	ld	a5,-56(s0)
    1406:	5fdc                	lw	a5,60(a5)
    1408:	a029                	j	1412 <schedule_lst+0x90>
    140a:	800007b7          	lui	a5,0x80000
    140e:	fff7c793          	not	a5,a5
    1412:	873e                	mv	a4,a5
    1414:	87b6                	mv	a5,a3
    1416:	00e7da63          	bge	a5,a4,142a <schedule_lst+0xa8>
            min_slack_thread = t;
    141a:	fb843783          	ld	a5,-72(s0)
    141e:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    1422:	f7442783          	lw	a5,-140(s0)
    1426:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    142a:	fb843783          	ld	a5,-72(s0)
    142e:	779c                	ld	a5,40(a5)
    1430:	f6f43423          	sd	a5,-152(s0)
    1434:	f6843783          	ld	a5,-152(s0)
    1438:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdf10>
    143c:	faf43c23          	sd	a5,-72(s0)
    1440:	fb843783          	ld	a5,-72(s0)
    1444:	02878713          	addi	a4,a5,40
    1448:	649c                	ld	a5,8(s1)
    144a:	f6f717e3          	bne	a4,a5,13b8 <schedule_lst+0x36>
    ...
    144e:	800007b7          	lui	a5,0x80000
    1452:	fff7c793          	not	a5,a5
    1456:	faf42a23          	sw	a5,-76(s0)
    ...
    145a:	689c                	ld	a5,16(s1)
    145c:	639c                	ld	a5,0(a5)
    145e:	f8f43c23          	sd	a5,-104(s0)
    1462:	f9843783          	ld	a5,-104(s0)
    1466:	17e1                	addi	a5,a5,-8
    1468:	faf43423          	sd	a5,-88(s0)
    146c:	a0f1                	j	1538 <schedule_lst+0x1b6>
        if (entry->release_time > args.current_time) {
    146e:	fa843783          	ld	a5,-88(s0)
    1472:	4f98                	lw	a4,24(a5)
    1474:	409c                	lw	a5,0(s1)
    1476:	0ae7d763          	bge	a5,a4,1524 <schedule_lst+0x1a2>
            struct thread *upcoming_thread = entry->thrd;
    147a:	fa843783          	ld	a5,-88(s0)
    147e:	639c                	ld	a5,0(a5)
    1480:	f8f43423          	sd	a5,-120(s0)
            int upcoming_slack_time = upcoming_thread->current_deadline - entry->release_time - upcoming_thread->remaining_time;
    1484:	f8843783          	ld	a5,-120(s0)
    1488:	4ff8                	lw	a4,92(a5)
    148a:	fa843783          	ld	a5,-88(s0)
    148e:	4f9c                	lw	a5,24(a5)
    1490:	40f707bb          	subw	a5,a4,a5
    1494:	0007871b          	sext.w	a4,a5
    1498:	f8843783          	ld	a5,-120(s0)
    149c:	4fbc                	lw	a5,88(a5)
    149e:	40f707bb          	subw	a5,a4,a5
    14a2:	f8f42223          	sw	a5,-124(s0)
    ...
    14a6:	f8442703          	lw	a4,-124(s0)
    14aa:	fc442783          	lw	a5,-60(s0)
    14ae:	2701                	sext.w	a4,a4
    14b0:	2781                	sext.w	a5,a5
    14b2:	02f75163          	bge	a4,a5,14d4 <schedule_lst+0x152>
    ...
    14bc:	fb442783          	lw	a5,-76(s0)
    14c0:	85ba                	mv	a1,a4
    14c2:	853e                	mv	a0,a5
    14c4:	00000097          	auipc	ra,0x0
    14c8:	e8a080e7          	jalr	-374(ra) # 134e <min>
    14cc:	87aa                	mv	a5,a0
    14ce:	faf42a23          	sw	a5,-76(s0)
    14d2:	a889                	j	1524 <schedule_lst+0x1a2>
            } else if (upcoming_slack_time == min_slack_time && upcoming_thread->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))
    14d4:	f8442703          	lw	a4,-124(s0)
    14d8:	fc442783          	lw	a5,-60(s0)
    14dc:	2701                	sext.w	a4,a4
    14de:	2781                	sext.w	a5,a5
    14e0:	04f71263          	bne	a4,a5,1524 <schedule_lst+0x1a2>
    14e4:	f8843783          	ld	a5,-120(s0)
    14e8:	5fd4                	lw	a3,60(a5)
    14ea:	fc843783          	ld	a5,-56(s0)
    14ee:	c789                	beqz	a5,14f8 <schedule_lst+0x176>
    14f0:	fc843783          	ld	a5,-56(s0)
    14f4:	5fdc                	lw	a5,60(a5)
    14f6:	a029                	j	1500 <schedule_lst+0x17e>
    14f8:	800007b7          	lui	a5,0x80000
    14fc:	fff7c793          	not	a5,a5
    1500:	873e                	mv	a4,a5
    1502:	87b6                	mv	a5,a3
    1504:	02e7d063          	bge	a5,a4,1524 <schedule_lst+0x1a2>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    1508:	fa843783          	ld	a5,-88(s0)
    150c:	4f98                	lw	a4,24(a5)
    150e:	fb442783          	lw	a5,-76(s0)
    1512:	85ba                	mv	a1,a4
    1514:	853e                	mv	a0,a5
    1516:	00000097          	auipc	ra,0x0
    151a:	e38080e7          	jalr	-456(ra) # 134e <min>
    151e:	87aa                	mv	a5,a0
    1520:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(entry, args.release_queue, thread_list) {
    1524:	fa843783          	ld	a5,-88(s0)
    1528:	679c                	ld	a5,8(a5)
    152a:	f6f43c23          	sd	a5,-136(s0)
    152e:	f7843783          	ld	a5,-136(s0)
    1532:	17e1                	addi	a5,a5,-8
    1534:	faf43423          	sd	a5,-88(s0)
    1538:	fa843783          	ld	a5,-88(s0)
    153c:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffdf40>
    1540:	689c                	ld	a5,16(s1)
    1542:	f2f716e3          	bne	a4,a5,146e <schedule_lst+0xec>
        }
    }
    ...
    154a:	c3b1                	beqz	a5,158e <schedule_lst+0x20c>
    ...
    155c:	00f71663          	bne	a4,a5,1568 <schedule_lst+0x1e6>
    1560:	fc843783          	ld	a5,-56(s0)
    1564:	4fbc                	lw	a5,88(a5)
    1566:	a039                	j	1574 <schedule_lst+0x1f2>
    1568:	409c                	lw	a5,0(s1)
    156a:	fb442703          	lw	a4,-76(s0)
    156e:	40f707bb          	subw	a5,a4,a5
    1572:	2781                	sext.w	a5,a5
    1574:	f8f42a23          	sw	a5,-108(s0)
        r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    1578:	fc843783          	ld	a5,-56(s0)
    157c:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffdf60>
    1580:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = allocated_time;
    1584:	f9442783          	lw	a5,-108(s0)
    1588:	f4f42823          	sw	a5,-176(s0)
    158c:	a081                	j	15cc <schedule_lst+0x24a>
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    158e:	649c                	ld	a5,8(s1)
    1590:	f4f43423          	sd	a5,-184(s0)
    ...
    1594:	fb442783          	lw	a5,-76(s0)
    1598:	0007871b          	sext.w	a4,a5
    159c:	800007b7          	lui	a5,0x80000
    15a0:	fff7c793          	not	a5,a5
    15a4:	00f70963          	beq	a4,a5,15b6 <schedule_lst+0x234>
    15a8:	409c                	lw	a5,0(s1)
    15aa:	fb442703          	lw	a4,-76(s0)
    15ae:	40f707bb          	subw	a5,a4,a5
    15b2:	2781                	sext.w	a5,a5
    15b4:	a811                	j	15c8 <schedule_lst+0x246>
    15b6:	689c                	ld	a5,16(s1)
    15b8:	4098                	lw	a4,0(s1)
    15ba:	85ba                	mv	a1,a4
    15bc:	853e                	mv	a0,a5
    15be:	00000097          	auipc	ra,0x0
    15c2:	a72080e7          	jalr	-1422(ra) # 1030 <find_next_release_time>
    15c6:	87aa                	mv	a5,a0
    15c8:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    15cc:	f4843783          	ld	a5,-184(s0)
    15d0:	f4f43c23          	sd	a5,-168(s0)
    15d4:	f5043783          	ld	a5,-176(s0)
    15d8:	f6f43023          	sd	a5,-160(s0)
    15dc:	4701                	li	a4,0
    15de:	f5843703          	ld	a4,-168(s0)
    15e2:	4781                	li	a5,0
    15e4:	f6043783          	ld	a5,-160(s0)
    15e8:	893a                	mv	s2,a4
    15ea:	89be                	mv	s3,a5
    15ec:	874a                	mv	a4,s2
    15ee:	87ce                	mv	a5,s3
    ...
    15f0:	853a                	mv	a0,a4
    15f2:	85be                	mv	a1,a5
    15f4:	70ea                	ld	ra,184(sp)
    15f6:	744a                	ld	s0,176(sp)
    15f8:	74aa                	ld	s1,168(sp)
    15fa:	790a                	ld	s2,160(sp)
    15fc:	69ea                	ld	s3,152(sp)
    15fe:	6129                	addi	sp,sp,192
    1600:	8082                	ret

0000000000001602 <find_earliest_impactful_release_time_dm>:

int find_earliest_impactful_release_time_dm(struct list_head *release_queue, int current_time, int current_deadline) {
    1602:	715d                	addi	sp,sp,-80
    1604:	e4a2                	sd	s0,72(sp)
    1606:	0880                	addi	s0,sp,80
    1608:	faa43c23          	sd	a0,-72(s0)
    160c:	87ae                	mv	a5,a1
    160e:	8732                	mv	a4,a2
    1610:	faf42a23          	sw	a5,-76(s0)
    1614:	87ba                	mv	a5,a4
    1616:	faf42823          	sw	a5,-80(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_event = INT_MAX;
    161a:	800007b7          	lui	a5,0x80000
    161e:	fff7c793          	not	a5,a5
    1622:	fef42223          	sw	a5,-28(s0)
    struct thread *earliest_deadline_thread = NULL;
    1626:	fc043c23          	sd	zero,-40(s0)
    earliest_deadline_thread->ID = INT_MAX;
    162a:	fd843783          	ld	a5,-40(s0)
    162e:	80000737          	lui	a4,0x80000
    1632:	fff74713          	not	a4,a4
    1636:	dfd8                	sw	a4,60(a5)

    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    1638:	fb843783          	ld	a5,-72(s0)
    163c:	639c                	ld	a5,0(a5)
    163e:	fcf43823          	sd	a5,-48(s0)
    1642:	fd043783          	ld	a5,-48(s0)
    1646:	17e1                	addi	a5,a5,-8
    1648:	fef43423          	sd	a5,-24(s0)
    164c:	a075                	j	16f8 <find_earliest_impactful_release_time_dm+0xf6>
        if (entry->release_time > current_time && entry->thrd->period < current_deadline) {
    164e:	fe843783          	ld	a5,-24(s0)
    1652:	4f98                	lw	a4,24(a5)
    1654:	fb442783          	lw	a5,-76(s0)
    1658:	2781                	sext.w	a5,a5
    165a:	02e7d963          	bge	a5,a4,168c <find_earliest_impactful_release_time_dm+0x8a>
    165e:	fe843783          	ld	a5,-24(s0)
    1662:	639c                	ld	a5,0(a5)
    1664:	4bb8                	lw	a4,80(a5)
    1666:	fb042783          	lw	a5,-80(s0)
    166a:	2781                	sext.w	a5,a5
    166c:	02f75063          	bge	a4,a5,168c <find_earliest_impactful_release_time_dm+0x8a>
            if (entry->release_time < earliest_impactful_event) {
    1670:	fe843783          	ld	a5,-24(s0)
    1674:	4f98                	lw	a4,24(a5)
    1676:	fe442783          	lw	a5,-28(s0)
    167a:	2781                	sext.w	a5,a5
    167c:	06f75463          	bge	a4,a5,16e4 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    1680:	fe843783          	ld	a5,-24(s0)
    1684:	4f9c                	lw	a5,24(a5)
    1686:	fef42223          	sw	a5,-28(s0)
            if (entry->release_time < earliest_impactful_event) {
    168a:	a8a9                	j	16e4 <find_earliest_impactful_release_time_dm+0xe2>
            }
        } 
    ...
    1690:	4f98                	lw	a4,24(a5)
    1692:	fb442783          	lw	a5,-76(s0)
    1696:	2781                	sext.w	a5,a5
    1698:	04e7d663          	bge	a5,a4,16e4 <find_earliest_impactful_release_time_dm+0xe2>
    169c:	fe843783          	ld	a5,-24(s0)
    16a0:	639c                	ld	a5,0(a5)
    16a2:	4bb8                	lw	a4,80(a5)
    16a4:	fb042783          	lw	a5,-80(s0)
    16a8:	2781                	sext.w	a5,a5
    16aa:	02e79d63          	bne	a5,a4,16e4 <find_earliest_impactful_release_time_dm+0xe2>
    ...
    16b4:	fe442783          	lw	a5,-28(s0)
    16b8:	2781                	sext.w	a5,a5
    16ba:	02f75563          	bge	a4,a5,16e4 <find_earliest_impactful_release_time_dm+0xe2>
    16be:	fe843783          	ld	a5,-24(s0)
    16c2:	639c                	ld	a5,0(a5)
    16c4:	5fd8                	lw	a4,60(a5)
    16c6:	fd843783          	ld	a5,-40(s0)
    16ca:	5fdc                	lw	a5,60(a5)
    16cc:	00f75c63          	bge	a4,a5,16e4 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    16d0:	fe843783          	ld	a5,-24(s0)
    16d4:	4f9c                	lw	a5,24(a5)
    16d6:	fef42223          	sw	a5,-28(s0)
                earliest_deadline_thread = entry->thrd;
    16da:	fe843783          	ld	a5,-24(s0)
    16de:	639c                	ld	a5,0(a5)
    16e0:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    16e4:	fe843783          	ld	a5,-24(s0)
    16e8:	679c                	ld	a5,8(a5)
    16ea:	fcf43423          	sd	a5,-56(s0)
    16ee:	fc843783          	ld	a5,-56(s0)
    16f2:	17e1                	addi	a5,a5,-8
    16f4:	fef43423          	sd	a5,-24(s0)
    16f8:	fe843783          	ld	a5,-24(s0)
    16fc:	07a1                	addi	a5,a5,8
    16fe:	fb843703          	ld	a4,-72(s0)
    1702:	f4f716e3          	bne	a4,a5,164e <find_earliest_impactful_release_time_dm+0x4c>
            }
        }
    }
    ...
    1716:	00f70563          	beq	a4,a5,1720 <find_earliest_impactful_release_time_dm+0x11e>
    171a:	fe442783          	lw	a5,-28(s0)
    171e:	a011                	j	1722 <find_earliest_impactful_release_time_dm+0x120>
    1720:	57fd                	li	a5,-1
}
    1722:	853e                	mv	a0,a5
    1724:	6426                	ld	s0,72(sp)
    1726:	6161                	addi	sp,sp,80
    1728:	8082                	ret

000000000000172a <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    172a:	7175                	addi	sp,sp,-144
    172c:	e506                	sd	ra,136(sp)
    172e:	e122                	sd	s0,128(sp)
    1730:	fca6                	sd	s1,120(sp)
    1732:	f8ca                	sd	s2,112(sp)
    1734:	f4ce                	sd	s3,104(sp)
    ...
    173e:	800007b7          	lui	a5,0x80000
    1742:	fff7c793          	not	a5,a5
    1746:	faf42e23          	sw	a5,-68(s0)

    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    174a:	649c                	ld	a5,8(s1)
    174c:	639c                	ld	a5,0(a5)
    174e:	faf43823          	sd	a5,-80(s0)
    1752:	fb043783          	ld	a5,-80(s0)
    1756:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdf10>
    175a:	fcf43023          	sd	a5,-64(s0)
    175e:	a089                	j	17a0 <schedule_dm+0x76>
        if (t->is_real_time && t->period < earliest_deadline) {
    1760:	fc043783          	ld	a5,-64(s0)
    1764:	43bc                	lw	a5,64(a5)
    1766:	c395                	beqz	a5,178a <schedule_dm+0x60>
    1768:	fc043783          	ld	a5,-64(s0)
    176c:	4bb8                	lw	a4,80(a5)
    176e:	fbc42783          	lw	a5,-68(s0)
    1772:	2781                	sext.w	a5,a5
    1774:	00f75b63          	bge	a4,a5,178a <schedule_dm+0x60>
            earliest_deadline_thread = t;
    1778:	fc043783          	ld	a5,-64(s0)
    177c:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    1780:	fc043783          	ld	a5,-64(s0)
    1784:	4bbc                	lw	a5,80(a5)
    1786:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    178a:	fc043783          	ld	a5,-64(s0)
    178e:	779c                	ld	a5,40(a5)
    1790:	f8f43c23          	sd	a5,-104(s0)
    1794:	f9843783          	ld	a5,-104(s0)
    1798:	fd878793          	addi	a5,a5,-40
    179c:	fcf43023          	sd	a5,-64(s0)
    17a0:	fc043783          	ld	a5,-64(s0)
    17a4:	02878713          	addi	a4,a5,40
    17a8:	649c                	ld	a5,8(s1)
    17aa:	faf71be3          	bne	a4,a5,1760 <schedule_dm+0x36>
        }
    }
    ...
    17b0:	4098                	lw	a4,0(s1)
    17b2:	fbc42683          	lw	a3,-68(s0)
    17b6:	8636                	mv	a2,a3
    17b8:	85ba                	mv	a1,a4
    17ba:	853e                	mv	a0,a5
    17bc:	00000097          	auipc	ra,0x0
    17c0:	e46080e7          	jalr	-442(ra) # 1602 <find_earliest_impactful_release_time_dm>
    17c4:	87aa                	mv	a5,a0
    17c6:	faf42623          	sw	a5,-84(s0)

    if (earliest_deadline_thread) {
    17ca:	fc843783          	ld	a5,-56(s0)
    17ce:	c3c9                	beqz	a5,1850 <schedule_dm+0x126>
    ...
    17d6:	409c                	lw	a5,0(s1)
    17d8:	40f707bb          	subw	a5,a4,a5
    17dc:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline < 0) {
    17e0:	fa842783          	lw	a5,-88(s0)
    17e4:	2781                	sext.w	a5,a5
    17e6:	0007db63          	bgez	a5,17fc <schedule_dm+0xd2>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    17ea:	fc843783          	ld	a5,-56(s0)
    17ee:	02878793          	addi	a5,a5,40
    17f2:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    17f6:	f8042023          	sw	zero,-128(s0)
    17fa:	a88d                	j	186c <schedule_dm+0x142>
        } else {
    ...
    17fc:	fac42783          	lw	a5,-84(s0)
    1800:	0007871b          	sext.w	a4,a5
    1804:	57fd                	li	a5,-1
    1806:	02f70563          	beq	a4,a5,1830 <schedule_dm+0x106>
    180a:	409c                	lw	a5,0(s1)
    180c:	fac42703          	lw	a4,-84(s0)
    1810:	40f707bb          	subw	a5,a4,a5
    1814:	0007871b          	sext.w	a4,a5
    1818:	fc843783          	ld	a5,-56(s0)
    181c:	4fbc                	lw	a5,88(a5)
    181e:	00f75963          	bge	a4,a5,1830 <schedule_dm+0x106>
    1822:	409c                	lw	a5,0(s1)
    1824:	fac42703          	lw	a4,-84(s0)
    1828:	40f707bb          	subw	a5,a4,a5
    182c:	2781                	sext.w	a5,a5
    182e:	a021                	j	1836 <schedule_dm+0x10c>
    1830:	fc843783          	ld	a5,-56(s0)
    1834:	4fbc                	lw	a5,88(a5)
    1836:	faf42223          	sw	a5,-92(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    183a:	fc843783          	ld	a5,-56(s0)
    183e:	02878793          	addi	a5,a5,40
    1842:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    1846:	fa442783          	lw	a5,-92(s0)
    184a:	f8f42023          	sw	a5,-128(s0)
    184e:	a839                	j	186c <schedule_dm+0x142>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    1850:	649c                	ld	a5,8(s1)
    1852:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1856:	689c                	ld	a5,16(s1)
    1858:	4098                	lw	a4,0(s1)
    185a:	85ba                	mv	a1,a4
    185c:	853e                	mv	a0,a5
    185e:	fffff097          	auipc	ra,0xfffff
    1862:	7d2080e7          	jalr	2002(ra) # 1030 <find_next_release_time>
    1866:	87aa                	mv	a5,a0
    1868:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    186c:	f7843783          	ld	a5,-136(s0)
    1870:	f8f43423          	sd	a5,-120(s0)
    1874:	f8043783          	ld	a5,-128(s0)
    1878:	f8f43823          	sd	a5,-112(s0)
    187c:	4701                	li	a4,0
    187e:	f8843703          	ld	a4,-120(s0)
    1882:	4781                	li	a5,0
    1884:	f9043783          	ld	a5,-112(s0)
    1888:	893a                	mv	s2,a4
    188a:	89be                	mv	s3,a5
    188c:	874a                	mv	a4,s2
    188e:	87ce                	mv	a5,s3
    ...
    1890:	853a                	mv	a0,a4
    1892:	85be                	mv	a1,a5
    1894:	60aa                	ld	ra,136(sp)
    1896:	640a                	ld	s0,128(sp)
    1898:	74e6                	ld	s1,120(sp)
    189a:	7946                	ld	s2,112(sp)
    189c:	79a6                	ld	s3,104(sp)
    189e:	6149                	addi	sp,sp,144
    18a0:	8082                	ret

...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     622:	00268693          	addi	a3,a3,2 # 1620 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     6fc:	f2870713          	addi	a4,a4,-216 # 1620 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     8bc:	d6078793          	addi	a5,a5,-672 # 1618 <schedule_dm+0x20e>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     a68:	be478793          	addi	a5,a5,-1052 # 1648 <freep>
     a6c:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     b60:	aec78793          	addi	a5,a5,-1300 # 1648 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     be2:	a6a78793          	addi	a5,a5,-1430 # 1648 <freep>
     be6:	639c                	ld	a5,0(a5)
}
     be8:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c14:	a3878793          	addi	a5,a5,-1480 # 1648 <freep>
     c18:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     c28:	a1478793          	addi	a5,a5,-1516 # 1638 <base>
     c2c:	fef43023          	sd	a5,-32(s0)
     c30:	00001797          	auipc	a5,0x1
     c34:	a1878793          	addi	a5,a5,-1512 # 1648 <freep>
     c38:	fe043703          	ld	a4,-32(s0)
     c3c:	e398                	sd	a4,0(a5)
     c3e:	00001797          	auipc	a5,0x1
     c42:	a0a78793          	addi	a5,a5,-1526 # 1648 <freep>
     c46:	6398                	ld	a4,0(a5)
     c48:	00001797          	auipc	a5,0x1
     c4c:	9f078793          	addi	a5,a5,-1552 # 1638 <base>
     c50:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     c52:	00001797          	auipc	a5,0x1
     c56:	9e678793          	addi	a5,a5,-1562 # 1638 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     cd2:	97a78793          	addi	a5,a5,-1670 # 1648 <freep>
    ...
    if(p == freep)
     ...
     ce8:	96478793          	addi	a5,a5,-1692 # 1648 <freep>
     cec:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     e80:	7d478793          	addi	a5,a5,2004 # 1650 <last_thread.1226>
     e84:	639c                	ld	a5,0(a5)
     e86:	cb89                	beqz	a5,e98 <schedule_wrr+0x2e>
     e88:	00000797          	auipc	a5,0x0
     e8c:	7c878793          	addi	a5,a5,1992 # 1650 <last_thread.1226>
     e90:	639c                	ld	a5,0(a5)
     e92:	4fbc                	lw	a5,88(a5)
     e94:	00f04863          	bgtz	a5,ea4 <schedule_wrr+0x3a>
        last_thread = NULL;
     e98:	00000797          	auipc	a5,0x0
     e9c:	7b878793          	addi	a5,a5,1976 # 1650 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     ebe:	79678793          	addi	a5,a5,1942 # 1650 <last_thread.1226>
     ec2:	639c                	ld	a5,0(a5)
    ...
    if (selected_thread) {
     ...
     f86:	6ce78793          	addi	a5,a5,1742 # 1650 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    10b8:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe1b8>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    11ea:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe1b8>
    ...
    1284:	a00d                	j	12a6 <schedule_sjf+0x102>
    } else {
    ...
    1294:	57fd                	li	a5,-1
    1296:	00f70563          	beq	a4,a5,12a0 <schedule_sjf+0xfc>
    129a:	fb442783          	lw	a5,-76(s0)
    129e:	a011                	j	12a2 <schedule_sjf+0xfe>
    12a0:	4785                	li	a5,1
    12a2:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    12a6:	f8043783          	ld	a5,-128(s0)
    12aa:	f8f43823          	sd	a5,-112(s0)
    12ae:	f8843783          	ld	a5,-120(s0)
    12b2:	f8f43c23          	sd	a5,-104(s0)
    12b6:	4701                	li	a4,0
    12b8:	f9043703          	ld	a4,-112(s0)
    12bc:	4781                	li	a5,0
    ...
    12ca:	853a                	mv	a0,a4
    12cc:	85be                	mv	a1,a5
    12ce:	70e6                	ld	ra,120(sp)
    12d0:	7446                	ld	s0,112(sp)
    12d2:	74a6                	ld	s1,104(sp)
    12d4:	7906                	ld	s2,96(sp)
    12d6:	69e6                	ld	s3,88(sp)
    12d8:	6109                	addi	sp,sp,128
    12da:	8082                	ret

00000000000012dc <schedule_lst>:
...
{
    12dc:	7119                	addi	sp,sp,-128
    12de:	fc86                	sd	ra,120(sp)
    12e0:	f8a2                	sd	s0,112(sp)
    12e2:	f4a6                	sd	s1,104(sp)
    12e4:	f0ca                	sd	s2,96(sp)
    12e6:	ecce                	sd	s3,88(sp)
    12e8:	0100                	addi	s0,sp,128
    12ea:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the least-slack-time scheduling algorithm
    struct thread *min_slack = NULL;
    12ec:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    12f0:	800007b7          	lui	a5,0x80000
    12f4:	fff7c793          	not	a5,a5
    12f8:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;

    // Find the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    12fc:	649c                	ld	a5,8(s1)
    12fe:	639c                	ld	a5,0(a5)
    1300:	faf43823          	sd	a5,-80(s0)
    1304:	fb043783          	ld	a5,-80(s0)
    1308:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe1b8>
    130c:	faf43c23          	sd	a5,-72(s0)
    1310:	a8b5                	j	138c <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    1312:	fb843783          	ld	a5,-72(s0)
    1316:	47f8                	lw	a4,76(a5)
    1318:	409c                	lw	a5,0(s1)
    131a:	40f707bb          	subw	a5,a4,a5
    131e:	0007871b          	sext.w	a4,a5
    1322:	fb843783          	ld	a5,-72(s0)
    1326:	4fbc                	lw	a5,88(a5)
    1328:	40f707bb          	subw	a5,a4,a5
    132c:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    1330:	fc843783          	ld	a5,-56(s0)
    1334:	cb8d                	beqz	a5,1366 <schedule_lst+0x8a>
    1336:	fac42703          	lw	a4,-84(s0)
    133a:	fc442783          	lw	a5,-60(s0)
    133e:	2701                	sext.w	a4,a4
    1340:	2781                	sext.w	a5,a5
    1342:	02f74263          	blt	a4,a5,1366 <schedule_lst+0x8a>
    1346:	fac42703          	lw	a4,-84(s0)
    134a:	fc442783          	lw	a5,-60(s0)
    134e:	2701                	sext.w	a4,a4
    1350:	2781                	sext.w	a5,a5
    1352:	02f71263          	bne	a4,a5,1376 <schedule_lst+0x9a>
            (slack_time == min_slack_time && t->ID < min_slack->ID)) {
    1356:	fb843783          	ld	a5,-72(s0)
    135a:	5fd8                	lw	a4,60(a5)
    135c:	fc843783          	ld	a5,-56(s0)
    1360:	5fdc                	lw	a5,60(a5)
    1362:	00f75a63          	bge	a4,a5,1376 <schedule_lst+0x9a>
            min_slack = t;
    1366:	fb843783          	ld	a5,-72(s0)
    136a:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    136e:	fac42783          	lw	a5,-84(s0)
    1372:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    ...
    1396:	f6f71ee3          	bne	a4,a5,1312 <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    139a:	fc843783          	ld	a5,-56(s0)
    139e:	cf89                	beqz	a5,13b8 <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    13a0:	fc843783          	ld	a5,-56(s0)
    13a4:	02878793          	addi	a5,a5,40
    13a8:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    13ac:	fc843783          	ld	a5,-56(s0)
    13b0:	4fbc                	lw	a5,88(a5)
    13b2:	f8f42423          	sw	a5,-120(s0)
    13b6:	a839                	j	13d4 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    13b8:	649c                	ld	a5,8(s1)
    ...
    13c0:	4098                	lw	a4,0(s1)
    13c2:	85ba                	mv	a1,a4
    13c4:	853e                	mv	a0,a5
    13c6:	00000097          	auipc	ra,0x0
    13ca:	c08080e7          	jalr	-1016(ra) # fce <find_next_release_time>
    13ce:	87aa                	mv	a5,a0
    13d0:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    13d4:	f8043783          	ld	a5,-128(s0)
    13d8:	f8f43823          	sd	a5,-112(s0)
    13dc:	f8843783          	ld	a5,-120(s0)
    13e0:	f8f43c23          	sd	a5,-104(s0)
    13e4:	4701                	li	a4,0
    13e6:	f9043703          	ld	a4,-112(s0)
    13ea:	4781                	li	a5,0
    13ec:	f9843783          	ld	a5,-104(s0)
    13f0:	893a                	mv	s2,a4
    13f2:	89be                	mv	s3,a5
    13f4:	874a                	mv	a4,s2
    13f6:	87ce                	mv	a5,s3
    ...
    13f8:	853a                	mv	a0,a4
    13fa:	85be                	mv	a1,a5
    13fc:	70e6                	ld	ra,120(sp)
    13fe:	7446                	ld	s0,112(sp)
    1400:	74a6                	ld	s1,104(sp)
    1402:	7906                	ld	s2,96(sp)
    1404:	69e6                	ld	s3,88(sp)
    1406:	6109                	addi	sp,sp,128
    1408:	8082                	ret

000000000000140a <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    140a:	7135                	addi	sp,sp,-160
    140c:	ed06                	sd	ra,152(sp)
    140e:	e922                	sd	s0,144(sp)
    1410:	e526                	sd	s1,136(sp)
    1412:	e14a                	sd	s2,128(sp)
    1414:	fcce                	sd	s3,120(sp)
    1416:	1100                	addi	s0,sp,160
    1418:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    141a:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    141e:	800007b7          	lui	a5,0x80000
    1422:	fff7c793          	not	a5,a5
    1426:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    142a:	649c                	ld	a5,8(s1)
    142c:	639c                	ld	a5,0(a5)
    142e:	faf43423          	sd	a5,-88(s0)
    1432:	fa843783          	ld	a5,-88(s0)
    1436:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe1b8>
    143a:	fcf43023          	sd	a5,-64(s0)
    143e:	a841                	j	14ce <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    1440:	fc043783          	ld	a5,-64(s0)
    1444:	43bc                	lw	a5,64(a5)
    1446:	cb95                	beqz	a5,147a <schedule_dm+0x70>
    1448:	fc043783          	ld	a5,-64(s0)
    144c:	4bbc                	lw	a5,80(a5)
    144e:	873e                	mv	a4,a5
    1450:	57fd                	li	a5,-1
    1452:	02f70463          	beq	a4,a5,147a <schedule_dm+0x70>
    1456:	fc043783          	ld	a5,-64(s0)
    145a:	4ff8                	lw	a4,92(a5)
    145c:	fbc42783          	lw	a5,-68(s0)
    1460:	2781                	sext.w	a5,a5
    1462:	00f75c63          	bge	a4,a5,147a <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    1466:	fc043783          	ld	a5,-64(s0)
    146a:	4ffc                	lw	a5,92(a5)
    146c:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    1470:	fc043783          	ld	a5,-64(s0)
    1474:	fcf43423          	sd	a5,-56(s0)
    1478:	a081                	j	14b8 <schedule_dm+0xae>
    ...
    1502:	fc843783          	ld	a5,-56(s0)
    1506:	02878793          	addi	a5,a5,40
    150a:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0; // Could set to minimal quantum to allow cleanup or logging
    150e:	f6042823          	sw	zero,-144(s0)
    1512:	a0f1                	j	15de <schedule_dm+0x1d4>
        } else {
    ...
    151a:	863e                	mv	a2,a5
    151c:	f9442783          	lw	a5,-108(s0)
    1520:	0007869b          	sext.w	a3,a5
    1524:	0006071b          	sext.w	a4,a2
    1528:	00d75363          	bge	a4,a3,152e <schedule_dm+0x124>
    152c:	87b2                	mv	a5,a2
    152e:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1532:	fc843783          	ld	a5,-56(s0)
    1536:	02878793          	addi	a5,a5,40
    153a:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    153e:	f9042783          	lw	a5,-112(s0)
    1542:	f6f42823          	sw	a5,-144(s0)
    1546:	a861                	j	15de <schedule_dm+0x1d4>
        }
    } else {
    ...
    1548:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    154c:	649c                	ld	a5,8(s1)
    154e:	639c                	ld	a5,0(a5)
    1550:	faf43023          	sd	a5,-96(s0)
    1554:	fa043783          	ld	a5,-96(s0)
    1558:	fd878793          	addi	a5,a5,-40
    155c:	fcf43023          	sd	a5,-64(s0)
    1560:	a81d                	j	1596 <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    1562:	fb043783          	ld	a5,-80(s0)
    1566:	cb89                	beqz	a5,1578 <schedule_dm+0x16e>
    1568:	fc043783          	ld	a5,-64(s0)
    156c:	5fd8                	lw	a4,60(a5)
    156e:	fb043783          	ld	a5,-80(s0)
    1572:	5fdc                	lw	a5,60(a5)
    1574:	00f75663          	bge	a4,a5,1580 <schedule_dm+0x176>
                smallest_id_thread = t;
    1578:	fc043783          	ld	a5,-64(s0)
    157c:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    1580:	fc043783          	ld	a5,-64(s0)
    1584:	779c                	ld	a5,40(a5)
    1586:	f8f43c23          	sd	a5,-104(s0)
    158a:	f9843783          	ld	a5,-104(s0)
    158e:	fd878793          	addi	a5,a5,-40
    1592:	fcf43023          	sd	a5,-64(s0)
    1596:	fc043783          	ld	a5,-64(s0)
    159a:	02878713          	addi	a4,a5,40
    159e:	649c                	ld	a5,8(s1)
    15a0:	fcf711e3          	bne	a4,a5,1562 <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    15a4:	fb043783          	ld	a5,-80(s0)
    15a8:	cf89                	beqz	a5,15c2 <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    15aa:	fb043783          	ld	a5,-80(s0)
    15ae:	02878793          	addi	a5,a5,40
    15b2:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    15b6:	fb043783          	ld	a5,-80(s0)
    15ba:	4fbc                	lw	a5,88(a5)
    15bc:	f6f42823          	sw	a5,-144(s0)
    15c0:	a839                	j	15de <schedule_dm+0x1d4>
        } else {
            // If no thread is ready, perhaps idle or find the next release time
            r.scheduled_thread_list_member = args.run_queue;
    15c2:	649c                	ld	a5,8(s1)
    15c4:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    ...
    15d4:	9fe080e7          	jalr	-1538(ra) # fce <find_next_release_time>
    15d8:	87aa                	mv	a5,a0
    15da:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    15de:	f6843783          	ld	a5,-152(s0)
    15e2:	f6f43c23          	sd	a5,-136(s0)
    15e6:	f7043783          	ld	a5,-144(s0)
    15ea:	f8f43023          	sd	a5,-128(s0)
    15ee:	4701                	li	a4,0
    15f0:	f7843703          	ld	a4,-136(s0)
    15f4:	4781                	li	a5,0
    15f6:	f8043783          	ld	a5,-128(s0)
    15fa:	893a                	mv	s2,a4
    15fc:	89be                	mv	s3,a5
    15fe:	874a                	mv	a4,s2
    1600:	87ce                	mv	a5,s3
    ...
    1602:	853a                	mv	a0,a4
    1604:	85be                	mv	a1,a5
    1606:	60ea                	ld	ra,152(sp)
    1608:	644a                	ld	s0,144(sp)
    160a:	64aa                	ld	s1,136(sp)
    160c:	690a                	ld	s2,128(sp)
    160e:	79e6                	ld	s3,120(sp)
    1610:	610d                	addi	sp,sp,160
    1612:	8082                	ret

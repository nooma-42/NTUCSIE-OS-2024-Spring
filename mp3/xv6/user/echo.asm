...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    if(i + 1 < argc){
      ...
      70:	4d458593          	addi	a1,a1,1236 # 1540 <schedule_dm+0x20a>
      74:	4505                	li	a0,1
      ...
      86:	4c658593          	addi	a1,a1,1222 # 1548 <schedule_dm+0x212>
      8a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6b0:	ed468693          	addi	a3,a3,-300 # 1580 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     78a:	dfa70713          	addi	a4,a4,-518 # 1580 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     94a:	c0a78793          	addi	a5,a5,-1014 # 1550 <schedule_dm+0x21a>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     af6:	ab678793          	addi	a5,a5,-1354 # 15a8 <freep>
     afa:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bee:	9be78793          	addi	a5,a5,-1602 # 15a8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c70:	93c78793          	addi	a5,a5,-1732 # 15a8 <freep>
     c74:	639c                	ld	a5,0(a5)
}
     c76:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     ca2:	90a78793          	addi	a5,a5,-1782 # 15a8 <freep>
     ca6:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     cb6:	8e678793          	addi	a5,a5,-1818 # 1598 <base>
     cba:	fef43023          	sd	a5,-32(s0)
     cbe:	00001797          	auipc	a5,0x1
     cc2:	8ea78793          	addi	a5,a5,-1814 # 15a8 <freep>
     cc6:	fe043703          	ld	a4,-32(s0)
     cca:	e398                	sd	a4,0(a5)
     ccc:	00001797          	auipc	a5,0x1
     cd0:	8dc78793          	addi	a5,a5,-1828 # 15a8 <freep>
     cd4:	6398                	ld	a4,0(a5)
     cd6:	00001797          	auipc	a5,0x1
     cda:	8c278793          	addi	a5,a5,-1854 # 1598 <base>
     cde:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     ce0:	00001797          	auipc	a5,0x1
     ce4:	8b878793          	addi	a5,a5,-1864 # 1598 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d60:	84c78793          	addi	a5,a5,-1972 # 15a8 <freep>
    ...
    if(p == freep)
     ...
     d76:	83678793          	addi	a5,a5,-1994 # 15a8 <freep>
     d7a:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     f0e:	6a678793          	addi	a5,a5,1702 # 15b0 <last_thread.1226>
     f12:	639c                	ld	a5,0(a5)
     f14:	cb89                	beqz	a5,f26 <schedule_wrr+0x2e>
     f16:	00000797          	auipc	a5,0x0
     f1a:	69a78793          	addi	a5,a5,1690 # 15b0 <last_thread.1226>
     f1e:	639c                	ld	a5,0(a5)
     f20:	4fbc                	lw	a5,88(a5)
     f22:	00f04863          	bgtz	a5,f32 <schedule_wrr+0x3a>
        last_thread = NULL;
     f26:	00000797          	auipc	a5,0x0
     f2a:	68a78793          	addi	a5,a5,1674 # 15b0 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     f4c:	66878793          	addi	a5,a5,1640 # 15b0 <last_thread.1226>
     f50:	639c                	ld	a5,0(a5)
    ...
    1014:	5a078793          	addi	a5,a5,1440 # 15b0 <last_thread.1226>
...
000000000000105c <schedule_sjf>:

struct threads_sched_result schedule_sjf(struct threads_sched_args args)
{
    105c:	7119                	addi	sp,sp,-128
    105e:	fc86                	sd	ra,120(sp)
    1060:	f8a2                	sd	s0,112(sp)
    1062:	f4a6                	sd	s1,104(sp)
    1064:	f0ca                	sd	s2,96(sp)
    1066:	ecce                	sd	s3,88(sp)
    1068:	0100                	addi	s0,sp,128
    106a:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the shortest-job-first scheduling algorithm
    struct thread *shortest_job = NULL;
    106c:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    ...
    1080:	faf43823          	sd	a5,-80(s0)
    1084:	fb043783          	ld	a5,-80(s0)
    1088:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe258>
    108c:	fcf43023          	sd	a5,-64(s0)
    1090:	a8a9                	j	10ea <schedule_sjf+0x8e>
        printf("Thread ID: %d, Remaining Time: %d\n", t->ID, t->remaining_time);
    1092:	fc043783          	ld	a5,-64(s0)
    1096:	5fd8                	lw	a4,60(a5)
    1098:	fc043783          	ld	a5,-64(s0)
    109c:	4fbc                	lw	a5,88(a5)
    109e:	863e                	mv	a2,a5
    10a0:	85ba                	mv	a1,a4
    10a2:	00000517          	auipc	a0,0x0
    10a6:	4b650513          	addi	a0,a0,1206 # 1558 <schedule_dm+0x222>
    10aa:	00000097          	auipc	ra,0x0
    10ae:	9e4080e7          	jalr	-1564(ra) # a8e <printf>
        if (t->remaining_time < shortest_time) {
    10b2:	fc043783          	ld	a5,-64(s0)
    10b6:	4fb8                	lw	a4,88(a5)
    10b8:	fbc42783          	lw	a5,-68(s0)
    10bc:	2781                	sext.w	a5,a5
    10be:	00f75b63          	bge	a4,a5,10d4 <schedule_sjf+0x78>
            shortest_time = t->remaining_time;
    10c2:	fc043783          	ld	a5,-64(s0)
    10c6:	4fbc                	lw	a5,88(a5)
    10c8:	faf42e23          	sw	a5,-68(s0)
            shortest_job = t;
    10cc:	fc043783          	ld	a5,-64(s0)
    10d0:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    10d4:	fc043783          	ld	a5,-64(s0)
    10d8:	779c                	ld	a5,40(a5)
    10da:	faf43423          	sd	a5,-88(s0)
    10de:	fa843783          	ld	a5,-88(s0)
    10e2:	fd878793          	addi	a5,a5,-40
    10e6:	fcf43023          	sd	a5,-64(s0)
    10ea:	fc043783          	ld	a5,-64(s0)
    10ee:	02878713          	addi	a4,a5,40
    10f2:	649c                	ld	a5,8(s1)
    10f4:	f8f71fe3          	bne	a4,a5,1092 <schedule_sjf+0x36>
        }
    }

    if (shortest_job) {
    10f8:	fc843783          	ld	a5,-56(s0)
    10fc:	cf89                	beqz	a5,1116 <schedule_sjf+0xba>
        r.scheduled_thread_list_member = &shortest_job->thread_list;
    10fe:	fc843783          	ld	a5,-56(s0)
    1102:	02878793          	addi	a5,a5,40
    1106:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = shortest_job->remaining_time;  // Allow the thread to run to completion
    110a:	fc843783          	ld	a5,-56(s0)
    110e:	4fbc                	lw	a5,88(a5)
    1110:	f8f42823          	sw	a5,-112(s0)
    1114:	a039                	j	1122 <schedule_sjf+0xc6>
    } else {
        // If no threads are ready, find the next release time or idle
        r.scheduled_thread_list_member = args.run_queue;
    1116:	649c                	ld	a5,8(s1)
    1118:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;  // Default minimal quantum if unsure
    111c:	4785                	li	a5,1
    111e:	f8f42823          	sw	a5,-112(s0)
    }
    return r;
    1122:	f8843783          	ld	a5,-120(s0)
    1126:	f8f43c23          	sd	a5,-104(s0)
    112a:	f9043783          	ld	a5,-112(s0)
    112e:	faf43023          	sd	a5,-96(s0)
    1132:	4701                	li	a4,0
    1134:	f9843703          	ld	a4,-104(s0)
    1138:	4781                	li	a5,0
...
int find_next_release_time(struct list_head *release_queue, int current_time) {
    ...
    117e:	fcf43c23          	sd	a5,-40(s0)
    1182:	fd843783          	ld	a5,-40(s0)
    1186:	17e1                	addi	a5,a5,-8
    1188:	fef43423          	sd	a5,-24(s0)
    118c:	a081                	j	11cc <find_next_release_time+0x74>
        if (next_release->release_time > current_time &&
    118e:	fe843783          	ld	a5,-24(s0)
    1192:	4f98                	lw	a4,24(a5)
    1194:	fc442783          	lw	a5,-60(s0)
    1198:	2781                	sext.w	a5,a5
    119a:	00e7df63          	bge	a5,a4,11b8 <find_next_release_time+0x60>
            next_release->release_time < next_release_time) {
    119e:	fe843783          	ld	a5,-24(s0)
    11a2:	4f98                	lw	a4,24(a5)
        if (next_release->release_time > current_time &&
    11a4:	fe442783          	lw	a5,-28(s0)
    11a8:	2781                	sext.w	a5,a5
    11aa:	00f75763          	bge	a4,a5,11b8 <find_next_release_time+0x60>
    ...
    11be:	fcf43823          	sd	a5,-48(s0)
    11c2:	fd043783          	ld	a5,-48(s0)
    11c6:	17e1                	addi	a5,a5,-8
    11c8:	fef43423          	sd	a5,-24(s0)
    11cc:	fe843783          	ld	a5,-24(s0)
    11d0:	07a1                	addi	a5,a5,8
    11d2:	fc843703          	ld	a4,-56(s0)
    11d6:	faf71ce3          	bne	a4,a5,118e <find_next_release_time+0x36>
        }
    }
    ...
    11ea:	00f71463          	bne	a4,a5,11f2 <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    11ee:	57fd                	li	a5,-1
    11f0:	a801                	j	1200 <find_next_release_time+0xa8>

    return next_release_time - current_time;
    11f2:	fe442703          	lw	a4,-28(s0)
    11f6:	fc442783          	lw	a5,-60(s0)
    11fa:	40f707bb          	subw	a5,a4,a5
    11fe:	2781                	sext.w	a5,a5
}
    1200:	853e                	mv	a0,a5
    1202:	7462                	ld	s0,56(sp)
    1204:	6121                	addi	sp,sp,64
    1206:	8082                	ret

0000000000001208 <schedule_lst>:
...
struct threads_sched_result schedule_lst(struct threads_sched_args args)
{
    ...
    1224:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;

    // Find the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    1228:	649c                	ld	a5,8(s1)
    122a:	639c                	ld	a5,0(a5)
    122c:	faf43823          	sd	a5,-80(s0)
    1230:	fb043783          	ld	a5,-80(s0)
    1234:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe258>
    1238:	faf43c23          	sd	a5,-72(s0)
    123c:	a8b5                	j	12b8 <schedule_lst+0xb0>
        int slack_time = t->deadline - args.current_time - t->remaining_time;
    123e:	fb843783          	ld	a5,-72(s0)
    1242:	47f8                	lw	a4,76(a5)
    1244:	409c                	lw	a5,0(s1)
    1246:	40f707bb          	subw	a5,a4,a5
    124a:	0007871b          	sext.w	a4,a5
    124e:	fb843783          	ld	a5,-72(s0)
    1252:	4fbc                	lw	a5,88(a5)
    1254:	40f707bb          	subw	a5,a4,a5
    1258:	faf42623          	sw	a5,-84(s0)
        if (min_slack == NULL || slack_time < min_slack_time ||
    125c:	fc843783          	ld	a5,-56(s0)
    1260:	cb8d                	beqz	a5,1292 <schedule_lst+0x8a>
    1262:	fac42703          	lw	a4,-84(s0)
    1266:	fc442783          	lw	a5,-60(s0)
    126a:	2701                	sext.w	a4,a4
    126c:	2781                	sext.w	a5,a5
    126e:	02f74263          	blt	a4,a5,1292 <schedule_lst+0x8a>
    1272:	fac42703          	lw	a4,-84(s0)
    1276:	fc442783          	lw	a5,-60(s0)
    127a:	2701                	sext.w	a4,a4
    127c:	2781                	sext.w	a5,a5
    127e:	02f71263          	bne	a4,a5,12a2 <schedule_lst+0x9a>
    ...
    128e:	00f75a63          	bge	a4,a5,12a2 <schedule_lst+0x9a>
            min_slack = t;
    1292:	fb843783          	ld	a5,-72(s0)
    1296:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    129a:	fac42783          	lw	a5,-84(s0)
    129e:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    12a2:	fb843783          	ld	a5,-72(s0)
    12a6:	779c                	ld	a5,40(a5)
    12a8:	faf43023          	sd	a5,-96(s0)
    12ac:	fa043783          	ld	a5,-96(s0)
    12b0:	fd878793          	addi	a5,a5,-40
    12b4:	faf43c23          	sd	a5,-72(s0)
    12b8:	fb843783          	ld	a5,-72(s0)
    12bc:	02878713          	addi	a4,a5,40
    12c0:	649c                	ld	a5,8(s1)
    12c2:	f6f71ee3          	bne	a4,a5,123e <schedule_lst+0x36>
        }
    }

    if (min_slack) {
    12c6:	fc843783          	ld	a5,-56(s0)
    12ca:	cf89                	beqz	a5,12e4 <schedule_lst+0xdc>
        r.scheduled_thread_list_member = &min_slack->thread_list;
    12cc:	fc843783          	ld	a5,-56(s0)
    12d0:	02878793          	addi	a5,a5,40
    12d4:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = min_slack->remaining_time;
    12d8:	fc843783          	ld	a5,-56(s0)
    12dc:	4fbc                	lw	a5,88(a5)
    12de:	f8f42423          	sw	a5,-120(s0)
    12e2:	a839                	j	1300 <schedule_lst+0xf8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    12e4:	649c                	ld	a5,8(s1)
    12e6:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    12ea:	689c                	ld	a5,16(s1)
    12ec:	4098                	lw	a4,0(s1)
    12ee:	85ba                	mv	a1,a4
    12f0:	853e                	mv	a0,a5
    12f2:	00000097          	auipc	ra,0x0
    12f6:	e66080e7          	jalr	-410(ra) # 1158 <find_next_release_time>
    12fa:	87aa                	mv	a5,a0
    12fc:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    1300:	f8043783          	ld	a5,-128(s0)
    1304:	f8f43823          	sd	a5,-112(s0)
    1308:	f8843783          	ld	a5,-120(s0)
    130c:	f8f43c23          	sd	a5,-104(s0)
    1310:	4701                	li	a4,0
    1312:	f9043703          	ld	a4,-112(s0)
    1316:	4781                	li	a5,0
    ...
    1332:	6109                	addi	sp,sp,128
    1334:	8082                	ret

0000000000001336 <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    1336:	7135                	addi	sp,sp,-160
    1338:	ed06                	sd	ra,152(sp)
    133a:	e922                	sd	s0,144(sp)
    133c:	e526                	sd	s1,136(sp)
    133e:	e14a                	sd	s2,128(sp)
    1340:	fcce                	sd	s3,120(sp)
    1342:	1100                	addi	s0,sp,160
    1344:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    // TODO: implement the deadline-monotonic scheduling algorithm
   struct thread *earliest_deadline_thread = NULL;
    1346:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    134a:	800007b7          	lui	a5,0x80000
    134e:	fff7c793          	not	a5,a5
    1352:	faf42e23          	sw	a5,-68(s0)

    // Find the earliest deadline real-time thread
    list_for_each_entry(t, args.run_queue, thread_list) {
    1356:	649c                	ld	a5,8(s1)
    1358:	639c                	ld	a5,0(a5)
    135a:	faf43423          	sd	a5,-88(s0)
    135e:	fa843783          	ld	a5,-88(s0)
    1362:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffe258>
    1366:	fcf43023          	sd	a5,-64(s0)
    136a:	a841                	j	13fa <schedule_dm+0xc4>
        if (t->is_real_time && t->period != -1 && t->current_deadline < earliest_deadline) {
    136c:	fc043783          	ld	a5,-64(s0)
    1370:	43bc                	lw	a5,64(a5)
    1372:	cb95                	beqz	a5,13a6 <schedule_dm+0x70>
    1374:	fc043783          	ld	a5,-64(s0)
    1378:	4bbc                	lw	a5,80(a5)
    137a:	873e                	mv	a4,a5
    137c:	57fd                	li	a5,-1
    137e:	02f70463          	beq	a4,a5,13a6 <schedule_dm+0x70>
    1382:	fc043783          	ld	a5,-64(s0)
    1386:	4ff8                	lw	a4,92(a5)
    1388:	fbc42783          	lw	a5,-68(s0)
    138c:	2781                	sext.w	a5,a5
    138e:	00f75c63          	bge	a4,a5,13a6 <schedule_dm+0x70>
            earliest_deadline = t->current_deadline;
    1392:	fc043783          	ld	a5,-64(s0)
    1396:	4ffc                	lw	a5,92(a5)
    1398:	faf42e23          	sw	a5,-68(s0)
            earliest_deadline_thread = t;
    139c:	fc043783          	ld	a5,-64(s0)
    13a0:	fcf43423          	sd	a5,-56(s0)
    13a4:	a081                	j	13e4 <schedule_dm+0xae>
    ...
    13aa:	43bc                	lw	a5,64(a5)
    13ac:	cf85                	beqz	a5,13e4 <schedule_dm+0xae>
    13ae:	fc043783          	ld	a5,-64(s0)
    13b2:	4bbc                	lw	a5,80(a5)
    13b4:	873e                	mv	a4,a5
    13b6:	57fd                	li	a5,-1
    13b8:	02f70663          	beq	a4,a5,13e4 <schedule_dm+0xae>
    13bc:	fc043783          	ld	a5,-64(s0)
    13c0:	4ff8                	lw	a4,92(a5)
    13c2:	fbc42783          	lw	a5,-68(s0)
    13c6:	2781                	sext.w	a5,a5
    13c8:	00e79e63          	bne	a5,a4,13e4 <schedule_dm+0xae>
    13cc:	fc043783          	ld	a5,-64(s0)
    13d0:	5fd8                	lw	a4,60(a5)
    13d2:	fc843783          	ld	a5,-56(s0)
    13d6:	5fdc                	lw	a5,60(a5)
    13d8:	00f75663          	bge	a4,a5,13e4 <schedule_dm+0xae>
            earliest_deadline_thread = t;  // Tie-breaking by ID
    13dc:	fc043783          	ld	a5,-64(s0)
    13e0:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    13e4:	fc043783          	ld	a5,-64(s0)
    13e8:	779c                	ld	a5,40(a5)
    13ea:	f8f43423          	sd	a5,-120(s0)
    13ee:	f8843783          	ld	a5,-120(s0)
    13f2:	fd878793          	addi	a5,a5,-40
    13f6:	fcf43023          	sd	a5,-64(s0)
    13fa:	fc043783          	ld	a5,-64(s0)
    13fe:	02878713          	addi	a4,a5,40
    1402:	649c                	ld	a5,8(s1)
    1404:	f6f714e3          	bne	a4,a5,136c <schedule_dm+0x36>
        }
    }

    if (earliest_deadline_thread) {
    1408:	fc843783          	ld	a5,-56(s0)
    140c:	c7a5                	beqz	a5,1474 <schedule_dm+0x13e>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    140e:	fc843783          	ld	a5,-56(s0)
    1412:	4ff8                	lw	a4,92(a5)
    1414:	409c                	lw	a5,0(s1)
    1416:	40f707bb          	subw	a5,a4,a5
    141a:	f8f42a23          	sw	a5,-108(s0)
        if (earliest_deadline_thread->remaining_time > time_to_deadline) {
    141e:	fc843783          	ld	a5,-56(s0)
    1422:	4fb8                	lw	a4,88(a5)
    1424:	f9442783          	lw	a5,-108(s0)
    1428:	2781                	sext.w	a5,a5
    142a:	00e7db63          	bge	a5,a4,1440 <schedule_dm+0x10a>
    ...
    143a:	f6042823          	sw	zero,-144(s0)
    143e:	a0f1                	j	150a <schedule_dm+0x1d4>
        } else {
    ...
    1446:	863e                	mv	a2,a5
    1448:	f9442783          	lw	a5,-108(s0)
    144c:	0007869b          	sext.w	a3,a5
    1450:	0006071b          	sext.w	a4,a2
    1454:	00d75363          	bge	a4,a3,145a <schedule_dm+0x124>
    1458:	87b2                	mv	a5,a2
    145a:	f8f42823          	sw	a5,-112(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    145e:	fc843783          	ld	a5,-56(s0)
    1462:	02878793          	addi	a5,a5,40
    1466:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = time_slice;
    146a:	f9042783          	lw	a5,-112(s0)
    146e:	f6f42823          	sw	a5,-144(s0)
    1472:	a861                	j	150a <schedule_dm+0x1d4>
        }
    } else {
    ...
    1474:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    1478:	649c                	ld	a5,8(s1)
    147a:	639c                	ld	a5,0(a5)
    147c:	faf43023          	sd	a5,-96(s0)
    1480:	fa043783          	ld	a5,-96(s0)
    1484:	fd878793          	addi	a5,a5,-40
    1488:	fcf43023          	sd	a5,-64(s0)
    148c:	a81d                	j	14c2 <schedule_dm+0x18c>
            if (smallest_id_thread == NULL || t->ID < smallest_id_thread->ID) {
    148e:	fb043783          	ld	a5,-80(s0)
    1492:	cb89                	beqz	a5,14a4 <schedule_dm+0x16e>
    1494:	fc043783          	ld	a5,-64(s0)
    1498:	5fd8                	lw	a4,60(a5)
    149a:	fb043783          	ld	a5,-80(s0)
    149e:	5fdc                	lw	a5,60(a5)
    14a0:	00f75663          	bge	a4,a5,14ac <schedule_dm+0x176>
                smallest_id_thread = t;
    14a4:	fc043783          	ld	a5,-64(s0)
    14a8:	faf43823          	sd	a5,-80(s0)
        list_for_each_entry(t, args.run_queue, thread_list) {
    14ac:	fc043783          	ld	a5,-64(s0)
    14b0:	779c                	ld	a5,40(a5)
    14b2:	f8f43c23          	sd	a5,-104(s0)
    14b6:	f9843783          	ld	a5,-104(s0)
    14ba:	fd878793          	addi	a5,a5,-40
    14be:	fcf43023          	sd	a5,-64(s0)
    14c2:	fc043783          	ld	a5,-64(s0)
    14c6:	02878713          	addi	a4,a5,40
    14ca:	649c                	ld	a5,8(s1)
    14cc:	fcf711e3          	bne	a4,a5,148e <schedule_dm+0x158>
            }
        }

        if (smallest_id_thread) {
    14d0:	fb043783          	ld	a5,-80(s0)
    14d4:	cf89                	beqz	a5,14ee <schedule_dm+0x1b8>
            r.scheduled_thread_list_member = &smallest_id_thread->thread_list;
    14d6:	fb043783          	ld	a5,-80(s0)
    14da:	02878793          	addi	a5,a5,40
    14de:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = smallest_id_thread->remaining_time;
    14e2:	fb043783          	ld	a5,-80(s0)
    14e6:	4fbc                	lw	a5,88(a5)
    14e8:	f6f42823          	sw	a5,-144(s0)
    14ec:	a839                	j	150a <schedule_dm+0x1d4>
        } else {
    ...
    14f0:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    14f4:	689c                	ld	a5,16(s1)
    14f6:	4098                	lw	a4,0(s1)
    14f8:	85ba                	mv	a1,a4
    14fa:	853e                	mv	a0,a5
    14fc:	00000097          	auipc	ra,0x0
    1500:	c5c080e7          	jalr	-932(ra) # 1158 <find_next_release_time>
    1504:	87aa                	mv	a5,a0
    1506:	f6f42823          	sw	a5,-144(s0)
        }
    }

    return r;
    150a:	f6843783          	ld	a5,-152(s0)
    150e:	f6f43c23          	sd	a5,-136(s0)
    1512:	f7043783          	ld	a5,-144(s0)
    1516:	f8f43023          	sd	a5,-128(s0)
    151a:	4701                	li	a4,0
    151c:	f7843703          	ld	a4,-136(s0)
    1520:	4781                	li	a5,0
    1522:	f8043783          	ld	a5,-128(s0)
    1526:	893a                	mv	s2,a4
    1528:	89be                	mv	s3,a5
    152a:	874a                	mv	a4,s2
    152c:	87ce                	mv	a5,s3
    ...
    152e:	853a                	mv	a0,a4
    1530:	85be                	mv	a1,a5
    1532:	60ea                	ld	ra,152(sp)
    1534:	644a                	ld	s0,144(sp)
    1536:	64aa                	ld	s1,136(sp)
    1538:	690a                	ld	s2,128(sp)
    153a:	79e6                	ld	s3,120(sp)
    153c:	610d                	addi	sp,sp,160
    153e:	8082                	ret

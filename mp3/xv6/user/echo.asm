...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    if(i + 1 < argc){
      ...
      70:	86458593          	addi	a1,a1,-1948 # 18d0 <schedule_dm+0x17a>
      74:	4505                	li	a0,1
      ...
      86:	85658593          	addi	a1,a1,-1962 # 18d8 <schedule_dm+0x182>
      8a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6b0:	23c68693          	addi	a3,a3,572 # 18e8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     78a:	16270713          	addi	a4,a4,354 # 18e8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     94a:	f9a78793          	addi	a5,a5,-102 # 18e0 <schedule_dm+0x18a>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     af6:	e1e78793          	addi	a5,a5,-482 # 1910 <freep>
     afa:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bee:	d2678793          	addi	a5,a5,-730 # 1910 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c70:	ca478793          	addi	a5,a5,-860 # 1910 <freep>
     c74:	639c                	ld	a5,0(a5)
}
     c76:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     ca2:	c7278793          	addi	a5,a5,-910 # 1910 <freep>
     ca6:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     cb6:	c4e78793          	addi	a5,a5,-946 # 1900 <base>
     cba:	fef43023          	sd	a5,-32(s0)
     cbe:	00001797          	auipc	a5,0x1
     cc2:	c5278793          	addi	a5,a5,-942 # 1910 <freep>
     cc6:	fe043703          	ld	a4,-32(s0)
     cca:	e398                	sd	a4,0(a5)
     ccc:	00001797          	auipc	a5,0x1
     cd0:	c4478793          	addi	a5,a5,-956 # 1910 <freep>
     cd4:	6398                	ld	a4,0(a5)
     cd6:	00001797          	auipc	a5,0x1
     cda:	c2a78793          	addi	a5,a5,-982 # 1900 <base>
     cde:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     ce0:	00001797          	auipc	a5,0x1
     ce4:	c2078793          	addi	a5,a5,-992 # 1900 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d60:	bb478793          	addi	a5,a5,-1100 # 1910 <freep>
    ...
    if(p == freep)
     ...
     d76:	b9e78793          	addi	a5,a5,-1122 # 1910 <freep>
     d7a:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     f0e:	a0e78793          	addi	a5,a5,-1522 # 1918 <last_thread.1226>
     f12:	639c                	ld	a5,0(a5)
     f14:	cb89                	beqz	a5,f26 <schedule_wrr+0x2e>
     f16:	00001797          	auipc	a5,0x1
     f1a:	a0278793          	addi	a5,a5,-1534 # 1918 <last_thread.1226>
     f1e:	639c                	ld	a5,0(a5)
     f20:	4fbc                	lw	a5,88(a5)
     f22:	00f04863          	bgtz	a5,f32 <schedule_wrr+0x3a>
        last_thread = NULL;
     f26:	00001797          	auipc	a5,0x1
     f2a:	9f278793          	addi	a5,a5,-1550 # 1918 <last_thread.1226>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     f4c:	9d078793          	addi	a5,a5,-1584 # 1918 <last_thread.1226>
     f50:	639c                	ld	a5,0(a5)
    ...
    1014:	90878793          	addi	a5,a5,-1784 # 1918 <last_thread.1226>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    1146:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdef0>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    1278:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdef0>
    ...
    1312:	a80d                	j	1344 <schedule_sjf+0x112>
    } else {
    ...
    1322:	57fd                	li	a5,-1
    1324:	00f71c63          	bne	a4,a5,133c <schedule_sjf+0x10a>
    1328:	689c                	ld	a5,16(s1)
    132a:	4098                	lw	a4,0(s1)
    132c:	85ba                	mv	a1,a4
    132e:	853e                	mv	a0,a5
    1330:	00000097          	auipc	ra,0x0
    1334:	d2c080e7          	jalr	-724(ra) # 105c <find_next_release_time>
    1338:	87aa                	mv	a5,a0
    133a:	a019                	j	1340 <schedule_sjf+0x10e>
    133c:	fb442783          	lw	a5,-76(s0)
    1340:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    1344:	f8043783          	ld	a5,-128(s0)
    1348:	f8f43823          	sd	a5,-112(s0)
    134c:	f8843783          	ld	a5,-120(s0)
    1350:	f8f43c23          	sd	a5,-104(s0)
    1354:	4701                	li	a4,0
    1356:	f9043703          	ld	a4,-112(s0)
    135a:	4781                	li	a5,0
    135c:	f9843783          	ld	a5,-104(s0)
    1360:	893a                	mv	s2,a4
    1362:	89be                	mv	s3,a5
    1364:	874a                	mv	a4,s2
    1366:	87ce                	mv	a5,s3
...
000000000000137a <min>:

int min(int a, int b) {
    137a:	1101                	addi	sp,sp,-32
    137c:	ec22                	sd	s0,24(sp)
    137e:	1000                	addi	s0,sp,32
    1380:	87aa                	mv	a5,a0
    1382:	872e                	mv	a4,a1
    1384:	fef42623          	sw	a5,-20(s0)
    1388:	87ba                	mv	a5,a4
    138a:	fef42423          	sw	a5,-24(s0)
    return (a < b) ? a : b;
    138e:	fec42603          	lw	a2,-20(s0)
    1392:	fe842783          	lw	a5,-24(s0)
    1396:	0007869b          	sext.w	a3,a5
    139a:	0006071b          	sext.w	a4,a2
    139e:	00d75363          	bge	a4,a3,13a4 <min+0x2a>
    13a2:	87b2                	mv	a5,a2
    13a4:	2781                	sext.w	a5,a5
}
    13a6:	853e                	mv	a0,a5
    13a8:	6462                	ld	s0,24(sp)
    13aa:	6105                	addi	sp,sp,32
    13ac:	8082                	ret

00000000000013ae <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    13ae:	7131                	addi	sp,sp,-192
    13b0:	fd06                	sd	ra,184(sp)
    13b2:	f922                	sd	s0,176(sp)
    13b4:	f526                	sd	s1,168(sp)
    13b6:	f14a                	sd	s2,160(sp)
    13b8:	ed4e                	sd	s3,152(sp)
    13ba:	0180                	addi	s0,sp,192
    13bc:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *min_slack_thread = NULL;
    13be:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    13c2:	800007b7          	lui	a5,0x80000
    13c6:	fff7c793          	not	a5,a5
    13ca:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;
    // int ddl;
    ...
    13d2:	faf43023          	sd	a5,-96(s0)
    13d6:	fa043783          	ld	a5,-96(s0)
    13da:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdef0>
    13de:	faf43c23          	sd	a5,-72(s0)
    13e2:	a069                	j	146c <schedule_lst+0xbe>
    ...
    13f8:	4fbc                	lw	a5,88(a5)
    13fa:	40f707bb          	subw	a5,a4,a5
    13fe:	f6f42a23          	sw	a5,-140(s0)
    ...
    140e:	02f74c63          	blt	a4,a5,1446 <schedule_lst+0x98>
    1412:	f7442703          	lw	a4,-140(s0)
    1416:	fc442783          	lw	a5,-60(s0)
    141a:	2701                	sext.w	a4,a4
    141c:	2781                	sext.w	a5,a5
    141e:	02f71c63          	bne	a4,a5,1456 <schedule_lst+0xa8>
    1422:	fb843783          	ld	a5,-72(s0)
    1426:	5fd4                	lw	a3,60(a5)
    1428:	fc843783          	ld	a5,-56(s0)
    142c:	c789                	beqz	a5,1436 <schedule_lst+0x88>
    142e:	fc843783          	ld	a5,-56(s0)
    1432:	5fdc                	lw	a5,60(a5)
    1434:	a029                	j	143e <schedule_lst+0x90>
    1436:	800007b7          	lui	a5,0x80000
    143a:	fff7c793          	not	a5,a5
    143e:	873e                	mv	a4,a5
    1440:	87b6                	mv	a5,a3
    1442:	00e7da63          	bge	a5,a4,1456 <schedule_lst+0xa8>
            min_slack_thread = t;
    1446:	fb843783          	ld	a5,-72(s0)
    144a:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    144e:	f7442783          	lw	a5,-140(s0)
    1452:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1456:	fb843783          	ld	a5,-72(s0)
    145a:	779c                	ld	a5,40(a5)
    145c:	f6f43423          	sd	a5,-152(s0)
    1460:	f6843783          	ld	a5,-152(s0)
    1464:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdef0>
    1468:	faf43c23          	sd	a5,-72(s0)
    146c:	fb843783          	ld	a5,-72(s0)
    1470:	02878713          	addi	a4,a5,40
    1474:	649c                	ld	a5,8(s1)
    1476:	f6f717e3          	bne	a4,a5,13e4 <schedule_lst+0x36>
    ...
    14d2:	f8442703          	lw	a4,-124(s0)
    14d6:	fc442783          	lw	a5,-60(s0)
    14da:	2701                	sext.w	a4,a4
    14dc:	2781                	sext.w	a5,a5
    14de:	02f75163          	bge	a4,a5,1500 <schedule_lst+0x152>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    14e2:	fa843783          	ld	a5,-88(s0)
    14e6:	4f98                	lw	a4,24(a5)
    14e8:	fb442783          	lw	a5,-76(s0)
    14ec:	85ba                	mv	a1,a4
    14ee:	853e                	mv	a0,a5
    14f0:	00000097          	auipc	ra,0x0
    14f4:	e8a080e7          	jalr	-374(ra) # 137a <min>
    14f8:	87aa                	mv	a5,a0
    14fa:	faf42a23          	sw	a5,-76(s0)
    14fe:	a889                	j	1550 <schedule_lst+0x1a2>
            } else if (upcoming_slack_time == min_slack_time && upcoming_thread->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))
    1500:	f8442703          	lw	a4,-124(s0)
    1504:	fc442783          	lw	a5,-60(s0)
    1508:	2701                	sext.w	a4,a4
    150a:	2781                	sext.w	a5,a5
    150c:	04f71263          	bne	a4,a5,1550 <schedule_lst+0x1a2>
    1510:	f8843783          	ld	a5,-120(s0)
    1514:	5fd4                	lw	a3,60(a5)
    1516:	fc843783          	ld	a5,-56(s0)
    151a:	c789                	beqz	a5,1524 <schedule_lst+0x176>
    151c:	fc843783          	ld	a5,-56(s0)
    1520:	5fdc                	lw	a5,60(a5)
    1522:	a029                	j	152c <schedule_lst+0x17e>
    1524:	800007b7          	lui	a5,0x80000
    1528:	fff7c793          	not	a5,a5
    152c:	873e                	mv	a4,a5
    152e:	87b6                	mv	a5,a3
    1530:	02e7d063          	bge	a5,a4,1550 <schedule_lst+0x1a2>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    1534:	fa843783          	ld	a5,-88(s0)
    1538:	4f98                	lw	a4,24(a5)
    153a:	fb442783          	lw	a5,-76(s0)
    153e:	85ba                	mv	a1,a4
    1540:	853e                	mv	a0,a5
    1542:	00000097          	auipc	ra,0x0
    1546:	e38080e7          	jalr	-456(ra) # 137a <min>
    154a:	87aa                	mv	a5,a0
    154c:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(entry, args.release_queue, thread_list) {
    1550:	fa843783          	ld	a5,-88(s0)
    1554:	679c                	ld	a5,8(a5)
    1556:	f6f43c23          	sd	a5,-136(s0)
    155a:	f7843783          	ld	a5,-136(s0)
    155e:	17e1                	addi	a5,a5,-8
    1560:	faf43423          	sd	a5,-88(s0)
    1564:	fa843783          	ld	a5,-88(s0)
    1568:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffdf20>
    156c:	689c                	ld	a5,16(s1)
    156e:	f2f716e3          	bne	a4,a5,149a <schedule_lst+0xec>
        }
    }
    ...
    1576:	c3b1                	beqz	a5,15ba <schedule_lst+0x20c>
    ...
    1578:	fb442783          	lw	a5,-76(s0)
    157c:	0007871b          	sext.w	a4,a5
    1580:	800007b7          	lui	a5,0x80000
    1584:	fff7c793          	not	a5,a5
    1588:	00f71663          	bne	a4,a5,1594 <schedule_lst+0x1e6>
    158c:	fc843783          	ld	a5,-56(s0)
    1590:	4fbc                	lw	a5,88(a5)
    1592:	a039                	j	15a0 <schedule_lst+0x1f2>
    1594:	409c                	lw	a5,0(s1)
    1596:	fb442703          	lw	a4,-76(s0)
    159a:	40f707bb          	subw	a5,a4,a5
    ...
    15a8:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffdf40>
    15ac:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = allocated_time;
    15b0:	f9442783          	lw	a5,-108(s0)
    15b4:	f4f42823          	sw	a5,-176(s0)
    15b8:	a081                	j	15f8 <schedule_lst+0x24a>
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    15ba:	649c                	ld	a5,8(s1)
    15bc:	f4f43423          	sd	a5,-184(s0)
    ...
    15c8:	800007b7          	lui	a5,0x80000
    15cc:	fff7c793          	not	a5,a5
    15d0:	00f70963          	beq	a4,a5,15e2 <schedule_lst+0x234>
    15d4:	409c                	lw	a5,0(s1)
    15d6:	fb442703          	lw	a4,-76(s0)
    15da:	40f707bb          	subw	a5,a4,a5
    15de:	2781                	sext.w	a5,a5
    15e0:	a811                	j	15f4 <schedule_lst+0x246>
    15e2:	689c                	ld	a5,16(s1)
    15e4:	4098                	lw	a4,0(s1)
    15e6:	85ba                	mv	a1,a4
    15e8:	853e                	mv	a0,a5
    15ea:	00000097          	auipc	ra,0x0
    15ee:	a72080e7          	jalr	-1422(ra) # 105c <find_next_release_time>
    15f2:	87aa                	mv	a5,a0
    15f4:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    15f8:	f4843783          	ld	a5,-184(s0)
    15fc:	f4f43c23          	sd	a5,-168(s0)
    1600:	f5043783          	ld	a5,-176(s0)
    1604:	f6f43023          	sd	a5,-160(s0)
    1608:	4701                	li	a4,0
    160a:	f5843703          	ld	a4,-168(s0)
    160e:	4781                	li	a5,0
    1610:	f6043783          	ld	a5,-160(s0)
    1614:	893a                	mv	s2,a4
    1616:	89be                	mv	s3,a5
    1618:	874a                	mv	a4,s2
    161a:	87ce                	mv	a5,s3
    ...
    161c:	853a                	mv	a0,a4
    161e:	85be                	mv	a1,a5
    1620:	70ea                	ld	ra,184(sp)
    1622:	744a                	ld	s0,176(sp)
    1624:	74aa                	ld	s1,168(sp)
    1626:	790a                	ld	s2,160(sp)
    1628:	69ea                	ld	s3,152(sp)
    162a:	6129                	addi	sp,sp,192
    162c:	8082                	ret

000000000000162e <find_earliest_impactful_release_time_dm>:

int find_earliest_impactful_release_time_dm(struct list_head *release_queue, int current_time, int current_deadline) {
    162e:	715d                	addi	sp,sp,-80
    1630:	e4a2                	sd	s0,72(sp)
    1632:	0880                	addi	s0,sp,80
    1634:	faa43c23          	sd	a0,-72(s0)
    1638:	87ae                	mv	a5,a1
    163a:	8732                	mv	a4,a2
    163c:	faf42a23          	sw	a5,-76(s0)
    1640:	87ba                	mv	a5,a4
    1642:	faf42823          	sw	a5,-80(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_event = INT_MAX;
    1646:	800007b7          	lui	a5,0x80000
    164a:	fff7c793          	not	a5,a5
    164e:	fef42223          	sw	a5,-28(s0)
    struct thread *earliest_deadline_thread = NULL;
    1652:	fc043c23          	sd	zero,-40(s0)
    earliest_deadline_thread->ID = INT_MAX;
    1656:	fd843783          	ld	a5,-40(s0)
    165a:	80000737          	lui	a4,0x80000
    165e:	fff74713          	not	a4,a4
    1662:	dfd8                	sw	a4,60(a5)
    ...
    166e:	fd043783          	ld	a5,-48(s0)
    1672:	17e1                	addi	a5,a5,-8
    1674:	fef43423          	sd	a5,-24(s0)
    1678:	a075                	j	1724 <find_earliest_impactful_release_time_dm+0xf6>
        if (entry->release_time > current_time && entry->thrd->period < current_deadline) {
    167a:	fe843783          	ld	a5,-24(s0)
    167e:	4f98                	lw	a4,24(a5)
    1680:	fb442783          	lw	a5,-76(s0)
    1684:	2781                	sext.w	a5,a5
    1686:	02e7d963          	bge	a5,a4,16b8 <find_earliest_impactful_release_time_dm+0x8a>
    168a:	fe843783          	ld	a5,-24(s0)
    168e:	639c                	ld	a5,0(a5)
    1690:	4bb8                	lw	a4,80(a5)
    1692:	fb042783          	lw	a5,-80(s0)
    1696:	2781                	sext.w	a5,a5
    1698:	02f75063          	bge	a4,a5,16b8 <find_earliest_impactful_release_time_dm+0x8a>
            if (entry->release_time < earliest_impactful_event) {
    169c:	fe843783          	ld	a5,-24(s0)
    16a0:	4f98                	lw	a4,24(a5)
    16a2:	fe442783          	lw	a5,-28(s0)
    16a6:	2781                	sext.w	a5,a5
    16a8:	06f75463          	bge	a4,a5,1710 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    16ac:	fe843783          	ld	a5,-24(s0)
    16b0:	4f9c                	lw	a5,24(a5)
    16b2:	fef42223          	sw	a5,-28(s0)
            if (entry->release_time < earliest_impactful_event) {
    16b6:	a8a9                	j	1710 <find_earliest_impactful_release_time_dm+0xe2>
            }
        } 
    ...
    16b8:	fe843783          	ld	a5,-24(s0)
    16bc:	4f98                	lw	a4,24(a5)
    16be:	fb442783          	lw	a5,-76(s0)
    16c2:	2781                	sext.w	a5,a5
    16c4:	04e7d663          	bge	a5,a4,1710 <find_earliest_impactful_release_time_dm+0xe2>
    16c8:	fe843783          	ld	a5,-24(s0)
    16cc:	639c                	ld	a5,0(a5)
    16ce:	4bb8                	lw	a4,80(a5)
    16d0:	fb042783          	lw	a5,-80(s0)
    16d4:	2781                	sext.w	a5,a5
    16d6:	02e79d63          	bne	a5,a4,1710 <find_earliest_impactful_release_time_dm+0xe2>
            if (entry->release_time < earliest_impactful_event && entry->thrd->ID < earliest_deadline_thread->ID) {
    16da:	fe843783          	ld	a5,-24(s0)
    16de:	4f98                	lw	a4,24(a5)
    16e0:	fe442783          	lw	a5,-28(s0)
    16e4:	2781                	sext.w	a5,a5
    16e6:	02f75563          	bge	a4,a5,1710 <find_earliest_impactful_release_time_dm+0xe2>
    16ea:	fe843783          	ld	a5,-24(s0)
    16ee:	639c                	ld	a5,0(a5)
    16f0:	5fd8                	lw	a4,60(a5)
    16f2:	fd843783          	ld	a5,-40(s0)
    16f6:	5fdc                	lw	a5,60(a5)
    16f8:	00f75c63          	bge	a4,a5,1710 <find_earliest_impactful_release_time_dm+0xe2>
                earliest_impactful_event = entry->release_time;
    16fc:	fe843783          	ld	a5,-24(s0)
    1700:	4f9c                	lw	a5,24(a5)
    1702:	fef42223          	sw	a5,-28(s0)
                earliest_deadline_thread = entry->thrd;
    1706:	fe843783          	ld	a5,-24(s0)
    170a:	639c                	ld	a5,0(a5)
    170c:	fcf43c23          	sd	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    1710:	fe843783          	ld	a5,-24(s0)
    1714:	679c                	ld	a5,8(a5)
    1716:	fcf43423          	sd	a5,-56(s0)
    171a:	fc843783          	ld	a5,-56(s0)
    171e:	17e1                	addi	a5,a5,-8
    1720:	fef43423          	sd	a5,-24(s0)
    1724:	fe843783          	ld	a5,-24(s0)
    1728:	07a1                	addi	a5,a5,8
    172a:	fb843703          	ld	a4,-72(s0)
    172e:	f4f716e3          	bne	a4,a5,167a <find_earliest_impactful_release_time_dm+0x4c>
            }
        }
    }
    ...
    173a:	800007b7          	lui	a5,0x80000
    173e:	fff7c793          	not	a5,a5
    1742:	00f70563          	beq	a4,a5,174c <find_earliest_impactful_release_time_dm+0x11e>
    1746:	fe442783          	lw	a5,-28(s0)
    174a:	a011                	j	174e <find_earliest_impactful_release_time_dm+0x120>
    174c:	57fd                	li	a5,-1
}
    174e:	853e                	mv	a0,a5
    1750:	6426                	ld	s0,72(sp)
    1752:	6161                	addi	sp,sp,80
    1754:	8082                	ret

0000000000001756 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    1756:	7175                	addi	sp,sp,-144
    1758:	e506                	sd	ra,136(sp)
    175a:	e122                	sd	s0,128(sp)
    175c:	fca6                	sd	s1,120(sp)
    175e:	f8ca                	sd	s2,112(sp)
    1760:	f4ce                	sd	s3,104(sp)
    1762:	0900                	addi	s0,sp,144
    1764:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    1766:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    176a:	800007b7          	lui	a5,0x80000
    176e:	fff7c793          	not	a5,a5
    1772:	faf42e23          	sw	a5,-68(s0)

    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    1776:	649c                	ld	a5,8(s1)
    1778:	639c                	ld	a5,0(a5)
    177a:	faf43823          	sd	a5,-80(s0)
    177e:	fb043783          	ld	a5,-80(s0)
    1782:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdef0>
    1786:	fcf43023          	sd	a5,-64(s0)
    178a:	a089                	j	17cc <schedule_dm+0x76>
        if (t->is_real_time && t->period < earliest_deadline) {
    178c:	fc043783          	ld	a5,-64(s0)
    1790:	43bc                	lw	a5,64(a5)
    1792:	c395                	beqz	a5,17b6 <schedule_dm+0x60>
    1794:	fc043783          	ld	a5,-64(s0)
    1798:	4bb8                	lw	a4,80(a5)
    179a:	fbc42783          	lw	a5,-68(s0)
    179e:	2781                	sext.w	a5,a5
    17a0:	00f75b63          	bge	a4,a5,17b6 <schedule_dm+0x60>
    ...
    17b0:	4bbc                	lw	a5,80(a5)
    17b2:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    17b6:	fc043783          	ld	a5,-64(s0)
    17ba:	779c                	ld	a5,40(a5)
    17bc:	f8f43c23          	sd	a5,-104(s0)
    17c0:	f9843783          	ld	a5,-104(s0)
    ...
    17d6:	faf71be3          	bne	a4,a5,178c <schedule_dm+0x36>
        }
    }
    ...
    17da:	689c                	ld	a5,16(s1)
    17dc:	4098                	lw	a4,0(s1)
    17de:	fbc42683          	lw	a3,-68(s0)
    17e2:	8636                	mv	a2,a3
    17e4:	85ba                	mv	a1,a4
    17e6:	853e                	mv	a0,a5
    17e8:	00000097          	auipc	ra,0x0
    17ec:	e46080e7          	jalr	-442(ra) # 162e <find_earliest_impactful_release_time_dm>
    17f0:	87aa                	mv	a5,a0
    17f2:	faf42623          	sw	a5,-84(s0)

    if (earliest_deadline_thread) {
    17f6:	fc843783          	ld	a5,-56(s0)
    17fa:	c3c9                	beqz	a5,187c <schedule_dm+0x126>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    17fc:	fc843783          	ld	a5,-56(s0)
    1800:	4ff8                	lw	a4,92(a5)
    1802:	409c                	lw	a5,0(s1)
    1804:	40f707bb          	subw	a5,a4,a5
    1808:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline < 0) {
    180c:	fa842783          	lw	a5,-88(s0)
    1810:	2781                	sext.w	a5,a5
    1812:	0007db63          	bgez	a5,1828 <schedule_dm+0xd2>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1816:	fc843783          	ld	a5,-56(s0)
    181a:	02878793          	addi	a5,a5,40
    181e:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    1822:	f8042023          	sw	zero,-128(s0)
    1826:	a88d                	j	1898 <schedule_dm+0x142>
        } else {
    ...
    1828:	fac42783          	lw	a5,-84(s0)
    182c:	0007871b          	sext.w	a4,a5
    1830:	57fd                	li	a5,-1
    1832:	02f70563          	beq	a4,a5,185c <schedule_dm+0x106>
    1836:	409c                	lw	a5,0(s1)
    1838:	fac42703          	lw	a4,-84(s0)
    183c:	40f707bb          	subw	a5,a4,a5
    1840:	0007871b          	sext.w	a4,a5
    1844:	fc843783          	ld	a5,-56(s0)
    1848:	4fbc                	lw	a5,88(a5)
    184a:	00f75963          	bge	a4,a5,185c <schedule_dm+0x106>
    184e:	409c                	lw	a5,0(s1)
    1850:	fac42703          	lw	a4,-84(s0)
    1854:	40f707bb          	subw	a5,a4,a5
    1858:	2781                	sext.w	a5,a5
    185a:	a021                	j	1862 <schedule_dm+0x10c>
    185c:	fc843783          	ld	a5,-56(s0)
    1860:	4fbc                	lw	a5,88(a5)
    1862:	faf42223          	sw	a5,-92(s0)
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1866:	fc843783          	ld	a5,-56(s0)
    186a:	02878793          	addi	a5,a5,40
    186e:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    1872:	fa442783          	lw	a5,-92(s0)
    1876:	f8f42023          	sw	a5,-128(s0)
    187a:	a839                	j	1898 <schedule_dm+0x142>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    187c:	649c                	ld	a5,8(s1)
    187e:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1882:	689c                	ld	a5,16(s1)
    1884:	4098                	lw	a4,0(s1)
    1886:	85ba                	mv	a1,a4
    1888:	853e                	mv	a0,a5
    188a:	fffff097          	auipc	ra,0xfffff
    188e:	7d2080e7          	jalr	2002(ra) # 105c <find_next_release_time>
    1892:	87aa                	mv	a5,a0
    1894:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    1898:	f7843783          	ld	a5,-136(s0)
    189c:	f8f43423          	sd	a5,-120(s0)
    18a0:	f8043783          	ld	a5,-128(s0)
    18a4:	f8f43823          	sd	a5,-112(s0)
    18a8:	4701                	li	a4,0
    18aa:	f8843703          	ld	a4,-120(s0)
    18ae:	4781                	li	a5,0
    18b0:	f9043783          	ld	a5,-112(s0)
    18b4:	893a                	mv	s2,a4
    18b6:	89be                	mv	s3,a5
    18b8:	874a                	mv	a4,s2
    18ba:	87ce                	mv	a5,s3
    ...
    18bc:	853a                	mv	a0,a4
    18be:	85be                	mv	a1,a5
    18c0:	60aa                	ld	ra,136(sp)
    18c2:	640a                	ld	s0,128(sp)
    18c4:	74e6                	ld	s1,120(sp)
    18c6:	7946                	ld	s2,112(sp)
    18c8:	79a6                	ld	s3,104(sp)
    18ca:	6149                	addi	sp,sp,144
    18cc:	8082                	ret

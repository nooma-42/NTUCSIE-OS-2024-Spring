...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      32:	92a78793          	addi	a5,a5,-1750 # 2958 <schedule_dm+0x226>
      36:	97ba                	add	a5,a5,a4
      38:	439c                	lw	a5,0(a5)
      3a:	0007871b          	sext.w	a4,a5
      3e:	00003797          	auipc	a5,0x3
      42:	91a78793          	addi	a5,a5,-1766 # 2958 <schedule_dm+0x226>
      46:	97ba                	add	a5,a5,a4
      48:	8782                	jr	a5
  default:
    panic("runcmd");
      4a:	00003517          	auipc	a0,0x3
      4e:	8de50513          	addi	a0,a0,-1826 # 2928 <schedule_dm+0x1f6>
  ...
  case EXEC:
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      98:	89c58593          	addi	a1,a1,-1892 # 2930 <schedule_dm+0x1fe>
      9c:	4509                	li	a0,2
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ea:	85a58593          	addi	a1,a1,-1958 # 2940 <schedule_dm+0x20e>
      ee:	4509                	li	a0,2
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     174:	7e050513          	addi	a0,a0,2016 # 2950 <schedule_dm+0x21e>
...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
     ...
     298:	6dc58593          	addi	a1,a1,1756 # 2970 <schedule_dm+0x23e>
     29c:	4509                	li	a0,2
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     314:	66850513          	addi	a0,a0,1640 # 2978 <schedule_dm+0x246>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     378:	72450513          	addi	a0,a0,1828 # 2a98 <buf.1144>
     ...
     390:	70c70713          	addi	a4,a4,1804 # 2a98 <buf.1144>
     ...
     3a2:	6fd78793          	addi	a5,a5,1789 # 2a9b <buf.1144+0x3>
     3a6:	853e                	mv	a0,a5
     ...
     3ba:	6e578793          	addi	a5,a5,1765 # 2a9b <buf.1144+0x3>
     3be:	863e                	mv	a2,a5
     3c0:	00002597          	auipc	a1,0x2
     3c4:	5c058593          	addi	a1,a1,1472 # 2980 <schedule_dm+0x24e>
     3c8:	4509                	li	a0,2
    ...
    if(fork1() == 0)
     ...
     3e4:	6b850513          	addi	a0,a0,1720 # 2a98 <buf.1144>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     40e:	68e50513          	addi	a0,a0,1678 # 2a98 <buf.1144>
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
     ...
     43e:	55658593          	addi	a1,a1,1366 # 2990 <schedule_dm+0x25e>
     442:	4509                	li	a0,2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     47e:	51e50513          	addi	a0,a0,1310 # 2998 <schedule_dm+0x266>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a4:	3e850513          	addi	a0,a0,1000 # 2a88 <whitespace>
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     7a0:	2ec50513          	addi	a0,a0,748 # 2a88 <whitespace>
     ...
     7be:	2d650513          	addi	a0,a0,726 # 2a90 <symbols>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     810:	27c50513          	addi	a0,a0,636 # 2a88 <whitespace>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     87c:	21050513          	addi	a0,a0,528 # 2a88 <whitespace>
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     916:	08e60613          	addi	a2,a2,142 # 29a0 <schedule_dm+0x26e>
  ...
  if(s != es){
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     93e:	06e58593          	addi	a1,a1,110 # 29a8 <schedule_dm+0x276>
     942:	4509                	li	a0,2
     944:	00001097          	auipc	ra,0x1
     948:	f96080e7          	jalr	-106(ra) # 18da <fprintf>
    panic("syntax");
     94c:	00002517          	auipc	a0,0x2
     950:	06c50513          	addi	a0,a0,108 # 29b8 <schedule_dm+0x286>
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     9c6:	ffe60613          	addi	a2,a2,-2 # 29c0 <schedule_dm+0x28e>
  ...
  if(peek(ps, es, ";")){
     ...
     9e2:	fea60613          	addi	a2,a2,-22 # 29c8 <schedule_dm+0x296>
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     a68:	f6c60613          	addi	a2,a2,-148 # 29d0 <schedule_dm+0x29e>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     b22:	eba50513          	addi	a0,a0,-326 # 29d8 <schedule_dm+0x2a6>
  ...
  while(peek(ps, es, "<>")){
     ...
     bd6:	e2660613          	addi	a2,a2,-474 # 29f8 <schedule_dm+0x2c6>
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     c12:	df260613          	addi	a2,a2,-526 # 2a00 <schedule_dm+0x2ce>
    ...
    panic("parseblock");
     ...
     c2e:	dde50513          	addi	a0,a0,-546 # 2a08 <schedule_dm+0x2d6>
  ...
  if(!peek(ps, es, ")"))
     ...
     c66:	db660613          	addi	a2,a2,-586 # 2a18 <schedule_dm+0x2e6>
    ...
    panic("syntax - missing )");
     ...
     c82:	da250513          	addi	a0,a0,-606 # 2a20 <schedule_dm+0x2ee>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     cdc:	d2860613          	addi	a2,a2,-728 # 2a00 <schedule_dm+0x2ce>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     d78:	c4450513          	addi	a0,a0,-956 # 29b8 <schedule_dm+0x286>
    ...
    if(argc >= MAXARGS)
     ...
     dc6:	c7650513          	addi	a0,a0,-906 # 2a38 <schedule_dm+0x306>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     dee:	c5e60613          	addi	a2,a2,-930 # 2a48 <schedule_dm+0x316>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     e66:	bee78793          	addi	a5,a5,-1042 # 2a50 <schedule_dm+0x31e>
     e6a:	97ba                	add	a5,a5,a4
     e6c:	439c                	lw	a5,0(a5)
     e6e:	0007871b          	sext.w	a4,a5
     e72:	00002797          	auipc	a5,0x2
     e76:	bde78793          	addi	a5,a5,-1058 # 2a50 <schedule_dm+0x31e>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1554:	52068693          	addi	a3,a3,1312 # 2a70 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    162e:	44670713          	addi	a4,a4,1094 # 2a70 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    17ee:	27e78793          	addi	a5,a5,638 # 2a68 <schedule_dm+0x336>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    199a:	17a78793          	addi	a5,a5,378 # 2b10 <freep>
  ...
  freep = p;
    ...
    1a92:	08278793          	addi	a5,a5,130 # 2b10 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1b46:	fce78793          	addi	a5,a5,-50 # 2b10 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1c04:	f1078793          	addi	a5,a5,-240 # 2b10 <freep>
    ...
    1c1a:	efa78793          	addi	a5,a5,-262 # 2b10 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    1ea6:	c7678793          	addi	a5,a5,-906 # 2b18 <last_thread.1239>
    ...
    1f02:	c1a78793          	addi	a5,a5,-998 # 2b18 <last_thread.1239>
    1f06:	639c                	ld	a5,0(a5)
    1f08:	c385                	beqz	a5,1f28 <schedule_wrr+0xdc>
    1f0a:	00001797          	auipc	a5,0x1
    1f0e:	c0e78793          	addi	a5,a5,-1010 # 2b18 <last_thread.1239>
    ...
    1f1e:	bfe78793          	addi	a5,a5,-1026 # 2b18 <last_thread.1239>
    ...
    1f6e:	bae78793          	addi	a5,a5,-1106 # 2b18 <last_thread.1239>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    2006:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffcd68>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    2138:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffcd68>
...
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    226e:	7115                	addi	sp,sp,-224
    2270:	ed86                	sd	ra,216(sp)
    2272:	e9a2                	sd	s0,208(sp)
    2274:	e5a6                	sd	s1,200(sp)
    2276:	e1ca                	sd	s2,192(sp)
    2278:	fd4e                	sd	s3,184(sp)
    227a:	1180                	addi	s0,sp,224
    227c:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    ...
    2292:	f8f43823          	sd	a5,-112(s0)
    2296:	f9043783          	ld	a5,-112(s0)
    229a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffcd68>
    ...
    230e:	f5442783          	lw	a5,-172(s0)
    2312:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    2316:	fb843783          	ld	a5,-72(s0)
    231a:	779c                	ld	a5,40(a5)
    231c:	f4f43423          	sd	a5,-184(s0)
    2320:	f4843783          	ld	a5,-184(s0)
    2324:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffcd68>
    ...
    234a:	f8f43423          	sd	a5,-120(s0)
    234e:	f8843783          	ld	a5,-120(s0)
    ...
    2416:	f4f43c23          	sd	a5,-168(s0)
    241a:	f5843783          	ld	a5,-168(s0)
    241e:	17e1                	addi	a5,a5,-8
    2420:	faf43423          	sd	a5,-88(s0)
    2424:	fa843783          	ld	a5,-88(s0)
    2428:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffcd98>
    ...
    2436:	10078b63          	beqz	a5,254c <schedule_lst+0x2de>
    ...
    243a:	4098                	lw	a4,0(s1)
    243c:	fc843783          	ld	a5,-56(s0)
    2440:	4ffc                	lw	a5,92(a5)
    2442:	08f74863          	blt	a4,a5,24d2 <schedule_lst+0x264>
    2446:	fc843783          	ld	a5,-56(s0)
    244a:	4fbc                	lw	a5,88(a5)
    244c:	08f05363          	blez	a5,24d2 <schedule_lst+0x264>
            struct thread *thread_with_smallest_id = min_slack_thread;
    2450:	fc843783          	ld	a5,-56(s0)
    2454:	faf43023          	sd	a5,-96(s0)
            // Iterate again to find if there are other threads that also missed their deadlines and have smaller IDs
            list_for_each_entry(t, args.run_queue, thread_list) {
    2458:	649c                	ld	a5,8(s1)
    245a:	639c                	ld	a5,0(a5)
    245c:	f8f43023          	sd	a5,-128(s0)
    2460:	f8043783          	ld	a5,-128(s0)
    2464:	fd878793          	addi	a5,a5,-40
    2468:	faf43c23          	sd	a5,-72(s0)
    246c:	a099                	j	24b2 <schedule_lst+0x244>
                if (args.current_time >= t->current_deadline && t->remaining_time > 0 && t->ID < thread_with_smallest_id->ID) {
    246e:	4098                	lw	a4,0(s1)
    2470:	fb843783          	ld	a5,-72(s0)
    2474:	4ffc                	lw	a5,92(a5)
    2476:	02f74363          	blt	a4,a5,249c <schedule_lst+0x22e>
    247a:	fb843783          	ld	a5,-72(s0)
    247e:	4fbc                	lw	a5,88(a5)
    2480:	00f05e63          	blez	a5,249c <schedule_lst+0x22e>
    2484:	fb843783          	ld	a5,-72(s0)
    2488:	5fd8                	lw	a4,60(a5)
    248a:	fa043783          	ld	a5,-96(s0)
    248e:	5fdc                	lw	a5,60(a5)
    2490:	00f75663          	bge	a4,a5,249c <schedule_lst+0x22e>
                    thread_with_smallest_id = t;
    2494:	fb843783          	ld	a5,-72(s0)
    2498:	faf43023          	sd	a5,-96(s0)
            list_for_each_entry(t, args.run_queue, thread_list) {
    249c:	fb843783          	ld	a5,-72(s0)
    24a0:	779c                	ld	a5,40(a5)
    24a2:	f6f43c23          	sd	a5,-136(s0)
    24a6:	f7843783          	ld	a5,-136(s0)
    24aa:	fd878793          	addi	a5,a5,-40
    24ae:	faf43c23          	sd	a5,-72(s0)
    24b2:	fb843783          	ld	a5,-72(s0)
    24b6:	02878713          	addi	a4,a5,40
    24ba:	649c                	ld	a5,8(s1)
    24bc:	faf719e3          	bne	a4,a5,246e <schedule_lst+0x200>
                }
            }
            r.scheduled_thread_list_member = &thread_with_smallest_id->thread_list;
    24c0:	fa043783          	ld	a5,-96(s0)
    24c4:	02878793          	addi	a5,a5,40
    24c8:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = 0;
    24cc:	f2042823          	sw	zero,-208(s0)
        if (args.current_time >= min_slack_thread->current_deadline && min_slack_thread->remaining_time > 0) {
    24d0:	a86d                	j	258a <schedule_lst+0x31c>
        } else {
            // Calculate time until the thread's deadline
            int time_until_deadline = min_slack_thread->current_deadline - args.current_time;
    24d2:	fc843783          	ld	a5,-56(s0)
    24d6:	4ff8                	lw	a4,92(a5)
    24d8:	409c                	lw	a5,0(s1)
    24da:	40f707bb          	subw	a5,a4,a5
    24de:	f6f42a23          	sw	a5,-140(s0)
            
            // Decide the allocated time based on current minimum slack or upcoming preemption needs
            int allocated_time = min(min_slack_thread->remaining_time, time_until_deadline);
    24e2:	fc843783          	ld	a5,-56(s0)
    24e6:	4fbc                	lw	a5,88(a5)
    24e8:	f7442703          	lw	a4,-140(s0)
    24ec:	85ba                	mv	a1,a4
    24ee:	853e                	mv	a0,a5
    24f0:	00000097          	auipc	ra,0x0
    24f4:	d4a080e7          	jalr	-694(ra) # 223a <min>
    24f8:	87aa                	mv	a5,a0
    24fa:	f8f42e23          	sw	a5,-100(s0)
            if (next_significant_event_time != INT_MAX) {
    24fe:	fb442783          	lw	a5,-76(s0)
    2502:	0007871b          	sext.w	a4,a5
    2506:	800007b7          	lui	a5,0x80000
    250a:	fff7c793          	not	a5,a5
    250e:	02f70463          	beq	a4,a5,2536 <schedule_lst+0x2c8>
                allocated_time = min(allocated_time, next_significant_event_time - args.current_time);
    2512:	409c                	lw	a5,0(s1)
    2514:	fb442703          	lw	a4,-76(s0)
    2518:	40f707bb          	subw	a5,a4,a5
    251c:	0007871b          	sext.w	a4,a5
    2520:	f9c42783          	lw	a5,-100(s0)
    2524:	85ba                	mv	a1,a4
    2526:	853e                	mv	a0,a5
    2528:	00000097          	auipc	ra,0x0
    252c:	d12080e7          	jalr	-750(ra) # 223a <min>
    2530:	87aa                	mv	a5,a0
    2532:	f8f42e23          	sw	a5,-100(s0)
            }

            r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    2536:	fc843783          	ld	a5,-56(s0)
    253a:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffcdb8>
    253e:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = allocated_time;
    2542:	f9c42783          	lw	a5,-100(s0)
    2546:	f2f42823          	sw	a5,-208(s0)
    254a:	a081                	j	258a <schedule_lst+0x31c>
        }
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    254c:	649c                	ld	a5,8(s1)
    254e:	f2f43423          	sd	a5,-216(s0)
    ...
    2552:	fb442783          	lw	a5,-76(s0)
    2556:	0007871b          	sext.w	a4,a5
    255a:	800007b7          	lui	a5,0x80000
    255e:	fff7c793          	not	a5,a5
    2562:	00f70963          	beq	a4,a5,2574 <schedule_lst+0x306>
    2566:	409c                	lw	a5,0(s1)
    2568:	fb442703          	lw	a4,-76(s0)
    256c:	40f707bb          	subw	a5,a4,a5
    2570:	2781                	sext.w	a5,a5
    2572:	a811                	j	2586 <schedule_lst+0x318>
    2574:	689c                	ld	a5,16(s1)
    2576:	4098                	lw	a4,0(s1)
    2578:	85ba                	mv	a1,a4
    257a:	853e                	mv	a0,a5
    257c:	00000097          	auipc	ra,0x0
    2580:	820080e7          	jalr	-2016(ra) # 1d9c <find_next_release_time>
    2584:	87aa                	mv	a5,a0
    2586:	f2f42823          	sw	a5,-208(s0)
    }

    return r;
    258a:	f2843783          	ld	a5,-216(s0)
    258e:	f2f43c23          	sd	a5,-200(s0)
    2592:	f3043783          	ld	a5,-208(s0)
    2596:	f4f43023          	sd	a5,-192(s0)
    259a:	4701                	li	a4,0
    259c:	f3843703          	ld	a4,-200(s0)
    25a0:	4781                	li	a5,0
    25a2:	f4043783          	ld	a5,-192(s0)
    25a6:	893a                	mv	s2,a4
    25a8:	89be                	mv	s3,a5
    25aa:	874a                	mv	a4,s2
    25ac:	87ce                	mv	a5,s3
    ...
    25ae:	853a                	mv	a0,a4
    25b0:	85be                	mv	a1,a5
    25b2:	60ee                	ld	ra,216(sp)
    25b4:	644e                	ld	s0,208(sp)
    25b6:	64ae                	ld	s1,200(sp)
    25b8:	690e                	ld	s2,192(sp)
    25ba:	79ea                	ld	s3,184(sp)
    25bc:	612d                	addi	sp,sp,224
    25be:	8082                	ret

00000000000025c0 <find_earliest_impactful_release_time_dm>:
typedef struct {
...
ImpactfulEvent find_earliest_impactful_release_time_dm(struct list_head *release_queue, struct list_head*run_queue, int current_time, int current_period, int current_thread_ID) {
    25c0:	7119                	addi	sp,sp,-128
    25c2:	fca2                	sd	s0,120(sp)
    25c4:	0100                	addi	s0,sp,128
    25c6:	f8a43c23          	sd	a0,-104(s0)
    25ca:	f8b43823          	sd	a1,-112(s0)
    25ce:	87b2                	mv	a5,a2
    25d0:	f8f42623          	sw	a5,-116(s0)
    25d4:	87b6                	mv	a5,a3
    25d6:	f8f42423          	sw	a5,-120(s0)
    25da:	87ba                	mv	a5,a4
    25dc:	f8f42223          	sw	a5,-124(s0)
    struct release_queue_entry *entry;
    struct thread *t;
    int earliest_impactful_event = INT_MAX;
    25e0:	800007b7          	lui	a5,0x80000
    25e4:	fff7c793          	not	a5,a5
    25e8:	fcf42e23          	sw	a5,-36(s0)
    int earliest_impactful_thread_ID = current_thread_ID;    
    25ec:	f8442783          	lw	a5,-124(s0)
    25f0:	fcf42c23          	sw	a5,-40(s0)
    
    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    25f4:	f9843783          	ld	a5,-104(s0)
    25f8:	639c                	ld	a5,0(a5)
    25fa:	fcf43823          	sd	a5,-48(s0)
    25fe:	fd043783          	ld	a5,-48(s0)
    2602:	17e1                	addi	a5,a5,-8
    2604:	fef43423          	sd	a5,-24(s0)
    2608:	a0f9                	j	26d6 <find_earliest_impactful_release_time_dm+0x116>
        if (entry->release_time > current_time && entry->thrd->period < current_period) {
    260a:	fe843783          	ld	a5,-24(s0)
    260e:	4f98                	lw	a4,24(a5)
    2610:	f8c42783          	lw	a5,-116(s0)
    2614:	2781                	sext.w	a5,a5
    2616:	04e7d463          	bge	a5,a4,265e <find_earliest_impactful_release_time_dm+0x9e>
    261a:	fe843783          	ld	a5,-24(s0)
    261e:	639c                	ld	a5,0(a5)
    2620:	4bb8                	lw	a4,80(a5)
    2622:	f8842783          	lw	a5,-120(s0)
    2626:	2781                	sext.w	a5,a5
    2628:	02f75b63          	bge	a4,a5,265e <find_earliest_impactful_release_time_dm+0x9e>
            if (entry->release_time < earliest_impactful_event) {
    262c:	fe843783          	ld	a5,-24(s0)
    2630:	4f98                	lw	a4,24(a5)
    2632:	fdc42783          	lw	a5,-36(s0)
    2636:	2781                	sext.w	a5,a5
    2638:	08f75563          	bge	a4,a5,26c2 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    263c:	fe843783          	ld	a5,-24(s0)
    2640:	4f9c                	lw	a5,24(a5)
    2642:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    2646:	fe843783          	ld	a5,-24(s0)
    264a:	639c                	ld	a5,0(a5)
    264c:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    2650:	fe843783          	ld	a5,-24(s0)
    2654:	639c                	ld	a5,0(a5)
    2656:	5fdc                	lw	a5,60(a5)
    2658:	fcf42c23          	sw	a5,-40(s0)
            if (entry->release_time < earliest_impactful_event) {
    265c:	a09d                	j	26c2 <find_earliest_impactful_release_time_dm+0x102>
            }
        } 
        else if (entry->release_time > current_time && entry->thrd->period == current_period) {
    265e:	fe843783          	ld	a5,-24(s0)
    2662:	4f98                	lw	a4,24(a5)
    2664:	f8c42783          	lw	a5,-116(s0)
    2668:	2781                	sext.w	a5,a5
    266a:	04e7dc63          	bge	a5,a4,26c2 <find_earliest_impactful_release_time_dm+0x102>
    266e:	fe843783          	ld	a5,-24(s0)
    2672:	639c                	ld	a5,0(a5)
    2674:	4bb8                	lw	a4,80(a5)
    2676:	f8842783          	lw	a5,-120(s0)
    267a:	2781                	sext.w	a5,a5
    267c:	04e79363          	bne	a5,a4,26c2 <find_earliest_impactful_release_time_dm+0x102>
    ...
    2680:	fe843783          	ld	a5,-24(s0)
    2684:	4f98                	lw	a4,24(a5)
    2686:	fdc42783          	lw	a5,-36(s0)
    268a:	2781                	sext.w	a5,a5
    268c:	02e7cb63          	blt	a5,a4,26c2 <find_earliest_impactful_release_time_dm+0x102>
    2690:	fe843783          	ld	a5,-24(s0)
    2694:	639c                	ld	a5,0(a5)
    2696:	5fd8                	lw	a4,60(a5)
    2698:	fd842783          	lw	a5,-40(s0)
    269c:	2781                	sext.w	a5,a5
    269e:	02f75263          	bge	a4,a5,26c2 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    26a2:	fe843783          	ld	a5,-24(s0)
    26a6:	4f9c                	lw	a5,24(a5)
    26a8:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    26ac:	fe843783          	ld	a5,-24(s0)
    26b0:	639c                	ld	a5,0(a5)
    26b2:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    26b6:	fe843783          	ld	a5,-24(s0)
    26ba:	639c                	ld	a5,0(a5)
    26bc:	5fdc                	lw	a5,60(a5)
    26be:	fcf42c23          	sw	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    26c2:	fe843783          	ld	a5,-24(s0)
    26c6:	679c                	ld	a5,8(a5)
    26c8:	fcf43423          	sd	a5,-56(s0)
    26cc:	fc843783          	ld	a5,-56(s0)
    26d0:	17e1                	addi	a5,a5,-8
    26d2:	fef43423          	sd	a5,-24(s0)
    26d6:	fe843783          	ld	a5,-24(s0)
    26da:	07a1                	addi	a5,a5,8
    26dc:	f9843703          	ld	a4,-104(s0)
    26e0:	f2f715e3          	bne	a4,a5,260a <find_earliest_impactful_release_time_dm+0x4a>
            }
        }
    }
    ...
    26e4:	fdc42783          	lw	a5,-36(s0)
    26e8:	0007871b          	sext.w	a4,a5
    26ec:	800007b7          	lui	a5,0x80000
    26f0:	fff7c793          	not	a5,a5
    26f4:	00f70563          	beq	a4,a5,26fe <find_earliest_impactful_release_time_dm+0x13e>
    26f8:	fdc42783          	lw	a5,-36(s0)
    26fc:	a011                	j	2700 <find_earliest_impactful_release_time_dm+0x140>
    26fe:	57fd                	li	a5,-1
    2700:	fcf42e23          	sw	a5,-36(s0)
    return (ImpactfulEvent) {earliest_impactful_event, t};
    2704:	fdc42783          	lw	a5,-36(s0)
    2708:	faf42c23          	sw	a5,-72(s0)
    270c:	fe043783          	ld	a5,-32(s0)
    2710:	fcf43023          	sd	a5,-64(s0)
    2714:	4701                	li	a4,0
    2716:	fb843703          	ld	a4,-72(s0)
    271a:	4781                	li	a5,0
    ...
    2728:	853a                	mv	a0,a4
    272a:	85be                	mv	a1,a5
    272c:	7466                	ld	s0,120(sp)
    272e:	6109                	addi	sp,sp,128
    2730:	8082                	ret

0000000000002732 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    2732:	7135                	addi	sp,sp,-160
    2734:	ed06                	sd	ra,152(sp)
    2736:	e922                	sd	s0,144(sp)
    2738:	e526                	sd	s1,136(sp)
    273a:	e14a                	sd	s2,128(sp)
    273c:	fcce                	sd	s3,120(sp)
    273e:	1100                	addi	s0,sp,160
    2740:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    2742:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    2746:	800007b7          	lui	a5,0x80000
    274a:	fff7c793          	not	a5,a5
    274e:	faf42e23          	sw	a5,-68(s0)
    int earliest_impactful_deadline; 
    
    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    2752:	649c                	ld	a5,8(s1)
    2754:	639c                	ld	a5,0(a5)
    2756:	faf43823          	sd	a5,-80(s0)
    275a:	fb043783          	ld	a5,-80(s0)
    275e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffcd68>
    2762:	fcf43023          	sd	a5,-64(s0)
    2766:	a8bd                	j	27e4 <schedule_dm+0xb2>
        if (t->is_real_time && t->period < earliest_deadline) {
    2768:	fc043783          	ld	a5,-64(s0)
    276c:	43bc                	lw	a5,64(a5)
    276e:	c39d                	beqz	a5,2794 <schedule_dm+0x62>
    2770:	fc043783          	ld	a5,-64(s0)
    2774:	4bb8                	lw	a4,80(a5)
    2776:	fbc42783          	lw	a5,-68(s0)
    277a:	2781                	sext.w	a5,a5
    277c:	00f75c63          	bge	a4,a5,2794 <schedule_dm+0x62>
            earliest_deadline_thread = t;
    2780:	fc043783          	ld	a5,-64(s0)
    2784:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    2788:	fc043783          	ld	a5,-64(s0)
    278c:	4bbc                	lw	a5,80(a5)
    278e:	faf42e23          	sw	a5,-68(s0)
    2792:	a835                	j	27ce <schedule_dm+0x9c>
        } else if (t->is_real_time && t->period == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    2794:	fc043783          	ld	a5,-64(s0)
    2798:	43bc                	lw	a5,64(a5)
    279a:	cb95                	beqz	a5,27ce <schedule_dm+0x9c>
    279c:	fc043783          	ld	a5,-64(s0)
    27a0:	4bb8                	lw	a4,80(a5)
    27a2:	fbc42783          	lw	a5,-68(s0)
    27a6:	2781                	sext.w	a5,a5
    27a8:	02e79363          	bne	a5,a4,27ce <schedule_dm+0x9c>
    27ac:	fc043783          	ld	a5,-64(s0)
    27b0:	5fd8                	lw	a4,60(a5)
    27b2:	fc843783          	ld	a5,-56(s0)
    27b6:	5fdc                	lw	a5,60(a5)
    27b8:	00f75b63          	bge	a4,a5,27ce <schedule_dm+0x9c>
            earliest_deadline_thread = t;
    27bc:	fc043783          	ld	a5,-64(s0)
    27c0:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    27c4:	fc043783          	ld	a5,-64(s0)
    27c8:	4bbc                	lw	a5,80(a5)
    27ca:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    27ce:	fc043783          	ld	a5,-64(s0)
    27d2:	779c                	ld	a5,40(a5)
    27d4:	f8f43c23          	sd	a5,-104(s0)
    27d8:	f9843783          	ld	a5,-104(s0)
    27dc:	fd878793          	addi	a5,a5,-40
    27e0:	fcf43023          	sd	a5,-64(s0)
    27e4:	fc043783          	ld	a5,-64(s0)
    27e8:	02878713          	addi	a4,a5,40
    27ec:	649c                	ld	a5,8(s1)
    27ee:	f6f71de3          	bne	a4,a5,2768 <schedule_dm+0x36>
        }
    }
    ...
    27f2:	6888                	ld	a0,16(s1)
    27f4:	648c                	ld	a1,8(s1)
    27f6:	4090                	lw	a2,0(s1)
    27f8:	fc843783          	ld	a5,-56(s0)
    27fc:	c789                	beqz	a5,2806 <schedule_dm+0xd4>
    27fe:	fc843783          	ld	a5,-56(s0)
    2802:	4bbc                	lw	a5,80(a5)
    2804:	a029                	j	280e <schedule_dm+0xdc>
    2806:	800007b7          	lui	a5,0x80000
    280a:	fff7c793          	not	a5,a5
    280e:	fc843703          	ld	a4,-56(s0)
    2812:	5f58                	lw	a4,60(a4)
    2814:	86be                	mv	a3,a5
    2816:	00000097          	auipc	ra,0x0
    281a:	daa080e7          	jalr	-598(ra) # 25c0 <find_earliest_impactful_release_time_dm>
    281e:	872a                	mv	a4,a0
    2820:	87ae                	mv	a5,a1
    2822:	f6e43423          	sd	a4,-152(s0)
    2826:	f6f43823          	sd	a5,-144(s0)
    earliest_impactful_deadline = earliest_impactful_event.earliest_impactful_event;
    282a:	f6842783          	lw	a5,-152(s0)
    282e:	faf42623          	sw	a5,-84(s0)
    //printf("earliest_impactful_deadline: %d\n", earliest_impactful_deadline);
    if (earliest_deadline_thread) {
    2832:	fc843783          	ld	a5,-56(s0)
    2836:	cfd9                	beqz	a5,28d4 <schedule_dm+0x1a2>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    2838:	fc843783          	ld	a5,-56(s0)
    283c:	4ff8                	lw	a4,92(a5)
    283e:	409c                	lw	a5,0(s1)
    2840:	40f707bb          	subw	a5,a4,a5
    2844:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline <= 0) {
    2848:	fa842783          	lw	a5,-88(s0)
    284c:	2781                	sext.w	a5,a5
    284e:	00f04b63          	bgtz	a5,2864 <schedule_dm+0x132>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    2852:	fc843783          	ld	a5,-56(s0)
    2856:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffcdb8>
    285a:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    285e:	f8042023          	sw	zero,-128(s0)
    2862:	a079                	j	28f0 <schedule_dm+0x1be>
        } else {
    ...
    2864:	fc843783          	ld	a5,-56(s0)
    2868:	4fbc                	lw	a5,88(a5)
    286a:	fa842703          	lw	a4,-88(s0)
    286e:	85ba                	mv	a1,a4
    2870:	853e                	mv	a0,a5
    2872:	00000097          	auipc	ra,0x0
    2876:	9c8080e7          	jalr	-1592(ra) # 223a <min>
    287a:	87aa                	mv	a5,a0
    287c:	faf42223          	sw	a5,-92(s0)
            int allocated_time;
            if (earliest_impactful_deadline != -1 && (earliest_impactful_deadline - args.current_time) < remaining_time){
    2880:	fac42783          	lw	a5,-84(s0)
    2884:	0007871b          	sext.w	a4,a5
    2888:	57fd                	li	a5,-1
    288a:	02f70663          	beq	a4,a5,28b6 <schedule_dm+0x184>
    288e:	409c                	lw	a5,0(s1)
    2890:	fac42703          	lw	a4,-84(s0)
    2894:	40f707bb          	subw	a5,a4,a5
    2898:	0007871b          	sext.w	a4,a5
    289c:	fa442783          	lw	a5,-92(s0)
    28a0:	2781                	sext.w	a5,a5
    28a2:	00f75a63          	bge	a4,a5,28b6 <schedule_dm+0x184>
                allocated_time = earliest_impactful_deadline - args.current_time;
    28a6:	409c                	lw	a5,0(s1)
    28a8:	fac42703          	lw	a4,-84(s0)
    28ac:	40f707bb          	subw	a5,a4,a5
    28b0:	faf42c23          	sw	a5,-72(s0)
    28b4:	a029                	j	28be <schedule_dm+0x18c>
            } else {
                allocated_time = remaining_time;
    28b6:	fa442783          	lw	a5,-92(s0)
    28ba:	faf42c23          	sw	a5,-72(s0)
            }
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    28be:	fc843783          	ld	a5,-56(s0)
    28c2:	02878793          	addi	a5,a5,40
    28c6:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    28ca:	fb842783          	lw	a5,-72(s0)
    28ce:	f8f42023          	sw	a5,-128(s0)
    28d2:	a839                	j	28f0 <schedule_dm+0x1be>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    28d4:	649c                	ld	a5,8(s1)
    28d6:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    28da:	689c                	ld	a5,16(s1)
    28dc:	4098                	lw	a4,0(s1)
    28de:	85ba                	mv	a1,a4
    28e0:	853e                	mv	a0,a5
    28e2:	fffff097          	auipc	ra,0xfffff
    28e6:	4ba080e7          	jalr	1210(ra) # 1d9c <find_next_release_time>
    28ea:	87aa                	mv	a5,a0
    28ec:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    28f0:	f7843783          	ld	a5,-136(s0)
    28f4:	f8f43423          	sd	a5,-120(s0)
    28f8:	f8043783          	ld	a5,-128(s0)
    28fc:	f8f43823          	sd	a5,-112(s0)
    2900:	4701                	li	a4,0
    2902:	f8843703          	ld	a4,-120(s0)
    2906:	4781                	li	a5,0
    2908:	f9043783          	ld	a5,-112(s0)
    290c:	893a                	mv	s2,a4
    290e:	89be                	mv	s3,a5
    2910:	874a                	mv	a4,s2
    2912:	87ce                	mv	a5,s3
    ...
    2914:	853a                	mv	a0,a4
    2916:	85be                	mv	a1,a5
    2918:	60ea                	ld	ra,152(sp)
    291a:	644a                	ld	s0,144(sp)
    291c:	64aa                	ld	s1,136(sp)
    291e:	690a                	ld	s2,128(sp)
    2920:	79e6                	ld	s3,120(sp)
    2922:	610d                	addi	sp,sp,160
    2924:	8082                	ret

...
copyin(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
      ...
      54:	7f050513          	addi	a0,a0,2032 # 8840 <schedule_dm+0x4f8>
    ...
    if(fd < 0){
      ...
      74:	7d850513          	addi	a0,a0,2008 # 8848 <schedule_dm+0x500>
    ...
    if(n >= 0){
      ...
      be:	7a650513          	addi	a0,a0,1958 # 8860 <schedule_dm+0x518>
    ...
    unlink("copyin1");
      ...
      e6:	75e50513          	addi	a0,a0,1886 # 8840 <schedule_dm+0x4f8>
    ...
    if(n > 0){
     ...
     122:	77250513          	addi	a0,a0,1906 # 8890 <schedule_dm+0x548>
    ...
    if(pipe(fds) < 0){
     ...
     150:	77450513          	addi	a0,a0,1908 # 88c0 <schedule_dm+0x578>
    ...
    if(n > 0){
     ...
     19a:	73a50513          	addi	a0,a0,1850 # 88d0 <schedule_dm+0x588>
...
copyout(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     22a:	6da50513          	addi	a0,a0,1754 # 8900 <schedule_dm+0x5b8>
    ...
    if(fd < 0){
     ...
     24a:	6c250513          	addi	a0,a0,1730 # 8908 <schedule_dm+0x5c0>
    ...
    if(n > 0){
     ...
     294:	69050513          	addi	a0,a0,1680 # 8920 <schedule_dm+0x5d8>
    ...
    if(pipe(fds) < 0){
     ...
     2d0:	5f450513          	addi	a0,a0,1524 # 88c0 <schedule_dm+0x578>
    ...
    n = write(fds[1], "x", 1);
     ...
     2f0:	66458593          	addi	a1,a1,1636 # 8950 <schedule_dm+0x608>
     2f4:	853e                	mv	a0,a5
    ...
    if(n != 1){
     ...
     316:	64650513          	addi	a0,a0,1606 # 8958 <schedule_dm+0x610>
    ...
    if(n > 0){
     ...
     360:	61450513          	addi	a0,a0,1556 # 8970 <schedule_dm+0x628>
...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    if(fd >= 0){
     ...
     41a:	58a50513          	addi	a0,a0,1418 # 89a0 <schedule_dm+0x658>
...
copyinstr2(char *s)
{
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     4c8:	4fc50513          	addi	a0,a0,1276 # 89c0 <schedule_dm+0x678>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     514:	4d050513          	addi	a0,a0,1232 # 89e0 <schedule_dm+0x698>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     566:	49e50513          	addi	a0,a0,1182 # 8a00 <schedule_dm+0x6b8>
  ...
  char *args[] = { "xx", 0 };
     ...
     580:	4ac78793          	addi	a5,a5,1196 # 8a28 <schedule_dm+0x6e0>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     5c4:	47050513          	addi	a0,a0,1136 # 8a30 <schedule_dm+0x6e8>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
     ...
     5f6:	45e50513          	addi	a0,a0,1118 # 8a50 <schedule_dm+0x708>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     61e:	dbe70713          	addi	a4,a4,-578 # 103d8 <big.1275>
    ...
    ret = exec("echo", args2);
     ...
     682:	3e250513          	addi	a0,a0,994 # 8a60 <schedule_dm+0x718>
    ...
    if(ret != -1){
     ...
     6ac:	3c050513          	addi	a0,a0,960 # 8a68 <schedule_dm+0x720>
  ...
  if(st != 747){
    ...
    printf("exec(echo, BIG) succeeded, should have failed\n");
     ...
     6f2:	3a250513          	addi	a0,a0,930 # 8a90 <schedule_dm+0x748>
...
copyinstr3(char *s)
{
  ...
  if(top % PGSIZE){
    ...
    printf("oops\n");
     ...
     788:	35c50513          	addi	a0,a0,860 # 8ae0 <schedule_dm+0x798>
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     7e2:	1e250513          	addi	a0,a0,482 # 89c0 <schedule_dm+0x678>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     82a:	1ba50513          	addi	a0,a0,442 # 89e0 <schedule_dm+0x698>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     876:	18e50513          	addi	a0,a0,398 # 8a00 <schedule_dm+0x6b8>
  ...
  char *args[] = { "xx", 0 };
     ...
     890:	19c78793          	addi	a5,a5,412 # 8a28 <schedule_dm+0x6e0>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     8d0:	16450513          	addi	a0,a0,356 # 8a30 <schedule_dm+0x6e8>
...
rwsbrk()
{
  ...
  if(a == 0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) failed\n");
     ...
     916:	1d650513          	addi	a0,a0,470 # 8ae8 <schedule_dm+0x7a0>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) shrink failed\n");
     ...
     942:	1c250513          	addi	a0,a0,450 # 8b00 <schedule_dm+0x7b8>
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
     ...
     960:	c3c50513          	addi	a0,a0,-964 # 8598 <schedule_dm+0x250>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     980:	1a450513          	addi	a0,a0,420 # 8b20 <schedule_dm+0x7d8>
  ...
  if(n >= 0){
    ...
    printf("write(fd, %p, 1024) returned %d, not -1\n", a+4096, n);
     ...
     9d8:	16450513          	addi	a0,a0,356 # 8b38 <schedule_dm+0x7f0>
  ...
  unlink("rwsbrk");
     ...
     a00:	b9c50513          	addi	a0,a0,-1124 # 8598 <schedule_dm+0x250>
  ...
  fd = open("README", O_RDONLY);
     ...
     a12:	ef250513          	addi	a0,a0,-270 # 8900 <schedule_dm+0x5b8>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     a32:	0f250513          	addi	a0,a0,242 # 8b20 <schedule_dm+0x7d8>
  ...
  if(n >= 0){
    ...
    printf("read(fd, %p, 10) returned %d, not -1\n", a+4096, n);
     ...
     a88:	0e450513          	addi	a0,a0,228 # 8b68 <schedule_dm+0x820>
...
truncate1(char *s)
{
  ...
  write(fd1, "abcd", 4);
     ...
     af6:	0ae58593          	addi	a1,a1,174 # 8ba0 <schedule_dm+0x858>
     afa:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     b18:	07c50513          	addi	a0,a0,124 # 8b90 <schedule_dm+0x848>
  ...
  if(n != 4){
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     b64:	04850513          	addi	a0,a0,72 # 8ba8 <schedule_dm+0x860>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     b82:	01250513          	addi	a0,a0,18 # 8b90 <schedule_dm+0x848>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     b9a:	ffa50513          	addi	a0,a0,-6 # 8b90 <schedule_dm+0x848>
  ...
  if(n != 0){
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     bdc:	ff050513          	addi	a0,a0,-16 # 8bc8 <schedule_dm+0x880>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     bf6:	fe650513          	addi	a0,a0,-26 # 8bd8 <schedule_dm+0x890>
  ...
  if(n != 0){
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     c3c:	fc050513          	addi	a0,a0,-64 # 8bf8 <schedule_dm+0x8b0>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     c56:	f8650513          	addi	a0,a0,-122 # 8bd8 <schedule_dm+0x890>
  ...
  write(fd1, "abcdef", 6);
     ...
     c76:	f9658593          	addi	a1,a1,-106 # 8c08 <schedule_dm+0x8c0>
     c7a:	853e                	mv	a0,a5
  ...
  if(n != 6){
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     cbe:	f5650513          	addi	a0,a0,-170 # 8c10 <schedule_dm+0x8c8>
  ...
  if(n != 2){
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     d0e:	f2650513          	addi	a0,a0,-218 # 8c30 <schedule_dm+0x8e8>
  ...
  unlink("truncfile");
     ...
     d28:	e6c50513          	addi	a0,a0,-404 # 8b90 <schedule_dm+0x848>
...
truncate2(char *s)
{
  ...
  unlink("truncfile");
     ...
     d78:	e1c50513          	addi	a0,a0,-484 # 8b90 <schedule_dm+0x848>
  ...
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     ...
     d8c:	e0850513          	addi	a0,a0,-504 # 8b90 <schedule_dm+0x848>
  ...
  write(fd1, "abcd", 4);
     ...
     da8:	dfc58593          	addi	a1,a1,-516 # 8ba0 <schedule_dm+0x858>
     dac:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     ...
     dbe:	dd650513          	addi	a0,a0,-554 # 8b90 <schedule_dm+0x848>
  ...
  int n = write(fd1, "x", 1);
     ...
     dda:	b7a58593          	addi	a1,a1,-1158 # 8950 <schedule_dm+0x608>
     dde:	853e                	mv	a0,a5
  ...
  if(n != -1){
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     e0a:	e4a50513          	addi	a0,a0,-438 # 8c50 <schedule_dm+0x908>
  ...
  unlink("truncfile");
     ...
     e24:	d7050513          	addi	a0,a0,-656 # 8b90 <schedule_dm+0x848>
...
truncate3(char *s)
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     e6a:	d2a50513          	addi	a0,a0,-726 # 8b90 <schedule_dm+0x848>
  ...
  if(pid < 0){
    ...
    printf("%s: fork failed\n", s);
     ...
     ea2:	dda50513          	addi	a0,a0,-550 # 8c78 <schedule_dm+0x930>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < 100; i++){
     ...
     ece:	cc650513          	addi	a0,a0,-826 # 8b90 <schedule_dm+0x848>
     ...
     ef2:	da250513          	addi	a0,a0,-606 # 8c90 <schedule_dm+0x948>
     ...
     f12:	d9a58593          	addi	a1,a1,-614 # 8ca8 <schedule_dm+0x960>
     f16:	853e                	mv	a0,a5
     ...
     f42:	d7a50513          	addi	a0,a0,-646 # 8cb8 <schedule_dm+0x970>
     ...
     f6c:	c2850513          	addi	a0,a0,-984 # 8b90 <schedule_dm+0x848>
  ...
  for(int i = 0; i < 150; i++){
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     fd6:	bbe50513          	addi	a0,a0,-1090 # 8b90 <schedule_dm+0x848>
    ...
    if(fd < 0){
     ...
     ffa:	c9a50513          	addi	a0,a0,-870 # 8c90 <schedule_dm+0x948>
    ...
    101a:	cc258593          	addi	a1,a1,-830 # 8cd8 <schedule_dm+0x990>
    101e:	853e                	mv	a0,a5
    ...
    104a:	c9a50513          	addi	a0,a0,-870 # 8ce0 <schedule_dm+0x998>
  ...
  unlink("truncfile");
    ...
    109a:	afa50513          	addi	a0,a0,-1286 # 8b90 <schedule_dm+0x848>
...
iputtest(char *s)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    10c4:	c4050513          	addi	a0,a0,-960 # 8d00 <schedule_dm+0x9b8>
    ...
    10de:	c2e50513          	addi	a0,a0,-978 # 8d08 <schedule_dm+0x9c0>
  ...
  if(chdir("iputdir") < 0){
    ...
    10f8:	c0c50513          	addi	a0,a0,-1012 # 8d00 <schedule_dm+0x9b8>
    ...
    1112:	c1250513          	addi	a0,a0,-1006 # 8d20 <schedule_dm+0x9d8>
  ...
  if(unlink("../iputdir") < 0){
    ...
    112c:	c1850513          	addi	a0,a0,-1000 # 8d40 <schedule_dm+0x9f8>
    ...
    1146:	c0e50513          	addi	a0,a0,-1010 # 8d50 <schedule_dm+0xa08>
  ...
  if(chdir("/") < 0){
    ...
    1160:	c1450513          	addi	a0,a0,-1004 # 8d70 <schedule_dm+0xa28>
    ...
    117a:	c0250513          	addi	a0,a0,-1022 # 8d78 <schedule_dm+0xa30>
...
exitiputtest(char *s)
{
  ...
  if(pid < 0){
    ...
    11c6:	ab650513          	addi	a0,a0,-1354 # 8c78 <schedule_dm+0x930>
  ...
  if(pid == 0){
    ...
    11e8:	b1c50513          	addi	a0,a0,-1252 # 8d00 <schedule_dm+0x9b8>
    ...
    1202:	b0a50513          	addi	a0,a0,-1270 # 8d08 <schedule_dm+0x9c0>
    ...
    121c:	ae850513          	addi	a0,a0,-1304 # 8d00 <schedule_dm+0x9b8>
    ...
    1236:	b5e50513          	addi	a0,a0,-1186 # 8d90 <schedule_dm+0xa48>
    ...
    1250:	af450513          	addi	a0,a0,-1292 # 8d40 <schedule_dm+0x9f8>
    ...
    126a:	aea50513          	addi	a0,a0,-1302 # 8d50 <schedule_dm+0xa08>
...
openiputtest(char *s)
{
  ...
  if(mkdir("oidir") < 0){
    ...
    12b6:	af650513          	addi	a0,a0,-1290 # 8da8 <schedule_dm+0xa60>
    ...
    12d0:	ae450513          	addi	a0,a0,-1308 # 8db0 <schedule_dm+0xa68>
  ...
  if(pid < 0){
    ...
    1306:	97650513          	addi	a0,a0,-1674 # 8c78 <schedule_dm+0x930>
  ...
  if(pid == 0){
    ...
    132a:	a8250513          	addi	a0,a0,-1406 # 8da8 <schedule_dm+0xa60>
    ...
    134e:	a7e50513          	addi	a0,a0,-1410 # 8dc8 <schedule_dm+0xa80>
  ...
  if(unlink("oidir") != 0){
    ...
    137c:	a3050513          	addi	a0,a0,-1488 # 8da8 <schedule_dm+0xa60>
    ...
    1394:	a6050513          	addi	a0,a0,-1440 # 8df0 <schedule_dm+0xaa8>
...
opentest(char *s)
{
  ...
  fd = open("echo", 0);
    ...
    13d8:	68c50513          	addi	a0,a0,1676 # 8a60 <schedule_dm+0x718>
  ...
  if(fd < 0){
    ...
    13fc:	a1050513          	addi	a0,a0,-1520 # 8e08 <schedule_dm+0xac0>
  ...
  fd = open("doesnotexist", 0);
    ...
    1426:	9fe50513          	addi	a0,a0,-1538 # 8e20 <schedule_dm+0xad8>
  ...
  if(fd >= 0){
    ...
    144a:	9ea50513          	addi	a0,a0,-1558 # 8e30 <schedule_dm+0xae8>
...
writetest(char *s)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    147e:	9de50513          	addi	a0,a0,-1570 # 8e58 <schedule_dm+0xb10>
  ...
  if(fd < 0){
    ...
    14a2:	9c250513          	addi	a0,a0,-1598 # 8e60 <schedule_dm+0xb18>
  ...
  for(i = 0; i < N; i++){
    ...
    14c8:	9bc58593          	addi	a1,a1,-1604 # 8e80 <schedule_dm+0xb38>
    14cc:	853e                	mv	a0,a5
    ...
    14ee:	9a650513          	addi	a0,a0,-1626 # 8e90 <schedule_dm+0xb48>
    ...
    150e:	9ae58593          	addi	a1,a1,-1618 # 8eb8 <schedule_dm+0xb70>
    1512:	853e                	mv	a0,a5
    ...
    1534:	99850513          	addi	a0,a0,-1640 # 8ec8 <schedule_dm+0xb80>
  ...
  fd = open("small", O_RDONLY);
    ...
    1578:	8e450513          	addi	a0,a0,-1820 # 8e58 <schedule_dm+0xb10>
  ...
  if(fd < 0){
    ...
    159c:	95850513          	addi	a0,a0,-1704 # 8ef0 <schedule_dm+0xba8>
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    15be:	70e58593          	addi	a1,a1,1806 # acc8 <buf>
    15c2:	853e                	mv	a0,a5
  ...
  if(i != N*SZ*2){
    ...
    15ea:	92a50513          	addi	a0,a0,-1750 # 8f10 <schedule_dm+0xbc8>
  ...
  if(unlink("small") < 0){
    ...
    1612:	84a50513          	addi	a0,a0,-1974 # 8e58 <schedule_dm+0xb10>
    ...
    162c:	90050513          	addi	a0,a0,-1792 # 8f28 <schedule_dm+0xbe0>
...
writebig(char *s)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    1660:	8ec50513          	addi	a0,a0,-1812 # 8f48 <schedule_dm+0xc00>
  ...
  if(fd < 0){
    ...
    1684:	8d050513          	addi	a0,a0,-1840 # 8f50 <schedule_dm+0xc08>
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	62878793          	addi	a5,a5,1576 # acc8 <buf>
    ...
    16ba:	61258593          	addi	a1,a1,1554 # acc8 <buf>
    16be:	853e                	mv	a0,a5
    ...
    16e2:	89250513          	addi	a0,a0,-1902 # 8f70 <schedule_dm+0xc28>
  ...
  fd = open("big", O_RDONLY);
    ...
    1726:	82650513          	addi	a0,a0,-2010 # 8f48 <schedule_dm+0xc00>
  ...
  if(fd < 0){
    ...
    174a:	85250513          	addi	a0,a0,-1966 # 8f98 <schedule_dm+0xc50>
  ...
  for(;;){
    ...
    1770:	55c58593          	addi	a1,a1,1372 # acc8 <buf>
    1774:	853e                	mv	a0,a5
    ...
    17aa:	81250513          	addi	a0,a0,-2030 # 8fb8 <schedule_dm+0xc70>
    ...
    17de:	80650513          	addi	a0,a0,-2042 # 8fe0 <schedule_dm+0xc98>
    ...
    17f8:	4d478793          	addi	a5,a5,1236 # acc8 <buf>
    ...
    180c:	4c078793          	addi	a5,a5,1216 # acc8 <buf>
      printf("%s: read content of block %d is %d\n", s,
    ...
    1822:	7da50513          	addi	a0,a0,2010 # 8ff8 <schedule_dm+0xcb0>
  ...
  if(unlink("big") < 0){
    ...
    1858:	6f450513          	addi	a0,a0,1780 # 8f48 <schedule_dm+0xc00>
    ...
    1872:	7b250513          	addi	a0,a0,1970 # 9020 <schedule_dm+0xcd8>
...
void dirtest(char *s)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    196e:	6ce50513          	addi	a0,a0,1742 # 9038 <schedule_dm+0xcf0>
    ...
    1988:	38450513          	addi	a0,a0,900 # 8d08 <schedule_dm+0x9c0>
  ...
  if(chdir("dir0") < 0){
    ...
    19a2:	69a50513          	addi	a0,a0,1690 # 9038 <schedule_dm+0xcf0>
    ...
    19bc:	68850513          	addi	a0,a0,1672 # 9040 <schedule_dm+0xcf8>
  ...
  if(chdir("..") < 0){
    ...
    19d6:	68650513          	addi	a0,a0,1670 # 9058 <schedule_dm+0xd10>
    ...
    19f0:	67450513          	addi	a0,a0,1652 # 9060 <schedule_dm+0xd18>
  ...
  if(unlink("dir0") < 0){
    ...
    1a0a:	63250513          	addi	a0,a0,1586 # 9038 <schedule_dm+0xcf0>
    ...
    1a24:	65850513          	addi	a0,a0,1624 # 9078 <schedule_dm+0xd30>
...
exectest(char *s)
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1a54:	01078793          	addi	a5,a5,16 # 8a60 <schedule_dm+0x718>
    1a58:	fcf43423          	sd	a5,-56(s0)
    1a5c:	00007797          	auipc	a5,0x7
    1a60:	63478793          	addi	a5,a5,1588 # 9090 <schedule_dm+0xd48>
  ...
  unlink("echo-ok");
    ...
    1a70:	62c50513          	addi	a0,a0,1580 # 9098 <schedule_dm+0xd50>
  ...
  if(pid < 0) {
    ...
    1a9c:	1e050513          	addi	a0,a0,480 # 8c78 <schedule_dm+0x930>
  ...
  if(pid == 0) {
    ...
    1acc:	5d050513          	addi	a0,a0,1488 # 9098 <schedule_dm+0xd50>
    ...
    1af0:	5b450513          	addi	a0,a0,1460 # 90a0 <schedule_dm+0xd58>
    ...
    1b1c:	5a050513          	addi	a0,a0,1440 # 90b8 <schedule_dm+0xd70>
    ...
    1b3c:	f2850513          	addi	a0,a0,-216 # 8a60 <schedule_dm+0x718>
    ...
    1b56:	57650513          	addi	a0,a0,1398 # 90c8 <schedule_dm+0xd80>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1b90:	55450513          	addi	a0,a0,1364 # 90e0 <schedule_dm+0xd98>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1bb6:	4e650513          	addi	a0,a0,1254 # 9098 <schedule_dm+0xd50>
  ...
  if(fd < 0) {
    ...
    1bda:	0ba50513          	addi	a0,a0,186 # 8c90 <schedule_dm+0x948>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1c18:	2fc50513          	addi	a0,a0,764 # 8f10 <schedule_dm+0xbc8>
  ...
  unlink("echo-ok");
    ...
    1c32:	46a50513          	addi	a0,a0,1130 # 9098 <schedule_dm+0xd50>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1c6c:	49050513          	addi	a0,a0,1168 # 90f8 <schedule_dm+0xdb0>
...
pipe1(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    1ca8:	46c50513          	addi	a0,a0,1132 # 9110 <schedule_dm+0xdc8>
  ...
  if(pid == 0){
    ...
    1d06:	fc668693          	addi	a3,a3,-58 # acc8 <buf>
    ...
    1d3a:	f9258593          	addi	a1,a1,-110 # acc8 <buf>
    1d3e:	853e                	mv	a0,a5
    ...
    1d5c:	3d050513          	addi	a0,a0,976 # 9128 <schedule_dm+0xde0>
    ...
    1dc2:	f0a70713          	addi	a4,a4,-246 # acc8 <buf>
    ...
    1df4:	35050513          	addi	a0,a0,848 # 9140 <schedule_dm+0xdf8>
    ...
    1e56:	e7658593          	addi	a1,a1,-394 # acc8 <buf>
    1e5a:	853e                	mv	a0,a5
    ...
    1e90:	2cc50513          	addi	a0,a0,716 # 9158 <schedule_dm+0xe10>
    ...
    1ed8:	2a450513          	addi	a0,a0,676 # 9178 <schedule_dm+0xe30>
...
preempt(char *s)
{
  ...
  if(pid1 < 0) {
    ...
    1f22:	27250513          	addi	a0,a0,626 # 9190 <schedule_dm+0xe48>
  ...
  if(pid2 < 0) {
    ...
    1f62:	d1a50513          	addi	a0,a0,-742 # 8c78 <schedule_dm+0x930>
  ...
  if(pid3 < 0) {
    ...
    1fb0:	ccc50513          	addi	a0,a0,-820 # 8c78 <schedule_dm+0x930>
  ...
  if(pid3 == 0){
    ...
    1fe6:	96e58593          	addi	a1,a1,-1682 # 8950 <schedule_dm+0x608>
    1fea:	853e                	mv	a0,a5
    ...
    2006:	19e50513          	addi	a0,a0,414 # 91a0 <schedule_dm+0xe58>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    203a:	c9258593          	addi	a1,a1,-878 # acc8 <buf>
    203e:	853e                	mv	a0,a5
    ...
    205a:	16250513          	addi	a0,a0,354 # 91b8 <schedule_dm+0xe70>
  ...
  printf("kill... ");
    ...
    207a:	15a50513          	addi	a0,a0,346 # 91d0 <schedule_dm+0xe88>
  ...
  printf("wait... ");
    ...
    20b4:	13050513          	addi	a0,a0,304 # 91e0 <schedule_dm+0xe98>
...
exitwait(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    2118:	b6450513          	addi	a0,a0,-1180 # 8c78 <schedule_dm+0x930>
    ...
    215a:	09a50513          	addi	a0,a0,154 # 91f0 <schedule_dm+0xea8>
    ...
    2186:	08650513          	addi	a0,a0,134 # 9208 <schedule_dm+0xec0>
...
reparent(char *s)
{
  ...
  for(int i = 0; i < 200; i++){
    ...
    2210:	a6c50513          	addi	a0,a0,-1428 # 8c78 <schedule_dm+0x930>
    ...
    224e:	fa650513          	addi	a0,a0,-90 # 91f0 <schedule_dm+0xea8>
...
twochildren(char *s)
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    22f4:	98850513          	addi	a0,a0,-1656 # 8c78 <schedule_dm+0x930>
    ...
    233c:	94050513          	addi	a0,a0,-1728 # 8c78 <schedule_dm+0x930>
...
forkfork(char *s)
{
  ...
  for(int i = 0; i < N; i++){
    ...
    23d0:	dc450513          	addi	a0,a0,-572 # 9190 <schedule_dm+0xe48>
  ...
  for(int i = 0; i < N; i++){
    ...
    2490:	d9c50513          	addi	a0,a0,-612 # 9228 <schedule_dm+0xee0>
...
forkforkfork(char *s)
{
  ...
  unlink("stopforking");
    ...
    24da:	d7250513          	addi	a0,a0,-654 # 9248 <schedule_dm+0xf00>
  ...
  if(pid < 0){
    ...
    2506:	c8e50513          	addi	a0,a0,-882 # 9190 <schedule_dm+0xe48>
  ...
  if(pid == 0){
    ...
    252a:	d2250513          	addi	a0,a0,-734 # 9248 <schedule_dm+0xf00>
    ...
    2566:	ce650513          	addi	a0,a0,-794 # 9248 <schedule_dm+0xf00>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    2592:	cba50513          	addi	a0,a0,-838 # 9248 <schedule_dm+0xf00>
...
reparent2(char *s)
{
  ...
  for(int i = 0; i < 800; i++){
    ...
    25f6:	45e50513          	addi	a0,a0,1118 # 8a50 <schedule_dm+0x708>
...
mem(char *s)
{
  ...
  if((pid = fork()) == 0){
    ...
    26f0:	b6c50513          	addi	a0,a0,-1172 # 9258 <schedule_dm+0xf10>
...
sharedfd(char *s)
{
  ...
  if(fd < 0){
    ...
    2796:	ae650513          	addi	a0,a0,-1306 # 9278 <schedule_dm+0xf30>
  ...
  for(i = 0; i < N; i++){
    ...
    280c:	a9850513          	addi	a0,a0,-1384 # 92a0 <schedule_dm+0xf58>
  ...
  fd = open("sharedfd", 0);
    ...
    2884:	e3850513          	addi	a0,a0,-456 # 86b8 <schedule_dm+0x370>
  ...
  if(fd < 0){
    ...
    28a8:	a1c50513          	addi	a0,a0,-1508 # 92c0 <schedule_dm+0xf78>
  ...
  unlink("sharedfd");
    ...
    2964:	d5850513          	addi	a0,a0,-680 # 86b8 <schedule_dm+0x370>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    29a6:	94650513          	addi	a0,a0,-1722 # 92e8 <schedule_dm+0xfa0>
...
fourfiles(char *s)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    29cc:	98878793          	addi	a5,a5,-1656 # 9350 <schedule_dm+0x1008>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2a2e:	02650513          	addi	a0,a0,38 # 8a50 <schedule_dm+0x708>
    ...
    2a74:	89050513          	addi	a0,a0,-1904 # 9300 <schedule_dm+0xfb8>
    ...
    2a9e:	22e50513          	addi	a0,a0,558 # acc8 <buf>
    ...
    2abc:	21058593          	addi	a1,a1,528 # acc8 <buf>
    2ac0:	853e                	mv	a0,a5
    ...
    2aea:	82a50513          	addi	a0,a0,-2006 # 9310 <schedule_dm+0xfc8>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2bb8:	11470713          	addi	a4,a4,276 # acc8 <buf>
    ...
    2be0:	74c50513          	addi	a0,a0,1868 # 9328 <schedule_dm+0xfe0>
    ...
    2c28:	0a458593          	addi	a1,a1,164 # acc8 <buf>
    2c2c:	853e                	mv	a0,a5
    ...
    2c70:	6cc50513          	addi	a0,a0,1740 # 9338 <schedule_dm+0xff0>
...
createdelete(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2ce8:	d6c50513          	addi	a0,a0,-660 # 8a50 <schedule_dm+0x708>
    ...
    2d64:	34050513          	addi	a0,a0,832 # 90a0 <schedule_dm+0xd58>
    ...
    2dd8:	01c50513          	addi	a0,a0,28 # 8df0 <schedule_dm+0xaa8>
  ...
  for(i = 0; i < N; i++){
    ...
    2ef0:	48450513          	addi	a0,a0,1156 # 9370 <schedule_dm+0x1028>
    ...
    2f36:	46650513          	addi	a0,a0,1126 # 9398 <schedule_dm+0x1050>
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3026:	65e50513          	addi	a0,a0,1630 # 8680 <schedule_dm+0x338>
  ...
  if(fd < 0){
    ...
    304a:	37a50513          	addi	a0,a0,890 # 93c0 <schedule_dm+0x1078>
  ...
  write(fd, "hello", SZ);
    ...
    306a:	37a58593          	addi	a1,a1,890 # 93e0 <schedule_dm+0x1098>
    306e:	853e                	mv	a0,a5
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    308c:	5f850513          	addi	a0,a0,1528 # 8680 <schedule_dm+0x338>
  ...
  if(fd < 0){
    ...
    30b0:	33c50513          	addi	a0,a0,828 # 93e8 <schedule_dm+0x10a0>
  ...
  if(unlink("unlinkread") != 0){
    ...
    30ca:	5ba50513          	addi	a0,a0,1466 # 8680 <schedule_dm+0x338>
    ...
    30e2:	32a50513          	addi	a0,a0,810 # 9408 <schedule_dm+0x10c0>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3100:	58450513          	addi	a0,a0,1412 # 8680 <schedule_dm+0x338>
  ...
  write(fd1, "yyy", 3);
    ...
    311c:	31058593          	addi	a1,a1,784 # 9428 <schedule_dm+0x10e0>
    3120:	853e                	mv	a0,a5
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3142:	b8a58593          	addi	a1,a1,-1142 # acc8 <buf>
    3146:	853e                	mv	a0,a5
    ...
    3162:	2d250513          	addi	a0,a0,722 # 9430 <schedule_dm+0x10e8>
  ...
  if(buf[0] != 'h'){
    ...
    317c:	b5078793          	addi	a5,a5,-1200 # acc8 <buf>
    ...
    3196:	2be50513          	addi	a0,a0,702 # 9450 <schedule_dm+0x1108>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    31b6:	b1658593          	addi	a1,a1,-1258 # acc8 <buf>
    31ba:	853e                	mv	a0,a5
    ...
    31d6:	29e50513          	addi	a0,a0,670 # 9470 <schedule_dm+0x1128>
  ...
  unlink("unlinkread");
    ...
    31fe:	48650513          	addi	a0,a0,1158 # 8680 <schedule_dm+0x338>
...
linktest(char *s)
{
  ...
  unlink("lf1");
    ...
    3224:	27050513          	addi	a0,a0,624 # 9490 <schedule_dm+0x1148>
    3228:	00004097          	auipc	ra,0x4
    322c:	ea2080e7          	jalr	-350(ra) # 70ca <unlink>
  unlink("lf2");
    3230:	00006517          	auipc	a0,0x6
    3234:	26850513          	addi	a0,a0,616 # 9498 <schedule_dm+0x1150>
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    3248:	24c50513          	addi	a0,a0,588 # 9490 <schedule_dm+0x1148>
  ...
  if(fd < 0){
    ...
    326c:	23850513          	addi	a0,a0,568 # 94a0 <schedule_dm+0x1158>
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    328c:	15858593          	addi	a1,a1,344 # 93e0 <schedule_dm+0x1098>
    3290:	853e                	mv	a0,a5
    ...
    32ac:	21050513          	addi	a0,a0,528 # 94b8 <schedule_dm+0x1170>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    32d4:	1c858593          	addi	a1,a1,456 # 9498 <schedule_dm+0x1150>
    32d8:	00006517          	auipc	a0,0x6
    32dc:	1b850513          	addi	a0,a0,440 # 9490 <schedule_dm+0x1148>
    ...
    32f6:	1de50513          	addi	a0,a0,478 # 94d0 <schedule_dm+0x1188>
  ...
  unlink("lf1");
    ...
    3310:	18450513          	addi	a0,a0,388 # 9490 <schedule_dm+0x1148>
  ...
  if(open("lf1", 0) >= 0){
    ...
    3322:	17250513          	addi	a0,a0,370 # 9490 <schedule_dm+0x1148>
    ...
    333c:	1b850513          	addi	a0,a0,440 # 94f0 <schedule_dm+0x11a8>
  ...
  fd = open("lf2", 0);
    ...
    3358:	14450513          	addi	a0,a0,324 # 9498 <schedule_dm+0x1150>
  ...
  if(fd < 0){
    ...
    337c:	1a850513          	addi	a0,a0,424 # 9520 <schedule_dm+0x11d8>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    339c:	93058593          	addi	a1,a1,-1744 # acc8 <buf>
    33a0:	853e                	mv	a0,a5
    ...
    33bc:	18050513          	addi	a0,a0,384 # 9538 <schedule_dm+0x11f0>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    33e4:	0b858593          	addi	a1,a1,184 # 9498 <schedule_dm+0x1150>
    33e8:	00006517          	auipc	a0,0x6
    33ec:	0b050513          	addi	a0,a0,176 # 9498 <schedule_dm+0x1150>
    ...
    3406:	14e50513          	addi	a0,a0,334 # 9550 <schedule_dm+0x1208>
  ...
  unlink("lf2");
    ...
    3420:	07c50513          	addi	a0,a0,124 # 9498 <schedule_dm+0x1150>
    3424:	00004097          	auipc	ra,0x4
    3428:	ca6080e7          	jalr	-858(ra) # 70ca <unlink>
  if(link("lf2", "lf1") >= 0){
    342c:	00006597          	auipc	a1,0x6
    3430:	06458593          	addi	a1,a1,100 # 9490 <schedule_dm+0x1148>
    3434:	00006517          	auipc	a0,0x6
    3438:	06450513          	addi	a0,a0,100 # 9498 <schedule_dm+0x1150>
    ...
    3452:	12a50513          	addi	a0,a0,298 # 9578 <schedule_dm+0x1230>
  ...
  if(link(".", "lf1") >= 0){
    ...
    346c:	02858593          	addi	a1,a1,40 # 9490 <schedule_dm+0x1148>
    3470:	00006517          	auipc	a0,0x6
    3474:	13050513          	addi	a0,a0,304 # 95a0 <schedule_dm+0x1258>
    ...
    348e:	11e50513          	addi	a0,a0,286 # 95a8 <schedule_dm+0x1260>
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    3522:	0aa50513          	addi	a0,a0,170 # 95c8 <schedule_dm+0x1280>
    ...
    3556:	07650513          	addi	a0,a0,118 # 95c8 <schedule_dm+0x1280>
    ...
    3590:	04450513          	addi	a0,a0,68 # 95d0 <schedule_dm+0x1288>
  ...
  fd = open(".", 0);
    ...
    3618:	f8c50513          	addi	a0,a0,-116 # 95a0 <schedule_dm+0x1258>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3682:	f7250513          	addi	a0,a0,-142 # 95f0 <schedule_dm+0x12a8>
    ...
    36b8:	f5c50513          	addi	a0,a0,-164 # 9610 <schedule_dm+0x12c8>
  ...
  if(n != N){
    ...
    372a:	f1250513          	addi	a0,a0,-238 # 9638 <schedule_dm+0x12f0>
  ...
  for(i = 0; i < N; i++){
    ...
    377a:	50250513          	addi	a0,a0,1282 # 8c78 <schedule_dm+0x930>
...
linkunlink(char *s)
{
  ...
  unlink("x");
    ...
    3912:	04250513          	addi	a0,a0,66 # 8950 <schedule_dm+0x608>
  ...
  if(pid < 0){
    ...
    393e:	33e50513          	addi	a0,a0,830 # 8c78 <schedule_dm+0x930>
  ...
  for(i = 0; i < 100; i++){
    ...
    39a4:	fb050513          	addi	a0,a0,-80 # 8950 <schedule_dm+0x608>
    ...
    39d6:	f7e58593          	addi	a1,a1,-130 # 8950 <schedule_dm+0x608>
    39da:	00006517          	auipc	a0,0x6
    39de:	c9650513          	addi	a0,a0,-874 # 9670 <schedule_dm+0x1328>
    ...
    39f0:	f6450513          	addi	a0,a0,-156 # 8950 <schedule_dm+0x608>
...
bigdir(char *s)
{
  ...
  unlink("bd");
    ...
    3a4c:	c3050513          	addi	a0,a0,-976 # 9678 <schedule_dm+0x1330>
  ...
  fd = open("bd", O_CREATE);
    ...
    3a60:	c1c50513          	addi	a0,a0,-996 # 9678 <schedule_dm+0x1330>
  ...
  if(fd < 0){
    ...
    3a84:	c0050513          	addi	a0,a0,-1024 # 9680 <schedule_dm+0x1338>
  ...
  for(i = 0; i < N; i++){
    ...
    3b10:	b6c50513          	addi	a0,a0,-1172 # 9678 <schedule_dm+0x1330>
    ...
    3b2e:	b7650513          	addi	a0,a0,-1162 # 96a0 <schedule_dm+0x1358>
  ...
  unlink("bd");
    ...
    3b62:	b1a50513          	addi	a0,a0,-1254 # 9678 <schedule_dm+0x1330>
  ...
  for(i = 0; i < N; i++){
    ...
    3be6:	ade50513          	addi	a0,a0,-1314 # 96c0 <schedule_dm+0x1378>
...
subdir(char *s)
{
  ...
  unlink("ff");
    ...
    3c32:	ab250513          	addi	a0,a0,-1358 # 96e0 <schedule_dm+0x1398>
    3c36:	00003097          	auipc	ra,0x3
    3c3a:	494080e7          	jalr	1172(ra) # 70ca <unlink>
  if(mkdir("dd") != 0){
    3c3e:	00006517          	auipc	a0,0x6
    3c42:	aaa50513          	addi	a0,a0,-1366 # 96e8 <schedule_dm+0x13a0>
    ...
    3c5a:	a9a50513          	addi	a0,a0,-1382 # 96f0 <schedule_dm+0x13a8>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3c78:	a9450513          	addi	a0,a0,-1388 # 9708 <schedule_dm+0x13c0>
  ...
  if(fd < 0){
    ...
    3c9c:	a7850513          	addi	a0,a0,-1416 # 9710 <schedule_dm+0x13c8>
  ...
  write(fd, "ff", 2);
    ...
    3cbc:	a2858593          	addi	a1,a1,-1496 # 96e0 <schedule_dm+0x1398>
    3cc0:	853e                	mv	a0,a5
  ...
  if(unlink("dd") >= 0){
    ...
    3cdc:	a1050513          	addi	a0,a0,-1520 # 96e8 <schedule_dm+0x13a0>
    ...
    3cf6:	a3e50513          	addi	a0,a0,-1474 # 9730 <schedule_dm+0x13e8>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3d10:	a5450513          	addi	a0,a0,-1452 # 9760 <schedule_dm+0x1418>
    ...
    3d28:	a4450513          	addi	a0,a0,-1468 # 9768 <schedule_dm+0x1420>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3d46:	a4650513          	addi	a0,a0,-1466 # 9788 <schedule_dm+0x1440>
  ...
  if(fd < 0){
    ...
    3d6a:	a3250513          	addi	a0,a0,-1486 # 9798 <schedule_dm+0x1450>
  ...
  write(fd, "FF", 2);
    ...
    3d8a:	a3258593          	addi	a1,a1,-1486 # 97b8 <schedule_dm+0x1470>
    3d8e:	853e                	mv	a0,a5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3dac:	a1850513          	addi	a0,a0,-1512 # 97c0 <schedule_dm+0x1478>
  ...
  if(fd < 0){
    ...
    3dd0:	a0450513          	addi	a0,a0,-1532 # 97d0 <schedule_dm+0x1488>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3df0:	edc58593          	addi	a1,a1,-292 # acc8 <buf>
    3df4:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3e16:	eb678793          	addi	a5,a5,-330 # acc8 <buf>
    ...
    3e30:	9c450513          	addi	a0,a0,-1596 # 97f0 <schedule_dm+0x14a8>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3e58:	9bc58593          	addi	a1,a1,-1604 # 9810 <schedule_dm+0x14c8>
    3e5c:	00006517          	auipc	a0,0x6
    3e60:	92c50513          	addi	a0,a0,-1748 # 9788 <schedule_dm+0x1440>
    ...
    3e78:	9ac50513          	addi	a0,a0,-1620 # 9820 <schedule_dm+0x14d8>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3e92:	8fa50513          	addi	a0,a0,-1798 # 9788 <schedule_dm+0x1440>
    ...
    3eaa:	9a250513          	addi	a0,a0,-1630 # 9848 <schedule_dm+0x1500>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3ec6:	8c650513          	addi	a0,a0,-1850 # 9788 <schedule_dm+0x1440>
    ...
    3ee0:	98c50513          	addi	a0,a0,-1652 # 9868 <schedule_dm+0x1520>
  ...
  if(chdir("dd") != 0){
    ...
    3efa:	7f250513          	addi	a0,a0,2034 # 96e8 <schedule_dm+0x13a0>
    ...
    3f12:	98250513          	addi	a0,a0,-1662 # 9890 <schedule_dm+0x1548>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3f2c:	98050513          	addi	a0,a0,-1664 # 98a8 <schedule_dm+0x1560>
    ...
    3f44:	97850513          	addi	a0,a0,-1672 # 98b8 <schedule_dm+0x1570>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3f5e:	97e50513          	addi	a0,a0,-1666 # 98d8 <schedule_dm+0x1590>
    ...
    3f76:	97650513          	addi	a0,a0,-1674 # 98e8 <schedule_dm+0x15a0>
  ...
  if(chdir("./..") != 0){
    ...
    3f90:	97c50513          	addi	a0,a0,-1668 # 9908 <schedule_dm+0x15c0>
    ...
    3fa8:	96c50513          	addi	a0,a0,-1684 # 9910 <schedule_dm+0x15c8>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3fc4:	85050513          	addi	a0,a0,-1968 # 9810 <schedule_dm+0x14c8>
  ...
  if(fd < 0){
    ...
    3fe8:	94450513          	addi	a0,a0,-1724 # 9928 <schedule_dm+0x15e0>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    4008:	cc458593          	addi	a1,a1,-828 # acc8 <buf>
    400c:	853e                	mv	a0,a5
    ...
    4028:	92450513          	addi	a0,a0,-1756 # 9948 <schedule_dm+0x1600>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    4052:	73a50513          	addi	a0,a0,1850 # 9788 <schedule_dm+0x1440>
    ...
    406c:	90050513          	addi	a0,a0,-1792 # 9968 <schedule_dm+0x1620>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    408a:	91250513          	addi	a0,a0,-1774 # 9998 <schedule_dm+0x1650>
    ...
    40a4:	90850513          	addi	a0,a0,-1784 # 99a8 <schedule_dm+0x1660>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    40c2:	90a50513          	addi	a0,a0,-1782 # 99c8 <schedule_dm+0x1680>
    ...
    40dc:	90050513          	addi	a0,a0,-1792 # 99d8 <schedule_dm+0x1690>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    40fa:	5f250513          	addi	a0,a0,1522 # 96e8 <schedule_dm+0x13a0>
    ...
    4114:	8e850513          	addi	a0,a0,-1816 # 99f8 <schedule_dm+0x16b0>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    4130:	5bc50513          	addi	a0,a0,1468 # 96e8 <schedule_dm+0x13a0>
    ...
    414a:	8d250513          	addi	a0,a0,-1838 # 9a18 <schedule_dm+0x16d0>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    4166:	58650513          	addi	a0,a0,1414 # 96e8 <schedule_dm+0x13a0>
    ...
    4180:	8bc50513          	addi	a0,a0,-1860 # 9a38 <schedule_dm+0x16f0>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    419a:	8c258593          	addi	a1,a1,-1854 # 9a58 <schedule_dm+0x1710>
    419e:	00005517          	auipc	a0,0x5
    41a2:	7fa50513          	addi	a0,a0,2042 # 9998 <schedule_dm+0x1650>
    ...
    41ba:	8b250513          	addi	a0,a0,-1870 # 9a68 <schedule_dm+0x1720>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    41d4:	88858593          	addi	a1,a1,-1912 # 9a58 <schedule_dm+0x1710>
    41d8:	00005517          	auipc	a0,0x5
    41dc:	7f050513          	addi	a0,a0,2032 # 99c8 <schedule_dm+0x1680>
    ...
    41f4:	8a050513          	addi	a0,a0,-1888 # 9a90 <schedule_dm+0x1748>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    420e:	60658593          	addi	a1,a1,1542 # 9810 <schedule_dm+0x14c8>
    4212:	00005517          	auipc	a0,0x5
    4216:	4f650513          	addi	a0,a0,1270 # 9708 <schedule_dm+0x13c0>
    ...
    422e:	88e50513          	addi	a0,a0,-1906 # 9ab8 <schedule_dm+0x1770>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    4248:	75450513          	addi	a0,a0,1876 # 9998 <schedule_dm+0x1650>
    ...
    4260:	88450513          	addi	a0,a0,-1916 # 9ae0 <schedule_dm+0x1798>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    427a:	75250513          	addi	a0,a0,1874 # 99c8 <schedule_dm+0x1680>
    ...
    4292:	87250513          	addi	a0,a0,-1934 # 9b00 <schedule_dm+0x17b8>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    42ac:	56850513          	addi	a0,a0,1384 # 9810 <schedule_dm+0x14c8>
    ...
    42c4:	86050513          	addi	a0,a0,-1952 # 9b20 <schedule_dm+0x17d8>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    42de:	6ee50513          	addi	a0,a0,1774 # 99c8 <schedule_dm+0x1680>
    ...
    42f6:	85650513          	addi	a0,a0,-1962 # 9b48 <schedule_dm+0x1800>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    4310:	68c50513          	addi	a0,a0,1676 # 9998 <schedule_dm+0x1650>
    ...
    4328:	84450513          	addi	a0,a0,-1980 # 9b68 <schedule_dm+0x1820>
  ...
  if(chdir("dd/ff") == 0){
    ...
    4342:	3ca50513          	addi	a0,a0,970 # 9708 <schedule_dm+0x13c0>
    ...
    435a:	83250513          	addi	a0,a0,-1998 # 9b88 <schedule_dm+0x1840>
  ...
  if(chdir("dd/xx") == 0){
    ...
    4374:	83850513          	addi	a0,a0,-1992 # 9ba8 <schedule_dm+0x1860>
    ...
    438c:	82850513          	addi	a0,a0,-2008 # 9bb0 <schedule_dm+0x1868>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    43a6:	46e50513          	addi	a0,a0,1134 # 9810 <schedule_dm+0x14c8>
    ...
    43be:	48e50513          	addi	a0,a0,1166 # 9848 <schedule_dm+0x1500>
  ...
  if(unlink("dd/ff") != 0){
    ...
    43d8:	33450513          	addi	a0,a0,820 # 9708 <schedule_dm+0x13c0>
    ...
    43f0:	7e450513          	addi	a0,a0,2020 # 9bd0 <schedule_dm+0x1888>
  ...
  if(unlink("dd") == 0){
    ...
    440a:	2e250513          	addi	a0,a0,738 # 96e8 <schedule_dm+0x13a0>
    ...
    4422:	7d250513          	addi	a0,a0,2002 # 9bf0 <schedule_dm+0x18a8>
  ...
  if(unlink("dd/dd") < 0){
    ...
    443c:	7e050513          	addi	a0,a0,2016 # 9c18 <schedule_dm+0x18d0>
    ...
    4456:	7ce50513          	addi	a0,a0,1998 # 9c20 <schedule_dm+0x18d8>
  ...
  if(unlink("dd") < 0){
    ...
    4470:	27c50513          	addi	a0,a0,636 # 96e8 <schedule_dm+0x13a0>
    ...
    448a:	7ba50513          	addi	a0,a0,1978 # 9c40 <schedule_dm+0x18f8>
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
    ...
    44ba:	23a50513          	addi	a0,a0,570 # 86f0 <schedule_dm+0x3a8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    44d8:	21c50513          	addi	a0,a0,540 # 86f0 <schedule_dm+0x3a8>
    ...
    44fc:	76050513          	addi	a0,a0,1888 # 9c58 <schedule_dm+0x1910>
    ...
    4526:	7a658593          	addi	a1,a1,1958 # acc8 <buf>
    452a:	853e                	mv	a0,a5
    ...
    455e:	71e50513          	addi	a0,a0,1822 # 9c78 <schedule_dm+0x1930>
    ...
    459e:	15650513          	addi	a0,a0,342 # 86f0 <schedule_dm+0x3a8>
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    460a:	44a50513          	addi	a0,a0,1098 # 8a50 <schedule_dm+0x708>
    ...
    4694:	60050513          	addi	a0,a0,1536 # 9c90 <schedule_dm+0x1948>
    ...
    46be:	60e58593          	addi	a1,a1,1550 # acc8 <buf>
    46c2:	853e                	mv	a0,a5
    ...
    46f6:	58650513          	addi	a0,a0,1414 # 9c78 <schedule_dm+0x1930>
...
bigfile(char *s)
{
  ...
  if(fd < 0){
    ...
    4826:	49650513          	addi	a0,a0,1174 # 9cb8 <schedule_dm+0x1970>
  ...
  for(i = 0; i < N; i++){
    ...
    4850:	47c50513          	addi	a0,a0,1148 # acc8 <buf>
    ...
    4868:	46458593          	addi	a1,a1,1124 # acc8 <buf>
    486c:	853e                	mv	a0,a5
    ...
    488a:	45250513          	addi	a0,a0,1106 # 9cd8 <schedule_dm+0x1990>
  ...
  fd = open("bigfile.dat", 0);
    ...
    48cc:	3e050513          	addi	a0,a0,992 # 9ca8 <schedule_dm+0x1960>
  ...
  if(fd < 0){
    ...
    48f0:	40c50513          	addi	a0,a0,1036 # 9cf8 <schedule_dm+0x19b0>
  ...
  for(i = 0; ; i++){
    ...
    491a:	3b258593          	addi	a1,a1,946 # acc8 <buf>
    491e:	853e                	mv	a0,a5
    ...
    4940:	3dc50513          	addi	a0,a0,988 # 9d18 <schedule_dm+0x19d0>
    ...
    4976:	3c650513          	addi	a0,a0,966 # 9d38 <schedule_dm+0x19f0>
    ...
    4990:	33c78793          	addi	a5,a5,828 # acc8 <buf>
    ...
    49b6:	31678793          	addi	a5,a5,790 # acc8 <buf>
    ...
    49e0:	37450513          	addi	a0,a0,884 # 9d50 <schedule_dm+0x1a08>
  ...
  if(total != N*SZ){
    ...
    4a3a:	33a50513          	addi	a0,a0,826 # 9d70 <schedule_dm+0x1a28>
  ...
  unlink("bigfile.dat");
    ...
    4a54:	25850513          	addi	a0,a0,600 # 9ca8 <schedule_dm+0x1960>
...
fourteen(char *s)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    4a7a:	31a50513          	addi	a0,a0,794 # 9d90 <schedule_dm+0x1a48>
    ...
    4a92:	31250513          	addi	a0,a0,786 # 9da0 <schedule_dm+0x1a58>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    4aac:	32050513          	addi	a0,a0,800 # 9dc8 <schedule_dm+0x1a80>
    ...
    4ac4:	32850513          	addi	a0,a0,808 # 9de8 <schedule_dm+0x1aa0>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    4ae2:	34250513          	addi	a0,a0,834 # 9e20 <schedule_dm+0x1ad8>
  ...
  if(fd < 0){
    ...
    4b06:	34e50513          	addi	a0,a0,846 # 9e50 <schedule_dm+0x1b08>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    4b30:	36c50513          	addi	a0,a0,876 # 9e98 <schedule_dm+0x1b50>
  ...
  if(fd < 0){
    ...
    4b54:	37850513          	addi	a0,a0,888 # 9ec8 <schedule_dm+0x1b80>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    4b7c:	39050513          	addi	a0,a0,912 # 9f08 <schedule_dm+0x1bc0>
    ...
    4b94:	39850513          	addi	a0,a0,920 # 9f28 <schedule_dm+0x1be0>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    4bae:	3b650513          	addi	a0,a0,950 # 9f60 <schedule_dm+0x1c18>
    ...
    4bc6:	3be50513          	addi	a0,a0,958 # 9f80 <schedule_dm+0x1c38>
...
rmdot(char *s)
{
  ...
  if(mkdir("dots") != 0){
    ...
    4c56:	36650513          	addi	a0,a0,870 # 9fb8 <schedule_dm+0x1c70>
    ...
    4c6e:	35650513          	addi	a0,a0,854 # 9fc0 <schedule_dm+0x1c78>
  ...
  if(chdir("dots") != 0){
    ...
    4c88:	33450513          	addi	a0,a0,820 # 9fb8 <schedule_dm+0x1c70>
    ...
    4ca0:	33c50513          	addi	a0,a0,828 # 9fd8 <schedule_dm+0x1c90>
  ...
  if(unlink(".") == 0){
    ...
    4cba:	8ea50513          	addi	a0,a0,-1814 # 95a0 <schedule_dm+0x1258>
    ...
    4cd2:	32250513          	addi	a0,a0,802 # 9ff0 <schedule_dm+0x1ca8>
  ...
  if(unlink("..") == 0){
    ...
    4cec:	37050513          	addi	a0,a0,880 # 9058 <schedule_dm+0xd10>
    ...
    4d04:	30850513          	addi	a0,a0,776 # a008 <schedule_dm+0x1cc0>
  ...
  if(chdir("/") != 0){
    ...
    4d1e:	05650513          	addi	a0,a0,86 # 8d70 <schedule_dm+0xa28>
    ...
    4d36:	04650513          	addi	a0,a0,70 # 8d78 <schedule_dm+0xa30>
  ...
  if(unlink("dots/.") == 0){
    ...
    4d50:	2d450513          	addi	a0,a0,724 # a020 <schedule_dm+0x1cd8>
    ...
    4d68:	2c450513          	addi	a0,a0,708 # a028 <schedule_dm+0x1ce0>
  ...
  if(unlink("dots/..") == 0){
    ...
    4d82:	2ca50513          	addi	a0,a0,714 # a048 <schedule_dm+0x1d00>
    ...
    4d9a:	2ba50513          	addi	a0,a0,698 # a050 <schedule_dm+0x1d08>
  ...
  if(unlink("dots") != 0){
    ...
    4db4:	20850513          	addi	a0,a0,520 # 9fb8 <schedule_dm+0x1c70>
    ...
    4dcc:	2a850513          	addi	a0,a0,680 # a070 <schedule_dm+0x1d28>
...
dirfile(char *s)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4e00:	a1c50513          	addi	a0,a0,-1508 # 8818 <schedule_dm+0x4d0>
  ...
  if(fd < 0){
    ...
    4e24:	27050513          	addi	a0,a0,624 # a090 <schedule_dm+0x1d48>
  ...
  if(chdir("dirfile") == 0){
    ...
    4e4c:	9d050513          	addi	a0,a0,-1584 # 8818 <schedule_dm+0x4d0>
    ...
    4e64:	25050513          	addi	a0,a0,592 # a0b0 <schedule_dm+0x1d68>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4e80:	25450513          	addi	a0,a0,596 # a0d0 <schedule_dm+0x1d88>
  ...
  if(fd >= 0){
    ...
    4ea4:	24050513          	addi	a0,a0,576 # a0e0 <schedule_dm+0x1d98>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4ec2:	21250513          	addi	a0,a0,530 # a0d0 <schedule_dm+0x1d88>
  ...
  if(fd >= 0){
    ...
    4ee6:	1fe50513          	addi	a0,a0,510 # a0e0 <schedule_dm+0x1d98>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4f00:	1d450513          	addi	a0,a0,468 # a0d0 <schedule_dm+0x1d88>
    ...
    4f18:	1f450513          	addi	a0,a0,500 # a108 <schedule_dm+0x1dc0>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4f32:	1a250513          	addi	a0,a0,418 # a0d0 <schedule_dm+0x1d88>
    ...
    4f4a:	1ea50513          	addi	a0,a0,490 # a130 <schedule_dm+0x1de8>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4f64:	17058593          	addi	a1,a1,368 # a0d0 <schedule_dm+0x1d88>
    4f68:	00004517          	auipc	a0,0x4
    4f6c:	99850513          	addi	a0,a0,-1640 # 8900 <schedule_dm+0x5b8>
    ...
    4f84:	1d850513          	addi	a0,a0,472 # a158 <schedule_dm+0x1e10>
  ...
  if(unlink("dirfile") != 0){
    ...
    4f9e:	87e50513          	addi	a0,a0,-1922 # 8818 <schedule_dm+0x4d0>
    ...
    4fb6:	1ce50513          	addi	a0,a0,462 # a180 <schedule_dm+0x1e38>
  ...
  fd = open(".", O_RDWR);
    ...
    4fd2:	5d250513          	addi	a0,a0,1490 # 95a0 <schedule_dm+0x1258>
  ...
  if(fd >= 0){
    ...
    4ff6:	1ae50513          	addi	a0,a0,430 # a1a0 <schedule_dm+0x1e58>
  ...
  fd = open(".", 0);
    ...
    5012:	59250513          	addi	a0,a0,1426 # 95a0 <schedule_dm+0x1258>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    502e:	92658593          	addi	a1,a1,-1754 # 8950 <schedule_dm+0x608>
    5032:	853e                	mv	a0,a5
    ...
    504a:	18250513          	addi	a0,a0,386 # a1c8 <schedule_dm+0x1e80>
...
iref(char *s)
{
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    508e:	15650513          	addi	a0,a0,342 # a1e0 <schedule_dm+0x1e98>
    ...
    50a6:	14650513          	addi	a0,a0,326 # a1e8 <schedule_dm+0x1ea0>
    ...
    50c0:	12450513          	addi	a0,a0,292 # a1e0 <schedule_dm+0x1e98>
    ...
    50d8:	12c50513          	addi	a0,a0,300 # a200 <schedule_dm+0x1eb8>
    ...
    5150:	8dc50513          	addi	a0,a0,-1828 # 8a28 <schedule_dm+0x6e0>
    ...
    517e:	8ae50513          	addi	a0,a0,-1874 # 8a28 <schedule_dm+0x6e0>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    51ae:	eae50513          	addi	a0,a0,-338 # 9058 <schedule_dm+0xd10>
    51b2:	00002097          	auipc	ra,0x2
    51b6:	f38080e7          	jalr	-200(ra) # 70ea <chdir>
    unlink("irefd");
    51ba:	00005517          	auipc	a0,0x5
    51be:	02650513          	addi	a0,a0,38 # a1e0 <schedule_dm+0x1e98>
  ...
  chdir("/");
    ...
    51e8:	b8c50513          	addi	a0,a0,-1140 # 8d70 <schedule_dm+0xa28>
...
forktest(char *s)
{
  ...
  if (n == 0) {
    ...
    5268:	fbc50513          	addi	a0,a0,-68 # a220 <schedule_dm+0x1ed8>
  ...
  if(n == N){
    ...
    5296:	fa650513          	addi	a0,a0,-90 # a238 <schedule_dm+0x1ef0>
  ...
  for(; n > 0; n--){
    ...
    52c4:	fa050513          	addi	a0,a0,-96 # a260 <schedule_dm+0x1f18>
  ...
  if(wait(0) != -1){
    ...
    530a:	f7250513          	addi	a0,a0,-142 # a278 <schedule_dm+0x1f30>
...
sbrkbasic(char *s)
{
  ...
  if(pid < 0){
    ...
    5352:	f4250513          	addi	a0,a0,-190 # a290 <schedule_dm+0x1f48>
  ...
  if(xstatus == 1){
    ...
    53f4:	ec050513          	addi	a0,a0,-320 # a2b0 <schedule_dm+0x1f68>
  ...
  for(i = 0; i < 5000; i++){
    ...
    544a:	e8a50513          	addi	a0,a0,-374 # a2d0 <schedule_dm+0x1f88>
    ...
    *b = 1;
    ...
    5464:	4705                	li	a4,1
    5466:	00e78023          	sb	a4,0(a5) # 40000000 <__BSS_END__+0x3ffeeb00>
    a = b + 1;
  ...
  if(pid < 0){
    ...
    54b0:	e4450513          	addi	a0,a0,-444 # a2f0 <schedule_dm+0x1fa8>
  ...
  if(c != a + 1){
    ...
    54f8:	e1c50513          	addi	a0,a0,-484 # a310 <schedule_dm+0x1fc8>
...
sbrkmuch(char *s)
{
  ...
  if (p != a) {
    ...
    559c:	d9850513          	addi	a0,a0,-616 # a330 <schedule_dm+0x1fe8>
  ...
  *lastaddr = 99;
    ...
    55fe:	00e78023          	sb	a4,0(a5) # 6400000 <__BSS_END__+0x63eeb00>
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5630:	d4c50513          	addi	a0,a0,-692 # a378 <schedule_dm+0x2030>
  ...
  if(c != a - PGSIZE){
    ...
    5674:	d2850513          	addi	a0,a0,-728 # a398 <schedule_dm+0x2050>
  ...
  if(c != a || sbrk(0) != a + PGSIZE){
    ...
    56da:	d0250513          	addi	a0,a0,-766 # a3d8 <schedule_dm+0x2090>
  ...
  if(*lastaddr == 99){
    ...
    570a:	d0250513          	addi	a0,a0,-766 # a408 <schedule_dm+0x20c0>
  ...
  if(c != a){
    ...
    576c:	cd850513          	addi	a0,a0,-808 # a440 <schedule_dm+0x20f8>
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    57c2:	4ba50513          	addi	a0,a0,1210 # 8c78 <schedule_dm+0x930>
    ...
    57f8:	c7450513          	addi	a0,a0,-908 # a468 <schedule_dm+0x2120>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    5838:	35078793          	addi	a5,a5,848 # c350 <__global_pointer$+0xe90>
    ...
    584c:	47f78793          	addi	a5,a5,1151 # 1003d47f <__BSS_END__+0x1002bf7f>
...
sbrkfail(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    5886:	88e50513          	addi	a0,a0,-1906 # 9110 <schedule_dm+0xdc8>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    58fe:	05658593          	addi	a1,a1,86 # 8950 <schedule_dm+0x608>
    5902:	853e                	mv	a0,a5
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    59da:	ab250513          	addi	a0,a0,-1358 # a488 <schedule_dm+0x2140>
  ...
  if(pid < 0){
    ...
    5a10:	26c50513          	addi	a0,a0,620 # 8c78 <schedule_dm+0x930>
  ...
  if(pid == 0){
    ...
    5a96:	a1650513          	addi	a0,a0,-1514 # a4a8 <schedule_dm+0x2160>
...
sbrkarg(char *s)
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    5b08:	9d450513          	addi	a0,a0,-1580 # a4d8 <schedule_dm+0x2190>
  ...
  unlink("sbrk");
    ...
    5b1e:	9be50513          	addi	a0,a0,-1602 # a4d8 <schedule_dm+0x2190>
  ...
  if(fd < 0)  {
    ...
    5b3c:	9a850513          	addi	a0,a0,-1624 # a4e0 <schedule_dm+0x2198>
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    5b7e:	97e50513          	addi	a0,a0,-1666 # a4f8 <schedule_dm+0x21b0>
  ...
  if(pipe((int *) a) != 0){
    ...
    5bc8:	54c50513          	addi	a0,a0,1356 # 9110 <schedule_dm+0xdc8>
...
validatetest(char *s)
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    5c0c:	90850513          	addi	a0,a0,-1784 # a510 <schedule_dm+0x21c8>
    ...
    5c2a:	8fa50513          	addi	a0,a0,-1798 # a520 <schedule_dm+0x21d8>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    5c7e:	04e70713          	addi	a4,a4,78 # dcc8 <uninit>
    ...
    5c96:	8ae50513          	addi	a0,a0,-1874 # a540 <schedule_dm+0x21f8>
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    ...
    5ce2:	87a50513          	addi	a0,a0,-1926 # a558 <schedule_dm+0x2210>
  ...
  if(pid == 0){
    ...
    5d0e:	6d670713          	addi	a4,a4,1750 # 113e0 <args.1845>
    5d12:	fec42783          	lw	a5,-20(s0)
    5d16:	078e                	slli	a5,a5,0x3
    5d18:	97ba                	add	a5,a5,a4
    5d1a:	00005717          	auipc	a4,0x5
    5d1e:	84e70713          	addi	a4,a4,-1970 # a568 <schedule_dm+0x2220>
    ...
    5da4:	8a850513          	addi	a0,a0,-1880 # a648 <schedule_dm+0x2300>
  ...
  fd = open("bigarg-ok", 0);
    ...
    5de2:	77a50513          	addi	a0,a0,1914 # a558 <schedule_dm+0x2210>
  ...
  if(fd < 0){
    ...
    5e06:	86650513          	addi	a0,a0,-1946 # a668 <schedule_dm+0x2320>
...
fsfull()
{
  ...
  printf("fsfull test\n");
    ...
    5e44:	84850513          	addi	a0,a0,-1976 # a688 <schedule_dm+0x2340>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5ef6:	7a650513          	addi	a0,a0,1958 # a698 <schedule_dm+0x2350>
    ...
    5f2e:	77e50513          	addi	a0,a0,1918 # a6a8 <schedule_dm+0x2360>
    ...
    5f4c:	d8058593          	addi	a1,a1,-640 # acc8 <buf>
    5f50:	853e                	mv	a0,a5
    ...
    5f96:	72650513          	addi	a0,a0,1830 # a6b8 <schedule_dm+0x2370>
  ...
  printf("fsfull test finished\n");
    ...
    6086:	64650513          	addi	a0,a0,1606 # a6c8 <schedule_dm+0x2380>
...
void argptest(char *s)
{
  ...
  fd = open("init", O_RDONLY);
    ...
    60ae:	63650513          	addi	a0,a0,1590 # a6e0 <schedule_dm+0x2398>
  ...
  if (fd < 0) {
    ...
    60d2:	bc250513          	addi	a0,a0,-1086 # 8c90 <schedule_dm+0x948>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    612c:	b9878793          	addi	a5,a5,-1128 # acc0 <randstate>
    6130:	6398                	ld	a4,0(a5)
    6132:	001967b7          	lui	a5,0x196
    6136:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x18510d>
    613a:	02f70733          	mul	a4,a4,a5
    613e:	3c6ef7b7          	lui	a5,0x3c6ef
    6142:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6dde5f>
    6146:	973e                	add	a4,a4,a5
    6148:	00005797          	auipc	a5,0x5
    614c:	b7878793          	addi	a5,a5,-1160 # acc0 <randstate>
    6150:	e398                	sd	a4,0(a5)
  return randstate;
    6152:	00005797          	auipc	a5,0x5
    6156:	b6e78793          	addi	a5,a5,-1170 # acc0 <randstate>
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    61a6:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffedb00>
    61aa:	2781                	sext.w	a5,a5
    61ac:	863e                	mv	a2,a5
    61ae:	fc843583          	ld	a1,-56(s0)
    61b2:	00004517          	auipc	a0,0x4
    61b6:	53650513          	addi	a0,a0,1334 # a6e8 <schedule_dm+0x23a0>
    ...
    61de:	a9e50513          	addi	a0,a0,-1378 # 8c78 <schedule_dm+0x930>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    623e:	a5e78793          	addi	a5,a5,-1442 # ac98 <schedule_dm+0x2950>
  ...
  pipe((int*)0xeaeb0b5b00002f5e);
    ...
    6254:	a4878793          	addi	a5,a5,-1464 # ac98 <schedule_dm+0x2950>
...
sbrkbugs(char *s)
{
  ...
  if(pid < 0){
    ...
    6296:	7be50513          	addi	a0,a0,1982 # 8a50 <schedule_dm+0x708>
  ...
  if(pid < 0){
    ...
    6308:	74c50513          	addi	a0,a0,1868 # 8a50 <schedule_dm+0x708>
  ...
  if(pid < 0){
    ...
    6380:	6d450513          	addi	a0,a0,1748 # 8a50 <schedule_dm+0x708>
...
badwrite(char *s)
{
  ...
  unlink("junk");
    ...
    6404:	31050513          	addi	a0,a0,784 # a710 <schedule_dm+0x23c8>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    641e:	2f650513          	addi	a0,a0,758 # a710 <schedule_dm+0x23c8>
    ...
    643e:	2de50513          	addi	a0,a0,734 # a718 <schedule_dm+0x23d0>
    ...
    647c:	29850513          	addi	a0,a0,664 # a710 <schedule_dm+0x23c8>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    64aa:	26a50513          	addi	a0,a0,618 # a710 <schedule_dm+0x23c8>
  ...
  if(fd < 0){
    ...
    64ca:	25250513          	addi	a0,a0,594 # a718 <schedule_dm+0x23d0>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    64ea:	46a58593          	addi	a1,a1,1130 # 8950 <schedule_dm+0x608>
    64ee:	853e                	mv	a0,a5
    ...
    6506:	22e50513          	addi	a0,a0,558 # a730 <schedule_dm+0x23e8>
  ...
  unlink("junk");
    ...
    652e:	1e650513          	addi	a0,a0,486 # a710 <schedule_dm+0x23c8>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    656c:	4f850513          	addi	a0,a0,1272 # 8a60 <schedule_dm+0x718>
  ...
  for(int i = 0; i < 50000; i++){
    ...
    658c:	34f78793          	addi	a5,a5,847 # c34f <__global_pointer$+0xe8f>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    65cc:	48850513          	addi	a0,a0,1160 # 8a50 <schedule_dm+0x708>
    ...
    660e:	873e                	mv	a4,a5
    6610:	4785                	li	a5,1
    6612:	00f70023          	sb	a5,0(a4) # b000 <buf+0x338>
      while(1){
    ...
    6652:	41278793          	addi	a5,a5,1042 # 8a60 <schedule_dm+0x718>
    6656:	fcf43023          	sd	a5,-64(s0)
    665a:	00002797          	auipc	a5,0x2
    665e:	2f678793          	addi	a5,a5,758 # 8950 <schedule_dm+0x608>
    ...
    6674:	3f050513          	addi	a0,a0,1008 # 8a60 <schedule_dm+0x718>
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    66d6:	06e50513          	addi	a0,a0,110 # a740 <schedule_dm+0x23f8>
  ...
  if(pid < 0){
    ...
    6708:	05c50513          	addi	a0,a0,92 # a760 <schedule_dm+0x2418>
  ...
  if(pid == 0){
    ...
    676a:	1ea58593          	addi	a1,a1,490 # 8950 <schedule_dm+0x608>
    676e:	853e                	mv	a0,a5
    ...
    6786:	ffe50513          	addi	a0,a0,-2 # a780 <schedule_dm+0x2438>
  ...
  while(1){
    ...
    67e4:	fc050513          	addi	a0,a0,-64 # a7a0 <schedule_dm+0x2458>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    684e:	f7650513          	addi	a0,a0,-138 # a7c0 <schedule_dm+0x2478>
  ...
  if((pid = fork()) < 0) {
    ...
    6876:	f5e50513          	addi	a0,a0,-162 # a7d0 <schedule_dm+0x2488>
  ...
  if(pid == 0) {
    ...
    68c0:	f2c50513          	addi	a0,a0,-212 # a7e8 <schedule_dm+0x24a0>
    ...
    68d2:	f2250513          	addi	a0,a0,-222 # a7f0 <schedule_dm+0x24a8>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    6932:	eca58593          	addi	a1,a1,-310 # a7f8 <schedule_dm+0x24b0>
    6936:	853e                	mv	a0,a5
    ...
    6966:	e9e58593          	addi	a1,a1,-354 # a800 <schedule_dm+0x24b8>
    696a:	853e                	mv	a0,a5
    ...
    69c2:	e4a50513          	addi	a0,a0,-438 # a808 <schedule_dm+0x24c0>
  ...
  struct test {
    ...
    69dc:	f1070713          	addi	a4,a4,-240 # a8e8 <schedule_dm+0x25a0>
  ...
  if(continuous){
    ...
    6a04:	e3050513          	addi	a0,a0,-464 # a830 <schedule_dm+0x24e8>
    ...
    6a6e:	de650513          	addi	a0,a0,-538 # a850 <schedule_dm+0x2508>
    ...
    6ac4:	da850513          	addi	a0,a0,-600 # a868 <schedule_dm+0x2520>
  ...
  printf("usertests starting\n");
    ...
    6aec:	da050513          	addi	a0,a0,-608 # a888 <schedule_dm+0x2540>
  ...
  if(fail){
    ...
    6b76:	cde50513          	addi	a0,a0,-802 # a850 <schedule_dm+0x2508>
    ...
    6bba:	cea50513          	addi	a0,a0,-790 # a8a0 <schedule_dm+0x2558>
    ...
    6bd4:	d0050513          	addi	a0,a0,-768 # a8d0 <schedule_dm+0x2588>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    71e2:	aca68693          	addi	a3,a3,-1334 # aca8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    72bc:	9f070713          	addi	a4,a4,-1552 # aca8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    747c:	82878793          	addi	a5,a5,-2008 # aca0 <schedule_dm+0x2958>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    7628:	ecc78793          	addi	a5,a5,-308 # 114f0 <freep>
  ...
  freep = p;
    ...
    7720:	dd478793          	addi	a5,a5,-556 # 114f0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    77a2:	d5278793          	addi	a5,a5,-686 # 114f0 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    77d4:	d2078793          	addi	a5,a5,-736 # 114f0 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    7892:	c6278793          	addi	a5,a5,-926 # 114f0 <freep>
    ...
    78a8:	c4c78793          	addi	a5,a5,-948 # 114f0 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    7b34:	9c878793          	addi	a5,a5,-1592 # 114f8 <last_thread.1239>
    ...
    7b90:	96c78793          	addi	a5,a5,-1684 # 114f8 <last_thread.1239>
    7b94:	639c                	ld	a5,0(a5)
    7b96:	c385                	beqz	a5,7bb6 <schedule_wrr+0xdc>
    7b98:	0000a797          	auipc	a5,0xa
    7b9c:	96078793          	addi	a5,a5,-1696 # 114f8 <last_thread.1239>
    ...
    7bac:	95078793          	addi	a5,a5,-1712 # 114f8 <last_thread.1239>
    ...
    7bfc:	90078793          	addi	a5,a5,-1792 # 114f8 <last_thread.1239>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    7c94:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeead8>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    7dc6:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeead8>
...
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    7efc:	7131                	addi	sp,sp,-192
    7efe:	fd06                	sd	ra,184(sp)
    7f00:	f922                	sd	s0,176(sp)
    7f02:	f526                	sd	s1,168(sp)
    7f04:	f14a                	sd	s2,160(sp)
    7f06:	ed4e                	sd	s3,152(sp)
    7f08:	0180                	addi	s0,sp,192
    7f0a:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    ...
    7f20:	faf43023          	sd	a5,-96(s0)
    7f24:	fa043783          	ld	a5,-96(s0)
    7f28:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeead8>
    ...
    7f9c:	f7442783          	lw	a5,-140(s0)
    7fa0:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    7fa4:	fb843783          	ld	a5,-72(s0)
    7fa8:	779c                	ld	a5,40(a5)
    7faa:	f6f43423          	sd	a5,-152(s0)
    7fae:	f6843783          	ld	a5,-152(s0)
    7fb2:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeead8>
    ...
    7fd8:	f8f43c23          	sd	a5,-104(s0)
    7fdc:	f9843783          	ld	a5,-104(s0)
    ...
    80a4:	f6f43c23          	sd	a5,-136(s0)
    80a8:	f7843783          	ld	a5,-136(s0)
    80ac:	17e1                	addi	a5,a5,-8
    80ae:	faf43423          	sd	a5,-88(s0)
    80b2:	fa843783          	ld	a5,-88(s0)
    80b6:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__BSS_END__+0xffffffff7ffeeb08>
    ...
    80c4:	c7b5                	beqz	a5,8130 <schedule_lst+0x234>
    ...
    80c6:	4098                	lw	a4,0(s1)
    80c8:	fc843783          	ld	a5,-56(s0)
    80cc:	4ffc                	lw	a5,92(a5)
    80ce:	02f74063          	blt	a4,a5,80ee <schedule_lst+0x1f2>
    80d2:	fc843783          	ld	a5,-56(s0)
    80d6:	4fbc                	lw	a5,88(a5)
    80d8:	00f05b63          	blez	a5,80ee <schedule_lst+0x1f2>
            r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    80dc:	fc843783          	ld	a5,-56(s0)
    80e0:	02878793          	addi	a5,a5,40
    80e4:	f4f43423          	sd	a5,-184(s0)
            r.allocated_time = 0;  // Set to 0 to handle missed deadline
    80e8:	f4042823          	sw	zero,-176(s0)
    80ec:	a049                	j	816e <schedule_lst+0x272>
        } else {
            // Decide the allocated time based on current minimum slack or upcoming preemption needs
    ...
    80ee:	fb442783          	lw	a5,-76(s0)
    80f2:	0007871b          	sext.w	a4,a5
    80f6:	800007b7          	lui	a5,0x80000
    80fa:	fff7c793          	not	a5,a5
    80fe:	00f71663          	bne	a4,a5,810a <schedule_lst+0x20e>
    8102:	fc843783          	ld	a5,-56(s0)
    8106:	4fbc                	lw	a5,88(a5)
    8108:	a039                	j	8116 <schedule_lst+0x21a>
    810a:	409c                	lw	a5,0(s1)
    810c:	fb442703          	lw	a4,-76(s0)
    8110:	40f707bb          	subw	a5,a4,a5
    8114:	2781                	sext.w	a5,a5
    8116:	f8f42a23          	sw	a5,-108(s0)
            r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    811a:	fc843783          	ld	a5,-56(s0)
    811e:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__BSS_END__+0xffffffff7ffeeb28>
    8122:	f4f43423          	sd	a5,-184(s0)
            r.allocated_time = allocated_time;
    8126:	f9442783          	lw	a5,-108(s0)
    812a:	f4f42823          	sw	a5,-176(s0)
    812e:	a081                	j	816e <schedule_lst+0x272>
        }
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    8130:	649c                	ld	a5,8(s1)
    8132:	f4f43423          	sd	a5,-184(s0)
    ...
    8136:	fb442783          	lw	a5,-76(s0)
    813a:	0007871b          	sext.w	a4,a5
    813e:	800007b7          	lui	a5,0x80000
    8142:	fff7c793          	not	a5,a5
    8146:	00f70963          	beq	a4,a5,8158 <schedule_lst+0x25c>
    814a:	409c                	lw	a5,0(s1)
    814c:	fb442703          	lw	a4,-76(s0)
    8150:	40f707bb          	subw	a5,a4,a5
    8154:	2781                	sext.w	a5,a5
    8156:	a811                	j	816a <schedule_lst+0x26e>
    8158:	689c                	ld	a5,16(s1)
    815a:	4098                	lw	a4,0(s1)
    815c:	85ba                	mv	a1,a4
    815e:	853e                	mv	a0,a5
    8160:	00000097          	auipc	ra,0x0
    8164:	8ca080e7          	jalr	-1846(ra) # 7a2a <find_next_release_time>
    8168:	87aa                	mv	a5,a0
    816a:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    816e:	f4843783          	ld	a5,-184(s0)
    8172:	f4f43c23          	sd	a5,-168(s0)
    8176:	f5043783          	ld	a5,-176(s0)
    817a:	f6f43023          	sd	a5,-160(s0)
    817e:	4701                	li	a4,0
    8180:	f5843703          	ld	a4,-168(s0)
    8184:	4781                	li	a5,0
    8186:	f6043783          	ld	a5,-160(s0)
    818a:	893a                	mv	s2,a4
    818c:	89be                	mv	s3,a5
    818e:	874a                	mv	a4,s2
    8190:	87ce                	mv	a5,s3
    ...
    8192:	853a                	mv	a0,a4
    8194:	85be                	mv	a1,a5
    8196:	70ea                	ld	ra,184(sp)
    8198:	744a                	ld	s0,176(sp)
    819a:	74aa                	ld	s1,168(sp)
    819c:	790a                	ld	s2,160(sp)
    819e:	69ea                	ld	s3,152(sp)
    81a0:	6129                	addi	sp,sp,192
    81a2:	8082                	ret

00000000000081a4 <find_earliest_impactful_release_time_dm>:
typedef struct {
...
ImpactfulEvent find_earliest_impactful_release_time_dm(struct list_head *release_queue, struct list_head*run_queue, int current_time, int current_period) {
    81a4:	7119                	addi	sp,sp,-128
    81a6:	fca2                	sd	s0,120(sp)
    81a8:	0100                	addi	s0,sp,128
    81aa:	f8a43c23          	sd	a0,-104(s0)
    81ae:	f8b43823          	sd	a1,-112(s0)
    81b2:	87b2                	mv	a5,a2
    81b4:	8736                	mv	a4,a3
    81b6:	f8f42623          	sw	a5,-116(s0)
    81ba:	87ba                	mv	a5,a4
    81bc:	f8f42423          	sw	a5,-120(s0)
    struct release_queue_entry *entry;
    struct thread *t;
    int earliest_impactful_event = INT_MAX;
    81c0:	800007b7          	lui	a5,0x80000
    81c4:	fff7c793          	not	a5,a5
    81c8:	fcf42e23          	sw	a5,-36(s0)
    int earliest_impactful_thread_ID = INT_MAX;    
    81cc:	800007b7          	lui	a5,0x80000
    81d0:	fff7c793          	not	a5,a5
    81d4:	fcf42c23          	sw	a5,-40(s0)
    
    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    81d8:	f9843783          	ld	a5,-104(s0)
    81dc:	639c                	ld	a5,0(a5)
    81de:	fcf43823          	sd	a5,-48(s0)
    81e2:	fd043783          	ld	a5,-48(s0)
    81e6:	17e1                	addi	a5,a5,-8
    81e8:	fef43423          	sd	a5,-24(s0)
    81ec:	a201                	j	82ec <find_earliest_impactful_release_time_dm+0x148>
        if (entry->release_time > current_time && entry->thrd->period < current_period) {
    81ee:	fe843783          	ld	a5,-24(s0)
    81f2:	4f98                	lw	a4,24(a5)
    81f4:	f8c42783          	lw	a5,-116(s0)
    81f8:	2781                	sext.w	a5,a5
    81fa:	04e7d463          	bge	a5,a4,8242 <find_earliest_impactful_release_time_dm+0x9e>
    81fe:	fe843783          	ld	a5,-24(s0)
    8202:	639c                	ld	a5,0(a5)
    8204:	4bb8                	lw	a4,80(a5)
    8206:	f8842783          	lw	a5,-120(s0)
    820a:	2781                	sext.w	a5,a5
    820c:	02f75b63          	bge	a4,a5,8242 <find_earliest_impactful_release_time_dm+0x9e>
            if (entry->release_time < earliest_impactful_event) {
    8210:	fe843783          	ld	a5,-24(s0)
    8214:	4f98                	lw	a4,24(a5)
    8216:	fdc42783          	lw	a5,-36(s0)
    821a:	2781                	sext.w	a5,a5
    821c:	0af75e63          	bge	a4,a5,82d8 <find_earliest_impactful_release_time_dm+0x134>
                earliest_impactful_event = entry->release_time;
    8220:	fe843783          	ld	a5,-24(s0)
    8224:	4f9c                	lw	a5,24(a5)
    8226:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    822a:	fe843783          	ld	a5,-24(s0)
    822e:	639c                	ld	a5,0(a5)
    8230:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    8234:	fe843783          	ld	a5,-24(s0)
    8238:	639c                	ld	a5,0(a5)
    823a:	5fdc                	lw	a5,60(a5)
    823c:	fcf42c23          	sw	a5,-40(s0)
            if (entry->release_time < earliest_impactful_event) {
    8240:	a861                	j	82d8 <find_earliest_impactful_release_time_dm+0x134>
            }
        } 
    ...
    8246:	4f98                	lw	a4,24(a5)
    8248:	f8c42783          	lw	a5,-116(s0)
    824c:	2781                	sext.w	a5,a5
    824e:	08e7d563          	bge	a5,a4,82d8 <find_earliest_impactful_release_time_dm+0x134>
    8252:	fe843783          	ld	a5,-24(s0)
    8256:	639c                	ld	a5,0(a5)
    8258:	4bb8                	lw	a4,80(a5)
    825a:	f8842783          	lw	a5,-120(s0)
    825e:	2781                	sext.w	a5,a5
    8260:	06e79c63          	bne	a5,a4,82d8 <find_earliest_impactful_release_time_dm+0x134>
            
            //printf("ID %d, entry release time: %d\n", entry->thrd->ID, entry->release_time);
            if (entry->release_time < earliest_impactful_event) {
    8264:	fe843783          	ld	a5,-24(s0)
    8268:	4f98                	lw	a4,24(a5)
    826a:	fdc42783          	lw	a5,-36(s0)
    826e:	2781                	sext.w	a5,a5
    8270:	02f75363          	bge	a4,a5,8296 <find_earliest_impactful_release_time_dm+0xf2>
                earliest_impactful_event = entry->release_time;
    8274:	fe843783          	ld	a5,-24(s0)
    8278:	4f9c                	lw	a5,24(a5)
    827a:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    827e:	fe843783          	ld	a5,-24(s0)
    8282:	639c                	ld	a5,0(a5)
    8284:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    8288:	fe843783          	ld	a5,-24(s0)
    828c:	639c                	ld	a5,0(a5)
    828e:	5fdc                	lw	a5,60(a5)
    8290:	fcf42c23          	sw	a5,-40(s0)
    8294:	a091                	j	82d8 <find_earliest_impactful_release_time_dm+0x134>
            } else if (entry->release_time == earliest_impactful_event && entry->thrd->ID < earliest_impactful_thread_ID) {
    8296:	fe843783          	ld	a5,-24(s0)
    829a:	4f98                	lw	a4,24(a5)
    829c:	fdc42783          	lw	a5,-36(s0)
    82a0:	2781                	sext.w	a5,a5
    82a2:	02e79b63          	bne	a5,a4,82d8 <find_earliest_impactful_release_time_dm+0x134>
    82a6:	fe843783          	ld	a5,-24(s0)
    82aa:	639c                	ld	a5,0(a5)
    82ac:	5fd8                	lw	a4,60(a5)
    82ae:	fd842783          	lw	a5,-40(s0)
    82b2:	2781                	sext.w	a5,a5
    82b4:	02f75263          	bge	a4,a5,82d8 <find_earliest_impactful_release_time_dm+0x134>
                earliest_impactful_event = entry->release_time;
    82b8:	fe843783          	ld	a5,-24(s0)
    82bc:	4f9c                	lw	a5,24(a5)
    82be:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    82c2:	fe843783          	ld	a5,-24(s0)
    82c6:	639c                	ld	a5,0(a5)
    82c8:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    82cc:	fe843783          	ld	a5,-24(s0)
    82d0:	639c                	ld	a5,0(a5)
    82d2:	5fdc                	lw	a5,60(a5)
    82d4:	fcf42c23          	sw	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    82d8:	fe843783          	ld	a5,-24(s0)
    82dc:	679c                	ld	a5,8(a5)
    82de:	fcf43423          	sd	a5,-56(s0)
    82e2:	fc843783          	ld	a5,-56(s0)
    82e6:	17e1                	addi	a5,a5,-8
    82e8:	fef43423          	sd	a5,-24(s0)
    82ec:	fe843783          	ld	a5,-24(s0)
    82f0:	07a1                	addi	a5,a5,8
    82f2:	f9843703          	ld	a4,-104(s0)
    82f6:	eef71ce3          	bne	a4,a5,81ee <find_earliest_impactful_release_time_dm+0x4a>
            }
        }
    }
    ...
    82fe:	0007871b          	sext.w	a4,a5
    8302:	800007b7          	lui	a5,0x80000
    8306:	fff7c793          	not	a5,a5
    830a:	00f70563          	beq	a4,a5,8314 <find_earliest_impactful_release_time_dm+0x170>
    830e:	fdc42783          	lw	a5,-36(s0)
    8312:	a011                	j	8316 <find_earliest_impactful_release_time_dm+0x172>
    8314:	57fd                	li	a5,-1
    8316:	fcf42e23          	sw	a5,-36(s0)
    return (ImpactfulEvent) {earliest_impactful_event, t};
    831a:	fdc42783          	lw	a5,-36(s0)
    831e:	faf42c23          	sw	a5,-72(s0)
    8322:	fe043783          	ld	a5,-32(s0)
    8326:	fcf43023          	sd	a5,-64(s0)
    832a:	4701                	li	a4,0
    832c:	fb843703          	ld	a4,-72(s0)
    8330:	4781                	li	a5,0
    8332:	fc043783          	ld	a5,-64(s0)
    8336:	883a                	mv	a6,a4
    8338:	88be                	mv	a7,a5
    833a:	8742                	mv	a4,a6
    833c:	87c6                	mv	a5,a7
    ...
    833e:	853a                	mv	a0,a4
    8340:	85be                	mv	a1,a5
    8342:	7466                	ld	s0,120(sp)
    8344:	6109                	addi	sp,sp,128
    8346:	8082                	ret

0000000000008348 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    8348:	7175                	addi	sp,sp,-144
    834a:	e506                	sd	ra,136(sp)
    834c:	e122                	sd	s0,128(sp)
    834e:	fca6                	sd	s1,120(sp)
    8350:	f8ca                	sd	s2,112(sp)
    8352:	f4ce                	sd	s3,104(sp)
    8354:	0900                	addi	s0,sp,144
    8356:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    8358:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    835c:	800007b7          	lui	a5,0x80000
    8360:	fff7c793          	not	a5,a5
    8364:	faf42e23          	sw	a5,-68(s0)
    int earliest_impactful_deadline; 
    
    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    8368:	649c                	ld	a5,8(s1)
    836a:	639c                	ld	a5,0(a5)
    836c:	faf43823          	sd	a5,-80(s0)
    8370:	fb043783          	ld	a5,-80(s0)
    8374:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeead8>
    8378:	fcf43023          	sd	a5,-64(s0)
    837c:	a8bd                	j	83fa <schedule_dm+0xb2>
        if (t->is_real_time && t->period < earliest_deadline) {
    837e:	fc043783          	ld	a5,-64(s0)
    8382:	43bc                	lw	a5,64(a5)
    8384:	c39d                	beqz	a5,83aa <schedule_dm+0x62>
    8386:	fc043783          	ld	a5,-64(s0)
    838a:	4bb8                	lw	a4,80(a5)
    838c:	fbc42783          	lw	a5,-68(s0)
    8390:	2781                	sext.w	a5,a5
    8392:	00f75c63          	bge	a4,a5,83aa <schedule_dm+0x62>
            earliest_deadline_thread = t;
    8396:	fc043783          	ld	a5,-64(s0)
    839a:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    839e:	fc043783          	ld	a5,-64(s0)
    83a2:	4bbc                	lw	a5,80(a5)
    83a4:	faf42e23          	sw	a5,-68(s0)
    83a8:	a835                	j	83e4 <schedule_dm+0x9c>
        } else if (t->is_real_time && t->period == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    83aa:	fc043783          	ld	a5,-64(s0)
    83ae:	43bc                	lw	a5,64(a5)
    83b0:	cb95                	beqz	a5,83e4 <schedule_dm+0x9c>
    83b2:	fc043783          	ld	a5,-64(s0)
    83b6:	4bb8                	lw	a4,80(a5)
    83b8:	fbc42783          	lw	a5,-68(s0)
    83bc:	2781                	sext.w	a5,a5
    83be:	02e79363          	bne	a5,a4,83e4 <schedule_dm+0x9c>
    83c2:	fc043783          	ld	a5,-64(s0)
    83c6:	5fd8                	lw	a4,60(a5)
    83c8:	fc843783          	ld	a5,-56(s0)
    83cc:	5fdc                	lw	a5,60(a5)
    83ce:	00f75b63          	bge	a4,a5,83e4 <schedule_dm+0x9c>
            earliest_deadline_thread = t;
    83d2:	fc043783          	ld	a5,-64(s0)
    83d6:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    83da:	fc043783          	ld	a5,-64(s0)
    83de:	4bbc                	lw	a5,80(a5)
    83e0:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    83e4:	fc043783          	ld	a5,-64(s0)
    83e8:	779c                	ld	a5,40(a5)
    83ea:	faf43023          	sd	a5,-96(s0)
    83ee:	fa043783          	ld	a5,-96(s0)
    83f2:	fd878793          	addi	a5,a5,-40
    83f6:	fcf43023          	sd	a5,-64(s0)
    83fa:	fc043783          	ld	a5,-64(s0)
    83fe:	02878713          	addi	a4,a5,40
    8402:	649c                	ld	a5,8(s1)
    8404:	f6f71de3          	bne	a4,a5,837e <schedule_dm+0x36>
        }
    }
    ...
    8408:	6898                	ld	a4,16(s1)
    840a:	648c                	ld	a1,8(s1)
    840c:	4090                	lw	a2,0(s1)
    840e:	fc843783          	ld	a5,-56(s0)
    8412:	c789                	beqz	a5,841c <schedule_dm+0xd4>
    8414:	fc843783          	ld	a5,-56(s0)
    8418:	4bbc                	lw	a5,80(a5)
    841a:	a029                	j	8424 <schedule_dm+0xdc>
    841c:	800007b7          	lui	a5,0x80000
    8420:	fff7c793          	not	a5,a5
    8424:	86be                	mv	a3,a5
    8426:	853a                	mv	a0,a4
    8428:	00000097          	auipc	ra,0x0
    842c:	d7c080e7          	jalr	-644(ra) # 81a4 <find_earliest_impactful_release_time_dm>
    8430:	872a                	mv	a4,a0
    8432:	87ae                	mv	a5,a1
    8434:	f6e43823          	sd	a4,-144(s0)
    8438:	f6f43c23          	sd	a5,-136(s0)
    earliest_impactful_deadline = earliest_impactful_event.earliest_impactful_event;
    843c:	f7042783          	lw	a5,-144(s0)
    8440:	faf42623          	sw	a5,-84(s0)

    if (earliest_deadline_thread) {
    8444:	fc843783          	ld	a5,-56(s0)
    8448:	c3d1                	beqz	a5,84cc <schedule_dm+0x184>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    844a:	fc843783          	ld	a5,-56(s0)
    844e:	4ff8                	lw	a4,92(a5)
    8450:	409c                	lw	a5,0(s1)
    8452:	40f707bb          	subw	a5,a4,a5
    8456:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline <= 0) {
    845a:	fa842783          	lw	a5,-88(s0)
    845e:	2781                	sext.w	a5,a5
    8460:	00f04b63          	bgtz	a5,8476 <schedule_dm+0x12e>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    8464:	fc843783          	ld	a5,-56(s0)
    8468:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__BSS_END__+0xffffffff7ffeeb28>
    846c:	f8f43023          	sd	a5,-128(s0)
            r.allocated_time = 0;
    8470:	f8042423          	sw	zero,-120(s0)
    8474:	a895                	j	84e8 <schedule_dm+0x1a0>
        } else {
    ...
    8476:	fac42783          	lw	a5,-84(s0)
    847a:	0007871b          	sext.w	a4,a5
    847e:	57fd                	li	a5,-1
    8480:	02f70663          	beq	a4,a5,84ac <schedule_dm+0x164>
    8484:	409c                	lw	a5,0(s1)
    8486:	fac42703          	lw	a4,-84(s0)
    848a:	40f707bb          	subw	a5,a4,a5
    848e:	0007871b          	sext.w	a4,a5
    8492:	fc843783          	ld	a5,-56(s0)
    8496:	4fbc                	lw	a5,88(a5)
    8498:	00f75a63          	bge	a4,a5,84ac <schedule_dm+0x164>
                allocated_time = earliest_impactful_deadline - args.current_time;
    849c:	409c                	lw	a5,0(s1)
    849e:	fac42703          	lw	a4,-84(s0)
    84a2:	40f707bb          	subw	a5,a4,a5
    84a6:	faf42c23          	sw	a5,-72(s0)
    84aa:	a031                	j	84b6 <schedule_dm+0x16e>
            } else {
                allocated_time = earliest_deadline_thread->remaining_time;
    84ac:	fc843783          	ld	a5,-56(s0)
    84b0:	4fbc                	lw	a5,88(a5)
    84b2:	faf42c23          	sw	a5,-72(s0)
            }
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    84b6:	fc843783          	ld	a5,-56(s0)
    84ba:	02878793          	addi	a5,a5,40
    84be:	f8f43023          	sd	a5,-128(s0)
            r.allocated_time = allocated_time;
    84c2:	fb842783          	lw	a5,-72(s0)
    84c6:	f8f42423          	sw	a5,-120(s0)
    84ca:	a839                	j	84e8 <schedule_dm+0x1a0>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    84cc:	649c                	ld	a5,8(s1)
    84ce:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    84d2:	689c                	ld	a5,16(s1)
    84d4:	4098                	lw	a4,0(s1)
    84d6:	85ba                	mv	a1,a4
    84d8:	853e                	mv	a0,a5
    84da:	fffff097          	auipc	ra,0xfffff
    84de:	550080e7          	jalr	1360(ra) # 7a2a <find_next_release_time>
    84e2:	87aa                	mv	a5,a0
    84e4:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    84e8:	f8043783          	ld	a5,-128(s0)
    84ec:	f8f43823          	sd	a5,-112(s0)
    84f0:	f8843783          	ld	a5,-120(s0)
    84f4:	f8f43c23          	sd	a5,-104(s0)
    84f8:	4701                	li	a4,0
    84fa:	f9043703          	ld	a4,-112(s0)
    84fe:	4781                	li	a5,0
    8500:	f9843783          	ld	a5,-104(s0)
    8504:	893a                	mv	s2,a4
    8506:	89be                	mv	s3,a5
    8508:	874a                	mv	a4,s2
    850a:	87ce                	mv	a5,s3
    ...
    850c:	853a                	mv	a0,a4
    850e:	85be                	mv	a1,a5
    8510:	60aa                	ld	ra,136(sp)
    8512:	640a                	ld	s0,128(sp)
    8514:	74e6                	ld	s1,120(sp)
    8516:	7946                	ld	s2,112(sp)
    8518:	79a6                	ld	s3,104(sp)
    851a:	6149                	addi	sp,sp,144
    851c:	8082                	ret

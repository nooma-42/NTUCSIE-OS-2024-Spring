...
copyin(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
      ...
      54:	88850513          	addi	a0,a0,-1912 # 88d8 <schedule_dm+0x518>
    ...
    if(fd < 0){
      ...
      74:	87050513          	addi	a0,a0,-1936 # 88e0 <schedule_dm+0x520>
    ...
    if(n >= 0){
      ...
      be:	83e50513          	addi	a0,a0,-1986 # 88f8 <schedule_dm+0x538>
    ...
    unlink("copyin1");
      ...
      e6:	7f650513          	addi	a0,a0,2038 # 88d8 <schedule_dm+0x518>
    ...
    if(n > 0){
     ...
     122:	80a50513          	addi	a0,a0,-2038 # 8928 <schedule_dm+0x568>
    ...
    if(pipe(fds) < 0){
     ...
     150:	80c50513          	addi	a0,a0,-2036 # 8958 <schedule_dm+0x598>
    ...
    if(n > 0){
     ...
     19a:	7d250513          	addi	a0,a0,2002 # 8968 <schedule_dm+0x5a8>
...
copyout(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     22a:	77250513          	addi	a0,a0,1906 # 8998 <schedule_dm+0x5d8>
    ...
    if(fd < 0){
     ...
     24a:	75a50513          	addi	a0,a0,1882 # 89a0 <schedule_dm+0x5e0>
    ...
    if(n > 0){
     ...
     294:	72850513          	addi	a0,a0,1832 # 89b8 <schedule_dm+0x5f8>
    ...
    if(pipe(fds) < 0){
     ...
     2d0:	68c50513          	addi	a0,a0,1676 # 8958 <schedule_dm+0x598>
    ...
    n = write(fds[1], "x", 1);
     ...
     2f0:	6fc58593          	addi	a1,a1,1788 # 89e8 <schedule_dm+0x628>
     2f4:	853e                	mv	a0,a5
    ...
    if(n != 1){
     ...
     316:	6de50513          	addi	a0,a0,1758 # 89f0 <schedule_dm+0x630>
    ...
    if(n > 0){
     ...
     360:	6ac50513          	addi	a0,a0,1708 # 8a08 <schedule_dm+0x648>
...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    if(fd >= 0){
     ...
     41a:	62250513          	addi	a0,a0,1570 # 8a38 <schedule_dm+0x678>
...
copyinstr2(char *s)
{
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     4c8:	59450513          	addi	a0,a0,1428 # 8a58 <schedule_dm+0x698>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     514:	56850513          	addi	a0,a0,1384 # 8a78 <schedule_dm+0x6b8>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     566:	53650513          	addi	a0,a0,1334 # 8a98 <schedule_dm+0x6d8>
  ...
  char *args[] = { "xx", 0 };
     ...
     580:	54478793          	addi	a5,a5,1348 # 8ac0 <schedule_dm+0x700>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     5c4:	50850513          	addi	a0,a0,1288 # 8ac8 <schedule_dm+0x708>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
     ...
     5f6:	4f650513          	addi	a0,a0,1270 # 8ae8 <schedule_dm+0x728>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     61e:	e5670713          	addi	a4,a4,-426 # 10470 <big.1275>
    ...
    ret = exec("echo", args2);
     ...
     682:	47a50513          	addi	a0,a0,1146 # 8af8 <schedule_dm+0x738>
    ...
    if(ret != -1){
     ...
     6ac:	45850513          	addi	a0,a0,1112 # 8b00 <schedule_dm+0x740>
  ...
  if(st != 747){
    ...
    printf("exec(echo, BIG) succeeded, should have failed\n");
     ...
     6f2:	43a50513          	addi	a0,a0,1082 # 8b28 <schedule_dm+0x768>
...
copyinstr3(char *s)
{
  ...
  if(top % PGSIZE){
    ...
    printf("oops\n");
     ...
     788:	3f450513          	addi	a0,a0,1012 # 8b78 <schedule_dm+0x7b8>
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     7e2:	27a50513          	addi	a0,a0,634 # 8a58 <schedule_dm+0x698>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     82a:	25250513          	addi	a0,a0,594 # 8a78 <schedule_dm+0x6b8>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     876:	22650513          	addi	a0,a0,550 # 8a98 <schedule_dm+0x6d8>
  ...
  char *args[] = { "xx", 0 };
     ...
     890:	23478793          	addi	a5,a5,564 # 8ac0 <schedule_dm+0x700>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     8d0:	1fc50513          	addi	a0,a0,508 # 8ac8 <schedule_dm+0x708>
...
rwsbrk()
{
  ...
  if(a == 0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) failed\n");
     ...
     916:	26e50513          	addi	a0,a0,622 # 8b80 <schedule_dm+0x7c0>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) shrink failed\n");
     ...
     942:	25a50513          	addi	a0,a0,602 # 8b98 <schedule_dm+0x7d8>
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
     ...
     960:	cd450513          	addi	a0,a0,-812 # 8630 <schedule_dm+0x270>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     980:	23c50513          	addi	a0,a0,572 # 8bb8 <schedule_dm+0x7f8>
  ...
  if(n >= 0){
    ...
    printf("write(fd, %p, 1024) returned %d, not -1\n", a+4096, n);
     ...
     9d8:	1fc50513          	addi	a0,a0,508 # 8bd0 <schedule_dm+0x810>
  ...
  unlink("rwsbrk");
     ...
     a00:	c3450513          	addi	a0,a0,-972 # 8630 <schedule_dm+0x270>
  ...
  fd = open("README", O_RDONLY);
     ...
     a12:	f8a50513          	addi	a0,a0,-118 # 8998 <schedule_dm+0x5d8>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     a32:	18a50513          	addi	a0,a0,394 # 8bb8 <schedule_dm+0x7f8>
  ...
  if(n >= 0){
    ...
    printf("read(fd, %p, 10) returned %d, not -1\n", a+4096, n);
     ...
     a88:	17c50513          	addi	a0,a0,380 # 8c00 <schedule_dm+0x840>
...
truncate1(char *s)
{
  ...
  write(fd1, "abcd", 4);
     ...
     af6:	14658593          	addi	a1,a1,326 # 8c38 <schedule_dm+0x878>
     afa:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     b18:	11450513          	addi	a0,a0,276 # 8c28 <schedule_dm+0x868>
  ...
  if(n != 4){
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     b64:	0e050513          	addi	a0,a0,224 # 8c40 <schedule_dm+0x880>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     b82:	0aa50513          	addi	a0,a0,170 # 8c28 <schedule_dm+0x868>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     b9a:	09250513          	addi	a0,a0,146 # 8c28 <schedule_dm+0x868>
  ...
  if(n != 0){
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     bdc:	08850513          	addi	a0,a0,136 # 8c60 <schedule_dm+0x8a0>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     bf6:	07e50513          	addi	a0,a0,126 # 8c70 <schedule_dm+0x8b0>
  ...
  if(n != 0){
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     c3c:	05850513          	addi	a0,a0,88 # 8c90 <schedule_dm+0x8d0>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     c56:	01e50513          	addi	a0,a0,30 # 8c70 <schedule_dm+0x8b0>
  ...
  write(fd1, "abcdef", 6);
     ...
     c76:	02e58593          	addi	a1,a1,46 # 8ca0 <schedule_dm+0x8e0>
     c7a:	853e                	mv	a0,a5
  ...
  if(n != 6){
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     cbe:	fee50513          	addi	a0,a0,-18 # 8ca8 <schedule_dm+0x8e8>
  ...
  if(n != 2){
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     d0e:	fbe50513          	addi	a0,a0,-66 # 8cc8 <schedule_dm+0x908>
  ...
  unlink("truncfile");
     ...
     d28:	f0450513          	addi	a0,a0,-252 # 8c28 <schedule_dm+0x868>
...
truncate2(char *s)
{
  ...
  unlink("truncfile");
     ...
     d78:	eb450513          	addi	a0,a0,-332 # 8c28 <schedule_dm+0x868>
  ...
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     ...
     d8c:	ea050513          	addi	a0,a0,-352 # 8c28 <schedule_dm+0x868>
  ...
  write(fd1, "abcd", 4);
     ...
     da8:	e9458593          	addi	a1,a1,-364 # 8c38 <schedule_dm+0x878>
     dac:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     ...
     dbe:	e6e50513          	addi	a0,a0,-402 # 8c28 <schedule_dm+0x868>
  ...
  int n = write(fd1, "x", 1);
     ...
     dda:	c1258593          	addi	a1,a1,-1006 # 89e8 <schedule_dm+0x628>
     dde:	853e                	mv	a0,a5
  ...
  if(n != -1){
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     e0a:	ee250513          	addi	a0,a0,-286 # 8ce8 <schedule_dm+0x928>
  ...
  unlink("truncfile");
     ...
     e24:	e0850513          	addi	a0,a0,-504 # 8c28 <schedule_dm+0x868>
...
truncate3(char *s)
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     e6a:	dc250513          	addi	a0,a0,-574 # 8c28 <schedule_dm+0x868>
  ...
  if(pid < 0){
    ...
    printf("%s: fork failed\n", s);
     ...
     ea2:	e7250513          	addi	a0,a0,-398 # 8d10 <schedule_dm+0x950>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < 100; i++){
     ...
     ece:	d5e50513          	addi	a0,a0,-674 # 8c28 <schedule_dm+0x868>
     ...
     ef2:	e3a50513          	addi	a0,a0,-454 # 8d28 <schedule_dm+0x968>
     ...
     f12:	e3258593          	addi	a1,a1,-462 # 8d40 <schedule_dm+0x980>
     f16:	853e                	mv	a0,a5
     ...
     f42:	e1250513          	addi	a0,a0,-494 # 8d50 <schedule_dm+0x990>
     ...
     f6c:	cc050513          	addi	a0,a0,-832 # 8c28 <schedule_dm+0x868>
  ...
  for(int i = 0; i < 150; i++){
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     fd6:	c5650513          	addi	a0,a0,-938 # 8c28 <schedule_dm+0x868>
    ...
    if(fd < 0){
     ...
     ffa:	d3250513          	addi	a0,a0,-718 # 8d28 <schedule_dm+0x968>
    ...
    101a:	d5a58593          	addi	a1,a1,-678 # 8d70 <schedule_dm+0x9b0>
    101e:	853e                	mv	a0,a5
    ...
    104a:	d3250513          	addi	a0,a0,-718 # 8d78 <schedule_dm+0x9b8>
  ...
  unlink("truncfile");
    ...
    109a:	b9250513          	addi	a0,a0,-1134 # 8c28 <schedule_dm+0x868>
...
iputtest(char *s)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    10c4:	cd850513          	addi	a0,a0,-808 # 8d98 <schedule_dm+0x9d8>
    ...
    10de:	cc650513          	addi	a0,a0,-826 # 8da0 <schedule_dm+0x9e0>
  ...
  if(chdir("iputdir") < 0){
    ...
    10f8:	ca450513          	addi	a0,a0,-860 # 8d98 <schedule_dm+0x9d8>
    ...
    1112:	caa50513          	addi	a0,a0,-854 # 8db8 <schedule_dm+0x9f8>
  ...
  if(unlink("../iputdir") < 0){
    ...
    112c:	cb050513          	addi	a0,a0,-848 # 8dd8 <schedule_dm+0xa18>
    ...
    1146:	ca650513          	addi	a0,a0,-858 # 8de8 <schedule_dm+0xa28>
  ...
  if(chdir("/") < 0){
    ...
    1160:	cac50513          	addi	a0,a0,-852 # 8e08 <schedule_dm+0xa48>
    ...
    117a:	c9a50513          	addi	a0,a0,-870 # 8e10 <schedule_dm+0xa50>
...
exitiputtest(char *s)
{
  ...
  if(pid < 0){
    ...
    11c6:	b4e50513          	addi	a0,a0,-1202 # 8d10 <schedule_dm+0x950>
  ...
  if(pid == 0){
    ...
    11e8:	bb450513          	addi	a0,a0,-1100 # 8d98 <schedule_dm+0x9d8>
    ...
    1202:	ba250513          	addi	a0,a0,-1118 # 8da0 <schedule_dm+0x9e0>
    ...
    121c:	b8050513          	addi	a0,a0,-1152 # 8d98 <schedule_dm+0x9d8>
    ...
    1236:	bf650513          	addi	a0,a0,-1034 # 8e28 <schedule_dm+0xa68>
    ...
    1250:	b8c50513          	addi	a0,a0,-1140 # 8dd8 <schedule_dm+0xa18>
    ...
    126a:	b8250513          	addi	a0,a0,-1150 # 8de8 <schedule_dm+0xa28>
...
openiputtest(char *s)
{
  ...
  if(mkdir("oidir") < 0){
    ...
    12b6:	b8e50513          	addi	a0,a0,-1138 # 8e40 <schedule_dm+0xa80>
    ...
    12d0:	b7c50513          	addi	a0,a0,-1156 # 8e48 <schedule_dm+0xa88>
  ...
  if(pid < 0){
    ...
    1306:	a0e50513          	addi	a0,a0,-1522 # 8d10 <schedule_dm+0x950>
  ...
  if(pid == 0){
    ...
    132a:	b1a50513          	addi	a0,a0,-1254 # 8e40 <schedule_dm+0xa80>
    ...
    134e:	b1650513          	addi	a0,a0,-1258 # 8e60 <schedule_dm+0xaa0>
  ...
  if(unlink("oidir") != 0){
    ...
    137c:	ac850513          	addi	a0,a0,-1336 # 8e40 <schedule_dm+0xa80>
    ...
    1394:	af850513          	addi	a0,a0,-1288 # 8e88 <schedule_dm+0xac8>
...
opentest(char *s)
{
  ...
  fd = open("echo", 0);
    ...
    13d8:	72450513          	addi	a0,a0,1828 # 8af8 <schedule_dm+0x738>
  ...
  if(fd < 0){
    ...
    13fc:	aa850513          	addi	a0,a0,-1368 # 8ea0 <schedule_dm+0xae0>
  ...
  fd = open("doesnotexist", 0);
    ...
    1426:	a9650513          	addi	a0,a0,-1386 # 8eb8 <schedule_dm+0xaf8>
  ...
  if(fd >= 0){
    ...
    144a:	a8250513          	addi	a0,a0,-1406 # 8ec8 <schedule_dm+0xb08>
...
writetest(char *s)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    147e:	a7650513          	addi	a0,a0,-1418 # 8ef0 <schedule_dm+0xb30>
  ...
  if(fd < 0){
    ...
    14a2:	a5a50513          	addi	a0,a0,-1446 # 8ef8 <schedule_dm+0xb38>
  ...
  for(i = 0; i < N; i++){
    ...
    14c8:	a5458593          	addi	a1,a1,-1452 # 8f18 <schedule_dm+0xb58>
    14cc:	853e                	mv	a0,a5
    ...
    14ee:	a3e50513          	addi	a0,a0,-1474 # 8f28 <schedule_dm+0xb68>
    ...
    150e:	a4658593          	addi	a1,a1,-1466 # 8f50 <schedule_dm+0xb90>
    1512:	853e                	mv	a0,a5
    ...
    1534:	a3050513          	addi	a0,a0,-1488 # 8f60 <schedule_dm+0xba0>
  ...
  fd = open("small", O_RDONLY);
    ...
    1578:	97c50513          	addi	a0,a0,-1668 # 8ef0 <schedule_dm+0xb30>
  ...
  if(fd < 0){
    ...
    159c:	9f050513          	addi	a0,a0,-1552 # 8f88 <schedule_dm+0xbc8>
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    15be:	7a658593          	addi	a1,a1,1958 # ad60 <buf>
    15c2:	853e                	mv	a0,a5
  ...
  if(i != N*SZ*2){
    ...
    15ea:	9c250513          	addi	a0,a0,-1598 # 8fa8 <schedule_dm+0xbe8>
  ...
  if(unlink("small") < 0){
    ...
    1612:	8e250513          	addi	a0,a0,-1822 # 8ef0 <schedule_dm+0xb30>
    ...
    162c:	99850513          	addi	a0,a0,-1640 # 8fc0 <schedule_dm+0xc00>
...
writebig(char *s)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    1660:	98450513          	addi	a0,a0,-1660 # 8fe0 <schedule_dm+0xc20>
  ...
  if(fd < 0){
    ...
    1684:	96850513          	addi	a0,a0,-1688 # 8fe8 <schedule_dm+0xc28>
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	6c078793          	addi	a5,a5,1728 # ad60 <buf>
    ...
    16ba:	6aa58593          	addi	a1,a1,1706 # ad60 <buf>
    16be:	853e                	mv	a0,a5
    ...
    16e2:	92a50513          	addi	a0,a0,-1750 # 9008 <schedule_dm+0xc48>
  ...
  fd = open("big", O_RDONLY);
    ...
    1726:	8be50513          	addi	a0,a0,-1858 # 8fe0 <schedule_dm+0xc20>
  ...
  if(fd < 0){
    ...
    174a:	8ea50513          	addi	a0,a0,-1814 # 9030 <schedule_dm+0xc70>
  ...
  for(;;){
    ...
    1770:	5f458593          	addi	a1,a1,1524 # ad60 <buf>
    1774:	853e                	mv	a0,a5
    ...
    17aa:	8aa50513          	addi	a0,a0,-1878 # 9050 <schedule_dm+0xc90>
    ...
    17de:	89e50513          	addi	a0,a0,-1890 # 9078 <schedule_dm+0xcb8>
    ...
    17f8:	56c78793          	addi	a5,a5,1388 # ad60 <buf>
    ...
    180c:	55878793          	addi	a5,a5,1368 # ad60 <buf>
      printf("%s: read content of block %d is %d\n", s,
    ...
    1822:	87250513          	addi	a0,a0,-1934 # 9090 <schedule_dm+0xcd0>
  ...
  if(unlink("big") < 0){
    ...
    1858:	78c50513          	addi	a0,a0,1932 # 8fe0 <schedule_dm+0xc20>
    ...
    1872:	84a50513          	addi	a0,a0,-1974 # 90b8 <schedule_dm+0xcf8>
...
void dirtest(char *s)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    196e:	76650513          	addi	a0,a0,1894 # 90d0 <schedule_dm+0xd10>
    ...
    1988:	41c50513          	addi	a0,a0,1052 # 8da0 <schedule_dm+0x9e0>
  ...
  if(chdir("dir0") < 0){
    ...
    19a2:	73250513          	addi	a0,a0,1842 # 90d0 <schedule_dm+0xd10>
    ...
    19bc:	72050513          	addi	a0,a0,1824 # 90d8 <schedule_dm+0xd18>
  ...
  if(chdir("..") < 0){
    ...
    19d6:	71e50513          	addi	a0,a0,1822 # 90f0 <schedule_dm+0xd30>
    ...
    19f0:	70c50513          	addi	a0,a0,1804 # 90f8 <schedule_dm+0xd38>
  ...
  if(unlink("dir0") < 0){
    ...
    1a0a:	6ca50513          	addi	a0,a0,1738 # 90d0 <schedule_dm+0xd10>
    ...
    1a24:	6f050513          	addi	a0,a0,1776 # 9110 <schedule_dm+0xd50>
...
exectest(char *s)
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1a54:	0a878793          	addi	a5,a5,168 # 8af8 <schedule_dm+0x738>
    1a58:	fcf43423          	sd	a5,-56(s0)
    1a5c:	00007797          	auipc	a5,0x7
    1a60:	6cc78793          	addi	a5,a5,1740 # 9128 <schedule_dm+0xd68>
  ...
  unlink("echo-ok");
    ...
    1a70:	6c450513          	addi	a0,a0,1732 # 9130 <schedule_dm+0xd70>
  ...
  if(pid < 0) {
    ...
    1a9c:	27850513          	addi	a0,a0,632 # 8d10 <schedule_dm+0x950>
  ...
  if(pid == 0) {
    ...
    1acc:	66850513          	addi	a0,a0,1640 # 9130 <schedule_dm+0xd70>
    ...
    1af0:	64c50513          	addi	a0,a0,1612 # 9138 <schedule_dm+0xd78>
    ...
    1b1c:	63850513          	addi	a0,a0,1592 # 9150 <schedule_dm+0xd90>
    ...
    1b3c:	fc050513          	addi	a0,a0,-64 # 8af8 <schedule_dm+0x738>
    ...
    1b56:	60e50513          	addi	a0,a0,1550 # 9160 <schedule_dm+0xda0>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1b90:	5ec50513          	addi	a0,a0,1516 # 9178 <schedule_dm+0xdb8>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1bb6:	57e50513          	addi	a0,a0,1406 # 9130 <schedule_dm+0xd70>
  ...
  if(fd < 0) {
    ...
    1bda:	15250513          	addi	a0,a0,338 # 8d28 <schedule_dm+0x968>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1c18:	39450513          	addi	a0,a0,916 # 8fa8 <schedule_dm+0xbe8>
  ...
  unlink("echo-ok");
    ...
    1c32:	50250513          	addi	a0,a0,1282 # 9130 <schedule_dm+0xd70>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1c6c:	52850513          	addi	a0,a0,1320 # 9190 <schedule_dm+0xdd0>
...
pipe1(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    1ca8:	50450513          	addi	a0,a0,1284 # 91a8 <schedule_dm+0xde8>
  ...
  if(pid == 0){
    ...
    1d06:	05e68693          	addi	a3,a3,94 # ad60 <buf>
    ...
    1d3a:	02a58593          	addi	a1,a1,42 # ad60 <buf>
    1d3e:	853e                	mv	a0,a5
    ...
    1d5c:	46850513          	addi	a0,a0,1128 # 91c0 <schedule_dm+0xe00>
    ...
    1dc2:	fa270713          	addi	a4,a4,-94 # ad60 <buf>
    ...
    1df4:	3e850513          	addi	a0,a0,1000 # 91d8 <schedule_dm+0xe18>
    ...
    1e56:	f0e58593          	addi	a1,a1,-242 # ad60 <buf>
    1e5a:	853e                	mv	a0,a5
    ...
    1e90:	36450513          	addi	a0,a0,868 # 91f0 <schedule_dm+0xe30>
    ...
    1ed8:	33c50513          	addi	a0,a0,828 # 9210 <schedule_dm+0xe50>
...
preempt(char *s)
{
  ...
  if(pid1 < 0) {
    ...
    1f22:	30a50513          	addi	a0,a0,778 # 9228 <schedule_dm+0xe68>
  ...
  if(pid2 < 0) {
    ...
    1f62:	db250513          	addi	a0,a0,-590 # 8d10 <schedule_dm+0x950>
  ...
  if(pid3 < 0) {
    ...
    1fb0:	d6450513          	addi	a0,a0,-668 # 8d10 <schedule_dm+0x950>
  ...
  if(pid3 == 0){
    ...
    1fe6:	a0658593          	addi	a1,a1,-1530 # 89e8 <schedule_dm+0x628>
    1fea:	853e                	mv	a0,a5
    ...
    2006:	23650513          	addi	a0,a0,566 # 9238 <schedule_dm+0xe78>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    203a:	d2a58593          	addi	a1,a1,-726 # ad60 <buf>
    203e:	853e                	mv	a0,a5
    ...
    205a:	1fa50513          	addi	a0,a0,506 # 9250 <schedule_dm+0xe90>
  ...
  printf("kill... ");
    ...
    207a:	1f250513          	addi	a0,a0,498 # 9268 <schedule_dm+0xea8>
  ...
  printf("wait... ");
    ...
    20b4:	1c850513          	addi	a0,a0,456 # 9278 <schedule_dm+0xeb8>
...
exitwait(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    2118:	bfc50513          	addi	a0,a0,-1028 # 8d10 <schedule_dm+0x950>
    ...
    215a:	13250513          	addi	a0,a0,306 # 9288 <schedule_dm+0xec8>
    ...
    2186:	11e50513          	addi	a0,a0,286 # 92a0 <schedule_dm+0xee0>
...
reparent(char *s)
{
  ...
  for(int i = 0; i < 200; i++){
    ...
    2210:	b0450513          	addi	a0,a0,-1276 # 8d10 <schedule_dm+0x950>
    ...
    224e:	03e50513          	addi	a0,a0,62 # 9288 <schedule_dm+0xec8>
...
twochildren(char *s)
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    22f4:	a2050513          	addi	a0,a0,-1504 # 8d10 <schedule_dm+0x950>
    ...
    233c:	9d850513          	addi	a0,a0,-1576 # 8d10 <schedule_dm+0x950>
...
forkfork(char *s)
{
  ...
  for(int i = 0; i < N; i++){
    ...
    23d0:	e5c50513          	addi	a0,a0,-420 # 9228 <schedule_dm+0xe68>
  ...
  for(int i = 0; i < N; i++){
    ...
    2490:	e3450513          	addi	a0,a0,-460 # 92c0 <schedule_dm+0xf00>
...
forkforkfork(char *s)
{
  ...
  unlink("stopforking");
    ...
    24da:	e0a50513          	addi	a0,a0,-502 # 92e0 <schedule_dm+0xf20>
  ...
  if(pid < 0){
    ...
    2506:	d2650513          	addi	a0,a0,-730 # 9228 <schedule_dm+0xe68>
  ...
  if(pid == 0){
    ...
    252a:	dba50513          	addi	a0,a0,-582 # 92e0 <schedule_dm+0xf20>
    ...
    2566:	d7e50513          	addi	a0,a0,-642 # 92e0 <schedule_dm+0xf20>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    2592:	d5250513          	addi	a0,a0,-686 # 92e0 <schedule_dm+0xf20>
...
reparent2(char *s)
{
  ...
  for(int i = 0; i < 800; i++){
    ...
    25f6:	4f650513          	addi	a0,a0,1270 # 8ae8 <schedule_dm+0x728>
...
mem(char *s)
{
  ...
  if((pid = fork()) == 0){
    ...
    26f0:	c0450513          	addi	a0,a0,-1020 # 92f0 <schedule_dm+0xf30>
...
sharedfd(char *s)
{
  ...
  if(fd < 0){
    ...
    2796:	b7e50513          	addi	a0,a0,-1154 # 9310 <schedule_dm+0xf50>
  ...
  for(i = 0; i < N; i++){
    ...
    280c:	b3050513          	addi	a0,a0,-1232 # 9338 <schedule_dm+0xf78>
  ...
  fd = open("sharedfd", 0);
    ...
    2884:	ed050513          	addi	a0,a0,-304 # 8750 <schedule_dm+0x390>
  ...
  if(fd < 0){
    ...
    28a8:	ab450513          	addi	a0,a0,-1356 # 9358 <schedule_dm+0xf98>
  ...
  unlink("sharedfd");
    ...
    2964:	df050513          	addi	a0,a0,-528 # 8750 <schedule_dm+0x390>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    29a6:	9de50513          	addi	a0,a0,-1570 # 9380 <schedule_dm+0xfc0>
...
fourfiles(char *s)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    29cc:	a2078793          	addi	a5,a5,-1504 # 93e8 <schedule_dm+0x1028>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2a2e:	0be50513          	addi	a0,a0,190 # 8ae8 <schedule_dm+0x728>
    ...
    2a74:	92850513          	addi	a0,a0,-1752 # 9398 <schedule_dm+0xfd8>
    ...
    2a9e:	2c650513          	addi	a0,a0,710 # ad60 <buf>
    ...
    2abc:	2a858593          	addi	a1,a1,680 # ad60 <buf>
    2ac0:	853e                	mv	a0,a5
    ...
    2aea:	8c250513          	addi	a0,a0,-1854 # 93a8 <schedule_dm+0xfe8>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2bb8:	1ac70713          	addi	a4,a4,428 # ad60 <buf>
    ...
    2be0:	7e450513          	addi	a0,a0,2020 # 93c0 <schedule_dm+0x1000>
    ...
    2c28:	13c58593          	addi	a1,a1,316 # ad60 <buf>
    2c2c:	853e                	mv	a0,a5
    ...
    2c70:	76450513          	addi	a0,a0,1892 # 93d0 <schedule_dm+0x1010>
...
createdelete(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2ce8:	e0450513          	addi	a0,a0,-508 # 8ae8 <schedule_dm+0x728>
    ...
    2d64:	3d850513          	addi	a0,a0,984 # 9138 <schedule_dm+0xd78>
    ...
    2dd8:	0b450513          	addi	a0,a0,180 # 8e88 <schedule_dm+0xac8>
  ...
  for(i = 0; i < N; i++){
    ...
    2ef0:	51c50513          	addi	a0,a0,1308 # 9408 <schedule_dm+0x1048>
    ...
    2f36:	4fe50513          	addi	a0,a0,1278 # 9430 <schedule_dm+0x1070>
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3026:	6f650513          	addi	a0,a0,1782 # 8718 <schedule_dm+0x358>
  ...
  if(fd < 0){
    ...
    304a:	41250513          	addi	a0,a0,1042 # 9458 <schedule_dm+0x1098>
  ...
  write(fd, "hello", SZ);
    ...
    306a:	41258593          	addi	a1,a1,1042 # 9478 <schedule_dm+0x10b8>
    306e:	853e                	mv	a0,a5
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    308c:	69050513          	addi	a0,a0,1680 # 8718 <schedule_dm+0x358>
  ...
  if(fd < 0){
    ...
    30b0:	3d450513          	addi	a0,a0,980 # 9480 <schedule_dm+0x10c0>
  ...
  if(unlink("unlinkread") != 0){
    ...
    30ca:	65250513          	addi	a0,a0,1618 # 8718 <schedule_dm+0x358>
    ...
    30e2:	3c250513          	addi	a0,a0,962 # 94a0 <schedule_dm+0x10e0>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3100:	61c50513          	addi	a0,a0,1564 # 8718 <schedule_dm+0x358>
  ...
  write(fd1, "yyy", 3);
    ...
    311c:	3a858593          	addi	a1,a1,936 # 94c0 <schedule_dm+0x1100>
    3120:	853e                	mv	a0,a5
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3142:	c2258593          	addi	a1,a1,-990 # ad60 <buf>
    3146:	853e                	mv	a0,a5
    ...
    3162:	36a50513          	addi	a0,a0,874 # 94c8 <schedule_dm+0x1108>
  ...
  if(buf[0] != 'h'){
    ...
    317c:	be878793          	addi	a5,a5,-1048 # ad60 <buf>
    ...
    3196:	35650513          	addi	a0,a0,854 # 94e8 <schedule_dm+0x1128>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    31b6:	bae58593          	addi	a1,a1,-1106 # ad60 <buf>
    31ba:	853e                	mv	a0,a5
    ...
    31d6:	33650513          	addi	a0,a0,822 # 9508 <schedule_dm+0x1148>
  ...
  unlink("unlinkread");
    ...
    31fe:	51e50513          	addi	a0,a0,1310 # 8718 <schedule_dm+0x358>
...
linktest(char *s)
{
  ...
  unlink("lf1");
    ...
    3224:	30850513          	addi	a0,a0,776 # 9528 <schedule_dm+0x1168>
    3228:	00004097          	auipc	ra,0x4
    322c:	ea2080e7          	jalr	-350(ra) # 70ca <unlink>
  unlink("lf2");
    3230:	00006517          	auipc	a0,0x6
    3234:	30050513          	addi	a0,a0,768 # 9530 <schedule_dm+0x1170>
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    3248:	2e450513          	addi	a0,a0,740 # 9528 <schedule_dm+0x1168>
  ...
  if(fd < 0){
    ...
    326c:	2d050513          	addi	a0,a0,720 # 9538 <schedule_dm+0x1178>
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    328c:	1f058593          	addi	a1,a1,496 # 9478 <schedule_dm+0x10b8>
    3290:	853e                	mv	a0,a5
    ...
    32ac:	2a850513          	addi	a0,a0,680 # 9550 <schedule_dm+0x1190>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    32d4:	26058593          	addi	a1,a1,608 # 9530 <schedule_dm+0x1170>
    32d8:	00006517          	auipc	a0,0x6
    32dc:	25050513          	addi	a0,a0,592 # 9528 <schedule_dm+0x1168>
    ...
    32f6:	27650513          	addi	a0,a0,630 # 9568 <schedule_dm+0x11a8>
  ...
  unlink("lf1");
    ...
    3310:	21c50513          	addi	a0,a0,540 # 9528 <schedule_dm+0x1168>
  ...
  if(open("lf1", 0) >= 0){
    ...
    3322:	20a50513          	addi	a0,a0,522 # 9528 <schedule_dm+0x1168>
    ...
    333c:	25050513          	addi	a0,a0,592 # 9588 <schedule_dm+0x11c8>
  ...
  fd = open("lf2", 0);
    ...
    3358:	1dc50513          	addi	a0,a0,476 # 9530 <schedule_dm+0x1170>
  ...
  if(fd < 0){
    ...
    337c:	24050513          	addi	a0,a0,576 # 95b8 <schedule_dm+0x11f8>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    339c:	9c858593          	addi	a1,a1,-1592 # ad60 <buf>
    33a0:	853e                	mv	a0,a5
    ...
    33bc:	21850513          	addi	a0,a0,536 # 95d0 <schedule_dm+0x1210>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    33e4:	15058593          	addi	a1,a1,336 # 9530 <schedule_dm+0x1170>
    33e8:	00006517          	auipc	a0,0x6
    33ec:	14850513          	addi	a0,a0,328 # 9530 <schedule_dm+0x1170>
    ...
    3406:	1e650513          	addi	a0,a0,486 # 95e8 <schedule_dm+0x1228>
  ...
  unlink("lf2");
    ...
    3420:	11450513          	addi	a0,a0,276 # 9530 <schedule_dm+0x1170>
    3424:	00004097          	auipc	ra,0x4
    3428:	ca6080e7          	jalr	-858(ra) # 70ca <unlink>
  if(link("lf2", "lf1") >= 0){
    342c:	00006597          	auipc	a1,0x6
    3430:	0fc58593          	addi	a1,a1,252 # 9528 <schedule_dm+0x1168>
    3434:	00006517          	auipc	a0,0x6
    3438:	0fc50513          	addi	a0,a0,252 # 9530 <schedule_dm+0x1170>
    ...
    3452:	1c250513          	addi	a0,a0,450 # 9610 <schedule_dm+0x1250>
  ...
  if(link(".", "lf1") >= 0){
    ...
    346c:	0c058593          	addi	a1,a1,192 # 9528 <schedule_dm+0x1168>
    3470:	00006517          	auipc	a0,0x6
    3474:	1c850513          	addi	a0,a0,456 # 9638 <schedule_dm+0x1278>
    ...
    348e:	1b650513          	addi	a0,a0,438 # 9640 <schedule_dm+0x1280>
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    3522:	14250513          	addi	a0,a0,322 # 9660 <schedule_dm+0x12a0>
    ...
    3556:	10e50513          	addi	a0,a0,270 # 9660 <schedule_dm+0x12a0>
    ...
    3590:	0dc50513          	addi	a0,a0,220 # 9668 <schedule_dm+0x12a8>
  ...
  fd = open(".", 0);
    ...
    3618:	02450513          	addi	a0,a0,36 # 9638 <schedule_dm+0x1278>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3682:	00a50513          	addi	a0,a0,10 # 9688 <schedule_dm+0x12c8>
    ...
    36b8:	ff450513          	addi	a0,a0,-12 # 96a8 <schedule_dm+0x12e8>
  ...
  if(n != N){
    ...
    372a:	faa50513          	addi	a0,a0,-86 # 96d0 <schedule_dm+0x1310>
  ...
  for(i = 0; i < N; i++){
    ...
    377a:	59a50513          	addi	a0,a0,1434 # 8d10 <schedule_dm+0x950>
...
linkunlink(char *s)
{
  ...
  unlink("x");
    ...
    3912:	0da50513          	addi	a0,a0,218 # 89e8 <schedule_dm+0x628>
  ...
  if(pid < 0){
    ...
    393e:	3d650513          	addi	a0,a0,982 # 8d10 <schedule_dm+0x950>
  ...
  for(i = 0; i < 100; i++){
    ...
    39a4:	04850513          	addi	a0,a0,72 # 89e8 <schedule_dm+0x628>
    ...
    39d6:	01658593          	addi	a1,a1,22 # 89e8 <schedule_dm+0x628>
    39da:	00006517          	auipc	a0,0x6
    39de:	d2e50513          	addi	a0,a0,-722 # 9708 <schedule_dm+0x1348>
    ...
    39f0:	ffc50513          	addi	a0,a0,-4 # 89e8 <schedule_dm+0x628>
...
bigdir(char *s)
{
  ...
  unlink("bd");
    ...
    3a4c:	cc850513          	addi	a0,a0,-824 # 9710 <schedule_dm+0x1350>
  ...
  fd = open("bd", O_CREATE);
    ...
    3a60:	cb450513          	addi	a0,a0,-844 # 9710 <schedule_dm+0x1350>
  ...
  if(fd < 0){
    ...
    3a84:	c9850513          	addi	a0,a0,-872 # 9718 <schedule_dm+0x1358>
  ...
  for(i = 0; i < N; i++){
    ...
    3b10:	c0450513          	addi	a0,a0,-1020 # 9710 <schedule_dm+0x1350>
    ...
    3b2e:	c0e50513          	addi	a0,a0,-1010 # 9738 <schedule_dm+0x1378>
  ...
  unlink("bd");
    ...
    3b62:	bb250513          	addi	a0,a0,-1102 # 9710 <schedule_dm+0x1350>
  ...
  for(i = 0; i < N; i++){
    ...
    3be6:	b7650513          	addi	a0,a0,-1162 # 9758 <schedule_dm+0x1398>
...
subdir(char *s)
{
  ...
  unlink("ff");
    ...
    3c32:	b4a50513          	addi	a0,a0,-1206 # 9778 <schedule_dm+0x13b8>
    3c36:	00003097          	auipc	ra,0x3
    3c3a:	494080e7          	jalr	1172(ra) # 70ca <unlink>
  if(mkdir("dd") != 0){
    3c3e:	00006517          	auipc	a0,0x6
    3c42:	b4250513          	addi	a0,a0,-1214 # 9780 <schedule_dm+0x13c0>
    ...
    3c5a:	b3250513          	addi	a0,a0,-1230 # 9788 <schedule_dm+0x13c8>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3c78:	b2c50513          	addi	a0,a0,-1236 # 97a0 <schedule_dm+0x13e0>
  ...
  if(fd < 0){
    ...
    3c9c:	b1050513          	addi	a0,a0,-1264 # 97a8 <schedule_dm+0x13e8>
  ...
  write(fd, "ff", 2);
    ...
    3cbc:	ac058593          	addi	a1,a1,-1344 # 9778 <schedule_dm+0x13b8>
    3cc0:	853e                	mv	a0,a5
  ...
  if(unlink("dd") >= 0){
    ...
    3cdc:	aa850513          	addi	a0,a0,-1368 # 9780 <schedule_dm+0x13c0>
    ...
    3cf6:	ad650513          	addi	a0,a0,-1322 # 97c8 <schedule_dm+0x1408>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3d10:	aec50513          	addi	a0,a0,-1300 # 97f8 <schedule_dm+0x1438>
    ...
    3d28:	adc50513          	addi	a0,a0,-1316 # 9800 <schedule_dm+0x1440>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3d46:	ade50513          	addi	a0,a0,-1314 # 9820 <schedule_dm+0x1460>
  ...
  if(fd < 0){
    ...
    3d6a:	aca50513          	addi	a0,a0,-1334 # 9830 <schedule_dm+0x1470>
  ...
  write(fd, "FF", 2);
    ...
    3d8a:	aca58593          	addi	a1,a1,-1334 # 9850 <schedule_dm+0x1490>
    3d8e:	853e                	mv	a0,a5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3dac:	ab050513          	addi	a0,a0,-1360 # 9858 <schedule_dm+0x1498>
  ...
  if(fd < 0){
    ...
    3dd0:	a9c50513          	addi	a0,a0,-1380 # 9868 <schedule_dm+0x14a8>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3df0:	f7458593          	addi	a1,a1,-140 # ad60 <buf>
    3df4:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3e16:	f4e78793          	addi	a5,a5,-178 # ad60 <buf>
    ...
    3e30:	a5c50513          	addi	a0,a0,-1444 # 9888 <schedule_dm+0x14c8>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3e58:	a5458593          	addi	a1,a1,-1452 # 98a8 <schedule_dm+0x14e8>
    3e5c:	00006517          	auipc	a0,0x6
    3e60:	9c450513          	addi	a0,a0,-1596 # 9820 <schedule_dm+0x1460>
    ...
    3e78:	a4450513          	addi	a0,a0,-1468 # 98b8 <schedule_dm+0x14f8>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3e92:	99250513          	addi	a0,a0,-1646 # 9820 <schedule_dm+0x1460>
    ...
    3eaa:	a3a50513          	addi	a0,a0,-1478 # 98e0 <schedule_dm+0x1520>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3ec6:	95e50513          	addi	a0,a0,-1698 # 9820 <schedule_dm+0x1460>
    ...
    3ee0:	a2450513          	addi	a0,a0,-1500 # 9900 <schedule_dm+0x1540>
  ...
  if(chdir("dd") != 0){
    ...
    3efa:	88a50513          	addi	a0,a0,-1910 # 9780 <schedule_dm+0x13c0>
    ...
    3f12:	a1a50513          	addi	a0,a0,-1510 # 9928 <schedule_dm+0x1568>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3f2c:	a1850513          	addi	a0,a0,-1512 # 9940 <schedule_dm+0x1580>
    ...
    3f44:	a1050513          	addi	a0,a0,-1520 # 9950 <schedule_dm+0x1590>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3f5e:	a1650513          	addi	a0,a0,-1514 # 9970 <schedule_dm+0x15b0>
    ...
    3f76:	a0e50513          	addi	a0,a0,-1522 # 9980 <schedule_dm+0x15c0>
  ...
  if(chdir("./..") != 0){
    ...
    3f90:	a1450513          	addi	a0,a0,-1516 # 99a0 <schedule_dm+0x15e0>
    ...
    3fa8:	a0450513          	addi	a0,a0,-1532 # 99a8 <schedule_dm+0x15e8>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3fc4:	8e850513          	addi	a0,a0,-1816 # 98a8 <schedule_dm+0x14e8>
  ...
  if(fd < 0){
    ...
    3fe8:	9dc50513          	addi	a0,a0,-1572 # 99c0 <schedule_dm+0x1600>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    4008:	d5c58593          	addi	a1,a1,-676 # ad60 <buf>
    400c:	853e                	mv	a0,a5
    ...
    4028:	9bc50513          	addi	a0,a0,-1604 # 99e0 <schedule_dm+0x1620>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    4052:	7d250513          	addi	a0,a0,2002 # 9820 <schedule_dm+0x1460>
    ...
    406c:	99850513          	addi	a0,a0,-1640 # 9a00 <schedule_dm+0x1640>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    408a:	9aa50513          	addi	a0,a0,-1622 # 9a30 <schedule_dm+0x1670>
    ...
    40a4:	9a050513          	addi	a0,a0,-1632 # 9a40 <schedule_dm+0x1680>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    40c2:	9a250513          	addi	a0,a0,-1630 # 9a60 <schedule_dm+0x16a0>
    ...
    40dc:	99850513          	addi	a0,a0,-1640 # 9a70 <schedule_dm+0x16b0>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    40fa:	68a50513          	addi	a0,a0,1674 # 9780 <schedule_dm+0x13c0>
    ...
    4114:	98050513          	addi	a0,a0,-1664 # 9a90 <schedule_dm+0x16d0>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    4130:	65450513          	addi	a0,a0,1620 # 9780 <schedule_dm+0x13c0>
    ...
    414a:	96a50513          	addi	a0,a0,-1686 # 9ab0 <schedule_dm+0x16f0>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    4166:	61e50513          	addi	a0,a0,1566 # 9780 <schedule_dm+0x13c0>
    ...
    4180:	95450513          	addi	a0,a0,-1708 # 9ad0 <schedule_dm+0x1710>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    419a:	95a58593          	addi	a1,a1,-1702 # 9af0 <schedule_dm+0x1730>
    419e:	00006517          	auipc	a0,0x6
    41a2:	89250513          	addi	a0,a0,-1902 # 9a30 <schedule_dm+0x1670>
    ...
    41ba:	94a50513          	addi	a0,a0,-1718 # 9b00 <schedule_dm+0x1740>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    41d4:	92058593          	addi	a1,a1,-1760 # 9af0 <schedule_dm+0x1730>
    41d8:	00006517          	auipc	a0,0x6
    41dc:	88850513          	addi	a0,a0,-1912 # 9a60 <schedule_dm+0x16a0>
    ...
    41f4:	93850513          	addi	a0,a0,-1736 # 9b28 <schedule_dm+0x1768>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    420e:	69e58593          	addi	a1,a1,1694 # 98a8 <schedule_dm+0x14e8>
    4212:	00005517          	auipc	a0,0x5
    4216:	58e50513          	addi	a0,a0,1422 # 97a0 <schedule_dm+0x13e0>
    ...
    422e:	92650513          	addi	a0,a0,-1754 # 9b50 <schedule_dm+0x1790>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    4248:	7ec50513          	addi	a0,a0,2028 # 9a30 <schedule_dm+0x1670>
    ...
    4260:	91c50513          	addi	a0,a0,-1764 # 9b78 <schedule_dm+0x17b8>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    427a:	7ea50513          	addi	a0,a0,2026 # 9a60 <schedule_dm+0x16a0>
    ...
    4292:	90a50513          	addi	a0,a0,-1782 # 9b98 <schedule_dm+0x17d8>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    42ac:	60050513          	addi	a0,a0,1536 # 98a8 <schedule_dm+0x14e8>
    ...
    42c4:	8f850513          	addi	a0,a0,-1800 # 9bb8 <schedule_dm+0x17f8>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    42de:	78650513          	addi	a0,a0,1926 # 9a60 <schedule_dm+0x16a0>
    ...
    42f6:	8ee50513          	addi	a0,a0,-1810 # 9be0 <schedule_dm+0x1820>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    4310:	72450513          	addi	a0,a0,1828 # 9a30 <schedule_dm+0x1670>
    ...
    4328:	8dc50513          	addi	a0,a0,-1828 # 9c00 <schedule_dm+0x1840>
  ...
  if(chdir("dd/ff") == 0){
    ...
    4342:	46250513          	addi	a0,a0,1122 # 97a0 <schedule_dm+0x13e0>
    ...
    435a:	8ca50513          	addi	a0,a0,-1846 # 9c20 <schedule_dm+0x1860>
  ...
  if(chdir("dd/xx") == 0){
    ...
    4374:	8d050513          	addi	a0,a0,-1840 # 9c40 <schedule_dm+0x1880>
    ...
    438c:	8c050513          	addi	a0,a0,-1856 # 9c48 <schedule_dm+0x1888>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    43a6:	50650513          	addi	a0,a0,1286 # 98a8 <schedule_dm+0x14e8>
    ...
    43be:	52650513          	addi	a0,a0,1318 # 98e0 <schedule_dm+0x1520>
  ...
  if(unlink("dd/ff") != 0){
    ...
    43d8:	3cc50513          	addi	a0,a0,972 # 97a0 <schedule_dm+0x13e0>
    ...
    43f0:	87c50513          	addi	a0,a0,-1924 # 9c68 <schedule_dm+0x18a8>
  ...
  if(unlink("dd") == 0){
    ...
    440a:	37a50513          	addi	a0,a0,890 # 9780 <schedule_dm+0x13c0>
    ...
    4422:	86a50513          	addi	a0,a0,-1942 # 9c88 <schedule_dm+0x18c8>
  ...
  if(unlink("dd/dd") < 0){
    ...
    443c:	87850513          	addi	a0,a0,-1928 # 9cb0 <schedule_dm+0x18f0>
    ...
    4456:	86650513          	addi	a0,a0,-1946 # 9cb8 <schedule_dm+0x18f8>
  ...
  if(unlink("dd") < 0){
    ...
    4470:	31450513          	addi	a0,a0,788 # 9780 <schedule_dm+0x13c0>
    ...
    448a:	85250513          	addi	a0,a0,-1966 # 9cd8 <schedule_dm+0x1918>
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
    ...
    44ba:	2d250513          	addi	a0,a0,722 # 8788 <schedule_dm+0x3c8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    44d8:	2b450513          	addi	a0,a0,692 # 8788 <schedule_dm+0x3c8>
    ...
    44fc:	7f850513          	addi	a0,a0,2040 # 9cf0 <schedule_dm+0x1930>
    ...
    4526:	83e58593          	addi	a1,a1,-1986 # ad60 <buf>
    452a:	853e                	mv	a0,a5
    ...
    455e:	7b650513          	addi	a0,a0,1974 # 9d10 <schedule_dm+0x1950>
    ...
    459e:	1ee50513          	addi	a0,a0,494 # 8788 <schedule_dm+0x3c8>
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    460a:	4e250513          	addi	a0,a0,1250 # 8ae8 <schedule_dm+0x728>
    ...
    4694:	69850513          	addi	a0,a0,1688 # 9d28 <schedule_dm+0x1968>
    ...
    46be:	6a658593          	addi	a1,a1,1702 # ad60 <buf>
    46c2:	853e                	mv	a0,a5
    ...
    46f6:	61e50513          	addi	a0,a0,1566 # 9d10 <schedule_dm+0x1950>
...
bigfile(char *s)
{
  ...
  if(fd < 0){
    ...
    4826:	52e50513          	addi	a0,a0,1326 # 9d50 <schedule_dm+0x1990>
  ...
  for(i = 0; i < N; i++){
    ...
    4850:	51450513          	addi	a0,a0,1300 # ad60 <buf>
    ...
    4868:	4fc58593          	addi	a1,a1,1276 # ad60 <buf>
    486c:	853e                	mv	a0,a5
    ...
    488a:	4ea50513          	addi	a0,a0,1258 # 9d70 <schedule_dm+0x19b0>
  ...
  fd = open("bigfile.dat", 0);
    ...
    48cc:	47850513          	addi	a0,a0,1144 # 9d40 <schedule_dm+0x1980>
  ...
  if(fd < 0){
    ...
    48f0:	4a450513          	addi	a0,a0,1188 # 9d90 <schedule_dm+0x19d0>
  ...
  for(i = 0; ; i++){
    ...
    491a:	44a58593          	addi	a1,a1,1098 # ad60 <buf>
    491e:	853e                	mv	a0,a5
    ...
    4940:	47450513          	addi	a0,a0,1140 # 9db0 <schedule_dm+0x19f0>
    ...
    4976:	45e50513          	addi	a0,a0,1118 # 9dd0 <schedule_dm+0x1a10>
    ...
    4990:	3d478793          	addi	a5,a5,980 # ad60 <buf>
    ...
    49b6:	3ae78793          	addi	a5,a5,942 # ad60 <buf>
    ...
    49e0:	40c50513          	addi	a0,a0,1036 # 9de8 <schedule_dm+0x1a28>
  ...
  if(total != N*SZ){
    ...
    4a3a:	3d250513          	addi	a0,a0,978 # 9e08 <schedule_dm+0x1a48>
  ...
  unlink("bigfile.dat");
    ...
    4a54:	2f050513          	addi	a0,a0,752 # 9d40 <schedule_dm+0x1980>
...
fourteen(char *s)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    4a7a:	3b250513          	addi	a0,a0,946 # 9e28 <schedule_dm+0x1a68>
    ...
    4a92:	3aa50513          	addi	a0,a0,938 # 9e38 <schedule_dm+0x1a78>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    4aac:	3b850513          	addi	a0,a0,952 # 9e60 <schedule_dm+0x1aa0>
    ...
    4ac4:	3c050513          	addi	a0,a0,960 # 9e80 <schedule_dm+0x1ac0>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    4ae2:	3da50513          	addi	a0,a0,986 # 9eb8 <schedule_dm+0x1af8>
  ...
  if(fd < 0){
    ...
    4b06:	3e650513          	addi	a0,a0,998 # 9ee8 <schedule_dm+0x1b28>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    4b30:	40450513          	addi	a0,a0,1028 # 9f30 <schedule_dm+0x1b70>
  ...
  if(fd < 0){
    ...
    4b54:	41050513          	addi	a0,a0,1040 # 9f60 <schedule_dm+0x1ba0>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    4b7c:	42850513          	addi	a0,a0,1064 # 9fa0 <schedule_dm+0x1be0>
    ...
    4b94:	43050513          	addi	a0,a0,1072 # 9fc0 <schedule_dm+0x1c00>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    4bae:	44e50513          	addi	a0,a0,1102 # 9ff8 <schedule_dm+0x1c38>
    ...
    4bc6:	45650513          	addi	a0,a0,1110 # a018 <schedule_dm+0x1c58>
...
rmdot(char *s)
{
  ...
  if(mkdir("dots") != 0){
    ...
    4c56:	3fe50513          	addi	a0,a0,1022 # a050 <schedule_dm+0x1c90>
    ...
    4c6e:	3ee50513          	addi	a0,a0,1006 # a058 <schedule_dm+0x1c98>
  ...
  if(chdir("dots") != 0){
    ...
    4c88:	3cc50513          	addi	a0,a0,972 # a050 <schedule_dm+0x1c90>
    ...
    4ca0:	3d450513          	addi	a0,a0,980 # a070 <schedule_dm+0x1cb0>
  ...
  if(unlink(".") == 0){
    ...
    4cba:	98250513          	addi	a0,a0,-1662 # 9638 <schedule_dm+0x1278>
    ...
    4cd2:	3ba50513          	addi	a0,a0,954 # a088 <schedule_dm+0x1cc8>
  ...
  if(unlink("..") == 0){
    ...
    4cec:	40850513          	addi	a0,a0,1032 # 90f0 <schedule_dm+0xd30>
    ...
    4d04:	3a050513          	addi	a0,a0,928 # a0a0 <schedule_dm+0x1ce0>
  ...
  if(chdir("/") != 0){
    ...
    4d1e:	0ee50513          	addi	a0,a0,238 # 8e08 <schedule_dm+0xa48>
    ...
    4d36:	0de50513          	addi	a0,a0,222 # 8e10 <schedule_dm+0xa50>
  ...
  if(unlink("dots/.") == 0){
    ...
    4d50:	36c50513          	addi	a0,a0,876 # a0b8 <schedule_dm+0x1cf8>
    ...
    4d68:	35c50513          	addi	a0,a0,860 # a0c0 <schedule_dm+0x1d00>
  ...
  if(unlink("dots/..") == 0){
    ...
    4d82:	36250513          	addi	a0,a0,866 # a0e0 <schedule_dm+0x1d20>
    ...
    4d9a:	35250513          	addi	a0,a0,850 # a0e8 <schedule_dm+0x1d28>
  ...
  if(unlink("dots") != 0){
    ...
    4db4:	2a050513          	addi	a0,a0,672 # a050 <schedule_dm+0x1c90>
    ...
    4dcc:	34050513          	addi	a0,a0,832 # a108 <schedule_dm+0x1d48>
...
dirfile(char *s)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4e00:	ab450513          	addi	a0,a0,-1356 # 88b0 <schedule_dm+0x4f0>
  ...
  if(fd < 0){
    ...
    4e24:	30850513          	addi	a0,a0,776 # a128 <schedule_dm+0x1d68>
  ...
  if(chdir("dirfile") == 0){
    ...
    4e4c:	a6850513          	addi	a0,a0,-1432 # 88b0 <schedule_dm+0x4f0>
    ...
    4e64:	2e850513          	addi	a0,a0,744 # a148 <schedule_dm+0x1d88>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4e80:	2ec50513          	addi	a0,a0,748 # a168 <schedule_dm+0x1da8>
  ...
  if(fd >= 0){
    ...
    4ea4:	2d850513          	addi	a0,a0,728 # a178 <schedule_dm+0x1db8>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4ec2:	2aa50513          	addi	a0,a0,682 # a168 <schedule_dm+0x1da8>
  ...
  if(fd >= 0){
    ...
    4ee6:	29650513          	addi	a0,a0,662 # a178 <schedule_dm+0x1db8>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4f00:	26c50513          	addi	a0,a0,620 # a168 <schedule_dm+0x1da8>
    ...
    4f18:	28c50513          	addi	a0,a0,652 # a1a0 <schedule_dm+0x1de0>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4f32:	23a50513          	addi	a0,a0,570 # a168 <schedule_dm+0x1da8>
    ...
    4f4a:	28250513          	addi	a0,a0,642 # a1c8 <schedule_dm+0x1e08>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4f64:	20858593          	addi	a1,a1,520 # a168 <schedule_dm+0x1da8>
    4f68:	00004517          	auipc	a0,0x4
    4f6c:	a3050513          	addi	a0,a0,-1488 # 8998 <schedule_dm+0x5d8>
    ...
    4f84:	27050513          	addi	a0,a0,624 # a1f0 <schedule_dm+0x1e30>
  ...
  if(unlink("dirfile") != 0){
    ...
    4f9e:	91650513          	addi	a0,a0,-1770 # 88b0 <schedule_dm+0x4f0>
    ...
    4fb6:	26650513          	addi	a0,a0,614 # a218 <schedule_dm+0x1e58>
  ...
  fd = open(".", O_RDWR);
    ...
    4fd2:	66a50513          	addi	a0,a0,1642 # 9638 <schedule_dm+0x1278>
  ...
  if(fd >= 0){
    ...
    4ff6:	24650513          	addi	a0,a0,582 # a238 <schedule_dm+0x1e78>
  ...
  fd = open(".", 0);
    ...
    5012:	62a50513          	addi	a0,a0,1578 # 9638 <schedule_dm+0x1278>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    502e:	9be58593          	addi	a1,a1,-1602 # 89e8 <schedule_dm+0x628>
    5032:	853e                	mv	a0,a5
    ...
    504a:	21a50513          	addi	a0,a0,538 # a260 <schedule_dm+0x1ea0>
...
iref(char *s)
{
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    508e:	1ee50513          	addi	a0,a0,494 # a278 <schedule_dm+0x1eb8>
    ...
    50a6:	1de50513          	addi	a0,a0,478 # a280 <schedule_dm+0x1ec0>
    ...
    50c0:	1bc50513          	addi	a0,a0,444 # a278 <schedule_dm+0x1eb8>
    ...
    50d8:	1c450513          	addi	a0,a0,452 # a298 <schedule_dm+0x1ed8>
    ...
    5150:	97450513          	addi	a0,a0,-1676 # 8ac0 <schedule_dm+0x700>
    ...
    517e:	94650513          	addi	a0,a0,-1722 # 8ac0 <schedule_dm+0x700>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    51ae:	f4650513          	addi	a0,a0,-186 # 90f0 <schedule_dm+0xd30>
    51b2:	00002097          	auipc	ra,0x2
    51b6:	f38080e7          	jalr	-200(ra) # 70ea <chdir>
    unlink("irefd");
    51ba:	00005517          	auipc	a0,0x5
    51be:	0be50513          	addi	a0,a0,190 # a278 <schedule_dm+0x1eb8>
  ...
  chdir("/");
    ...
    51e8:	c2450513          	addi	a0,a0,-988 # 8e08 <schedule_dm+0xa48>
...
forktest(char *s)
{
  ...
  if (n == 0) {
    ...
    5268:	05450513          	addi	a0,a0,84 # a2b8 <schedule_dm+0x1ef8>
  ...
  if(n == N){
    ...
    5296:	03e50513          	addi	a0,a0,62 # a2d0 <schedule_dm+0x1f10>
  ...
  for(; n > 0; n--){
    ...
    52c4:	03850513          	addi	a0,a0,56 # a2f8 <schedule_dm+0x1f38>
  ...
  if(wait(0) != -1){
    ...
    530a:	00a50513          	addi	a0,a0,10 # a310 <schedule_dm+0x1f50>
...
sbrkbasic(char *s)
{
  ...
  if(pid < 0){
    ...
    5352:	fda50513          	addi	a0,a0,-38 # a328 <schedule_dm+0x1f68>
  ...
  if(xstatus == 1){
    ...
    53f4:	f5850513          	addi	a0,a0,-168 # a348 <schedule_dm+0x1f88>
  ...
  for(i = 0; i < 5000; i++){
    ...
    544a:	f2250513          	addi	a0,a0,-222 # a368 <schedule_dm+0x1fa8>
    ...
    *b = 1;
    ...
    5464:	4705                	li	a4,1
    5466:	00e78023          	sb	a4,0(a5) # 40000000 <__BSS_END__+0x3ffeea68>
    a = b + 1;
  ...
  if(pid < 0){
    ...
    54b0:	edc50513          	addi	a0,a0,-292 # a388 <schedule_dm+0x1fc8>
  ...
  if(c != a + 1){
    ...
    54f8:	eb450513          	addi	a0,a0,-332 # a3a8 <schedule_dm+0x1fe8>
...
sbrkmuch(char *s)
{
  ...
  if (p != a) {
    ...
    559c:	e3050513          	addi	a0,a0,-464 # a3c8 <schedule_dm+0x2008>
  ...
  *lastaddr = 99;
    ...
    55fe:	00e78023          	sb	a4,0(a5) # 6400000 <__BSS_END__+0x63eea68>
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5630:	de450513          	addi	a0,a0,-540 # a410 <schedule_dm+0x2050>
  ...
  if(c != a - PGSIZE){
    ...
    5674:	dc050513          	addi	a0,a0,-576 # a430 <schedule_dm+0x2070>
  ...
  if(c != a || sbrk(0) != a + PGSIZE){
    ...
    56da:	d9a50513          	addi	a0,a0,-614 # a470 <schedule_dm+0x20b0>
  ...
  if(*lastaddr == 99){
    ...
    570a:	d9a50513          	addi	a0,a0,-614 # a4a0 <schedule_dm+0x20e0>
  ...
  if(c != a){
    ...
    576c:	d7050513          	addi	a0,a0,-656 # a4d8 <schedule_dm+0x2118>
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    57c2:	55250513          	addi	a0,a0,1362 # 8d10 <schedule_dm+0x950>
    ...
    57f8:	d0c50513          	addi	a0,a0,-756 # a500 <schedule_dm+0x2140>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    5838:	35078793          	addi	a5,a5,848 # c350 <__global_pointer$+0xdf8>
    ...
    584c:	47f78793          	addi	a5,a5,1151 # 1003d47f <__BSS_END__+0x1002bee7>
...
sbrkfail(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    5886:	92650513          	addi	a0,a0,-1754 # 91a8 <schedule_dm+0xde8>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    58fe:	0ee58593          	addi	a1,a1,238 # 89e8 <schedule_dm+0x628>
    5902:	853e                	mv	a0,a5
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    59da:	b4a50513          	addi	a0,a0,-1206 # a520 <schedule_dm+0x2160>
  ...
  if(pid < 0){
    ...
    5a10:	30450513          	addi	a0,a0,772 # 8d10 <schedule_dm+0x950>
  ...
  if(pid == 0){
    ...
    5a96:	aae50513          	addi	a0,a0,-1362 # a540 <schedule_dm+0x2180>
...
sbrkarg(char *s)
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    5b08:	a6c50513          	addi	a0,a0,-1428 # a570 <schedule_dm+0x21b0>
  ...
  unlink("sbrk");
    ...
    5b1e:	a5650513          	addi	a0,a0,-1450 # a570 <schedule_dm+0x21b0>
  ...
  if(fd < 0)  {
    ...
    5b3c:	a4050513          	addi	a0,a0,-1472 # a578 <schedule_dm+0x21b8>
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    5b7e:	a1650513          	addi	a0,a0,-1514 # a590 <schedule_dm+0x21d0>
  ...
  if(pipe((int *) a) != 0){
    ...
    5bc8:	5e450513          	addi	a0,a0,1508 # 91a8 <schedule_dm+0xde8>
...
validatetest(char *s)
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    5c0c:	9a050513          	addi	a0,a0,-1632 # a5a8 <schedule_dm+0x21e8>
    ...
    5c2a:	99250513          	addi	a0,a0,-1646 # a5b8 <schedule_dm+0x21f8>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    5c7e:	0e670713          	addi	a4,a4,230 # dd60 <uninit>
    ...
    5c96:	94650513          	addi	a0,a0,-1722 # a5d8 <schedule_dm+0x2218>
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    ...
    5ce2:	91250513          	addi	a0,a0,-1774 # a5f0 <schedule_dm+0x2230>
  ...
  if(pid == 0){
    ...
    5d0e:	76e70713          	addi	a4,a4,1902 # 11478 <args.1845>
    5d12:	fec42783          	lw	a5,-20(s0)
    5d16:	078e                	slli	a5,a5,0x3
    5d18:	97ba                	add	a5,a5,a4
    5d1a:	00005717          	auipc	a4,0x5
    5d1e:	8e670713          	addi	a4,a4,-1818 # a600 <schedule_dm+0x2240>
    ...
    5da4:	94050513          	addi	a0,a0,-1728 # a6e0 <schedule_dm+0x2320>
  ...
  fd = open("bigarg-ok", 0);
    ...
    5de2:	81250513          	addi	a0,a0,-2030 # a5f0 <schedule_dm+0x2230>
  ...
  if(fd < 0){
    ...
    5e06:	8fe50513          	addi	a0,a0,-1794 # a700 <schedule_dm+0x2340>
...
fsfull()
{
  ...
  printf("fsfull test\n");
    ...
    5e44:	8e050513          	addi	a0,a0,-1824 # a720 <schedule_dm+0x2360>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5ef6:	83e50513          	addi	a0,a0,-1986 # a730 <schedule_dm+0x2370>
    ...
    5f2e:	81650513          	addi	a0,a0,-2026 # a740 <schedule_dm+0x2380>
    ...
    5f4c:	e1858593          	addi	a1,a1,-488 # ad60 <buf>
    5f50:	853e                	mv	a0,a5
    ...
    5f96:	7be50513          	addi	a0,a0,1982 # a750 <schedule_dm+0x2390>
  ...
  printf("fsfull test finished\n");
    ...
    6086:	6de50513          	addi	a0,a0,1758 # a760 <schedule_dm+0x23a0>
...
void argptest(char *s)
{
  ...
  fd = open("init", O_RDONLY);
    ...
    60ae:	6ce50513          	addi	a0,a0,1742 # a778 <schedule_dm+0x23b8>
  ...
  if (fd < 0) {
    ...
    60d2:	c5a50513          	addi	a0,a0,-934 # 8d28 <schedule_dm+0x968>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    612c:	c3078793          	addi	a5,a5,-976 # ad58 <randstate>
    6130:	6398                	ld	a4,0(a5)
    6132:	001967b7          	lui	a5,0x196
    6136:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x185075>
    613a:	02f70733          	mul	a4,a4,a5
    613e:	3c6ef7b7          	lui	a5,0x3c6ef
    6142:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6dddc7>
    6146:	973e                	add	a4,a4,a5
    6148:	00005797          	auipc	a5,0x5
    614c:	c1078793          	addi	a5,a5,-1008 # ad58 <randstate>
    6150:	e398                	sd	a4,0(a5)
  return randstate;
    6152:	00005797          	auipc	a5,0x5
    6156:	c0678793          	addi	a5,a5,-1018 # ad58 <randstate>
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    61a6:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffeda68>
    61aa:	2781                	sext.w	a5,a5
    61ac:	863e                	mv	a2,a5
    61ae:	fc843583          	ld	a1,-56(s0)
    61b2:	00004517          	auipc	a0,0x4
    61b6:	5ce50513          	addi	a0,a0,1486 # a780 <schedule_dm+0x23c0>
    ...
    61de:	b3650513          	addi	a0,a0,-1226 # 8d10 <schedule_dm+0x950>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    623e:	af678793          	addi	a5,a5,-1290 # ad30 <schedule_dm+0x2970>
  ...
  pipe((int*)0xeaeb0b5b00002f5e);
    ...
    6254:	ae078793          	addi	a5,a5,-1312 # ad30 <schedule_dm+0x2970>
...
sbrkbugs(char *s)
{
  ...
  if(pid < 0){
    ...
    6296:	85650513          	addi	a0,a0,-1962 # 8ae8 <schedule_dm+0x728>
  ...
  if(pid < 0){
    ...
    6308:	7e450513          	addi	a0,a0,2020 # 8ae8 <schedule_dm+0x728>
  ...
  if(pid < 0){
    ...
    6380:	76c50513          	addi	a0,a0,1900 # 8ae8 <schedule_dm+0x728>
...
badwrite(char *s)
{
  ...
  unlink("junk");
    ...
    6404:	3a850513          	addi	a0,a0,936 # a7a8 <schedule_dm+0x23e8>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    641e:	38e50513          	addi	a0,a0,910 # a7a8 <schedule_dm+0x23e8>
    ...
    643e:	37650513          	addi	a0,a0,886 # a7b0 <schedule_dm+0x23f0>
    ...
    647c:	33050513          	addi	a0,a0,816 # a7a8 <schedule_dm+0x23e8>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    64aa:	30250513          	addi	a0,a0,770 # a7a8 <schedule_dm+0x23e8>
  ...
  if(fd < 0){
    ...
    64ca:	2ea50513          	addi	a0,a0,746 # a7b0 <schedule_dm+0x23f0>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    64ea:	50258593          	addi	a1,a1,1282 # 89e8 <schedule_dm+0x628>
    64ee:	853e                	mv	a0,a5
    ...
    6506:	2c650513          	addi	a0,a0,710 # a7c8 <schedule_dm+0x2408>
  ...
  unlink("junk");
    ...
    652e:	27e50513          	addi	a0,a0,638 # a7a8 <schedule_dm+0x23e8>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    656c:	59050513          	addi	a0,a0,1424 # 8af8 <schedule_dm+0x738>
  ...
  for(int i = 0; i < 50000; i++){
    ...
    658c:	34f78793          	addi	a5,a5,847 # c34f <__global_pointer$+0xdf7>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    65cc:	52050513          	addi	a0,a0,1312 # 8ae8 <schedule_dm+0x728>
    ...
    660e:	873e                	mv	a4,a5
    6610:	4785                	li	a5,1
    6612:	00f70023          	sb	a5,0(a4) # b000 <buf+0x2a0>
      while(1){
    ...
    6652:	4aa78793          	addi	a5,a5,1194 # 8af8 <schedule_dm+0x738>
    6656:	fcf43023          	sd	a5,-64(s0)
    665a:	00002797          	auipc	a5,0x2
    665e:	38e78793          	addi	a5,a5,910 # 89e8 <schedule_dm+0x628>
    ...
    6674:	48850513          	addi	a0,a0,1160 # 8af8 <schedule_dm+0x738>
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    66d6:	10650513          	addi	a0,a0,262 # a7d8 <schedule_dm+0x2418>
  ...
  if(pid < 0){
    ...
    6708:	0f450513          	addi	a0,a0,244 # a7f8 <schedule_dm+0x2438>
  ...
  if(pid == 0){
    ...
    676a:	28258593          	addi	a1,a1,642 # 89e8 <schedule_dm+0x628>
    676e:	853e                	mv	a0,a5
    ...
    6786:	09650513          	addi	a0,a0,150 # a818 <schedule_dm+0x2458>
  ...
  while(1){
    ...
    67e4:	05850513          	addi	a0,a0,88 # a838 <schedule_dm+0x2478>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    684e:	00e50513          	addi	a0,a0,14 # a858 <schedule_dm+0x2498>
  ...
  if((pid = fork()) < 0) {
    ...
    6876:	ff650513          	addi	a0,a0,-10 # a868 <schedule_dm+0x24a8>
  ...
  if(pid == 0) {
    ...
    68c0:	fc450513          	addi	a0,a0,-60 # a880 <schedule_dm+0x24c0>
    ...
    68d2:	fba50513          	addi	a0,a0,-70 # a888 <schedule_dm+0x24c8>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    6932:	f6258593          	addi	a1,a1,-158 # a890 <schedule_dm+0x24d0>
    6936:	853e                	mv	a0,a5
    ...
    6966:	f3658593          	addi	a1,a1,-202 # a898 <schedule_dm+0x24d8>
    696a:	853e                	mv	a0,a5
    ...
    69c2:	ee250513          	addi	a0,a0,-286 # a8a0 <schedule_dm+0x24e0>
  ...
  struct test {
    ...
    69dc:	fa870713          	addi	a4,a4,-88 # a980 <schedule_dm+0x25c0>
  ...
  if(continuous){
    ...
    6a04:	ec850513          	addi	a0,a0,-312 # a8c8 <schedule_dm+0x2508>
    ...
    6a6e:	e7e50513          	addi	a0,a0,-386 # a8e8 <schedule_dm+0x2528>
    ...
    6ac4:	e4050513          	addi	a0,a0,-448 # a900 <schedule_dm+0x2540>
  ...
  printf("usertests starting\n");
    ...
    6aec:	e3850513          	addi	a0,a0,-456 # a920 <schedule_dm+0x2560>
  ...
  if(fail){
    ...
    6b76:	d7650513          	addi	a0,a0,-650 # a8e8 <schedule_dm+0x2528>
    ...
    6bba:	d8250513          	addi	a0,a0,-638 # a938 <schedule_dm+0x2578>
    ...
    6bd4:	d9850513          	addi	a0,a0,-616 # a968 <schedule_dm+0x25a8>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    71e2:	b6268693          	addi	a3,a3,-1182 # ad40 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    72bc:	a8870713          	addi	a4,a4,-1400 # ad40 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    747c:	8c078793          	addi	a5,a5,-1856 # ad38 <schedule_dm+0x2978>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    7628:	f6478793          	addi	a5,a5,-156 # 11588 <freep>
  ...
  freep = p;
    ...
    7720:	e6c78793          	addi	a5,a5,-404 # 11588 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    77a2:	dea78793          	addi	a5,a5,-534 # 11588 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    77d4:	db878793          	addi	a5,a5,-584 # 11588 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    7892:	cfa78793          	addi	a5,a5,-774 # 11588 <freep>
    ...
    78a8:	ce478793          	addi	a5,a5,-796 # 11588 <freep>
...
0000000000007a2a <find_next_release_time>:

int find_next_release_time(struct list_head *release_queue, int current_time) {
    7a2a:	7139                	addi	sp,sp,-64
    7a2c:	fc22                	sd	s0,56(sp)
    7a2e:	0080                	addi	s0,sp,64
    7a30:	fca43423          	sd	a0,-56(s0)
    7a34:	87ae                	mv	a5,a1
    7a36:	fcf42223          	sw	a5,-60(s0)
    struct release_queue_entry *next_release = NULL;
    7a3a:	fe043423          	sd	zero,-24(s0)
    int next_release_time = INT_MAX;
    7a3e:	800007b7          	lui	a5,0x80000
    7a42:	fff7c793          	not	a5,a5
    7a46:	fef42223          	sw	a5,-28(s0)

    list_for_each_entry(next_release, release_queue, thread_list) {
    7a4a:	fc843783          	ld	a5,-56(s0)
    7a4e:	639c                	ld	a5,0(a5)
    7a50:	fcf43c23          	sd	a5,-40(s0)
    7a54:	fd843783          	ld	a5,-40(s0)
    7a58:	17e1                	addi	a5,a5,-8
    7a5a:	fef43423          	sd	a5,-24(s0)
    7a5e:	a081                	j	7a9e <find_next_release_time+0x74>
        if (next_release->release_time > current_time && next_release->release_time < next_release_time) {
    7a60:	fe843783          	ld	a5,-24(s0)
    7a64:	4f98                	lw	a4,24(a5)
    7a66:	fc442783          	lw	a5,-60(s0)
    7a6a:	2781                	sext.w	a5,a5
    7a6c:	00e7df63          	bge	a5,a4,7a8a <find_next_release_time+0x60>
    7a70:	fe843783          	ld	a5,-24(s0)
    7a74:	4f98                	lw	a4,24(a5)
    7a76:	fe442783          	lw	a5,-28(s0)
    7a7a:	2781                	sext.w	a5,a5
    7a7c:	00f75763          	bge	a4,a5,7a8a <find_next_release_time+0x60>
            next_release_time = next_release->release_time;
    7a80:	fe843783          	ld	a5,-24(s0)
    7a84:	4f9c                	lw	a5,24(a5)
    7a86:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(next_release, release_queue, thread_list) {
    7a8a:	fe843783          	ld	a5,-24(s0)
    7a8e:	679c                	ld	a5,8(a5)
    7a90:	fcf43823          	sd	a5,-48(s0)
    7a94:	fd043783          	ld	a5,-48(s0)
    7a98:	17e1                	addi	a5,a5,-8
    7a9a:	fef43423          	sd	a5,-24(s0)
    7a9e:	fe843783          	ld	a5,-24(s0)
    7aa2:	07a1                	addi	a5,a5,8
    7aa4:	fc843703          	ld	a4,-56(s0)
    7aa8:	faf71ce3          	bne	a4,a5,7a60 <find_next_release_time+0x36>
        }
    }

    if (next_release_time == INT_MAX)
    7aac:	fe442783          	lw	a5,-28(s0)
    7ab0:	0007871b          	sext.w	a4,a5
    7ab4:	800007b7          	lui	a5,0x80000
    7ab8:	fff7c793          	not	a5,a5
    7abc:	00f71463          	bne	a4,a5,7ac4 <find_next_release_time+0x9a>
        return -1; // No threads in the release queue
    7ac0:	57fd                	li	a5,-1
    7ac2:	a801                	j	7ad2 <find_next_release_time+0xa8>

    return next_release_time - current_time;
    7ac4:	fe442703          	lw	a4,-28(s0)
    7ac8:	fc442783          	lw	a5,-60(s0)
    7acc:	40f707bb          	subw	a5,a4,a5
    7ad0:	2781                	sext.w	a5,a5
}
    7ad2:	853e                	mv	a0,a5
    7ad4:	7462                	ld	s0,56(sp)
    7ad6:	6121                	addi	sp,sp,64
    7ad8:	8082                	ret

0000000000007ada <schedule_wrr>:

/* MP3 Part 1 - Non-Real-Time Scheduling */
/* Weighted-Round-Robin Scheduling */
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    7ada:	7119                	addi	sp,sp,-128
    7adc:	fc86                	sd	ra,120(sp)
    7ade:	f8a2                	sd	s0,112(sp)
    7ae0:	f4a6                	sd	s1,104(sp)
    7ae2:	f0ca                	sd	s2,96(sp)
    7ae4:	ecce                	sd	s3,88(sp)
    ...
    7aea:	fc043423          	sd	zero,-56(s0)
    struct thread *candidate = NULL;
    7aee:	fc043023          	sd	zero,-64(s0)
    ...
    7af2:	0000a797          	auipc	a5,0xa
    7af6:	a9e78793          	addi	a5,a5,-1378 # 11590 <last_thread.1239>
    7afa:	639c                	ld	a5,0(a5)
    7afc:	cb89                	beqz	a5,7b0e <schedule_wrr+0x34>
    7afe:	0000a797          	auipc	a5,0xa
    7b02:	a9278793          	addi	a5,a5,-1390 # 11590 <last_thread.1239>
    7b06:	639c                	ld	a5,0(a5)
    7b08:	4fbc                	lw	a5,88(a5)
    7b0a:	00f04863          	bgtz	a5,7b1a <schedule_wrr+0x40>
        last_thread = NULL;
    7b0e:	0000a797          	auipc	a5,0xa
    7b12:	a8278793          	addi	a5,a5,-1406 # 11590 <last_thread.1239>
    7b16:	0007b023          	sd	zero,0(a5)
    }

    // Find the first thread that is ready to run
    list_for_each_entry(candidate, args.run_queue, thread_list) {
    7b1a:	649c                	ld	a5,8(s1)
    7b1c:	639c                	ld	a5,0(a5)
    7b1e:	faf43823          	sd	a5,-80(s0)
    7b22:	fb043783          	ld	a5,-80(s0)
    7b26:	fd878793          	addi	a5,a5,-40
    7b2a:	fcf43023          	sd	a5,-64(s0)
    7b2e:	a0a9                	j	7b78 <schedule_wrr+0x9e>
        if (!last_thread && candidate->remaining_time > 0)
    7b30:	0000a797          	auipc	a5,0xa
    7b34:	a6078793          	addi	a5,a5,-1440 # 11590 <last_thread.1239>
    7b38:	639c                	ld	a5,0(a5)
    7b3a:	eb91                	bnez	a5,7b4e <schedule_wrr+0x74>
    7b3c:	fc043783          	ld	a5,-64(s0)
    7b40:	4fbc                	lw	a5,88(a5)
    7b42:	00f05663          	blez	a5,7b4e <schedule_wrr+0x74>
            selected_thread = candidate;
    7b46:	fc043783          	ld	a5,-64(s0)
    7b4a:	fcf43423          	sd	a5,-56(s0)
        if (candidate->remaining_time > 0) {
    7b4e:	fc043783          	ld	a5,-64(s0)
    7b52:	4fbc                	lw	a5,88(a5)
    7b54:	00f05763          	blez	a5,7b62 <schedule_wrr+0x88>
            selected_thread = candidate;
    7b58:	fc043783          	ld	a5,-64(s0)
    7b5c:	fcf43423          	sd	a5,-56(s0)
            break;
    7b60:	a01d                	j	7b86 <schedule_wrr+0xac>
    list_for_each_entry(candidate, args.run_queue, thread_list) {
    7b62:	fc043783          	ld	a5,-64(s0)
    7b66:	779c                	ld	a5,40(a5)
    7b68:	faf43423          	sd	a5,-88(s0)
    7b6c:	fa843783          	ld	a5,-88(s0)
    7b70:	fd878793          	addi	a5,a5,-40
    7b74:	fcf43023          	sd	a5,-64(s0)
    7b78:	fc043783          	ld	a5,-64(s0)
    7b7c:	02878713          	addi	a4,a5,40
    7b80:	649c                	ld	a5,8(s1)
    7b82:	faf717e3          	bne	a4,a5,7b30 <schedule_wrr+0x56>
        }
    }
    ...
    7b8a:	e795                	bnez	a5,7bb6 <schedule_wrr+0xdc>
    7b8c:	0000a797          	auipc	a5,0xa
    7b90:	a0478793          	addi	a5,a5,-1532 # 11590 <last_thread.1239>
    7b94:	639c                	ld	a5,0(a5)
    7b96:	c385                	beqz	a5,7bb6 <schedule_wrr+0xdc>
    7b98:	0000a797          	auipc	a5,0xa
    7b9c:	9f878793          	addi	a5,a5,-1544 # 11590 <last_thread.1239>
    7ba0:	639c                	ld	a5,0(a5)
    7ba2:	4fbc                	lw	a5,88(a5)
    7ba4:	00f05963          	blez	a5,7bb6 <schedule_wrr+0xdc>
        selected_thread = last_thread;
    7ba8:	0000a797          	auipc	a5,0xa
    7bac:	9e878793          	addi	a5,a5,-1560 # 11590 <last_thread.1239>
    7bb0:	639c                	ld	a5,0(a5)
    7bb2:	fcf43423          	sd	a5,-56(s0)
    }

    // Set the scheduling result
    if (selected_thread) {
    7bb6:	fc843783          	ld	a5,-56(s0)
    7bba:	c7b9                	beqz	a5,7c08 <schedule_wrr+0x12e>
        int time_slice = selected_thread->weight * TIME_QUANTUM;
    7bbc:	fc843783          	ld	a5,-56(s0)
    7bc0:	47bc                	lw	a5,72(a5)
    7bc2:	0017979b          	slliw	a5,a5,0x1
    7bc6:	faf42e23          	sw	a5,-68(s0)
        if (time_slice > selected_thread->remaining_time) {
    7bca:	fc843783          	ld	a5,-56(s0)
    7bce:	4fb8                	lw	a4,88(a5)
    7bd0:	fbc42783          	lw	a5,-68(s0)
    7bd4:	2781                	sext.w	a5,a5
    7bd6:	00f75763          	bge	a4,a5,7be4 <schedule_wrr+0x10a>
            time_slice = selected_thread->remaining_time;
    7bda:	fc843783          	ld	a5,-56(s0)
    7bde:	4fbc                	lw	a5,88(a5)
    7be0:	faf42e23          	sw	a5,-68(s0)
        }
        r.scheduled_thread_list_member = &selected_thread->thread_list;
    7be4:	fc843783          	ld	a5,-56(s0)
    7be8:	02878793          	addi	a5,a5,40
    7bec:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = time_slice;
    7bf0:	fbc42783          	lw	a5,-68(s0)
    7bf4:	f8f42823          	sw	a5,-112(s0)
        last_thread = selected_thread;  // Update the last run thread
    7bf8:	0000a797          	auipc	a5,0xa
    7bfc:	99878793          	addi	a5,a5,-1640 # 11590 <last_thread.1239>
    7c00:	fc843703          	ld	a4,-56(s0)
    7c04:	e398                	sd	a4,0(a5)
    7c06:	a839                	j	7c24 <schedule_wrr+0x14a>
    } else {
        // Idle if no suitable thread is found
        r.scheduled_thread_list_member = args.run_queue;
    7c08:	649c                	ld	a5,8(s1)
    7c0a:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    7c0e:	689c                	ld	a5,16(s1)
    7c10:	4098                	lw	a4,0(s1)
    7c12:	85ba                	mv	a1,a4
    7c14:	853e                	mv	a0,a5
    7c16:	00000097          	auipc	ra,0x0
    7c1a:	e14080e7          	jalr	-492(ra) # 7a2a <find_next_release_time>
    7c1e:	87aa                	mv	a5,a0
    7c20:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    7c24:	f8843783          	ld	a5,-120(s0)
    7c28:	f8f43c23          	sd	a5,-104(s0)
    7c2c:	f9043783          	ld	a5,-112(s0)
    7c30:	faf43023          	sd	a5,-96(s0)
    7c34:	4701                	li	a4,0
    7c36:	f9843703          	ld	a4,-104(s0)
    7c3a:	4781                	li	a5,0
    7c3c:	fa043783          	ld	a5,-96(s0)
    7c40:	893a                	mv	s2,a4
    7c42:	89be                	mv	s3,a5
    7c44:	874a                	mv	a4,s2
    7c46:	87ce                	mv	a5,s3
    ...
    7c48:	853a                	mv	a0,a4
    7c4a:	85be                	mv	a1,a5
    7c4c:	70e6                	ld	ra,120(sp)
    7c4e:	7446                	ld	s0,112(sp)
    7c50:	74a6                	ld	s1,104(sp)
    7c52:	7906                	ld	s2,96(sp)
    7c54:	69e6                	ld	s3,88(sp)
    7c56:	6109                	addi	sp,sp,128
    7c58:	8082                	ret

0000000000007c5a <find_earliest_impactful_release_time>:


int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    7c5a:	7159                	addi	sp,sp,-112
    7c5c:	f4a2                	sd	s0,104(sp)
    7c5e:	1880                	addi	s0,sp,112
    7c60:	faa43423          	sd	a0,-88(s0)
    7c64:	fab43023          	sd	a1,-96(s0)
    7c68:	87b2                	mv	a5,a2
    7c6a:	f8f42e23          	sw	a5,-100(s0)
    struct release_queue_entry *entry;
    int earliest_impactful_time = INT_MAX;
    7c6e:	800007b7          	lui	a5,0x80000
    7c72:	fff7c793          	not	a5,a5
    7c76:	fef42223          	sw	a5,-28(s0)
    int shortest_current_time = INT_MAX;
    7c7a:	800007b7          	lui	a5,0x80000
    7c7e:	fff7c793          	not	a5,a5
    7c82:	fef42023          	sw	a5,-32(s0)
    // Find the shortest remaining time among currently running tasks
    struct thread *t;
    list_for_each_entry(t, run_queue, thread_list) {
    7c86:	fa043783          	ld	a5,-96(s0)
    7c8a:	639c                	ld	a5,0(a5)
    7c8c:	fcf43823          	sd	a5,-48(s0)
    7c90:	fd043783          	ld	a5,-48(s0)
    7c94:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeea40>
    7c98:	fcf43c23          	sd	a5,-40(s0)
    7c9c:	a80d                	j	7cce <find_earliest_impactful_release_time+0x74>
        if (t->remaining_time < shortest_current_time) {
    7c9e:	fd843783          	ld	a5,-40(s0)
    7ca2:	4fb8                	lw	a4,88(a5)
    7ca4:	fe042783          	lw	a5,-32(s0)
    7ca8:	2781                	sext.w	a5,a5
    7caa:	00f75763          	bge	a4,a5,7cb8 <find_earliest_impactful_release_time+0x5e>
            shortest_current_time = t->remaining_time;
    7cae:	fd843783          	ld	a5,-40(s0)
    7cb2:	4fbc                	lw	a5,88(a5)
    7cb4:	fef42023          	sw	a5,-32(s0)
    list_for_each_entry(t, run_queue, thread_list) {
    7cb8:	fd843783          	ld	a5,-40(s0)
    7cbc:	779c                	ld	a5,40(a5)
    7cbe:	faf43c23          	sd	a5,-72(s0)
    7cc2:	fb843783          	ld	a5,-72(s0)
    7cc6:	fd878793          	addi	a5,a5,-40
    7cca:	fcf43c23          	sd	a5,-40(s0)
    7cce:	fd843783          	ld	a5,-40(s0)
    7cd2:	02878793          	addi	a5,a5,40
    7cd6:	fa043703          	ld	a4,-96(s0)
    7cda:	fcf712e3          	bne	a4,a5,7c9e <find_earliest_impactful_release_time+0x44>
        }
    }
    ...
    7cde:	fa843783          	ld	a5,-88(s0)
    7ce2:	639c                	ld	a5,0(a5)
    7ce4:	fcf43423          	sd	a5,-56(s0)
    7ce8:	fc843783          	ld	a5,-56(s0)
    7cec:	17e1                	addi	a5,a5,-8
    7cee:	fef43423          	sd	a5,-24(s0)
    7cf2:	a889                	j	7d44 <find_earliest_impactful_release_time+0xea>
        if (entry->release_time > current_time && entry->release_time < earliest_impactful_time) {
    7cf4:	fe843783          	ld	a5,-24(s0)
    7cf8:	4f98                	lw	a4,24(a5)
    7cfa:	f9c42783          	lw	a5,-100(s0)
    7cfe:	2781                	sext.w	a5,a5
    7d00:	02e7d863          	bge	a5,a4,7d30 <find_earliest_impactful_release_time+0xd6>
    7d04:	fe843783          	ld	a5,-24(s0)
    7d08:	4f98                	lw	a4,24(a5)
    7d0a:	fe442783          	lw	a5,-28(s0)
    7d0e:	2781                	sext.w	a5,a5
    7d10:	02f75063          	bge	a4,a5,7d30 <find_earliest_impactful_release_time+0xd6>
            if (entry->thrd->remaining_time < shortest_current_time) {
    7d14:	fe843783          	ld	a5,-24(s0)
    7d18:	639c                	ld	a5,0(a5)
    7d1a:	4fb8                	lw	a4,88(a5)
    7d1c:	fe042783          	lw	a5,-32(s0)
    7d20:	2781                	sext.w	a5,a5
    7d22:	00f75763          	bge	a4,a5,7d30 <find_earliest_impactful_release_time+0xd6>
                earliest_impactful_time = entry->release_time;
    7d26:	fe843783          	ld	a5,-24(s0)
    7d2a:	4f9c                	lw	a5,24(a5)
    7d2c:	fef42223          	sw	a5,-28(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    7d30:	fe843783          	ld	a5,-24(s0)
    7d34:	679c                	ld	a5,8(a5)
    7d36:	fcf43023          	sd	a5,-64(s0)
    7d3a:	fc043783          	ld	a5,-64(s0)
    7d3e:	17e1                	addi	a5,a5,-8
    7d40:	fef43423          	sd	a5,-24(s0)
    7d44:	fe843783          	ld	a5,-24(s0)
    7d48:	07a1                	addi	a5,a5,8
    7d4a:	fa843703          	ld	a4,-88(s0)
    7d4e:	faf713e3          	bne	a4,a5,7cf4 <find_earliest_impactful_release_time+0x9a>
            }
        }
    }
    ...
    7d56:	0007871b          	sext.w	a4,a5
    7d5a:	800007b7          	lui	a5,0x80000
    7d5e:	fff7c793          	not	a5,a5
    7d62:	00f70a63          	beq	a4,a5,7d76 <find_earliest_impactful_release_time+0x11c>
    7d66:	fe442703          	lw	a4,-28(s0)
    7d6a:	f9c42783          	lw	a5,-100(s0)
    7d6e:	40f707bb          	subw	a5,a4,a5
    7d72:	2781                	sext.w	a5,a5
    7d74:	a011                	j	7d78 <find_earliest_impactful_release_time+0x11e>
    7d76:	57fd                	li	a5,-1
}
    7d78:	853e                	mv	a0,a5
    7d7a:	7426                	ld	s0,104(sp)
    7d7c:	6165                	addi	sp,sp,112
    7d7e:	8082                	ret

0000000000007d80 <schedule_sjf>:


struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    7d80:	7119                	addi	sp,sp,-128
    7d82:	fc86                	sd	ra,120(sp)
    7d84:	f8a2                	sd	s0,112(sp)
    7d86:	f4a6                	sd	s1,104(sp)
    7d88:	f0ca                	sd	s2,96(sp)
    7d8a:	ecce                	sd	s3,88(sp)
    7d8c:	0100                	addi	s0,sp,128
    7d8e:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *shortest_job = NULL;
    7d90:	fc043423          	sd	zero,-56(s0)
    struct thread *current;
    int shortest_time = INT_MAX;
    7d94:	800007b7          	lui	a5,0x80000
    7d98:	fff7c793          	not	a5,a5
    7d9c:	faf42e23          	sw	a5,-68(s0)
    int earliest_impactful_time = find_earliest_impactful_release_time(args.release_queue, args.run_queue, args.current_time);
    7da0:	689c                	ld	a5,16(s1)
    7da2:	6498                	ld	a4,8(s1)
    7da4:	4094                	lw	a3,0(s1)
    7da6:	8636                	mv	a2,a3
    7da8:	85ba                	mv	a1,a4
    7daa:	853e                	mv	a0,a5
    7dac:	00000097          	auipc	ra,0x0
    7db0:	eae080e7          	jalr	-338(ra) # 7c5a <find_earliest_impactful_release_time>
    7db4:	87aa                	mv	a5,a0
    7db6:	faf42a23          	sw	a5,-76(s0)

    // Determine the shortest job from the run queue
    list_for_each_entry(current, args.run_queue, thread_list) {
    7dba:	649c                	ld	a5,8(s1)
    7dbc:	639c                	ld	a5,0(a5)
    7dbe:	faf43423          	sd	a5,-88(s0)
    7dc2:	fa843783          	ld	a5,-88(s0)
    7dc6:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeea40>
    7dca:	fcf43023          	sd	a5,-64(s0)
    7dce:	a82d                	j	7e08 <schedule_sjf+0x88>
        if (current->remaining_time < shortest_time) {
    7dd0:	fc043783          	ld	a5,-64(s0)
    7dd4:	4fb8                	lw	a4,88(a5)
    7dd6:	fbc42783          	lw	a5,-68(s0)
    7dda:	2781                	sext.w	a5,a5
    7ddc:	00f75b63          	bge	a4,a5,7df2 <schedule_sjf+0x72>
            shortest_time = current->remaining_time;
    7de0:	fc043783          	ld	a5,-64(s0)
    7de4:	4fbc                	lw	a5,88(a5)
    7de6:	faf42e23          	sw	a5,-68(s0)
            shortest_job = current;
    7dea:	fc043783          	ld	a5,-64(s0)
    7dee:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(current, args.run_queue, thread_list) {
    7df2:	fc043783          	ld	a5,-64(s0)
    7df6:	779c                	ld	a5,40(a5)
    7df8:	faf43023          	sd	a5,-96(s0)
    7dfc:	fa043783          	ld	a5,-96(s0)
    7e00:	fd878793          	addi	a5,a5,-40
    7e04:	fcf43023          	sd	a5,-64(s0)
    7e08:	fc043783          	ld	a5,-64(s0)
    7e0c:	02878713          	addi	a4,a5,40
    7e10:	649c                	ld	a5,8(s1)
    7e12:	faf71fe3          	bne	a4,a5,7dd0 <schedule_sjf+0x50>
        }
    }

    if (shortest_job) {
    7e16:	fc843783          	ld	a5,-56(s0)
    7e1a:	c7a1                	beqz	a5,7e62 <schedule_sjf+0xe2>
        int time_to_allocate = shortest_job->remaining_time;
    7e1c:	fc843783          	ld	a5,-56(s0)
    7e20:	4fbc                	lw	a5,88(a5)
    7e22:	faf42c23          	sw	a5,-72(s0)
    ...
    7e26:	fb442783          	lw	a5,-76(s0)
    7e2a:	0007871b          	sext.w	a4,a5
    7e2e:	57fd                	li	a5,-1
    7e30:	00f70e63          	beq	a4,a5,7e4c <schedule_sjf+0xcc>
    7e34:	fb442703          	lw	a4,-76(s0)
    7e38:	fb842783          	lw	a5,-72(s0)
    7e3c:	2701                	sext.w	a4,a4
    7e3e:	2781                	sext.w	a5,a5
    7e40:	00f75663          	bge	a4,a5,7e4c <schedule_sjf+0xcc>
            time_to_allocate = earliest_impactful_time;
    7e44:	fb442783          	lw	a5,-76(s0)
    7e48:	faf42c23          	sw	a5,-72(s0)
        }

        r.scheduled_thread_list_member = &shortest_job->thread_list;
    7e4c:	fc843783          	ld	a5,-56(s0)
    7e50:	02878793          	addi	a5,a5,40
    7e54:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = time_to_allocate;
    7e58:	fb842783          	lw	a5,-72(s0)
    7e5c:	f8f42423          	sw	a5,-120(s0)
    7e60:	a80d                	j	7e92 <schedule_sjf+0x112>
    } else {
        // If no current tasks are ready, wait for the next impactful task
        r.scheduled_thread_list_member = args.run_queue;
    7e62:	649c                	ld	a5,8(s1)
    7e64:	f8f43023          	sd	a5,-128(s0)
    ...
    7e68:	fb442783          	lw	a5,-76(s0)
    7e6c:	0007871b          	sext.w	a4,a5
    7e70:	57fd                	li	a5,-1
    7e72:	00f71c63          	bne	a4,a5,7e8a <schedule_sjf+0x10a>
    7e76:	689c                	ld	a5,16(s1)
    7e78:	4098                	lw	a4,0(s1)
    7e7a:	85ba                	mv	a1,a4
    7e7c:	853e                	mv	a0,a5
    7e7e:	00000097          	auipc	ra,0x0
    7e82:	bac080e7          	jalr	-1108(ra) # 7a2a <find_next_release_time>
    7e86:	87aa                	mv	a5,a0
    7e88:	a019                	j	7e8e <schedule_sjf+0x10e>
    7e8a:	fb442783          	lw	a5,-76(s0)
    7e8e:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    7e92:	f8043783          	ld	a5,-128(s0)
    7e96:	f8f43823          	sd	a5,-112(s0)
    7e9a:	f8843783          	ld	a5,-120(s0)
    7e9e:	f8f43c23          	sd	a5,-104(s0)
    7ea2:	4701                	li	a4,0
    7ea4:	f9043703          	ld	a4,-112(s0)
    7ea8:	4781                	li	a5,0
    7eaa:	f9843783          	ld	a5,-104(s0)
    7eae:	893a                	mv	s2,a4
    7eb0:	89be                	mv	s3,a5
    7eb2:	874a                	mv	a4,s2
    7eb4:	87ce                	mv	a5,s3
    ...
    7eb6:	853a                	mv	a0,a4
    7eb8:	85be                	mv	a1,a5
    7eba:	70e6                	ld	ra,120(sp)
    7ebc:	7446                	ld	s0,112(sp)
    7ebe:	74a6                	ld	s1,104(sp)
    7ec0:	7906                	ld	s2,96(sp)
    7ec2:	69e6                	ld	s3,88(sp)
    7ec4:	6109                	addi	sp,sp,128
    7ec6:	8082                	ret

0000000000007ec8 <min>:

int min(int a, int b) {
    7ec8:	1101                	addi	sp,sp,-32
    7eca:	ec22                	sd	s0,24(sp)
    7ecc:	1000                	addi	s0,sp,32
    7ece:	87aa                	mv	a5,a0
    7ed0:	872e                	mv	a4,a1
    7ed2:	fef42623          	sw	a5,-20(s0)
    7ed6:	87ba                	mv	a5,a4
    7ed8:	fef42423          	sw	a5,-24(s0)
    return (a < b) ? a : b;
    7edc:	fec42603          	lw	a2,-20(s0)
    7ee0:	fe842783          	lw	a5,-24(s0)
    7ee4:	0007869b          	sext.w	a3,a5
    7ee8:	0006071b          	sext.w	a4,a2
    7eec:	00d75363          	bge	a4,a3,7ef2 <min+0x2a>
    7ef0:	87b2                	mv	a5,a2
    7ef2:	2781                	sext.w	a5,a5
}
    7ef4:	853e                	mv	a0,a5
    7ef6:	6462                	ld	s0,24(sp)
    7ef8:	6105                	addi	sp,sp,32
    7efa:	8082                	ret

0000000000007efc <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    7efc:	7115                	addi	sp,sp,-224
    7efe:	ed86                	sd	ra,216(sp)
    7f00:	e9a2                	sd	s0,208(sp)
    7f02:	e5a6                	sd	s1,200(sp)
    7f04:	e1ca                	sd	s2,192(sp)
    7f06:	fd4e                	sd	s3,184(sp)
    7f08:	1180                	addi	s0,sp,224
    7f0a:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *min_slack_thread = NULL;
    7f0c:	fc043423          	sd	zero,-56(s0)
    int min_slack_time = INT_MAX;
    7f10:	800007b7          	lui	a5,0x80000
    7f14:	fff7c793          	not	a5,a5
    7f18:	fcf42223          	sw	a5,-60(s0)
    struct thread *t;

    // Determine the thread with the minimum slack time
    list_for_each_entry(t, args.run_queue, thread_list) {
    7f1c:	649c                	ld	a5,8(s1)
    7f1e:	639c                	ld	a5,0(a5)
    7f20:	f8f43823          	sd	a5,-112(s0)
    7f24:	f9043783          	ld	a5,-112(s0)
    7f28:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeea40>
    7f2c:	faf43c23          	sd	a5,-72(s0)
    7f30:	a069                	j	7fba <schedule_lst+0xbe>
        int slack_time = t->current_deadline - args.current_time - t->remaining_time;
    7f32:	fb843783          	ld	a5,-72(s0)
    7f36:	4ff8                	lw	a4,92(a5)
    7f38:	409c                	lw	a5,0(s1)
    7f3a:	40f707bb          	subw	a5,a4,a5
    7f3e:	0007871b          	sext.w	a4,a5
    7f42:	fb843783          	ld	a5,-72(s0)
    7f46:	4fbc                	lw	a5,88(a5)
    7f48:	40f707bb          	subw	a5,a4,a5
    7f4c:	f4f42a23          	sw	a5,-172(s0)
        if (slack_time < min_slack_time || (slack_time == min_slack_time && t->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))) {
    7f50:	f5442703          	lw	a4,-172(s0)
    7f54:	fc442783          	lw	a5,-60(s0)
    7f58:	2701                	sext.w	a4,a4
    7f5a:	2781                	sext.w	a5,a5
    7f5c:	02f74c63          	blt	a4,a5,7f94 <schedule_lst+0x98>
    7f60:	f5442703          	lw	a4,-172(s0)
    7f64:	fc442783          	lw	a5,-60(s0)
    7f68:	2701                	sext.w	a4,a4
    7f6a:	2781                	sext.w	a5,a5
    7f6c:	02f71c63          	bne	a4,a5,7fa4 <schedule_lst+0xa8>
    7f70:	fb843783          	ld	a5,-72(s0)
    7f74:	5fd4                	lw	a3,60(a5)
    7f76:	fc843783          	ld	a5,-56(s0)
    7f7a:	c789                	beqz	a5,7f84 <schedule_lst+0x88>
    7f7c:	fc843783          	ld	a5,-56(s0)
    7f80:	5fdc                	lw	a5,60(a5)
    7f82:	a029                	j	7f8c <schedule_lst+0x90>
    7f84:	800007b7          	lui	a5,0x80000
    7f88:	fff7c793          	not	a5,a5
    7f8c:	873e                	mv	a4,a5
    7f8e:	87b6                	mv	a5,a3
    7f90:	00e7da63          	bge	a5,a4,7fa4 <schedule_lst+0xa8>
            min_slack_thread = t;
    7f94:	fb843783          	ld	a5,-72(s0)
    7f98:	fcf43423          	sd	a5,-56(s0)
            min_slack_time = slack_time;
    7f9c:	f5442783          	lw	a5,-172(s0)
    7fa0:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    7fa4:	fb843783          	ld	a5,-72(s0)
    7fa8:	779c                	ld	a5,40(a5)
    7faa:	f4f43423          	sd	a5,-184(s0)
    7fae:	f4843783          	ld	a5,-184(s0)
    7fb2:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeea40>
    7fb6:	faf43c23          	sd	a5,-72(s0)
    7fba:	fb843783          	ld	a5,-72(s0)
    7fbe:	02878713          	addi	a4,a5,40
    7fc2:	649c                	ld	a5,8(s1)
    7fc4:	f6f717e3          	bne	a4,a5,7f32 <schedule_lst+0x36>
        }
    }
    ...
    7fc8:	800007b7          	lui	a5,0x80000
    7fcc:	fff7c793          	not	a5,a5
    7fd0:	faf42a23          	sw	a5,-76(s0)
    ...
    7fd4:	689c                	ld	a5,16(s1)
    7fd6:	639c                	ld	a5,0(a5)
    7fd8:	f8f43423          	sd	a5,-120(s0)
    7fdc:	f8843783          	ld	a5,-120(s0)
    7fe0:	17e1                	addi	a5,a5,-8
    7fe2:	faf43423          	sd	a5,-88(s0)
    7fe6:	a0f1                	j	80b2 <schedule_lst+0x1b6>
        if (entry->release_time > args.current_time) {
    7fe8:	fa843783          	ld	a5,-88(s0)
    7fec:	4f98                	lw	a4,24(a5)
    7fee:	409c                	lw	a5,0(s1)
    7ff0:	0ae7d763          	bge	a5,a4,809e <schedule_lst+0x1a2>
            struct thread *upcoming_thread = entry->thrd;
    7ff4:	fa843783          	ld	a5,-88(s0)
    7ff8:	639c                	ld	a5,0(a5)
    7ffa:	f6f43423          	sd	a5,-152(s0)
    ...
    7ffe:	f6843783          	ld	a5,-152(s0)
    8002:	4ff8                	lw	a4,92(a5)
    8004:	fa843783          	ld	a5,-88(s0)
    8008:	4f9c                	lw	a5,24(a5)
    800a:	40f707bb          	subw	a5,a4,a5
    800e:	0007871b          	sext.w	a4,a5
    8012:	f6843783          	ld	a5,-152(s0)
    8016:	43fc                	lw	a5,68(a5)
    8018:	40f707bb          	subw	a5,a4,a5
    801c:	f6f42223          	sw	a5,-156(s0)
    ...
    8020:	f6442703          	lw	a4,-156(s0)
    8024:	fc442783          	lw	a5,-60(s0)
    8028:	2701                	sext.w	a4,a4
    802a:	2781                	sext.w	a5,a5
    802c:	02f75163          	bge	a4,a5,804e <schedule_lst+0x152>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    8030:	fa843783          	ld	a5,-88(s0)
    8034:	4f98                	lw	a4,24(a5)
    8036:	fb442783          	lw	a5,-76(s0)
    803a:	85ba                	mv	a1,a4
    803c:	853e                	mv	a0,a5
    803e:	00000097          	auipc	ra,0x0
    8042:	e8a080e7          	jalr	-374(ra) # 7ec8 <min>
    8046:	87aa                	mv	a5,a0
    8048:	faf42a23          	sw	a5,-76(s0)
    804c:	a889                	j	809e <schedule_lst+0x1a2>
            } else if (upcoming_slack_time == min_slack_time && upcoming_thread->ID < (min_slack_thread ? min_slack_thread->ID : INT_MAX))
    804e:	f6442703          	lw	a4,-156(s0)
    8052:	fc442783          	lw	a5,-60(s0)
    8056:	2701                	sext.w	a4,a4
    8058:	2781                	sext.w	a5,a5
    805a:	04f71263          	bne	a4,a5,809e <schedule_lst+0x1a2>
    805e:	f6843783          	ld	a5,-152(s0)
    8062:	5fd4                	lw	a3,60(a5)
    8064:	fc843783          	ld	a5,-56(s0)
    8068:	c789                	beqz	a5,8072 <schedule_lst+0x176>
    806a:	fc843783          	ld	a5,-56(s0)
    806e:	5fdc                	lw	a5,60(a5)
    8070:	a029                	j	807a <schedule_lst+0x17e>
    8072:	800007b7          	lui	a5,0x80000
    8076:	fff7c793          	not	a5,a5
    807a:	873e                	mv	a4,a5
    807c:	87b6                	mv	a5,a3
    807e:	02e7d063          	bge	a5,a4,809e <schedule_lst+0x1a2>
                next_significant_event_time = min(next_significant_event_time, entry->release_time);
    8082:	fa843783          	ld	a5,-88(s0)
    8086:	4f98                	lw	a4,24(a5)
    8088:	fb442783          	lw	a5,-76(s0)
    808c:	85ba                	mv	a1,a4
    808e:	853e                	mv	a0,a5
    8090:	00000097          	auipc	ra,0x0
    8094:	e38080e7          	jalr	-456(ra) # 7ec8 <min>
    8098:	87aa                	mv	a5,a0
    809a:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(entry, args.release_queue, thread_list) {
    809e:	fa843783          	ld	a5,-88(s0)
    80a2:	679c                	ld	a5,8(a5)
    80a4:	f4f43c23          	sd	a5,-168(s0)
    80a8:	f5843783          	ld	a5,-168(s0)
    80ac:	17e1                	addi	a5,a5,-8
    80ae:	faf43423          	sd	a5,-88(s0)
    80b2:	fa843783          	ld	a5,-88(s0)
    80b6:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__BSS_END__+0xffffffff7ffeea70>
    80ba:	689c                	ld	a5,16(s1)
    80bc:	f2f716e3          	bne	a4,a5,7fe8 <schedule_lst+0xec>
        }
    }

    // Decide the allocated time based on current minimum slack or upcoming preemption needs
    if (min_slack_thread) {
    80c0:	fc843783          	ld	a5,-56(s0)
    80c4:	10078b63          	beqz	a5,81da <schedule_lst+0x2de>
    ...
    80c8:	4098                	lw	a4,0(s1)
    80ca:	fc843783          	ld	a5,-56(s0)
    80ce:	4ffc                	lw	a5,92(a5)
    80d0:	08f74863          	blt	a4,a5,8160 <schedule_lst+0x264>
    80d4:	fc843783          	ld	a5,-56(s0)
    80d8:	4fbc                	lw	a5,88(a5)
    80da:	08f05363          	blez	a5,8160 <schedule_lst+0x264>
            struct thread *thread_with_smallest_id = min_slack_thread;
    80de:	fc843783          	ld	a5,-56(s0)
    80e2:	faf43023          	sd	a5,-96(s0)
            // Iterate again to find if there are other threads that also missed their deadlines and have smaller IDs
            list_for_each_entry(t, args.run_queue, thread_list) {
    80e6:	649c                	ld	a5,8(s1)
    80e8:	639c                	ld	a5,0(a5)
    80ea:	f8f43023          	sd	a5,-128(s0)
    80ee:	f8043783          	ld	a5,-128(s0)
    80f2:	fd878793          	addi	a5,a5,-40
    80f6:	faf43c23          	sd	a5,-72(s0)
    80fa:	a099                	j	8140 <schedule_lst+0x244>
                if (args.current_time >= t->current_deadline && t->remaining_time > 0 && t->ID < thread_with_smallest_id->ID) {
    80fc:	4098                	lw	a4,0(s1)
    80fe:	fb843783          	ld	a5,-72(s0)
    8102:	4ffc                	lw	a5,92(a5)
    8104:	02f74363          	blt	a4,a5,812a <schedule_lst+0x22e>
    8108:	fb843783          	ld	a5,-72(s0)
    810c:	4fbc                	lw	a5,88(a5)
    810e:	00f05e63          	blez	a5,812a <schedule_lst+0x22e>
    8112:	fb843783          	ld	a5,-72(s0)
    8116:	5fd8                	lw	a4,60(a5)
    8118:	fa043783          	ld	a5,-96(s0)
    811c:	5fdc                	lw	a5,60(a5)
    811e:	00f75663          	bge	a4,a5,812a <schedule_lst+0x22e>
                    thread_with_smallest_id = t;
    8122:	fb843783          	ld	a5,-72(s0)
    8126:	faf43023          	sd	a5,-96(s0)
            list_for_each_entry(t, args.run_queue, thread_list) {
    812a:	fb843783          	ld	a5,-72(s0)
    812e:	779c                	ld	a5,40(a5)
    8130:	f6f43c23          	sd	a5,-136(s0)
    8134:	f7843783          	ld	a5,-136(s0)
    8138:	fd878793          	addi	a5,a5,-40
    813c:	faf43c23          	sd	a5,-72(s0)
    8140:	fb843783          	ld	a5,-72(s0)
    8144:	02878713          	addi	a4,a5,40
    8148:	649c                	ld	a5,8(s1)
    814a:	faf719e3          	bne	a4,a5,80fc <schedule_lst+0x200>
                }
            }
            r.scheduled_thread_list_member = &thread_with_smallest_id->thread_list;
    814e:	fa043783          	ld	a5,-96(s0)
    8152:	02878793          	addi	a5,a5,40
    8156:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = 0;
    815a:	f2042823          	sw	zero,-208(s0)
        if (args.current_time >= min_slack_thread->current_deadline && min_slack_thread->remaining_time > 0) {
    815e:	a86d                	j	8218 <schedule_lst+0x31c>
        } else {
            // Calculate time until the thread's deadline
            int time_until_deadline = min_slack_thread->current_deadline - args.current_time;
    8160:	fc843783          	ld	a5,-56(s0)
    8164:	4ff8                	lw	a4,92(a5)
    8166:	409c                	lw	a5,0(s1)
    8168:	40f707bb          	subw	a5,a4,a5
    816c:	f6f42a23          	sw	a5,-140(s0)
            
            // Decide the allocated time based on current minimum slack or upcoming preemption needs
            int allocated_time = min(min_slack_thread->remaining_time, time_until_deadline);
    8170:	fc843783          	ld	a5,-56(s0)
    8174:	4fbc                	lw	a5,88(a5)
    8176:	f7442703          	lw	a4,-140(s0)
    817a:	85ba                	mv	a1,a4
    817c:	853e                	mv	a0,a5
    817e:	00000097          	auipc	ra,0x0
    8182:	d4a080e7          	jalr	-694(ra) # 7ec8 <min>
    8186:	87aa                	mv	a5,a0
    8188:	f8f42e23          	sw	a5,-100(s0)
            if (next_significant_event_time != INT_MAX) {
    818c:	fb442783          	lw	a5,-76(s0)
    8190:	0007871b          	sext.w	a4,a5
    8194:	800007b7          	lui	a5,0x80000
    8198:	fff7c793          	not	a5,a5
    819c:	02f70463          	beq	a4,a5,81c4 <schedule_lst+0x2c8>
                allocated_time = min(allocated_time, next_significant_event_time - args.current_time);
    81a0:	409c                	lw	a5,0(s1)
    81a2:	fb442703          	lw	a4,-76(s0)
    81a6:	40f707bb          	subw	a5,a4,a5
    81aa:	0007871b          	sext.w	a4,a5
    81ae:	f9c42783          	lw	a5,-100(s0)
    81b2:	85ba                	mv	a1,a4
    81b4:	853e                	mv	a0,a5
    81b6:	00000097          	auipc	ra,0x0
    81ba:	d12080e7          	jalr	-750(ra) # 7ec8 <min>
    81be:	87aa                	mv	a5,a0
    81c0:	f8f42e23          	sw	a5,-100(s0)
            }

            r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    81c4:	fc843783          	ld	a5,-56(s0)
    81c8:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__BSS_END__+0xffffffff7ffeea90>
    81cc:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = allocated_time;
    81d0:	f9c42783          	lw	a5,-100(s0)
    81d4:	f2f42823          	sw	a5,-208(s0)
    81d8:	a081                	j	8218 <schedule_lst+0x31c>
        }
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    81da:	649c                	ld	a5,8(s1)
    81dc:	f2f43423          	sd	a5,-216(s0)
    ...
    81e0:	fb442783          	lw	a5,-76(s0)
    81e4:	0007871b          	sext.w	a4,a5
    81e8:	800007b7          	lui	a5,0x80000
    81ec:	fff7c793          	not	a5,a5
    81f0:	00f70963          	beq	a4,a5,8202 <schedule_lst+0x306>
    81f4:	409c                	lw	a5,0(s1)
    81f6:	fb442703          	lw	a4,-76(s0)
    81fa:	40f707bb          	subw	a5,a4,a5
    81fe:	2781                	sext.w	a5,a5
    8200:	a811                	j	8214 <schedule_lst+0x318>
    8202:	689c                	ld	a5,16(s1)
    8204:	4098                	lw	a4,0(s1)
    8206:	85ba                	mv	a1,a4
    8208:	853e                	mv	a0,a5
    820a:	00000097          	auipc	ra,0x0
    820e:	820080e7          	jalr	-2016(ra) # 7a2a <find_next_release_time>
    8212:	87aa                	mv	a5,a0
    8214:	f2f42823          	sw	a5,-208(s0)
    }

    return r;
    8218:	f2843783          	ld	a5,-216(s0)
    821c:	f2f43c23          	sd	a5,-200(s0)
    8220:	f3043783          	ld	a5,-208(s0)
    8224:	f4f43023          	sd	a5,-192(s0)
    8228:	4701                	li	a4,0
    822a:	f3843703          	ld	a4,-200(s0)
    822e:	4781                	li	a5,0
    8230:	f4043783          	ld	a5,-192(s0)
    8234:	893a                	mv	s2,a4
    8236:	89be                	mv	s3,a5
    8238:	874a                	mv	a4,s2
    823a:	87ce                	mv	a5,s3
    ...
    823c:	853a                	mv	a0,a4
    823e:	85be                	mv	a1,a5
    8240:	60ee                	ld	ra,216(sp)
    8242:	644e                	ld	s0,208(sp)
    8244:	64ae                	ld	s1,200(sp)
    8246:	690e                	ld	s2,192(sp)
    8248:	79ea                	ld	s3,184(sp)
    824a:	612d                	addi	sp,sp,224
    824c:	8082                	ret

000000000000824e <find_earliest_impactful_release_time_dm>:
typedef struct {
...
ImpactfulEvent find_earliest_impactful_release_time_dm(struct list_head *release_queue, struct list_head*run_queue, int current_time, int current_period, int current_thread_ID) {
    824e:	7119                	addi	sp,sp,-128
    8250:	fca2                	sd	s0,120(sp)
    8252:	0100                	addi	s0,sp,128
    8254:	f8a43c23          	sd	a0,-104(s0)
    8258:	f8b43823          	sd	a1,-112(s0)
    825c:	87b2                	mv	a5,a2
    825e:	f8f42623          	sw	a5,-116(s0)
    8262:	87b6                	mv	a5,a3
    8264:	f8f42423          	sw	a5,-120(s0)
    8268:	87ba                	mv	a5,a4
    826a:	f8f42223          	sw	a5,-124(s0)
    struct release_queue_entry *entry;
    struct thread *t;
    int earliest_impactful_event = INT_MAX;
    826e:	800007b7          	lui	a5,0x80000
    8272:	fff7c793          	not	a5,a5
    8276:	fcf42e23          	sw	a5,-36(s0)
    int earliest_impactful_thread_ID = current_thread_ID;    
    827a:	f8442783          	lw	a5,-124(s0)
    827e:	fcf42c23          	sw	a5,-40(s0)
    
    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    8282:	f9843783          	ld	a5,-104(s0)
    8286:	639c                	ld	a5,0(a5)
    8288:	fcf43823          	sd	a5,-48(s0)
    828c:	fd043783          	ld	a5,-48(s0)
    8290:	17e1                	addi	a5,a5,-8
    8292:	fef43423          	sd	a5,-24(s0)
    8296:	a0f9                	j	8364 <find_earliest_impactful_release_time_dm+0x116>
        if (entry->release_time > current_time && entry->thrd->period < current_period) {
    8298:	fe843783          	ld	a5,-24(s0)
    829c:	4f98                	lw	a4,24(a5)
    829e:	f8c42783          	lw	a5,-116(s0)
    82a2:	2781                	sext.w	a5,a5
    82a4:	04e7d463          	bge	a5,a4,82ec <find_earliest_impactful_release_time_dm+0x9e>
    82a8:	fe843783          	ld	a5,-24(s0)
    82ac:	639c                	ld	a5,0(a5)
    82ae:	4bb8                	lw	a4,80(a5)
    82b0:	f8842783          	lw	a5,-120(s0)
    82b4:	2781                	sext.w	a5,a5
    82b6:	02f75b63          	bge	a4,a5,82ec <find_earliest_impactful_release_time_dm+0x9e>
            if (entry->release_time < earliest_impactful_event) {
    82ba:	fe843783          	ld	a5,-24(s0)
    82be:	4f98                	lw	a4,24(a5)
    82c0:	fdc42783          	lw	a5,-36(s0)
    82c4:	2781                	sext.w	a5,a5
    82c6:	08f75563          	bge	a4,a5,8350 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    82ca:	fe843783          	ld	a5,-24(s0)
    82ce:	4f9c                	lw	a5,24(a5)
    82d0:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    82d4:	fe843783          	ld	a5,-24(s0)
    82d8:	639c                	ld	a5,0(a5)
    82da:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    82de:	fe843783          	ld	a5,-24(s0)
    82e2:	639c                	ld	a5,0(a5)
    82e4:	5fdc                	lw	a5,60(a5)
    82e6:	fcf42c23          	sw	a5,-40(s0)
            if (entry->release_time < earliest_impactful_event) {
    82ea:	a09d                	j	8350 <find_earliest_impactful_release_time_dm+0x102>
            }
        } 
        else if (entry->release_time > current_time && entry->thrd->period == current_period) {
    82ec:	fe843783          	ld	a5,-24(s0)
    82f0:	4f98                	lw	a4,24(a5)
    82f2:	f8c42783          	lw	a5,-116(s0)
    82f6:	2781                	sext.w	a5,a5
    82f8:	04e7dc63          	bge	a5,a4,8350 <find_earliest_impactful_release_time_dm+0x102>
    82fc:	fe843783          	ld	a5,-24(s0)
    8300:	639c                	ld	a5,0(a5)
    8302:	4bb8                	lw	a4,80(a5)
    8304:	f8842783          	lw	a5,-120(s0)
    8308:	2781                	sext.w	a5,a5
    830a:	04e79363          	bne	a5,a4,8350 <find_earliest_impactful_release_time_dm+0x102>
    ...
    830e:	fe843783          	ld	a5,-24(s0)
    8312:	4f98                	lw	a4,24(a5)
    8314:	fdc42783          	lw	a5,-36(s0)
    8318:	2781                	sext.w	a5,a5
    831a:	02e7cb63          	blt	a5,a4,8350 <find_earliest_impactful_release_time_dm+0x102>
    831e:	fe843783          	ld	a5,-24(s0)
    8322:	639c                	ld	a5,0(a5)
    8324:	5fd8                	lw	a4,60(a5)
    8326:	fd842783          	lw	a5,-40(s0)
    832a:	2781                	sext.w	a5,a5
    832c:	02f75263          	bge	a4,a5,8350 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    8330:	fe843783          	ld	a5,-24(s0)
    8334:	4f9c                	lw	a5,24(a5)
    8336:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    833a:	fe843783          	ld	a5,-24(s0)
    833e:	639c                	ld	a5,0(a5)
    8340:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    8344:	fe843783          	ld	a5,-24(s0)
    8348:	639c                	ld	a5,0(a5)
    834a:	5fdc                	lw	a5,60(a5)
    834c:	fcf42c23          	sw	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    8350:	fe843783          	ld	a5,-24(s0)
    8354:	679c                	ld	a5,8(a5)
    8356:	fcf43423          	sd	a5,-56(s0)
    835a:	fc843783          	ld	a5,-56(s0)
    835e:	17e1                	addi	a5,a5,-8
    8360:	fef43423          	sd	a5,-24(s0)
    8364:	fe843783          	ld	a5,-24(s0)
    8368:	07a1                	addi	a5,a5,8
    836a:	f9843703          	ld	a4,-104(s0)
    836e:	f2f715e3          	bne	a4,a5,8298 <find_earliest_impactful_release_time_dm+0x4a>
            }
        }
    }
    ...
    8372:	fdc42783          	lw	a5,-36(s0)
    8376:	0007871b          	sext.w	a4,a5
    837a:	800007b7          	lui	a5,0x80000
    837e:	fff7c793          	not	a5,a5
    8382:	00f70563          	beq	a4,a5,838c <find_earliest_impactful_release_time_dm+0x13e>
    8386:	fdc42783          	lw	a5,-36(s0)
    838a:	a011                	j	838e <find_earliest_impactful_release_time_dm+0x140>
    838c:	57fd                	li	a5,-1
    838e:	fcf42e23          	sw	a5,-36(s0)
    return (ImpactfulEvent) {earliest_impactful_event, t};
    8392:	fdc42783          	lw	a5,-36(s0)
    8396:	faf42c23          	sw	a5,-72(s0)
    839a:	fe043783          	ld	a5,-32(s0)
    839e:	fcf43023          	sd	a5,-64(s0)
    83a2:	4701                	li	a4,0
    83a4:	fb843703          	ld	a4,-72(s0)
    83a8:	4781                	li	a5,0
    83aa:	fc043783          	ld	a5,-64(s0)
    83ae:	883a                	mv	a6,a4
    83b0:	88be                	mv	a7,a5
    83b2:	8742                	mv	a4,a6
    83b4:	87c6                	mv	a5,a7
    ...
    83b6:	853a                	mv	a0,a4
    83b8:	85be                	mv	a1,a5
    83ba:	7466                	ld	s0,120(sp)
    83bc:	6109                	addi	sp,sp,128
    83be:	8082                	ret

00000000000083c0 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    83c0:	7135                	addi	sp,sp,-160
    83c2:	ed06                	sd	ra,152(sp)
    83c4:	e922                	sd	s0,144(sp)
    83c6:	e526                	sd	s1,136(sp)
    83c8:	e14a                	sd	s2,128(sp)
    83ca:	fcce                	sd	s3,120(sp)
    83cc:	1100                	addi	s0,sp,160
    83ce:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    83d0:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    83d4:	800007b7          	lui	a5,0x80000
    83d8:	fff7c793          	not	a5,a5
    83dc:	faf42e23          	sw	a5,-68(s0)
    int earliest_impactful_deadline; 
    
    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    83e0:	649c                	ld	a5,8(s1)
    83e2:	639c                	ld	a5,0(a5)
    83e4:	faf43823          	sd	a5,-80(s0)
    83e8:	fb043783          	ld	a5,-80(s0)
    83ec:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__BSS_END__+0xffffffff7ffeea40>
    83f0:	fcf43023          	sd	a5,-64(s0)
    83f4:	a8bd                	j	8472 <schedule_dm+0xb2>
        if (t->is_real_time && t->period < earliest_deadline) {
    83f6:	fc043783          	ld	a5,-64(s0)
    83fa:	43bc                	lw	a5,64(a5)
    83fc:	c39d                	beqz	a5,8422 <schedule_dm+0x62>
    83fe:	fc043783          	ld	a5,-64(s0)
    8402:	4bb8                	lw	a4,80(a5)
    8404:	fbc42783          	lw	a5,-68(s0)
    8408:	2781                	sext.w	a5,a5
    840a:	00f75c63          	bge	a4,a5,8422 <schedule_dm+0x62>
            earliest_deadline_thread = t;
    840e:	fc043783          	ld	a5,-64(s0)
    8412:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    8416:	fc043783          	ld	a5,-64(s0)
    841a:	4bbc                	lw	a5,80(a5)
    841c:	faf42e23          	sw	a5,-68(s0)
    8420:	a835                	j	845c <schedule_dm+0x9c>
        } else if (t->is_real_time && t->period == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    8422:	fc043783          	ld	a5,-64(s0)
    8426:	43bc                	lw	a5,64(a5)
    8428:	cb95                	beqz	a5,845c <schedule_dm+0x9c>
    842a:	fc043783          	ld	a5,-64(s0)
    842e:	4bb8                	lw	a4,80(a5)
    8430:	fbc42783          	lw	a5,-68(s0)
    8434:	2781                	sext.w	a5,a5
    8436:	02e79363          	bne	a5,a4,845c <schedule_dm+0x9c>
    843a:	fc043783          	ld	a5,-64(s0)
    843e:	5fd8                	lw	a4,60(a5)
    8440:	fc843783          	ld	a5,-56(s0)
    8444:	5fdc                	lw	a5,60(a5)
    8446:	00f75b63          	bge	a4,a5,845c <schedule_dm+0x9c>
            earliest_deadline_thread = t;
    844a:	fc043783          	ld	a5,-64(s0)
    844e:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    8452:	fc043783          	ld	a5,-64(s0)
    8456:	4bbc                	lw	a5,80(a5)
    8458:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    845c:	fc043783          	ld	a5,-64(s0)
    8460:	779c                	ld	a5,40(a5)
    8462:	f8f43c23          	sd	a5,-104(s0)
    8466:	f9843783          	ld	a5,-104(s0)
    846a:	fd878793          	addi	a5,a5,-40
    846e:	fcf43023          	sd	a5,-64(s0)
    8472:	fc043783          	ld	a5,-64(s0)
    8476:	02878713          	addi	a4,a5,40
    847a:	649c                	ld	a5,8(s1)
    847c:	f6f71de3          	bne	a4,a5,83f6 <schedule_dm+0x36>
        }
    }
    ...
    8480:	6888                	ld	a0,16(s1)
    8482:	648c                	ld	a1,8(s1)
    8484:	4090                	lw	a2,0(s1)
    8486:	fc843783          	ld	a5,-56(s0)
    848a:	c789                	beqz	a5,8494 <schedule_dm+0xd4>
    848c:	fc843783          	ld	a5,-56(s0)
    8490:	4bbc                	lw	a5,80(a5)
    8492:	a029                	j	849c <schedule_dm+0xdc>
    8494:	800007b7          	lui	a5,0x80000
    8498:	fff7c793          	not	a5,a5
    849c:	fc843703          	ld	a4,-56(s0)
    84a0:	5f58                	lw	a4,60(a4)
    84a2:	86be                	mv	a3,a5
    84a4:	00000097          	auipc	ra,0x0
    84a8:	daa080e7          	jalr	-598(ra) # 824e <find_earliest_impactful_release_time_dm>
    84ac:	872a                	mv	a4,a0
    84ae:	87ae                	mv	a5,a1
    84b0:	f6e43423          	sd	a4,-152(s0)
    84b4:	f6f43823          	sd	a5,-144(s0)
    earliest_impactful_deadline = earliest_impactful_event.earliest_impactful_event;
    84b8:	f6842783          	lw	a5,-152(s0)
    84bc:	faf42623          	sw	a5,-84(s0)
    //printf("earliest_impactful_deadline: %d\n", earliest_impactful_deadline);
    if (earliest_deadline_thread) {
    84c0:	fc843783          	ld	a5,-56(s0)
    84c4:	cfd9                	beqz	a5,8562 <schedule_dm+0x1a2>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    84c6:	fc843783          	ld	a5,-56(s0)
    84ca:	4ff8                	lw	a4,92(a5)
    84cc:	409c                	lw	a5,0(s1)
    84ce:	40f707bb          	subw	a5,a4,a5
    84d2:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline <= 0) {
    84d6:	fa842783          	lw	a5,-88(s0)
    84da:	2781                	sext.w	a5,a5
    84dc:	00f04b63          	bgtz	a5,84f2 <schedule_dm+0x132>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    84e0:	fc843783          	ld	a5,-56(s0)
    84e4:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__BSS_END__+0xffffffff7ffeea90>
    84e8:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    84ec:	f8042023          	sw	zero,-128(s0)
    84f0:	a079                	j	857e <schedule_dm+0x1be>
        } else {
    ...
    84f2:	fc843783          	ld	a5,-56(s0)
    84f6:	4fbc                	lw	a5,88(a5)
    84f8:	fa842703          	lw	a4,-88(s0)
    84fc:	85ba                	mv	a1,a4
    84fe:	853e                	mv	a0,a5
    8500:	00000097          	auipc	ra,0x0
    8504:	9c8080e7          	jalr	-1592(ra) # 7ec8 <min>
    8508:	87aa                	mv	a5,a0
    850a:	faf42223          	sw	a5,-92(s0)
            int allocated_time;
            if (earliest_impactful_deadline != -1 && (earliest_impactful_deadline - args.current_time) < remaining_time){
    850e:	fac42783          	lw	a5,-84(s0)
    8512:	0007871b          	sext.w	a4,a5
    8516:	57fd                	li	a5,-1
    8518:	02f70663          	beq	a4,a5,8544 <schedule_dm+0x184>
    851c:	409c                	lw	a5,0(s1)
    851e:	fac42703          	lw	a4,-84(s0)
    8522:	40f707bb          	subw	a5,a4,a5
    8526:	0007871b          	sext.w	a4,a5
    852a:	fa442783          	lw	a5,-92(s0)
    852e:	2781                	sext.w	a5,a5
    8530:	00f75a63          	bge	a4,a5,8544 <schedule_dm+0x184>
                allocated_time = earliest_impactful_deadline - args.current_time;
    8534:	409c                	lw	a5,0(s1)
    8536:	fac42703          	lw	a4,-84(s0)
    853a:	40f707bb          	subw	a5,a4,a5
    853e:	faf42c23          	sw	a5,-72(s0)
    8542:	a029                	j	854c <schedule_dm+0x18c>
            } else {
                allocated_time = remaining_time;
    8544:	fa442783          	lw	a5,-92(s0)
    8548:	faf42c23          	sw	a5,-72(s0)
            }
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    854c:	fc843783          	ld	a5,-56(s0)
    8550:	02878793          	addi	a5,a5,40
    8554:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    8558:	fb842783          	lw	a5,-72(s0)
    855c:	f8f42023          	sw	a5,-128(s0)
    8560:	a839                	j	857e <schedule_dm+0x1be>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    8562:	649c                	ld	a5,8(s1)
    8564:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    8568:	689c                	ld	a5,16(s1)
    856a:	4098                	lw	a4,0(s1)
    856c:	85ba                	mv	a1,a4
    856e:	853e                	mv	a0,a5
    8570:	fffff097          	auipc	ra,0xfffff
    8574:	4ba080e7          	jalr	1210(ra) # 7a2a <find_next_release_time>
    8578:	87aa                	mv	a5,a0
    857a:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    857e:	f7843783          	ld	a5,-136(s0)
    8582:	f8f43423          	sd	a5,-120(s0)
    8586:	f8043783          	ld	a5,-128(s0)
    858a:	f8f43823          	sd	a5,-112(s0)
    858e:	4701                	li	a4,0
    8590:	f8843703          	ld	a4,-120(s0)
    8594:	4781                	li	a5,0
    8596:	f9043783          	ld	a5,-112(s0)
    859a:	893a                	mv	s2,a4
    859c:	89be                	mv	s3,a5
    859e:	874a                	mv	a4,s2
    85a0:	87ce                	mv	a5,s3
    ...
    85a2:	853a                	mv	a0,a4
    85a4:	85be                	mv	a1,a5
    85a6:	60ea                	ld	ra,152(sp)
    85a8:	644a                	ld	s0,144(sp)
    85aa:	64aa                	ld	s1,136(sp)
    85ac:	690a                	ld	s2,128(sp)
    85ae:	79e6                	ld	s3,120(sp)
    85b0:	610d                	addi	sp,sp,160
    85b2:	8082                	ret

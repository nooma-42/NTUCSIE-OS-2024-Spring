...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    fprintf(2, "Usage: mkdir files...\n");
      ...
      24:	9c058593          	addi	a1,a1,-1600 # 19e0 <schedule_dm+0x1d8>
      28:	4509                	li	a0,2
  ...
  for(i = 1; i < argc; i++){
    ...
    if(mkdir(argv[i]) < 0){
      ...
      76:	98658593          	addi	a1,a1,-1658 # 19f8 <schedule_dm+0x1f0>
      7a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6a2:	38268693          	addi	a3,a3,898 # 1a20 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     77c:	2a870713          	addi	a4,a4,680 # 1a20 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     93c:	0e078793          	addi	a5,a5,224 # 1a18 <schedule_dm+0x210>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     ae8:	f6478793          	addi	a5,a5,-156 # 1a48 <freep>
     aec:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     be0:	e6c78793          	addi	a5,a5,-404 # 1a48 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c62:	dea78793          	addi	a5,a5,-534 # 1a48 <freep>
     c66:	639c                	ld	a5,0(a5)
}
     c68:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c94:	db878793          	addi	a5,a5,-584 # 1a48 <freep>
     c98:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     ca8:	d9478793          	addi	a5,a5,-620 # 1a38 <base>
     cac:	fef43023          	sd	a5,-32(s0)
     cb0:	00001797          	auipc	a5,0x1
     cb4:	d9878793          	addi	a5,a5,-616 # 1a48 <freep>
     cb8:	fe043703          	ld	a4,-32(s0)
     cbc:	e398                	sd	a4,0(a5)
     cbe:	00001797          	auipc	a5,0x1
     cc2:	d8a78793          	addi	a5,a5,-630 # 1a48 <freep>
     cc6:	6398                	ld	a4,0(a5)
     cc8:	00001797          	auipc	a5,0x1
     ccc:	d7078793          	addi	a5,a5,-656 # 1a38 <base>
     cd0:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     cd2:	00001797          	auipc	a5,0x1
     cd6:	d6678793          	addi	a5,a5,-666 # 1a38 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d52:	cfa78793          	addi	a5,a5,-774 # 1a48 <freep>
    ...
    if(p == freep)
     ...
     d68:	ce478793          	addi	a5,a5,-796 # 1a48 <freep>
     d6c:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     fb6:	a9e78793          	addi	a5,a5,-1378 # 1a50 <last_thread.1239>
     fba:	639c                	ld	a5,0(a5)
     fbc:	cb89                	beqz	a5,fce <schedule_wrr+0x34>
     fbe:	00001797          	auipc	a5,0x1
     fc2:	a9278793          	addi	a5,a5,-1390 # 1a50 <last_thread.1239>
     fc6:	639c                	ld	a5,0(a5)
     fc8:	4fbc                	lw	a5,88(a5)
     fca:	00f04863          	bgtz	a5,fda <schedule_wrr+0x40>
        last_thread = NULL;
     fce:	00001797          	auipc	a5,0x1
     fd2:	a8278793          	addi	a5,a5,-1406 # 1a50 <last_thread.1239>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     ff4:	a6078793          	addi	a5,a5,-1440 # 1a50 <last_thread.1239>
     ff8:	639c                	ld	a5,0(a5)
    ...
    1050:	a0478793          	addi	a5,a5,-1532 # 1a50 <last_thread.1239>
    1054:	639c                	ld	a5,0(a5)
    1056:	c385                	beqz	a5,1076 <schedule_wrr+0xdc>
    1058:	00001797          	auipc	a5,0x1
    105c:	9f878793          	addi	a5,a5,-1544 # 1a50 <last_thread.1239>
    ...
    106c:	9e878793          	addi	a5,a5,-1560 # 1a50 <last_thread.1239>
    ...
    10bc:	99878793          	addi	a5,a5,-1640 # 1a50 <last_thread.1239>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    1154:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffddb8>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    1286:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffddb8>
...
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    13bc:	7131                	addi	sp,sp,-192
    13be:	fd06                	sd	ra,184(sp)
    13c0:	f922                	sd	s0,176(sp)
    13c2:	f526                	sd	s1,168(sp)
    13c4:	f14a                	sd	s2,160(sp)
    13c6:	ed4e                	sd	s3,152(sp)
    13c8:	0180                	addi	s0,sp,192
    13ca:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    ...
    13e8:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffddb8>
    ...
    145c:	f7442783          	lw	a5,-140(s0)
    1460:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1464:	fb843783          	ld	a5,-72(s0)
    1468:	779c                	ld	a5,40(a5)
    146a:	f6f43423          	sd	a5,-152(s0)
    146e:	f6843783          	ld	a5,-152(s0)
    1472:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffddb8>
    ...
    14d6:	4fbc                	lw	a5,88(a5)
    14d8:	40f707bb          	subw	a5,a4,a5
    14dc:	f8f42223          	sw	a5,-124(s0)
    ...
    1564:	f6f43c23          	sd	a5,-136(s0)
    1568:	f7843783          	ld	a5,-136(s0)
    156c:	17e1                	addi	a5,a5,-8
    156e:	faf43423          	sd	a5,-88(s0)
    1572:	fa843783          	ld	a5,-88(s0)
    1576:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffdde8>
    ...
    1584:	c7b5                	beqz	a5,15f0 <schedule_lst+0x234>
    ...
    15b6:	800007b7          	lui	a5,0x80000
    15ba:	fff7c793          	not	a5,a5
    15be:	00f71663          	bne	a4,a5,15ca <schedule_lst+0x20e>
    15c2:	fc843783          	ld	a5,-56(s0)
    15c6:	4fbc                	lw	a5,88(a5)
    15c8:	a039                	j	15d6 <schedule_lst+0x21a>
    15ca:	409c                	lw	a5,0(s1)
    15cc:	fb442703          	lw	a4,-76(s0)
    15d0:	40f707bb          	subw	a5,a4,a5
    15d4:	2781                	sext.w	a5,a5
    15d6:	f8f42a23          	sw	a5,-108(s0)
            r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    15da:	fc843783          	ld	a5,-56(s0)
    15de:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffde08>
    15e2:	f4f43423          	sd	a5,-184(s0)
            r.allocated_time = allocated_time;
    15e6:	f9442783          	lw	a5,-108(s0)
    15ea:	f4f42823          	sw	a5,-176(s0)
    15ee:	a081                	j	162e <schedule_lst+0x272>
        }
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    15f0:	649c                	ld	a5,8(s1)
    15f2:	f4f43423          	sd	a5,-184(s0)
    ...
    1606:	00f70963          	beq	a4,a5,1618 <schedule_lst+0x25c>
    160a:	409c                	lw	a5,0(s1)
    160c:	fb442703          	lw	a4,-76(s0)
    1610:	40f707bb          	subw	a5,a4,a5
    1614:	2781                	sext.w	a5,a5
    1616:	a811                	j	162a <schedule_lst+0x26e>
    1618:	689c                	ld	a5,16(s1)
    161a:	4098                	lw	a4,0(s1)
    161c:	85ba                	mv	a1,a4
    161e:	853e                	mv	a0,a5
    1620:	00000097          	auipc	ra,0x0
    1624:	8ca080e7          	jalr	-1846(ra) # eea <find_next_release_time>
    1628:	87aa                	mv	a5,a0
    162a:	f4f42823          	sw	a5,-176(s0)
    }

    return r;
    162e:	f4843783          	ld	a5,-184(s0)
    1632:	f4f43c23          	sd	a5,-168(s0)
    1636:	f5043783          	ld	a5,-176(s0)
    163a:	f6f43023          	sd	a5,-160(s0)
    163e:	4701                	li	a4,0
    1640:	f5843703          	ld	a4,-168(s0)
    1644:	4781                	li	a5,0
    1646:	f6043783          	ld	a5,-160(s0)
    164a:	893a                	mv	s2,a4
    164c:	89be                	mv	s3,a5
    164e:	874a                	mv	a4,s2
    1650:	87ce                	mv	a5,s3
    ...
    1652:	853a                	mv	a0,a4
    1654:	85be                	mv	a1,a5
    1656:	70ea                	ld	ra,184(sp)
    1658:	744a                	ld	s0,176(sp)
    165a:	74aa                	ld	s1,168(sp)
    165c:	790a                	ld	s2,160(sp)
    165e:	69ea                	ld	s3,152(sp)
    1660:	6129                	addi	sp,sp,192
    1662:	8082                	ret
...
ImpactfulEvent find_earliest_impactful_release_time_dm(struct list_head *release_queue, struct list_head*run_queue, int current_time, int current_period) {
    ...
    1672:	87b2                	mv	a5,a2
    1674:	8736                	mv	a4,a3
    1676:	f8f42623          	sw	a5,-116(s0)
    167a:	87ba                	mv	a5,a4
    167c:	f8f42423          	sw	a5,-120(s0)
    struct release_queue_entry *entry;
    struct thread *t;
    int earliest_impactful_event = INT_MAX;
    1680:	800007b7          	lui	a5,0x80000
    1684:	fff7c793          	not	a5,a5
    1688:	fcf42e23          	sw	a5,-36(s0)
    ...
    16ac:	a201                	j	17ac <find_earliest_impactful_release_time_dm+0x148>
    ...
    16dc:	0af75e63          	bge	a4,a5,1798 <find_earliest_impactful_release_time_dm+0x134>
    ...
    16fc:	fcf42c23          	sw	a5,-40(s0)
            if (entry->release_time < earliest_impactful_event) {
    1700:	a861                	j	1798 <find_earliest_impactful_release_time_dm+0x134>
            }
        } 
    ...
    170e:	08e7d563          	bge	a5,a4,1798 <find_earliest_impactful_release_time_dm+0x134>
    1712:	fe843783          	ld	a5,-24(s0)
    1716:	639c                	ld	a5,0(a5)
    1718:	4bb8                	lw	a4,80(a5)
    171a:	f8842783          	lw	a5,-120(s0)
    171e:	2781                	sext.w	a5,a5
    1720:	06e79c63          	bne	a5,a4,1798 <find_earliest_impactful_release_time_dm+0x134>
    ...
    1730:	02f75363          	bge	a4,a5,1756 <find_earliest_impactful_release_time_dm+0xf2>
                earliest_impactful_event = entry->release_time;
    1734:	fe843783          	ld	a5,-24(s0)
    1738:	4f9c                	lw	a5,24(a5)
    173a:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    173e:	fe843783          	ld	a5,-24(s0)
    1742:	639c                	ld	a5,0(a5)
    1744:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    1748:	fe843783          	ld	a5,-24(s0)
    174c:	639c                	ld	a5,0(a5)
    174e:	5fdc                	lw	a5,60(a5)
    1750:	fcf42c23          	sw	a5,-40(s0)
    1754:	a091                	j	1798 <find_earliest_impactful_release_time_dm+0x134>
            } else if (entry->release_time == earliest_impactful_event && entry->thrd->ID < earliest_impactful_thread_ID) {
    1756:	fe843783          	ld	a5,-24(s0)
    175a:	4f98                	lw	a4,24(a5)
    175c:	fdc42783          	lw	a5,-36(s0)
    1760:	2781                	sext.w	a5,a5
    1762:	02e79b63          	bne	a5,a4,1798 <find_earliest_impactful_release_time_dm+0x134>
    1766:	fe843783          	ld	a5,-24(s0)
    176a:	639c                	ld	a5,0(a5)
    176c:	5fd8                	lw	a4,60(a5)
    176e:	fd842783          	lw	a5,-40(s0)
    1772:	2781                	sext.w	a5,a5
    1774:	02f75263          	bge	a4,a5,1798 <find_earliest_impactful_release_time_dm+0x134>
                earliest_impactful_event = entry->release_time;
    1778:	fe843783          	ld	a5,-24(s0)
    177c:	4f9c                	lw	a5,24(a5)
    177e:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    1782:	fe843783          	ld	a5,-24(s0)
    1786:	639c                	ld	a5,0(a5)
    1788:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    178c:	fe843783          	ld	a5,-24(s0)
    1790:	639c                	ld	a5,0(a5)
    1792:	5fdc                	lw	a5,60(a5)
    1794:	fcf42c23          	sw	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    1798:	fe843783          	ld	a5,-24(s0)
    179c:	679c                	ld	a5,8(a5)
    179e:	fcf43423          	sd	a5,-56(s0)
    17a2:	fc843783          	ld	a5,-56(s0)
    17a6:	17e1                	addi	a5,a5,-8
    17a8:	fef43423          	sd	a5,-24(s0)
    17ac:	fe843783          	ld	a5,-24(s0)
    17b0:	07a1                	addi	a5,a5,8
    17b2:	f9843703          	ld	a4,-104(s0)
    17b6:	eef71ce3          	bne	a4,a5,16ae <find_earliest_impactful_release_time_dm+0x4a>
            }
        }
    }
    ...
    17ba:	fdc42783          	lw	a5,-36(s0)
    17be:	0007871b          	sext.w	a4,a5
    17c2:	800007b7          	lui	a5,0x80000
    17c6:	fff7c793          	not	a5,a5
    17ca:	00f70563          	beq	a4,a5,17d4 <find_earliest_impactful_release_time_dm+0x170>
    17ce:	fdc42783          	lw	a5,-36(s0)
    17d2:	a011                	j	17d6 <find_earliest_impactful_release_time_dm+0x172>
    17d4:	57fd                	li	a5,-1
    17d6:	fcf42e23          	sw	a5,-36(s0)
    return (ImpactfulEvent) {earliest_impactful_event, t};
    17da:	fdc42783          	lw	a5,-36(s0)
    17de:	faf42c23          	sw	a5,-72(s0)
    17e2:	fe043783          	ld	a5,-32(s0)
    17e6:	fcf43023          	sd	a5,-64(s0)
    17ea:	4701                	li	a4,0
    17ec:	fb843703          	ld	a4,-72(s0)
    17f0:	4781                	li	a5,0
    ...
    17fe:	853a                	mv	a0,a4
    1800:	85be                	mv	a1,a5
    1802:	7466                	ld	s0,120(sp)
    1804:	6109                	addi	sp,sp,128
    1806:	8082                	ret

0000000000001808 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    1808:	7175                	addi	sp,sp,-144
    180a:	e506                	sd	ra,136(sp)
    180c:	e122                	sd	s0,128(sp)
    180e:	fca6                	sd	s1,120(sp)
    1810:	f8ca                	sd	s2,112(sp)
    1812:	f4ce                	sd	s3,104(sp)
    1814:	0900                	addi	s0,sp,144
    1816:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    1818:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    181c:	800007b7          	lui	a5,0x80000
    1820:	fff7c793          	not	a5,a5
    1824:	faf42e23          	sw	a5,-68(s0)
    int earliest_impactful_deadline; 
    
    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    1828:	649c                	ld	a5,8(s1)
    182a:	639c                	ld	a5,0(a5)
    182c:	faf43823          	sd	a5,-80(s0)
    1830:	fb043783          	ld	a5,-80(s0)
    1834:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffddb8>
    1838:	fcf43023          	sd	a5,-64(s0)
    183c:	a8bd                	j	18ba <schedule_dm+0xb2>
        if (t->is_real_time && t->period < earliest_deadline) {
    183e:	fc043783          	ld	a5,-64(s0)
    1842:	43bc                	lw	a5,64(a5)
    1844:	c39d                	beqz	a5,186a <schedule_dm+0x62>
    1846:	fc043783          	ld	a5,-64(s0)
    184a:	4bb8                	lw	a4,80(a5)
    184c:	fbc42783          	lw	a5,-68(s0)
    1850:	2781                	sext.w	a5,a5
    1852:	00f75c63          	bge	a4,a5,186a <schedule_dm+0x62>
            earliest_deadline_thread = t;
    1856:	fc043783          	ld	a5,-64(s0)
    185a:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    185e:	fc043783          	ld	a5,-64(s0)
    1862:	4bbc                	lw	a5,80(a5)
    1864:	faf42e23          	sw	a5,-68(s0)
    1868:	a835                	j	18a4 <schedule_dm+0x9c>
        } else if (t->is_real_time && t->period == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    186a:	fc043783          	ld	a5,-64(s0)
    186e:	43bc                	lw	a5,64(a5)
    1870:	cb95                	beqz	a5,18a4 <schedule_dm+0x9c>
    1872:	fc043783          	ld	a5,-64(s0)
    1876:	4bb8                	lw	a4,80(a5)
    1878:	fbc42783          	lw	a5,-68(s0)
    187c:	2781                	sext.w	a5,a5
    187e:	02e79363          	bne	a5,a4,18a4 <schedule_dm+0x9c>
    1882:	fc043783          	ld	a5,-64(s0)
    1886:	5fd8                	lw	a4,60(a5)
    1888:	fc843783          	ld	a5,-56(s0)
    188c:	5fdc                	lw	a5,60(a5)
    188e:	00f75b63          	bge	a4,a5,18a4 <schedule_dm+0x9c>
            earliest_deadline_thread = t;
    1892:	fc043783          	ld	a5,-64(s0)
    1896:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    189a:	fc043783          	ld	a5,-64(s0)
    189e:	4bbc                	lw	a5,80(a5)
    18a0:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    18a4:	fc043783          	ld	a5,-64(s0)
    18a8:	779c                	ld	a5,40(a5)
    18aa:	faf43023          	sd	a5,-96(s0)
    18ae:	fa043783          	ld	a5,-96(s0)
    18b2:	fd878793          	addi	a5,a5,-40
    18b6:	fcf43023          	sd	a5,-64(s0)
    18ba:	fc043783          	ld	a5,-64(s0)
    18be:	02878713          	addi	a4,a5,40
    18c2:	649c                	ld	a5,8(s1)
    18c4:	f6f71de3          	bne	a4,a5,183e <schedule_dm+0x36>
        }
    }
    ...
    18c8:	6898                	ld	a4,16(s1)
    18ca:	648c                	ld	a1,8(s1)
    18cc:	4090                	lw	a2,0(s1)
    18ce:	fc843783          	ld	a5,-56(s0)
    18d2:	c789                	beqz	a5,18dc <schedule_dm+0xd4>
    18d4:	fc843783          	ld	a5,-56(s0)
    18d8:	4bbc                	lw	a5,80(a5)
    18da:	a029                	j	18e4 <schedule_dm+0xdc>
    18dc:	800007b7          	lui	a5,0x80000
    18e0:	fff7c793          	not	a5,a5
    18e4:	86be                	mv	a3,a5
    18e6:	853a                	mv	a0,a4
    18e8:	00000097          	auipc	ra,0x0
    18ec:	d7c080e7          	jalr	-644(ra) # 1664 <find_earliest_impactful_release_time_dm>
    18f0:	872a                	mv	a4,a0
    18f2:	87ae                	mv	a5,a1
    18f4:	f6e43823          	sd	a4,-144(s0)
    18f8:	f6f43c23          	sd	a5,-136(s0)
    earliest_impactful_deadline = earliest_impactful_event.earliest_impactful_event;
    18fc:	f7042783          	lw	a5,-144(s0)
    1900:	faf42623          	sw	a5,-84(s0)

    if (earliest_deadline_thread) {
    1904:	fc843783          	ld	a5,-56(s0)
    1908:	c3d1                	beqz	a5,198c <schedule_dm+0x184>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    190a:	fc843783          	ld	a5,-56(s0)
    190e:	4ff8                	lw	a4,92(a5)
    1910:	409c                	lw	a5,0(s1)
    1912:	40f707bb          	subw	a5,a4,a5
    1916:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline <= 0) {
    191a:	fa842783          	lw	a5,-88(s0)
    191e:	2781                	sext.w	a5,a5
    1920:	00f04b63          	bgtz	a5,1936 <schedule_dm+0x12e>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1924:	fc843783          	ld	a5,-56(s0)
    1928:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffde08>
    192c:	f8f43023          	sd	a5,-128(s0)
            r.allocated_time = 0;
    1930:	f8042423          	sw	zero,-120(s0)
    1934:	a895                	j	19a8 <schedule_dm+0x1a0>
        } else {
    ...
    1936:	fac42783          	lw	a5,-84(s0)
    193a:	0007871b          	sext.w	a4,a5
    193e:	57fd                	li	a5,-1
    1940:	02f70663          	beq	a4,a5,196c <schedule_dm+0x164>
    1944:	409c                	lw	a5,0(s1)
    1946:	fac42703          	lw	a4,-84(s0)
    194a:	40f707bb          	subw	a5,a4,a5
    194e:	0007871b          	sext.w	a4,a5
    1952:	fc843783          	ld	a5,-56(s0)
    1956:	4fbc                	lw	a5,88(a5)
    1958:	00f75a63          	bge	a4,a5,196c <schedule_dm+0x164>
                allocated_time = earliest_impactful_deadline - args.current_time;
    195c:	409c                	lw	a5,0(s1)
    195e:	fac42703          	lw	a4,-84(s0)
    1962:	40f707bb          	subw	a5,a4,a5
    1966:	faf42c23          	sw	a5,-72(s0)
    196a:	a031                	j	1976 <schedule_dm+0x16e>
            } else {
                allocated_time = earliest_deadline_thread->remaining_time;
    196c:	fc843783          	ld	a5,-56(s0)
    1970:	4fbc                	lw	a5,88(a5)
    1972:	faf42c23          	sw	a5,-72(s0)
            }
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1976:	fc843783          	ld	a5,-56(s0)
    197a:	02878793          	addi	a5,a5,40
    197e:	f8f43023          	sd	a5,-128(s0)
            r.allocated_time = allocated_time;
    1982:	fb842783          	lw	a5,-72(s0)
    1986:	f8f42423          	sw	a5,-120(s0)
    198a:	a839                	j	19a8 <schedule_dm+0x1a0>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    198c:	649c                	ld	a5,8(s1)
    198e:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1992:	689c                	ld	a5,16(s1)
    1994:	4098                	lw	a4,0(s1)
    1996:	85ba                	mv	a1,a4
    1998:	853e                	mv	a0,a5
    199a:	fffff097          	auipc	ra,0xfffff
    199e:	550080e7          	jalr	1360(ra) # eea <find_next_release_time>
    19a2:	87aa                	mv	a5,a0
    19a4:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    19a8:	f8043783          	ld	a5,-128(s0)
    19ac:	f8f43823          	sd	a5,-112(s0)
    19b0:	f8843783          	ld	a5,-120(s0)
    19b4:	f8f43c23          	sd	a5,-104(s0)
    19b8:	4701                	li	a4,0
    19ba:	f9043703          	ld	a4,-112(s0)
    19be:	4781                	li	a5,0
    19c0:	f9843783          	ld	a5,-104(s0)
    19c4:	893a                	mv	s2,a4
    19c6:	89be                	mv	s3,a5
    19c8:	874a                	mv	a4,s2
    19ca:	87ce                	mv	a5,s3
    ...
    19cc:	853a                	mv	a0,a4
    19ce:	85be                	mv	a1,a5
    19d0:	60aa                	ld	ra,136(sp)
    19d2:	640a                	ld	s0,128(sp)
    19d4:	74e6                	ld	s1,120(sp)
    19d6:	7946                	ld	s2,112(sp)
    19d8:	79a6                	ld	s3,104(sp)

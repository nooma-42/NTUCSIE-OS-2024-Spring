...
main(int argc, char **argv)
{
  ...
  if(argc < 2){
    ...
    fprintf(2, "usage: kill pid...\n");
      ...
      24:	a3858593          	addi	a1,a1,-1480 # 1a58 <schedule_dm+0x1f6>
      28:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     684:	3f868693          	addi	a3,a3,1016 # 1a78 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     75e:	31e70713          	addi	a4,a4,798 # 1a78 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     91e:	15678793          	addi	a5,a5,342 # 1a70 <schedule_dm+0x20e>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     aca:	fda78793          	addi	a5,a5,-38 # 1aa0 <freep>
     ace:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bc2:	ee278793          	addi	a5,a5,-286 # 1aa0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c44:	e6078793          	addi	a5,a5,-416 # 1aa0 <freep>
     c48:	639c                	ld	a5,0(a5)
}
     c4a:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c76:	e2e78793          	addi	a5,a5,-466 # 1aa0 <freep>
     c7a:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     c8a:	e0a78793          	addi	a5,a5,-502 # 1a90 <base>
     c8e:	fef43023          	sd	a5,-32(s0)
     c92:	00001797          	auipc	a5,0x1
     c96:	e0e78793          	addi	a5,a5,-498 # 1aa0 <freep>
     c9a:	fe043703          	ld	a4,-32(s0)
     c9e:	e398                	sd	a4,0(a5)
     ca0:	00001797          	auipc	a5,0x1
     ca4:	e0078793          	addi	a5,a5,-512 # 1aa0 <freep>
     ca8:	6398                	ld	a4,0(a5)
     caa:	00001797          	auipc	a5,0x1
     cae:	de678793          	addi	a5,a5,-538 # 1a90 <base>
     cb2:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     cb4:	00001797          	auipc	a5,0x1
     cb8:	ddc78793          	addi	a5,a5,-548 # 1a90 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d34:	d7078793          	addi	a5,a5,-656 # 1aa0 <freep>
    ...
    if(p == freep)
     ...
     d4a:	d5a78793          	addi	a5,a5,-678 # 1aa0 <freep>
     d4e:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     f98:	b1478793          	addi	a5,a5,-1260 # 1aa8 <last_thread.1239>
     f9c:	639c                	ld	a5,0(a5)
     f9e:	cb89                	beqz	a5,fb0 <schedule_wrr+0x34>
     fa0:	00001797          	auipc	a5,0x1
     fa4:	b0878793          	addi	a5,a5,-1272 # 1aa8 <last_thread.1239>
     fa8:	639c                	ld	a5,0(a5)
     faa:	4fbc                	lw	a5,88(a5)
     fac:	00f04863          	bgtz	a5,fbc <schedule_wrr+0x40>
        last_thread = NULL;
     fb0:	00001797          	auipc	a5,0x1
     fb4:	af878793          	addi	a5,a5,-1288 # 1aa8 <last_thread.1239>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     fd6:	ad678793          	addi	a5,a5,-1322 # 1aa8 <last_thread.1239>
     fda:	639c                	ld	a5,0(a5)
    ...
    1032:	a7a78793          	addi	a5,a5,-1414 # 1aa8 <last_thread.1239>
    1036:	639c                	ld	a5,0(a5)
    1038:	c385                	beqz	a5,1058 <schedule_wrr+0xdc>
    103a:	00001797          	auipc	a5,0x1
    103e:	a6e78793          	addi	a5,a5,-1426 # 1aa8 <last_thread.1239>
    ...
    104e:	a5e78793          	addi	a5,a5,-1442 # 1aa8 <last_thread.1239>
    ...
    109e:	a0e78793          	addi	a5,a5,-1522 # 1aa8 <last_thread.1239>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    1136:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdd60>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    1268:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdd60>
...
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    139e:	7115                	addi	sp,sp,-224
    13a0:	ed86                	sd	ra,216(sp)
    13a2:	e9a2                	sd	s0,208(sp)
    13a4:	e5a6                	sd	s1,200(sp)
    13a6:	e1ca                	sd	s2,192(sp)
    13a8:	fd4e                	sd	s3,184(sp)
    13aa:	1180                	addi	s0,sp,224
    13ac:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    ...
    13c2:	f8f43823          	sd	a5,-112(s0)
    13c6:	f9043783          	ld	a5,-112(s0)
    13ca:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdd60>
    ...
    143e:	f5442783          	lw	a5,-172(s0)
    1442:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1446:	fb843783          	ld	a5,-72(s0)
    144a:	779c                	ld	a5,40(a5)
    144c:	f4f43423          	sd	a5,-184(s0)
    1450:	f4843783          	ld	a5,-184(s0)
    1454:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdd60>
    ...
    147a:	f8f43423          	sd	a5,-120(s0)
    147e:	f8843783          	ld	a5,-120(s0)
    ...
    1546:	f4f43c23          	sd	a5,-168(s0)
    154a:	f5843783          	ld	a5,-168(s0)
    154e:	17e1                	addi	a5,a5,-8
    1550:	faf43423          	sd	a5,-88(s0)
    1554:	fa843783          	ld	a5,-88(s0)
    1558:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffdd90>
    ...
    1566:	10078b63          	beqz	a5,167c <schedule_lst+0x2de>
    ...
    158c:	f8f43023          	sd	a5,-128(s0)
    1590:	f8043783          	ld	a5,-128(s0)
    1594:	fd878793          	addi	a5,a5,-40
    1598:	faf43c23          	sd	a5,-72(s0)
    159c:	a099                	j	15e2 <schedule_lst+0x244>
                if (args.current_time >= t->current_deadline && t->remaining_time > 0 && t->ID < thread_with_smallest_id->ID) {
    159e:	4098                	lw	a4,0(s1)
    15a0:	fb843783          	ld	a5,-72(s0)
    15a4:	4ffc                	lw	a5,92(a5)
    15a6:	02f74363          	blt	a4,a5,15cc <schedule_lst+0x22e>
    15aa:	fb843783          	ld	a5,-72(s0)
    15ae:	4fbc                	lw	a5,88(a5)
    15b0:	00f05e63          	blez	a5,15cc <schedule_lst+0x22e>
    15b4:	fb843783          	ld	a5,-72(s0)
    15b8:	5fd8                	lw	a4,60(a5)
    15ba:	fa043783          	ld	a5,-96(s0)
    15be:	5fdc                	lw	a5,60(a5)
    15c0:	00f75663          	bge	a4,a5,15cc <schedule_lst+0x22e>
                    thread_with_smallest_id = t;
    15c4:	fb843783          	ld	a5,-72(s0)
    15c8:	faf43023          	sd	a5,-96(s0)
            list_for_each_entry(t, args.run_queue, thread_list) {
    15cc:	fb843783          	ld	a5,-72(s0)
    15d0:	779c                	ld	a5,40(a5)
    15d2:	f6f43c23          	sd	a5,-136(s0)
    15d6:	f7843783          	ld	a5,-136(s0)
    15da:	fd878793          	addi	a5,a5,-40
    15de:	faf43c23          	sd	a5,-72(s0)
    15e2:	fb843783          	ld	a5,-72(s0)
    15e6:	02878713          	addi	a4,a5,40
    15ea:	649c                	ld	a5,8(s1)
    15ec:	faf719e3          	bne	a4,a5,159e <schedule_lst+0x200>
                }
            }
            r.scheduled_thread_list_member = &thread_with_smallest_id->thread_list;
    15f0:	fa043783          	ld	a5,-96(s0)
    15f4:	02878793          	addi	a5,a5,40
    15f8:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = 0;
    15fc:	f2042823          	sw	zero,-208(s0)
        if (args.current_time >= min_slack_thread->current_deadline && min_slack_thread->remaining_time > 0) {
    1600:	a86d                	j	16ba <schedule_lst+0x31c>
        } else {
            // Calculate time until the thread's deadline
            int time_until_deadline = min_slack_thread->current_deadline - args.current_time;
    1602:	fc843783          	ld	a5,-56(s0)
    1606:	4ff8                	lw	a4,92(a5)
    1608:	409c                	lw	a5,0(s1)
    160a:	40f707bb          	subw	a5,a4,a5
    160e:	f6f42a23          	sw	a5,-140(s0)
            
            // Decide the allocated time based on current minimum slack or upcoming preemption needs
            int allocated_time = min(min_slack_thread->remaining_time, time_until_deadline);
    1612:	fc843783          	ld	a5,-56(s0)
    1616:	4fbc                	lw	a5,88(a5)
    1618:	f7442703          	lw	a4,-140(s0)
    161c:	85ba                	mv	a1,a4
    161e:	853e                	mv	a0,a5
    1620:	00000097          	auipc	ra,0x0
    1624:	d4a080e7          	jalr	-694(ra) # 136a <min>
    1628:	87aa                	mv	a5,a0
    162a:	f8f42e23          	sw	a5,-100(s0)
            if (next_significant_event_time != INT_MAX) {
    162e:	fb442783          	lw	a5,-76(s0)
    1632:	0007871b          	sext.w	a4,a5
    1636:	800007b7          	lui	a5,0x80000
    163a:	fff7c793          	not	a5,a5
    163e:	02f70463          	beq	a4,a5,1666 <schedule_lst+0x2c8>
                allocated_time = min(allocated_time, next_significant_event_time - args.current_time);
    1642:	409c                	lw	a5,0(s1)
    1644:	fb442703          	lw	a4,-76(s0)
    1648:	40f707bb          	subw	a5,a4,a5
    164c:	0007871b          	sext.w	a4,a5
    1650:	f9c42783          	lw	a5,-100(s0)
    1654:	85ba                	mv	a1,a4
    1656:	853e                	mv	a0,a5
    1658:	00000097          	auipc	ra,0x0
    165c:	d12080e7          	jalr	-750(ra) # 136a <min>
    1660:	87aa                	mv	a5,a0
    1662:	f8f42e23          	sw	a5,-100(s0)
            }

            r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    1666:	fc843783          	ld	a5,-56(s0)
    166a:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffddb0>
    166e:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = allocated_time;
    1672:	f9c42783          	lw	a5,-100(s0)
    1676:	f2f42823          	sw	a5,-208(s0)
    167a:	a081                	j	16ba <schedule_lst+0x31c>
        }
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    167c:	649c                	ld	a5,8(s1)
    167e:	f2f43423          	sd	a5,-216(s0)
    ...
    1692:	00f70963          	beq	a4,a5,16a4 <schedule_lst+0x306>
    1696:	409c                	lw	a5,0(s1)
    1698:	fb442703          	lw	a4,-76(s0)
    169c:	40f707bb          	subw	a5,a4,a5
    16a0:	2781                	sext.w	a5,a5
    16a2:	a811                	j	16b6 <schedule_lst+0x318>
    16a4:	689c                	ld	a5,16(s1)
    16a6:	4098                	lw	a4,0(s1)
    16a8:	85ba                	mv	a1,a4
    16aa:	853e                	mv	a0,a5
    16ac:	00000097          	auipc	ra,0x0
    16b0:	820080e7          	jalr	-2016(ra) # ecc <find_next_release_time>
    16b4:	87aa                	mv	a5,a0
    16b6:	f2f42823          	sw	a5,-208(s0)
    }

    return r;
    16ba:	f2843783          	ld	a5,-216(s0)
    16be:	f2f43c23          	sd	a5,-200(s0)
    16c2:	f3043783          	ld	a5,-208(s0)
    16c6:	f4f43023          	sd	a5,-192(s0)
    16ca:	4701                	li	a4,0
    16cc:	f3843703          	ld	a4,-200(s0)
    16d0:	4781                	li	a5,0
    16d2:	f4043783          	ld	a5,-192(s0)
    16d6:	893a                	mv	s2,a4
    16d8:	89be                	mv	s3,a5
    16da:	874a                	mv	a4,s2
    16dc:	87ce                	mv	a5,s3
    ...
    16de:	853a                	mv	a0,a4
    16e0:	85be                	mv	a1,a5
    16e2:	60ee                	ld	ra,216(sp)
    16e4:	644e                	ld	s0,208(sp)
    16e6:	64ae                	ld	s1,200(sp)
    16e8:	690e                	ld	s2,192(sp)
    16ea:	79ea                	ld	s3,184(sp)
    16ec:	612d                	addi	sp,sp,224
    16ee:	8082                	ret

00000000000016f0 <find_earliest_impactful_release_time_dm>:
typedef struct {
...
ImpactfulEvent find_earliest_impactful_release_time_dm(struct list_head *release_queue, struct list_head*run_queue, int current_time, int current_period, int current_thread_ID) {
    16f0:	7119                	addi	sp,sp,-128
    16f2:	fca2                	sd	s0,120(sp)
    16f4:	0100                	addi	s0,sp,128
    16f6:	f8a43c23          	sd	a0,-104(s0)
    16fa:	f8b43823          	sd	a1,-112(s0)
    16fe:	87b2                	mv	a5,a2
    1700:	f8f42623          	sw	a5,-116(s0)
    1704:	87b6                	mv	a5,a3
    1706:	f8f42423          	sw	a5,-120(s0)
    170a:	87ba                	mv	a5,a4
    170c:	f8f42223          	sw	a5,-124(s0)
    struct release_queue_entry *entry;
    struct thread *t;
    int earliest_impactful_event = INT_MAX;
    1710:	800007b7          	lui	a5,0x80000
    1714:	fff7c793          	not	a5,a5
    1718:	fcf42e23          	sw	a5,-36(s0)
    int earliest_impactful_thread_ID = current_thread_ID;    
    171c:	f8442783          	lw	a5,-124(s0)
    1720:	fcf42c23          	sw	a5,-40(s0)
    
    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    1724:	f9843783          	ld	a5,-104(s0)
    1728:	639c                	ld	a5,0(a5)
    172a:	fcf43823          	sd	a5,-48(s0)
    172e:	fd043783          	ld	a5,-48(s0)
    1732:	17e1                	addi	a5,a5,-8
    1734:	fef43423          	sd	a5,-24(s0)
    1738:	a0f9                	j	1806 <find_earliest_impactful_release_time_dm+0x116>
        if (entry->release_time > current_time && entry->thrd->period < current_period) {
    173a:	fe843783          	ld	a5,-24(s0)
    173e:	4f98                	lw	a4,24(a5)
    1740:	f8c42783          	lw	a5,-116(s0)
    1744:	2781                	sext.w	a5,a5
    1746:	04e7d463          	bge	a5,a4,178e <find_earliest_impactful_release_time_dm+0x9e>
    174a:	fe843783          	ld	a5,-24(s0)
    174e:	639c                	ld	a5,0(a5)
    1750:	4bb8                	lw	a4,80(a5)
    1752:	f8842783          	lw	a5,-120(s0)
    1756:	2781                	sext.w	a5,a5
    1758:	02f75b63          	bge	a4,a5,178e <find_earliest_impactful_release_time_dm+0x9e>
            if (entry->release_time < earliest_impactful_event) {
    175c:	fe843783          	ld	a5,-24(s0)
    1760:	4f98                	lw	a4,24(a5)
    1762:	fdc42783          	lw	a5,-36(s0)
    1766:	2781                	sext.w	a5,a5
    1768:	08f75563          	bge	a4,a5,17f2 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    176c:	fe843783          	ld	a5,-24(s0)
    1770:	4f9c                	lw	a5,24(a5)
    1772:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    1776:	fe843783          	ld	a5,-24(s0)
    177a:	639c                	ld	a5,0(a5)
    177c:	fef43023          	sd	a5,-32(s0)
    ...
    1788:	fcf42c23          	sw	a5,-40(s0)
            if (entry->release_time < earliest_impactful_event) {
    178c:	a09d                	j	17f2 <find_earliest_impactful_release_time_dm+0x102>
            }
        } 
        else if (entry->release_time > current_time && entry->thrd->period == current_period) {
    178e:	fe843783          	ld	a5,-24(s0)
    1792:	4f98                	lw	a4,24(a5)
    1794:	f8c42783          	lw	a5,-116(s0)
    1798:	2781                	sext.w	a5,a5
    179a:	04e7dc63          	bge	a5,a4,17f2 <find_earliest_impactful_release_time_dm+0x102>
    179e:	fe843783          	ld	a5,-24(s0)
    17a2:	639c                	ld	a5,0(a5)
    17a4:	4bb8                	lw	a4,80(a5)
    17a6:	f8842783          	lw	a5,-120(s0)
    17aa:	2781                	sext.w	a5,a5
    17ac:	04e79363          	bne	a5,a4,17f2 <find_earliest_impactful_release_time_dm+0x102>
    ...
    17b4:	4f98                	lw	a4,24(a5)
    17b6:	fdc42783          	lw	a5,-36(s0)
    17ba:	2781                	sext.w	a5,a5
    17bc:	02e7cb63          	blt	a5,a4,17f2 <find_earliest_impactful_release_time_dm+0x102>
    17c0:	fe843783          	ld	a5,-24(s0)
    17c4:	639c                	ld	a5,0(a5)
    17c6:	5fd8                	lw	a4,60(a5)
    17c8:	fd842783          	lw	a5,-40(s0)
    17cc:	2781                	sext.w	a5,a5
    17ce:	02f75263          	bge	a4,a5,17f2 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    17d2:	fe843783          	ld	a5,-24(s0)
    17d6:	4f9c                	lw	a5,24(a5)
    17d8:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    17dc:	fe843783          	ld	a5,-24(s0)
    17e0:	639c                	ld	a5,0(a5)
    17e2:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    17e6:	fe843783          	ld	a5,-24(s0)
    17ea:	639c                	ld	a5,0(a5)
    17ec:	5fdc                	lw	a5,60(a5)
    17ee:	fcf42c23          	sw	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    17f2:	fe843783          	ld	a5,-24(s0)
    17f6:	679c                	ld	a5,8(a5)
    17f8:	fcf43423          	sd	a5,-56(s0)
    17fc:	fc843783          	ld	a5,-56(s0)
    1800:	17e1                	addi	a5,a5,-8
    1802:	fef43423          	sd	a5,-24(s0)
    1806:	fe843783          	ld	a5,-24(s0)
    180a:	07a1                	addi	a5,a5,8
    180c:	f9843703          	ld	a4,-104(s0)
    1810:	f2f715e3          	bne	a4,a5,173a <find_earliest_impactful_release_time_dm+0x4a>
            }
        }
    }
    ...
    181c:	800007b7          	lui	a5,0x80000
    1820:	fff7c793          	not	a5,a5
    1824:	00f70563          	beq	a4,a5,182e <find_earliest_impactful_release_time_dm+0x13e>
    1828:	fdc42783          	lw	a5,-36(s0)
    182c:	a011                	j	1830 <find_earliest_impactful_release_time_dm+0x140>
    182e:	57fd                	li	a5,-1
    1830:	fcf42e23          	sw	a5,-36(s0)
    return (ImpactfulEvent) {earliest_impactful_event, t};
    1834:	fdc42783          	lw	a5,-36(s0)
    1838:	faf42c23          	sw	a5,-72(s0)
    183c:	fe043783          	ld	a5,-32(s0)
    1840:	fcf43023          	sd	a5,-64(s0)
    1844:	4701                	li	a4,0
    1846:	fb843703          	ld	a4,-72(s0)
    184a:	4781                	li	a5,0
    ...
    1858:	853a                	mv	a0,a4
    185a:	85be                	mv	a1,a5
    185c:	7466                	ld	s0,120(sp)
    185e:	6109                	addi	sp,sp,128
    1860:	8082                	ret

0000000000001862 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    1862:	7135                	addi	sp,sp,-160
    1864:	ed06                	sd	ra,152(sp)
    1866:	e922                	sd	s0,144(sp)
    1868:	e526                	sd	s1,136(sp)
    186a:	e14a                	sd	s2,128(sp)
    186c:	fcce                	sd	s3,120(sp)
    186e:	1100                	addi	s0,sp,160
    1870:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    1872:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    1876:	800007b7          	lui	a5,0x80000
    187a:	fff7c793          	not	a5,a5
    187e:	faf42e23          	sw	a5,-68(s0)
    int earliest_impactful_deadline; 
    
    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    1882:	649c                	ld	a5,8(s1)
    1884:	639c                	ld	a5,0(a5)
    1886:	faf43823          	sd	a5,-80(s0)
    188a:	fb043783          	ld	a5,-80(s0)
    188e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdd60>
    1892:	fcf43023          	sd	a5,-64(s0)
    1896:	a8bd                	j	1914 <schedule_dm+0xb2>
        if (t->is_real_time && t->period < earliest_deadline) {
    1898:	fc043783          	ld	a5,-64(s0)
    189c:	43bc                	lw	a5,64(a5)
    189e:	c39d                	beqz	a5,18c4 <schedule_dm+0x62>
    18a0:	fc043783          	ld	a5,-64(s0)
    18a4:	4bb8                	lw	a4,80(a5)
    18a6:	fbc42783          	lw	a5,-68(s0)
    18aa:	2781                	sext.w	a5,a5
    18ac:	00f75c63          	bge	a4,a5,18c4 <schedule_dm+0x62>
            earliest_deadline_thread = t;
    18b0:	fc043783          	ld	a5,-64(s0)
    18b4:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    18b8:	fc043783          	ld	a5,-64(s0)
    18bc:	4bbc                	lw	a5,80(a5)
    18be:	faf42e23          	sw	a5,-68(s0)
    18c2:	a835                	j	18fe <schedule_dm+0x9c>
    ...
    18ca:	cb95                	beqz	a5,18fe <schedule_dm+0x9c>
    18cc:	fc043783          	ld	a5,-64(s0)
    18d0:	4bb8                	lw	a4,80(a5)
    18d2:	fbc42783          	lw	a5,-68(s0)
    18d6:	2781                	sext.w	a5,a5
    18d8:	02e79363          	bne	a5,a4,18fe <schedule_dm+0x9c>
    18dc:	fc043783          	ld	a5,-64(s0)
    18e0:	5fd8                	lw	a4,60(a5)
    18e2:	fc843783          	ld	a5,-56(s0)
    18e6:	5fdc                	lw	a5,60(a5)
    18e8:	00f75b63          	bge	a4,a5,18fe <schedule_dm+0x9c>
            earliest_deadline_thread = t;
    18ec:	fc043783          	ld	a5,-64(s0)
    18f0:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    18f4:	fc043783          	ld	a5,-64(s0)
    18f8:	4bbc                	lw	a5,80(a5)
    18fa:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    18fe:	fc043783          	ld	a5,-64(s0)
    1902:	779c                	ld	a5,40(a5)
    1904:	f8f43c23          	sd	a5,-104(s0)
    1908:	f9843783          	ld	a5,-104(s0)
    190c:	fd878793          	addi	a5,a5,-40
    1910:	fcf43023          	sd	a5,-64(s0)
    1914:	fc043783          	ld	a5,-64(s0)
    1918:	02878713          	addi	a4,a5,40
    191c:	649c                	ld	a5,8(s1)
    191e:	f6f71de3          	bne	a4,a5,1898 <schedule_dm+0x36>
        }
    }
    ...
    1922:	6888                	ld	a0,16(s1)
    1924:	648c                	ld	a1,8(s1)
    1926:	4090                	lw	a2,0(s1)
    1928:	fc843783          	ld	a5,-56(s0)
    192c:	c789                	beqz	a5,1936 <schedule_dm+0xd4>
    192e:	fc843783          	ld	a5,-56(s0)
    1932:	4bbc                	lw	a5,80(a5)
    1934:	a029                	j	193e <schedule_dm+0xdc>
    1936:	800007b7          	lui	a5,0x80000
    193a:	fff7c793          	not	a5,a5
    193e:	fc843703          	ld	a4,-56(s0)
    1942:	5f58                	lw	a4,60(a4)
    1944:	86be                	mv	a3,a5
    1946:	00000097          	auipc	ra,0x0
    194a:	daa080e7          	jalr	-598(ra) # 16f0 <find_earliest_impactful_release_time_dm>
    194e:	872a                	mv	a4,a0
    1950:	87ae                	mv	a5,a1
    1952:	f6e43423          	sd	a4,-152(s0)
    1956:	f6f43823          	sd	a5,-144(s0)
    earliest_impactful_deadline = earliest_impactful_event.earliest_impactful_event;
    195a:	f6842783          	lw	a5,-152(s0)
    195e:	faf42623          	sw	a5,-84(s0)
    //printf("earliest_impactful_deadline: %d\n", earliest_impactful_deadline);
    if (earliest_deadline_thread) {
    1962:	fc843783          	ld	a5,-56(s0)
    1966:	cfd9                	beqz	a5,1a04 <schedule_dm+0x1a2>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    1968:	fc843783          	ld	a5,-56(s0)
    196c:	4ff8                	lw	a4,92(a5)
    196e:	409c                	lw	a5,0(s1)
    1970:	40f707bb          	subw	a5,a4,a5
    1974:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline <= 0) {
    1978:	fa842783          	lw	a5,-88(s0)
    197c:	2781                	sext.w	a5,a5
    197e:	00f04b63          	bgtz	a5,1994 <schedule_dm+0x132>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1982:	fc843783          	ld	a5,-56(s0)
    1986:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffddb0>
    198a:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    198e:	f8042023          	sw	zero,-128(s0)
    1992:	a079                	j	1a20 <schedule_dm+0x1be>
        } else {
    ...
    1998:	4fbc                	lw	a5,88(a5)
    199a:	fa842703          	lw	a4,-88(s0)
    199e:	85ba                	mv	a1,a4
    19a0:	853e                	mv	a0,a5
    19a2:	00000097          	auipc	ra,0x0
    19a6:	9c8080e7          	jalr	-1592(ra) # 136a <min>
    19aa:	87aa                	mv	a5,a0
    19ac:	faf42223          	sw	a5,-92(s0)
            int allocated_time;
            if (earliest_impactful_deadline != -1 && (earliest_impactful_deadline - args.current_time) < remaining_time){
    19b0:	fac42783          	lw	a5,-84(s0)
    19b4:	0007871b          	sext.w	a4,a5
    19b8:	57fd                	li	a5,-1
    19ba:	02f70663          	beq	a4,a5,19e6 <schedule_dm+0x184>
    19be:	409c                	lw	a5,0(s1)
    19c0:	fac42703          	lw	a4,-84(s0)
    19c4:	40f707bb          	subw	a5,a4,a5
    19c8:	0007871b          	sext.w	a4,a5
    19cc:	fa442783          	lw	a5,-92(s0)
    19d0:	2781                	sext.w	a5,a5
    19d2:	00f75a63          	bge	a4,a5,19e6 <schedule_dm+0x184>
                allocated_time = earliest_impactful_deadline - args.current_time;
    19d6:	409c                	lw	a5,0(s1)
    19d8:	fac42703          	lw	a4,-84(s0)
    19dc:	40f707bb          	subw	a5,a4,a5
    19e0:	faf42c23          	sw	a5,-72(s0)
    19e4:	a029                	j	19ee <schedule_dm+0x18c>
            } else {
                allocated_time = remaining_time;
    19e6:	fa442783          	lw	a5,-92(s0)
    19ea:	faf42c23          	sw	a5,-72(s0)
            }
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    19ee:	fc843783          	ld	a5,-56(s0)
    19f2:	02878793          	addi	a5,a5,40
    19f6:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    19fa:	fb842783          	lw	a5,-72(s0)
    19fe:	f8f42023          	sw	a5,-128(s0)
    1a02:	a839                	j	1a20 <schedule_dm+0x1be>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    1a04:	649c                	ld	a5,8(s1)
    1a06:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1a0a:	689c                	ld	a5,16(s1)
    1a0c:	4098                	lw	a4,0(s1)
    1a0e:	85ba                	mv	a1,a4
    1a10:	853e                	mv	a0,a5
    1a12:	fffff097          	auipc	ra,0xfffff
    1a16:	4ba080e7          	jalr	1210(ra) # ecc <find_next_release_time>
    1a1a:	87aa                	mv	a5,a0
    1a1c:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    1a20:	f7843783          	ld	a5,-136(s0)
    1a24:	f8f43423          	sd	a5,-120(s0)
    1a28:	f8043783          	ld	a5,-128(s0)
    1a2c:	f8f43823          	sd	a5,-112(s0)
    1a30:	4701                	li	a4,0
    1a32:	f8843703          	ld	a4,-120(s0)
    1a36:	4781                	li	a5,0
    1a38:	f9043783          	ld	a5,-112(s0)
    1a3c:	893a                	mv	s2,a4
    1a3e:	89be                	mv	s3,a5
    1a40:	874a                	mv	a4,s2
    1a42:	87ce                	mv	a5,s3
    ...
    1a44:	853a                	mv	a0,a4
    1a46:	85be                	mv	a1,a5
    1a48:	60ea                	ld	ra,152(sp)
    1a4a:	644a                	ld	s0,144(sp)
    1a4c:	64aa                	ld	s1,136(sp)
    1a4e:	690a                	ld	s2,128(sp)
    1a50:	79e6                	ld	s3,120(sp)
    1a52:	610d                	addi	sp,sp,160
    1a54:	8082                	ret

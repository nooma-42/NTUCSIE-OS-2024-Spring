...
static inline void list_del(struct list_head *entry)
{
    ...
    entry->next = LIST_POISON1;
      ...
      ca:	10070713          	addi	a4,a4,256 # 100100 <__global_pointer$+0xfd250>
      ce:	e398                	sd	a4,0(a5)
    entry->prev = LIST_POISON2;
      d0:	fe843783          	ld	a5,-24(s0)
      d4:	00200737          	lui	a4,0x200
      d8:	20070713          	addi	a4,a4,512 # 200200 <__global_pointer$+0x1fd350>
      dc:	e798                	sd	a4,8(a5)
}
      de:	0001                	nop
      e0:	60e2                	ld	ra,24(sp)
...
struct thread *thread_create(void (*f)(void *), void *arg, int is_real_time, int processing_time, int period, int n)
{
    ...
    t->ID = _id++;
     ...
     188:	56478793          	addi	a5,a5,1380 # 26e8 <_id.1229>
     18c:	439c                	lw	a5,0(a5)
     18e:	0017871b          	addiw	a4,a5,1
     192:	0007069b          	sext.w	a3,a4
     196:	00002717          	auipc	a4,0x2
     19a:	55270713          	addi	a4,a4,1362 # 26e8 <_id.1229>
     19e:	c314                	sw	a3,0(a4)
...
void thread_add_at(struct thread *t, int arrival_time)
{
    ...
    list_add_tail(&new_entry->thread_list, &release_queue);
     ...
     2a6:	41e58593          	addi	a1,a1,1054 # 26c0 <release_queue>
     2aa:	853e                	mv	a0,a5
...
void __release()
{
    ...
    list_for_each_entry_safe(cur, nxt, &release_queue, thread_list) {
     ...
     2ca:	3fa78793          	addi	a5,a5,1018 # 26c0 <release_queue>
     2ce:	639c                	ld	a5,0(a5)
     ...
     2fe:	3fe78793          	addi	a5,a5,1022 # 26f8 <threading_system_time>
     302:	439c                	lw	a5,0(a5)
     ...
     340:	37458593          	addi	a1,a1,884 # 26b0 <run_queue>
     344:	853e                	mv	a0,a5
    ...
    list_for_each_entry_safe(cur, nxt, &release_queue, thread_list) {
     ...
     392:	33278793          	addi	a5,a5,818 # 26c0 <release_queue>
...
void __thread_exit(struct thread *to_remove)
{
    ...
    current = to_remove->thread_list.prev;
     ...
     3bc:	33878793          	addi	a5,a5,824 # 26f0 <current>
     3c0:	e398                	sd	a4,0(a5)
    ...
    thrdresume(main_thrd_id);
     ...
     404:	2e478793          	addi	a5,a5,740 # 26e4 <main_thrd_id>
     408:	439c                	lw	a5,0(a5)
     40a:	853e                	mv	a0,a5
...
void thread_exit(void)
{
    ...
    if (current == &run_queue) {
     ...
     42a:	2ca78793          	addi	a5,a5,714 # 26f0 <current>
     42e:	6398                	ld	a4,0(a5)
     430:	00002797          	auipc	a5,0x2
     434:	28078793          	addi	a5,a5,640 # 26b0 <run_queue>
     ...
     440:	12c58593          	addi	a1,a1,300 # 2568 <schedule_dm+0x1f4>
     444:	4509                	li	a0,2
    ...
    struct thread *to_remove = list_entry(current, struct thread, thread_list);
     ...
     45c:	29878793          	addi	a5,a5,664 # 26f0 <current>
     460:	639c                	ld	a5,0(a5)
    ...
    threading_system_time += consume_ticks;
     ...
     48e:	26e78793          	addi	a5,a5,622 # 26f8 <threading_system_time>
     492:	439c                	lw	a5,0(a5)
     494:	fdc42703          	lw	a4,-36(s0)
     498:	9fb9                	addw	a5,a5,a4
     49a:	0007871b          	sext.w	a4,a5
     49e:	00002797          	auipc	a5,0x2
     4a2:	25a78793          	addi	a5,a5,602 # 26f8 <threading_system_time>
     4a6:	c398                	sw	a4,0(a5)
...
void __finish_current()
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     4d2:	22278793          	addi	a5,a5,546 # 26f0 <current>
     4d6:	639c                	ld	a5,0(a5)
    ...
    printf("thread#%d finish at %d\n",
     ...
     504:	1f878793          	addi	a5,a5,504 # 26f8 <threading_system_time>
     508:	4390                	lw	a2,0(a5)
     ...
     518:	08c50513          	addi	a0,a0,140 # 25a0 <schedule_dm+0x22c>
    ...
    if (current_thread->n > 0) {
     ...
     532:	1c278793          	addi	a5,a5,450 # 26f0 <current>
     536:	639c                	ld	a5,0(a5)
     538:	fcf43c23          	sd	a5,-40(s0)
        current = current->prev;
     53c:	00002797          	auipc	a5,0x2
     540:	1b478793          	addi	a5,a5,436 # 26f0 <current>
     544:	639c                	ld	a5,0(a5)
     546:	6798                	ld	a4,8(a5)
     548:	00002797          	auipc	a5,0x2
     54c:	1a878793          	addi	a5,a5,424 # 26f0 <current>
     550:	e398                	sd	a4,0(a5)
        list_del(to_remove);
...
void __rt_finish_current()
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     596:	15e78793          	addi	a5,a5,350 # 26f0 <current>
     59a:	639c                	ld	a5,0(a5)
    ...
    printf("thread#%d finish one cycle at %d: %d cycles left\n",
     ...
     5c8:	13478793          	addi	a5,a5,308 # 26f8 <threading_system_time>
     5cc:	4390                	lw	a2,0(a5)
     ...
     5dc:	fe050513          	addi	a0,a0,-32 # 25b8 <schedule_dm+0x244>
    ...
    if (current_thread->n > 0) {
     ...
     5f6:	0fe78793          	addi	a5,a5,254 # 26f0 <current>
     5fa:	639c                	ld	a5,0(a5)
     5fc:	fcf43c23          	sd	a5,-40(s0)
        current = current->prev;
     600:	00002797          	auipc	a5,0x2
     604:	0f078793          	addi	a5,a5,240 # 26f0 <current>
     608:	639c                	ld	a5,0(a5)
     60a:	6798                	ld	a4,8(a5)
     60c:	00002797          	auipc	a5,0x2
     610:	0e478793          	addi	a5,a5,228 # 26f0 <current>
     614:	e398                	sd	a4,0(a5)
        list_del(to_remove);
...
void switch_handler(void *arg)
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     666:	08e78793          	addi	a5,a5,142 # 26f0 <current>
     66a:	639c                	ld	a5,0(a5)
    ...
    threading_system_time += elapsed_time;
     ...
     688:	07478793          	addi	a5,a5,116 # 26f8 <threading_system_time>
     68c:	439c                	lw	a5,0(a5)
     ...
     69c:	06078793          	addi	a5,a5,96 # 26f8 <threading_system_time>
     6a0:	c398                	sw	a4,0(a5)
     __release();
    ...
    if (current_thread->is_real_time)
     ...
     6dc:	02078793          	addi	a5,a5,32 # 26f8 <threading_system_time>
     6e0:	439c                	lw	a5,0(a5)
     ...
     6f0:	00c78793          	addi	a5,a5,12 # 26f8 <threading_system_time>
     6f4:	439c                	lw	a5,0(a5)
        if (threading_system_time > current_thread->current_deadline || 
     ...
     70e:	fee78793          	addi	a5,a5,-18 # 26f8 <threading_system_time>
     712:	439c                	lw	a5,0(a5)
     714:	863e                	mv	a2,a5
     716:	85ba                	mv	a1,a4
     718:	00002517          	auipc	a0,0x2
     71c:	ed850513          	addi	a0,a0,-296 # 25f0 <schedule_dm+0x27c>
    ...
    if (current_thread->remaining_time <= 0) {
     ...
     75c:	f9878793          	addi	a5,a5,-104 # 26f0 <current>
     760:	639c                	ld	a5,0(a5)
     762:	fcf43823          	sd	a5,-48(s0)
        current = current->prev;
     766:	00002797          	auipc	a5,0x2
     76a:	f8a78793          	addi	a5,a5,-118 # 26f0 <current>
     76e:	639c                	ld	a5,0(a5)
     770:	6798                	ld	a4,8(a5)
     772:	00002797          	auipc	a5,0x2
     776:	f7e78793          	addi	a5,a5,-130 # 26f0 <current>
     77a:	e398                	sd	a4,0(a5)
        list_del(to_remove);
     ...
     78c:	f2858593          	addi	a1,a1,-216 # 26b0 <run_queue>
    ...
    thrdresume(main_thrd_id);
     ...
     7b8:	f3078793          	addi	a5,a5,-208 # 26e4 <main_thrd_id>
     7bc:	439c                	lw	a5,0(a5)
     7be:	853e                	mv	a0,a5
...
void __dispatch()
{
    ...
    if (current == &run_queue) {
     ...
     7de:	f1678793          	addi	a5,a5,-234 # 26f0 <current>
     7e2:	6398                	ld	a4,0(a5)
     7e4:	00002797          	auipc	a5,0x2
     7e8:	ecc78793          	addi	a5,a5,-308 # 26b0 <run_queue>
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     7f4:	f0078793          	addi	a5,a5,-256 # 26f0 <current>
     7f8:	639c                	ld	a5,0(a5)
    ...
    if (current_thread->is_real_time && allocated_time == 0) { // miss deadline, abort
     ...
     816:	eee78793          	addi	a5,a5,-274 # 2700 <allocated_time>
     81a:	639c                	ld	a5,0(a5)
     ...
     832:	dc250513          	addi	a0,a0,-574 # 25f0 <schedule_dm+0x27c>
    ...
    printf("dispatch thread#%d at %d: allocated_time=%d\n", current_thread->ID, threading_system_time, allocated_time);
     ...
     852:	eaa78793          	addi	a5,a5,-342 # 26f8 <threading_system_time>
     856:	4390                	lw	a2,0(a5)
     858:	00002797          	auipc	a5,0x2
     85c:	ea878793          	addi	a5,a5,-344 # 2700 <allocated_time>
     860:	639c                	ld	a5,0(a5)
     862:	86be                	mv	a3,a5
     864:	85ba                	mv	a1,a4
     866:	00002517          	auipc	a0,0x2
     86a:	db250513          	addi	a0,a0,-590 # 2618 <schedule_dm+0x2a4>
    ...
    if (current_thread->buf_set) {
     ...
     920:	d2c58593          	addi	a1,a1,-724 # 2648 <schedule_dm+0x2d4>
     924:	4509                	li	a0,2
...
void __schedule()
{
    ...
    struct threads_sched_args args = {
     ...
     96e:	d8e78793          	addi	a5,a5,-626 # 26f8 <threading_system_time>
     972:	439c                	lw	a5,0(a5)
     974:	fcf42c23          	sw	a5,-40(s0)
     978:	4789                	li	a5,2
     97a:	fcf42e23          	sw	a5,-36(s0)
     97e:	00002797          	auipc	a5,0x2
     982:	d3278793          	addi	a5,a5,-718 # 26b0 <run_queue>
     986:	fef43023          	sd	a5,-32(s0)
     98a:	00002797          	auipc	a5,0x2
     98e:	d3678793          	addi	a5,a5,-714 # 26c0 <release_queue>
    ...
    r = schedule_dm(args);
     ...
     9b8:	9c0080e7          	jalr	-1600(ra) # 2374 <schedule_dm>
     9bc:	872a                	mv	a4,a0
     9be:	87ae                	mv	a5,a1
    ...
    current = r.scheduled_thread_list_member;
     ...
     9d0:	d2478793          	addi	a5,a5,-732 # 26f0 <current>
     9d4:	e398                	sd	a4,0(a5)
    allocated_time = r.allocated_time;
     9d6:	fd042783          	lw	a5,-48(s0)
     9da:	873e                	mv	a4,a5
     9dc:	00002797          	auipc	a5,0x2
     9e0:	d2478793          	addi	a5,a5,-732 # 2700 <allocated_time>
     9e4:	e398                	sd	a4,0(a5)
}
     9e6:	0001                	nop
...
void back_to_main_handler(void *arg)
{
    ...
    sleeping = 0;
     ...
     a00:	d0078793          	addi	a5,a5,-768 # 26fc <sleeping>
    ...
    threading_system_time += (uint64)arg;
     ...
     a14:	ce878793          	addi	a5,a5,-792 # 26f8 <threading_system_time>
     a18:	439c                	lw	a5,0(a5)
     ...
     a28:	cd478793          	addi	a5,a5,-812 # 26f8 <threading_system_time>
     a2c:	c398                	sw	a4,0(a5)
    thrdresume(main_thrd_id);
     a2e:	00002797          	auipc	a5,0x2
     a32:	cb678793          	addi	a5,a5,-842 # 26e4 <main_thrd_id>
     a36:	439c                	lw	a5,0(a5)
     a38:	853e                	mv	a0,a5
...
void thread_start_threading()
{
    ...
    threading_system_time = 0;
     ...
     a58:	ca478793          	addi	a5,a5,-860 # 26f8 <threading_system_time>
     a5c:	0007a023          	sw	zero,0(a5)
    current = &run_queue;
     a60:	00002797          	auipc	a5,0x2
     a64:	c9078793          	addi	a5,a5,-880 # 26f0 <current>
     a68:	00002717          	auipc	a4,0x2
     a6c:	c4870713          	addi	a4,a4,-952 # 26b0 <run_queue>
     a70:	e398                	sd	a4,0(a5)
    ...
    thrdstop(1000, &main_thrd_id, back_to_main_handler, (void *)0);
     ...
     a80:	c6858593          	addi	a1,a1,-920 # 26e4 <main_thrd_id>
    ...
    cancelthrdstop(main_thrd_id, 0);
     ...
     a94:	c5478793          	addi	a5,a5,-940 # 26e4 <main_thrd_id>
     a98:	439c                	lw	a5,0(a5)
     a9a:	4581                	li	a1,0
     a9c:	853e                	mv	a0,a5
    ...
    while (!list_empty(&run_queue) || !list_empty(&release_queue)) {
     ...
     abc:	c2c78793          	addi	a5,a5,-980 # 26e4 <main_thrd_id>
     ac0:	439c                	lw	a5,0(a5)
     ac2:	4581                	li	a1,0
     ac4:	853e                	mv	a0,a5
     ...
     ada:	bda50513          	addi	a0,a0,-1062 # 26b0 <run_queue>
     ...
     aee:	bd650513          	addi	a0,a0,-1066 # 26c0 <release_queue>
     ...
     b60:	ba078793          	addi	a5,a5,-1120 # 26fc <sleeping>
     b64:	439c                	lw	a5,0(a5)
     b66:	fbfd                	bnez	a5,b5c <thread_start_threading+0x110>
    while (!list_empty(&run_queue) || !list_empty(&release_queue)) {
     b68:	00002517          	auipc	a0,0x2
     b6c:	b4850513          	addi	a0,a0,-1208 # 26b0 <run_queue>
     ...
     b80:	b4450513          	addi	a0,a0,-1212 # 26c0 <release_queue>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1196:	53e68693          	addi	a3,a3,1342 # 26d0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1270:	46470713          	addi	a4,a4,1124 # 26d0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1430:	27c78793          	addi	a5,a5,636 # 26a8 <schedule_dm+0x334>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    15dc:	14078793          	addi	a5,a5,320 # 2718 <freep>
  ...
  freep = p;
    ...
    16d4:	04878793          	addi	a5,a5,72 # 2718 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1756:	fc678793          	addi	a5,a5,-58 # 2718 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1788:	f9478793          	addi	a5,a5,-108 # 2718 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1846:	ed678793          	addi	a5,a5,-298 # 2718 <freep>
    ...
    185c:	ec078793          	addi	a5,a5,-320 # 2718 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    1ae8:	c3c78793          	addi	a5,a5,-964 # 2720 <last_thread.1239>
    ...
    1b44:	be078793          	addi	a5,a5,-1056 # 2720 <last_thread.1239>
    1b48:	639c                	ld	a5,0(a5)
    1b4a:	c385                	beqz	a5,1b6a <schedule_wrr+0xdc>
    1b4c:	00001797          	auipc	a5,0x1
    1b50:	bd478793          	addi	a5,a5,-1068 # 2720 <last_thread.1239>
    ...
    1b60:	bc478793          	addi	a5,a5,-1084 # 2720 <last_thread.1239>
    ...
    1bb0:	b7478793          	addi	a5,a5,-1164 # 2720 <last_thread.1239>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    1c48:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd128>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    1d7a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd128>
...
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    1eb0:	7115                	addi	sp,sp,-224
    1eb2:	ed86                	sd	ra,216(sp)
    1eb4:	e9a2                	sd	s0,208(sp)
    1eb6:	e5a6                	sd	s1,200(sp)
    1eb8:	e1ca                	sd	s2,192(sp)
    1eba:	fd4e                	sd	s3,184(sp)
    1ebc:	1180                	addi	s0,sp,224
    1ebe:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    ...
    1ed4:	f8f43823          	sd	a5,-112(s0)
    1ed8:	f9043783          	ld	a5,-112(s0)
    1edc:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd128>
    ...
    1f50:	f5442783          	lw	a5,-172(s0)
    1f54:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1f58:	fb843783          	ld	a5,-72(s0)
    1f5c:	779c                	ld	a5,40(a5)
    1f5e:	f4f43423          	sd	a5,-184(s0)
    1f62:	f4843783          	ld	a5,-184(s0)
    1f66:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd128>
    ...
    1f8c:	f8f43423          	sd	a5,-120(s0)
    1f90:	f8843783          	ld	a5,-120(s0)
    ...
    2058:	f4f43c23          	sd	a5,-168(s0)
    205c:	f5843783          	ld	a5,-168(s0)
    2060:	17e1                	addi	a5,a5,-8
    2062:	faf43423          	sd	a5,-88(s0)
    2066:	fa843783          	ld	a5,-88(s0)
    206a:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffd158>
    ...
    2078:	10078b63          	beqz	a5,218e <schedule_lst+0x2de>
    ...
    207c:	4098                	lw	a4,0(s1)
    207e:	fc843783          	ld	a5,-56(s0)
    2082:	4ffc                	lw	a5,92(a5)
    2084:	08f74863          	blt	a4,a5,2114 <schedule_lst+0x264>
    2088:	fc843783          	ld	a5,-56(s0)
    208c:	4fbc                	lw	a5,88(a5)
    208e:	08f05363          	blez	a5,2114 <schedule_lst+0x264>
            struct thread *thread_with_smallest_id = min_slack_thread;
    2092:	fc843783          	ld	a5,-56(s0)
    2096:	faf43023          	sd	a5,-96(s0)
            ...
            list_for_each_entry(t, args.run_queue, thread_list) {
    209a:	649c                	ld	a5,8(s1)
    209c:	639c                	ld	a5,0(a5)
    209e:	f8f43023          	sd	a5,-128(s0)
    20a2:	f8043783          	ld	a5,-128(s0)
    20a6:	fd878793          	addi	a5,a5,-40
    20aa:	faf43c23          	sd	a5,-72(s0)
    20ae:	a099                	j	20f4 <schedule_lst+0x244>
                if (args.current_time >= t->current_deadline && t->remaining_time > 0 && t->ID < thread_with_smallest_id->ID) {
    20b0:	4098                	lw	a4,0(s1)
    20b2:	fb843783          	ld	a5,-72(s0)
    20b6:	4ffc                	lw	a5,92(a5)
    20b8:	02f74363          	blt	a4,a5,20de <schedule_lst+0x22e>
    20bc:	fb843783          	ld	a5,-72(s0)
    20c0:	4fbc                	lw	a5,88(a5)
    20c2:	00f05e63          	blez	a5,20de <schedule_lst+0x22e>
    20c6:	fb843783          	ld	a5,-72(s0)
    20ca:	5fd8                	lw	a4,60(a5)
    20cc:	fa043783          	ld	a5,-96(s0)
    20d0:	5fdc                	lw	a5,60(a5)
    20d2:	00f75663          	bge	a4,a5,20de <schedule_lst+0x22e>
                    thread_with_smallest_id = t;
    20d6:	fb843783          	ld	a5,-72(s0)
    20da:	faf43023          	sd	a5,-96(s0)
            list_for_each_entry(t, args.run_queue, thread_list) {
    20de:	fb843783          	ld	a5,-72(s0)
    20e2:	779c                	ld	a5,40(a5)
    20e4:	f6f43c23          	sd	a5,-136(s0)
    20e8:	f7843783          	ld	a5,-136(s0)
    20ec:	fd878793          	addi	a5,a5,-40
    20f0:	faf43c23          	sd	a5,-72(s0)
    20f4:	fb843783          	ld	a5,-72(s0)
    20f8:	02878713          	addi	a4,a5,40
    20fc:	649c                	ld	a5,8(s1)
    20fe:	faf719e3          	bne	a4,a5,20b0 <schedule_lst+0x200>
                }
            }
            r.scheduled_thread_list_member = &thread_with_smallest_id->thread_list;
    2102:	fa043783          	ld	a5,-96(s0)
    2106:	02878793          	addi	a5,a5,40
    210a:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = 0;
    210e:	f2042823          	sw	zero,-208(s0)
        if (args.current_time >= min_slack_thread->current_deadline && min_slack_thread->remaining_time > 0) {
    2112:	a86d                	j	21cc <schedule_lst+0x31c>
        } else {
            // Calculate time until the thread's deadline
            int time_until_deadline = min_slack_thread->current_deadline - args.current_time;
    2114:	fc843783          	ld	a5,-56(s0)
    2118:	4ff8                	lw	a4,92(a5)
    211a:	409c                	lw	a5,0(s1)
    211c:	40f707bb          	subw	a5,a4,a5
    2120:	f6f42a23          	sw	a5,-140(s0)
            
            // Decide the allocated time based on current minimum slack or upcoming preemption needs
            int allocated_time = min(min_slack_thread->remaining_time, time_until_deadline);
    2124:	fc843783          	ld	a5,-56(s0)
    2128:	4fbc                	lw	a5,88(a5)
    212a:	f7442703          	lw	a4,-140(s0)
    212e:	85ba                	mv	a1,a4
    2130:	853e                	mv	a0,a5
    2132:	00000097          	auipc	ra,0x0
    2136:	d4a080e7          	jalr	-694(ra) # 1e7c <min>
    213a:	87aa                	mv	a5,a0
    213c:	f8f42e23          	sw	a5,-100(s0)
            if (next_significant_event_time != INT_MAX) {
    2140:	fb442783          	lw	a5,-76(s0)
    2144:	0007871b          	sext.w	a4,a5
    2148:	800007b7          	lui	a5,0x80000
    214c:	fff7c793          	not	a5,a5
    2150:	02f70463          	beq	a4,a5,2178 <schedule_lst+0x2c8>
                allocated_time = min(allocated_time, next_significant_event_time - args.current_time);
    2154:	409c                	lw	a5,0(s1)
    2156:	fb442703          	lw	a4,-76(s0)
    215a:	40f707bb          	subw	a5,a4,a5
    215e:	0007871b          	sext.w	a4,a5
    2162:	f9c42783          	lw	a5,-100(s0)
    2166:	85ba                	mv	a1,a4
    2168:	853e                	mv	a0,a5
    216a:	00000097          	auipc	ra,0x0
    216e:	d12080e7          	jalr	-750(ra) # 1e7c <min>
    2172:	87aa                	mv	a5,a0
    2174:	f8f42e23          	sw	a5,-100(s0)
            }

            r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    2178:	fc843783          	ld	a5,-56(s0)
    217c:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffd178>
    2180:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = allocated_time;
    2184:	f9c42783          	lw	a5,-100(s0)
    2188:	f2f42823          	sw	a5,-208(s0)
    218c:	a081                	j	21cc <schedule_lst+0x31c>
        }
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    218e:	649c                	ld	a5,8(s1)
    2190:	f2f43423          	sd	a5,-216(s0)
    ...
    2194:	fb442783          	lw	a5,-76(s0)
    2198:	0007871b          	sext.w	a4,a5
    219c:	800007b7          	lui	a5,0x80000
    21a0:	fff7c793          	not	a5,a5
    21a4:	00f70963          	beq	a4,a5,21b6 <schedule_lst+0x306>
    21a8:	409c                	lw	a5,0(s1)
    21aa:	fb442703          	lw	a4,-76(s0)
    21ae:	40f707bb          	subw	a5,a4,a5
    21b2:	2781                	sext.w	a5,a5
    21b4:	a811                	j	21c8 <schedule_lst+0x318>
    21b6:	689c                	ld	a5,16(s1)
    21b8:	4098                	lw	a4,0(s1)
    21ba:	85ba                	mv	a1,a4
    21bc:	853e                	mv	a0,a5
    21be:	00000097          	auipc	ra,0x0
    21c2:	820080e7          	jalr	-2016(ra) # 19de <find_next_release_time>
    21c6:	87aa                	mv	a5,a0
    21c8:	f2f42823          	sw	a5,-208(s0)
    }

    return r;
    21cc:	f2843783          	ld	a5,-216(s0)
    21d0:	f2f43c23          	sd	a5,-200(s0)
    21d4:	f3043783          	ld	a5,-208(s0)
    21d8:	f4f43023          	sd	a5,-192(s0)
    21dc:	4701                	li	a4,0
    21de:	f3843703          	ld	a4,-200(s0)
    21e2:	4781                	li	a5,0
    21e4:	f4043783          	ld	a5,-192(s0)
    21e8:	893a                	mv	s2,a4
    21ea:	89be                	mv	s3,a5
    21ec:	874a                	mv	a4,s2
    21ee:	87ce                	mv	a5,s3
    ...
    21f0:	853a                	mv	a0,a4
    21f2:	85be                	mv	a1,a5
    21f4:	60ee                	ld	ra,216(sp)
    21f6:	644e                	ld	s0,208(sp)
    21f8:	64ae                	ld	s1,200(sp)
    21fa:	690e                	ld	s2,192(sp)
    21fc:	79ea                	ld	s3,184(sp)
    21fe:	612d                	addi	sp,sp,224
    2200:	8082                	ret

0000000000002202 <find_earliest_impactful_release_time_dm>:
typedef struct {
...
ImpactfulEvent find_earliest_impactful_release_time_dm(struct list_head *release_queue, struct list_head*run_queue, int current_time, int current_period, int current_thread_ID) {
    2202:	7119                	addi	sp,sp,-128
    2204:	fca2                	sd	s0,120(sp)
    2206:	0100                	addi	s0,sp,128
    2208:	f8a43c23          	sd	a0,-104(s0)
    220c:	f8b43823          	sd	a1,-112(s0)
    2210:	87b2                	mv	a5,a2
    2212:	f8f42623          	sw	a5,-116(s0)
    2216:	87b6                	mv	a5,a3
    2218:	f8f42423          	sw	a5,-120(s0)
    221c:	87ba                	mv	a5,a4
    221e:	f8f42223          	sw	a5,-124(s0)
    struct release_queue_entry *entry;
    struct thread *t;
    int earliest_impactful_event = INT_MAX;
    2222:	800007b7          	lui	a5,0x80000
    2226:	fff7c793          	not	a5,a5
    222a:	fcf42e23          	sw	a5,-36(s0)
    int earliest_impactful_thread_ID = current_thread_ID;    
    222e:	f8442783          	lw	a5,-124(s0)
    2232:	fcf42c23          	sw	a5,-40(s0)
    
    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    2236:	f9843783          	ld	a5,-104(s0)
    223a:	639c                	ld	a5,0(a5)
    223c:	fcf43823          	sd	a5,-48(s0)
    2240:	fd043783          	ld	a5,-48(s0)
    2244:	17e1                	addi	a5,a5,-8
    2246:	fef43423          	sd	a5,-24(s0)
    224a:	a0f9                	j	2318 <find_earliest_impactful_release_time_dm+0x116>
        if (entry->release_time > current_time && entry->thrd->period < current_period) {
    224c:	fe843783          	ld	a5,-24(s0)
    2250:	4f98                	lw	a4,24(a5)
    2252:	f8c42783          	lw	a5,-116(s0)
    2256:	2781                	sext.w	a5,a5
    2258:	04e7d463          	bge	a5,a4,22a0 <find_earliest_impactful_release_time_dm+0x9e>
    225c:	fe843783          	ld	a5,-24(s0)
    2260:	639c                	ld	a5,0(a5)
    2262:	4bb8                	lw	a4,80(a5)
    2264:	f8842783          	lw	a5,-120(s0)
    2268:	2781                	sext.w	a5,a5
    226a:	02f75b63          	bge	a4,a5,22a0 <find_earliest_impactful_release_time_dm+0x9e>
            if (entry->release_time < earliest_impactful_event) {
    226e:	fe843783          	ld	a5,-24(s0)
    2272:	4f98                	lw	a4,24(a5)
    2274:	fdc42783          	lw	a5,-36(s0)
    2278:	2781                	sext.w	a5,a5
    227a:	08f75563          	bge	a4,a5,2304 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    227e:	fe843783          	ld	a5,-24(s0)
    2282:	4f9c                	lw	a5,24(a5)
    2284:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    2288:	fe843783          	ld	a5,-24(s0)
    228c:	639c                	ld	a5,0(a5)
    228e:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    2292:	fe843783          	ld	a5,-24(s0)
    2296:	639c                	ld	a5,0(a5)
    2298:	5fdc                	lw	a5,60(a5)
    229a:	fcf42c23          	sw	a5,-40(s0)
            if (entry->release_time < earliest_impactful_event) {
    229e:	a09d                	j	2304 <find_earliest_impactful_release_time_dm+0x102>
            }
        } 
        else if (entry->release_time > current_time && entry->thrd->period == current_period) {
    22a0:	fe843783          	ld	a5,-24(s0)
    22a4:	4f98                	lw	a4,24(a5)
    22a6:	f8c42783          	lw	a5,-116(s0)
    22aa:	2781                	sext.w	a5,a5
    22ac:	04e7dc63          	bge	a5,a4,2304 <find_earliest_impactful_release_time_dm+0x102>
    22b0:	fe843783          	ld	a5,-24(s0)
    22b4:	639c                	ld	a5,0(a5)
    22b6:	4bb8                	lw	a4,80(a5)
    22b8:	f8842783          	lw	a5,-120(s0)
    22bc:	2781                	sext.w	a5,a5
    22be:	04e79363          	bne	a5,a4,2304 <find_earliest_impactful_release_time_dm+0x102>
    ...
    22c6:	4f98                	lw	a4,24(a5)
    22c8:	fdc42783          	lw	a5,-36(s0)
    22cc:	2781                	sext.w	a5,a5
    22ce:	02e7cb63          	blt	a5,a4,2304 <find_earliest_impactful_release_time_dm+0x102>
    22d2:	fe843783          	ld	a5,-24(s0)
    22d6:	639c                	ld	a5,0(a5)
    22d8:	5fd8                	lw	a4,60(a5)
    22da:	fd842783          	lw	a5,-40(s0)
    22de:	2781                	sext.w	a5,a5
    22e0:	02f75263          	bge	a4,a5,2304 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    22e4:	fe843783          	ld	a5,-24(s0)
    22e8:	4f9c                	lw	a5,24(a5)
    22ea:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    22ee:	fe843783          	ld	a5,-24(s0)
    22f2:	639c                	ld	a5,0(a5)
    22f4:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    22f8:	fe843783          	ld	a5,-24(s0)
    22fc:	639c                	ld	a5,0(a5)
    22fe:	5fdc                	lw	a5,60(a5)
    2300:	fcf42c23          	sw	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    2304:	fe843783          	ld	a5,-24(s0)
    2308:	679c                	ld	a5,8(a5)
    230a:	fcf43423          	sd	a5,-56(s0)
    230e:	fc843783          	ld	a5,-56(s0)
    2312:	17e1                	addi	a5,a5,-8
    2314:	fef43423          	sd	a5,-24(s0)
    2318:	fe843783          	ld	a5,-24(s0)
    231c:	07a1                	addi	a5,a5,8
    231e:	f9843703          	ld	a4,-104(s0)
    2322:	f2f715e3          	bne	a4,a5,224c <find_earliest_impactful_release_time_dm+0x4a>
            }
        }
    }
    ...
    2326:	fdc42783          	lw	a5,-36(s0)
    232a:	0007871b          	sext.w	a4,a5
    232e:	800007b7          	lui	a5,0x80000
    2332:	fff7c793          	not	a5,a5
    2336:	00f70563          	beq	a4,a5,2340 <find_earliest_impactful_release_time_dm+0x13e>
    233a:	fdc42783          	lw	a5,-36(s0)
    233e:	a011                	j	2342 <find_earliest_impactful_release_time_dm+0x140>
    2340:	57fd                	li	a5,-1
    2342:	fcf42e23          	sw	a5,-36(s0)
    return (ImpactfulEvent) {earliest_impactful_event, t};
    2346:	fdc42783          	lw	a5,-36(s0)
    234a:	faf42c23          	sw	a5,-72(s0)
    234e:	fe043783          	ld	a5,-32(s0)
    2352:	fcf43023          	sd	a5,-64(s0)
    2356:	4701                	li	a4,0
    2358:	fb843703          	ld	a4,-72(s0)
    235c:	4781                	li	a5,0
    ...
    236a:	853a                	mv	a0,a4
    236c:	85be                	mv	a1,a5
    236e:	7466                	ld	s0,120(sp)
    2370:	6109                	addi	sp,sp,128
    2372:	8082                	ret

0000000000002374 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    2374:	7135                	addi	sp,sp,-160
    2376:	ed06                	sd	ra,152(sp)
    2378:	e922                	sd	s0,144(sp)
    237a:	e526                	sd	s1,136(sp)
    237c:	e14a                	sd	s2,128(sp)
    237e:	fcce                	sd	s3,120(sp)
    2380:	1100                	addi	s0,sp,160
    2382:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    2384:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    2388:	800007b7          	lui	a5,0x80000
    238c:	fff7c793          	not	a5,a5
    2390:	faf42e23          	sw	a5,-68(s0)
    int earliest_impactful_deadline; 
    
    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    2394:	649c                	ld	a5,8(s1)
    2396:	639c                	ld	a5,0(a5)
    2398:	faf43823          	sd	a5,-80(s0)
    239c:	fb043783          	ld	a5,-80(s0)
    23a0:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffd128>
    23a4:	fcf43023          	sd	a5,-64(s0)
    23a8:	a8bd                	j	2426 <schedule_dm+0xb2>
        if (t->is_real_time && t->period < earliest_deadline) {
    23aa:	fc043783          	ld	a5,-64(s0)
    23ae:	43bc                	lw	a5,64(a5)
    23b0:	c39d                	beqz	a5,23d6 <schedule_dm+0x62>
    23b2:	fc043783          	ld	a5,-64(s0)
    23b6:	4bb8                	lw	a4,80(a5)
    23b8:	fbc42783          	lw	a5,-68(s0)
    23bc:	2781                	sext.w	a5,a5
    23be:	00f75c63          	bge	a4,a5,23d6 <schedule_dm+0x62>
            earliest_deadline_thread = t;
    23c2:	fc043783          	ld	a5,-64(s0)
    23c6:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    23ca:	fc043783          	ld	a5,-64(s0)
    23ce:	4bbc                	lw	a5,80(a5)
    23d0:	faf42e23          	sw	a5,-68(s0)
    23d4:	a835                	j	2410 <schedule_dm+0x9c>
        } else if (t->is_real_time && t->period == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    23d6:	fc043783          	ld	a5,-64(s0)
    23da:	43bc                	lw	a5,64(a5)
    23dc:	cb95                	beqz	a5,2410 <schedule_dm+0x9c>
    23de:	fc043783          	ld	a5,-64(s0)
    23e2:	4bb8                	lw	a4,80(a5)
    23e4:	fbc42783          	lw	a5,-68(s0)
    23e8:	2781                	sext.w	a5,a5
    23ea:	02e79363          	bne	a5,a4,2410 <schedule_dm+0x9c>
    23ee:	fc043783          	ld	a5,-64(s0)
    23f2:	5fd8                	lw	a4,60(a5)
    23f4:	fc843783          	ld	a5,-56(s0)
    23f8:	5fdc                	lw	a5,60(a5)
    23fa:	00f75b63          	bge	a4,a5,2410 <schedule_dm+0x9c>
            earliest_deadline_thread = t;
    23fe:	fc043783          	ld	a5,-64(s0)
    2402:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    2406:	fc043783          	ld	a5,-64(s0)
    240a:	4bbc                	lw	a5,80(a5)
    240c:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    2410:	fc043783          	ld	a5,-64(s0)
    2414:	779c                	ld	a5,40(a5)
    2416:	f8f43c23          	sd	a5,-104(s0)
    241a:	f9843783          	ld	a5,-104(s0)
    241e:	fd878793          	addi	a5,a5,-40
    2422:	fcf43023          	sd	a5,-64(s0)
    2426:	fc043783          	ld	a5,-64(s0)
    242a:	02878713          	addi	a4,a5,40
    242e:	649c                	ld	a5,8(s1)
    2430:	f6f71de3          	bne	a4,a5,23aa <schedule_dm+0x36>
        }
    }
    ...
    2434:	6888                	ld	a0,16(s1)
    2436:	648c                	ld	a1,8(s1)
    2438:	4090                	lw	a2,0(s1)
    243a:	fc843783          	ld	a5,-56(s0)
    243e:	c789                	beqz	a5,2448 <schedule_dm+0xd4>
    2440:	fc843783          	ld	a5,-56(s0)
    2444:	4bbc                	lw	a5,80(a5)
    2446:	a029                	j	2450 <schedule_dm+0xdc>
    2448:	800007b7          	lui	a5,0x80000
    244c:	fff7c793          	not	a5,a5
    2450:	fc843703          	ld	a4,-56(s0)
    2454:	5f58                	lw	a4,60(a4)
    2456:	86be                	mv	a3,a5
    2458:	00000097          	auipc	ra,0x0
    245c:	daa080e7          	jalr	-598(ra) # 2202 <find_earliest_impactful_release_time_dm>
    2460:	872a                	mv	a4,a0
    2462:	87ae                	mv	a5,a1
    2464:	f6e43423          	sd	a4,-152(s0)
    2468:	f6f43823          	sd	a5,-144(s0)
    earliest_impactful_deadline = earliest_impactful_event.earliest_impactful_event;
    246c:	f6842783          	lw	a5,-152(s0)
    2470:	faf42623          	sw	a5,-84(s0)
    //printf("earliest_impactful_deadline: %d\n", earliest_impactful_deadline);
    if (earliest_deadline_thread) {
    2474:	fc843783          	ld	a5,-56(s0)
    2478:	cfd9                	beqz	a5,2516 <schedule_dm+0x1a2>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    247a:	fc843783          	ld	a5,-56(s0)
    247e:	4ff8                	lw	a4,92(a5)
    2480:	409c                	lw	a5,0(s1)
    2482:	40f707bb          	subw	a5,a4,a5
    2486:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline <= 0) {
    248a:	fa842783          	lw	a5,-88(s0)
    248e:	2781                	sext.w	a5,a5
    2490:	00f04b63          	bgtz	a5,24a6 <schedule_dm+0x132>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    2494:	fc843783          	ld	a5,-56(s0)
    2498:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffd178>
    249c:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    24a0:	f8042023          	sw	zero,-128(s0)
    24a4:	a079                	j	2532 <schedule_dm+0x1be>
        } else {
    ...
    24a6:	fc843783          	ld	a5,-56(s0)
    24aa:	4fbc                	lw	a5,88(a5)
    24ac:	fa842703          	lw	a4,-88(s0)
    24b0:	85ba                	mv	a1,a4
    24b2:	853e                	mv	a0,a5
    24b4:	00000097          	auipc	ra,0x0
    24b8:	9c8080e7          	jalr	-1592(ra) # 1e7c <min>
    24bc:	87aa                	mv	a5,a0
    24be:	faf42223          	sw	a5,-92(s0)
            int allocated_time;
            if (earliest_impactful_deadline != -1 && (earliest_impactful_deadline - args.current_time) < remaining_time){
    24c2:	fac42783          	lw	a5,-84(s0)
    24c6:	0007871b          	sext.w	a4,a5
    24ca:	57fd                	li	a5,-1
    24cc:	02f70663          	beq	a4,a5,24f8 <schedule_dm+0x184>
    24d0:	409c                	lw	a5,0(s1)
    24d2:	fac42703          	lw	a4,-84(s0)
    24d6:	40f707bb          	subw	a5,a4,a5
    24da:	0007871b          	sext.w	a4,a5
    24de:	fa442783          	lw	a5,-92(s0)
    24e2:	2781                	sext.w	a5,a5
    24e4:	00f75a63          	bge	a4,a5,24f8 <schedule_dm+0x184>
                allocated_time = earliest_impactful_deadline - args.current_time;
    24e8:	409c                	lw	a5,0(s1)
    24ea:	fac42703          	lw	a4,-84(s0)
    24ee:	40f707bb          	subw	a5,a4,a5
    24f2:	faf42c23          	sw	a5,-72(s0)
    24f6:	a029                	j	2500 <schedule_dm+0x18c>
            } else {
                allocated_time = remaining_time;
    24f8:	fa442783          	lw	a5,-92(s0)
    24fc:	faf42c23          	sw	a5,-72(s0)
            }
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    2500:	fc843783          	ld	a5,-56(s0)
    2504:	02878793          	addi	a5,a5,40
    2508:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    250c:	fb842783          	lw	a5,-72(s0)
    2510:	f8f42023          	sw	a5,-128(s0)
    2514:	a839                	j	2532 <schedule_dm+0x1be>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    2516:	649c                	ld	a5,8(s1)
    2518:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    251c:	689c                	ld	a5,16(s1)
    251e:	4098                	lw	a4,0(s1)
    2520:	85ba                	mv	a1,a4
    2522:	853e                	mv	a0,a5
    2524:	fffff097          	auipc	ra,0xfffff
    2528:	4ba080e7          	jalr	1210(ra) # 19de <find_next_release_time>
    252c:	87aa                	mv	a5,a0
    252e:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    2532:	f7843783          	ld	a5,-136(s0)
    2536:	f8f43423          	sd	a5,-120(s0)
    253a:	f8043783          	ld	a5,-128(s0)
    253e:	f8f43823          	sd	a5,-112(s0)
    2542:	4701                	li	a4,0
    2544:	f8843703          	ld	a4,-120(s0)
    2548:	4781                	li	a5,0
    254a:	f9043783          	ld	a5,-112(s0)
    254e:	893a                	mv	s2,a4
    2550:	89be                	mv	s3,a5
    2552:	874a                	mv	a4,s2
    2554:	87ce                	mv	a5,s3
    ...
    2556:	853a                	mv	a0,a4
    2558:	85be                	mv	a1,a5
    255a:	60ea                	ld	ra,152(sp)
    255c:	644a                	ld	s0,144(sp)
    255e:	64aa                	ld	s1,136(sp)
    2560:	690a                	ld	s2,128(sp)
    2562:	79e6                	ld	s3,120(sp)
    2564:	610d                	addi	sp,sp,160
    2566:	8082                	ret

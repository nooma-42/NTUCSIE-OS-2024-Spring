...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     66e:	36e68693          	addi	a3,a3,878 # 19d8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     748:	29470713          	addi	a4,a4,660 # 19d8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     908:	0cc78793          	addi	a5,a5,204 # 19d0 <schedule_dm+0x1fa>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     ab4:	f5078793          	addi	a5,a5,-176 # 1a00 <freep>
     ab8:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bac:	e5878793          	addi	a5,a5,-424 # 1a00 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c2e:	dd678793          	addi	a5,a5,-554 # 1a00 <freep>
     c32:	639c                	ld	a5,0(a5)
}
     c34:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c60:	da478793          	addi	a5,a5,-604 # 1a00 <freep>
     c64:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     c74:	d8078793          	addi	a5,a5,-640 # 19f0 <base>
     c78:	fef43023          	sd	a5,-32(s0)
     c7c:	00001797          	auipc	a5,0x1
     c80:	d8478793          	addi	a5,a5,-636 # 1a00 <freep>
     c84:	fe043703          	ld	a4,-32(s0)
     c88:	e398                	sd	a4,0(a5)
     c8a:	00001797          	auipc	a5,0x1
     c8e:	d7678793          	addi	a5,a5,-650 # 1a00 <freep>
     c92:	6398                	ld	a4,0(a5)
     c94:	00001797          	auipc	a5,0x1
     c98:	d5c78793          	addi	a5,a5,-676 # 19f0 <base>
     c9c:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     c9e:	00001797          	auipc	a5,0x1
     ca2:	d5278793          	addi	a5,a5,-686 # 19f0 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d1e:	ce678793          	addi	a5,a5,-794 # 1a00 <freep>
    ...
    if(p == freep)
     ...
     d34:	cd078793          	addi	a5,a5,-816 # 1a00 <freep>
     d38:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    if (last_thread == NULL || last_thread->remaining_time <= 0) {
     ...
     f0c:	b0078793          	addi	a5,a5,-1280 # 1a08 <last_thread.1239>
     f10:	639c                	ld	a5,0(a5)
     f12:	cb89                	beqz	a5,f24 <schedule_wrr+0x34>
     f14:	00001797          	auipc	a5,0x1
     f18:	af478793          	addi	a5,a5,-1292 # 1a08 <last_thread.1239>
     f1c:	639c                	ld	a5,0(a5)
     f1e:	4fbc                	lw	a5,88(a5)
     f20:	00f04863          	bgtz	a5,f30 <schedule_wrr+0x40>
        last_thread = NULL;
     f24:	00001797          	auipc	a5,0x1
     f28:	ae478793          	addi	a5,a5,-1308 # 1a08 <last_thread.1239>
    ...
    list_for_each_entry(candidate, args.run_queue, thread_list) {
     ...
     f4a:	ac278793          	addi	a5,a5,-1342 # 1a08 <last_thread.1239>
     f4e:	639c                	ld	a5,0(a5)
    ...
    1012:	9fa78793          	addi	a5,a5,-1542 # 1a08 <last_thread.1239>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    10aa:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffde00>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    11dc:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffde00>
...
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    ...
    1336:	f8f43823          	sd	a5,-112(s0)
    133a:	f9043783          	ld	a5,-112(s0)
    133e:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffde00>
    ...
    13b2:	f5442783          	lw	a5,-172(s0)
    13b6:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    13ba:	fb843783          	ld	a5,-72(s0)
    13be:	779c                	ld	a5,40(a5)
    13c0:	f4f43423          	sd	a5,-184(s0)
    13c4:	f4843783          	ld	a5,-184(s0)
    13c8:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffde00>
    ...
    13ee:	f8f43423          	sd	a5,-120(s0)
    13f2:	f8843783          	ld	a5,-120(s0)
    ...
    14ba:	f4f43c23          	sd	a5,-168(s0)
    14be:	f5843783          	ld	a5,-168(s0)
    14c2:	17e1                	addi	a5,a5,-8
    14c4:	faf43423          	sd	a5,-88(s0)
    14c8:	fa843783          	ld	a5,-88(s0)
    14cc:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffde30>
    ...
    14da:	10078b63          	beqz	a5,15f0 <schedule_lst+0x2de>
    ...
    14e4:	4ffc                	lw	a5,92(a5)
    14e6:	08f74863          	blt	a4,a5,1576 <schedule_lst+0x264>
    14ea:	fc843783          	ld	a5,-56(s0)
    14ee:	4fbc                	lw	a5,88(a5)
    14f0:	08f05363          	blez	a5,1576 <schedule_lst+0x264>
            struct thread *thread_with_smallest_id = min_slack_thread;
    14f4:	fc843783          	ld	a5,-56(s0)
    14f8:	faf43023          	sd	a5,-96(s0)
            // Iterate again to find if there are other threads that also missed their deadlines and have smaller IDs
            list_for_each_entry(t, args.run_queue, thread_list) {
    14fc:	649c                	ld	a5,8(s1)
    14fe:	639c                	ld	a5,0(a5)
    1500:	f8f43023          	sd	a5,-128(s0)
    1504:	f8043783          	ld	a5,-128(s0)
    1508:	fd878793          	addi	a5,a5,-40
    150c:	faf43c23          	sd	a5,-72(s0)
    1510:	a099                	j	1556 <schedule_lst+0x244>
                if (args.current_time >= t->current_deadline && t->remaining_time > 0 && t->ID < thread_with_smallest_id->ID) {
    1512:	4098                	lw	a4,0(s1)
    1514:	fb843783          	ld	a5,-72(s0)
    1518:	4ffc                	lw	a5,92(a5)
    151a:	02f74363          	blt	a4,a5,1540 <schedule_lst+0x22e>
    151e:	fb843783          	ld	a5,-72(s0)
    1522:	4fbc                	lw	a5,88(a5)
    1524:	00f05e63          	blez	a5,1540 <schedule_lst+0x22e>
    1528:	fb843783          	ld	a5,-72(s0)
    152c:	5fd8                	lw	a4,60(a5)
    152e:	fa043783          	ld	a5,-96(s0)
    1532:	5fdc                	lw	a5,60(a5)
    1534:	00f75663          	bge	a4,a5,1540 <schedule_lst+0x22e>
    ...
    1552:	faf43c23          	sd	a5,-72(s0)
    1556:	fb843783          	ld	a5,-72(s0)
    155a:	02878713          	addi	a4,a5,40
    155e:	649c                	ld	a5,8(s1)
    1560:	faf719e3          	bne	a4,a5,1512 <schedule_lst+0x200>
                }
            }
            r.scheduled_thread_list_member = &thread_with_smallest_id->thread_list;
    1564:	fa043783          	ld	a5,-96(s0)
    1568:	02878793          	addi	a5,a5,40
    156c:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = 0;
    1570:	f2042823          	sw	zero,-208(s0)
        if (args.current_time >= min_slack_thread->current_deadline && min_slack_thread->remaining_time > 0) {
    1574:	a86d                	j	162e <schedule_lst+0x31c>
        } else {
    ...
    157c:	409c                	lw	a5,0(s1)
    157e:	40f707bb          	subw	a5,a4,a5
    1582:	f6f42a23          	sw	a5,-140(s0)
            
            // Decide the allocated time based on current minimum slack or upcoming preemption needs
            int allocated_time = min(min_slack_thread->remaining_time, time_until_deadline);
    1586:	fc843783          	ld	a5,-56(s0)
    158a:	4fbc                	lw	a5,88(a5)
    158c:	f7442703          	lw	a4,-140(s0)
    1590:	85ba                	mv	a1,a4
    1592:	853e                	mv	a0,a5
    1594:	00000097          	auipc	ra,0x0
    1598:	d4a080e7          	jalr	-694(ra) # 12de <min>
    159c:	87aa                	mv	a5,a0
    159e:	f8f42e23          	sw	a5,-100(s0)
            if (next_significant_event_time != INT_MAX) {
    15a2:	fb442783          	lw	a5,-76(s0)
    15a6:	0007871b          	sext.w	a4,a5
    15aa:	800007b7          	lui	a5,0x80000
    15ae:	fff7c793          	not	a5,a5
    15b2:	02f70463          	beq	a4,a5,15da <schedule_lst+0x2c8>
                allocated_time = min(allocated_time, next_significant_event_time - args.current_time);
    15b6:	409c                	lw	a5,0(s1)
    15b8:	fb442703          	lw	a4,-76(s0)
    15bc:	40f707bb          	subw	a5,a4,a5
    15c0:	0007871b          	sext.w	a4,a5
    15c4:	f9c42783          	lw	a5,-100(s0)
    15c8:	85ba                	mv	a1,a4
    15ca:	853e                	mv	a0,a5
    15cc:	00000097          	auipc	ra,0x0
    15d0:	d12080e7          	jalr	-750(ra) # 12de <min>
    15d4:	87aa                	mv	a5,a0
    15d6:	f8f42e23          	sw	a5,-100(s0)
            }

            r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    15da:	fc843783          	ld	a5,-56(s0)
    15de:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffde50>
    15e2:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = allocated_time;
    15e6:	f9c42783          	lw	a5,-100(s0)
    15ea:	f2f42823          	sw	a5,-208(s0)
    15ee:	a081                	j	162e <schedule_lst+0x31c>
        }
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    15f0:	649c                	ld	a5,8(s1)
    15f2:	f2f43423          	sd	a5,-216(s0)
    ...
    15f6:	fb442783          	lw	a5,-76(s0)
    15fa:	0007871b          	sext.w	a4,a5
    15fe:	800007b7          	lui	a5,0x80000
    1602:	fff7c793          	not	a5,a5
    1606:	00f70963          	beq	a4,a5,1618 <schedule_lst+0x306>
    160a:	409c                	lw	a5,0(s1)
    160c:	fb442703          	lw	a4,-76(s0)
    1610:	40f707bb          	subw	a5,a4,a5
    1614:	2781                	sext.w	a5,a5
    1616:	a811                	j	162a <schedule_lst+0x318>
    1618:	689c                	ld	a5,16(s1)
    161a:	4098                	lw	a4,0(s1)
    161c:	85ba                	mv	a1,a4
    161e:	853e                	mv	a0,a5
    1620:	00000097          	auipc	ra,0x0
    1624:	820080e7          	jalr	-2016(ra) # e40 <find_next_release_time>
    1628:	87aa                	mv	a5,a0
    162a:	f2f42823          	sw	a5,-208(s0)
    }

    return r;
    162e:	f2843783          	ld	a5,-216(s0)
    1632:	f2f43c23          	sd	a5,-200(s0)
    1636:	f3043783          	ld	a5,-208(s0)
    163a:	f4f43023          	sd	a5,-192(s0)
    163e:	4701                	li	a4,0
    1640:	f3843703          	ld	a4,-200(s0)
    1644:	4781                	li	a5,0
    1646:	f4043783          	ld	a5,-192(s0)
    164a:	893a                	mv	s2,a4
    164c:	89be                	mv	s3,a5
    164e:	874a                	mv	a4,s2
    1650:	87ce                	mv	a5,s3
    ...
    1652:	853a                	mv	a0,a4
    1654:	85be                	mv	a1,a5
    1656:	60ee                	ld	ra,216(sp)
    1658:	644e                	ld	s0,208(sp)
    165a:	64ae                	ld	s1,200(sp)
    165c:	690e                	ld	s2,192(sp)
    165e:	79ea                	ld	s3,184(sp)
    1660:	612d                	addi	sp,sp,224
    1662:	8082                	ret

0000000000001664 <find_earliest_impactful_release_time_dm>:
typedef struct {
...
ImpactfulEvent find_earliest_impactful_release_time_dm(struct list_head *release_queue, struct list_head*run_queue, int current_time, int current_period, int current_thread_ID) {
    1664:	7119                	addi	sp,sp,-128
    1666:	fca2                	sd	s0,120(sp)
    1668:	0100                	addi	s0,sp,128
    166a:	f8a43c23          	sd	a0,-104(s0)
    166e:	f8b43823          	sd	a1,-112(s0)
    1672:	87b2                	mv	a5,a2
    1674:	f8f42623          	sw	a5,-116(s0)
    1678:	87b6                	mv	a5,a3
    167a:	f8f42423          	sw	a5,-120(s0)
    167e:	87ba                	mv	a5,a4
    1680:	f8f42223          	sw	a5,-124(s0)
    struct release_queue_entry *entry;
    struct thread *t;
    int earliest_impactful_event = INT_MAX;
    1684:	800007b7          	lui	a5,0x80000
    1688:	fff7c793          	not	a5,a5
    168c:	fcf42e23          	sw	a5,-36(s0)
    int earliest_impactful_thread_ID = current_thread_ID;    
    1690:	f8442783          	lw	a5,-124(s0)
    1694:	fcf42c23          	sw	a5,-40(s0)
    
    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    1698:	f9843783          	ld	a5,-104(s0)
    169c:	639c                	ld	a5,0(a5)
    169e:	fcf43823          	sd	a5,-48(s0)
    16a2:	fd043783          	ld	a5,-48(s0)
    16a6:	17e1                	addi	a5,a5,-8
    16a8:	fef43423          	sd	a5,-24(s0)
    16ac:	a0f9                	j	177a <find_earliest_impactful_release_time_dm+0x116>
        if (entry->release_time > current_time && entry->thrd->period < current_period) {
    16ae:	fe843783          	ld	a5,-24(s0)
    16b2:	4f98                	lw	a4,24(a5)
    16b4:	f8c42783          	lw	a5,-116(s0)
    16b8:	2781                	sext.w	a5,a5
    16ba:	04e7d463          	bge	a5,a4,1702 <find_earliest_impactful_release_time_dm+0x9e>
    16be:	fe843783          	ld	a5,-24(s0)
    16c2:	639c                	ld	a5,0(a5)
    16c4:	4bb8                	lw	a4,80(a5)
    16c6:	f8842783          	lw	a5,-120(s0)
    16ca:	2781                	sext.w	a5,a5
    16cc:	02f75b63          	bge	a4,a5,1702 <find_earliest_impactful_release_time_dm+0x9e>
            if (entry->release_time < earliest_impactful_event) {
    16d0:	fe843783          	ld	a5,-24(s0)
    16d4:	4f98                	lw	a4,24(a5)
    16d6:	fdc42783          	lw	a5,-36(s0)
    16da:	2781                	sext.w	a5,a5
    16dc:	08f75563          	bge	a4,a5,1766 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    16e0:	fe843783          	ld	a5,-24(s0)
    16e4:	4f9c                	lw	a5,24(a5)
    16e6:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    16ea:	fe843783          	ld	a5,-24(s0)
    16ee:	639c                	ld	a5,0(a5)
    16f0:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    16f4:	fe843783          	ld	a5,-24(s0)
    16f8:	639c                	ld	a5,0(a5)
    16fa:	5fdc                	lw	a5,60(a5)
    16fc:	fcf42c23          	sw	a5,-40(s0)
            if (entry->release_time < earliest_impactful_event) {
    1700:	a09d                	j	1766 <find_earliest_impactful_release_time_dm+0x102>
            }
        } 
        else if (entry->release_time > current_time && entry->thrd->period == current_period) {
    1702:	fe843783          	ld	a5,-24(s0)
    1706:	4f98                	lw	a4,24(a5)
    1708:	f8c42783          	lw	a5,-116(s0)
    170c:	2781                	sext.w	a5,a5
    170e:	04e7dc63          	bge	a5,a4,1766 <find_earliest_impactful_release_time_dm+0x102>
    1712:	fe843783          	ld	a5,-24(s0)
    1716:	639c                	ld	a5,0(a5)
    1718:	4bb8                	lw	a4,80(a5)
    171a:	f8842783          	lw	a5,-120(s0)
    171e:	2781                	sext.w	a5,a5
    1720:	04e79363          	bne	a5,a4,1766 <find_earliest_impactful_release_time_dm+0x102>
    ...
    1728:	4f98                	lw	a4,24(a5)
    172a:	fdc42783          	lw	a5,-36(s0)
    172e:	2781                	sext.w	a5,a5
    1730:	02e7cb63          	blt	a5,a4,1766 <find_earliest_impactful_release_time_dm+0x102>
    1734:	fe843783          	ld	a5,-24(s0)
    1738:	639c                	ld	a5,0(a5)
    173a:	5fd8                	lw	a4,60(a5)
    173c:	fd842783          	lw	a5,-40(s0)
    1740:	2781                	sext.w	a5,a5
    1742:	02f75263          	bge	a4,a5,1766 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    1746:	fe843783          	ld	a5,-24(s0)
    174a:	4f9c                	lw	a5,24(a5)
    174c:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    ...
    1760:	5fdc                	lw	a5,60(a5)
    1762:	fcf42c23          	sw	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    1766:	fe843783          	ld	a5,-24(s0)
    176a:	679c                	ld	a5,8(a5)
    176c:	fcf43423          	sd	a5,-56(s0)
    1770:	fc843783          	ld	a5,-56(s0)
    1774:	17e1                	addi	a5,a5,-8
    1776:	fef43423          	sd	a5,-24(s0)
    177a:	fe843783          	ld	a5,-24(s0)
    177e:	07a1                	addi	a5,a5,8
    1780:	f9843703          	ld	a4,-104(s0)
    1784:	f2f715e3          	bne	a4,a5,16ae <find_earliest_impactful_release_time_dm+0x4a>
            }
        }
    }
    ...
    1790:	800007b7          	lui	a5,0x80000
    1794:	fff7c793          	not	a5,a5
    1798:	00f70563          	beq	a4,a5,17a2 <find_earliest_impactful_release_time_dm+0x13e>
    179c:	fdc42783          	lw	a5,-36(s0)
    17a0:	a011                	j	17a4 <find_earliest_impactful_release_time_dm+0x140>
    17a2:	57fd                	li	a5,-1
    17a4:	fcf42e23          	sw	a5,-36(s0)
    return (ImpactfulEvent) {earliest_impactful_event, t};
    17a8:	fdc42783          	lw	a5,-36(s0)
    17ac:	faf42c23          	sw	a5,-72(s0)
    17b0:	fe043783          	ld	a5,-32(s0)
    17b4:	fcf43023          	sd	a5,-64(s0)
    17b8:	4701                	li	a4,0
    17ba:	fb843703          	ld	a4,-72(s0)
    17be:	4781                	li	a5,0
    ...
    17cc:	853a                	mv	a0,a4
    17ce:	85be                	mv	a1,a5
    17d0:	7466                	ld	s0,120(sp)
    17d2:	6109                	addi	sp,sp,128
    17d4:	8082                	ret

00000000000017d6 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    17d6:	7135                	addi	sp,sp,-160
    17d8:	ed06                	sd	ra,152(sp)
    17da:	e922                	sd	s0,144(sp)
    17dc:	e526                	sd	s1,136(sp)
    17de:	e14a                	sd	s2,128(sp)
    17e0:	fcce                	sd	s3,120(sp)
    17e2:	1100                	addi	s0,sp,160
    17e4:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    17e6:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    17ea:	800007b7          	lui	a5,0x80000
    17ee:	fff7c793          	not	a5,a5
    17f2:	faf42e23          	sw	a5,-68(s0)
    int earliest_impactful_deadline; 
    
    // Determine the earliest deadline among current tasks
    list_for_each_entry(t, args.run_queue, thread_list) {
    17f6:	649c                	ld	a5,8(s1)
    17f8:	639c                	ld	a5,0(a5)
    17fa:	faf43823          	sd	a5,-80(s0)
    17fe:	fb043783          	ld	a5,-80(s0)
    1802:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffde00>
    1806:	fcf43023          	sd	a5,-64(s0)
    180a:	a8bd                	j	1888 <schedule_dm+0xb2>
        if (t->is_real_time && t->period < earliest_deadline) {
    180c:	fc043783          	ld	a5,-64(s0)
    1810:	43bc                	lw	a5,64(a5)
    1812:	c39d                	beqz	a5,1838 <schedule_dm+0x62>
    1814:	fc043783          	ld	a5,-64(s0)
    1818:	4bb8                	lw	a4,80(a5)
    181a:	fbc42783          	lw	a5,-68(s0)
    181e:	2781                	sext.w	a5,a5
    1820:	00f75c63          	bge	a4,a5,1838 <schedule_dm+0x62>
            earliest_deadline_thread = t;
    1824:	fc043783          	ld	a5,-64(s0)
    1828:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    182c:	fc043783          	ld	a5,-64(s0)
    1830:	4bbc                	lw	a5,80(a5)
    1832:	faf42e23          	sw	a5,-68(s0)
    1836:	a835                	j	1872 <schedule_dm+0x9c>
        } else if (t->is_real_time && t->period == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    1838:	fc043783          	ld	a5,-64(s0)
    183c:	43bc                	lw	a5,64(a5)
    183e:	cb95                	beqz	a5,1872 <schedule_dm+0x9c>
    1840:	fc043783          	ld	a5,-64(s0)
    1844:	4bb8                	lw	a4,80(a5)
    1846:	fbc42783          	lw	a5,-68(s0)
    184a:	2781                	sext.w	a5,a5
    184c:	02e79363          	bne	a5,a4,1872 <schedule_dm+0x9c>
    1850:	fc043783          	ld	a5,-64(s0)
    1854:	5fd8                	lw	a4,60(a5)
    1856:	fc843783          	ld	a5,-56(s0)
    185a:	5fdc                	lw	a5,60(a5)
    185c:	00f75b63          	bge	a4,a5,1872 <schedule_dm+0x9c>
            earliest_deadline_thread = t;
    1860:	fc043783          	ld	a5,-64(s0)
    1864:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    1868:	fc043783          	ld	a5,-64(s0)
    186c:	4bbc                	lw	a5,80(a5)
    186e:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1872:	fc043783          	ld	a5,-64(s0)
    1876:	779c                	ld	a5,40(a5)
    1878:	f8f43c23          	sd	a5,-104(s0)
    187c:	f9843783          	ld	a5,-104(s0)
    1880:	fd878793          	addi	a5,a5,-40
    1884:	fcf43023          	sd	a5,-64(s0)
    1888:	fc043783          	ld	a5,-64(s0)
    188c:	02878713          	addi	a4,a5,40
    1890:	649c                	ld	a5,8(s1)
    1892:	f6f71de3          	bne	a4,a5,180c <schedule_dm+0x36>
        }
    }
    ...
    1896:	6888                	ld	a0,16(s1)
    1898:	648c                	ld	a1,8(s1)
    189a:	4090                	lw	a2,0(s1)
    189c:	fc843783          	ld	a5,-56(s0)
    18a0:	c789                	beqz	a5,18aa <schedule_dm+0xd4>
    18a2:	fc843783          	ld	a5,-56(s0)
    18a6:	4bbc                	lw	a5,80(a5)
    18a8:	a029                	j	18b2 <schedule_dm+0xdc>
    18aa:	800007b7          	lui	a5,0x80000
    18ae:	fff7c793          	not	a5,a5
    18b2:	fc843703          	ld	a4,-56(s0)
    18b6:	5f58                	lw	a4,60(a4)
    18b8:	86be                	mv	a3,a5
    18ba:	00000097          	auipc	ra,0x0
    18be:	daa080e7          	jalr	-598(ra) # 1664 <find_earliest_impactful_release_time_dm>
    18c2:	872a                	mv	a4,a0
    18c4:	87ae                	mv	a5,a1
    18c6:	f6e43423          	sd	a4,-152(s0)
    18ca:	f6f43823          	sd	a5,-144(s0)
    earliest_impactful_deadline = earliest_impactful_event.earliest_impactful_event;
    18ce:	f6842783          	lw	a5,-152(s0)
    18d2:	faf42623          	sw	a5,-84(s0)
    //printf("earliest_impactful_deadline: %d\n", earliest_impactful_deadline);
    if (earliest_deadline_thread) {
    18d6:	fc843783          	ld	a5,-56(s0)
    18da:	cfd9                	beqz	a5,1978 <schedule_dm+0x1a2>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    18dc:	fc843783          	ld	a5,-56(s0)
    18e0:	4ff8                	lw	a4,92(a5)
    18e2:	409c                	lw	a5,0(s1)
    18e4:	40f707bb          	subw	a5,a4,a5
    18e8:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline <= 0) {
    18ec:	fa842783          	lw	a5,-88(s0)
    18f0:	2781                	sext.w	a5,a5
    18f2:	00f04b63          	bgtz	a5,1908 <schedule_dm+0x132>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    18f6:	fc843783          	ld	a5,-56(s0)
    18fa:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffde50>
    18fe:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    1902:	f8042023          	sw	zero,-128(s0)
    1906:	a079                	j	1994 <schedule_dm+0x1be>
        } else {
    ...
    190c:	4fbc                	lw	a5,88(a5)
    190e:	fa842703          	lw	a4,-88(s0)
    1912:	85ba                	mv	a1,a4
    1914:	853e                	mv	a0,a5
    1916:	00000097          	auipc	ra,0x0
    191a:	9c8080e7          	jalr	-1592(ra) # 12de <min>
    191e:	87aa                	mv	a5,a0
    1920:	faf42223          	sw	a5,-92(s0)
            int allocated_time;
            if (earliest_impactful_deadline != -1 && (earliest_impactful_deadline - args.current_time) < remaining_time){
    1924:	fac42783          	lw	a5,-84(s0)
    1928:	0007871b          	sext.w	a4,a5
    192c:	57fd                	li	a5,-1
    192e:	02f70663          	beq	a4,a5,195a <schedule_dm+0x184>
    1932:	409c                	lw	a5,0(s1)
    1934:	fac42703          	lw	a4,-84(s0)
    1938:	40f707bb          	subw	a5,a4,a5
    193c:	0007871b          	sext.w	a4,a5
    1940:	fa442783          	lw	a5,-92(s0)
    1944:	2781                	sext.w	a5,a5
    1946:	00f75a63          	bge	a4,a5,195a <schedule_dm+0x184>
                allocated_time = earliest_impactful_deadline - args.current_time;
    194a:	409c                	lw	a5,0(s1)
    194c:	fac42703          	lw	a4,-84(s0)
    1950:	40f707bb          	subw	a5,a4,a5
    1954:	faf42c23          	sw	a5,-72(s0)
    1958:	a029                	j	1962 <schedule_dm+0x18c>
            } else {
                allocated_time = remaining_time;
    195a:	fa442783          	lw	a5,-92(s0)
    195e:	faf42c23          	sw	a5,-72(s0)
            }
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1962:	fc843783          	ld	a5,-56(s0)
    1966:	02878793          	addi	a5,a5,40
    196a:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    196e:	fb842783          	lw	a5,-72(s0)
    1972:	f8f42023          	sw	a5,-128(s0)
    1976:	a839                	j	1994 <schedule_dm+0x1be>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    1978:	649c                	ld	a5,8(s1)
    197a:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    197e:	689c                	ld	a5,16(s1)
    1980:	4098                	lw	a4,0(s1)
    1982:	85ba                	mv	a1,a4
    1984:	853e                	mv	a0,a5
    1986:	fffff097          	auipc	ra,0xfffff
    198a:	4ba080e7          	jalr	1210(ra) # e40 <find_next_release_time>
    198e:	87aa                	mv	a5,a0
    1990:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    1994:	f7843783          	ld	a5,-136(s0)
    1998:	f8f43423          	sd	a5,-120(s0)
    199c:	f8043783          	ld	a5,-128(s0)
    19a0:	f8f43823          	sd	a5,-112(s0)
    19a4:	4701                	li	a4,0
    19a6:	f8843703          	ld	a4,-120(s0)
    19aa:	4781                	li	a5,0
    19ac:	f9043783          	ld	a5,-112(s0)
    19b0:	893a                	mv	s2,a4
    19b2:	89be                	mv	s3,a5
    19b4:	874a                	mv	a4,s2
    19b6:	87ce                	mv	a5,s3
    ...
    19b8:	853a                	mv	a0,a4
    19ba:	85be                	mv	a1,a5
    19bc:	60ea                	ld	ra,152(sp)
    19be:	644a                	ld	s0,144(sp)
    19c0:	64aa                	ld	s1,136(sp)
    19c2:	690a                	ld	s2,128(sp)
    19c4:	79e6                	ld	s3,120(sp)
    19c6:	610d                	addi	sp,sp,160
    19c8:	8082                	ret

...
fmtname(char *path)
{
  ...
  memmove(buf, p, strlen(p));
      ...
      9a:	d5a50513          	addi	a0,a0,-678 # 1df0 <buf.1118>
  ...
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
      ...
      c0:	d3478793          	addi	a5,a5,-716 # 1df0 <buf.1118>
  ...
  return buf;
      ...
      f4:	d0078793          	addi	a5,a5,-768 # 1df0 <buf.1118>
}
      f8:	853e                	mv	a0,a5
      fa:	70e2                	ld	ra,56(sp)
      fc:	7442                	ld	s0,48(sp)
...
ls(char *path)
{
  ...
  if((fd = open(path, 0)) < 0){
    ...
    fprintf(2, "ls: cannot open %s\n", path);
     ...
     13c:	c2858593          	addi	a1,a1,-984 # 1d60 <schedule_dm+0x1fa>
     140:	4509                	li	a0,2
  ...
  if(fstat(fd, &st) < 0){
    ...
    fprintf(2, "ls: cannot stat %s\n", path);
     ...
     16e:	c0e58593          	addi	a1,a1,-1010 # 1d78 <schedule_dm+0x212>
     172:	4509                	li	a0,2
  ...
  case T_FILE:
    printf("%s %d %d %l\n", fmtname(path), st.type, st.ino, st.size);
     ...
     1c4:	bd050513          	addi	a0,a0,-1072 # 1d90 <schedule_dm+0x22a>
  ...
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
     ...
     1f4:	bb050513          	addi	a0,a0,-1104 # 1da0 <schedule_dm+0x23a>
    ...
    *p++ = '/';
    ...
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
     ...
     296:	ae650513          	addi	a0,a0,-1306 # 1d78 <schedule_dm+0x212>
     ...
     2c8:	af450513          	addi	a0,a0,-1292 # 1db8 <schedule_dm+0x252>
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    ls(".");
     ...
     336:	a9650513          	addi	a0,a0,-1386 # 1dc8 <schedule_dm+0x262>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     988:	45468693          	addi	a3,a3,1108 # 1dd8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     a62:	37a70713          	addi	a4,a4,890 # 1dd8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     c22:	1b278793          	addi	a5,a5,434 # 1dd0 <schedule_dm+0x26a>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     dce:	04678793          	addi	a5,a5,70 # 1e10 <freep>
     dd2:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     ec6:	f4e78793          	addi	a5,a5,-178 # 1e10 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     f48:	ecc78793          	addi	a5,a5,-308 # 1e10 <freep>
     f4c:	639c                	ld	a5,0(a5)
}
     f4e:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     f7a:	e9a78793          	addi	a5,a5,-358 # 1e10 <freep>
     f7e:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     f8e:	e7678793          	addi	a5,a5,-394 # 1e00 <base>
     f92:	fef43023          	sd	a5,-32(s0)
     f96:	00001797          	auipc	a5,0x1
     f9a:	e7a78793          	addi	a5,a5,-390 # 1e10 <freep>
     f9e:	fe043703          	ld	a4,-32(s0)
     fa2:	e398                	sd	a4,0(a5)
     fa4:	00001797          	auipc	a5,0x1
     fa8:	e6c78793          	addi	a5,a5,-404 # 1e10 <freep>
     fac:	6398                	ld	a4,0(a5)
     fae:	00001797          	auipc	a5,0x1
     fb2:	e5278793          	addi	a5,a5,-430 # 1e00 <base>
     fb6:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     fb8:	00001797          	auipc	a5,0x1
     fbc:	e4878793          	addi	a5,a5,-440 # 1e00 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1038:	ddc78793          	addi	a5,a5,-548 # 1e10 <freep>
    ...
    104e:	dc678793          	addi	a5,a5,-570 # 1e10 <freep>
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    12da:	b4278793          	addi	a5,a5,-1214 # 1e18 <last_thread.1239>
    ...
    1336:	ae678793          	addi	a5,a5,-1306 # 1e18 <last_thread.1239>
    133a:	639c                	ld	a5,0(a5)
    133c:	c385                	beqz	a5,135c <schedule_wrr+0xdc>
    133e:	00001797          	auipc	a5,0x1
    1342:	ada78793          	addi	a5,a5,-1318 # 1e18 <last_thread.1239>
    ...
    1352:	aca78793          	addi	a5,a5,-1334 # 1e18 <last_thread.1239>
    ...
    13a2:	a7a78793          	addi	a5,a5,-1414 # 1e18 <last_thread.1239>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    143a:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffda00>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    156c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffda00>
...
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    16a2:	7115                	addi	sp,sp,-224
    16a4:	ed86                	sd	ra,216(sp)
    16a6:	e9a2                	sd	s0,208(sp)
    16a8:	e5a6                	sd	s1,200(sp)
    16aa:	e1ca                	sd	s2,192(sp)
    16ac:	fd4e                	sd	s3,184(sp)
    16ae:	1180                	addi	s0,sp,224
    16b0:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    ...
    16c6:	f8f43823          	sd	a5,-112(s0)
    16ca:	f9043783          	ld	a5,-112(s0)
    16ce:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffda00>
    ...
    1742:	f5442783          	lw	a5,-172(s0)
    1746:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    174a:	fb843783          	ld	a5,-72(s0)
    174e:	779c                	ld	a5,40(a5)
    1750:	f4f43423          	sd	a5,-184(s0)
    1754:	f4843783          	ld	a5,-184(s0)
    1758:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffda00>
    ...
    177e:	f8f43423          	sd	a5,-120(s0)
    1782:	f8843783          	ld	a5,-120(s0)
    ...
    184a:	f4f43c23          	sd	a5,-168(s0)
    184e:	f5843783          	ld	a5,-168(s0)
    1852:	17e1                	addi	a5,a5,-8
    1854:	faf43423          	sd	a5,-88(s0)
    1858:	fa843783          	ld	a5,-88(s0)
    185c:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffda30>
    ...
    186a:	10078b63          	beqz	a5,1980 <schedule_lst+0x2de>
    ...
    186e:	4098                	lw	a4,0(s1)
    1870:	fc843783          	ld	a5,-56(s0)
    1874:	4ffc                	lw	a5,92(a5)
    1876:	08f74863          	blt	a4,a5,1906 <schedule_lst+0x264>
    187a:	fc843783          	ld	a5,-56(s0)
    187e:	4fbc                	lw	a5,88(a5)
    1880:	08f05363          	blez	a5,1906 <schedule_lst+0x264>
            struct thread *thread_with_smallest_id = min_slack_thread;
    1884:	fc843783          	ld	a5,-56(s0)
    1888:	faf43023          	sd	a5,-96(s0)
            // Iterate again to find if there are other threads that also missed their deadlines and have smaller IDs
            list_for_each_entry(t, args.run_queue, thread_list) {
    188c:	649c                	ld	a5,8(s1)
    188e:	639c                	ld	a5,0(a5)
    1890:	f8f43023          	sd	a5,-128(s0)
    1894:	f8043783          	ld	a5,-128(s0)
    1898:	fd878793          	addi	a5,a5,-40
    189c:	faf43c23          	sd	a5,-72(s0)
    18a0:	a099                	j	18e6 <schedule_lst+0x244>
                if (args.current_time >= t->current_deadline && t->remaining_time > 0 && t->ID < thread_with_smallest_id->ID) {
    18a2:	4098                	lw	a4,0(s1)
    18a4:	fb843783          	ld	a5,-72(s0)
    18a8:	4ffc                	lw	a5,92(a5)
    18aa:	02f74363          	blt	a4,a5,18d0 <schedule_lst+0x22e>
    18ae:	fb843783          	ld	a5,-72(s0)
    18b2:	4fbc                	lw	a5,88(a5)
    18b4:	00f05e63          	blez	a5,18d0 <schedule_lst+0x22e>
    18b8:	fb843783          	ld	a5,-72(s0)
    18bc:	5fd8                	lw	a4,60(a5)
    18be:	fa043783          	ld	a5,-96(s0)
    18c2:	5fdc                	lw	a5,60(a5)
    18c4:	00f75663          	bge	a4,a5,18d0 <schedule_lst+0x22e>
                    thread_with_smallest_id = t;
    18c8:	fb843783          	ld	a5,-72(s0)
    18cc:	faf43023          	sd	a5,-96(s0)
            list_for_each_entry(t, args.run_queue, thread_list) {
    18d0:	fb843783          	ld	a5,-72(s0)
    18d4:	779c                	ld	a5,40(a5)
    18d6:	f6f43c23          	sd	a5,-136(s0)
    18da:	f7843783          	ld	a5,-136(s0)
    18de:	fd878793          	addi	a5,a5,-40
    18e2:	faf43c23          	sd	a5,-72(s0)
    18e6:	fb843783          	ld	a5,-72(s0)
    18ea:	02878713          	addi	a4,a5,40
    18ee:	649c                	ld	a5,8(s1)
    18f0:	faf719e3          	bne	a4,a5,18a2 <schedule_lst+0x200>
                }
            }
            r.scheduled_thread_list_member = &thread_with_smallest_id->thread_list;
    18f4:	fa043783          	ld	a5,-96(s0)
    18f8:	02878793          	addi	a5,a5,40
    18fc:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = 0;
    1900:	f2042823          	sw	zero,-208(s0)
        if (args.current_time >= min_slack_thread->current_deadline && min_slack_thread->remaining_time > 0) {
    1904:	a86d                	j	19be <schedule_lst+0x31c>
        } else {
    ...
    1912:	f6f42a23          	sw	a5,-140(s0)
            
            // Decide the allocated time based on current minimum slack or upcoming preemption needs
            int allocated_time = min(min_slack_thread->remaining_time, time_until_deadline);
    1916:	fc843783          	ld	a5,-56(s0)
    191a:	4fbc                	lw	a5,88(a5)
    191c:	f7442703          	lw	a4,-140(s0)
    1920:	85ba                	mv	a1,a4
    1922:	853e                	mv	a0,a5
    1924:	00000097          	auipc	ra,0x0
    1928:	d4a080e7          	jalr	-694(ra) # 166e <min>
    192c:	87aa                	mv	a5,a0
    192e:	f8f42e23          	sw	a5,-100(s0)
            if (next_significant_event_time != INT_MAX) {
    1932:	fb442783          	lw	a5,-76(s0)
    1936:	0007871b          	sext.w	a4,a5
    193a:	800007b7          	lui	a5,0x80000
    193e:	fff7c793          	not	a5,a5
    1942:	02f70463          	beq	a4,a5,196a <schedule_lst+0x2c8>
                allocated_time = min(allocated_time, next_significant_event_time - args.current_time);
    1946:	409c                	lw	a5,0(s1)
    1948:	fb442703          	lw	a4,-76(s0)
    194c:	40f707bb          	subw	a5,a4,a5
    1950:	0007871b          	sext.w	a4,a5
    1954:	f9c42783          	lw	a5,-100(s0)
    1958:	85ba                	mv	a1,a4
    195a:	853e                	mv	a0,a5
    195c:	00000097          	auipc	ra,0x0
    1960:	d12080e7          	jalr	-750(ra) # 166e <min>
    1964:	87aa                	mv	a5,a0
    1966:	f8f42e23          	sw	a5,-100(s0)
            }

            r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    196a:	fc843783          	ld	a5,-56(s0)
    196e:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffda50>
    1972:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = allocated_time;
    1976:	f9c42783          	lw	a5,-100(s0)
    197a:	f2f42823          	sw	a5,-208(s0)
    197e:	a081                	j	19be <schedule_lst+0x31c>
        }
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    1980:	649c                	ld	a5,8(s1)
    1982:	f2f43423          	sd	a5,-216(s0)
    ...
    1986:	fb442783          	lw	a5,-76(s0)
    198a:	0007871b          	sext.w	a4,a5
    198e:	800007b7          	lui	a5,0x80000
    1992:	fff7c793          	not	a5,a5
    1996:	00f70963          	beq	a4,a5,19a8 <schedule_lst+0x306>
    199a:	409c                	lw	a5,0(s1)
    199c:	fb442703          	lw	a4,-76(s0)
    19a0:	40f707bb          	subw	a5,a4,a5
    19a4:	2781                	sext.w	a5,a5
    19a6:	a811                	j	19ba <schedule_lst+0x318>
    19a8:	689c                	ld	a5,16(s1)
    19aa:	4098                	lw	a4,0(s1)
    19ac:	85ba                	mv	a1,a4
    19ae:	853e                	mv	a0,a5
    19b0:	00000097          	auipc	ra,0x0
    19b4:	820080e7          	jalr	-2016(ra) # 11d0 <find_next_release_time>
    19b8:	87aa                	mv	a5,a0
    19ba:	f2f42823          	sw	a5,-208(s0)
    }

    return r;
    19be:	f2843783          	ld	a5,-216(s0)
    19c2:	f2f43c23          	sd	a5,-200(s0)
    19c6:	f3043783          	ld	a5,-208(s0)
    19ca:	f4f43023          	sd	a5,-192(s0)
    19ce:	4701                	li	a4,0
    19d0:	f3843703          	ld	a4,-200(s0)
    19d4:	4781                	li	a5,0
    19d6:	f4043783          	ld	a5,-192(s0)
    19da:	893a                	mv	s2,a4
    19dc:	89be                	mv	s3,a5
    19de:	874a                	mv	a4,s2
    19e0:	87ce                	mv	a5,s3
    ...
    19e2:	853a                	mv	a0,a4
    19e4:	85be                	mv	a1,a5
    19e6:	60ee                	ld	ra,216(sp)
    19e8:	644e                	ld	s0,208(sp)
    19ea:	64ae                	ld	s1,200(sp)
    19ec:	690e                	ld	s2,192(sp)
    19ee:	79ea                	ld	s3,184(sp)
    19f0:	612d                	addi	sp,sp,224
    19f2:	8082                	ret

00000000000019f4 <find_earliest_impactful_release_time_dm>:
typedef struct {
...
ImpactfulEvent find_earliest_impactful_release_time_dm(struct list_head *release_queue, struct list_head*run_queue, int current_time, int current_period, int current_thread_ID) {
    19f4:	7119                	addi	sp,sp,-128
    19f6:	fca2                	sd	s0,120(sp)
    19f8:	0100                	addi	s0,sp,128
    19fa:	f8a43c23          	sd	a0,-104(s0)
    19fe:	f8b43823          	sd	a1,-112(s0)
    1a02:	87b2                	mv	a5,a2
    1a04:	f8f42623          	sw	a5,-116(s0)
    1a08:	87b6                	mv	a5,a3
    1a0a:	f8f42423          	sw	a5,-120(s0)
    1a0e:	87ba                	mv	a5,a4
    1a10:	f8f42223          	sw	a5,-124(s0)
    struct release_queue_entry *entry;
    struct thread *t;
    int earliest_impactful_event = INT_MAX;
    1a14:	800007b7          	lui	a5,0x80000
    1a18:	fff7c793          	not	a5,a5
    1a1c:	fcf42e23          	sw	a5,-36(s0)
    int earliest_impactful_thread_ID = current_thread_ID;    
    1a20:	f8442783          	lw	a5,-124(s0)
    1a24:	fcf42c23          	sw	a5,-40(s0)
    
    // Look for the smallest deadline that is less than the current task's deadline
    list_for_each_entry(entry, release_queue, thread_list) {
    1a28:	f9843783          	ld	a5,-104(s0)
    1a2c:	639c                	ld	a5,0(a5)
    1a2e:	fcf43823          	sd	a5,-48(s0)
    1a32:	fd043783          	ld	a5,-48(s0)
    1a36:	17e1                	addi	a5,a5,-8
    1a38:	fef43423          	sd	a5,-24(s0)
    1a3c:	a0f9                	j	1b0a <find_earliest_impactful_release_time_dm+0x116>
        if (entry->release_time > current_time && entry->thrd->period < current_period) {
    1a3e:	fe843783          	ld	a5,-24(s0)
    1a42:	4f98                	lw	a4,24(a5)
    1a44:	f8c42783          	lw	a5,-116(s0)
    1a48:	2781                	sext.w	a5,a5
    1a4a:	04e7d463          	bge	a5,a4,1a92 <find_earliest_impactful_release_time_dm+0x9e>
    1a4e:	fe843783          	ld	a5,-24(s0)
    1a52:	639c                	ld	a5,0(a5)
    1a54:	4bb8                	lw	a4,80(a5)
    1a56:	f8842783          	lw	a5,-120(s0)
    1a5a:	2781                	sext.w	a5,a5
    1a5c:	02f75b63          	bge	a4,a5,1a92 <find_earliest_impactful_release_time_dm+0x9e>
            if (entry->release_time < earliest_impactful_event) {
    1a60:	fe843783          	ld	a5,-24(s0)
    1a64:	4f98                	lw	a4,24(a5)
    1a66:	fdc42783          	lw	a5,-36(s0)
    1a6a:	2781                	sext.w	a5,a5
    1a6c:	08f75563          	bge	a4,a5,1af6 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    1a70:	fe843783          	ld	a5,-24(s0)
    1a74:	4f9c                	lw	a5,24(a5)
    1a76:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    1a7a:	fe843783          	ld	a5,-24(s0)
    1a7e:	639c                	ld	a5,0(a5)
    1a80:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    1a84:	fe843783          	ld	a5,-24(s0)
    1a88:	639c                	ld	a5,0(a5)
    1a8a:	5fdc                	lw	a5,60(a5)
    1a8c:	fcf42c23          	sw	a5,-40(s0)
            if (entry->release_time < earliest_impactful_event) {
    1a90:	a09d                	j	1af6 <find_earliest_impactful_release_time_dm+0x102>
            }
        } 
        else if (entry->release_time > current_time && entry->thrd->period == current_period) {
    1a92:	fe843783          	ld	a5,-24(s0)
    1a96:	4f98                	lw	a4,24(a5)
    1a98:	f8c42783          	lw	a5,-116(s0)
    1a9c:	2781                	sext.w	a5,a5
    1a9e:	04e7dc63          	bge	a5,a4,1af6 <find_earliest_impactful_release_time_dm+0x102>
    1aa2:	fe843783          	ld	a5,-24(s0)
    1aa6:	639c                	ld	a5,0(a5)
    1aa8:	4bb8                	lw	a4,80(a5)
    1aaa:	f8842783          	lw	a5,-120(s0)
    1aae:	2781                	sext.w	a5,a5
    1ab0:	04e79363          	bne	a5,a4,1af6 <find_earliest_impactful_release_time_dm+0x102>
    ...
    1ab8:	4f98                	lw	a4,24(a5)
    1aba:	fdc42783          	lw	a5,-36(s0)
    1abe:	2781                	sext.w	a5,a5
    1ac0:	02e7cb63          	blt	a5,a4,1af6 <find_earliest_impactful_release_time_dm+0x102>
    1ac4:	fe843783          	ld	a5,-24(s0)
    1ac8:	639c                	ld	a5,0(a5)
    1aca:	5fd8                	lw	a4,60(a5)
    1acc:	fd842783          	lw	a5,-40(s0)
    1ad0:	2781                	sext.w	a5,a5
    1ad2:	02f75263          	bge	a4,a5,1af6 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    1ad6:	fe843783          	ld	a5,-24(s0)
    1ada:	4f9c                	lw	a5,24(a5)
    ...
    1af0:	5fdc                	lw	a5,60(a5)
    1af2:	fcf42c23          	sw	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    1af6:	fe843783          	ld	a5,-24(s0)
    1afa:	679c                	ld	a5,8(a5)
    1afc:	fcf43423          	sd	a5,-56(s0)
    1b00:	fc843783          	ld	a5,-56(s0)
    1b04:	17e1                	addi	a5,a5,-8
    1b06:	fef43423          	sd	a5,-24(s0)
    1b0a:	fe843783          	ld	a5,-24(s0)
    1b0e:	07a1                	addi	a5,a5,8
    1b10:	f9843703          	ld	a4,-104(s0)
    1b14:	f2f715e3          	bne	a4,a5,1a3e <find_earliest_impactful_release_time_dm+0x4a>
            }
        }
    }
    ...
    1b20:	800007b7          	lui	a5,0x80000
    1b24:	fff7c793          	not	a5,a5
    1b28:	00f70563          	beq	a4,a5,1b32 <find_earliest_impactful_release_time_dm+0x13e>
    1b2c:	fdc42783          	lw	a5,-36(s0)
    1b30:	a011                	j	1b34 <find_earliest_impactful_release_time_dm+0x140>
    1b32:	57fd                	li	a5,-1
    1b34:	fcf42e23          	sw	a5,-36(s0)
    return (ImpactfulEvent) {earliest_impactful_event, t};
    1b38:	fdc42783          	lw	a5,-36(s0)
    1b3c:	faf42c23          	sw	a5,-72(s0)
    1b40:	fe043783          	ld	a5,-32(s0)
    1b44:	fcf43023          	sd	a5,-64(s0)
    1b48:	4701                	li	a4,0
    1b4a:	fb843703          	ld	a4,-72(s0)
    1b4e:	4781                	li	a5,0
    ...
    1b5c:	853a                	mv	a0,a4
    1b5e:	85be                	mv	a1,a5
    1b60:	7466                	ld	s0,120(sp)
    1b62:	6109                	addi	sp,sp,128
    1b64:	8082                	ret

0000000000001b66 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    1b66:	7135                	addi	sp,sp,-160
    1b68:	ed06                	sd	ra,152(sp)
    1b6a:	e922                	sd	s0,144(sp)
    1b6c:	e526                	sd	s1,136(sp)
    1b6e:	e14a                	sd	s2,128(sp)
    1b70:	fcce                	sd	s3,120(sp)
    1b72:	1100                	addi	s0,sp,160
    1b74:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    1b76:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    1b7a:	800007b7          	lui	a5,0x80000
    1b7e:	fff7c793          	not	a5,a5
    1b82:	faf42e23          	sw	a5,-68(s0)
    ...
    1b8a:	faf43823          	sd	a5,-80(s0)
    1b8e:	fb043783          	ld	a5,-80(s0)
    1b92:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffda00>
    1b96:	fcf43023          	sd	a5,-64(s0)
    1b9a:	a8bd                	j	1c18 <schedule_dm+0xb2>
        if (t->is_real_time && t->period < earliest_deadline) {
    1b9c:	fc043783          	ld	a5,-64(s0)
    1ba0:	43bc                	lw	a5,64(a5)
    1ba2:	c39d                	beqz	a5,1bc8 <schedule_dm+0x62>
    1ba4:	fc043783          	ld	a5,-64(s0)
    1ba8:	4bb8                	lw	a4,80(a5)
    1baa:	fbc42783          	lw	a5,-68(s0)
    1bae:	2781                	sext.w	a5,a5
    1bb0:	00f75c63          	bge	a4,a5,1bc8 <schedule_dm+0x62>
            earliest_deadline_thread = t;
    1bb4:	fc043783          	ld	a5,-64(s0)
    1bb8:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    1bbc:	fc043783          	ld	a5,-64(s0)
    1bc0:	4bbc                	lw	a5,80(a5)
    1bc2:	faf42e23          	sw	a5,-68(s0)
    1bc6:	a835                	j	1c02 <schedule_dm+0x9c>
        } else if (t->is_real_time && t->period == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    1bc8:	fc043783          	ld	a5,-64(s0)
    1bcc:	43bc                	lw	a5,64(a5)
    1bce:	cb95                	beqz	a5,1c02 <schedule_dm+0x9c>
    1bd0:	fc043783          	ld	a5,-64(s0)
    1bd4:	4bb8                	lw	a4,80(a5)
    1bd6:	fbc42783          	lw	a5,-68(s0)
    1bda:	2781                	sext.w	a5,a5
    1bdc:	02e79363          	bne	a5,a4,1c02 <schedule_dm+0x9c>
    1be0:	fc043783          	ld	a5,-64(s0)
    1be4:	5fd8                	lw	a4,60(a5)
    1be6:	fc843783          	ld	a5,-56(s0)
    1bea:	5fdc                	lw	a5,60(a5)
    1bec:	00f75b63          	bge	a4,a5,1c02 <schedule_dm+0x9c>
            earliest_deadline_thread = t;
    1bf0:	fc043783          	ld	a5,-64(s0)
    1bf4:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    1bf8:	fc043783          	ld	a5,-64(s0)
    1bfc:	4bbc                	lw	a5,80(a5)
    1bfe:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1c02:	fc043783          	ld	a5,-64(s0)
    1c06:	779c                	ld	a5,40(a5)
    1c08:	f8f43c23          	sd	a5,-104(s0)
    1c0c:	f9843783          	ld	a5,-104(s0)
    1c10:	fd878793          	addi	a5,a5,-40
    1c14:	fcf43023          	sd	a5,-64(s0)
    1c18:	fc043783          	ld	a5,-64(s0)
    1c1c:	02878713          	addi	a4,a5,40
    1c20:	649c                	ld	a5,8(s1)
    1c22:	f6f71de3          	bne	a4,a5,1b9c <schedule_dm+0x36>
        }
    }
    ...
    1c26:	6888                	ld	a0,16(s1)
    1c28:	648c                	ld	a1,8(s1)
    1c2a:	4090                	lw	a2,0(s1)
    1c2c:	fc843783          	ld	a5,-56(s0)
    1c30:	c789                	beqz	a5,1c3a <schedule_dm+0xd4>
    1c32:	fc843783          	ld	a5,-56(s0)
    1c36:	4bbc                	lw	a5,80(a5)
    1c38:	a029                	j	1c42 <schedule_dm+0xdc>
    1c3a:	800007b7          	lui	a5,0x80000
    1c3e:	fff7c793          	not	a5,a5
    1c42:	fc843703          	ld	a4,-56(s0)
    1c46:	5f58                	lw	a4,60(a4)
    1c48:	86be                	mv	a3,a5
    1c4a:	00000097          	auipc	ra,0x0
    1c4e:	daa080e7          	jalr	-598(ra) # 19f4 <find_earliest_impactful_release_time_dm>
    1c52:	872a                	mv	a4,a0
    1c54:	87ae                	mv	a5,a1
    1c56:	f6e43423          	sd	a4,-152(s0)
    1c5a:	f6f43823          	sd	a5,-144(s0)
    earliest_impactful_deadline = earliest_impactful_event.earliest_impactful_event;
    1c5e:	f6842783          	lw	a5,-152(s0)
    1c62:	faf42623          	sw	a5,-84(s0)
    //printf("earliest_impactful_deadline: %d\n", earliest_impactful_deadline);
    if (earliest_deadline_thread) {
    1c66:	fc843783          	ld	a5,-56(s0)
    1c6a:	cfd9                	beqz	a5,1d08 <schedule_dm+0x1a2>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    1c6c:	fc843783          	ld	a5,-56(s0)
    1c70:	4ff8                	lw	a4,92(a5)
    1c72:	409c                	lw	a5,0(s1)
    1c74:	40f707bb          	subw	a5,a4,a5
    1c78:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline <= 0) {
    1c7c:	fa842783          	lw	a5,-88(s0)
    1c80:	2781                	sext.w	a5,a5
    1c82:	00f04b63          	bgtz	a5,1c98 <schedule_dm+0x132>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1c86:	fc843783          	ld	a5,-56(s0)
    1c8a:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffda50>
    1c8e:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    1c92:	f8042023          	sw	zero,-128(s0)
    1c96:	a079                	j	1d24 <schedule_dm+0x1be>
        } else {
    ...
    1c9e:	fa842703          	lw	a4,-88(s0)
    1ca2:	85ba                	mv	a1,a4
    1ca4:	853e                	mv	a0,a5
    1ca6:	00000097          	auipc	ra,0x0
    1caa:	9c8080e7          	jalr	-1592(ra) # 166e <min>
    1cae:	87aa                	mv	a5,a0
    1cb0:	faf42223          	sw	a5,-92(s0)
            int allocated_time;
            if (earliest_impactful_deadline != -1 && (earliest_impactful_deadline - args.current_time) < remaining_time){
    1cb4:	fac42783          	lw	a5,-84(s0)
    1cb8:	0007871b          	sext.w	a4,a5
    1cbc:	57fd                	li	a5,-1
    1cbe:	02f70663          	beq	a4,a5,1cea <schedule_dm+0x184>
    1cc2:	409c                	lw	a5,0(s1)
    1cc4:	fac42703          	lw	a4,-84(s0)
    1cc8:	40f707bb          	subw	a5,a4,a5
    1ccc:	0007871b          	sext.w	a4,a5
    1cd0:	fa442783          	lw	a5,-92(s0)
    1cd4:	2781                	sext.w	a5,a5
    1cd6:	00f75a63          	bge	a4,a5,1cea <schedule_dm+0x184>
                allocated_time = earliest_impactful_deadline - args.current_time;
    1cda:	409c                	lw	a5,0(s1)
    1cdc:	fac42703          	lw	a4,-84(s0)
    1ce0:	40f707bb          	subw	a5,a4,a5
    1ce4:	faf42c23          	sw	a5,-72(s0)
    1ce8:	a029                	j	1cf2 <schedule_dm+0x18c>
            } else {
                allocated_time = remaining_time;
    1cea:	fa442783          	lw	a5,-92(s0)
    1cee:	faf42c23          	sw	a5,-72(s0)
            }
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1cf2:	fc843783          	ld	a5,-56(s0)
    1cf6:	02878793          	addi	a5,a5,40
    1cfa:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    1cfe:	fb842783          	lw	a5,-72(s0)
    1d02:	f8f42023          	sw	a5,-128(s0)
    1d06:	a839                	j	1d24 <schedule_dm+0x1be>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    1d08:	649c                	ld	a5,8(s1)
    1d0a:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    ...
    1d1a:	4ba080e7          	jalr	1210(ra) # 11d0 <find_next_release_time>
    1d1e:	87aa                	mv	a5,a0
    1d20:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    1d24:	f7843783          	ld	a5,-136(s0)
    1d28:	f8f43423          	sd	a5,-120(s0)
    1d2c:	f8043783          	ld	a5,-128(s0)
    1d30:	f8f43823          	sd	a5,-112(s0)
    1d34:	4701                	li	a4,0
    1d36:	f8843703          	ld	a4,-120(s0)
    1d3a:	4781                	li	a5,0
    ...
    1d48:	853a                	mv	a0,a4
    1d4a:	85be                	mv	a1,a5
    1d4c:	60ea                	ld	ra,152(sp)
    1d4e:	644a                	ld	s0,144(sp)
    1d50:	64aa                	ld	s1,136(sp)
    1d52:	690a                	ld	s2,128(sp)
    1d54:	79e6                	ld	s3,120(sp)
    1d56:	610d                	addi	sp,sp,160
    1d58:	8082                	ret

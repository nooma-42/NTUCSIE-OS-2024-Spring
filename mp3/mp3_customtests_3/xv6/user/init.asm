...
main(void)
{
  ...
  if(open("console", O_RDWR) < 0){
       ...
       e:	ae650513          	addi	a0,a0,-1306 # 1af0 <schedule_dm+0x1fc>
    ...
    mknod("console", CONSOLE, 0);
      ...
      28:	acc50513          	addi	a0,a0,-1332 # 1af0 <schedule_dm+0x1fc>
      2c:	00000097          	auipc	ra,0x0
      30:	5ca080e7          	jalr	1482(ra) # 5f6 <mknod>
    open("console", O_RDWR);
      34:	4589                	li	a1,2
      36:	00002517          	auipc	a0,0x2
      3a:	aba50513          	addi	a0,a0,-1350 # 1af0 <schedule_dm+0x1fc>
  ...
  for(;;){
    printf("init: starting sh\n");
      ...
      5e:	a9e50513          	addi	a0,a0,-1378 # 1af8 <schedule_dm+0x204>
    ...
    if(pid < 0){
      ...
      86:	a8e50513          	addi	a0,a0,-1394 # 1b10 <schedule_dm+0x21c>
    ...
    if(pid == 0){
      ...
      a8:	ac458593          	addi	a1,a1,-1340 # 1b68 <argv>
      ac:	00002517          	auipc	a0,0x2
      b0:	a3c50513          	addi	a0,a0,-1476 # 1ae8 <schedule_dm+0x1f4>
      b4:	00000097          	auipc	ra,0x0
      b8:	532080e7          	jalr	1330(ra) # 5e6 <exec>
      printf("init: exec sh failed\n");
      bc:	00002517          	auipc	a0,0x2
      c0:	a6c50513          	addi	a0,a0,-1428 # 1b28 <schedule_dm+0x234>
    ...
    for(;;){
     ...
     104:	a4050513          	addi	a0,a0,-1472 # 1b40 <schedule_dm+0x24c>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     716:	46668693          	addi	a3,a3,1126 # 1b78 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     7f0:	38c70713          	addi	a4,a4,908 # 1b78 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     9b0:	1b478793          	addi	a5,a5,436 # 1b60 <schedule_dm+0x26c>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     b5c:	04878793          	addi	a5,a5,72 # 1ba0 <freep>
     b60:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     c54:	f5078793          	addi	a5,a5,-176 # 1ba0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     cd6:	ece78793          	addi	a5,a5,-306 # 1ba0 <freep>
     cda:	639c                	ld	a5,0(a5)
}
     cdc:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d08:	e9c78793          	addi	a5,a5,-356 # 1ba0 <freep>
     d0c:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d1c:	e7878793          	addi	a5,a5,-392 # 1b90 <base>
     d20:	fef43023          	sd	a5,-32(s0)
     d24:	00001797          	auipc	a5,0x1
     d28:	e7c78793          	addi	a5,a5,-388 # 1ba0 <freep>
     d2c:	fe043703          	ld	a4,-32(s0)
     d30:	e398                	sd	a4,0(a5)
     d32:	00001797          	auipc	a5,0x1
     d36:	e6e78793          	addi	a5,a5,-402 # 1ba0 <freep>
     d3a:	6398                	ld	a4,0(a5)
     d3c:	00001797          	auipc	a5,0x1
     d40:	e5478793          	addi	a5,a5,-428 # 1b90 <base>
     d44:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     d46:	00001797          	auipc	a5,0x1
     d4a:	e4a78793          	addi	a5,a5,-438 # 1b90 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     dc6:	dde78793          	addi	a5,a5,-546 # 1ba0 <freep>
    ...
    if(p == freep)
     ...
     ddc:	dc878793          	addi	a5,a5,-568 # 1ba0 <freep>
     de0:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    1068:	b4478793          	addi	a5,a5,-1212 # 1ba8 <last_thread.1239>
    ...
    10c4:	ae878793          	addi	a5,a5,-1304 # 1ba8 <last_thread.1239>
    10c8:	639c                	ld	a5,0(a5)
    10ca:	c385                	beqz	a5,10ea <schedule_wrr+0xdc>
    10cc:	00001797          	auipc	a5,0x1
    10d0:	adc78793          	addi	a5,a5,-1316 # 1ba8 <last_thread.1239>
    ...
    10e0:	acc78793          	addi	a5,a5,-1332 # 1ba8 <last_thread.1239>
    ...
    1130:	a7c78793          	addi	a5,a5,-1412 # 1ba8 <last_thread.1239>
...
int find_earliest_impactful_release_time(struct list_head *release_queue, struct list_head *run_queue, int current_time) {
    ...
    11c8:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdc70>
...
struct threads_sched_result schedule_sjf(struct threads_sched_args args) {
    ...
    12fa:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdc70>
...
struct threads_sched_result schedule_lst(struct threads_sched_args args) {
    1430:	7115                	addi	sp,sp,-224
    1432:	ed86                	sd	ra,216(sp)
    1434:	e9a2                	sd	s0,208(sp)
    1436:	e5a6                	sd	s1,200(sp)
    1438:	e1ca                	sd	s2,192(sp)
    143a:	fd4e                	sd	s3,184(sp)
    143c:	1180                	addi	s0,sp,224
    143e:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    ...
    1458:	f9043783          	ld	a5,-112(s0)
    145c:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdc70>
    ...
    14d0:	f5442783          	lw	a5,-172(s0)
    14d4:	fcf42223          	sw	a5,-60(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    14d8:	fb843783          	ld	a5,-72(s0)
    14dc:	779c                	ld	a5,40(a5)
    14de:	f4f43423          	sd	a5,-184(s0)
    14e2:	f4843783          	ld	a5,-184(s0)
    14e6:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdc70>
    ...
    150c:	f8f43423          	sd	a5,-120(s0)
    1510:	f8843783          	ld	a5,-120(s0)
    ...
    1546:	f6843783          	ld	a5,-152(s0)
    154a:	43fc                	lw	a5,68(a5)
    154c:	40f707bb          	subw	a5,a4,a5
    1550:	f6f42223          	sw	a5,-156(s0)
    ...
    15dc:	f5843783          	ld	a5,-168(s0)
    15e0:	17e1                	addi	a5,a5,-8
    15e2:	faf43423          	sd	a5,-88(s0)
    15e6:	fa843783          	ld	a5,-88(s0)
    15ea:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffdca0>
    ...
    15f8:	10078b63          	beqz	a5,170e <schedule_lst+0x2de>
    ...
    1602:	4ffc                	lw	a5,92(a5)
    1604:	08f74863          	blt	a4,a5,1694 <schedule_lst+0x264>
    1608:	fc843783          	ld	a5,-56(s0)
    160c:	4fbc                	lw	a5,88(a5)
    160e:	08f05363          	blez	a5,1694 <schedule_lst+0x264>
            struct thread *thread_with_smallest_id = min_slack_thread;
    1612:	fc843783          	ld	a5,-56(s0)
    1616:	faf43023          	sd	a5,-96(s0)
    ...
    161e:	f8f43023          	sd	a5,-128(s0)
    1622:	f8043783          	ld	a5,-128(s0)
    1626:	fd878793          	addi	a5,a5,-40
    162a:	faf43c23          	sd	a5,-72(s0)
    162e:	a099                	j	1674 <schedule_lst+0x244>
                if (args.current_time >= t->current_deadline && t->remaining_time > 0 && t->ID < thread_with_smallest_id->ID) {
    1630:	4098                	lw	a4,0(s1)
    1632:	fb843783          	ld	a5,-72(s0)
    1636:	4ffc                	lw	a5,92(a5)
    1638:	02f74363          	blt	a4,a5,165e <schedule_lst+0x22e>
    163c:	fb843783          	ld	a5,-72(s0)
    1640:	4fbc                	lw	a5,88(a5)
    1642:	00f05e63          	blez	a5,165e <schedule_lst+0x22e>
    1646:	fb843783          	ld	a5,-72(s0)
    164a:	5fd8                	lw	a4,60(a5)
    164c:	fa043783          	ld	a5,-96(s0)
    1650:	5fdc                	lw	a5,60(a5)
    1652:	00f75663          	bge	a4,a5,165e <schedule_lst+0x22e>
                    thread_with_smallest_id = t;
    1656:	fb843783          	ld	a5,-72(s0)
    165a:	faf43023          	sd	a5,-96(s0)
            list_for_each_entry(t, args.run_queue, thread_list) {
    165e:	fb843783          	ld	a5,-72(s0)
    1662:	779c                	ld	a5,40(a5)
    1664:	f6f43c23          	sd	a5,-136(s0)
    1668:	f7843783          	ld	a5,-136(s0)
    166c:	fd878793          	addi	a5,a5,-40
    1670:	faf43c23          	sd	a5,-72(s0)
    1674:	fb843783          	ld	a5,-72(s0)
    1678:	02878713          	addi	a4,a5,40
    167c:	649c                	ld	a5,8(s1)
    167e:	faf719e3          	bne	a4,a5,1630 <schedule_lst+0x200>
                }
            }
            r.scheduled_thread_list_member = &thread_with_smallest_id->thread_list;
    1682:	fa043783          	ld	a5,-96(s0)
    1686:	02878793          	addi	a5,a5,40
    168a:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = 0;
    168e:	f2042823          	sw	zero,-208(s0)
        if (args.current_time >= min_slack_thread->current_deadline && min_slack_thread->remaining_time > 0) {
    1692:	a86d                	j	174c <schedule_lst+0x31c>
        } else {
    ...
    16a0:	f6f42a23          	sw	a5,-140(s0)
            
            // Decide the allocated time based on current minimum slack or upcoming preemption needs
            int allocated_time = min(min_slack_thread->remaining_time, time_until_deadline);
    16a4:	fc843783          	ld	a5,-56(s0)
    16a8:	4fbc                	lw	a5,88(a5)
    16aa:	f7442703          	lw	a4,-140(s0)
    16ae:	85ba                	mv	a1,a4
    16b0:	853e                	mv	a0,a5
    16b2:	00000097          	auipc	ra,0x0
    16b6:	d4a080e7          	jalr	-694(ra) # 13fc <min>
    16ba:	87aa                	mv	a5,a0
    16bc:	f8f42e23          	sw	a5,-100(s0)
            if (next_significant_event_time != INT_MAX) {
    16c0:	fb442783          	lw	a5,-76(s0)
    16c4:	0007871b          	sext.w	a4,a5
    16c8:	800007b7          	lui	a5,0x80000
    16cc:	fff7c793          	not	a5,a5
    16d0:	02f70463          	beq	a4,a5,16f8 <schedule_lst+0x2c8>
                allocated_time = min(allocated_time, next_significant_event_time - args.current_time);
    16d4:	409c                	lw	a5,0(s1)
    16d6:	fb442703          	lw	a4,-76(s0)
    16da:	40f707bb          	subw	a5,a4,a5
    16de:	0007871b          	sext.w	a4,a5
    16e2:	f9c42783          	lw	a5,-100(s0)
    16e6:	85ba                	mv	a1,a4
    16e8:	853e                	mv	a0,a5
    16ea:	00000097          	auipc	ra,0x0
    16ee:	d12080e7          	jalr	-750(ra) # 13fc <min>
    16f2:	87aa                	mv	a5,a0
    16f4:	f8f42e23          	sw	a5,-100(s0)
            }

            r.scheduled_thread_list_member = &min_slack_thread->thread_list;
    16f8:	fc843783          	ld	a5,-56(s0)
    16fc:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffdcc0>
    1700:	f2f43423          	sd	a5,-216(s0)
            r.allocated_time = allocated_time;
    1704:	f9c42783          	lw	a5,-100(s0)
    1708:	f2f42823          	sw	a5,-208(s0)
    170c:	a081                	j	174c <schedule_lst+0x31c>
        }
    } else {
        // No runnable threads, prepare to sleep or wait based on next known event
        r.scheduled_thread_list_member = args.run_queue;
    170e:	649c                	ld	a5,8(s1)
    1710:	f2f43423          	sd	a5,-216(s0)
    ...
    1714:	fb442783          	lw	a5,-76(s0)
    1718:	0007871b          	sext.w	a4,a5
    171c:	800007b7          	lui	a5,0x80000
    1720:	fff7c793          	not	a5,a5
    1724:	00f70963          	beq	a4,a5,1736 <schedule_lst+0x306>
    1728:	409c                	lw	a5,0(s1)
    172a:	fb442703          	lw	a4,-76(s0)
    172e:	40f707bb          	subw	a5,a4,a5
    1732:	2781                	sext.w	a5,a5
    1734:	a811                	j	1748 <schedule_lst+0x318>
    1736:	689c                	ld	a5,16(s1)
    1738:	4098                	lw	a4,0(s1)
    173a:	85ba                	mv	a1,a4
    173c:	853e                	mv	a0,a5
    173e:	00000097          	auipc	ra,0x0
    1742:	820080e7          	jalr	-2016(ra) # f5e <find_next_release_time>
    1746:	87aa                	mv	a5,a0
    1748:	f2f42823          	sw	a5,-208(s0)
    }

    return r;
    174c:	f2843783          	ld	a5,-216(s0)
    1750:	f2f43c23          	sd	a5,-200(s0)
    1754:	f3043783          	ld	a5,-208(s0)
    1758:	f4f43023          	sd	a5,-192(s0)
    175c:	4701                	li	a4,0
    175e:	f3843703          	ld	a4,-200(s0)
    1762:	4781                	li	a5,0
    1764:	f4043783          	ld	a5,-192(s0)
    1768:	893a                	mv	s2,a4
    176a:	89be                	mv	s3,a5
    176c:	874a                	mv	a4,s2
    176e:	87ce                	mv	a5,s3
    ...
    1770:	853a                	mv	a0,a4
    1772:	85be                	mv	a1,a5
    1774:	60ee                	ld	ra,216(sp)
    1776:	644e                	ld	s0,208(sp)
    1778:	64ae                	ld	s1,200(sp)
    177a:	690e                	ld	s2,192(sp)
    177c:	79ea                	ld	s3,184(sp)
    177e:	612d                	addi	sp,sp,224
    1780:	8082                	ret

0000000000001782 <find_earliest_impactful_release_time_dm>:
typedef struct {
...
ImpactfulEvent find_earliest_impactful_release_time_dm(struct list_head *release_queue, struct list_head*run_queue, int current_time, int current_period, int current_thread_ID) {
    1782:	7119                	addi	sp,sp,-128
    1784:	fca2                	sd	s0,120(sp)
    1786:	0100                	addi	s0,sp,128
    1788:	f8a43c23          	sd	a0,-104(s0)
    178c:	f8b43823          	sd	a1,-112(s0)
    1790:	87b2                	mv	a5,a2
    1792:	f8f42623          	sw	a5,-116(s0)
    1796:	87b6                	mv	a5,a3
    1798:	f8f42423          	sw	a5,-120(s0)
    179c:	87ba                	mv	a5,a4
    179e:	f8f42223          	sw	a5,-124(s0)
    struct release_queue_entry *entry;
    struct thread *t;
    int earliest_impactful_event = INT_MAX;
    17a2:	800007b7          	lui	a5,0x80000
    17a6:	fff7c793          	not	a5,a5
    17aa:	fcf42e23          	sw	a5,-36(s0)
    int earliest_impactful_thread_ID = current_thread_ID;    
    17ae:	f8442783          	lw	a5,-124(s0)
    17b2:	fcf42c23          	sw	a5,-40(s0)
    ...
    17bc:	fcf43823          	sd	a5,-48(s0)
    17c0:	fd043783          	ld	a5,-48(s0)
    17c4:	17e1                	addi	a5,a5,-8
    17c6:	fef43423          	sd	a5,-24(s0)
    17ca:	a0f9                	j	1898 <find_earliest_impactful_release_time_dm+0x116>
        if (entry->release_time > current_time && entry->thrd->period < current_period) {
    17cc:	fe843783          	ld	a5,-24(s0)
    17d0:	4f98                	lw	a4,24(a5)
    17d2:	f8c42783          	lw	a5,-116(s0)
    17d6:	2781                	sext.w	a5,a5
    17d8:	04e7d463          	bge	a5,a4,1820 <find_earliest_impactful_release_time_dm+0x9e>
    17dc:	fe843783          	ld	a5,-24(s0)
    17e0:	639c                	ld	a5,0(a5)
    17e2:	4bb8                	lw	a4,80(a5)
    17e4:	f8842783          	lw	a5,-120(s0)
    17e8:	2781                	sext.w	a5,a5
    17ea:	02f75b63          	bge	a4,a5,1820 <find_earliest_impactful_release_time_dm+0x9e>
            if (entry->release_time < earliest_impactful_event) {
    17ee:	fe843783          	ld	a5,-24(s0)
    17f2:	4f98                	lw	a4,24(a5)
    17f4:	fdc42783          	lw	a5,-36(s0)
    17f8:	2781                	sext.w	a5,a5
    17fa:	08f75563          	bge	a4,a5,1884 <find_earliest_impactful_release_time_dm+0x102>
    ...
    181a:	fcf42c23          	sw	a5,-40(s0)
            if (entry->release_time < earliest_impactful_event) {
    181e:	a09d                	j	1884 <find_earliest_impactful_release_time_dm+0x102>
            }
        } 
        else if (entry->release_time > current_time && entry->thrd->period == current_period) {
    1820:	fe843783          	ld	a5,-24(s0)
    1824:	4f98                	lw	a4,24(a5)
    1826:	f8c42783          	lw	a5,-116(s0)
    182a:	2781                	sext.w	a5,a5
    182c:	04e7dc63          	bge	a5,a4,1884 <find_earliest_impactful_release_time_dm+0x102>
    1830:	fe843783          	ld	a5,-24(s0)
    1834:	639c                	ld	a5,0(a5)
    1836:	4bb8                	lw	a4,80(a5)
    1838:	f8842783          	lw	a5,-120(s0)
    183c:	2781                	sext.w	a5,a5
    183e:	04e79363          	bne	a5,a4,1884 <find_earliest_impactful_release_time_dm+0x102>
    ...
    184c:	2781                	sext.w	a5,a5
    184e:	02e7cb63          	blt	a5,a4,1884 <find_earliest_impactful_release_time_dm+0x102>
    1852:	fe843783          	ld	a5,-24(s0)
    1856:	639c                	ld	a5,0(a5)
    1858:	5fd8                	lw	a4,60(a5)
    185a:	fd842783          	lw	a5,-40(s0)
    185e:	2781                	sext.w	a5,a5
    1860:	02f75263          	bge	a4,a5,1884 <find_earliest_impactful_release_time_dm+0x102>
                earliest_impactful_event = entry->release_time;
    1864:	fe843783          	ld	a5,-24(s0)
    1868:	4f9c                	lw	a5,24(a5)
    186a:	fcf42e23          	sw	a5,-36(s0)
                t = entry->thrd;
    186e:	fe843783          	ld	a5,-24(s0)
    1872:	639c                	ld	a5,0(a5)
    1874:	fef43023          	sd	a5,-32(s0)
                earliest_impactful_thread_ID = entry->thrd->ID;
    1878:	fe843783          	ld	a5,-24(s0)
    187c:	639c                	ld	a5,0(a5)
    187e:	5fdc                	lw	a5,60(a5)
    1880:	fcf42c23          	sw	a5,-40(s0)
    list_for_each_entry(entry, release_queue, thread_list) {
    1884:	fe843783          	ld	a5,-24(s0)
    1888:	679c                	ld	a5,8(a5)
    188a:	fcf43423          	sd	a5,-56(s0)
    188e:	fc843783          	ld	a5,-56(s0)
    1892:	17e1                	addi	a5,a5,-8
    1894:	fef43423          	sd	a5,-24(s0)
    1898:	fe843783          	ld	a5,-24(s0)
    189c:	07a1                	addi	a5,a5,8
    189e:	f9843703          	ld	a4,-104(s0)
    18a2:	f2f715e3          	bne	a4,a5,17cc <find_earliest_impactful_release_time_dm+0x4a>
            }
        }
    }
    ...
    18ae:	800007b7          	lui	a5,0x80000
    18b2:	fff7c793          	not	a5,a5
    18b6:	00f70563          	beq	a4,a5,18c0 <find_earliest_impactful_release_time_dm+0x13e>
    18ba:	fdc42783          	lw	a5,-36(s0)
    18be:	a011                	j	18c2 <find_earliest_impactful_release_time_dm+0x140>
    18c0:	57fd                	li	a5,-1
    18c2:	fcf42e23          	sw	a5,-36(s0)
    return (ImpactfulEvent) {earliest_impactful_event, t};
    18c6:	fdc42783          	lw	a5,-36(s0)
    18ca:	faf42c23          	sw	a5,-72(s0)
    18ce:	fe043783          	ld	a5,-32(s0)
    18d2:	fcf43023          	sd	a5,-64(s0)
    18d6:	4701                	li	a4,0
    18d8:	fb843703          	ld	a4,-72(s0)
    18dc:	4781                	li	a5,0
    ...
    18ea:	853a                	mv	a0,a4
    18ec:	85be                	mv	a1,a5
    18ee:	7466                	ld	s0,120(sp)
    18f0:	6109                	addi	sp,sp,128
    18f2:	8082                	ret

00000000000018f4 <schedule_dm>:


struct threads_sched_result schedule_dm(struct threads_sched_args args) {
    18f4:	7135                	addi	sp,sp,-160
    18f6:	ed06                	sd	ra,152(sp)
    18f8:	e922                	sd	s0,144(sp)
    18fa:	e526                	sd	s1,136(sp)
    18fc:	e14a                	sd	s2,128(sp)
    18fe:	fcce                	sd	s3,120(sp)
    1900:	1100                	addi	s0,sp,160
    1902:	84aa                	mv	s1,a0
    struct threads_sched_result r;
    struct thread *earliest_deadline_thread = NULL;
    1904:	fc043423          	sd	zero,-56(s0)
    struct thread *t;
    int earliest_deadline = INT_MAX;
    1908:	800007b7          	lui	a5,0x80000
    190c:	fff7c793          	not	a5,a5
    1910:	faf42e23          	sw	a5,-68(s0)
    ...
    1920:	fd878793          	addi	a5,a5,-40 # ffffffff7fffffd8 <__global_pointer$+0xffffffff7fffdc70>
    1924:	fcf43023          	sd	a5,-64(s0)
    1928:	a8bd                	j	19a6 <schedule_dm+0xb2>
        if (t->is_real_time && t->period < earliest_deadline) {
    192a:	fc043783          	ld	a5,-64(s0)
    192e:	43bc                	lw	a5,64(a5)
    1930:	c39d                	beqz	a5,1956 <schedule_dm+0x62>
    1932:	fc043783          	ld	a5,-64(s0)
    1936:	4bb8                	lw	a4,80(a5)
    1938:	fbc42783          	lw	a5,-68(s0)
    193c:	2781                	sext.w	a5,a5
    193e:	00f75c63          	bge	a4,a5,1956 <schedule_dm+0x62>
            earliest_deadline_thread = t;
    1942:	fc043783          	ld	a5,-64(s0)
    1946:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    194a:	fc043783          	ld	a5,-64(s0)
    194e:	4bbc                	lw	a5,80(a5)
    1950:	faf42e23          	sw	a5,-68(s0)
    1954:	a835                	j	1990 <schedule_dm+0x9c>
        } else if (t->is_real_time && t->period == earliest_deadline && t->ID < earliest_deadline_thread->ID) {
    1956:	fc043783          	ld	a5,-64(s0)
    195a:	43bc                	lw	a5,64(a5)
    195c:	cb95                	beqz	a5,1990 <schedule_dm+0x9c>
    195e:	fc043783          	ld	a5,-64(s0)
    1962:	4bb8                	lw	a4,80(a5)
    1964:	fbc42783          	lw	a5,-68(s0)
    1968:	2781                	sext.w	a5,a5
    196a:	02e79363          	bne	a5,a4,1990 <schedule_dm+0x9c>
    196e:	fc043783          	ld	a5,-64(s0)
    1972:	5fd8                	lw	a4,60(a5)
    1974:	fc843783          	ld	a5,-56(s0)
    1978:	5fdc                	lw	a5,60(a5)
    197a:	00f75b63          	bge	a4,a5,1990 <schedule_dm+0x9c>
            earliest_deadline_thread = t;
    197e:	fc043783          	ld	a5,-64(s0)
    1982:	fcf43423          	sd	a5,-56(s0)
            earliest_deadline = t->period;
    1986:	fc043783          	ld	a5,-64(s0)
    198a:	4bbc                	lw	a5,80(a5)
    198c:	faf42e23          	sw	a5,-68(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    1990:	fc043783          	ld	a5,-64(s0)
    1994:	779c                	ld	a5,40(a5)
    1996:	f8f43c23          	sd	a5,-104(s0)
    199a:	f9843783          	ld	a5,-104(s0)
    199e:	fd878793          	addi	a5,a5,-40
    19a2:	fcf43023          	sd	a5,-64(s0)
    19a6:	fc043783          	ld	a5,-64(s0)
    19aa:	02878713          	addi	a4,a5,40
    19ae:	649c                	ld	a5,8(s1)
    19b0:	f6f71de3          	bne	a4,a5,192a <schedule_dm+0x36>
        }
    }
    ...
    19b4:	6888                	ld	a0,16(s1)
    19b6:	648c                	ld	a1,8(s1)
    19b8:	4090                	lw	a2,0(s1)
    19ba:	fc843783          	ld	a5,-56(s0)
    19be:	c789                	beqz	a5,19c8 <schedule_dm+0xd4>
    19c0:	fc843783          	ld	a5,-56(s0)
    19c4:	4bbc                	lw	a5,80(a5)
    19c6:	a029                	j	19d0 <schedule_dm+0xdc>
    19c8:	800007b7          	lui	a5,0x80000
    19cc:	fff7c793          	not	a5,a5
    19d0:	fc843703          	ld	a4,-56(s0)
    19d4:	5f58                	lw	a4,60(a4)
    19d6:	86be                	mv	a3,a5
    19d8:	00000097          	auipc	ra,0x0
    19dc:	daa080e7          	jalr	-598(ra) # 1782 <find_earliest_impactful_release_time_dm>
    19e0:	872a                	mv	a4,a0
    19e2:	87ae                	mv	a5,a1
    19e4:	f6e43423          	sd	a4,-152(s0)
    19e8:	f6f43823          	sd	a5,-144(s0)
    earliest_impactful_deadline = earliest_impactful_event.earliest_impactful_event;
    19ec:	f6842783          	lw	a5,-152(s0)
    19f0:	faf42623          	sw	a5,-84(s0)
    //printf("earliest_impactful_deadline: %d\n", earliest_impactful_deadline);
    if (earliest_deadline_thread) {
    19f4:	fc843783          	ld	a5,-56(s0)
    19f8:	cfd9                	beqz	a5,1a96 <schedule_dm+0x1a2>
        int time_to_deadline = earliest_deadline_thread->current_deadline - args.current_time;
    19fa:	fc843783          	ld	a5,-56(s0)
    19fe:	4ff8                	lw	a4,92(a5)
    1a00:	409c                	lw	a5,0(s1)
    1a02:	40f707bb          	subw	a5,a4,a5
    1a06:	faf42423          	sw	a5,-88(s0)
        
        // If the thread is already past its deadline, allocate no time (handle deadline miss)
        if (time_to_deadline <= 0) {
    1a0a:	fa842783          	lw	a5,-88(s0)
    1a0e:	2781                	sext.w	a5,a5
    1a10:	00f04b63          	bgtz	a5,1a26 <schedule_dm+0x132>
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1a14:	fc843783          	ld	a5,-56(s0)
    1a18:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffdcc0>
    1a1c:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = 0;
    1a20:	f8042023          	sw	zero,-128(s0)
    1a24:	a079                	j	1ab2 <schedule_dm+0x1be>
        } else {
    ...
    1a2c:	fa842703          	lw	a4,-88(s0)
    1a30:	85ba                	mv	a1,a4
    1a32:	853e                	mv	a0,a5
    1a34:	00000097          	auipc	ra,0x0
    1a38:	9c8080e7          	jalr	-1592(ra) # 13fc <min>
    1a3c:	87aa                	mv	a5,a0
    1a3e:	faf42223          	sw	a5,-92(s0)
            int allocated_time;
            if (earliest_impactful_deadline != -1 && (earliest_impactful_deadline - args.current_time) < remaining_time){
    1a42:	fac42783          	lw	a5,-84(s0)
    1a46:	0007871b          	sext.w	a4,a5
    1a4a:	57fd                	li	a5,-1
    1a4c:	02f70663          	beq	a4,a5,1a78 <schedule_dm+0x184>
    1a50:	409c                	lw	a5,0(s1)
    1a52:	fac42703          	lw	a4,-84(s0)
    1a56:	40f707bb          	subw	a5,a4,a5
    1a5a:	0007871b          	sext.w	a4,a5
    1a5e:	fa442783          	lw	a5,-92(s0)
    1a62:	2781                	sext.w	a5,a5
    1a64:	00f75a63          	bge	a4,a5,1a78 <schedule_dm+0x184>
                allocated_time = earliest_impactful_deadline - args.current_time;
    1a68:	409c                	lw	a5,0(s1)
    1a6a:	fac42703          	lw	a4,-84(s0)
    1a6e:	40f707bb          	subw	a5,a4,a5
    1a72:	faf42c23          	sw	a5,-72(s0)
    1a76:	a029                	j	1a80 <schedule_dm+0x18c>
            } else {
                allocated_time = remaining_time;
    1a78:	fa442783          	lw	a5,-92(s0)
    1a7c:	faf42c23          	sw	a5,-72(s0)
            }
            r.scheduled_thread_list_member = &earliest_deadline_thread->thread_list;
    1a80:	fc843783          	ld	a5,-56(s0)
    1a84:	02878793          	addi	a5,a5,40
    1a88:	f6f43c23          	sd	a5,-136(s0)
            r.allocated_time = allocated_time;
    1a8c:	fb842783          	lw	a5,-72(s0)
    1a90:	f8f42023          	sw	a5,-128(s0)
    1a94:	a839                	j	1ab2 <schedule_dm+0x1be>
        }
    } else {
        // If no immediate tasks, schedule the next possible task
        r.scheduled_thread_list_member = args.run_queue;
    1a96:	649c                	ld	a5,8(s1)
    1a98:	f6f43c23          	sd	a5,-136(s0)
        r.allocated_time = find_next_release_time(args.release_queue, args.current_time);
    1a9c:	689c                	ld	a5,16(s1)
    1a9e:	4098                	lw	a4,0(s1)
    1aa0:	85ba                	mv	a1,a4
    1aa2:	853e                	mv	a0,a5
    1aa4:	fffff097          	auipc	ra,0xfffff
    1aa8:	4ba080e7          	jalr	1210(ra) # f5e <find_next_release_time>
    1aac:	87aa                	mv	a5,a0
    1aae:	f8f42023          	sw	a5,-128(s0)
    }

    return r;
    1ab2:	f7843783          	ld	a5,-136(s0)
    1ab6:	f8f43423          	sd	a5,-120(s0)
    1aba:	f8043783          	ld	a5,-128(s0)
    1abe:	f8f43823          	sd	a5,-112(s0)
    1ac2:	4701                	li	a4,0
    1ac4:	f8843703          	ld	a4,-120(s0)
    1ac8:	4781                	li	a5,0
    1aca:	f9043783          	ld	a5,-112(s0)
    1ace:	893a                	mv	s2,a4
    1ad0:	89be                	mv	s3,a5
    1ad2:	874a                	mv	a4,s2
    1ad4:	87ce                	mv	a5,s3
    ...
    1ad6:	853a                	mv	a0,a4
    1ad8:	85be                	mv	a1,a5
    1ada:	60ea                	ld	ra,152(sp)
    1adc:	644a                	ld	s0,144(sp)
    1ade:	64aa                	ld	s1,136(sp)
    1ae0:	690a                	ld	s2,128(sp)
    1ae2:	79e6                	ld	s3,120(sp)
    1ae4:	610d                	addi	sp,sp,160
    1ae6:	8082                	ret

...
def test_uthread():
    ...
    expected = ""
    with open(f"custom/DM/rttask2.out","r") as f:
        expected=f.read()
    if not re.findall(expected, r.qemu.output, re.M):
...
def test_uthread():
    ...
    expected = ""
    with open(f"custom/DM/rttask3.out","r") as f:
        expected=f.read()
    if not re.findall(expected, r.qemu.output, re.M):
...
def test_uthread():
    ...
    expected = ""
    with open(f"custom/DM/rttask4.out","r") as f:
        expected=f.read()
    if not re.findall(expected, r.qemu.output, re.M):
...
def test_uthread():
    ...
    expected = ""
    with open(f"custom/DM/rttask5.out","r") as f:
        expected=f.read()
    if not re.findall(expected, r.qemu.output, re.M):
...
def test_uthread():
    ...
    expected = ""
    with open(f"custom/DM/rttask6.out","r") as f:
        expected=f.read()
    if not re.findall(expected, r.qemu.output, re.M):

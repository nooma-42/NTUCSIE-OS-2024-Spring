...
def test_uthread():
    ...
    expected = ""
    with open(f"custom/SJF/task1.out","r") as f:
        expected=f.read()
...
def test_uthread():
    ...
    expected = ""
    with open(f"custom/SJF/task2.out","r") as f:
        expected=f.read()
    if not re.findall(expected, r.qemu.output, re.M):
...
def test_uthread():
    ...
    expected = ""
    with open(f"custom/SJF/task3.out","r") as f:
        expected=f.read()
    if not re.findall(expected, r.qemu.output, re.M):
...
def test_uthread():
    ...
    expected = ""
    with open(f"custom/SJF/task4.out","r") as f:
        expected=f.read()
    if not re.findall(expected, r.qemu.output, re.M):
